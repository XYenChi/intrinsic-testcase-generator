...
int main(){
    const int8_t data1[] = {
    113, 0, 122, -33, 115, -96, -86, -24, -103, -33, -70, -91, 75, -83, -21, 112
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -40, -125, -4, -27, 87, -28, -27, 126, 121, -35, 126, -55, 114, -78, 64, 2
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsub_vv_i8m2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    113, 1, 126, 1, 0, 188, 0, 0, 0, 1, 60, 165, 0, 0, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
