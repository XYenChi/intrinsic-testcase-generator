...
int main(){
    const uint8_t data1[] = {
    118, 159, 240, 40, 143, 76, 191, 70, 62, 140, 31, 252, 176, 16, 252, 194
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    97, 140, 24, 138, 71, 70, 182, 28, 94, 80, 153, 85, 187, 251, 151, 234
    };
    ...
    uint8_t golden[] = {
    0, 0, 0, 144, 1, 200, 202, 168, 1, 192, 1, 172, 1, 0, 1, 84
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
