...
int main(){
    const uint8_t data1[] = {
    84, 221, 182, 148, 34, 100, 58, 188, 58, 242, 81, 93, 94, 160, 171, 231
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    0, 243, 200, 200, 87, 201, 88, 216, 186, 106, 40, 104, 165, 170, 132, 121
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u8m8 (data1_v, data2_v, vl);
