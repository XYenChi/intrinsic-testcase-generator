...
int main(){
    ...
    190, 173, 52, 163, 175, 148, 205, 116, 57, 238, 24, 149, 161, 3, 5, 226
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    32, 31, 0, 172, 117, 172, 61, 23, 67, 239, 204, 170, 124, 62, 131, 30
    };
    ...
    uint64_t golden[] = {
    1, 1, 0, 0, 1, 172, 0, 23, 67, 239, 0, 170, 124, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
