...
int main(){
    const uint8_t data1[] = {
    148, 209, 26, 26, 144, 184, 173, 44, 123, 13, 148, 155, 189, 37, 95, 60
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    27, 71, 242, 255, 74, 93, 18, 31, 133, 117, 171, 137, 44, 124, 17, 85
    };
    ...
    uint8_t golden[] = {
    156, 247, 149, 231, 161, 217, 43, 84, 231, 242, 221, 243, 124, 236, 80, 237
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
