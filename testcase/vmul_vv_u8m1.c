...
int main(){
    const uint8_t data1[] = {
    156, 53, 27, 196, 179, 81, 159, 247, 52, 56, 200, 186, 182, 96, 76, 206
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    233, 82, 52, 229, 188, 174, 57, 153, 10, 128, 186, 66, 137, 244, 241, 123
    };
    ...
    uint8_t golden[] = {
    252, 250, 124, 84, 116, 14, 103, 159, 8, 0, 80, 244, 102, 128, 140, 250
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
