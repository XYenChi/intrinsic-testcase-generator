...
int main(){
    const uint8_t data1[] = {
    185, 206, 86, 5, 121, 168, 65, 96, 109, 88, 76, 253, 25, 85, 24, 199
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    92, 8, 108, 106, 21, 146, 17, 164, 240, 41, 82, 250, 62, 206, 126, 201
    };
    ...
    uint8_t golden[] = {
    124, 112, 72, 18, 237, 208, 81, 128, 48, 24, 88, 18, 14, 102, 208, 63
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
