...
int main(){
    ...
    117, 49, 169, 164, 185, 120, 157, 83, 56, 185, 131, 191, 178, 176, 226, 202
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    75, 59, 243, 214, 20, 105, 200, 248, 200, 71, 144, 156, 125, 245, 236, 198
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vv_u16mf4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    8776, 1, 0, 35097, 3700, 12600, 1, 1, 1, 0, 18865, 29796, 22250, 0, 53337, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
