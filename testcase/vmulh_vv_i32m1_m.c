...
int main(){
    const int32_t data1[] = {
    -83, -67, 81, -101, 80, 18, -79, 94, -59, -105, -40, -97, -47, 18, 126, -114
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -128, 76, 35, 99, -97, -78, 41, 68, -12, 96, -97, -10, -98, -123, 73, -86
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vv_32m1_b32 (mask, data1_v, data2_v, vl);
