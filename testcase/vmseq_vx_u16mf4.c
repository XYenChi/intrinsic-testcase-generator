...
int main(){
    ...
    41, 133, 183, 206, 199, 62, 213, 173, 209, 161, 89, 216, 11, 172, 100, 62
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    209, 198, 166, 139, 180, 139, 181, 118, 132, 198, 50, 18, 186, 52, 251, 11
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_16mf4_b64 (data1_v, data2_v, vl);
