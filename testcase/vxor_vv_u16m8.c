...
int main(){
    ...
    161, 14, 222, 136, 200, 89, 41, 205, 91, 235, 197, 119, 39, 162, 185, 4
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    203, 142, 38, 153, 11, 130, 84, 180, 233, 170, 50, 157, 205, 210, 192, 62
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u16m8 (data1_v, data2_v, vl);
