...
int main(){
    ...
    222, 41, 125, 30, 141, 11, 94, 179, 90, 119, 86, 98, 74, 144, 215, 79
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    209, 243, 26, 97, 162, 52, 181, 12, 68, 196, 162, 211, 31, 6, 213, 47
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_16m2_b8 (data1_v, data2_v, vl);
