...
int main(){
    ...
    138, 20, 83, 142, 227, 159, 66, 34, 87, 53, 198, 222, 87, 95, 102, 25
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    201, 36, 162, 238, 52, 38, 82, 43, 237, 74, 212, 208, 243, 172, 118, 164
    };
    ...
    uint16_t golden[] = {
    201, 1, 162, 1, 227, 159, 0, 43, 0, 1, 212, 1, 1, 172, 118, 164
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
