...
int main(){
    ...
    79, 116, 63, 99, 14, 156, 163, 71, 132, 55, 191, 244, 88, 14, 193, 94
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    2, 190, 149, 43, 58, 230, 242, 218, 48, 39, 144, 231, 221, 151, 255, 105
    };
    ...
    uint16_t golden[] = {
    79, 0, 0, 99, 58, 230, 0, 0, 0, 0, 0, 244, 0, 151, 255, 105
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
