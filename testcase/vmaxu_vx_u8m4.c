...
int main(){
    const uint8_t data1[] = {
    182, 144, 115, 230, 186, 68, 162, 157, 0, 87, 115, 51, 246, 243, 112, 26
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    216, 21, 163, 197, 142, 149, 228, 78, 59, 146, 21, 126, 239, 120, 150, 208
    };
    ...
    uint8_t golden[] = {
    216, 144, 163, 230, 186, 149, 228, 157, 59, 146, 115, 126, 246, 243, 150, 208
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
