...
int main(){
    const uint8_t data1[] = {
    186, 28, 214, 147, 14, 62, 162, 175, 24, 141, 24, 76, 151, 203, 106, 131
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    53, 163, 5, 93, 211, 122, 49, 133, 222, 199, 106, 128, 249, 228, 45, 196
    };
    ...
    uint8_t golden[] = {
    186, 163, 214, 147, 211, 122, 162, 175, 222, 199, 106, 128, 249, 228, 106, 196
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
