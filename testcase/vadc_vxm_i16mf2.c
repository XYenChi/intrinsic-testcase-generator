...
int main(){
    const int16_t data1[] = {
    11, 15, 71, -70, -105, 80, -41, -57, -8, -127, -32, -69, 38, -69, -115, -86
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    101, -8, -27, -122, 74, -124, -67, -51, -57, 66, 16, -121, -70, 52, 12, 114
    };
    ...
    int16_t golden[] = {
    112, 8, 44, -191, -31, -43, -108, -108, -65, -60, -16, -190, -32, -16, -102, 29
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
