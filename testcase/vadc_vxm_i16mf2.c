...
int main(){
    const int16_t data1[] = {
    15, 57, 79, -45, -106, 96, -59, 3, 97, 28, 123, -86, 102, -67, 62, 34
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    102, -13, -22, 58, 17, -70, 12, -123, -50, -124, 45, -9, 100, 97, -18, -78
    };
    ...
    int16_t golden[] = {
    118, 45, 57, 14, -88, 26, -46, -119, 48, -96, 169, -95, 203, 31, 44, -44
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
