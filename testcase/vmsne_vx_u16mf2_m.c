...
int main(){
    ...
    227, 243, 58, 183, 41, 206, 122, 23, 149, 223, 151, 224, 193, 125, 63, 234
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    253, 175, 116, 178, 186, 89, 107, 174, 214, 118, 120, 248, 237, 208, 210, 58
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vx_16mf2_b32_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    1, 1, 1, 0, 1, 1, 0, 0, 1, 0, 1, 1, 1, 1, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
