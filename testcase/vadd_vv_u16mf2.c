...
int main(){
    ...
    99, 10, 235, 191, 122, 162, 249, 220, 176, 10, 37, 81, 67, 175, 58, 16
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    203, 31, 19, 153, 23, 156, 24, 108, 8, 208, 181, 11, 112, 1, 252, 128
    };
    ...
    uint16_t golden[] = {
    302, 41, 254, 344, 145, 318, 273, 328, 184, 218, 218, 92, 179, 176, 310, 144
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
