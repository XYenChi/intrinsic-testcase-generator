...
int main(){
    ...
    44, 223, 72, 194, 171, 241, 44, 202, 58, 239, 117, 189, 134, 191, 27, 3
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    103, 122, 221, 225, 90, 50, 223, 210, 28, 75, 75, 62, 197, 156, 39, 100
    };
    ...
    uint16_t golden[] = {
    147, 345, 293, 419, 261, 291, 267, 412, 86, 314, 192, 251, 331, 347, 66, 103
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
