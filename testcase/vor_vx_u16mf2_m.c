...
int main(){
    ...
    62, 174, 194, 62, 100, 253, 103, 246, 178, 32, 248, 205, 94, 122, 88, 103
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    43, 224, 225, 226, 101, 36, 89, 207, 241, 186, 64, 155, 23, 243, 63, 36
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wx_16mf2u_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    63, 238, 1, 254, 1, 1, 127, 255, 243, 1, 0, 223, 0, 251, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
