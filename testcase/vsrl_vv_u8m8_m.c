...
int main(){
    const uint8_t data1[] = {
    19, 80, 56, 29, 0, 220, 82, 92, 247, 171, 12, 78, 166, 0, 51, 129
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    167, 75, 83, 125, 49, 99, 113, 84, 101, 43, 254, 194, 101, 74, 83, 109
    };
    const uint8_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e8m8(avl);
    const uint out_data[] = {
    0, 1, 1, 1, 1, 0, 0, 0, 1, 0, 1, 0, 0, 0, 1, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u8m8_m (mask, data1_v, shift, vl);
    ...
    uint8_t golden[] = {
    9, 40, 28, 14, 0, 110, 41, 92, 123, 85, 12, 78, 83, 0, 25, 64
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
