...
int main(){
    const int64_t data1[] = {
    -103, 7, 104, -70, -113, 90, -61, -102, -105, -68, -83, -33, -9, -125, 38, 100
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -46, -10, 72, -119, -84, -66, -88, -85, 47, 109, 68, 10, 19, -93, -102, -25
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_64m1_b64_m (mask, data1_v, data2_v, vl);
