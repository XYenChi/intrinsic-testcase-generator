...
int main(){
    const uint8_t data1[] = {
    232, 161, 108, 243, 156, 19, 93, 65, 99, 19, 193, 205, 217, 46, 149, 4
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    126, 70, 62, 154, 133, 25, 173, 56, 197, 212, 251, 193, 250, 32, 233, 57
    };
    ...
    uint8_t golden[] = {
    232, 161, 108, 243, 156, 25, 173, 65, 197, 212, 251, 205, 250, 46, 233, 57
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
