...
int main(){
    const uint8_t data1[] = {
    53, 65, 217, 191, 108, 112, 235, 89, 97, 8, 4, 154, 191, 248, 170, 221
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    1, 145, 142, 69, 53, 185, 177, 88, 24, 97, 255, 228, 231, 86, 67, 12
    };
    ...
    uint8_t golden[] = {
    53, 145, 217, 191, 108, 185, 235, 89, 97, 97, 255, 228, 231, 248, 170, 221
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
