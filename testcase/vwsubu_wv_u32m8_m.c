...
int main(){
    ...
    99, 86, 244, 144, 71, 141, 103, 9, 23, 50, 35, 169, 139, 213, 185, 184
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    183, 216, 129, 149, 220, 144, 218, 211, 190, 95, 96, 156, 209, 143, 248, 223
    };
    ...
    uint4_t masked[] = {
    1, 1, 0, 0, 1, 0, 0, 1, 0, 0, 0, 1, 0, 0, 1, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u32m8_m (mask, data1_v, data2_v, vl);
