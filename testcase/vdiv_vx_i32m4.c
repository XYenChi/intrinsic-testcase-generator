...
int main(){
    const int32_t data1[] = {
    -99, 124, 82, 77, 25, -97, -92, -22, -112, 46, 71, 53, 83, -120, 67, -99
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -113, 65, 15, 80, -78, 88, 97, -110, -116, 90, 56, -94, 115, -44, 46, 74
    };
    ...
    int32_t golden[] = {
    1, 0, 0, 1, 4294967292, 4294967295, 4294967294, 5, 1, 1, 0, 4294967294, 1, 0, 0, 4294967295
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
