...
int main(){
    const int32_t data1[] = {
    -114, 73, -11, 71, -36, -126, 98, -37, -113, -69, 55, -21, -51, 80, -115, -2
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    108, 21, 14, 113, -112, 98, -29, -9, -75, -34, 117, 40, 86, -66, 45, -59
    };
    ...
    int32_t golden[] = {
    4294967295, 0, 4294967294, 1, 3, 4294967295, 4294967295, 0, 0, 0, 2, 4294967294, 4294967294, 4294967295, 4294967295, 29
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
