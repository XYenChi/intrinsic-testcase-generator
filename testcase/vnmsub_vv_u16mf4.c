...
int main(){
    ...
    87, 6, 86, 71, 210, 52, 32, 56, 128, 222, 27, 33, 147, 209, 118, 41
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    95, 247, 21, 51, 147, 71, 243, 38, 141, 52, 185, 134, 243, 215, 70, 116
    };
    ...
    uint16_t golden[] = {
    87, 65295, 86, 20, 210, 52, 65325, 56, 65523, 222, 65378, 65435, 65440, 209, 118, 65461
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
