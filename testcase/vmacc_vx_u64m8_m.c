...
int main(){
    ...
    198, 62, 252, 83, 170, 240, 67, 86, 189, 81, 179, 163, 67, 112, 73, 237
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    144, 82, 223, 143, 248, 173, 104, 152, 244, 82, 51, 76, 100, 210, 27, 116
    };
    ...
    uint64_t golden[] = {
    28512, 5084, 56197, 11870, 0, 41521, 0, 13073, 1, 0, 1, 12389, 0, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
