...
int main(){
    const int8_t data1[] = {
    16, 109, -127, -4, -90, -121, -89, 10, -8, -77, -99, -61, 23, -116, -60, 9
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    86, 112, 54, 18, -101, 120, 38, 26, -60, -76, -70, -27, -98, -80, 119, -51
    };
    ...
    int8_t golden[] = {
    103, 221, -73, 15, -191, -1, -50, 36, -68, -152, -169, -88, -74, -195, 60, -41
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
