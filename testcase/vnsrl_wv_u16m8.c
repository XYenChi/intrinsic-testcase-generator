...
int main(){
    ...
    1, 255, 92, 160, 84, 18, 91, 27, 235, 185, 166, 74, 144, 236, 246, 100
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    204, 83, 167, 99, 235, 168, 98, 143, 94, 161, 7, 165, 162, 121, 144, 230
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_16m8 (data1_v, shift, vl);
