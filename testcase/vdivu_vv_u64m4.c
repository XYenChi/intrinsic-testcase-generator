...
int main(){
    ...
    10, 215, 224, 234, 106, 94, 221, 145, 97, 84, 21, 113, 78, 197, 212, 198
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    68, 179, 171, 213, 46, 207, 196, 64, 236, 253, 192, 172, 83, 204, 25, 188
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i64m4 (data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    6, 0, 0, 0, 0, 2, 0, 0, 2, 3, 9, 1, 1, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
