...
int main(){
    ...
    205, 16, 194, 68, 71, 28, 211, 3, 61, 185, 177, 66, 41, 132, 231, 2
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    7, 84, 85, 112, 231, 26, 15, 162, 191, 255, 41, 17, 225, 69, 216, 35
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_32m2_m (mask, data1_v, shift, vl);
