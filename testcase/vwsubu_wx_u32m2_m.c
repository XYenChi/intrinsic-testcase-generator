...
int main(){
    ...
    109, 143, 252, 193, 144, 64, 186, 165, 245, 94, 155, 155, 7, 11, 140, 89
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    8, 46, 42, 87, 116, 2, 119, 235, 152, 13, 19, 254, 47, 171, 23, 130
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u32m2_m (mask, data1_v, data2_v, vl);
