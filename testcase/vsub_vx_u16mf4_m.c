...
int main(){
    ...
    24, 12, 102, 228, 226, 227, 102, 103, 57, 123, 118, 24, 211, 5, 168, 126
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    235, 178, 254, 58, 193, 61, 208, 142, 66, 192, 213, 15, 153, 42, 246, 98
    };
    ...
    uint16_t golden[] = {
    1, 65370, 65384, 170, 1, 0, 1, 65497, 0, 65467, 65441, 0, 1, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
