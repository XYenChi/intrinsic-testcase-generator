...
int main(){
    const int64_t data1[] = {
    17, -58, -128, 67, -13, -42, 87, -88, 32, 105, -113, 121, -6, 7, -2, 77
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    45, 67, -39, 104, 106, 92, 119, -14, -36, 40, -110, -53, 74, 120, 102, -37
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vv_64m1_b64_m (mask, data1_v, data2_v, vl);
