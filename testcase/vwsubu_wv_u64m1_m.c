...
int main(){
    ...
    87, 104, 83, 131, 111, 56, 5, 63, 120, 49, 141, 208, 201, 2, 28, 33
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    186, 146, 142, 9, 136, 141, 142, 179, 144, 200, 162, 136, 17, 8, 161, 182
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u64m1_m (mask, data1_v, data2_v, vl);
