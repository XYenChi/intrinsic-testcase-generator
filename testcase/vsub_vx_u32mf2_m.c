...
int main(){
    ...
    116, 83, 6, 153, 48, 177, 87, 198, 46, 226, 156, 145, 247, 137, 23, 161
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    173, 237, 158, 81, 44, 71, 182, 85, 132, 48, 57, 23, 243, 12, 108, 29
    };
    const uint32_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e32mf2(avl);
    const uint out_data[] = {
    0, 0, 0, 0, 0, 1, 0, 1, 1, 1, 0, 0, 1, 1, 1, 0
    };
    ...
    uint32_t golden[] = {
    0, 4294967142, 0, 0, 4, 1, 4294967201, 1, 4294967210, 1, 99, 0, 4, 125, 4294967211, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
