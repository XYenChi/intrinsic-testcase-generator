...
int main(){
    const int16_t data1[] = {
    64, 71, -59, -105, -19, 100, -78, 53, -48, -106, -112, 34, -114, -30, 102, 25
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -44, -109, 5, -16, -33, 75, 90, 52, -36, -93, -37, 86, 23, 120, 16, 7
    };
    ...
    int16_t golden[] = {
    62720, 57797, 65241, 1680, 627, 7500, 58516, 2756, 1728, 9858, 4144, 2924, 62914, 61936, 1632, 175
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
