...
int main(){
    const int16_t data1[] = {
    5, 49, -108, -61, 2, -59, 51, -40, -113, 75, -74, -72, 50, 103, 124, 70
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -91, 21, 15, 27, 29, -13, 4, -44, 89, 20, -43, 16, 67, -90, 1, 45
    };
    ...
    int16_t golden[] = {
    65081, 1029, 63916, 63889, 58, 767, 204, 1760, 55479, 1500, 3182, 64384, 3350, 56266, 124, 3150
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
