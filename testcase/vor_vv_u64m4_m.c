...
int main(){
    ...
    131, 92, 182, 186, 201, 121, 248, 58, 62, 51, 78, 155, 77, 231, 130, 185
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    190, 5, 164, 254, 208, 48, 158, 2, 60, 242, 44, 56, 179, 18, 187, 141
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wv_64m4u_m (mask, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    191, 0, 182, 1, 217, 121, 254, 0, 62, 243, 110, 1, 255, 247, 187, 189
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
