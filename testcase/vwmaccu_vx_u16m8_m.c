...
int main(){
    ...
    42, 146, 177, 229, 211, 9, 84, 220, 97, 120, 205, 123, 158, 125, 10, 87
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    120, 113, 42, 221, 87, 80, 168, 211, 165, 236, 252, 255, 83, 59, 10, 45
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vx_u16m8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    0, 0, 1, 50610, 18358, 721, 0, 1, 0, 1, 51661, 31365, 13114, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
