...
int main(){
    const int32_t data1[] = {
    -18, 117, 122, -49, 50, 106, -37, 50, -102, 120, 106, 51, 15, 95, 57, -44
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    29, 52, -51, -91, -50, -46, -41, -64, 77, 39, -121, 6, 61, -100, 103, -97
    };
    ...
    int32_t golden[] = {
    4294967249, 65, 1, 1, 100, 152, 1, 114, 1, 0, 227, 0, 0, 195, 4294967250, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
