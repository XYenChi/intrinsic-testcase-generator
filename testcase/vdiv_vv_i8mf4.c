...
int main(){
    const int8_t data1[] = {
    37, 52, -23, 126, 46, 126, 125, 53, -46, 16, 72, 15, 88, -103, 34, 115
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -36, 43, -35, -23, -105, -108, -67, 91, -93, -73, -56, 92, 74, 46, 96, -123
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdiv_vv_i8mf4 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    255, 0, 1, 255, 253, 255, 255, 1, 2, 251, 255, 6, 0, 255, 2, 254
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
