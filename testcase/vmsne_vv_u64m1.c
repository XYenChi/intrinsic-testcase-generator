...
int main(){
    ...
    48, 167, 66, 144, 162, 66, 103, 233, 208, 33, 47, 237, 238, 22, 213, 200
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    203, 135, 87, 193, 235, 138, 132, 94, 36, 183, 255, 205, 15, 73, 27, 115
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_64m1_b64 (data1_v, data2_v, vl);
