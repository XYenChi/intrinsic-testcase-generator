...
int main(){
    const int16_t data1[] = {
    -24, -40, 32, 52, 61, -37, -1, -106, -22, 39, -90, -82, -90, -117, 52, -37
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    43, -78, 76, 30, -18, 38, -94, -78, -91, 44, 64, -28, 101, 112, 107, 43
    };
    ...
    int16_t golden[] = {
    43, 0, 76, 1, 0, 1, 65535, 65458, 65514, 1, 64, 65508, 101, 0, 107, 43
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
