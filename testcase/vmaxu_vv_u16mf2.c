...
int main(){
    ...
    55, 47, 114, 207, 83, 165, 182, 120, 21, 245, 179, 128, 209, 218, 162, 94
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    165, 35, 245, 92, 222, 230, 76, 212, 78, 116, 158, 159, 38, 185, 159, 208
    };
    ...
    uint16_t golden[] = {
    165, 47, 245, 207, 222, 230, 182, 212, 78, 245, 179, 159, 209, 218, 162, 208
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
