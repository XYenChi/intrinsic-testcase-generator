...
int main(){
    ...
    172, 241, 3, 168, 111, 163, 40, 165, 16, 54, 11, 175, 10, 95, 155, 122
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    210, 171, 13, 152, 190, 87, 49, 224, 140, 66, 230, 205, 141, 42, 212, 20
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u16m8_m (mask, data1_v, shift, vl);
    ...
    uint16_t golden[] = {
    172, 120, 1, 168, 111, 81, 20, 165, 16, 54, 11, 87, 5, 95, 155, 122
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
