...
int main(){
    const int32_t data1[] = {
    -5, 93, 112, -106, -61, -40, -111, 74, -104, -105, 120, 41, 38, 34, -37, 125
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    28, 115, 108, 104, 42, 80, -51, 9, 56, -115, 75, 47, 114, -69, -106, -27
    };
    ...
    int32_t golden[] = {
    1, 1, 0, 104, 42, 80, 0, 74, 0, 4294967191, 120, 0, 114, 0, 4294967259, 125
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
