...
int main(){
    const int32_t data1[] = {
    54, 118, 123, -122, 56, -66, 14, 105, -60, -80, -68, 103, 58, -71, 67, 110
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    29, 83, -47, 13, 8, -121, -128, 67, 10, -117, -120, 110, -121, 87, -59, 48
    };
    ...
    int32_t golden[] = {
    1566, 9794, 4294961515, 4294965710, 448, 7986, 4294965504, 7035, 4294966696, 9360, 8160, 11330, 4294960278, 4294961119, 4294963343, 5280
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
