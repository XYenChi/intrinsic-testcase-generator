...
int main(){
    const int32_t data1[] = {
    116, 105, -6, -92, 8, -30, -110, -51, 86, -114, 61, -43, -128, -109, -81, -88
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    95, -60, -75, 70, 73, -127, 127, 95, 52, -67, 13, 95, -57, -115, -93, 110
    };
    ...
    int32_t golden[] = {
    11020, 4294960996, 450, 4294960856, 584, 3810, 4294953326, 4294962451, 4472, 7638, 793, 4294963211, 7296, 12535, 7533, 4294957616
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
