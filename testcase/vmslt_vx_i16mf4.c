...
int main(){
    const int16_t data1[] = {
    -60, -11, -110, -65, -98, 105, 86, -42, -37, 64, 64, -18, -107, -120, -110, -4
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -111, 30, 64, 89, -2, -7, -99, 12, -6, -108, 118, -121, -41, 110, -48, -79
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_16mf4_b64 (data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    0, 1, 1, 1, 1, 0, 0, 1, 1, 0, 1, 0, 1, 1, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
