...
int main(){
    ...
    206, 93, 17, 213, 173, 124, 248, 179, 89, 126, 28, 105, 189, 59, 41, 87
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    9, 111, 217, 83, 219, 219, 107, 115, 51, 166, 29, 120, 101, 15, 232, 20
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u32m8 (data1_v, data2_v, vl);
