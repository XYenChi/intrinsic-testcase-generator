...
int main(){
    const uint8_t data1[] = {
    211, 106, 161, 34, 163, 172, 16, 160, 43, 31, 133, 253, 158, 125, 61, 93
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    169, 174, 34, 199, 8, 39, 167, 49, 20, 174, 80, 14, 216, 124, 230, 215
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u8mf2 (data1_v, shift, vl);
