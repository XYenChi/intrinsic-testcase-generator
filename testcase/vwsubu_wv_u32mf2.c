...
int main(){
    ...
    105, 252, 234, 78, 189, 163, 237, 199, 149, 194, 35, 27, 82, 7, 193, 154
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    23, 141, 222, 225, 12, 5, 203, 205, 39, 151, 172, 161, 95, 140, 209, 165
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u32mf2 (data1_v, data2_v, vl);
