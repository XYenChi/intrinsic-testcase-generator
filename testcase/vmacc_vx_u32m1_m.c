...
int main(){
    ...
    105, 141, 14, 238, 148, 22, 15, 84, 32, 214, 20, 171, 107, 123, 2, 162
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    143, 156, 215, 45, 33, 169, 176, 249, 211, 2, 204, 152, 180, 24, 244, 113
    };
    ...
    uint32_t golden[] = {
    15016, 21996, 1, 1, 1, 3719, 2640, 0, 6753, 1, 4080, 25993, 1, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
