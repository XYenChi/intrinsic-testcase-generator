...
int main(){
    const int64_t data1[] = {
    10, 43, -18, 72, 77, -15, -18, 19, 28, -31, -73, 24, 97, -101, 124, 39
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -12, 84, 63, 47, -92, 16, 120, 60, 7, -4, 44, 58, -82, 125, 52, -33
    };
    ...
    int64_t golden[] = {
    10, 43, 18446744073709551598, 47, 77, 18446744073709551601, 120, 19, 7, 18446744073709551612, 18446744073709551543, 58, 15, 125, 124, 39
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
