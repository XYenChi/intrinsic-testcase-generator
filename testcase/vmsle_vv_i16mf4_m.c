...
int main(){
    const int16_t data1[] = {
    -78, -105, -45, 17, -1, -7, -86, -42, 42, -121, 25, 122, -66, 37, 11, -64
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    44, 49, 80, -5, 101, 20, 122, -39, 111, -46, 34, -68, 91, 89, 30, 28
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vv_16mf4_b64_m (mask, data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    1, 0, 1, 0, 1, 1, 0, 1, 1, 1, 0, 0, 1, 1, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
