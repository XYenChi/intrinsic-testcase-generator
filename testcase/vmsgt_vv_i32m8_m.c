...
int main(){
    const int32_t data1[] = {
    -96, -60, 38, -6, -112, 25, 65, -46, -115, -49, 60, 77, 28, 115, -48, -52
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -116, -15, -111, 32, 115, 16, -121, -82, 58, -17, -25, -62, 39, 29, -98, -1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vv_32m8_b4_m (mask, data1_v, data2_v, vl);
    ...
    int32_t golden[] = {
    1, 0, 0, 1, 0, 1, 0, 1, 0, 1, 1, 1, 1, 1, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
