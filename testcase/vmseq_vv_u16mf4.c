...
int main(){
    ...
    88, 210, 183, 115, 36, 14, 55, 183, 156, 163, 69, 30, 138, 69, 161, 231
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    135, 131, 237, 42, 253, 39, 84, 3, 100, 0, 215, 226, 79, 245, 65, 57
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_16mf4_b64 (data1_v, data2_v, vl);
