...
int main(){
    const uint8_t data1[] = {
    48, 123, 146, 87, 169, 92, 223, 201, 174, 245, 148, 40, 234, 39, 243, 32
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    182, 23, 198, 104, 68, 162, 113, 97, 125, 84, 176, 209, 37, 112, 82, 249
    };
    ...
    uint8_t golden[] = {
    1, 0, 236, 88, 1, 1, 1, 41, 0, 100, 0, 168, 0, 16, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
