...
int main(){
    ...
    54, 70, 42, 119, 153, 118, 74, 124, 42, 206, 6, 241, 141, 181, 150, 96
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    115, 221, 200, 196, 172, 109, 3, 200, 1, 27, 41, 160, 30, 136, 45, 141
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_16m2 (data1_v, shift, vl);
