...
int main(){
    const int64_t data1[] = {
    -103, -116, -75, -105, -1, 12, 102, 85, 124, 5, -115, 53, -53, -73, -91, 124
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -39, -112, 44, -50, 81, 90, -51, 47, 118, 9, 74, -87, 127, 2, -106, -100
    };
    ...
    int64_t golden[] = {
    18446744073709551577, 18446744073709551388, 44, 18446744073709551566, 80, 90, 18446744073709551565, 132, 242, 14, 74, 18446744073709551529, 74, 2, 18446744073709551510, 24
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
