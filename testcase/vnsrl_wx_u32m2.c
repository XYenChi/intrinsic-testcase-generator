...
int main(){
    ...
    140, 119, 238, 110, 200, 195, 185, 236, 235, 201, 149, 131, 173, 63, 46, 214
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    253, 163, 230, 60, 88, 158, 222, 8, 141, 105, 175, 236, 107, 78, 18, 255
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_32m2 (data1_v, shift, vl);
