...
int main(){
    const uint8_t data1[] = {
    114, 22, 210, 149, 132, 81, 5, 230, 49, 138, 141, 134, 35, 240, 77, 121
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    244, 225, 160, 32, 26, 217, 201, 113, 55, 156, 172, 163, 24, 164, 71, 131
    };
    ...
    uint8_t golden[] = {
    168, 86, 64, 160, 104, 169, 237, 134, 135, 24, 188, 82, 72, 192, 91, 235
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
