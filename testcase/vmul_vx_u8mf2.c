...
int main(){
    const uint8_t data1[] = {
    183, 176, 52, 214, 52, 245, 199, 123, 124, 147, 141, 133, 243, 165, 178, 213
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    146, 186, 144, 229, 193, 63, 241, 172, 98, 86, 16, 14, 252, 92, 76, 17
    };
    ...
    uint8_t golden[] = {
    94, 224, 64, 110, 52, 75, 87, 164, 120, 98, 208, 70, 52, 76, 216, 37
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
