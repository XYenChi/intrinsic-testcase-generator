...
int main(){
    ...
    57, 149, 190, 51, 171, 189, 196, 184, 106, 188, 128, 39, 48, 77, 98, 24
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    247, 31, 232, 220, 225, 118, 167, 132, 255, 11, 13, 125, 45, 252, 99, 249
    };
    ...
    uint32_t golden[] = {
    304, 180, 422, 271, 397, 307, 364, 317, 361, 200, 142, 164, 94, 330, 198, 274
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
