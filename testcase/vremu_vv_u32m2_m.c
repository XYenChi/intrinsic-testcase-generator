...
int main(){
    ...
    187, 201, 68, 62, 115, 207, 206, 8, 103, 139, 98, 164, 169, 57, 102, 139
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    71, 185, 131, 150, 248, 103, 137, 250, 39, 103, 102, 127, 111, 87, 55, 105
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u32m2_m (mask, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    1, 185, 63, 26, 0, 103, 1, 2, 39, 103, 1, 127, 0, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
