...
int main(){
    ...
    50, 196, 29, 100, 181, 227, 194, 127, 145, 53, 236, 20, 19, 88, 1, 105
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    169, 124, 125, 167, 53, 78, 12, 34, 87, 7, 49, 134, 38, 51, 120, 139
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_32m1 (data1_v, shift, vl);
