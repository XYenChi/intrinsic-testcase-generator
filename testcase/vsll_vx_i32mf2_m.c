...
int main(){
    const int32_t data1[] = {
    38, -115, 111, -29, 98, -113, 69, 84, -34, -86, -22, 35, -119, -125, 80, 114
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    55, -108, 79, -18, 44, 38, 42, 85, -103, 112, -106, -121, 72, -41, 70, 81
    };
    ...
    int32_t golden[] = {
    76, -115, 222, -29, 98, -113, 69, 168, -68, -86, -22, 70, -119, -250, 80, 228
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
