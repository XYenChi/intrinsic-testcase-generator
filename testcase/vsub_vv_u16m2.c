...
int main(){
    ...
    23, 226, 204, 250, 77, 252, 11, 171, 60, 55, 57, 65, 84, 137, 60, 73
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    108, 205, 46, 63, 25, 255, 55, 184, 31, 99, 209, 114, 117, 37, 31, 13
    };
    ...
    uint16_t golden[] = {
    65451, 21, 158, 187, 52, 65533, 65492, 65523, 29, 65492, 65384, 65487, 65503, 100, 29, 60
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
