...
int main(){
    ...
    131, 130, 226, 235, 207, 49, 137, 20, 23, 153, 69, 36, 212, 135, 48, 171
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    140, 201, 227, 119, 62, 118, 164, 153, 115, 39, 153, 182, 120, 45, 218, 12
    };
    ...
    uint16_t golden[] = {
    65527, 65465, 65535, 116, 145, 65467, 65509, 65403, 65444, 114, 65452, 65390, 92, 90, 65366, 159
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
