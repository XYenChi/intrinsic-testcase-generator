...
int main(){
    const int32_t data1[] = {
    -99, -49, -76, 124, 10, 110, 94, 9, 99, -71, -47, 115, -108, 27, 126, 3
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -30, -25, 117, 115, -116, 96, 74, -4, -36, 63, -87, -93, 34, 53, -98, -112
    };
    ...
    int32_t golden[] = {
    -69, -24, -128, 9, 126, 14, 20, 13, 127, -128, 40, 127, -128, -26, 127, 115
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
