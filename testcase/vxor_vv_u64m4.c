...
int main(){
    ...
    12, 106, 147, 244, 37, 34, 74, 185, 165, 238, 37, 37, 177, 37, 197, 40
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    67, 245, 192, 100, 249, 245, 181, 86, 212, 4, 121, 95, 35, 250, 140, 21
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u64m4 (data1_v, data2_v, vl);
