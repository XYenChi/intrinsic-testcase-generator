...
int main(){
    ...
    132, 9, 29, 149, 172, 45, 111, 131, 45, 247, 175, 128, 58, 225, 220, 238
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    69, 112, 160, 56, 216, 158, 188, 252, 235, 238, 141, 240, 71, 79, 236, 65
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u32m4_m (mask, data1_v, shift, vl);
    ...
    uint32_t golden[] = {
    66, 9, 29, 149, 172, 45, 111, 131, 22, 247, 87, 128, 29, 112, 220, 119
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
