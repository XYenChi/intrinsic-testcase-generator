...
int main(){
    const int32_t data1[] = {
    70, 4, -70, 63, -16, 1, 92, 31, -92, 123, -110, -124, -63, -89, -2, -34
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    38, -69, 15, 110, 122, -9, -49, -124, 93, 32, -29, 9, -26, 53, 17, -123
    };
    ...
    int32_t golden[] = {
    38, 4294967227, 15, 110, 122, 4294967287, 4294967247, 4294967172, 93, 32, 4294967267, 9, 4294967270, 53, 17, 4294967173
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
