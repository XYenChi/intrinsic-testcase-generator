...
int main(){
    const int8_t data1[] = {
    -14, 55, -77, 19, 1, 19, 7, 118, 81, -63, 66, -116, 49, -86, 26, -121
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    69, -85, 67, -116, -117, -1, -62, 95, 23, 98, -60, -110, 18, -98, 98, -8
    };
    ...
    int8_t golden[] = {
    58, 189, 217, 100, 139, 237, 78, 202, 71, 226, 136, 216, 114, 236, 244, 200
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
