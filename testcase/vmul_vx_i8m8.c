...
int main(){
    const int8_t data1[] = {
    33, 63, 34, 32, 117, 35, 225, 6, 135, 255, 223, 51, 207, 212, 40, 77
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    34, 13, 88, 4, 83, 256, 183, 132, 44, 232, 211, 194, 165, 240, 131, 162
    };
    ...
    int8_t golden[] = {
    1122, 819, 2992, 128, 9711, 8960, 41175, 792, 5940, 59160, 47053, 9894, 34155, 50880, 5240, 12474
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
