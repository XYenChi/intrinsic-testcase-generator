...
int main(){
    const int16_t data1[] = {
    -17, -83, 56, 24, -15, 71, -73, 20, -29, 118, 106, 12, 86, 117, -66, -124
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    65, 103, 32, 50, -60, 69, 7, 120, -108, -20, 114, 104, -78, -118, -7, -30
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vv_16m1_b16 (data1_v, data2_v, vl);
