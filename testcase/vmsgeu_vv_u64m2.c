...
int main(){
    ...
    230, 195, 10, 244, 107, 142, 26, 172, 8, 23, 67, 97, 165, 179, 129, 203
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    170, 137, 41, 199, 91, 81, 149, 17, 55, 33, 169, 17, 10, 188, 225, 248
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_64m2_b32 (data1_v, data2_v, vl);
