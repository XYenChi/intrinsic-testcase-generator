...
int main(){
    ...
    110, 120, 254, 253, 74, 183, 100, 118, 110, 217, 72, 91, 187, 124, 43, 213
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    117, 38, 166, 224, 248, 12, 10, 168, 137, 138, 88, 16, 72, 221, 1, 89
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u64m1 (data1_v, data2_v, vl);
