...
int main(){
    const int16_t data1[] = {
    -30, -20, -91, 106, 106, 27, -57, -92, 62, -108, 93, 28, -16, 25, -97, -79
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -67, -50, -126, 23, -91, 60, 86, 8, -80, -84, -112, -123, 48, -22, -88, 113
    };
    ...
    int16_t golden[] = {
    2010, 1001, 1, 2439, 0, 1, 0, 0, 60576, 1, 55120, 1, 64768, 0, 8537, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
