...
int main(){
    const int16_t data1[] = {
    -35, -19, -109, 73, -46, -76, -25, -102, -122, -66, 23, 63, 55, -37, -105, 63
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    103, 49, -4, -15, 103, 36, -122, -74, 17, -23, 75, 45, -45, -71, -76, 20
    };
    ...
    int16_t golden[] = {
    68, 30, 65423, 58, 57, 65496, 65389, 65360, 65431, 65447, 98, 108, 10, 65428, 65355, 83
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
