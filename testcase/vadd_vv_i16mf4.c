...
int main(){
    const int16_t data1[] = {
    -38, -62, 126, 78, -71, 70, 62, 22, -52, -38, -105, -37, -62, 4, 12, 79
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    37, -69, -34, -118, 68, 79, -22, -80, 65, 12, -15, -51, 21, 77, -114, 99
    };
    ...
    int16_t golden[] = {
    65535, 65405, 92, 65496, 65533, 149, 40, 65478, 13, 65510, 65416, 65448, 65495, 81, 65434, 178
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
