...
int main(){
    ...
    194, 238, 139, 150, 148, 225, 142, 219, 157, 87, 252, 204, 52, 232, 56, 212
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    244, 134, 21, 52, 253, 76, 34, 175, 139, 38, 5, 56, 220, 192, 52, 114
    };
    ...
    uint64_t masked[] = {
    0, 1, 1, 0, 1, 1, 1, 1, 1, 0, 1, 1, 0, 0, 1, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_32mf2_m (mask, data1_v, shift, vl);
