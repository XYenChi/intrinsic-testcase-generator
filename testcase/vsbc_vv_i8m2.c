...
int main(){
    const int8_t data1[] = {
    21, 214, 91, 150, 79, 241, 149, 37, 237, 148, 46, 1, 116, 65, 104, 32
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    180, 87, 81, 123, 51, 240, 27, 5, 9, 58, 36, 121, 61, 136, 239, 10
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsbc_vv_i8m2 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    -159, 127, 10, 27, 28, 1, 122, 32, 228, 90, 10, -120, 55, -71, -135, 22
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
