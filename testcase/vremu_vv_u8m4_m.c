...
int main(){
    const uint8_t data1[] = {
    176, 119, 66, 169, 134, 57, 102, 7, 134, 48, 11, 128, 23, 18, 215, 132
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    173, 39, 113, 250, 126, 50, 18, 167, 47, 186, 153, 10, 5, 105, 207, 80
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u8m4_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    1, 1, 47, 81, 126, 50, 18, 0, 1, 42, 10, 10, 5, 1, 207, 80
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
