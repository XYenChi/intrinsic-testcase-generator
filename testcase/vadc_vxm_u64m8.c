...
int main(){
    ...
    213, 123, 122, 29, 98, 121, 0, 82, 167, 171, 203, 236, 220, 46, 24, 191
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    68, 177, 56, 194, 235, 121, 20, 64, 83, 30, 113, 48, 61, 247, 85, 140
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vadc_vxm_i64m8 (data1_v, data2_v, masked, vl);
    ...
    uint64_t golden[] = {
    281, 301, 179, 224, 334, 243, 21, 147, 250, 202, 316, 285, 282, 294, 109, 332
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
