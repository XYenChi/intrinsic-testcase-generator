...
int main(){
    ...
    81, 254, 108, 244, 12, 90, 138, 100, 205, 29, 227, 250, 77, 29, 65, 196
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    13, 135, 108, 158, 212, 206, 97, 41, 191, 21, 195, 64, 33, 201, 136, 142
    };
    ...
    uint64_t golden[] = {
    95, 389, 217, 402, 225, 297, 235, 141, 396, 51, 422, 314, 110, 231, 202, 338
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
