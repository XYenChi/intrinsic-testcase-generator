...
int main(){
    const int8_t data1[] = {
    -34, 121, 110, -39, 125, -65, -71, 63, -95, -78, 42, 123, 40, -111, 67, 16
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    150, 158, 179, 220, 149, 153, 127, 196, 126, 199, 129, 41, 28, 80, 27, 93
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_8m8_b1 (data1_v, data2_v, vl);
