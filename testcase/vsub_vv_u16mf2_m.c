...
int main(){
    ...
    111, 4, 253, 167, 134, 154, 80, 17, 82, 30, 186, 212, 124, 77, 134, 136
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    217, 199, 75, 54, 8, 38, 244, 97, 106, 150, 219, 178, 74, 227, 227, 66
    };
    ...
    uint16_t golden[] = {
    65430, 1, 0, 1, 126, 1, 0, 65456, 65512, 65416, 0, 0, 0, 65386, 65443, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
