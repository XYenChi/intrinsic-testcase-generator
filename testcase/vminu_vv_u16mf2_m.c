...
int main(){
    ...
    133, 32, 97, 242, 105, 193, 69, 232, 41, 35, 221, 45, 33, 58, 93, 43
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    63, 127, 77, 22, 5, 247, 242, 14, 195, 145, 168, 188, 137, 0, 140, 252
    };
    ...
    uint16_t golden[] = {
    133, 127, 97, 242, 0, 247, 242, 232, 195, 145, 221, 188, 137, 1, 140, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
