...
int main(){
    ...
    85, 155, 113, 100, 237, 29, 29, 10, 194, 84, 194, 246, 1, 228, 218, 145
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    199, 96, 20, 42, 14, 14, 90, 128, 86, 233, 151, 49, 60, 7, 90, 88
    };
    ...
    uint16_t golden[] = {
    199, 1, 113, 100, 0, 0, 90, 1, 194, 233, 194, 0, 0, 228, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
