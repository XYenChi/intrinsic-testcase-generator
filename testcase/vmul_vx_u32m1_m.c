...
int main(){
    ...
    110, 163, 176, 66, 12, 21, 2, 60, 169, 229, 97, 246, 41, 32, 144, 236
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    29, 199, 200, 161, 244, 114, 16, 130, 52, 213, 146, 21, 198, 220, 89, 53
    };
    ...
    uint32_t golden[] = {
    3190, 0, 35200, 10626, 0, 0, 1, 0, 1, 0, 1, 1, 8118, 0, 1, 12508
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
