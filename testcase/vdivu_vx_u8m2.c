...
int main(){
    const uint8_t data1[] = {
    94, 186, 250, 172, 250, 186, 232, 60, 21, 0, 173, 72, 46, 129, 77, 115
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    104, 225, 206, 169, 161, 178, 93, 82, 65, 118, 128, 67, 136, 254, 11, 165
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i8m2 (data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    1, 1, 0, 0, 0, 0, 0, 1, 3, 255, 0, 0, 2, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
