...
int main(){
    const int64_t data1[] = {
    70, -79, 29, -18, 1, 13, 0, 22, 109, 84, -66, 78, 48, 38, -94, 59
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    74, -120, -3, -20, -56, -17, 85, 127, -112, -77, -61, -120, 27, 58, -30, 41
    };
    ...
    uint16_t masked[] = {
    1, 0, 0, 1, 0, 0, 1, 0, 1, 1, 1, 1, 0, 0, 1, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_64m4_b16_m (mask, data1_v, data2_v, vl);
