...
int main(){
    const int16_t data1[] = {
    98, -127, 57, -14, 20, 120, -115, -51, -55, 122, 48, -116, -88, -91, -108, -8
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -3, -79, 119, 47, -11, 32, 115, -108, 14, -45, 44, 49, -126, 25, -88, -48
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_16mf2_b32_m (mask, data1_v, data2_v, vl);
