...
int main(){
    const int32_t data1[] = {
    9, -72, -12, -35, 3, 28, -99, -112, -47, -101, 40, 76, 113, -31, -89, -17
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -10, -78, 90, 103, -108, 55, 60, 122, -39, 98, 49, 26, 45, -78, 107, 105
    };
    ...
    int32_t golden[] = {
    8, 4294967290, 4294967290, 4294967294, 0, 27, 4294967257, 4294967194, 4294967257, 4294967293, 9, 26, 45, 4294967280, 4294967225, 4294967282
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
