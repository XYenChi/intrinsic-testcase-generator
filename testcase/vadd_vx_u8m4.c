...
int main(){
    const int8_t data1[] = {
    59, 113, 204, 145, 167, 49, 250, 158, 226, 11, 100, 232, 199, 120, 243, 202
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    162, 93, 231, 145, 186, 170, 124, 95, 94, 85, 109, 204, 255, 37, 215, 53
    };
    ...
    int8_t golden[] = {
    221, 206, 179, 34, 97, 219, 118, 253, 64, 96, 209, 180, 198, 157, 202, 255
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
