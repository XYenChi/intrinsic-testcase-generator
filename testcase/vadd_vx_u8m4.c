...
int main(){
    const uint8_t data1[] = {
    54, 241, 26, 210, 225, 151, 205, 224, 105, 140, 74, 19, 54, 172, 149, 167
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    95, 242, 87, 7, 14, 89, 255, 165, 145, 50, 182, 210, 196, 243, 88, 152
    };
    ...
    uint8_t golden[] = {
    149, 227, 113, 217, 239, 240, 204, 133, 250, 190, 0, 229, 250, 159, 237, 63
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
