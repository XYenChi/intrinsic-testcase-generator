...
int main(){
    ...
    196, 52, 135, 1, 128, 190, 61, 234, 198, 62, 32, 7, 109, 91, 122, 13
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    3, 215, 22, 137, 59, 14, 148, 74, 200, 59, 108, 140, 182, 45, 223, 132
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_32m2 (data1_v, shift, vl);
