...
int main(){
    const int32_t data1[] = {
    91, -62, 26, 50, 49, 14, 80, 97, -56, 62, 122, -8, 16, 0, -41, -79
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    40, -8, 101, -55, -110, 75, -61, 55, -97, 24, -60, -107, 95, 94, -20, 93
    };
    ...
    int32_t golden[] = {
    91, 4294967288, 101, 50, 49, 75, 80, 97, 4294967240, 62, 122, 4294967288, 95, 94, 4294967276, 93
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
