...
int main(){
    const int32_t data1[] = {
    32, -124, 97, 68, 26, 10, -28, -69, -26, -16, -17, 41, 33, 105, -61, 54
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    27, -125, -14, 1, -96, 69, 28, -1, 83, 83, -125, 88, 64, -120, 46, -27
    };
    ...
    int32_t golden[] = {
    32, 4294967172, 97, 68, 26, 69, 28, 4294967295, 83, 83, 4294967279, 88, 64, 105, 46, 54
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
