...
int main(){
    ...
    56, 118, 83, 114, 209, 18, 191, 199, 205, 144, 59, 23, 17, 161, 54, 30
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    30, 101, 245, 211, 207, 1, 55, 8, 211, 184, 162, 184, 234, 57, 97, 59
    };
    ...
    uint32_t golden[] = {
    26, 17, 1, 4294967199, 0, 0, 1, 1, 4294967290, 4294967256, 4294967193, 4294967135, 0, 104, 4294967253, 4294967267
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
