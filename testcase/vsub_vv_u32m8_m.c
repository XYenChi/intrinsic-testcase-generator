...
int main(){
    ...
    105, 161, 251, 212, 70, 111, 208, 90, 84, 115, 181, 78, 93, 36, 54, 237
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    182, 126, 222, 163, 3, 229, 72, 61, 204, 9, 137, 114, 80, 224, 136, 85
    };
    ...
    uint32_t golden[] = {
    1, 1, 0, 49, 67, 1, 136, 29, 1, 1, 44, 4294967260, 13, 0, 4294967214, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
