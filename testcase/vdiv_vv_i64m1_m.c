...
int main(){
    const int64_t data1[] = {
    -103, 19, -19, 53, -14, -128, -19, 105, -43, 29, -38, -2, -119, -42, 40, -2
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    76, 53, 0, 17, -80, 63, -46, -81, 110, 102, 83, -42, -23, -103, -86, 32
    };
    ...
    int64_t golden[] = {
    18446744073709551615, 0, 0, 0, 1, 0, 0, 18446744073709551615, 1, 0, 18446744073709551613, 21, 1, 2, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
