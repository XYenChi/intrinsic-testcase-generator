...
int main(){
    const int16_t data1[] = {
    119, -105, -116, 7, -45, 80, 114, 116, 127, -87, 97, -58, -108, -105, -15, -108
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -38, -41, 102, 47, 40, 122, 67, -24, 19, -14, -99, 76, -54, -106, -20, -95
    };
    ...
    int16_t golden[] = {
    1, 1, 65318, 65496, 1, 1, 1, 0, 0, 65463, 1, 1, 0, 1, 5, 65523
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
