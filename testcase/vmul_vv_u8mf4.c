...
int main(){
    const uint8_t data1[] = {
    213, 155, 118, 17, 53, 20, 106, 133, 34, 71, 35, 202, 117, 130, 246, 139
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    57, 85, 28, 207, 213, 97, 96, 58, 213, 163, 20, 147, 26, 154, 104, 222
    };
    ...
    uint8_t golden[] = {
    109, 119, 232, 191, 25, 148, 192, 34, 74, 53, 188, 254, 226, 52, 240, 138
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
