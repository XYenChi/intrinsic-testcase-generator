...
int main(){
    const uint8_t data1[] = {
    200, 250, 78, 200, 239, 117, 103, 95, 18, 19, 230, 50, 61, 58, 70, 176
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    167, 242, 56, 91, 14, 130, 184, 49, 231, 145, 31, 97, 1, 31, 238, 133
    };
    ...
    uint8_t golden[] = {
    120, 84, 16, 24, 18, 106, 8, 47, 62, 195, 218, 242, 61, 6, 20, 112
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
