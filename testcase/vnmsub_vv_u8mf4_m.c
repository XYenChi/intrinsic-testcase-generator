...
int main(){
    const uint8_t data1[] = {
    113, 227, 42, 52, 239, 234, 231, 196, 114, 88, 199, 156, 65, 146, 216, 250
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    180, 15, 120, 60, 172, 213, 155, 131, 4, 45, 77, 222, 95, 250, 2, 133
    };
    ...
    uint8_t golden[] = {
    189, 212, 1, 0, 1, 1, 76, 196, 114, 1, 1, 0, 0, 0, 216, 250
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
