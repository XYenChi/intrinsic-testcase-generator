...
int main(){
    ...
    72, 12, 160, 199, 103, 21, 213, 210, 102, 48, 20, 122, 64, 165, 242, 196
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    250, 47, 229, 187, 225, 218, 114, 181, 64, 156, 6, 251, 89, 54, 213, 12
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsub_vv_u32m8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    1, 12, 4294967227, 1, 4294967174, 1, 0, 0, 38, 4294967188, 14, 1, 0, 111, 1, 196
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
