...
int main(){
    const int32_t data1[] = {
    104, 31, -92, 114, 51, -25, 16, -120, -6, -101, 89, -102, -62, -90, -124, 44
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    50, 66, 35, -106, -31, -73, -71, 70, -89, -45, 67, 59, -110, -69, 58, 54
    };
    ...
    int32_t golden[] = {
    50, 4, 4294967239, 8, 20, 4294967273, 9, 4294967246, 4294967291, 4294967251, 67, 4294967253, 4294967248, 4294967227, 4294967230, 10
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
