...
int main(){
    const uint8_t data1[] = {
    120, 199, 88, 149, 76, 13, 253, 107, 177, 181, 204, 67, 79, 107, 218, 231
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    66, 149, 30, 41, 53, 50, 128, 122, 166, 47, 155, 97, 238, 26, 221, 211
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i8m1 (data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 0, 0, 0, 0, 3, 0, 1, 0, 0, 0, 1, 3, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
