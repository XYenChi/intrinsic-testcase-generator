...
int main(){
    ...
    60, 87, 63, 38, 162, 99, 135, 241, 150, 58, 107, 93, 241, 27, 42, 210
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    60, 189, 253, 137, 157, 160, 17, 62, 71, 93, 79, 96, 7, 75, 113, 24
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u16mf4 (data1_v, data2_v, vl);
