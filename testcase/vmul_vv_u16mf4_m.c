...
int main(){
    ...
    179, 243, 175, 255, 28, 17, 213, 109, 200, 192, 31, 120, 140, 211, 144, 188
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    146, 62, 220, 190, 24, 140, 254, 35, 56, 93, 61, 43, 234, 70, 164, 236
    };
    ...
    uint16_t golden[] = {
    0, 15066, 38500, 1, 1, 1, 54102, 3815, 11200, 17856, 1891, 5160, 32760, 14770, 23616, 44368
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
