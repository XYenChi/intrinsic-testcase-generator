...
int main(){
    const int32_t data1[] = {
    -64, 11, 32, 58, 73, 23, -111, 39, -67, 109, 32, 106, 74, 57, -54, 61
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -41, -84, 103, 90, 97, -113, 7, 53, -54, -67, 87, -55, 53, -29, -86, 20
    };
    ...
    int32_t golden[] = {
    0, 4294967288, 3, 1, 1, 4294967291, 4294967295, 1, 0, 4294967295, 2, 4294967295, 0, 4294967295, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
