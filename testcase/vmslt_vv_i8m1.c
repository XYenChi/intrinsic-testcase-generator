...
int main(){
    const int8_t data1[] = {
    -99, 26, 121, 40, 43, 77, -66, 16, -45, 43, -76, -56, -102, 41, 24, -73
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -71, -22, 20, -126, 111, -89, 90, 83, 73, -113, -103, -108, -124, -76, 105, 106
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vv_8m1_b8 (data1_v, data2_v, vl);
