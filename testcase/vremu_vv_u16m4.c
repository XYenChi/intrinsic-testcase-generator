...
int main(){
    ...
    212, 72, 65, 142, 98, 125, 74, 148, 58, 225, 141, 199, 221, 165, 109, 176
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    146, 216, 94, 73, 15, 127, 149, 161, 8, 216, 85, 69, 216, 157, 178, 123
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u16m4 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    146, 0, 29, 73, 15, 2, 1, 13, 8, 216, 85, 69, 216, 157, 69, 123
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
