...
int main(){
    const int8_t data1[] = {
    -103, -52, -80, -54, -82, 60, -73, 22, 95, -55, 22, 2, -72, 92, -72, 24
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -7, 19, 7, -82, 57, -47, 53, -108, -81, 101, 116, -102, -2, 74, 8, -15
    };
    ...
    int8_t golden[] = {
    146, 223, 183, 120, 231, 13, 236, 170, 14, 46, 138, 156, 182, 166, 192, 9
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
