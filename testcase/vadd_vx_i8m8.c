...
int main(){
    const int8_t data1[] = {
    36, -104, 121, 56, -125, 95, 101, -12, -45, -108, -60, 67, 44, -120, 99, 23
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -31, 123, -10, 79, -16, -44, -84, -39, -38, 25, 35, -87, -33, 84, -30, -127
    };
    ...
    int8_t golden[] = {
    51, -56, 237, 10, -190, 199, 34, -34, 54, -221, 9, 121, 48, -130, 158, 63
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
