...
int main(){
    const int8_t data1[] = {
    -43, -105, 118, -9, -82, -102, 53, 5, -24, -67, -31, -77, -24, -58, 40, -97
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -73, -65, 124, -9, 79, -115, 85, -66, 105, -77, 64, 60, 50, 118, -33, 50
    };
    ...
    int8_t golden[] = {
    140, 86, 242, 238, 253, 39, 138, 195, 81, 112, 33, 239, 26, 60, 7, 209
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
