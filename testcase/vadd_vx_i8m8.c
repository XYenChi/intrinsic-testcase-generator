...
int main(){
    const int8_t data1[] = {
    -44, 65, -91, -28, -28, -106, 16, -4, 4, -41, 114, -7, 111, -68, 22, 11
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    0, 22, 28, -98, 117, -60, -19, -34, -119, -101, -9, -11, -20, -49, -84, -3
    };
    ...
    int8_t golden[] = {
    212, 87, 193, 130, 89, 90, 253, 218, 141, 114, 105, 238, 91, 139, 194, 8
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
