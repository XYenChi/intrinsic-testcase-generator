...
int main(){
    const int8_t data1[] = {
    15, 37, -17, -92, -19, -38, -9, 109, -7, 69, -73, -124, 121, -49, -99, 60
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    55, -87, -4, -104, 56, -92, -73, 81, 44, -111, -89, -114, 97, 56, -100, 78
    };
    ...
    int8_t golden[] = {
    70, -50, -21, -128, 37, -128, -82, 127, 37, -42, -128, -128, 127, 7, -128, 127
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
