...
int main(){
    const int8_t data1[] = {
    -111, 21, -106, -52, 64, -18, 90, 21, -38, -104, 121, 57, 56, 14, 120, 56
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -101, -113, -90, -73, 115, -15, -94, -50, -22, 22, 72, -69, 1, 73, 93, -91
    };
    ...
    int8_t golden[] = {
    203, 187, 68, 212, 192, 14, 244, 230, 68, 16, 8, 163, 56, 254, 152, 24
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
