...
int main(){
    ...
    113, 81, 15, 133, 83, 136, 168, 223, 148, 248, 172, 180, 20, 220, 16, 136
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    110, 126, 215, 101, 72, 162, 255, 115, 159, 244, 45, 250, 201, 150, 138, 97
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_16mf2 (data1_v, shift, vl);
