...
int main(){
    ...
    137, 207, 158, 236, 140, 46, 178, 121, 227, 49, 126, 86, 29, 93, 51, 126
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    110, 39, 49, 177, 163, 92, 137, 71, 84, 225, 138, 184, 148, 58, 31, 99
    };
    ...
    uint32_t golden[] = {
    137, 0, 158, 236, 0, 92, 178, 0, 1, 225, 0, 1, 0, 93, 51, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
