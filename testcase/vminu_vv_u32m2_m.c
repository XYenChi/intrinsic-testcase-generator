...
int main(){
    ...
    55, 219, 152, 18, 128, 228, 216, 4, 23, 228, 173, 131, 98, 33, 58, 151
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    187, 90, 19, 176, 107, 43, 140, 180, 24, 31, 192, 1, 141, 29, 91, 232
    };
    ...
    uint32_t golden[] = {
    187, 219, 152, 0, 0, 228, 216, 0, 0, 0, 0, 1, 141, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
