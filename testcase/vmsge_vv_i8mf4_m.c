...
int main(){
    const int8_t data1[] = {
    -58, 41, -94, 55, 122, 1, 123, 28, 68, 116, -29, 83, 51, 82, -41, -111
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    117, -18, 56, 103, -115, -1, 91, 69, -81, -19, 102, 58, -41, 85, -94, -107
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vv_8mf4_b32_m (mask, data1_v, data2_v, vl);
