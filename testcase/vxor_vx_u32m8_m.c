...
int main(){
    ...
    83, 251, 32, 233, 83, 169, 66, 222, 168, 100, 158, 4, 68, 33, 239, 13
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    183, 189, 75, 236, 208, 16, 75, 52, 17, 72, 195, 104, 49, 62, 98, 22
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u32m8_m (mask, data1_v, data2_v, vl);
