...
int main(){
    ...
    17, 186, 171, 78, 32, 112, 155, 238, 86, 98, 182, 121, 204, 68, 23, 69
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    188, 194, 234, 186, 142, 218, 195, 93, 48, 198, 189, 66, 195, 164, 15, 168
    };
    ...
    uint16_t golden[] = {
    188, 194, 234, 186, 142, 218, 195, 238, 86, 198, 189, 121, 204, 164, 23, 168
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
