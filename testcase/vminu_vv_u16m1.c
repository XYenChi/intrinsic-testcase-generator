...
int main(){
    ...
    143, 119, 252, 235, 37, 208, 90, 113, 184, 85, 223, 137, 204, 93, 192, 49
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    61, 63, 19, 215, 183, 230, 68, 36, 86, 85, 240, 103, 121, 82, 80, 108
    };
    ...
    uint16_t golden[] = {
    143, 119, 252, 235, 183, 230, 90, 113, 184, 85, 240, 137, 204, 93, 192, 108
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
