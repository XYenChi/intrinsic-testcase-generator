...
int main(){
    const uint8_t data1[] = {
    154, 161, 38, 39, 164, 87, 171, 193, 219, 60, 159, 178, 204, 86, 233, 109
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    177, 69, 98, 36, 202, 169, 64, 204, 200, 186, 161, 198, 250, 199, 2, 246
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_8m2_m (mask, data1_v, shift, vl);
