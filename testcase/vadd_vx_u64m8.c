...
int main(){
    const int64_t data1[] = {
    249, 38, 30, 80, 54, 18, 27, 255, 203, 154, 252, 141, 29, 23, 80, 160
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    171, 219, 143, 18, 35, 138, 225, 215, 75, 187, 37, 211, 250, 152, 180, 137
    };
    ...
    int64_t golden[] = {
    420, 257, 173, 98, 89, 156, 252, 470, 278, 341, 289, 352, 279, 175, 260, 297
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
