...
int main(){
    ...
    195, 226, 215, 169, 15, 100, 206, 143, 189, 197, 154, 251, 210, 15, 27, 107
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    171, 73, 242, 0, 109, 172, 141, 240, 110, 136, 130, 99, 175, 141, 49, 176
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_32m8_b4 (data1_v, data2_v, vl);
