...
int main(){
    ...
    187, 211, 188, 96, 105, 47, 126, 215, 53, 204, 57, 204, 121, 201, 139, 208
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    161, 239, 112, 83, 213, 157, 159, 50, 47, 63, 97, 107, 225, 220, 217, 175
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u16m1 (data1_v, data2_v, vl);
