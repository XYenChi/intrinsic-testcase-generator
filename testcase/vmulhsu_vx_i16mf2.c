...
int main(){
    const int16_t data1[] = {
    -57, -1, 15, 21, 66, -24, 25, -38, -124, -36, 75, -37, 89, 80, 84, -74
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    0, 152, 94, 180, 161, 229, 67, 88, 148, 161, 204, 141, 59, 93, 115, 235
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_16mf2_b32 (data1_v, data2_v, vl);
