...
int main(){
    const int16_t data1[] = {
    60, 15, 41, -120, 81, 4, -50, 50, 124, -85, 60, 49, 95, 120, -109, 68
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -6, -65, 83, 23, 28, -16, 121, 64, 40, -109, 123, -91, -59, 112, -126, 114
    };
    ...
    int16_t golden[] = {
    65530, 65471, 83, 23, 28, 65520, 121, 64, 40, 65427, 123, 65445, 65477, 112, 65410, 114
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
