...
int main(){
    const int16_t data1[] = {
    98, 44, 34, 5, 106, 116, 111, 127, 89, 63, -31, -116, 34, -27, 20, -69
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    77, -112, 82, 122, -36, 92, -64, 19, 77, 111, 44, 12, -108, 101, 27, 3
    };
    ...
    int16_t golden[] = {
    0, 65533, 2, 0, 65535, 0, 65535, 1, 0, 1, 65534, 1, 0, 1, 1, 65535
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
