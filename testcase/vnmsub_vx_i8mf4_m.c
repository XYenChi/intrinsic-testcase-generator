...
int main(){
    const int8_t data1[] = {
    -92, 93, 69, 87, 6, -95, -73, -119, -19, -82, -23, 9, 112, 25, 10, -21
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -10, 102, 125, 61, 30, -94, -100, 85, -1, -43, -116, -90, -26, 70, 50, 75
    };
    const int8_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e8mf4(avl);
    const int out_data[] = {
    1, 0, 1, 1, 0, 0, 0, 1, 0, 0, 0, 0, 0, 1, 1, 1
    };
    ...
    int8_t golden[] = {
    174, 0, 1, 1, 6, 161, 0, 1, 237, 0, 233, 0, 0, 1, 1, 160
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
