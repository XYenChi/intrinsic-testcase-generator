...
int main(){
    const int16_t data1[] = {
    77, 63, 13, 100, -56, 56, -121, 115, 68, -2, -71, 69, 92, -95, -115, -1
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -83, -22, -100, 77, -56, -106, -128, -127, 82, -3, -100, 88, -24, -101, 118, 7
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vv_16mf2_b32 (data1_v, data2_v, vl);
