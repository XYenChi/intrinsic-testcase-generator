...
int main(){
    ...
    174, 5, 78, 9, 71, 244, 45, 179, 230, 3, 254, 127, 221, 39, 210, 219
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    178, 60, 7, 11, 47, 196, 138, 187, 253, 136, 26, 46, 141, 122, 196, 146
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i64m2 (data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    1, 12, 0, 1, 0, 0, 3, 1, 1, 45, 0, 0, 0, 3, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
