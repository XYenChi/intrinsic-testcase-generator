...
int main(){
    const uint8_t data1[] = {
    196, 243, 150, 213, 140, 41, 39, 35, 147, 149, 86, 208, 28, 246, 223, 254
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    131, 198, 64, 82, 25, 183, 246, 49, 205, 125, 25, 193, 64, 9, 226, 10
    };
    ...
    uint8_t golden[] = {
    1, 0, 1, 213, 0, 0, 246, 49, 205, 0, 1, 0, 1, 246, 226, 254
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
