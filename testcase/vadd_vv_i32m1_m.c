...
int main(){
    const int32_t data1[] = {
    -116, 20, -4, -17, -29, 22, -33, -116, -90, -2, -72, 26, -93, 87, 75, 29
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -46, -69, 102, -125, 54, 6, -35, -76, 49, 117, 13, -55, 40, -128, -104, -12
    };
    ...
    int32_t golden[] = {
    4294967134, 0, 1, 4294967154, 25, 28, 4294967228, 0, 1, 115, 4294967237, 0, 1, 4294967255, 4294967267, 17
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
