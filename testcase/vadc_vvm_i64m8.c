...
int main(){
    const int64_t data1[] = {
    -125, 13, 4, 10, -33, -61, 127, 34, -80, 54, 48, -65, 29, -6, 6, 114
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -118, 13, 103, -125, -76, 18, 7, -115, 94, 105, -103, 86, 56, -128, 120, -105
    };
    ...
    int64_t golden[] = {
    -242, 27, 108, -115, -108, -43, 135, -81, 14, 159, -54, 22, 86, -134, 127, 10
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
