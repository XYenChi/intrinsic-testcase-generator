...
int main(){
    ...
    200, 41, 67, 51, 39, 253, 185, 131, 29, 143, 222, 43, 86, 222, 246, 217
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    153, 228, 254, 229, 225, 34, 171, 191, 188, 148, 226, 107, 52, 13, 218, 63
    };
    ...
    uint32_t golden[] = {
    47, 4294967109, 4294967109, 4294967118, 4294967110, 219, 14, 4294967236, 4294967137, 4294967291, 4294967292, 4294967232, 34, 209, 28, 154
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
