...
int main(){
    const uint8_t data1[] = {
    232, 187, 61, 207, 180, 203, 63, 60, 79, 248, 114, 221, 113, 145, 104, 16
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    126, 122, 235, 204, 8, 113, 153, 154, 124, 58, 209, 166, 93, 104, 239, 7
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_8mf8_b64_m (mask, data1_v, data2_v, vl);
