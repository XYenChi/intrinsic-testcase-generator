...
int main(){
    ...
    236, 10, 176, 225, 127, 53, 101, 174, 50, 131, 151, 233, 9, 111, 32, 135
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    190, 10, 217, 115, 184, 162, 57, 214, 241, 28, 155, 144, 170, 199, 177, 57
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u32m4 (data1_v, data2_v, vl);
