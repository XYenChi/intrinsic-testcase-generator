...
int main(){
    ...
    47, 209, 89, 166, 5, 67, 57, 222, 177, 35, 126, 178, 78, 199, 228, 53
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    243, 131, 212, 74, 216, 232, 164, 67, 51, 51, 149, 163, 154, 58, 194, 196
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u16m2 (data1_v, data2_v, vl);
