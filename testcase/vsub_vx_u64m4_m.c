...
int main(){
    ...
    118, 169, 6, 181, 114, 136, 121, 162, 213, 42, 109, 107, 54, 215, 109, 30
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    152, 189, 25, 44, 104, 3, 219, 35, 85, 240, 173, 226, 241, 21, 30, 220
    };
    ...
    uint64_t golden[] = {
    1, 0, 18446744073709551597, 137, 0, 133, 1, 1, 1, 18446744073709551418, 18446744073709551552, 1, 18446744073709551429, 1, 0, 18446744073709551426
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
