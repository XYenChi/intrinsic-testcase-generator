...
int main(){
    ...
    142, 55, 45, 103, 242, 48, 138, 174, 220, 125, 234, 68, 214, 94, 228, 50
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    7, 73, 21, 118, 110, 223, 160, 244, 191, 218, 204, 0, 47, 161, 14, 112
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u64m4_m (mask, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    7, 1, 21, 1, 0, 31, 1, 1, 1, 93, 1, 1, 47, 67, 14, 12
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
