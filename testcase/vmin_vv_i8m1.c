...
int main(){
    const int8_t data1[] = {
    -19, 0, 125, -78, -100, 119, 96, -128, 9, -92, 83, 15, -108, -10, -45, 37
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    60, 62, -47, 45, 32, 117, 51, 36, -15, 116, 72, -59, -79, -111, -34, -12
    };
    ...
    int8_t golden[] = {
    60, 62, 125, 45, 32, 119, 96, 36, 9, 116, 83, 15, 177, 246, 222, 37
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
