...
int main(){
    const uint8_t data1[] = {
    89, 40, 200, 138, 145, 186, 101, 211, 44, 131, 30, 104, 174, 124, 91, 193
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    149, 229, 151, 208, 125, 104, 141, 21, 4, 205, 183, 134, 149, 93, 54, 167
    };
    ...
    uint8_t golden[] = {
    238, 13, 95, 90, 14, 34, 242, 232, 48, 80, 213, 238, 67, 217, 145, 104
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
