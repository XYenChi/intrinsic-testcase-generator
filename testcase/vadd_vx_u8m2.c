...
int main(){
    const int8_t data1[] = {
    58, 204, 133, 120, 155, 52, 101, 42, 117, 176, 133, 87, 152, 68, 127, 16
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    171, 27, 201, 141, 159, 140, 162, 19, 124, 241, 22, 194, 220, 247, 87, 230
    };
    ...
    int8_t golden[] = {
    229, 231, 78, 5, 58, 192, 7, 61, 241, 161, 155, 25, 116, 59, 214, 246
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
