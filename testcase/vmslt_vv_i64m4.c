...
int main(){
    const int64_t data1[] = {
    -34, -126, 92, -113, -27, -41, 119, -103, 79, -6, -70, 101, 111, 55, 65, 122
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    14, 55, 103, 52, -70, -52, -21, -90, -87, -55, -117, -71, 119, 29, -30, 28
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vv_64m4_b16 (data1_v, data2_v, vl);
