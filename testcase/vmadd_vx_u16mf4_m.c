...
int main(){
    ...
    159, 110, 37, 63, 224, 12, 249, 151, 194, 170, 218, 185, 246, 230, 99, 30
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    113, 58, 37, 253, 251, 173, 238, 24, 193, 9, 89, 199, 135, 230, 249, 76
    };
    ...
    uint64_t masked[] = {
    1, 0, 0, 1, 0, 1, 1, 0, 0, 0, 0, 1, 0, 1, 0, 1
    };
    ...
    uint16_t golden[] = {
    272, 110, 37, 253, 224, 185, 238, 151, 194, 170, 218, 384, 246, 460, 99, 106
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
