...
int main(){
    ...
    61, 53, 9, 171, 69, 197, 204, 125, 91, 15, 241, 1, 84, 173, 120, 206
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    237, 5, 246, 178, 162, 66, 14, 229, 246, 244, 94, 195, 70, 147, 17, 121
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_64m4_b16 (data1_v, data2_v, vl);
