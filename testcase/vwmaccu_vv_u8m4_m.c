...
int main(){
    const uint8_t data1[] = {
    11, 97, 69, 14, 197, 127, 235, 40, 234, 224, 35, 40, 92, 210, 176, 118
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    188, 200, 207, 14, 68, 63, 157, 131, 132, 25, 44, 118, 68, 168, 48, 172
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vv_u8m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    1, 200, 1, 196, 0, 0, 0, 0, 168, 0, 5, 1, 0, 209, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
