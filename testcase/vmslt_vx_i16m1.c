...
int main(){
    const int16_t data1[] = {
    108, 21, 1, -67, 33, -46, -74, -118, -54, 99, -18, -109, -24, 4, -73, -127
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -44, 56, -28, 114, -80, 105, -108, 39, 61, -83, 76, 70, 100, -89, 83, 107
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_16m1_b16 (data1_v, data2_v, vl);
