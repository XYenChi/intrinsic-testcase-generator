...
int main(){
    const uint8_t data1[] = {
    251, 119, 200, 60, 153, 184, 193, 60, 143, 240, 98, 169, 153, 62, 162, 122
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    161, 251, 36, 115, 204, 105, 85, 191, 18, 153, 61, 114, 151, 111, 19, 175
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_8m1_b8_m (mask, data1_v, data2_v, vl);
