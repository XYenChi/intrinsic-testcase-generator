...
int main(){
    const int64_t data1[] = {
    57, 52, 115, 107, -19, -81, 36, -120, 88, -25, -6, -34, -123, 82, -77, -90
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -76, -106, 98, 80, -128, 124, -63, -71, -37, -121, -40, -109, 112, 51, -85, -2
    };
    ...
    int64_t golden[] = {
    57, 52, 1, 107, 1, 0, 1, 18446744073709551545, 1, 18446744073709551591, 18446744073709551610, 0, 112, 82, 18446744073709551539, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
