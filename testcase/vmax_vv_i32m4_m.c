...
int main(){
    const int32_t data1[] = {
    -42, -4, -127, 67, 91, -123, -64, 0, 61, -18, -56, -59, -40, -24, -116, -126
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -44, -113, -93, -84, 78, 106, -95, 64, -113, -62, -76, -29, 13, -33, -68, 86
    };
    ...
    int32_t golden[] = {
    0, 0, 4294967203, 1, 91, 0, 1, 64, 0, 4294967278, 4294967240, 1, 13, 4294967272, 4294967228, 86
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
