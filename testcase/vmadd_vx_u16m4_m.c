...
int main(){
    ...
    172, 163, 12, 156, 72, 220, 244, 106, 35, 224, 112, 177, 202, 154, 230, 74
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    251, 48, 114, 7, 35, 132, 134, 179, 193, 76, 224, 108, 170, 22, 28, 104
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmadd_vx_u16m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    251, 163, 12, 156, 35, 132, 244, 106, 193, 224, 224, 108, 372, 154, 28, 74
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
