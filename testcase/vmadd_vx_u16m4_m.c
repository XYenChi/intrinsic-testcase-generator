...
int main(){
    ...
    123, 254, 212, 110, 90, 65, 29, 15, 29, 7, 88, 45, 28, 189, 47, 58
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    108, 205, 47, 110, 38, 165, 163, 107, 194, 58, 76, 91, 29, 236, 176, 235
    };
    ...
    uint16_t golden[] = {
    123, 459, 259, 110, 90, 65, 29, 107, 29, 7, 88, 136, 29, 236, 47, 293
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
