...
int main(){
    const int16_t data1[] = {
    13, -18, 66, 127, -86, -64, 20, -54, 46, -52, 9, 62, 59, 114, -120, 60
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -40, -57, 94, -101, 41, -18, 77, -107, 89, -77, 89, -25, -87, 29, -104, -81
    };
    ...
    int16_t golden[] = {
    65016, 0, 1, 1, 62010, 0, 0, 5778, 0, 4004, 801, 1, 1, 3306, 12480, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
