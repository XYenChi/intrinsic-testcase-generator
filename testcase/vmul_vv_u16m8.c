...
int main(){
    ...
    48, 5, 221, 125, 63, 216, 218, 177, 63, 216, 81, 16, 104, 190, 205, 250
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    135, 240, 36, 220, 249, 196, 242, 63, 196, 45, 150, 170, 34, 77, 180, 6
    };
    ...
    uint16_t golden[] = {
    6480, 1200, 7956, 27500, 15687, 42336, 52756, 11151, 12348, 9720, 12150, 2720, 3536, 14630, 36900, 1500
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
