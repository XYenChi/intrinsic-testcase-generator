...
int main(){
    const int64_t data1[] = {
    -58, -64, -42, 8, -81, -98, 44, 11, -83, 41, 72, -70, -41, -98, -103, -86
    };
    const int64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    160, 175, 7, 68, 173, 249, 203, 100, 11, 86, 193, 71, 111, 71, 158, 87
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_64m2_b32 (mask, data1_v, data2_v, vl);
