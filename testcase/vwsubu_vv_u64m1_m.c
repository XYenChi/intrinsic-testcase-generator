...
int main(){
    ...
    45, 45, 151, 181, 196, 78, 140, 190, 189, 227, 95, 143, 175, 11, 206, 159
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    97, 250, 244, 249, 156, 120, 76, 218, 46, 29, 64, 184, 2, 112, 52, 173
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u64m1_m (mask, data1_v, data2_v, vl);
