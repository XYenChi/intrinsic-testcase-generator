...
int main(){
    const int8_t data1[] = {
    60, 99, -19, -91, 76, -48, -115, 48, -68, -125, -96, 8, 67, -30, -103, 3
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -23, 82, -24, 71, 66, 40, -82, 91, -45, -121, 89, 116, 19, -122, -76, -24
    };
    ...
    int8_t golden[] = {
    157, 183, 200, 196, 153, 129, 215, 16, 244, 21, 161, 160, 250, 77, 149, 185
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
