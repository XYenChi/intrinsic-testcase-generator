...
int main(){
    const int8_t data1[] = {
    70, 116, 76, -62, -76, -3, -110, 8, 11, -85, -54, 1, -35, -68, 81, -60
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    65, -9, -105, 112, 83, -96, -95, 116, 23, -78, -75, -36, 31, 45, 71, -4
    };
    ...
    int8_t golden[] = {
    198, 237, 212, 225, 92, 32, 210, 161, 254, 230, 211, 221, 196, 13, 120, 240
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
