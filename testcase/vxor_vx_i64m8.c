...
int main(){
    const int64_t data1[] = {
    -122, -111, -89, -87, -8, -108, -89, -117, 60, -53, -106, -119, -106, -68, -34, -27
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    60, 105, -126, -64, -75, 77, 90, 19, 115, -75, -119, 69, 79, -64, 84, -105
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_i64m8 (data1_v, data2_v, vl);
