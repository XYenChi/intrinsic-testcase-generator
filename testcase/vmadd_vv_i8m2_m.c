...
int main(){
    const int8_t data1[] = {
    -94, -126, 68, -29, 119, -118, 60, -107, 70, 31, -76, 68, -123, -90, -42, 107
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -87, 107, 90, -4, -101, 46, -54, 53, 107, -118, -36, -65, -101, 44, 75, -105
    };
    ...
    int8_t golden[] = {
    169, 130, 68, 227, 119, 138, 202, 149, 107, 31, 180, 68, 133, 166, 214, 151
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
