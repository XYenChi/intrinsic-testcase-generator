...
int main(){
    const int16_t data1[] = {
    -65, -95, 5, 46, -68, -54, -41, -98, -28, 102, 3, -119, 33, -85, -11, 120
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    68, -108, -38, -61, 89, 77, 69, 42, -17, 23, -51, 25, -109, 75, -103, -127
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vx_16m2_b8_m (mask, data1_v, data2_v, vl);
