...
int main(){
    const int32_t data1[] = {
    -32, -88, -108, 3, 14, -87, -35, 111, -125, 11, 27, -50, 122, 76, -49, 31
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    41, -30, -115, 21, -113, -41, -124, 119, 70, -12, 69, 53, -74, 101, -80, 6
    };
    ...
    int32_t golden[] = {
    1, 0, 12420, 0, 0, 3567, 4340, 1, 4294958546, 4294967164, 1, 4294964646, 4294958268, 1, 3920, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
