...
int main(){
    const uint8_t data1[] = {
    230, 120, 224, 181, 23, 192, 167, 122, 187, 18, 39, 176, 121, 148, 88, 54
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    74, 116, 24, 31, 117, 141, 81, 19, 209, 78, 29, 158, 26, 109, 188, 224
    };
    ...
    uint8_t golden[] = {
    230, 116, 224, 181, 23, 77, 167, 141, 140, 18, 39, 176, 147, 148, 88, 54
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
