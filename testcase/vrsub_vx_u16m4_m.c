...
int main(){
    ...
    79, 168, 214, 162, 28, 7, 227, 76, 85, 135, 43, 56, 215, 100, 88, 88
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    112, 22, 142, 125, 9, 88, 200, 71, 22, 11, 75, 74, 214, 77, 247, 64
    };
    ...
    uint16_t golden[] = {
    1, 1, 1, 0, 65517, 81, 1, 0, 0, 0, 32, 18, 65535, 65513, 1, 65512
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
