...
int main(){
    const int32_t data1[] = {
    -28, 55, -16, -81, 105, -83, -41, 33, -45, -62, 34, -70, -14, -1, 62, 124
    };
    const int32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    30, 231, 119, 156, 114, 2, 153, 124, 190, 215, 61, 134, 169, 162, 113, 51
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_32m1_b32 (data1_v, data2_v, vl);
