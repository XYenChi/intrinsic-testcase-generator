...
int main(){
    ...
    26, 235, 77, 158, 30, 199, 164, 124, 74, 235, 74, 118, 149, 215, 181, 170
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    108, 166, 77, 68, 68, 239, 25, 49, 163, 233, 132, 117, 122, 48, 142, 223
    };
    ...
    uint16_t golden[] = {
    0, 0, 0, 1, 0, 1, 0, 124, 74, 0, 0, 118, 27, 167, 1, 170
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
