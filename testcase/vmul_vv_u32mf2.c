...
int main(){
    ...
    196, 59, 99, 214, 72, 124, 93, 106, 239, 114, 102, 163, 251, 234, 235, 16
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    71, 224, 7, 166, 254, 169, 84, 63, 81, 154, 78, 180, 240, 182, 177, 20
    };
    ...
    uint32_t golden[] = {
    13916, 13216, 693, 35524, 18288, 20956, 7812, 6678, 19359, 17556, 7956, 29340, 60240, 42588, 41595, 320
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
