...
int main(){
    ...
    79, 209, 245, 238, 218, 164, 70, 74, 21, 3, 150, 145, 219, 180, 36, 120
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    27, 10, 31, 25, 255, 212, 159, 139, 50, 100, 89, 229, 93, 178, 41, 219
    };
    ...
    uint32_t golden[] = {
    2133, 2090, 7595, 5950, 55590, 34768, 11130, 10286, 1050, 300, 13350, 33205, 20367, 32040, 1476, 26280
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
