...
int main(){
    const uint8_t data1[] = {
    144, 62, 110, 84, 6, 19, 144, 30, 176, 63, 3, 120, 190, 136, 10, 159
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    175, 129, 135, 124, 150, 157, 202, 177, 50, 17, 70, 232, 74, 60, 247, 131
    };
    ...
    uint8_t golden[] = {
    225, 189, 231, 216, 112, 118, 198, 109, 126, 46, 189, 144, 116, 76, 19, 28
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
