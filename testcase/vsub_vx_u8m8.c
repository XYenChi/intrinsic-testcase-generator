...
int main(){
    const uint8_t data1[] = {
    130, 202, 36, 121, 241, 77, 19, 226, 13, 229, 27, 166, 235, 41, 6, 183
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    206, 31, 169, 208, 12, 215, 93, 147, 12, 126, 72, 38, 188, 136, 81, 96
    };
    ...
    uint8_t golden[] = {
    180, 171, 123, 169, 229, 118, 182, 79, 1, 103, 211, 128, 47, 161, 181, 87
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
