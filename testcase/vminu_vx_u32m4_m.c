...
int main(){
    ...
    114, 76, 241, 235, 246, 135, 86, 89, 238, 94, 249, 117, 69, 183, 90, 137
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    107, 104, 141, 103, 125, 35, 57, 105, 182, 186, 87, 142, 139, 70, 123, 230
    };
    ...
    uint32_t golden[] = {
    114, 1, 0, 235, 246, 1, 1, 105, 238, 186, 249, 142, 139, 183, 123, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
