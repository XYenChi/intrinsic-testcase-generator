...
int main(){
    const uint8_t data1[] = {
    8, 191, 52, 93, 239, 21, 104, 174, 53, 88, 14, 33, 183, 249, 36, 31
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    10, 129, 171, 220, 199, 156, 144, 133, 76, 25, 179, 193, 96, 16, 220, 202
    };
    ...
    uint8_t golden[] = {
    10, 191, 171, 220, 239, 156, 144, 174, 76, 88, 179, 193, 183, 249, 220, 202
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
