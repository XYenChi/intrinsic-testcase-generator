...
int main(){
    const uint8_t data1[] = {
    169, 103, 69, 16, 94, 87, 19, 50, 1, 146, 178, 40, 93, 79, 2, 70
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    8, 76, 146, 229, 88, 19, 217, 138, 184, 21, 220, 55, 160, 28, 156, 213
    };
    ...
    uint8_t golden[] = {
    169, 103, 146, 229, 94, 87, 217, 138, 184, 146, 220, 55, 160, 79, 156, 213
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
