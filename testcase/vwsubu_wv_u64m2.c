...
int main(){
    ...
    32, 108, 36, 85, 1, 215, 119, 198, 24, 28, 139, 130, 252, 199, 164, 94
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    24, 20, 72, 56, 42, 25, 77, 152, 239, 139, 105, 83, 229, 17, 81, 87
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u64m2 (data1_v, data2_v, vl);
