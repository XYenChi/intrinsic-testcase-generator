...
int main(){
    ...
    110, 207, 231, 33, 23, 110, 189, 216, 189, 54, 87, 139, 61, 125, 11, 215
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    216, 76, 171, 123, 130, 236, 149, 149, 155, 145, 156, 69, 112, 138, 164, 136
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_16m2_b8 (data1_v, data2_v, vl);
