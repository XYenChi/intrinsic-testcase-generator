...
int main(){
    ...
    89, 143, 204, 86, 43, 52, 192, 211, 1, 187, 148, 116, 181, 53, 173, 208
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    219, 217, 197, 1, 225, 244, 193, 245, 167, 175, 100, 126, 184, 72, 167, 158
    };
    ...
    uint32_t golden[] = {
    0, 360, 401, 87, 268, 1, 385, 456, 168, 1, 1, 1, 365, 0, 340, 366
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
