...
int main(){
    const int16_t data1[] = {
    19, -120, 116, 59, 89, 58, 111, 92, 71, -116, 80, 78, -6, -50, 118, 126
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -99, -90, -79, -15, -117, -40, 16, -90, 51, -87, 121, -74, -104, 127, -43, -78
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vv_16m1_b16_m (mask, data1_v, data2_v, vl);
