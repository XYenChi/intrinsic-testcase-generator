...
int main(){
    ...
    21, 145, 15, 244, 164, 141, 120, 245, 171, 233, 82, 132, 76, 188, 49, 112
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    20, 251, 212, 197, 113, 116, 33, 30, 194, 26, 43, 139, 33, 132, 22, 55
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_64m1_b64 (data1_v, data2_v, vl);
