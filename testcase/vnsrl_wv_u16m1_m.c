...
int main(){
    ...
    90, 133, 8, 195, 111, 28, 80, 54, 5, 97, 247, 78, 212, 48, 237, 153
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    73, 96, 186, 12, 248, 223, 139, 195, 110, 211, 169, 129, 124, 17, 107, 201
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_16m1_m (mask, data1_v, shift, vl);
