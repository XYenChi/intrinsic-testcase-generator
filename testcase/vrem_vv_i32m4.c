...
int main(){
    const int32_t data1[] = {
    78, 109, 24, 74, -111, -60, -38, 86, -120, 60, 52, -43, 59, -95, 59, 111
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -94, -55, 110, -30, -19, 107, 104, -106, -24, 78, 49, -72, -35, -108, 7, -28
    };
    ...
    int32_t golden[] = {
    62, 54, 14, 44, 4294967277, 4294967283, 4294967286, 66, 4294967272, 18, 49, 4294967267, 24, 4294967283, 7, 83
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
