...
int main(){
    ...
    121, 142, 21, 94, 26, 99, 225, 235, 3, 31, 25, 231, 137, 234, 177, 68
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    65, 207, 139, 159, 172, 105, 153, 4, 73, 241, 105, 242, 253, 124, 52, 91
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_16m4_b4 (data1_v, data2_v, vl);
