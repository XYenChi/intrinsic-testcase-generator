...
int main(){
    const int8_t data1[] = {
    37, 125, -24, 13, -28, -16, -56, -60, -68, 68, 117, -116, 74, -39, -15, -86
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -59, 48, -74, 2, 95, -76, -80, 90, -30, -106, -99, -105, -94, 37, 101, 58
    };
    ...
    int8_t golden[] = {
    -74, 153, 75, -50, -125, 9, -166, -67, -173, 93, 34, -224, 102, -65, 29, -43
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
