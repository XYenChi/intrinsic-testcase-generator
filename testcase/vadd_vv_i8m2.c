...
int main(){
    const int8_t data1[] = {
    -125, 92, -90, 116, 26, 74, 37, -121, -126, -39, -49, -43, 46, 73, -58, 68
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -19, -20, 119, -80, 74, 126, 105, -61, -126, -127, 30, -26, -44, 103, 117, 27
    };
    ...
    int8_t golden[] = {
    112, 72, 29, 36, 100, 200, 142, 74, 4, 90, 237, 187, 2, 176, 59, 95
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
