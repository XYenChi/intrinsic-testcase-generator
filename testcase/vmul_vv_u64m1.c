...
int main(){
    ...
    105, 53, 61, 133, 242, 75, 30, 144, 119, 172, 148, 72, 15, 19, 1, 204
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    252, 161, 131, 155, 230, 203, 253, 41, 144, 184, 124, 105, 187, 155, 133, 196
    };
    ...
    uint64_t golden[] = {
    26460, 8533, 7991, 20615, 55660, 15225, 7590, 5904, 17136, 31648, 18352, 7560, 2805, 2945, 133, 39984
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
