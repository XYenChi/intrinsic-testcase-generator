...
int main(){
    const int64_t data1[] = {
    9, 55, 39, 29, 7, 182, 87, 38, 241, 147, 109, 15, 170, 129, 200, 178
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    55, 243, 56, 20, 81, 50, 128, 146, 55, 89, 166, 128, 141, 39, 177, 97
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vv_ui64m4 (data1_v, data2_v, vl);
    ...
    int64_t golden[] = {
    0, 0, 0, 9, 0, 132, 0, 0, 186, 58, 0, 0, 29, 90, 23, 81
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
