...
int main(){
    const uint8_t data1[] = {
    198, 76, 31, 89, 182, 19, 127, 104, 102, 238, 126, 152, 136, 172, 134, 133
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    79, 177, 113, 149, 195, 39, 228, 164, 16, 207, 168, 79, 168, 212, 204, 25
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vx_8m1_b8 (data1_v, data2_v, vl);
