...
int main(){
    ...
    230, 120, 88, 106, 188, 244, 28, 52, 53, 174, 59, 34, 255, 72, 41, 116
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    140, 27, 98, 181, 219, 249, 74, 123, 126, 189, 19, 150, 222, 156, 45, 142
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u64m8 (data1_v, data2_v, vl);
