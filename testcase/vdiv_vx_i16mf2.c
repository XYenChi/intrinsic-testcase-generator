...
int main(){
    const int16_t data1[] = {
    32, -112, -51, 6, 70, 81, -114, 2, 116, -41, -109, 109, 60, 68, -101, -126
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -108, -94, -91, -52, 17, 55, -84, -91, -108, 6, 85, -38, -16, -126, -49, -43
    };
    ...
    int16_t golden[] = {
    65532, 0, 1, 65527, 0, 0, 0, 65490, 65535, 65535, 65535, 65535, 65535, 65534, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
