...
int main(){
    const uint8_t data1[] = {
    216, 133, 109, 86, 153, 191, 125, 68, 216, 80, 164, 39, 2, 150, 75, 112
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    173, 162, 138, 183, 167, 106, 191, 57, 211, 42, 162, 214, 14, 138, 214, 246
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i8m1 (data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 1, 1, 2, 1, 0, 1, 0, 0, 0, 0, 5, 7, 0, 2, 2
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
