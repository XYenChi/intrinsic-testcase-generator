...
int main(){
    const uint8_t data1[] = {
    26, 72, 158, 20, 154, 173, 137, 247, 191, 11, 4, 236, 160, 151, 120, 157
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnot_v_u8mf2 (data1_v, vl);
    ...
    uint8_t golden[] = {
    -27, -73, -159, -21, -155, -174, -138, -248, -192, -12, -5, -237, -161, -152, -121, -158
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
