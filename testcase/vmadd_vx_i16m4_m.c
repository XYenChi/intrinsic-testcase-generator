...
int main(){
    const int16_t data1[] = {
    110, 32, 123, -20, -24, -12, -65, 121, 122, -38, -7, -74, 68, 63, 55, -32
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -111, -110, -102, -37, -36, 82, -114, -76, -59, 22, -27, -124, 106, 93, 111, 63
    };
    ...
    int16_t golden[] = {
    65535, 65458, 123, 65499, 65500, 82, 65422, 45, 122, 65498, 65529, 65462, 68, 63, 111, 65504
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
