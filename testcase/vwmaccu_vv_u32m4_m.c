...
int main(){
    ...
    200, 204, 247, 147, 159, 176, 50, 251, 30, 77, 108, 99, 47, 149, 235, 217
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    38, 61, 184, 242, 127, 20, 167, 181, 46, 127, 45, 77, 70, 90, 0, 113
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vv_u32m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    7600, 12444, 45448, 0, 1, 1, 0, 0, 1380, 9780, 4860, 7624, 3291, 1, 0, 24521
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
