...
int main(){
    const int32_t data1[] = {
    70, -28, -14, 83, -15, -128, -63, 107, -52, -92, -93, 86, 12, -37, 114, -83
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    54, -105, -71, -112, 9, -34, -108, -14, 11, -42, 45, -30, -78, 5, -117, 108
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vx_32m2_b16 (mask, data1_v, data2_v, vl);
