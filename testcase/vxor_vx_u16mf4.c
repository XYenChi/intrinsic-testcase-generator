...
int main(){
    ...
    10, 121, 6, 235, 243, 141, 149, 145, 169, 51, 106, 193, 114, 2, 185, 17
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    160, 58, 87, 186, 178, 1, 125, 161, 91, 118, 16, 63, 36, 123, 173, 152
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u16mf4 (data1_v, data2_v, vl);
