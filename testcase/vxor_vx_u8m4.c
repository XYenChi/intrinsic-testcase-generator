...
int main(){
    const uint8_t data1[] = {
    102, 70, 48, 252, 252, 140, 5, 167, 242, 148, 101, 240, 193, 81, 7, 62
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    95, 3, 238, 188, 144, 33, 162, 247, 218, 164, 63, 44, 78, 188, 124, 205
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u8m4 (data1_v, data2_v, vl);
