...
int main(){
    const int64_t data1[] = {
    -68, -124, -73, 16, 3, 50, -101, 102, -86, -106, -23, -79, -41, 35, 73, -21
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    78, 118, -105, 103, -41, 59, -108, 65, -18, 79, 102, 56, 70, 110, -41, -95
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vv_64m8_b8 (data1_v, data2_v, vl);
