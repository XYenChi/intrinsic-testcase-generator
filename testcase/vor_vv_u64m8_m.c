...
int main(){
    ...
    171, 146, 160, 98, 108, 108, 51, 230, 68, 238, 227, 86, 96, 10, 17, 82
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    63, 108, 166, 134, 3, 42, 149, 124, 30, 112, 64, 152, 152, 185, 172, 181
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wv_64m8u_m (mask, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    191, 1, 166, 1, 111, 1, 1, 0, 94, 1, 0, 1, 248, 187, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
