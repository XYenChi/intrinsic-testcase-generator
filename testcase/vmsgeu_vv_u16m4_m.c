...
int main(){
    ...
    99, 136, 95, 0, 140, 214, 134, 167, 110, 106, 28, 200, 241, 100, 42, 202
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    125, 73, 34, 235, 66, 93, 26, 178, 192, 108, 5, 177, 23, 83, 173, 30
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_16m4_b4 (mask, data1_v, data2_v, vl);
