...
int main(){
    ...
    107, 20, 209, 46, 120, 232, 196, 236, 255, 86, 5, 111, 165, 67, 113, 210
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    143, 223, 170, 135, 176, 27, 213, 109, 44, 64, 24, 24, 127, 182, 187, 54
    };
    ...
    uint32_t golden[] = {
    36, 203, 4294967257, 89, 56, 4294967091, 17, 4294967169, 4294967085, 4294967274, 19, 4294967209, 4294967258, 115, 74, 4294967140
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
