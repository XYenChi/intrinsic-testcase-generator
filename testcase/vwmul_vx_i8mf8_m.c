...
int main(){
    const int8_t data1[] = {
    107, -123, -9, 68, -38, -99, -98, 29, -107, 82, -11, 107, 20, 87, -74, 88
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    -99, -99, 17, 8, 113, -97, -4, 9, -126, -83, 98, 39, -121, -53, -16, -113
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmul_vx_i8mf8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    0, 0, 103, 32, 58, 131, 1, 1, 1, 106, 0, 77, 140, 1, 160, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
