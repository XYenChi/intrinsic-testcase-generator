...
int main(){
    const int8_t data1[] = {
    105, -62, 30, -80, 32, -15, 80, -89, -41, -9, -10, 103, 94, 126, 111, 29
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -25, -5, 78, -72, -13, 26, -57, -48, -10, 54, -112, -78, 116, 50, 33, -79
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vv_8m2_b4 (mask, data1_v, data2_v, vl);
