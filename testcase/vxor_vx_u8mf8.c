...
int main(){
    const uint8_t data1[] = {
    66, 60, 164, 88, 1, 126, 162, 8, 28, 123, 21, 245, 27, 116, 219, 102
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    198, 64, 1, 232, 21, 4, 192, 78, 43, 127, 215, 195, 193, 80, 238, 56
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u8mf8 (data1_v, data2_v, vl);
