...
int main(){
    const int8_t data1[] = {
    -125, -38, -114, 96, -70, -21, -41, -109, 68, -108, 53, 82, -9, -108, 121, 3
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -114, 40, -5, 82, 116, 12, -35, -103, -112, -12, 5, 92, 16, -16, -114, -120
    };
    ...
    int8_t golden[] = {
    170, 16, 58, 192, 72, 4, 155, 219, 64, 16, 9, 120, 112, 192, 30, 152
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
