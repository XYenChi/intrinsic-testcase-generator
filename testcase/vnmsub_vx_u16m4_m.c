...
int main(){
    ...
    130, 238, 223, 147, 52, 113, 43, 216, 115, 74, 94, 125, 108, 6, 64, 117
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    231, 82, 239, 150, 202, 191, 142, 131, 249, 196, 36, 169, 239, 117, 68, 179
    };
    ...
    uint16_t golden[] = {
    0, 1, 65520, 65533, 65386, 113, 43, 0, 65402, 1, 94, 0, 1, 65425, 64, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
