...
int main(){
    ...
    148, 79, 100, 149, 187, 50, 104, 205, 4, 92, 47, 80, 203, 143, 164, 153
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    227, 148, 164, 223, 155, 141, 137, 239, 212, 17, 221, 29, 155, 153, 43, 79
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_32m1_b32 (data1_v, data2_v, vl);
