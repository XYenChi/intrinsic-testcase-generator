...
int main(){
    ...
    29, 159, 34, 16, 229, 162, 223, 105, 149, 43, 227, 250, 170, 238, 197, 137
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    30, 211, 55, 57, 28, 32, 76, 49, 182, 185, 146, 168, 170, 212, 38, 56
    };
    ...
    uint32_t golden[] = {
    59, 370, 90, 73, 258, 194, 299, 155, 332, 228, 373, 418, 340, 451, 235, 193
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
