...
int main(){
    const uint8_t data1[] = {
    47, 95, 47, 250, 25, 121, 136, 106, 218, 152, 3, 67, 130, 89, 212, 126
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    85, 226, 126, 118, 13, 101, 235, 82, 204, 252, 229, 168, 24, 244, 234, 194
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u8m8 (data1_v, data2_v, vl);
