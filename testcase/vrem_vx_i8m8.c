...
int main(){
    const int8_t data1[] = {
    64, 252, 57, 137, 83, 128, 211, 196, 201, 241, 62, 24, 206, 117, 162, 57
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    202, 31, 65, 5, 38, 10, 164, 177, 194, 36, 5, 6, 142, 105, 146, 76
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vrem_vx_i8m8 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    10, 31, 8, 5, 38, 10, 164, 177, 194, 36, 5, 6, 142, 105, 146, 19
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
