...
int main(){
    const int16_t data1[] = {
    27, 15, 7, 8, 102, -73, -88, 81, 121, -73, -57, 32, -33, -25, 20, -48
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -15, -79, 126, 80, 45, -31, 27, 37, -23, 123, -120, -11, -47, 34, 7, -101
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vv_16mf4_b64 (mask, data1_v, data2_v, vl);
