...
int main(){
    const uint8_t data1[] = {
    59, 149, 60, 41, 50, 155, 44, 220, 190, 124, 116, 127, 213, 212, 83, 213
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    196, 42, 125, 230, 54, 179, 193, 196, 28, 55, 4, 117, 222, 197, 36, 126
    };
    ...
    uint8_t golden[] = {
    0, 0, 1, 214, 140, 97, 1, 112, 200, 0, 0, 11, 1, 36, 0, 214
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
