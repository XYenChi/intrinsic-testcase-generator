...
int main(){
    const int16_t data1[] = {
    10, -123, 33, 10, -9, -4, -109, 14, 80, 35, 40, -24, 119, -72, -28, 32
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    197, 168, 117, 181, 166, 129, 19, 195, 79, 91, 237, 244, 0, 243, 172, 230
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_16mf4_b64 (data1_v, data2_v, vl);
