...
int main(){
    const int16_t data1[] = {
    -41, 29, 75, -124, -65, -81, 117, -56, 124, 104, 13, -17, -109, 127, 57, -20
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    111, 67, -79, 123, -116, 113, 78, -53, 105, -35, 4, -34, 25, 104, 126, 85
    };
    ...
    int16_t golden[] = {
    111, 1, 75, 1, 65471, 0, 0, 65483, 0, 1, 13, 65519, 0, 127, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
