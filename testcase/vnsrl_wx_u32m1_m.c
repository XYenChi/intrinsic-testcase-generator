...
int main(){
    ...
    164, 93, 142, 17, 128, 9, 39, 166, 39, 202, 164, 107, 212, 146, 48, 202
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    72, 246, 6, 252, 102, 130, 215, 99, 227, 4, 236, 14, 140, 121, 166, 135
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_32m1_m (mask, data1_v, shift, vl);
