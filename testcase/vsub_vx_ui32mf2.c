...
int main(){
    const int32_t data1[] = {
    113, 22, 156, 33, 34, 194, 217, 165, 109, 82, 249, 85, 114, 160, 83, 233
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    214, 144, 222, 247, 16, 137, 240, 69, 94, 190, 149, 240, 102, 124, 163, 202
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vx_ui32mf2 (data1_v, data2_v, vl);
    ...
    int32_t golden[] = {
    0, 0, 0, 0, 18, 57, 0, 96, 15, 0, 100, 0, 12, 36, 0, 31
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
