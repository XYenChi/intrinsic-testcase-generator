...
int main(){
    const uint8_t data1[] = {
    87, 22, 158, 117, 114, 40, 148, 71, 139, 185, 196, 148, 39, 151, 14, 219
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    36, 46, 249, 135, 244, 247, 212, 23, 177, 175, 197, 211, 115, 81, 154, 75
    };
    ...
    uint8_t golden[] = {
    60, 244, 174, 179, 168, 152, 144, 97, 27, 119, 212, 252, 133, 199, 108, 41
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
