...
int main(){
    const uint8_t data1[] = {
    107, 0, 90, 223, 133, 19, 71, 71, 174, 2, 44, 86, 49, 247, 22, 251
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    192, 38, 155, 48, 37, 49, 205, 69, 83, 147, 89, 114, 215, 138, 245, 190
    };
    ...
    uint8_t golden[] = {
    64, 0, 126, 208, 57, 163, 219, 35, 106, 38, 76, 76, 39, 38, 14, 74
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
