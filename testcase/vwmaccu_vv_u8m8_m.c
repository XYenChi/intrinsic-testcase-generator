...
int main(){
    const uint8_t data1[] = {
    33, 56, 209, 129, 251, 94, 183, 14, 229, 23, 170, 254, 25, 56, 182, 59
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    42, 209, 49, 167, 24, 208, 38, 189, 111, 65, 28, 145, 179, 49, 150, 149
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vv_u8m8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    106, 1, 0, 40, 1, 1, 0, 87, 0, 0, 1, 0, 0, 184, 0, 87
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
