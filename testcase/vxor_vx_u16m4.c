...
int main(){
    ...
    28, 8, 197, 191, 79, 232, 201, 113, 108, 82, 176, 186, 172, 204, 248, 74
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    54, 20, 186, 119, 252, 87, 68, 5, 173, 161, 19, 224, 135, 207, 191, 87
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u16m4 (data1_v, data2_v, vl);
