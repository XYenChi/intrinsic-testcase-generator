...
int main(){
    ...
    191, 249, 48, 20, 227, 120, 114, 55, 47, 169, 201, 93, 89, 81, 246, 42
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    106, 36, 162, 25, 93, 236, 110, 102, 207, 144, 15, 191, 146, 149, 237, 31
    };
    ...
    uint64_t golden[] = {
    191, 249, 162, 25, 227, 236, 114, 102, 207, 169, 201, 191, 146, 149, 246, 42
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
