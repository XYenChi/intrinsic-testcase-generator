...
int main(){
    ...
    139, 127, 24, 122, 150, 45, 3, 80, 221, 105, 113, 13, 140, 245, 127, 6
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    46, 131, 97, 64, 202, 118, 164, 157, 34, 199, 200, 35, 179, 101, 0, 151
    };
    ...
    uint64_t golden[] = {
    139, 131, 97, 122, 202, 118, 164, 157, 221, 199, 200, 35, 179, 245, 127, 151
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
