...
int main(){
    const uint8_t data1[] = {
    18, 4, 105, 59, 34, 69, 168, 181, 121, 90, 167, 13, 83, 253, 140, 148
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    15, 244, 226, 127, 200, 71, 222, 14, 69, 156, 38, 234, 141, 160, 124, 100
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u8mf4 (data1_v, data2_v, vl);
