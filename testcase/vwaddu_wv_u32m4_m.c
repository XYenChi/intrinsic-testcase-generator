...
int main(){
    ...
    90, 136, 151, 4, 122, 26, 42, 245, 217, 140, 98, 177, 38, 16, 167, 96
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    251, 244, 41, 230, 115, 249, 56, 109, 14, 87, 74, 91, 156, 247, 10, 107
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u32m4_m (mask, data1_v, data2_v, vl);
