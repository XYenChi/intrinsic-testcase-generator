...
int main(){
    const uint8_t data1[] = {
    67, 174, 173, 245, 171, 15, 35, 40, 36, 180, 133, 88, 66, 69, 105, 123
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    87, 209, 231, 34, 199, 45, 41, 200, 68, 176, 241, 41, 199, 190, 33, 236
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_8m1 (data1_v, shift, vl);
