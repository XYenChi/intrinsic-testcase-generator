...
int main(){
    const int64_t data1[] = {
    77, -69, 99, 58, -80, 26, 51, 75, -126, -98, -13, -31, -102, 72, -78, -42
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    35, -77, -74, 104, 65, -38, 121, -50, 43, 10, 20, 108, 100, 68, 68, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vx_64m1_b64_m (mask, data1_v, data2_v, vl);
