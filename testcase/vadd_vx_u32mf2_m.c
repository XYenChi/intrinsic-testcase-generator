...
int main(){
    ...
    254, 31, 247, 17, 184, 129, 218, 146, 228, 174, 157, 16, 79, 92, 64, 52
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    44, 58, 205, 81, 231, 112, 232, 50, 4, 193, 104, 124, 183, 87, 22, 127
    };
    ...
    uint32_t golden[] = {
    1, 1, 452, 98, 0, 241, 1, 196, 232, 367, 261, 140, 262, 179, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
