...
int main(){
    const uint8_t data1[] = {
    92, 27, 5, 28, 74, 133, 1, 99, 49, 182, 132, 58, 131, 39, 35, 11
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    202, 240, 242, 238, 180, 4, 215, 10, 22, 23, 146, 172, 231, 213, 63, 95
    };
    ...
    uint8_t golden[] = {
    294, 267, 248, 266, 255, 137, 216, 109, 71, 205, 279, 230, 363, 252, 98, 107
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
