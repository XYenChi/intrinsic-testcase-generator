...
int main(){
    const uint8_t data1[] = {
    7, 81, 19, 32, 232, 36, 135, 228, 231, 17, 135, 189, 94, 37, 175, 236
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    223, 37, 233, 118, 120, 255, 165, 85, 25, 4, 233, 109, 194, 29, 161, 255
    };
    ...
    uint8_t golden[] = {
    230, 118, 252, 150, 353, 292, 300, 313, 257, 21, 368, 299, 289, 66, 337, 492
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
