...
int main(){
    ...
    92, 38, 208, 9, 167, 227, 226, 70, 126, 64, 132, 64, 207, 213, 235, 148
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    137, 178, 235, 228, 43, 223, 46, 78, 205, 133, 110, 102, 79, 96, 176, 78
    };
    ...
    uint16_t golden[] = {
    137, 178, 235, 228, 167, 227, 226, 78, 205, 133, 132, 102, 207, 213, 235, 148
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
