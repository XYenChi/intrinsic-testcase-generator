...
int main(){
    ...
    208, 19, 123, 111, 60, 132, 135, 129, 202, 151, 118, 192, 45, 162, 223, 85
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    50, 198, 86, 90, 195, 90, 121, 9, 207, 155, 64, 104, 16, 80, 203, 205
    };
    ...
    uint16_t golden[] = {
    208, 198, 123, 111, 195, 132, 135, 129, 207, 155, 118, 192, 45, 162, 223, 205
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
