...
int main(){
    const int8_t data1[] = {
    72, 228, 91, 48, 10, 127, 10, 204, 3, 46, 143, 248, 65, 208, 57, 60
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    152, 93, 112, 182, 106, 205, 211, 213, 194, 75, 117, 186, 21, 99, 106, 186
    };
    ...
    int8_t golden[] = {
    72, 93, 91, 182, 106, 127, 10, 213, 3, 75, 117, 248, 21, 99, 106, 186
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
