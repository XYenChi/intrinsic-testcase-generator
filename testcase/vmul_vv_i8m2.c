...
int main(){
    const int8_t data1[] = {
    47, -73, -45, -37, 106, -94, 75, -27, 49, 110, -123, 117, 5, -60, 8, -123
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -6, 55, -14, 16, 57, -118, -80, 51, -58, -85, -39, 122, -71, 65, -37, -51
    };
    ...
    int8_t golden[] = {
    230, 81, 118, 176, 154, 84, 144, 159, 230, 122, 189, 194, 157, 196, 216, 129
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
