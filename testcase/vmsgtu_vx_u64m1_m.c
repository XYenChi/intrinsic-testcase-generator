...
int main(){
    ...
    45, 31, 134, 54, 96, 3, 11, 59, 102, 31, 64, 81, 106, 28, 233, 209
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    214, 5, 106, 26, 48, 85, 59, 228, 8, 217, 83, 80, 198, 152, 52, 19
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_64m1_b64_m (mask, data1_v, data2_v, vl);
