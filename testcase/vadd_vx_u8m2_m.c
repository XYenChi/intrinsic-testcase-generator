...
int main(){
    const uint8_t data1[] = {
    144, 209, 205, 162, 216, 138, 244, 210, 202, 28, 148, 127, 219, 127, 111, 206
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    221, 188, 64, 250, 130, 75, 49, 182, 175, 17, 196, 44, 29, 60, 134, 255
    };
    ...
    uint8_t golden[] = {
    109, 0, 13, 0, 90, 1, 37, 1, 121, 0, 1, 171, 0, 187, 245, 205
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
