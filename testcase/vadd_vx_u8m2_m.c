...
int main(){
    const uint8_t data1[] = {
    117, 24, 56, 219, 107, 1, 100, 108, 136, 128, 24, 20, 213, 241, 236, 82
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    213, 132, 144, 72, 205, 241, 200, 200, 178, 133, 140, 204, 59, 236, 252, 196
    };
    ...
    uint8_t golden[] = {
    74, 0, 200, 0, 56, 242, 0, 0, 0, 1, 164, 1, 16, 0, 1, 22
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
