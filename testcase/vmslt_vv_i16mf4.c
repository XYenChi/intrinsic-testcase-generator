...
int main(){
    const int16_t data1[] = {
    -125, 117, 124, 29, -100, -60, 124, -91, 124, 57, -45, 27, 32, 95, -79, -10
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    115, -85, -9, -35, -38, 70, -96, -20, 39, -128, 51, -125, -76, 15, -92, 102
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vv_16mf4_b64 (data1_v, data2_v, vl);
