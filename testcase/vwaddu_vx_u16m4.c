...
int main(){
    ...
    86, 189, 3, 80, 94, 87, 58, 227, 137, 23, 77, 94, 239, 43, 69, 71
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    225, 21, 222, 92, 105, 174, 191, 126, 22, 108, 213, 225, 184, 121, 124, 8
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u16m4 (data1_v, data2_v, vl);
