...
int main(){
    const uint8_t data1[] = {
    204, 109, 59, 123, 248, 223, 108, 232, 45, 140, 255, 227, 234, 108, 86, 96
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    151, 73, 102, 208, 210, 251, 55, 55, 68, 221, 144, 152, 10, 239, 251, 109
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u8m2 (data1_v, shift, vl);
