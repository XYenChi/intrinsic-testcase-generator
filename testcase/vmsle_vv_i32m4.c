...
int main(){
    const int32_t data1[] = {
    72, 66, 86, -107, 9, 79, -111, 34, -8, 123, 88, -96, 70, -9, -105, 26
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    93, -124, 127, -81, 87, -86, -29, -122, -126, -108, -126, -111, 83, 36, 106, -61
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vv_32m4_b8 (data1_v, data2_v, vl);
    ...
    int32_t golden[] = {
    1, 0, 1, 1, 1, 0, 1, 0, 0, 0, 0, 0, 1, 1, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
