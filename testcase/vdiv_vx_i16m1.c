...
int main(){
    const int16_t data1[] = {
    -109, 82, -21, -68, -66, 113, -128, -42, 127, 106, -80, -33, 22, 109, -27, 125
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -19, -67, 127, 91, -98, -78, 86, -72, -16, -35, -12, 111, -4, -102, 11, 87
    };
    ...
    int16_t golden[] = {
    0, 65535, 65529, 65534, 1, 65535, 65535, 1, 65535, 65535, 0, 65532, 65535, 65535, 65535, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
