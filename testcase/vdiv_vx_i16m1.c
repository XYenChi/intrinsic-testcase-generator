...
int main(){
    const int16_t data1[] = {
    -115, -4, -58, 64, 115, -108, -4, 48, -25, 49, -73, 72, -79, -29, -65, 73
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    90, -19, -128, -97, -16, -61, 112, 110, 117, 3, -87, 51, 77, 2, -16, 24
    };
    ...
    int16_t golden[] = {
    65535, 4, 2, 65534, 65535, 0, 65508, 2, 65531, 0, 1, 0, 65535, 65535, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
