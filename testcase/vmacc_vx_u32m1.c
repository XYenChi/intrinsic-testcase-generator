...
int main(){
    ...
    130, 238, 178, 130, 94, 25, 65, 85, 131, 97, 65, 73, 114, 153, 124, 139
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    254, 55, 158, 147, 49, 104, 172, 169, 173, 118, 196, 6, 59, 191, 42, 87
    };
    ...
    uint32_t golden[] = {
    33020, 13091, 28125, 19110, 4607, 2600, 11180, 14365, 22663, 11447, 12741, 438, 6727, 29223, 5209, 12094
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
