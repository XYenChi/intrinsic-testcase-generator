...
int main(){
    ...
    51, 232, 190, 177, 211, 67, 105, 200, 180, 142, 108, 147, 93, 212, 36, 237
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    63, 120, 223, 234, 27, 182, 84, 141, 108, 67, 24, 142, 44, 97, 145, 169
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u16m4 (data1_v, shift, vl);
