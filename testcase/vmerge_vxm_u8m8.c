...
int main(){
    const int8_t data1[] = {
    100, 30, 239, 165, 161, 1, 237, 9, 220, 58, 57, 75, 104, 24, 187, 209
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    214, 112, 22, 224, 252, 55, 191, 61, 219, 189, 222, 192, 221, 118, 12, 129
    };
    ...
    int8_t golden[] = {
    214, 112, 239, 165, 161, 55, 191, 9, 220, 189, 57, 192, 221, 24, 187, 129
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
