...
int main(){
    const uint8_t data1[] = {
    84, 235, 33, 91, 31, 165, 76, 190, 147, 85, 80, 114, 116, 120, 66, 115
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    77, 84, 45, 68, 184, 59, 194, 42, 231, 208, 235, 174, 132, 101, 107, 138
    };
    ...
    uint8_t golden[] = {
    84, 84, 33, 68, 31, 59, 76, 190, 147, 85, 80, 174, 116, 120, 107, 138
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
