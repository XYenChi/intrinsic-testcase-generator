...
int main(){
    const int16_t data1[] = {
    59, -103, 111, -48, -103, 42, -111, 43, 33, -89, -61, -36, 40, 31, 112, 45
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    22, 232, 75, 25, 195, 136, 160, 134, 76, 13, 193, 83, 227, 76, 116, 184
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_16m4_b4 (data1_v, data2_v, vl);
