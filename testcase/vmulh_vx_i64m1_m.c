...
int main(){
    const int64_t data1[] = {
    -109, -122, 125, -92, 5, -4, 24, -59, -76, -46, -10, 11, -7, -113, -43, -86
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -58, -32, 90, -96, 98, -108, 70, -49, 104, 58, 113, 123, 113, -30, 0, -50
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vx_64m1_b64 (mask, data1_v, data2_v, vl);
