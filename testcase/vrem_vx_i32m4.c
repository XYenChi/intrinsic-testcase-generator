...
int main(){
    const int32_t data1[] = {
    12, 113, -69, 114, 126, 62, 120, 24, -29, -43, 33, -31, -39, 15, -70, -26
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -72, 14, 86, -109, -110, 76, -87, -95, 29, 25, 108, -82, 3, 28, -45, 28
    };
    ...
    int32_t golden[] = {
    0, 14, 4294967244, 5, 16, 14, 33, 1, 0, 4294967278, 9, 4294967276, 4294967260, 13, 4294967251, 4294967272
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
