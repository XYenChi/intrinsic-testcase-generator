...
int main(){
    const int8_t data1[] = {
    18, -20, 105, -128, -52, -87, 43, 41, 123, -48, -9, 35, 83, -51, 84, 69
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -81, 61, -127, 61, -20, 50, 78, 102, -46, 60, 79, 1, 48, -125, -111, -81
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vv_8mf4_b32 (mask, data1_v, data2_v, vl);
