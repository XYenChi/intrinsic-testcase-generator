...
int main(){
    const int32_t data1[] = {
    38, -31, -19, -44, 125, 95, 26, -55, 38, -34, 55, -60, -117, -104, 123, 35
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    84, 6, 95, 77, 32, 8, -85, -60, 3, -17, 53, -122, 88, -83, -128, 99
    };
    ...
    int32_t golden[] = {
    4294967250, 4294967259, 4294967182, 4294967175, 93, 87, 111, 5, 35, 4294967279, 2, 62, 4294967091, 4294967275, 251, 4294967232
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
