...
int main(){
    const int16_t data1[] = {
    39, 19, -125, 68, 116, 111, 32, -37, -7, -127, 19, -23, 48, 108, -85, 61
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    103, -86, -27, -24, -28, -60, 70, -10, -9, -20, 57, 8, -120, 95, -14, -37
    };
    ...
    int16_t golden[] = {
    65472, 105, 65438, 0, 144, 171, 65498, 65509, 1, 65429, 65498, 65505, 0, 0, 1, 98
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
