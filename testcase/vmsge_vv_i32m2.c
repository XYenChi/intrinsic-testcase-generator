...
int main(){
    const int32_t data1[] = {
    109, -20, -76, 35, 94, -121, 127, 117, -71, -102, 115, 116, 111, -12, -115, 61
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    6, 115, -72, -98, 117, -25, 1, 18, 40, -86, 106, 65, 54, -74, -66, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vv_32m2_b16 (data1_v, data2_v, vl);
