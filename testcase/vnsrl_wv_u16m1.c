...
int main(){
    ...
    59, 175, 198, 217, 242, 73, 93, 62, 150, 124, 127, 123, 212, 227, 66, 133
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    28, 14, 61, 232, 202, 24, 109, 123, 179, 23, 178, 98, 108, 6, 202, 232
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_16m1 (data1_v, shift, vl);
