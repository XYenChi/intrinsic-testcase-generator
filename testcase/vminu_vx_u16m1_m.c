...
int main(){
    ...
    130, 39, 97, 89, 148, 227, 179, 25, 127, 29, 109, 227, 81, 183, 220, 67
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    49, 94, 224, 144, 133, 112, 169, 79, 163, 230, 249, 124, 173, 205, 240, 35
    };
    ...
    uint16_t golden[] = {
    1, 1, 0, 144, 148, 227, 179, 79, 0, 230, 249, 227, 0, 1, 240, 67
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
