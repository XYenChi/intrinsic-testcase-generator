...
int main(){
    ...
    157, 106, 160, 134, 32, 6, 197, 97, 94, 164, 134, 169, 165, 188, 111, 250
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    84, 19, 168, 212, 212, 179, 203, 214, 144, 22, 76, 128, 85, 184, 238, 171
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmadd_vx_u64m8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    157, 125, 168, 346, 212, 6, 203, 214, 94, 164, 134, 169, 85, 372, 111, 171
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
