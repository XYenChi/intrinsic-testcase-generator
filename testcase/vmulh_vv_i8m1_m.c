...
int main(){
    const int8_t data1[] = {
    -70, 51, -117, -52, -69, 47, 100, -15, -49, -88, 68, 84, -29, -17, -46, -122
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    81, 94, -43, 30, 105, -20, 77, 120, -124, 89, 57, -28, 108, 121, -85, -126
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vv_8m1_b8 (mask, data1_v, data2_v, vl);
