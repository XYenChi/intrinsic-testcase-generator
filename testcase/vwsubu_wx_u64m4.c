...
int main(){
    ...
    164, 217, 97, 82, 73, 38, 60, 202, 63, 254, 33, 61, 218, 82, 227, 2
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    250, 36, 127, 205, 103, 233, 137, 228, 13, 240, 106, 129, 79, 108, 218, 211
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u64m4 (data1_v, data2_v, vl);
