...
int main(){
    ...
    250, 51, 247, 180, 177, 105, 141, 149, 202, 80, 222, 172, 137, 29, 92, 35
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    49, 63, 185, 79, 172, 82, 42, 199, 75, 201, 243, 97, 73, 109, 44, 111
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u32m4 (data1_v, data2_v, vl);
