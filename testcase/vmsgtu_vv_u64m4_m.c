...
int main(){
    ...
    158, 73, 99, 145, 199, 185, 227, 182, 215, 159, 178, 21, 126, 110, 72, 87
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    5, 209, 123, 111, 102, 95, 181, 248, 22, 146, 13, 169, 39, 68, 80, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_64m4_b16_m (mask, data1_v, data2_v, vl);
