...
int main(){
    const int8_t data1[] = {
    -117, -103, 115, 123, -75, -113, 83, -114, -117, -105, -71, 75, -52, 105, -97, -74
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -46, -53, -50, 15, 105, 67, 48, 85, -60, -53, -91, 25, 33, -79, 62, 94
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_i8mf2_m (mask, data1_v, data2_v, vl);
