...
int main(){
    const int16_t data1[] = {
    -81, 4, 103, -84, 40, -7, 54, 120, -21, -36, -13, -45, -86, 65, 123, 40
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -119, 85, 21, -91, 72, 3, 1, 73, 54, 84, 34, 9, 50, 2, -20, 8
    };
    ...
    int16_t golden[] = {
    65417, 89, 21, 65361, 72, 65532, 1, 193, 54, 84, 21, 9, 65500, 67, 65516, 48
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
