...
int main(){
    const int8_t data1[] = {
    -10, -34, 48, -106, 16, -115, 43, -110, 53, -114, 11, -68, 114, 60, -95, 7
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    54, -41, -84, 23, -11, 31, -105, 33, 26, -110, -55, -12, 55, 6, -74, 118
    };
    ...
    int8_t golden[] = {
    54, 222, 48, 23, 16, 31, 43, 33, 53, 146, 11, 244, 114, 60, 182, 118
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
