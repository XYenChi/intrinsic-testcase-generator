...
int main(){
    const int8_t data1[] = {
    91, -101, -71, -81, 41, -66, -48, 118, -60, -19, -114, -41, 8, -97, 6, 84
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    1, -57, -71, 21, 88, 113, 101, -2, -12, 32, -117, -96, 21, 69, 15, -7
    };
    ...
    int8_t golden[] = {
    91, 199, 185, 21, 88, 113, 101, 118, 244, 32, 142, 215, 21, 69, 15, 84
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
