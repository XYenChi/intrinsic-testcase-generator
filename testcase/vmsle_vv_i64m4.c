...
int main(){
    const int64_t data1[] = {
    91, 60, 122, 74, 62, 112, -70, -103, -125, -8, 8, -10, -84, -77, 86, 59
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    31, 49, 50, 111, 55, 116, -65, -34, 103, 77, -120, -98, -80, 83, -72, -68
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vv_64m4_b16 (data1_v, data2_v, vl);
