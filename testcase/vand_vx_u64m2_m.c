...
int main(){
    ...
    190, 69, 68, 3, 255, 246, 179, 236, 2, 218, 25, 117, 192, 21, 186, 105
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    143, 124, 225, 145, 174, 92, 203, 113, 112, 41, 212, 127, 4, 21, 22, 218
    };
    ...
    uint64_t golden[] = {
    143, 124, 0, 0, 0, 92, 203, 113, 1, 41, 212, 1, 1, 21, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
