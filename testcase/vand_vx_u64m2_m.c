...
int main(){
    ...
    19, 139, 73, 161, 120, 107, 150, 192, 29, 130, 21, 194, 17, 210, 252, 188
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    116, 234, 66, 131, 144, 183, 120, 98, 166, 18, 232, 44, 109, 147, 49, 182
    };
    ...
    uint64_t golden[] = {
    116, 0, 66, 131, 144, 183, 120, 98, 166, 18, 0, 1, 1, 147, 49, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
