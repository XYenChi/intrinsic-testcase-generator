...
int main(){
    const int16_t data1[] = {
    -111, -38, -45, 45, -91, -107, 2, 53, -9, 0, -86, 77, 17, 44, 59, -109
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    66, -104, -117, 51, 65, -47, -20, -54, -37, -49, -36, 119, 106, -60, 41, 61
    };
    ...
    uint8_t masked[] = {
    0, 0, 1, 0, 0, 0, 1, 1, 0, 0, 1, 0, 1, 1, 0, 0
    };
    ...
    int16_t golden[] = {
    1, 1, 5265, 1, 1, 0, 65496, 62674, 0, 0, 3096, 0, 1802, 62896, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
