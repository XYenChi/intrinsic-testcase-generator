...
int main(){
    const int16_t data1[] = {
    107, 70, 69, -9, 75, -83, -55, 89, 27, -8, 0, 51, 81, -60, -3, 62
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -56, -115, 19, -126, -37, 61, -92, 24, 81, -100, 91, -3, -64, 33, 36, 49
    };
    ...
    int16_t golden[] = {
    65373, 65351, 65486, 65419, 65424, 144, 65499, 65471, 54, 65444, 91, 65482, 65391, 93, 39, 65523
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
