...
int main(){
    ...
    145, 74, 76, 232, 33, 227, 140, 128, 129, 193, 68, 201, 2, 39, 145, 160
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    250, 225, 255, 27, 233, 110, 116, 60, 24, 70, 225, 112, 179, 204, 111, 28
    };
    ...
    uint64_t golden[] = {
    0, 299, 0, 259, 1, 0, 0, 0, 1, 263, 293, 0, 1, 0, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
