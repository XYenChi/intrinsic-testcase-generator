...
int main(){
    ...
    64, 94, 168, 172, 59, 73, 189, 232, 214, 101, 78, 72, 230, 104, 236, 137
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    208, 174, 241, 209, 140, 102, 209, 60, 213, 221, 54, 30, 210, 42, 247, 197
    };
    ...
    uint64_t golden[] = {
    272, 268, 409, 381, 0, 175, 0, 1, 1, 322, 132, 0, 440, 0, 1, 334
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
