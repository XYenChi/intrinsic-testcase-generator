...
int main(){
    const int64_t data1[] = {
    127, 32, -29, -111, -21, 77, 52, 99, 51, 13, -91, 17, -39, 116, -57, 116
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    26, -5, -117, 21, -84, 7, -33, -52, -121, 58, 116, 122, -5, -91, 96, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vx_64m2_b32 (mask, data1_v, data2_v, vl);
