...
int main(){
    ...
    32, 152, 82, 221, 128, 16, 53, 179, 69, 172, 223, 231, 141, 7, 13, 67
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    137, 34, 218, 173, 227, 10, 157, 208, 113, 29, 255, 64, 223, 148, 187, 30
    };
    ...
    uint32_t golden[] = {
    64, 152, 82, 442, 256, 16, 106, 179, 138, 344, 446, 231, 282, 7, 26, 67
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
