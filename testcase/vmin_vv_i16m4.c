...
int main(){
    const int16_t data1[] = {
    36, -71, 110, 52, 75, -47, 24, -16, -125, -54, 93, -52, 107, 23, -16, -109
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    71, -79, -71, 105, -82, 87, -86, 82, 33, -16, -62, 97, 113, 47, 60, -104
    };
    ...
    int16_t golden[] = {
    71, 65465, 110, 105, 75, 87, 24, 82, 33, 65520, 93, 97, 113, 47, 60, 65432
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
