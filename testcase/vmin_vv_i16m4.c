...
int main(){
    const int16_t data1[] = {
    -104, 37, -34, -33, -86, -75, 108, 89, 119, 112, -95, 21, 105, -93, -60, 63
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    90, 23, 88, 22, -126, 112, 99, 29, -106, -65, 92, -78, 39, -126, -55, -122
    };
    ...
    int16_t golden[] = {
    90, 37, 88, 22, 65450, 112, 108, 89, 119, 112, 92, 21, 105, 65443, 65481, 63
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
