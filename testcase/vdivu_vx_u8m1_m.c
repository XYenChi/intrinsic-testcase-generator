...
int main(){
    const uint8_t data1[] = {
    232, 203, 242, 223, 192, 189, 140, 92, 196, 58, 177, 63, 159, 48, 200, 118
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    124, 142, 114, 111, 128, 120, 135, 87, 154, 226, 57, 127, 128, 34, 79, 156
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i8m1_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 0, 0, 0, 0, 1, 1, 0, 0, 3, 0, 1, 0, 0, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
