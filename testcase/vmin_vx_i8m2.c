...
int main(){
    const int8_t data1[] = {
    76, 74, -20, 25, -34, 67, -73, -26, -50, -31, 26, -65, -29, -107, 61, -48
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    58, 3, -93, 99, -79, 83, -105, -11, 12, -44, 102, 110, -118, 75, -71, 16
    };
    ...
    int8_t golden[] = {
    76, 74, 236, 99, 222, 83, 183, 245, 12, 225, 102, 110, 227, 75, 61, 16
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
