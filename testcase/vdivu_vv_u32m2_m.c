...
int main(){
    ...
    188, 24, 252, 61, 120, 175, 182, 86, 73, 226, 120, 158, 185, 171, 125, 121
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    164, 49, 10, 10, 151, 29, 35, 212, 87, 171, 170, 58, 71, 131, 201, 204
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i32m2_m (mask, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    0, 1, 0, 0, 1, 0, 0, 2, 1, 0, 1, 0, 0, 0, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
