...
int main(){
    const uint8_t data1[] = {
    77, 50, 229, 75, 211, 245, 133, 171, 23, 48, 215, 184, 181, 241, 12, 234
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    250, 156, 69, 209, 197, 106, 7, 147, 22, 36, 28, 104, 206, 36, 89, 73
    };
    ...
    uint8_t golden[] = {
    250, 0, 69, 1, 1, 106, 7, 147, 22, 36, 28, 104, 1, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
