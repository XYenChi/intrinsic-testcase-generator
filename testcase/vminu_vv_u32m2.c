...
int main(){
    ...
    130, 200, 117, 134, 190, 251, 28, 134, 146, 24, 36, 224, 171, 221, 126, 16
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    65, 103, 81, 239, 227, 143, 143, 116, 196, 9, 86, 88, 134, 128, 62, 51
    };
    ...
    uint32_t golden[] = {
    130, 200, 117, 239, 227, 251, 143, 134, 196, 24, 86, 224, 171, 221, 126, 51
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
