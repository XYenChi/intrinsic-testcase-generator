...
int main(){
    ...
    183, 106, 225, 114, 217, 250, 143, 196, 217, 164, 116, 204, 96, 98, 223, 213
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    9, 176, 12, 140, 17, 181, 60, 171, 136, 162, 158, 207, 208, 21, 167, 48
    };
    ...
    uint32_t golden[] = {
    183, 176, 225, 140, 217, 250, 143, 196, 217, 164, 158, 207, 208, 98, 223, 213
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
