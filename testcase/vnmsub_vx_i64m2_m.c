...
int main(){
    const int64_t data1[] = {
    -122, 6, -24, 8, 97, -3, -32, 32, -19, -82, -33, 103, -19, -112, 89, -5
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    109, 25, -114, -41, 49, 26, -77, 74, -18, -37, -43, -125, 23, 102, 10, -100
    };
    ...
    int64_t golden[] = {
    18446744073709551494, 6, 18446744073709551592, 0, 0, 0, 0, 0, 18446744073709551615, 1, 1, 103, 0, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
