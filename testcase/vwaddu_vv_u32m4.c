...
int main(){
    ...
    72, 6, 188, 81, 33, 161, 172, 13, 24, 103, 208, 146, 64, 89, 149, 215
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    32, 128, 204, 165, 120, 155, 163, 71, 35, 133, 28, 183, 34, 81, 241, 130
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u32m4 (data1_v, data2_v, vl);
