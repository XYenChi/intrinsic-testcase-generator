...
int main(){
    ...
    230, 213, 25, 110, 30, 19, 36, 113, 35, 33, 109, 169, 200, 152, 251, 227
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    209, 201, 24, 97, 51, 0, 176, 79, 81, 237, 242, 136, 190, 243, 79, 77
    };
    ...
    uint64_t golden[] = {
    0, 1, 1, 1, 1, 0, 6336, 8927, 2835, 7821, 26378, 1, 0, 36936, 0, 17479
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
