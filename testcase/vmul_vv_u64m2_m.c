...
int main(){
    ...
    0, 41, 116, 76, 144, 162, 229, 48, 55, 115, 195, 99, 124, 158, 141, 164
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    170, 197, 103, 143, 154, 249, 98, 161, 139, 126, 69, 136, 234, 91, 54, 97
    };
    ...
    uint64_t golden[] = {
    0, 8077, 11948, 10868, 0, 40338, 0, 0, 7645, 14490, 1, 1, 0, 14378, 7614, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
