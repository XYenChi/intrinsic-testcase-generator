...
int main(){
    ...
    238, 19, 95, 181, 124, 162, 202, 130, 116, 119, 230, 208, 14, 196, 109, 39
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    89, 247, 185, 91, 173, 168, 173, 247, 88, 42, 238, 149, 134, 61, 117, 123
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u16m4_m (mask, data1_v, data2_v, vl);
