...
int main(){
    const int8_t data1[] = {
    -34, -118, -116, -36, 70, -20, -114, -103, 78, -85, 12, -120, -102, -29, 95, -115
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -72, -103, -34, 34, -1, 42, -127, 82, 39, -43, -15, -119, -38, 59, 56, 107
    };
    ...
    int8_t golden[] = {
    150, 0, 0, 254, 0, 0, 15, 235, 1, 128, 253, 0, 1, 30, 151, 248
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
