...
int main(){
    const uint8_t data1[] = {
    119, 194, 223, 132, 97, 52, 247, 72, 248, 92, 195, 127, 252, 161, 140, 141
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    215, 249, 188, 52, 217, 55, 60, 217, 83, 193, 187, 117, 110, 104, 108, 143
    };
    ...
    uint8_t golden[] = {
    215, 249, 223, 132, 217, 55, 247, 217, 248, 193, 195, 127, 252, 161, 140, 143
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
