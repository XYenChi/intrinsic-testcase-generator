...
int main(){
    const uint8_t data1[] = {
    16, 74, 95, 182, 79, 93, 1, 90, 91, 211, 227, 167, 194, 96, 141, 205
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    239, 15, 188, 20, 92, 158, 51, 176, 53, 202, 64, 109, 60, 8, 115, 96
    };
    ...
    uint8_t golden[] = {
    239, 74, 188, 182, 92, 158, 51, 176, 91, 211, 227, 167, 194, 96, 141, 205
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
