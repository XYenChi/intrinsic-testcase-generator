...
int main(){
    const uint8_t data1[] = {
    128, 188, 73, 80, 35, 123, 189, 88, 255, 234, 215, 85, 245, 200, 122, 210
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    237, 59, 242, 141, 95, 216, 173, 233, 248, 96, 128, 231, 169, 173, 222, 18
    };
    ...
    uint8_t golden[] = {
    237, 188, 242, 141, 95, 216, 189, 233, 255, 234, 215, 231, 245, 200, 222, 210
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
