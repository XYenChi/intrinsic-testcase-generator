...
int main(){
    ...
    157, 47, 152, 56, 165, 89, 66, 135, 60, 140, 208, 172, 190, 17, 59, 165
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    158, 115, 108, 212, 104, 9, 100, 72, 32, 196, 140, 157, 217, 231, 244, 79
    };
    ...
    uint16_t golden[] = {
    315, 162, 261, 269, 270, 98, 166, 207, 93, 337, 348, 330, 408, 249, 303, 244
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
