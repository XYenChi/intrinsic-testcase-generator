...
int main(){
    const int32_t data1[] = {
    21, 90, -52, 0, 39, 65, 2, 107, -42, 70, 46, -15, 22, -67, 24, 19
    };
    const int32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    56, 98, 86, 20, 17, 191, 197, 175, 175, 180, 10, 37, 236, 72, 7, 203
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_32m2_b16 (mask, data1_v, data2_v, vl);
