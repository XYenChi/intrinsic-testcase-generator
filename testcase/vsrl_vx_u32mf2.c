...
int main(){
    ...
    6, 223, 252, 22, 138, 27, 222, 210, 154, 189, 172, 235, 125, 217, 99, 73
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    191, 54, 90, 96, 163, 96, 122, 91, 194, 89, 6, 222, 77, 213, 85, 122
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u32mf2 (data1_v, shift, vl);
