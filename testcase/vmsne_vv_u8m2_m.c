...
int main(){
    const uint8_t data1[] = {
    254, 29, 58, 129, 236, 174, 202, 153, 243, 107, 236, 3, 156, 101, 57, 161
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    216, 52, 134, 203, 8, 250, 53, 52, 254, 199, 5, 129, 52, 194, 99, 215
    };
    const uint8_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e8m2(avl);
    const uint out_data[] = {
    0, 1, 0, 0, 0, 0, 1, 0, 0, 1, 0, 1, 0, 0, 0, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_8m2_b4_m (mask, data1_v, data2_v, vl);
