...
int main(){
    ...
    218, 247, 49, 174, 45, 198, 114, 42, 74, 150, 88, 79, 192, 144, 49, 187
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    149, 43, 198, 227, 62, 216, 141, 251, 163, 181, 86, 127, 100, 117, 72, 209
    };
    ...
    uint16_t golden[] = {
    218, 247, 198, 401, 107, 198, 114, 293, 74, 150, 86, 127, 192, 144, 121, 209
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
