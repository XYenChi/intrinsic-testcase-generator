...
int main(){
    ...
    108, 253, 61, 166, 222, 215, 85, 200, 68, 90, 173, 113, 193, 229, 172, 142
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    55, 58, 220, 133, 162, 185, 155, 96, 14, 238, 170, 144, 93, 248, 179, 155
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u32m1 (data1_v, data2_v, vl);
