...
int main(){
    ...
    62, 190, 218, 236, 151, 148, 129, 146, 166, 254, 174, 189, 251, 202, 123, 60
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    106, 86, 227, 157, 122, 199, 57, 18, 65, 205, 181, 11, 193, 138, 171, 114
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u32m1_m (mask, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    44, 86, 9, 157, 122, 0, 57, 18, 65, 205, 7, 11, 0, 0, 48, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
