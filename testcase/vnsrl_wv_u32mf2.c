...
int main(){
    ...
    85, 94, 97, 41, 41, 64, 232, 55, 106, 192, 130, 126, 113, 237, 224, 6
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    250, 232, 135, 121, 219, 252, 166, 29, 32, 188, 93, 155, 194, 130, 35, 223
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_32mf2 (data1_v, shift, vl);
