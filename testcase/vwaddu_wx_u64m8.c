...
int main(){
    ...
    99, 229, 212, 202, 100, 219, 100, 218, 125, 56, 153, 195, 222, 76, 195, 85
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    70, 60, 214, 13, 225, 109, 191, 118, 157, 143, 18, 65, 133, 222, 162, 163
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u64m8 (data1_v, data2_v, vl);
