...
int main(){
    ...
    159, 91, 171, 28, 85, 192, 15, 21, 158, 22, 105, 255, 201, 113, 43, 15
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    236, 187, 110, 194, 123, 116, 237, 84, 192, 147, 141, 163, 147, 91, 110, 151
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u64m8_m (mask, data1_v, data2_v, vl);
