...
int main(){
    const int32_t data1[] = {
    95, 17, -61, -119, -32, 77, -125, -114, 36, 44, -86, -63, -96, 12, -41, 77
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -10, -15, 22, 41, -79, -127, -82, -89, -114, -19, -13, -127, 11, 31, 7, -19
    };
    ...
    int32_t golden[] = {
    0, 0, 22, 1, 4294967264, 1, 4294967214, 1, 1, 44, 4294967283, 4294967233, 0, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
