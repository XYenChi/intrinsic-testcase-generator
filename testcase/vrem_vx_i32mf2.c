...
int main(){
    const int32_t data1[] = {
    -116, 57, -90, 125, 90, 65, 38, 29, 120, 85, 107, 82, -80, -58, -22, 110
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -31, 40, 6, -31, 14, -71, 124, 14, 79, -32, -125, 118, -110, -68, -103, -72
    };
    ...
    int32_t golden[] = {
    4294967265, 40, 4294967212, 94, 14, 59, 10, 14, 79, 53, 89, 36, 4294967266, 4294967286, 4294967281, 38
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
