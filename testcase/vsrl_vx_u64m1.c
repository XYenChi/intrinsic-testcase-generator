...
int main(){
    ...
    244, 119, 55, 34, 191, 238, 50, 177, 201, 205, 120, 56, 146, 80, 91, 138
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    225, 27, 2, 192, 23, 152, 78, 4, 27, 29, 49, 65, 167, 66, 229, 156
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u64m1 (data1_v, shift, vl);
