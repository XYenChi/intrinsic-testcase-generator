...
int main(){
    ...
    129, 119, 79, 249, 30, 225, 153, 123, 167, 20, 232, 25, 13, 125, 132, 187
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    234, 126, 254, 75, 21, 252, 82, 80, 93, 26, 204, 73, 14, 102, 17, 160
    };
    ...
    uint32_t golden[] = {
    234, 126, 254, 249, 30, 252, 153, 123, 167, 26, 232, 73, 14, 125, 132, 187
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
