...
int main(){
    ...
    107, 28, 44, 79, 101, 42, 106, 101, 157, 51, 88, 86, 215, 105, 157, 152
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    210, 86, 119, 183, 186, 202, 105, 200, 168, 168, 220, 225, 212, 71, 58, 175
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_16mf2_b32 (data1_v, data2_v, vl);
