...
int main(){
    const int32_t data1[] = {
    98, 74, 80, 48, -13, 23, 44, 77, -83, 15, -112, 60, -124, -91, -51, -127
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -86, -128, 4, 115, -54, -66, 90, -60, -68, -15, -4, 10, -69, -101, -65, -37
    };
    ...
    int32_t golden[] = {
    4294958868, 4294957824, 320, 5520, 702, 4294965778, 3960, 4294962676, 5644, 4294967071, 448, 600, 8556, 9191, 3315, 4699
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
