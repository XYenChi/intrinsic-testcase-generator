...
int main(){
    const int64_t data1[] = {
    -84, -15, -84, -90, 44, -122, 95, -25, 125, -17, -20, 107, -127, 115, -20, 55
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    77, -101, 101, 38, -112, 7, -15, -101, 121, 13, -27, 116, 66, 109, 4, 57
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vx_64m4_b16 (data1_v, data2_v, vl);
