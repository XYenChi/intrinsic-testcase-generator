...
int main(){
    const int8_t data1[] = {
    29, -68, 65, 14, 77, 120, -91, 21, -75, 9, -49, 61, 120, -116, -76, -26
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    2, -45, 46, -36, -38, 85, 115, -12, 116, 20, -15, -61, 81, 53, 117, -105
    };
    ...
    int8_t golden[] = {
    29, -136, 65, 14, 77, 240, -182, 21, -75, 9, -98, 122, 240, -232, -152, -52
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
