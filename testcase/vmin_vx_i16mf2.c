...
int main(){
    const int16_t data1[] = {
    36, 125, 93, -47, -77, 41, -24, -58, 19, 79, -21, 28, -35, 46, 15, 6
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    108, 78, 51, 4, 8, 103, 65, -63, -66, -65, -65, 111, -15, -53, 70, -31
    };
    ...
    int16_t golden[] = {
    108, 125, 93, 4, 8, 103, 65, 65478, 19, 79, 65515, 111, 65521, 46, 70, 6
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
