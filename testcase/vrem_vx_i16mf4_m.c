...
int main(){
    const int16_t data1[] = {
    116, -58, 110, -89, 31, -27, -33, 96, 127, -120, 72, -57, 7, -7, 122, -28
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -75, -84, 114, -39, -33, -76, -94, -64, 78, 26, 107, -120, 120, -46, -23, 125
    };
    ...
    int16_t golden[] = {
    41, 65510, 4, 1, 29, 65514, 65508, 0, 0, 65442, 35, 0, 0, 65532, 99, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
