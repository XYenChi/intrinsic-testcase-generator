...
int main(){
    ...
    85, 156, 155, 46, 223, 185, 63, 239, 200, 59, 24, 37, 229, 187, 227, 18
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    241, 50, 183, 112, 146, 22, 101, 77, 0, 0, 166, 65, 153, 6, 206, 201
    };
    ...
    uint32_t golden[] = {
    85, 1, 0, 0, 1, 1, 63, 1, 200, 59, 0, 4294967268, 229, 0, 1, 4294967113
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
