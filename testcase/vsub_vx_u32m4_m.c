...
int main(){
    ...
    166, 226, 48, 108, 190, 33, 5, 139, 225, 104, 145, 119, 224, 159, 126, 248
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    187, 73, 56, 34, 219, 76, 186, 85, 120, 202, 64, 98, 88, 205, 193, 223
    };
    ...
    uint32_t golden[] = {
    4294967275, 153, 4294967288, 1, 1, 0, 0, 54, 0, 1, 81, 0, 136, 1, 1, 25
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
