...
int main(){
    ...
    186, 149, 27, 83, 167, 180, 130, 39, 59, 87, 48, 162, 45, 115, 171, 102
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    132, 102, 173, 52, 21, 77, 240, 171, 212, 103, 213, 136, 8, 179, 118, 77
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u32mf2 (data1_v, data2_v, vl);
