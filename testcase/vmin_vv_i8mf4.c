...
int main(){
    const int8_t data1[] = {
    81, -113, 59, -77, 22, 57, -108, -73, 84, -110, 4, -12, -63, -52, 107, 86
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    118, 86, 107, -83, 4, -65, -24, -26, 22, -80, 119, 13, 45, 18, -50, -8
    };
    ...
    int8_t golden[] = {
    118, 86, 107, 179, 22, 57, 232, 230, 84, 176, 119, 13, 45, 18, 107, 86
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
