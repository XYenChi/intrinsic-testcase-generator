...
int main(){
    const int8_t data1[] = {
    56, -75, -70, -117, 95, -93, -26, 10, -105, -106, 27, 92, -112, -99, 70, -97
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -6, -95, -10, 79, 69, -81, -33, 97, -126, -121, 118, -106, 72, -40, 126, -86
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vv_8mf2_b16 (data1_v, data2_v, vl);
