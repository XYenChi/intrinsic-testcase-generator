...
int main(){
    ...
    51, 90, 227, 123, 46, 3, 167, 71, 133, 146, 103, 161, 100, 177, 55, 71
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    52, 81, 75, 12, 32, 133, 16, 175, 219, 254, 121, 80, 106, 163, 30, 103
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vadc_vvm_i16mf2 (data1_v, data2_v, masked, vl);
    ...
    uint16_t golden[] = {
    103, 171, 302, 135, 79, 136, 184, 246, 353, 401, 225, 242, 206, 340, 86, 175
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
