...
int main(){
    ...
    152, 68, 62, 53, 252, 231, 168, 216, 95, 198, 7, 66, 102, 213, 246, 168
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    225, 251, 103, 245, 164, 244, 7, 219, 202, 166, 237, 46, 226, 185, 38, 71
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u32m8 (data1_v, data2_v, vl);
