...
int main(){
    ...
    106, 53, 217, 118, 248, 121, 43, 60, 226, 201, 251, 213, 112, 176, 114, 242
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    97, 104, 188, 150, 82, 91, 203, 211, 139, 28, 178, 133, 243, 141, 235, 218
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vx_16mf4_b64 (data1_v, data2_v, vl);
