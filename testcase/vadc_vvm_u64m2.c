...
int main(){
    ...
    220, 63, 107, 15, 52, 18, 66, 70, 181, 227, 217, 99, 227, 244, 4, 219
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    254, 254, 54, 202, 71, 119, 253, 242, 130, 218, 11, 105, 116, 0, 44, 141
    };
    ...
    uint64_t golden[] = {
    475, 317, 162, 218, 124, 137, 320, 313, 312, 446, 228, 205, 343, 245, 49, 361
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
