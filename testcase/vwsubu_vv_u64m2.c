...
int main(){
    ...
    91, 247, 140, 89, 67, 112, 226, 109, 95, 186, 58, 190, 118, 31, 210, 93
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    41, 17, 5, 215, 44, 119, 149, 253, 42, 213, 195, 29, 120, 7, 95, 64
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u64m2 (data1_v, data2_v, vl);
