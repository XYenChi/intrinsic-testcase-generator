...
int main(){
    ...
    74, 93, 219, 18, 53, 103, 14, 91, 70, 241, 13, 154, 238, 174, 215, 33
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    245, 7, 227, 104, 127, 214, 114, 16, 183, 102, 182, 228, 216, 240, 236, 31
    };
    ...
    uint32_t golden[] = {
    245, 93, 227, 104, 127, 214, 114, 91, 183, 241, 182, 228, 238, 240, 236, 33
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
