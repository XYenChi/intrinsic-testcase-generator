...
int main(){
    ...
    133, 113, 76, 187, 125, 24, 238, 248, 254, 102, 127, 100, 169, 4, 164, 179
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    117, 230, 53, 66, 19, 5, 45, 72, 37, 54, 93, 126, 217, 37, 54, 108
    };
    ...
    uint32_t golden[] = {
    133, 230, 76, 187, 125, 24, 238, 248, 254, 102, 127, 126, 217, 37, 164, 179
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
