...
int main(){
    ...
    226, 105, 134, 204, 148, 219, 89, 146, 213, 158, 205, 174, 59, 18, 33, 117
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    153, 33, 215, 187, 213, 235, 87, 93, 48, 25, 21, 137, 137, 235, 88, 145
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_16m1_b16 (mask, data1_v, data2_v, vl);
