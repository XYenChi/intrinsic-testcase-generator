...
int main(){
    ...
    23, 65, 182, 157, 186, 120, 212, 93, 172, 245, 134, 73, 212, 147, 234, 178
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    48, 86, 104, 140, 74, 145, 204, 45, 161, 107, 253, 222, 75, 171, 142, 159
    };
    ...
    uint16_t golden[] = {
    1104, 5590, 18928, 21980, 13764, 17400, 43248, 4185, 27692, 26215, 33902, 16206, 15900, 25137, 33228, 28302
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
