...
int main(){
    ...
    208, 133, 177, 93, 155, 110, 197, 133, 67, 26, 232, 19, 100, 42, 235, 24
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    28, 82, 184, 122, 113, 168, 97, 27, 116, 4, 185, 98, 199, 183, 82, 144
    };
    ...
    uint16_t golden[] = {
    5824, 10906, 32568, 11346, 17515, 18480, 19109, 3591, 7772, 104, 42920, 1862, 19900, 7686, 19270, 3456
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
