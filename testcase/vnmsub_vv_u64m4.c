...
int main(){
    ...
    157, 113, 46, 250, 158, 11, 243, 138, 159, 204, 28, 162, 71, 117, 182, 253
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    181, 224, 143, 208, 25, 42, 90, 134, 141, 15, 204, 52, 250, 12, 153, 36
    };
    ...
    uint64_t golden[] = {
    18446744073709551592, 113, 46, 42, 158, 18446744073709551585, 243, 4, 159, 189, 18446744073709551440, 162, 71, 117, 29, 217
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
