...
int main(){
    const int16_t data1[] = {
    13, -12, 71, 112, 54, -117, 68, 111, -81, 17, 127, -125, 118, 29, -14, 15
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    22, 121, 95, -68, 48, 9, -17, 40, 71, 77, 55, -95, -33, -35, 97, -33
    };
    ...
    int16_t golden[] = {
    9, 1, 24, 0, 65530, 126, 1, 1, 152, 0, 65464, 30, 65385, 65472, 0, 65488
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
