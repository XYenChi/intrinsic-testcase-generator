...
int main(){
    ...
    199, 69, 197, 112, 131, 209, 217, 78, 84, 133, 180, 139, 165, 187, 69, 217
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    177, 247, 233, 103, 65, 124, 201, 237, 213, 131, 111, 212, 94, 236, 170, 222
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u64m4 (data1_v, data2_v, vl);
