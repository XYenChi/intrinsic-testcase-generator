...
int main(){
    ...
    80, 176, 125, 62, 227, 200, 12, 11, 182, 226, 89, 52, 206, 17, 155, 227
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    47, 57, 211, 251, 182, 71, 49, 7, 106, 190, 75, 138, 62, 160, 224, 69
    };
    ...
    uint32_t golden[] = {
    160, 352, 250, 124, 227, 400, 24, 22, 182, 226, 178, 52, 206, 17, 155, 454
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
