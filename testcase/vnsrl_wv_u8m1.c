...
int main(){
    const uint8_t data1[] = {
    205, 204, 86, 185, 238, 35, 205, 87, 77, 232, 171, 210, 195, 186, 197, 24
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    139, 139, 106, 118, 107, 198, 223, 204, 7, 84, 35, 104, 21, 70, 232, 12
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_8m1 (data1_v, shift, vl);
