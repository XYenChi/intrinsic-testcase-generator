...
int main(){
    ...
    216, 242, 205, 183, 78, 218, 162, 12, 29, 233, 117, 201, 206, 128, 218, 23
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    24, 29, 78, 207, 54, 124, 194, 98, 228, 39, 241, 91, 115, 106, 217, 237
    };
    ...
    uint64_t golden[] = {
    0, 7018, 15991, 0, 4212, 0, 31429, 1176, 6612, 9088, 28197, 0, 1, 0, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
