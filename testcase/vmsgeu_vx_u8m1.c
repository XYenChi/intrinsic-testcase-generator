...
int main(){
    const uint8_t data1[] = {
    59, 33, 42, 176, 86, 15, 204, 201, 182, 105, 74, 153, 69, 121, 151, 7
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    27, 164, 180, 127, 213, 137, 46, 137, 117, 243, 63, 134, 15, 245, 197, 152
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_8m1_b8 (data1_v, data2_v, vl);
