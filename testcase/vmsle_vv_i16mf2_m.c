...
int main(){
    const int16_t data1[] = {
    24, -127, -26, -119, 125, 107, 122, 102, -110, -84, 72, 74, -47, 45, -111, 84
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -121, -5, 69, -16, 99, 39, 7, -61, -51, -8, -49, 63, -73, 63, 92, -77
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vv_16mf2_b32_m (mask, data1_v, data2_v, vl);
