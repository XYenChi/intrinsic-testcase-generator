...
int main(){
    const uint8_t data1[] = {
    11, 150, 111, 217, 162, 207, 107, 248, 223, 239, 9, 109, 112, 10, 145, 63
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    184, 30, 55, 200, 221, 222, 202, 246, 222, 184, 34, 170, 231, 251, 168, 10
    };
    ...
    uint8_t golden[] = {
    16, 0, 0, 0, 1, 1, 1, 0, 0, 0, 3, 1, 2, 25, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
