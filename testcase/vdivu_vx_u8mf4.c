...
int main(){
    const uint8_t data1[] = {
    139, 176, 214, 180, 135, 190, 17, 204, 208, 211, 211, 44, 116, 228, 71, 116
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    140, 55, 163, 228, 232, 144, 195, 76, 80, 71, 103, 125, 230, 108, 131, 91
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i8mf4 (data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    1, 0, 0, 1, 1, 0, 11, 0, 0, 0, 0, 2, 1, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
