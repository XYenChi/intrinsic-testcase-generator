...
int main(){
    const int16_t data1[] = {
    32, 194, 98, 6, 10, 250, 8, 211, 149, 37, 96, 236, 184, 27, 169, 232
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    66, 215, 209, 116, 225, 206, 156, 228, 200, 217, 179, 139, 154, 224, 242, 19
    };
    ...
    int16_t golden[] = {
    98, 409, 307, 122, 235, 456, 164, 439, 349, 254, 275, 375, 338, 251, 411, 251
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
