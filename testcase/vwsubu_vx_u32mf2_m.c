...
int main(){
    ...
    39, 160, 54, 199, 6, 164, 8, 32, 231, 43, 232, 152, 12, 113, 243, 6
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    236, 151, 225, 219, 132, 127, 1, 152, 230, 107, 79, 66, 237, 125, 106, 212
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u32mf2_m (mask, data1_v, data2_v, vl);
