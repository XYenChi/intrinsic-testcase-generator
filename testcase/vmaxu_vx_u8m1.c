...
int main(){
    const uint8_t data1[] = {
    112, 131, 77, 35, 104, 212, 70, 204, 35, 197, 90, 142, 150, 71, 83, 123
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    174, 121, 217, 125, 89, 59, 42, 61, 230, 230, 195, 221, 8, 182, 74, 12
    };
    ...
    uint8_t golden[] = {
    174, 131, 217, 125, 104, 212, 70, 204, 230, 230, 195, 221, 150, 182, 83, 123
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
