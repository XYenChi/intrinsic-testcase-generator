...
int main(){
    const int32_t data1[] = {
    -38, -78, -108, -103, -98, 43, 50, 81, 101, 71, 78, -44, 109, -86, 32, 69
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    122, -102, -88, -104, 55, 74, -66, 19, 105, 34, 116, 34, -9, 95, 85, 102
    };
    ...
    int32_t golden[] = {
    0, 1, 1, 1, 0, 1, 0, 1, 1, 0, 1, 4294967295, 4294967295, 4294967294, 2, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
