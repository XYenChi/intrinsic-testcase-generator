...
int main(){
    ...
    49, 113, 37, 106, 34, 198, 180, 100, 141, 255, 98, 68, 52, 49, 243, 6
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    37, 29, 87, 136, 193, 163, 172, 194, 61, 108, 241, 214, 195, 140, 52, 108
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wx_32m4u_m (mask, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    1, 125, 119, 234, 1, 231, 188, 0, 0, 255, 243, 214, 0, 1, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
