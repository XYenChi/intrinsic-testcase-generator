...
int main(){
    const int16_t data1[] = {
    109, -20, 29, 52, -115, -56, -120, 43, -88, -72, -102, 33, -96, 54, 8, 92
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    209, 97, 117, 50, 124, 52, 37, 64, 187, 23, 133, 2, 154, 198, 134, 2
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_16m2_b8 (data1_v, data2_v, vl);
