...
int main(){
    ...
    143, 235, 89, 246, 185, 153, 230, 74, 130, 98, 169, 246, 227, 55, 85, 82
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    243, 117, 213, 130, 206, 169, 77, 89, 62, 183, 22, 121, 59, 134, 70, 159
    };
    ...
    uint32_t golden[] = {
    4294932548, 1, 0, 1, 0, 4294941440, 0, 4294960710, 0, 1, 4294963579, 0, 4294953903, 1, 4294961347, 4294954258
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
