...
int main(){
    ...
    58, 58, 99, 236, 61, 252, 15, 97, 211, 173, 167, 70, 22, 239, 219, 126
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    156, 129, 69, 11, 138, 79, 143, 25, 13, 241, 246, 42, 130, 138, 43, 160
    };
    ...
    uint16_t golden[] = {
    9049, 1, 6831, 1, 0, 1, 2146, 2425, 2744, 41694, 1, 0, 1, 1, 9417, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
