...
int main(){
    ...
    178, 224, 219, 121, 180, 7, 241, 156, 136, 179, 246, 157, 0, 206, 159, 19
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    142, 228, 62, 120, 40, 178, 236, 213, 225, 162, 76, 46, 39, 37, 123, 250
    };
    ...
    uint32_t golden[] = {
    178, 452, 219, 120, 180, 185, 241, 213, 136, 179, 246, 203, 39, 37, 159, 19
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
