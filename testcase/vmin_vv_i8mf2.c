...
int main(){
    const int8_t data1[] = {
    182, 90, 107, 120, 62, 186, 46, 158, 124, 207, 8, 96, 13, 122, 22, 108
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    178, 73, 191, 5, 254, 84, 179, 212, 196, 200, 52, 203, 71, 27, 10, 95
    };
    ...
    int8_t golden[] = {
    182, 90, 191, 120, 254, 186, 179, 212, 196, 207, 52, 203, 71, 122, 22, 108
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
