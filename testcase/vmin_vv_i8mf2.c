...
int main(){
    const int8_t data1[] = {
    -79, 69, -49, -15, -52, -45, 47, 74, -14, -91, 9, 110, -89, 83, -26, 94
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    49, -89, -41, 107, 108, -67, -33, -69, -121, 46, 52, 44, -53, 44, -50, 92
    };
    ...
    int8_t golden[] = {
    49, 69, 215, 107, 108, 211, 47, 74, 242, 46, 52, 110, 203, 83, 230, 94
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
