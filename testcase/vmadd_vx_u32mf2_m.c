...
int main(){
    ...
    84, 76, 30, 15, 131, 148, 30, 131, 177, 203, 168, 57, 57, 172, 127, 180
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    171, 235, 225, 147, 167, 170, 199, 245, 50, 85, 20, 188, 76, 50, 117, 104
    };
    ...
    uint64_t masked[] = {
    1, 0, 0, 0, 1, 1, 0, 1, 0, 0, 1, 0, 1, 0, 0, 0
    };
    ...
    uint32_t golden[] = {
    255, 76, 30, 15, 167, 318, 30, 376, 177, 203, 188, 57, 133, 172, 127, 180
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
