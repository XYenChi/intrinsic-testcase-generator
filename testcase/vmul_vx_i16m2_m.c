...
int main(){
    const int16_t data1[] = {
    15, 118, 67, -49, 116, -72, -112, 113, -73, 117, 18, -42, 25, 100, -93, -11
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -28, -82, 63, -16, 124, 113, -106, -96, -101, 6, 32, 88, 106, 38, -93, 58
    };
    ...
    int16_t golden[] = {
    65116, 55860, 0, 784, 14384, 57400, 11872, 54688, 0, 0, 0, 61840, 0, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
