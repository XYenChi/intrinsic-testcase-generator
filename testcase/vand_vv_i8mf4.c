...
int main(){
    const int8_t data1[] = {
    -124, -34, 3, -10, -87, -79, 121, 19, 24, -98, -38, -14, 39, 21, 113, -120
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -30, 57, 58, 60, -22, 13, -8, 79, -32, -19, -119, 84, -106, -76, -85, 69
    };
    ...
    int8_t golden[] = {
    226, 57, 58, 60, 234, 13, 248, 79, 224, 237, 137, 84, 150, 180, 171, 69
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
