...
int main(){
    ...
    93, 145, 112, 64, 123, 106, 12, 1, 170, 82, 17, 70, 25, 147, 230, 19
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    34, 203, 49, 179, 221, 240, 174, 32, 24, 172, 107, 176, 80, 24, 247, 41
    };
    ...
    uint64_t golden[] = {
    3162, 1, 5488, 11456, 0, 25440, 0, 32, 0, 1, 1819, 12320, 2000, 1, 0, 779
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
