...
int main(){
    const int16_t data1[] = {
    20, -42, -32, -117, -10, 12, 113, 114, -105, 38, -53, -71, 38, 22, -60, 90
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -17, -120, -93, 12, 20, -49, 0, -127, 22, -6, 112, 71, 58, -4, 47, -15
    };
    ...
    int16_t golden[] = {
    65196, 5040, 2977, 64133, 65336, 64949, 0, 51058, 63227, 65309, 59601, 60495, 2204, 65449, 62717, 64186
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
