...
int main(){
    const int32_t data1[] = {
    34, 65, -25, 37, 96, 26, 72, 91, -57, -41, 94, -35, -115, 85, -86, -102
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    65, 82, -32, -51, -43, -81, -65, 89, 111, -87, 51, -8, -52, -43, 13, 91
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vv_32m1_b32_m (mask, data1_v, data2_v, vl);
