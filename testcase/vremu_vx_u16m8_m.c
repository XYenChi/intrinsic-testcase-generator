...
int main(){
    ...
    223, 234, 5, 133, 54, 95, 45, 124, 149, 22, 202, 17, 179, 151, 182, 219
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    56, 49, 168, 52, 214, 139, 42, 117, 67, 244, 59, 9, 189, 68, 185, 53
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u16m8_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    56, 49, 0, 1, 52, 44, 42, 117, 67, 1, 59, 9, 0, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
