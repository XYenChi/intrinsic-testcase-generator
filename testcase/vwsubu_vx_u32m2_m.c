...
int main(){
    ...
    50, 17, 49, 35, 77, 239, 87, 158, 164, 84, 88, 42, 15, 103, 255, 235
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    21, 149, 43, 20, 108, 128, 64, 217, 99, 117, 178, 55, 64, 203, 120, 72
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u32m2_m (mask, data1_v, data2_v, vl);
