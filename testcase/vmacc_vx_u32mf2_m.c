...
int main(){
    ...
    43, 110, 52, 173, 186, 241, 46, 235, 214, 48, 139, 39, 81, 112, 181, 248
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    69, 183, 32, 191, 25, 180, 183, 155, 78, 149, 219, 166, 64, 224, 77, 7
    };
    ...
    uint32_t golden[] = {
    0, 20130, 1, 1, 1, 43380, 8418, 0, 16693, 7153, 1, 0, 5185, 25089, 13938, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
