...
int main(){
    const uint8_t data1[] = {
    92, 57, 27, 183, 226, 159, 155, 26, 223, 169, 110, 224, 237, 247, 122, 135
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    124, 171, 109, 69, 235, 230, 11, 73, 212, 201, 29, 91, 216, 204, 228, 240
    };
    ...
    uint8_t golden[] = {
    92, 57, 27, 69, 226, 230, 155, 73, 179, 201, 139, 59, 197, 247, 122, 135
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
