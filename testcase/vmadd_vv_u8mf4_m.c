...
int main(){
    const uint8_t data1[] = {
    83, 162, 134, 176, 225, 165, 242, 2, 231, 140, 161, 158, 43, 139, 202, 184
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    221, 141, 152, 203, 203, 39, 109, 158, 218, 96, 30, 14, 204, 23, 87, 214
    };
    ...
    uint32_t masked[] = {
    0, 1, 1, 1, 0, 0, 1, 0, 1, 1, 1, 0, 1, 0, 0, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmadd_vv_u8mf4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    83, 141, 152, 123, 225, 165, 95, 2, 218, 236, 191, 158, 204, 139, 202, 214
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
