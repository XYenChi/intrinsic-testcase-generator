...
int main(){
    ...
    207, 13, 187, 61, 28, 70, 182, 172, 174, 216, 100, 176, 33, 21, 5, 143
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    178, 156, 175, 4, 171, 166, 237, 69, 193, 115, 212, 1, 107, 140, 219, 215
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulu_vv_u32m1_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    0, 1, 32725, 0, 1, 11620, 1, 0, 0, 24840, 0, 176, 1, 1, 1095, 30745
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
