...
int main(){
    ...
    225, 228, 249, 233, 154, 19, 128, 145, 89, 165, 100, 26, 184, 215, 65, 18
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    50, 61, 235, 178, 10, 118, 218, 235, 19, 198, 207, 157, 99, 221, 193, 4
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u64m8 (data1_v, shift, vl);
