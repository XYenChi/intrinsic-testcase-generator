...
int main(){
    const int8_t data1[] = {
    80, 133, 92, 62, 25, 192, 199, 223, 98, 59, 3, 78, 86, 211, 9, 111
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    182, 133, 188, 42, 180, 172, 165, 155, 54, 83, 120, 155, 7, 73, 244, 194
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vrem_vx_i8m1 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    22, 0, 4, 42, 5, 172, 165, 155, 54, 24, 0, 77, 7, 73, 1, 83
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
