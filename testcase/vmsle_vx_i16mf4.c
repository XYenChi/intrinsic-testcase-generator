...
int main(){
    const int16_t data1[] = {
    117, -33, 65, -103, -64, 107, -114, -74, -37, -71, -124, 15, -77, -48, -52, -35
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -28, -97, 86, -80, 87, -29, -82, 101, 33, 4, -34, 25, 122, 2, -30, -33
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vx_16mf4_b64 (data1_v, data2_v, vl);
