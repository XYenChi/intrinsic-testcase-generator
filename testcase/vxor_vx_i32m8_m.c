...
int main(){
    const int32_t data1[] = {
    -109, -71, -128, -90, 109, -24, -77, -126, 9, 37, 91, -34, 89, 96, 97, -79
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    97, -94, 38, -47, -1, -94, -49, 59, -104, 91, -68, 58, -12, -102, -46, -6
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_i32m8_m (mask, data1_v, data2_v, vl);
