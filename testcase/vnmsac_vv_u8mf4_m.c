...
int main(){
    const uint8_t data1[] = {
    77, 219, 103, 11, 207, 159, 32, 76, 211, 133, 150, 74, 170, 250, 34, 124
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    196, 36, 213, 84, 6, 126, 227, 78, 241, 182, 14, 229, 177, 126, 158, 253
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsac_vv_u8mf4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    12, 1, 77, 0, 39, 190, 1, 0, 94, 0, 205, 0, 0, 244, 0, 117
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
