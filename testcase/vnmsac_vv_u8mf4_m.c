...
int main(){
    const uint8_t data1[] = {
    207, 11, 6, 71, 187, 28, 51, 79, 156, 199, 87, 119, 244, 254, 172, 8
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    252, 65, 165, 32, 170, 178, 243, 160, 206, 172, 178, 216, 185, 42, 52, 79
    };
    ...
    uint8_t golden[] = {
    0, 1, 34, 32, 1, 1, 0, 0, 120, 77, 1, 0, 173, 1, 1, 137
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
