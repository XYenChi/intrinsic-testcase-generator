...
int main(){
    const int32_t data1[] = {
    21, -42, -75, -51, 8, -37, -103, 91, -117, 14, -49, -112, -12, 113, -68, 1
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -68, -108, 51, 84, -119, 123, 48, -121, 53, 75, 7, 123, 68, 59, -25, 107
    };
    ...
    int32_t golden[] = {
    4294965868, 4536, 4294963471, 4294963012, 4294966344, 4294962745, 4294962352, 4294956285, 4294961095, 1050, 4294966953, 4294953520, 4294966480, 6667, 1700, 107
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
