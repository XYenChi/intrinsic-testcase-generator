...
int main(){
    const int32_t data1[] = {
    115, 7, 57, -21, -110, -7, 119, -24, 18, 1, 80, -96, 126, 58, -23, -85
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -100, 97, 63, -48, 73, 113, 53, -44, 65, -119, -127, -6, 107, -127, -119, -33
    };
    ...
    int32_t golden[] = {
    4294955796, 679, 3591, 1008, 4294959266, 4294966505, 6307, 1056, 1170, 4294967177, 4294957136, 576, 13482, 4294959930, 2737, 2805
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
