...
int main(){
    const int64_t data1[] = {
    -48, 84, -44, -41, -91, -102, 22, 21, 40, -84, -44, 9, 69, 117, -29, -88
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -20, -57, 30, -123, 30, 74, 125, 25, -118, 32, -105, -25, -55, -55, 98, -83
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vv_64m8_b8 (data1_v, data2_v, vl);
    ...
    int64_t golden[] = {
    0, 1, 0, 1, 0, 0, 0, 0, 1, 0, 1, 1, 1, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
