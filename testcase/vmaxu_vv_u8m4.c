...
int main(){
    const uint8_t data1[] = {
    231, 177, 214, 166, 177, 104, 168, 25, 66, 30, 138, 28, 242, 4, 199, 225
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    206, 126, 44, 183, 180, 43, 219, 39, 193, 26, 244, 164, 163, 139, 247, 15
    };
    ...
    uint8_t golden[] = {
    231, 177, 214, 183, 180, 104, 219, 39, 193, 30, 244, 164, 242, 139, 247, 225
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
