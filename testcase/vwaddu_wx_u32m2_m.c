...
int main(){
    ...
    145, 111, 77, 166, 148, 108, 90, 176, 120, 46, 67, 82, 101, 226, 125, 11
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    251, 139, 109, 9, 194, 149, 32, 154, 7, 149, 13, 10, 1, 150, 95, 197
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u32m2_m (mask, data1_v, data2_v, vl);
