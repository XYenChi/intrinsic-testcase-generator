...
int main(){
    ...
    160, 73, 250, 108, 170, 193, 51, 167, 225, 159, 108, 226, 88, 127, 208, 241
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    248, 8, 8, 0, 243, 146, 87, 228, 86, 66, 145, 134, 255, 122, 240, 237
    };
    ...
    uint16_t golden[] = {
    248, 73, 250, 108, 243, 193, 87, 228, 225, 159, 145, 226, 255, 127, 240, 241
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
