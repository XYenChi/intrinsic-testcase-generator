...
int main(){
    ...
    116, 148, 246, 43, 44, 19, 14, 254, 155, 125, 56, 57, 32, 180, 8, 178
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    139, 154, 69, 157, 35, 148, 207, 207, 219, 216, 54, 226, 158, 204, 13, 219
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u16mf4_m (mask, data1_v, data2_v, vl);
