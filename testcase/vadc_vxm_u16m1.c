...
int main(){
    ...
    141, 236, 244, 200, 61, 230, 20, 223, 118, 139, 78, 239, 172, 176, 10, 206
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    47, 3, 55, 84, 190, 82, 28, 245, 184, 129, 146, 126, 211, 25, 166, 18
    };
    ...
    uint16_t golden[] = {
    189, 239, 300, 284, 252, 312, 48, 469, 302, 268, 225, 366, 383, 201, 177, 225
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
