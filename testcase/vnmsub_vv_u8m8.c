...
int main(){
    const uint8_t data1[] = {
    18, 238, 21, 150, 87, 201, 28, 59, 43, 92, 201, 250, 104, 92, 143, 116
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    20, 129, 50, 79, 16, 93, 194, 8, 26, 87, 190, 251, 246, 229, 78, 99
    };
    ...
    uint8_t golden[] = {
    18, 238, 227, 150, 71, 108, 90, 51, 43, 5, 11, 250, 114, 92, 65, 17
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
