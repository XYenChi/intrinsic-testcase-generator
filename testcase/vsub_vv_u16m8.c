...
int main(){
    ...
    105, 144, 244, 164, 63, 180, 148, 80, 93, 168, 180, 149, 218, 67, 108, 239
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    138, 147, 226, 86, 26, 148, 150, 252, 209, 170, 172, 168, 62, 127, 33, 38
    };
    ...
    uint16_t golden[] = {
    65503, 65533, 18, 78, 37, 32, 65534, 65364, 65420, 65534, 8, 65517, 156, 65476, 75, 201
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
