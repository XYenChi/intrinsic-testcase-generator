...
int main(){
    ...
    1, 220, 192, 140, 59, 197, 151, 4, 20, 208, 137, 136, 187, 151, 234, 171
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    17, 104, 136, 232, 187, 48, 7, 29, 18, 124, 64, 32, 248, 84, 78, 183
    };
    ...
    uint16_t golden[] = {
    18, 324, 328, 372, 246, 245, 158, 33, 38, 332, 201, 168, 435, 235, 312, 354
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
