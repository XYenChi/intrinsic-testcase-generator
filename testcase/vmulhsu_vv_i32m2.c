...
int main(){
    const int32_t data1[] = {
    37, -82, -40, -53, -29, 76, -112, -114, -1, 127, -88, 117, -128, 17, -121, -114
    };
    const int32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    249, 21, 98, 100, 161, 70, 70, 36, 235, 168, 144, 139, 46, 122, 247, 245
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_32m2_b16 (data1_v, data2_v, vl);
