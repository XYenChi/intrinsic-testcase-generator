...
int main(){
    ...
    165, 118, 234, 206, 139, 72, 172, 187, 91, 114, 249, 36, 28, 222, 199, 99
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    64, 18, 103, 111, 123, 96, 243, 179, 11, 129, 29, 4, 127, 249, 100, 249
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wv_32mf2u_m (mask, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    1, 0, 0, 239, 251, 1, 0, 187, 0, 1, 253, 1, 127, 1, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
