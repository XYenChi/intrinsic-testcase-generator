...
int main(){
    const uint8_t data1[] = {
    114, 59, 206, 208, 26, 174, 204, 247, 44, 49, 76, 155, 61, 81, 27, 89
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    36, 58, 186, 195, 245, 244, 101, 233, 220, 108, 101, 140, 225, 241, 236, 122
    };
    ...
    uint8_t golden[] = {
    0, 58, 1, 1, 1, 1, 0, 233, 220, 108, 101, 140, 0, 241, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
