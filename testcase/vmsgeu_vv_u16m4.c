...
int main(){
    ...
    218, 123, 141, 212, 194, 124, 143, 176, 249, 141, 223, 39, 139, 177, 108, 132
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    217, 166, 247, 115, 6, 226, 29, 98, 98, 110, 246, 155, 114, 72, 134, 7
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_16m4_b4 (data1_v, data2_v, vl);
