...
int main(){
    ...
    38, 150, 204, 38, 25, 105, 164, 143, 154, 181, 129, 212, 92, 241, 175, 68
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    97, 234, 92, 4, 39, 120, 163, 72, 157, 59, 42, 246, 246, 210, 225, 76
    };
    ...
    uint16_t golden[] = {
    65477, 65452, 112, 34, 65522, 65521, 1, 71, 65533, 122, 87, 65502, 65382, 31, 65486, 65528
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
