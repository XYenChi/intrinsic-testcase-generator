...
int main(){
    const int8_t data1[] = {
    -116, -117, 96, 74, 117, -121, 109, 47, 61, 37, 122, 70, 10, 62, -54, 86
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -21, 52, 80, -83, -31, -65, 9, 109, -35, -29, -122, 21, 37, -52, -119, -50
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vv_8mf4_b32 (data1_v, data2_v, vl);
