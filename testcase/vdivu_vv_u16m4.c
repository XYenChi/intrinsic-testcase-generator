...
int main(){
    ...
    150, 13, 131, 191, 154, 37, 170, 244, 180, 38, 240, 12, 43, 170, 120, 134
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    243, 43, 125, 236, 134, 105, 208, 238, 74, 248, 91, 122, 109, 126, 245, 83
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i16m4 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    1, 3, 0, 1, 0, 2, 1, 0, 0, 6, 0, 10, 2, 0, 2, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
