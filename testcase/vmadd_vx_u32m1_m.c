...
int main(){
    ...
    149, 124, 192, 202, 250, 215, 139, 184, 99, 228, 197, 80, 92, 173, 185, 109
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    76, 191, 216, 54, 197, 171, 233, 151, 106, 248, 109, 83, 30, 108, 246, 231
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmadd_vx_u32m1_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    76, 315, 216, 54, 250, 171, 233, 151, 99, 228, 306, 163, 92, 173, 246, 340
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
