...
int main(){
    ...
    36, 200, 126, 45, 10, 175, 208, 60, 109, 33, 81, 107, 63, 49, 23, 34
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    217, 30, 88, 102, 235, 148, 112, 142, 203, 31, 71, 136, 217, 127, 42, 178
    };
    ...
    uint32_t golden[] = {
    217, 230, 126, 45, 10, 175, 208, 60, 109, 33, 81, 107, 217, 49, 23, 178
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
