...
int main(){
    const uint8_t data1[] = {
    130, 121, 209, 86, 19, 105, 138, 81, 120, 68, 204, 43, 204, 148, 42, 93
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    84, 71, 217, 136, 73, 122, 151, 51, 189, 145, 6, 244, 123, 8, 39, 125
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsac_vv_u8mf2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    88, 1, 215, 1, 150, 247, 154, 0, 0, 1, 0, 0, 252, 96, 154, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
