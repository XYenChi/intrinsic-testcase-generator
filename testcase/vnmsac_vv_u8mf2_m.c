...
int main(){
    const uint8_t data1[] = {
    245, 77, 29, 207, 25, 240, 33, 62, 133, 38, 247, 4, 242, 108, 59, 64
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    142, 53, 136, 144, 253, 223, 147, 80, 75, 158, 214, 95, 124, 14, 203, 208
    };
    ...
    uint8_t golden[] = {
    0, 1, 153, 1, 1, 1, 1, 0, 0, 0, 1, 132, 201, 25, 56, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
