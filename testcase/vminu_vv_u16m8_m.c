...
int main(){
    ...
    162, 75, 120, 151, 50, 66, 86, 202, 141, 230, 73, 32, 232, 167, 53, 53
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    88, 153, 228, 206, 6, 67, 128, 237, 164, 34, 151, 209, 254, 211, 153, 26
    };
    ...
    uint16_t golden[] = {
    162, 153, 0, 206, 50, 67, 1, 0, 0, 230, 0, 209, 1, 211, 0, 53
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
