...
int main(){
    const uint8_t data1[] = {
    155, 57, 78, 88, 242, 198, 110, 115, 215, 37, 114, 227, 156, 226, 19, 21
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    44, 68, 42, 231, 69, 78, 133, 155, 234, 137, 4, 103, 17, 103, 232, 25
    };
    ...
    uint8_t golden[] = {
    199, 125, 121, 319, 311, 277, 243, 270, 449, 175, 118, 330, 173, 330, 252, 46
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
