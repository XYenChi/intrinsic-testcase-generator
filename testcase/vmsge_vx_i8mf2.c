...
int main(){
    const int8_t data1[] = {
    98, -84, -111, -55, 100, -41, -36, -102, 102, 64, 84, 110, 62, 127, -34, 1
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -37, 25, -90, -117, 116, -42, -3, -80, -22, 38, 35, 126, 89, 17, -85, -24
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_8mf2_b16 (data1_v, data2_v, vl);
