...
int main(){
    const int32_t data1[] = {
    20, 15, 46, 18, 67, 54, 13, 30, 32, 11, 65, -10, -125, 36, -36, -49
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -19, -127, -28, -119, 107, 13, 93, -2, -84, 43, -76, -128, -115, -34, 59, -46
    };
    ...
    int32_t golden[] = {
    0, 1, 4294966008, 4294965154, 1, 702, 1209, 0, 4294964608, 473, 4294962356, 0, 1, 4294966072, 0, 2254
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
