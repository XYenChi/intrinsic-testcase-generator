...
int main(){
    const int64_t data1[] = {
    124, 54, -51, 74, -124, 76, 51, -85, -75, -76, -13, 44, -68, -45, 58, 92
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    9, 34, 50, -88, -26, -93, 82, -68, -101, -52, 57, -54, -91, -58, 54, 56
    };
    ...
    int64_t golden[] = {
    1, 0, 18446744073709551515, 162, 0, 169, 0, 18446744073709551599, 0, 0, 18446744073709551546, 98, 1, 13, 4, 36
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
