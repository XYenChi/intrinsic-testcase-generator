...
int main(){
    const int64_t data1[] = {
    60, -69, -116, 36, -86, -5, 122, -14, 26, 117, -21, -100, 84, 95, 120, 32
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -64, 61, -84, -38, 26, 13, 77, -5, -117, -97, 65, 127, 118, 89, 116, -3
    };
    ...
    int64_t golden[] = {
    124, 1, 0, 1, 18446744073709551504, 18446744073709551598, 0, 0, 0, 214, 18446744073709551530, 18446744073709551389, 18446744073709551582, 1, 0, 35
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
