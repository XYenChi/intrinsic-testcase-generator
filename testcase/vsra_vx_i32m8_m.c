...
int main(){
    const int32_t data1[] = {
    38, -10, -41, 15, -73, -119, 125, 119, 22, 7, 76, -33, 83, -1, -50, -44
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -52, 9, 15, -74, 10, 22, 10, -63, -124, 31, 100, 91, 48, 78, -52, -19
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsra_vx_i32m8_m (mask, data1_v, shift, vl);
    ...
    int32_t golden[] = {
    38, -5, -21, 15, -73, -119, 125, 59, 22, 3, 76, -17, 83, -1, -50, -22
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
