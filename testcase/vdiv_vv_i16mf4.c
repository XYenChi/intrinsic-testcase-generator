...
int main(){
    const int16_t data1[] = {
    -7, -42, 74, 49, -118, -109, 30, 5, 84, -98, 94, -85, -68, -63, -12, -87
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    46, 50, 35, 126, -92, -115, 62, 57, -57, 58, 3, -29, -24, -61, 106, 18
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdiv_vv_i16mf4 (data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    65529, 65534, 0, 2, 0, 1, 2, 11, 65535, 65535, 0, 0, 0, 0, 65527, 65535
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
