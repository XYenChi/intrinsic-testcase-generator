...
int main(){
    ...
    52, 151, 178, 193, 36, 133, 101, 46, 125, 109, 91, 173, 189, 196, 122, 11
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    52, 252, 219, 58, 64, 229, 247, 167, 10, 7, 25, 172, 182, 1, 46, 91
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u32m8 (data1_v, data2_v, vl);
