...
int main(){
    ...
    240, 200, 79, 201, 73, 23, 34, 108, 131, 252, 84, 245, 247, 116, 192, 184
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    183, 205, 180, 81, 25, 3, 23, 229, 65, 201, 151, 176, 89, 234, 30, 15
    };
    ...
    uint32_t golden[] = {
    423, 405, 259, 282, 98, 26, 57, 337, 196, 453, 235, 421, 336, 350, 222, 199
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
