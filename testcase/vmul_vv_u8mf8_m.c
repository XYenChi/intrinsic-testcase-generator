...
int main(){
    const uint8_t data1[] = {
    205, 118, 64, 223, 116, 62, 13, 233, 165, 180, 58, 229, 138, 197, 24, 211
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    72, 114, 217, 190, 141, 248, 113, 150, 120, 27, 80, 203, 216, 149, 239, 113
    };
    ...
    uint8_t golden[] = {
    168, 140, 64, 130, 0, 16, 189, 134, 88, 252, 1, 151, 1, 169, 0, 35
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
