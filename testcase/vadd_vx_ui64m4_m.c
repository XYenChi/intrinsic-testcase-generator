...
int main(){
    const int64_t data1[] = {
    75, 145, 220, 196, 223, 140, 242, 67, 156, 173, 51, 144, 92, 89, 102, 195
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    172, 83, 217, 108, 105, 14, 216, 63, 35, 10, 69, 222, 204, 73, 48, 201
    };
    const int64_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e64m4(avl);
    const int out_data[] = {
    224, 148, 230, 46, 242, 231, 112, 245, 154, 255, 212, 213, 0, 131, 214, 15
    };
    ...
    int64_t golden[] = {
    224, 228, 230, 255, 242, 231, 112, 245, 154, 183, 120, 213, 255, 162, 150, 255
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
