...
int main(){
    const int64_t data1[] = {
    5, 138, 88, 219, 114, 244, 232, 17, 255, 94, 84, 171, 40, 37, 130, 35
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    252, 131, 64, 109, 119, 102, 199, 242, 198, 137, 172, 12, 210, 162, 77, 83
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vv_ui64m1 (data1_v, data2_v, vl);
    ...
    int64_t golden[] = {
    0, 7, 24, 110, 0, 142, 33, 0, 57, 0, 0, 159, 0, 0, 53, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
