...
int main(){
    ...
    117, 1, 86, 213, 93, 192, 205, 12, 162, 109, 197, 17, 11, 7, 179, 122
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    199, 37, 142, 5, 142, 92, 186, 233, 246, 62, 152, 52, 6, 215, 115, 148
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i32m8 (data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    1, 37, 1, 0, 1, 0, 0, 19, 1, 0, 0, 3, 0, 30, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
