...
int main(){
    const int32_t data1[] = {
    113, -40, -18, -38, 122, 31, 56, 38, 125, -60, 7, 43, -114, 47, -104, -114
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -122, -79, -21, 84, 101, -23, 36, 120, -30, 93, 66, -15, 35, 12, -36, 65
    };
    ...
    int32_t golden[] = {
    1, 39, 3, 1, 0, 54, 20, 4294967214, 0, 1, 1, 1, 4294967147, 0, 4294967228, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
