...
int main(){
    const int16_t data1[] = {
    -23, -73, 24, -88, 79, 84, -89, -122, -111, 18, 3, 111, -93, 81, -93, -7
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -101, 63, 24, 84, -28, -122, 127, -20, -122, 35, 63, 90, 45, 102, -125, -10
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vv_16mf2_b32 (data1_v, data2_v, vl);
