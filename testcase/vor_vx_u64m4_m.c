...
int main(){
    ...
    138, 187, 26, 163, 92, 34, 158, 61, 72, 167, 95, 116, 144, 62, 1, 51
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    81, 78, 164, 248, 246, 73, 250, 74, 133, 192, 48, 211, 255, 179, 101, 245
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wx_64m4u_m (mask, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    1, 0, 1, 251, 1, 0, 0, 0, 205, 1, 127, 0, 1, 191, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
