...
int main(){
    ...
    218, 199, 236, 246, 132, 180, 57, 141, 4, 180, 198, 0, 241, 178, 206, 253
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    143, 142, 61, 148, 250, 125, 7, 131, 105, 68, 123, 116, 20, 30, 72, 81
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u16m1 (data1_v, data2_v, vl);
