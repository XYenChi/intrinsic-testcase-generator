...
int main(){
    const uint8_t data1[] = {
    32, 109, 142, 60, 251, 8, 71, 55, 159, 140, 133, 71, 171, 44, 64, 183
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    102, 163, 22, 71, 32, 218, 36, 146, 84, 48, 251, 156, 7, 142, 148, 121
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_8mf2_b16 (data1_v, data2_v, vl);
