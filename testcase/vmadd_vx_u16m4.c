...
int main(){
    ...
    167, 162, 39, 121, 230, 39, 134, 94, 81, 117, 73, 39, 179, 211, 31, 230
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    1, 126, 44, 107, 206, 105, 9, 198, 30, 241, 236, 209, 68, 252, 231, 1
    };
    ...
    uint16_t golden[] = {
    168, 288, 83, 107, 206, 105, 143, 198, 111, 241, 236, 209, 247, 463, 231, 231
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
