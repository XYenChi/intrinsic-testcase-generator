...
int main(){
    const int8_t data1[] = {
    27, 1, 50, 232, 2, 102, 126, 191, 174, 14, 150, 75, 2, 49, 0, 20
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    130, 235, 96, 31, 224, 230, 171, 188, 192, 187, 141, 49, 248, 175, 175, 136
    };
    ...
    int8_t golden[] = {
    157, 237, 147, 263, 227, 332, 297, 379, 366, 201, 291, 125, 250, 224, 176, 157
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
