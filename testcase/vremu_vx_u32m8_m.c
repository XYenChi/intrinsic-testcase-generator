...
int main(){
    ...
    2, 221, 86, 141, 160, 163, 144, 213, 72, 167, 9, 210, 207, 249, 174, 133
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    225, 230, 33, 230, 24, 231, 149, 157, 137, 166, 45, 0, 223, 107, 129, 186
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u32m8_m (mask, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    1, 9, 1, 89, 24, 68, 5, 1, 0, 0, 0, 0, 1, 0, 129, 53
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
