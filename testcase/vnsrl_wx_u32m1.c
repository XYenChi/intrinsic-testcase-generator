...
int main(){
    ...
    91, 214, 190, 64, 9, 94, 170, 181, 61, 52, 185, 85, 224, 5, 90, 162
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    125, 172, 238, 89, 170, 206, 155, 214, 146, 7, 232, 108, 58, 107, 253, 240
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_32m1 (data1_v, shift, vl);
