...
int main(){
    const uint8_t data1[] = {
    136, 14, 54, 108, 246, 236, 97, 114, 2, 0, 69, 105, 182, 136, 178, 192
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    68, 178, 255, 199, 149, 209, 30, 197, 76, 128, 7, 190, 76, 76, 9, 180
    };
    ...
    uint8_t golden[] = {
    136, 178, 255, 199, 246, 236, 97, 197, 76, 128, 69, 190, 182, 136, 178, 192
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
