...
int main(){
    const uint8_t data1[] = {
    219, 157, 228, 216, 11, 154, 128, 74, 81, 148, 20, 167, 238, 51, 76, 197
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    205, 43, 43, 242, 60, 108, 185, 143, 98, 122, 4, 150, 26, 149, 147, 172
    };
    ...
    uint8_t golden[] = {
    219, 157, 228, 242, 60, 154, 185, 143, 98, 148, 20, 167, 238, 149, 147, 197
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
