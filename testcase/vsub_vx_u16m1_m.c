...
int main(){
    ...
    145, 223, 135, 45, 107, 27, 254, 215, 64, 139, 243, 47, 12, 236, 98, 20
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    171, 43, 103, 144, 208, 72, 41, 72, 177, 15, 159, 230, 79, 76, 44, 155
    };
    ...
    uint16_t golden[] = {
    0, 0, 0, 1, 65435, 65491, 1, 143, 0, 1, 84, 0, 0, 1, 1, 65401
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
