...
int main(){
    const int16_t data1[] = {
    -101, 8, -36, 25, -121, 70, -102, -5, 44, 55, 30, 20, 58, 91, -57, 25
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -91, 70, 11, 21, -18, -105, -25, -54, 50, -38, -118, 31, 119, 39, 103, 36
    };
    ...
    int16_t golden[] = {
    65445, 6, 65511, 21, 65518, 35, 65511, 65532, 6, 17, 2, 11, 3, 39, 65525, 11
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
