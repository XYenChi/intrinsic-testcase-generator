...
int main(){
    const uint8_t data1[] = {
    20, 4, 7, 240, 152, 61, 57, 248, 217, 89, 187, 13, 212, 192, 162, 102
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    11, 248, 60, 203, 146, 151, 165, 116, 149, 125, 2, 150, 224, 180, 166, 210
    };
    ...
    uint8_t golden[] = {
    1, 1, 1, 240, 1, 0, 165, 248, 217, 0, 0, 1, 1, 0, 166, 210
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
