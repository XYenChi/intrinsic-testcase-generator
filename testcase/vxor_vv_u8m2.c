...
int main(){
    const uint8_t data1[] = {
    14, 0, 205, 226, 31, 17, 133, 46, 51, 218, 196, 151, 240, 254, 54, 133
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    21, 56, 178, 247, 103, 62, 122, 253, 67, 86, 18, 44, 43, 179, 208, 13
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u8m2 (data1_v, data2_v, vl);
