...
int main(){
    const int8_t data1[] = {
    -115, -30, 124, 96, -17, -116, 83, -7, -6, 10, 64, 19, 119, -62, -119, -46
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    70, -62, 1, -31, 32, -100, -4, -84, -122, 100, 33, -102, -121, -39, 27, 29
    };
    ...
    int8_t golden[] = {
    142, 68, 124, 96, 224, 80, 180, 76, 220, 232, 64, 110, 193, 114, 115, 202
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
