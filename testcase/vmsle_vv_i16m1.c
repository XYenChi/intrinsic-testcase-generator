...
int main(){
    const int16_t data1[] = {
    47, 26, 65, -95, -86, -30, 16, 119, -56, 99, 33, -14, -15, 110, -10, 21
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    2, -76, -108, -100, -34, 25, -45, 116, 73, 85, -50, 66, 74, 113, 103, 57
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vv_16m1_b16 (data1_v, data2_v, vl);
