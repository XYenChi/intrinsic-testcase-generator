...
int main(){
    ...
    110, 231, 41, 173, 62, 1, 107, 31, 248, 43, 219, 30, 183, 13, 166, 33
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    62, 78, 31, 91, 117, 144, 116, 104, 153, 134, 152, 246, 123, 242, 206, 62
    };
    ...
    uint64_t golden[] = {
    0, 18018, 0, 1, 7254, 145, 1, 3225, 1, 1, 0, 1, 0, 1, 0, 2047
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
