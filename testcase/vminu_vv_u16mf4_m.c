...
int main(){
    ...
    148, 253, 7, 5, 154, 92, 215, 241, 252, 136, 25, 72, 218, 149, 185, 194
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    0, 230, 138, 40, 115, 233, 95, 247, 53, 167, 73, 43, 169, 220, 41, 84
    };
    ...
    uint16_t golden[] = {
    148, 1, 0, 40, 154, 233, 0, 1, 252, 1, 0, 72, 218, 0, 185, 194
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
