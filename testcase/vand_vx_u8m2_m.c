...
int main(){
    const uint8_t data1[] = {
    56, 60, 18, 68, 153, 76, 170, 74, 60, 141, 254, 7, 167, 62, 16, 123
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    25, 38, 245, 84, 216, 204, 75, 170, 87, 147, 11, 141, 25, 196, 57, 180
    };
    ...
    uint8_t golden[] = {
    25, 38, 245, 1, 1, 0, 1, 170, 87, 147, 0, 0, 25, 196, 57, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
