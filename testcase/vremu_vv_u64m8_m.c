...
int main(){
    ...
    177, 123, 242, 230, 118, 14, 54, 95, 146, 47, 99, 87, 49, 10, 8, 133
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    26, 109, 19, 165, 4, 241, 254, 8, 36, 190, 139, 52, 93, 243, 198, 175
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u64m8_m (mask, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    1, 109, 1, 1, 1, 1, 38, 8, 36, 2, 0, 52, 0, 3, 6, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
