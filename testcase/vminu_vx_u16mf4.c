...
int main(){
    ...
    165, 110, 143, 250, 232, 101, 207, 195, 21, 223, 230, 36, 26, 165, 96, 233
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    251, 32, 207, 201, 123, 166, 210, 170, 102, 212, 222, 59, 255, 18, 14, 154
    };
    ...
    uint16_t golden[] = {
    251, 110, 207, 250, 232, 166, 210, 195, 102, 223, 230, 59, 255, 165, 96, 233
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
