...
int main(){
    ...
    89, 172, 182, 5, 147, 190, 241, 149, 72, 28, 100, 141, 201, 130, 237, 161
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    235, 144, 209, 58, 211, 9, 184, 141, 202, 112, 64, 7, 213, 130, 229, 181
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_32mf2_b64 (data1_v, data2_v, vl);
