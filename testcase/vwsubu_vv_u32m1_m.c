...
int main(){
    ...
    195, 66, 70, 68, 12, 138, 218, 85, 44, 169, 159, 228, 35, 205, 88, 120
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    72, 142, 136, 198, 87, 193, 8, 21, 252, 47, 57, 25, 98, 31, 189, 113
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u32m1_m (mask, data1_v, data2_v, vl);
