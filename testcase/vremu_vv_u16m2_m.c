...
int main(){
    ...
    150, 153, 69, 149, 252, 46, 214, 69, 115, 76, 36, 157, 74, 2, 102, 169
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    151, 31, 235, 225, 56, 135, 128, 225, 9, 250, 77, 26, 147, 99, 200, 242
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u16m2_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    1, 31, 28, 1, 56, 43, 0, 1, 9, 22, 5, 26, 73, 1, 98, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
