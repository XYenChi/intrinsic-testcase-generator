...
int main(){
    ...
    183, 35, 146, 132, 64, 202, 38, 247, 161, 156, 167, 241, 201, 158, 198, 38
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    144, 162, 27, 5, 123, 230, 178, 64, 67, 229, 16, 106, 46, 252, 175, 93
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u16m8 (data1_v, shift, vl);
