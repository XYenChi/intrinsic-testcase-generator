...
int main(){
    const int8_t data1[] = {
    88, -100, -106, 112, -75, -104, -124, -96, -115, 24, -24, 116, -36, 35, -80, -125
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    69, 121, -37, -89, 9, -75, -84, -23, -20, 60, -48, 74, -120, -80, 24, -28
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vv_8mf2_b16_m (mask, data1_v, data2_v, vl);
