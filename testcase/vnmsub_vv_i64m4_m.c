...
int main(){
    const int64_t data1[] = {
    -41, 77, -102, 52, 76, -82, -54, 40, 14, 34, -87, -106, 83, 117, -99, -8
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    18, 93, 119, 17, 40, 16, 50, 112, 17, -106, 23, 98, 5, -40, -10, 17
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsub_vv_i64m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int64_t golden[] = {
    0, 18446744073709551600, 1, 0, 76, 0, 0, 18446744073709551544, 14, 0, 18446744073709551506, 0, 1, 117, 0, 18446744073709551608
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
