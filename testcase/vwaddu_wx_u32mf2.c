...
int main(){
    ...
    180, 240, 154, 192, 82, 165, 249, 18, 225, 47, 158, 98, 22, 97, 15, 180
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    128, 116, 76, 95, 182, 242, 174, 217, 211, 246, 102, 245, 21, 55, 84, 102
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u32mf2 (data1_v, data2_v, vl);
