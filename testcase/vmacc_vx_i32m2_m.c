...
int main(){
    const int32_t data1[] = {
    90, -41, 59, -73, -126, -120, 27, 31, -14, -36, 41, -86, -80, -81, -28, -60
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    9, -92, 71, -101, 81, -9, 76, -110, 20, 27, -124, -51, -8, -32, 3, -101
    };
    const int32_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e32m2(avl);
    const int out_data[] = {
    0, 0, 0, 1, 1, 0, 1, 0, 1, 0, 0, 0, 1, 0, 0, 0
    };
    ...
    int32_t golden[] = {
    0, 3772, 4189, 1, 4294957091, 1080, 2053, 0, 4294967017, 0, 4294962212, 0, 1, 0, 4294967212, 6060
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
