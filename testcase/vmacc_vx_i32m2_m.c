...
int main(){
    const int32_t data1[] = {
    -37, -3, -121, -24, -4, 114, 84, 11, 4, -33, -115, 87, 87, 35, 65, -36
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -115, 29, -57, -67, 51, 42, -29, 34, -16, 105, -126, 13, -124, 93, 82, 31
    };
    ...
    int32_t golden[] = {
    4256, 1, 1, 1609, 4294967093, 4788, 4294964860, 374, 4294967233, 4294963832, 14490, 1131, 1, 3255, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
