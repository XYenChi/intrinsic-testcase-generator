...
int main(){
    ...
    171, 8, 1, 53, 145, 43, 128, 163, 208, 109, 174, 147, 3, 147, 24, 170
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    155, 30, 61, 155, 11, 112, 31, 112, 79, 4, 116, 167, 12, 31, 174, 246
    };
    ...
    uint64_t golden[] = {
    0, 8, 18446744073709551556, 0, 145, 1, 97, 0, 1, 109, 1, 18446744073709551596, 18446744073709551607, 0, 0, 18446744073709551540
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
