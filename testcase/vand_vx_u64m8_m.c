...
int main(){
    ...
    181, 175, 245, 61, 244, 129, 199, 15, 39, 167, 224, 7, 223, 250, 253, 170
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    176, 117, 149, 131, 45, 229, 254, 124, 62, 193, 27, 37, 159, 143, 104, 114
    };
    ...
    uint64_t golden[] = {
    176, 0, 149, 0, 0, 229, 254, 1, 1, 193, 27, 37, 159, 0, 1, 114
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
