...
int main(){
    ...
    89, 224, 242, 134, 93, 134, 230, 158, 163, 78, 237, 249, 46, 250, 38, 243
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    136, 170, 2, 194, 18, 106, 174, 110, 247, 113, 12, 218, 150, 102, 251, 203
    };
    ...
    uint32_t golden[] = {
    136, 394, 2, 194, 18, 106, 174, 268, 247, 113, 12, 467, 196, 102, 289, 446
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
