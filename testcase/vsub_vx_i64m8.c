...
int main(){
    const int64_t data1[] = {
    115, 54, -64, 90, -103, -115, -43, 118, -104, -3, 1, -21, 36, -113, -99, 22
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -119, 111, -70, -11, 23, 120, 112, 83, -13, -63, -44, 41, -18, -65, 38, -115
    };
    ...
    int64_t golden[] = {
    127, -57, 6, 101, -126, -128, -128, 35, -91, 60, 45, -62, 54, -48, -128, 127
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
