...
int main(){
    ...
    112, 181, 72, 60, 254, 37, 48, 131, 231, 71, 12, 143, 5, 204, 21, 2
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    250, 61, 246, 244, 173, 97, 24, 215, 15, 127, 97, 250, 42, 143, 125, 106
    };
    ...
    uint32_t golden[] = {
    250, 181, 246, 244, 254, 97, 48, 215, 231, 127, 97, 250, 42, 204, 125, 106
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
