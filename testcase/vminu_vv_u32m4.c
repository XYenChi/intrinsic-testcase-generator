...
int main(){
    ...
    212, 176, 224, 30, 47, 53, 81, 211, 242, 142, 181, 52, 150, 182, 37, 42
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    177, 45, 140, 241, 92, 49, 31, 60, 99, 56, 45, 59, 84, 53, 0, 27
    };
    ...
    uint32_t golden[] = {
    212, 176, 224, 241, 92, 53, 81, 211, 242, 142, 181, 59, 150, 182, 37, 42
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
