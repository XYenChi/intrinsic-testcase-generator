...
int main(){
    ...
    204, 14, 219, 205, 103, 122, 181, 69, 67, 69, 125, 188, 234, 71, 63, 73
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    71, 78, 182, 182, 53, 179, 91, 228, 98, 238, 120, 86, 130, 65, 48, 102
    };
    ...
    uint32_t golden[] = {
    204, 78, 219, 205, 103, 179, 181, 228, 98, 238, 125, 188, 234, 71, 63, 102
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
