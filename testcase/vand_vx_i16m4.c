...
int main(){
    const int16_t data1[] = {
    108, 94, 28, 67, 36, 115, 113, 12, 75, 108, 124, 84, -7, 30, -27, 91
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -74, -44, 1, -72, 2, 37, -11, 66, -97, -66, -128, 59, 117, 31, -109, -4
    };
    ...
    int16_t golden[] = {
    65462, 65492, 1, 65464, 2, 37, 65525, 66, 65439, 65470, 65408, 59, 117, 31, 65427, 65532
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
