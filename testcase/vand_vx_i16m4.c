...
int main(){
    const int16_t data1[] = {
    -78, -109, -90, -10, -71, 102, 81, -48, -8, 81, -30, 97, 118, -56, 16, 89
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -26, -33, -3, -93, 119, 4, 91, -93, 95, -7, 58, 61, 50, 10, 85, 53
    };
    ...
    int16_t golden[] = {
    65510, 65503, 65533, 65443, 119, 4, 91, 65443, 95, 65529, 58, 61, 50, 10, 85, 53
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
