...
int main(){
    ...
    77, 207, 13, 203, 43, 50, 118, 151, 188, 119, 194, 39, 43, 134, 37, 251
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    7, 38, 99, 139, 204, 17, 31, 61, 37, 218, 172, 85, 63, 151, 185, 87
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u16mf4_m (mask, data1_v, data2_v, vl);
