...
int main(){
    ...
    209, 87, 36, 70, 127, 29, 37, 18, 251, 31, 180, 204, 218, 116, 204, 114
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    175, 215, 230, 169, 15, 208, 212, 190, 138, 219, 249, 66, 255, 74, 48, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_16mf4_m (mask, data1_v, shift, vl);
