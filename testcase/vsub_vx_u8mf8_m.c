...
int main(){
    const uint8_t data1[] = {
    127, 84, 246, 22, 173, 123, 71, 190, 198, 62, 140, 152, 47, 123, 53, 184
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    131, 157, 187, 43, 3, 166, 197, 211, 143, 162, 36, 243, 65, 107, 175, 111
    };
    ...
    uint8_t golden[] = {
    252, 183, 59, 235, 170, 213, 130, 0, 55, 1, 1, 165, 238, 16, 134, 73
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
