...
int main(){
    const int64_t data1[] = {
    53, 30, 56, 95, 82, -35, -116, 114, -2, -52, 82, 37, -20, 68, 20, 96
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    34, 57, 61, -39, -86, 13, 56, 14, -11, -89, -126, -20, 48, -109, 19, 27
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vv_64m8_b8_m (mask, data1_v, data2_v, vl);
