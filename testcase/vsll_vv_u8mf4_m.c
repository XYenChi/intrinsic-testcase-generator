...
int main(){
    const uint8_t data1[] = {
    55, 120, 142, 168, 213, 245, 243, 29, 70, 134, 187, 46, 148, 254, 22, 109
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    159, 125, 19, 13, 80, 120, 223, 204, 37, 167, 175, 138, 96, 137, 14, 247
    };
    ...
    uint8_t golden[] = {
    110, 240, 284, 336, 213, 245, 486, 29, 140, 268, 374, 46, 148, 508, 22, 218
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
