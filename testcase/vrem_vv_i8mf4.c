...
int main(){
    const int8_t data1[] = {
    38, -92, -123, -4, 123, 84, -97, -100, 88, 33, 42, 1, 64, 121, -5, 0
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -112, -13, -87, 69, 79, -43, 105, 26, -78, -54, -113, 14, -65, -89, -103, -62
    };
    ...
    int8_t golden[] = {
    2, 243, 169, 253, 79, 41, 167, 182, 10, 12, 13, 0, 63, 32, 253, 194
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
