...
int main(){
    ...
    5, 192, 97, 12, 19, 105, 111, 233, 3, 178, 35, 108, 241, 94, 142, 7
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    75, 95, 242, 135, 128, 6, 131, 20, 190, 225, 53, 1, 125, 82, 32, 232
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u16m2_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    0, 95, 48, 3, 1, 6, 1, 20, 1, 1, 0, 0, 0, 0, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
