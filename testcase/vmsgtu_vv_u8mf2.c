...
int main(){
    const uint8_t data1[] = {
    131, 231, 86, 85, 12, 169, 234, 228, 231, 248, 246, 215, 202, 141, 30, 243
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    192, 111, 121, 171, 251, 170, 218, 108, 21, 108, 96, 130, 172, 77, 28, 41
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_8mf2_b16 (data1_v, data2_v, vl);
