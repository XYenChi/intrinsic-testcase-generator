...
int main(){
    ...
    1, 170, 39, 199, 204, 187, 9, 212, 244, 41, 124, 36, 237, 107, 210, 94
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    245, 22, 13, 219, 147, 148, 124, 92, 185, 98, 76, 178, 81, 243, 68, 15
    };
    ...
    uint16_t golden[] = {
    245, 22, 13, 418, 147, 148, 124, 304, 185, 98, 200, 178, 81, 243, 68, 109
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
