...
int main(){
    const int16_t data1[] = {
    12, 191, 118, 11, 183, 38, 87, 7, 218, 213, 49, 17, 187, 157, 42, 23
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    55, 211, 255, 232, 45, 205, 58, 103, 21, 90, 178, 226, 42, 124, 73, 79
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vx_ui16m1 (data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    0, 0, 0, 0, 138, 0, 29, 0, 197, 123, 0, 0, 145, 33, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
