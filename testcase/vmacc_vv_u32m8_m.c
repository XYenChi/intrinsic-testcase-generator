...
int main(){
    ...
    80, 53, 82, 188, 214, 77, 25, 84, 91, 104, 86, 188, 64, 148, 178, 98
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    151, 38, 254, 18, 70, 138, 23, 207, 135, 1, 99, 0, 201, 106, 51, 77
    };
    ...
    uint32_t golden[] = {
    1, 1, 0, 1, 1, 10626, 1, 17388, 12286, 0, 0, 0, 12865, 1, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
