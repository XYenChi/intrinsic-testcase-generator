...
int main(){
    ...
    75, 255, 52, 154, 83, 65, 234, 4, 188, 155, 140, 135, 93, 38, 54, 105
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    112, 31, 151, 180, 57, 237, 71, 74, 49, 152, 198, 61, 12, 29, 221, 73
    };
    ...
    uint16_t golden[] = {
    75, 510, 104, 154, 166, 130, 468, 4, 376, 155, 140, 270, 93, 76, 108, 210
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
