...
int main(){
    const int32_t data1[] = {
    -56, 66, 10, 47, -46, -84, 24, -62, -49, -79, -86, 3, 0, -40, -79, 33
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    100, -42, 104, -78, -9, -70, -62, -23, -128, 58, -35, 45, 125, -74, -115, -85
    };
    ...
    int32_t golden[] = {
    5600, 2772, 4294966256, 3666, 4294966883, 4294961416, 1488, 4294965871, 4294961025, 4583, 4294964287, 4294967161, 0, 4294964336, 4294958212, 2806
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
