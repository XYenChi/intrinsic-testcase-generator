...
int main(){
    const int16_t data1[] = {
    -50, 18, 0, 29, -120, 29, 75, 77, -119, -81, -63, -45, -91, -17, -28, -83
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    47, -46, -64, -34, -58, -71, -12, 42, 75, 115, -25, 115, -53, -124, -100, 83
    };
    ...
    int16_t golden[] = {
    65533, 8, 65472, 24, 65478, 16, 63, 42, 65492, 65489, 65511, 65516, 65483, 65531, 65520, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
