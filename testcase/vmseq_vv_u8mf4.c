...
int main(){
    const uint8_t data1[] = {
    108, 6, 109, 58, 232, 233, 117, 113, 41, 122, 171, 118, 47, 133, 190, 221
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    93, 236, 189, 142, 84, 72, 67, 157, 35, 200, 114, 76, 187, 124, 37, 30
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_8mf4_b32 (data1_v, data2_v, vl);
