...
int main(){
    const uint8_t data1[] = {
    215, 72, 246, 128, 0, 137, 225, 29, 127, 149, 131, 45, 80, 4, 209, 72
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    202, 197, 160, 77, 188, 136, 199, 149, 175, 138, 55, 220, 80, 247, 239, 174
    };
    ...
    uint8_t golden[] = {
    215, 72, 246, 128, 0, 136, 225, 29, 175, 138, 131, 220, 80, 247, 239, 174
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
