...
int main(){
    const uint8_t data1[] = {
    205, 220, 10, 227, 219, 27, 83, 59, 207, 218, 119, 225, 30, 45, 137, 247
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    115, 177, 197, 203, 172, 160, 165, 192, 101, 25, 134, 35, 156, 36, 83, 105
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_8m2_b4 (mask, data1_v, data2_v, vl);
