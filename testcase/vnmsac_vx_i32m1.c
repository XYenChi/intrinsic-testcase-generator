...
int main(){
    const int32_t data1[] = {
    114, 47, -78, -100, 30, 122, 8, -105, 56, -3, -121, 89, 41, 10, 30, 84
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -26, -96, 49, 54, -8, 48, -120, 32, -32, -72, -89, -124, 12, -50, -56, -38
    };
    ...
    int32_t golden[] = {
    2964, 4513, 3823, 5401, 240, 4294961441, 961, 3361, 1792, 4294967080, 4294956528, 11036, 4294966805, 501, 1681, 3193
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
