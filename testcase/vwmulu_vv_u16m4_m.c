...
int main(){
    ...
    175, 59, 197, 49, 16, 155, 48, 146, 115, 181, 55, 94, 27, 22, 179, 52
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    19, 122, 118, 161, 12, 149, 110, 104, 142, 238, 102, 74, 47, 65, 203, 174
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulu_vv_u16m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    0, 7198, 23246, 7889, 192, 23095, 5280, 0, 16330, 43078, 5610, 0, 1269, 1430, 36337, 9048
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
