...
int main(){
    ...
    56, 226, 152, 203, 180, 17, 134, 183, 23, 190, 159, 252, 75, 232, 23, 36
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    133, 127, 101, 71, 6, 82, 178, 44, 124, 137, 2, 245, 138, 181, 101, 252
    };
    ...
    uint32_t golden[] = {
    7449, 28702, 15353, 14413, 1081, 1394, 23852, 8053, 2853, 26031, 318, 61741, 10350, 41992, 2323, 9073
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
