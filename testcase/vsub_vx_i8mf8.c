...
int main(){
    const int8_t data1[] = {
    30, -83, 44, -94, -119, 23, -4, 59, -39, -85, -41, -12, -5, -39, 36, -122
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -102, -92, 112, 72, -61, -43, 38, -111, -125, -43, -18, -50, 18, -118, 44, -69
    };
    ...
    int8_t golden[] = {
    132, 9, 188, 90, 198, 66, 214, 170, 86, 214, 233, 38, 233, 79, 248, 203
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
