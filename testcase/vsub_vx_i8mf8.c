...
int main(){
    const int8_t data1[] = {
    -118, 65, -2, 65, -43, 60, 68, 40, -11, 93, 86, -115, 76, 59, 3, 11
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    119, 7, 54, -128, -124, -87, -98, 123, -76, -42, -90, -43, -43, -83, -8, 121
    };
    ...
    int8_t golden[] = {
    -128, 58, -56, 127, 81, 127, 127, -83, 65, 127, 127, -72, 119, 127, 11, -110
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
