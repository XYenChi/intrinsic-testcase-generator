...
int main(){
    const int8_t data1[] = {
    247, 154, 13, 62, 48, 107, 201, 140, 247, 211, 142, 140, 162, 73, 184, 172
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    239, 107, 186, 38, 125, 183, 129, 23, 235, 66, 25, 126, 34, 98, 154, 106
    };
    ...
    int8_t golden[] = {
    8, 47, -173, 24, -77, -76, 72, 117, 12, 145, 117, 14, 128, -25, 30, 66
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
