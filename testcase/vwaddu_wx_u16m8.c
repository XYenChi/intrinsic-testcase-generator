...
int main(){
    ...
    51, 241, 33, 44, 107, 83, 129, 43, 69, 228, 202, 120, 64, 211, 70, 161
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    100, 121, 35, 57, 87, 150, 204, 4, 151, 50, 34, 229, 119, 3, 183, 143
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u16m8 (data1_v, data2_v, vl);
