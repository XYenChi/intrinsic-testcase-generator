...
int main(){
    ...
    226, 175, 212, 38, 86, 37, 215, 255, 254, 204, 91, 168, 157, 7, 78, 192
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    56, 48, 168, 156, 58, 150, 213, 246, 251, 133, 13, 48, 161, 89, 89, 249
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i16m1 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    0, 0, 0, 4, 0, 4, 0, 0, 0, 0, 0, 0, 1, 12, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
