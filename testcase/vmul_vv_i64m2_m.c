...
int main(){
    const int64_t data1[] = {
    60, 39, 119, 100, -118, -84, -104, 60, -73, 79, 59, 47, -124, 31, -51, 82
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    79, -119, -64, -47, 72, -96, -84, -24, -65, -126, -8, -18, 79, 68, 62, 16
    };
    ...
    int64_t golden[] = {
    1, 1, 18446744073709544000, 18446744073709546916, 18446744073709543120, 8064, 8736, 1, 0, 0, 18446744073709551144, 1, 1, 1, 18446744073709548454, 1312
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
