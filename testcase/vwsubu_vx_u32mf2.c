...
int main(){
    ...
    175, 140, 229, 42, 97, 197, 191, 14, 232, 131, 152, 165, 0, 108, 158, 25
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    20, 23, 205, 172, 25, 26, 219, 128, 61, 175, 5, 155, 105, 48, 195, 43
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u32mf2 (data1_v, data2_v, vl);
