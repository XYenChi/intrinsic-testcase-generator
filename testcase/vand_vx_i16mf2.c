...
int main(){
    const int16_t data1[] = {
    -18, 81, 81, -90, -48, 8, -92, 48, -124, 115, -75, 110, 44, 70, 80, 7
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -54, -80, -10, -10, 99, 69, -119, -126, -44, -83, 101, -78, 36, -59, -82, 68
    };
    ...
    int16_t golden[] = {
    65482, 65456, 65526, 65526, 99, 69, 65417, 65410, 65492, 65453, 101, 65458, 36, 65477, 65454, 68
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
