...
int main(){
    const int16_t data1[] = {
    48, -21, -57, 37, -92, -82, 48, -48, 110, 108, -49, -100, -115, -85, -13, 10
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -107, 91, 32, -77, 118, -123, -123, 82, 65, 0, -51, 52, 8, 7, 50, -62
    };
    ...
    int16_t golden[] = {
    65429, 91, 32, 65459, 118, 65413, 65413, 82, 65, 0, 65485, 52, 8, 7, 50, 65474
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
