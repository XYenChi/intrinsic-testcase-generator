...
int main(){
    const uint8_t data1[] = {
    221, 19, 32, 109, 150, 25, 143, 183, 247, 41, 142, 12, 64, 165, 69, 226
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    162, 56, 215, 115, 133, 26, 151, 243, 112, 5, 210, 41, 67, 122, 162, 13
    };
    ...
    uint8_t golden[] = {
    218, 1, 224, 247, 0, 1, 89, 181, 0, 1, 0, 0, 192, 162, 170, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
