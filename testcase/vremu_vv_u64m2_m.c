...
int main(){
    ...
    203, 255, 181, 66, 125, 66, 245, 149, 223, 23, 64, 117, 218, 119, 102, 240
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    160, 220, 26, 43, 5, 192, 24, 148, 38, 211, 198, 187, 24, 40, 171, 189
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u64m2_m (mask, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    1, 220, 1, 43, 0, 0, 0, 148, 0, 1, 6, 0, 0, 1, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
