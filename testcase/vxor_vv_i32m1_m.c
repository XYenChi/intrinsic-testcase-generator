...
int main(){
    const int32_t data1[] = {
    -84, -114, 15, -59, -51, 91, 32, -115, 62, -94, 109, -48, -41, 2, 82, 59
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    109, 5, -72, -112, -32, -39, 43, -60, 90, 69, -25, 92, -38, -91, -103, -1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_i32m1_m (mask, data1_v, data2_v, vl);
