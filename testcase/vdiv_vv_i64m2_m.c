...
int main(){
    const int64_t data1[] = {
    -87, 127, -89, 60, 26, -100, 63, 125, 14, -73, 20, -24, 81, -85, -34, -79
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    90, -118, 110, -84, 67, -5, 60, 78, 44, 43, -115, -23, -61, 72, 77, -103
    };
    ...
    int64_t golden[] = {
    18446744073709551614, 1, 18446744073709551614, 1, 1, 0, 0, 0, 3, 18446744073709551615, 18446744073709551610, 0, 0, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
