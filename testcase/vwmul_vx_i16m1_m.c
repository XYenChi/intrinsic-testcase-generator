...
int main(){
    const int16_t data1[] = {
    114, -23, 72, -111, -97, 12, 26, -14, -3, 103, 63, 79, -66, -71, -19, 39
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    -11, -69, 66, -99, 8, -59, -102, -118, 57, 4, 36, 91, -53, -11, 42, 79
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmul_vx_i16m1_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    64282, 0, 4752, 10989, 1, 1, 62884, 0, 1, 1, 2268, 1, 3498, 781, 64738, 3081
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
