...
int main(){
    ...
    208, 29, 170, 112, 179, 156, 64, 84, 63, 214, 194, 28, 150, 56, 33, 180
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    53, 46, 120, 70, 176, 157, 170, 231, 250, 227, 208, 72, 211, 255, 129, 159
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u64m1_m (mask, data1_v, data2_v, vl);
