...
int main(){
    ...
    244, 137, 7, 112, 222, 12, 201, 183, 227, 63, 75, 125, 163, 7, 91, 176
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    83, 76, 85, 206, 51, 255, 91, 233, 137, 95, 37, 205, 209, 135, 216, 114
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u32m1_m (mask, data1_v, data2_v, vl);
