...
int main(){
    const int16_t data1[] = {
    -108, 41, 48, 116, 76, 108, -4, -113, -28, 83, -46, 3, -25, -127, -103, 113
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    -36, -47, 4, 76, 75, -13, -47, -35, 74, 9, -23, -90, -79, -75, -124, 120
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmul_vv_i16m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    1, 1, 192, 8816, 0, 64132, 1, 3955, 63464, 747, 1058, 0, 1, 9525, 1, 13560
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
