...
int main(){
    ...
    225, 2, 75, 63, 145, 183, 72, 163, 46, 13, 124, 238, 240, 99, 53, 141
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    190, 254, 253, 237, 165, 181, 197, 187, 53, 72, 78, 96, 31, 209, 3, 137
    };
    ...
    uint32_t masked[] = {
    0, 1, 0, 0, 1, 1, 1, 0, 1, 0, 1, 1, 0, 1, 0, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vv_u16mf2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    0, 508, 1, 1, 23925, 33123, 14185, 1, 2439, 1, 9673, 22848, 0, 20692, 1, 19317
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
