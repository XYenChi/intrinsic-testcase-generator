...
int main(){
    ...
    125, 134, 164, 204, 85, 13, 46, 112, 67, 252, 253, 246, 115, 16, 149, 124
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    187, 122, 172, 174, 205, 239, 178, 28, 52, 184, 41, 248, 106, 65, 196, 222
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u32m8_m (mask, data1_v, data2_v, vl);
