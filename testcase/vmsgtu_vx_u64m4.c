...
int main(){
    ...
    209, 219, 89, 220, 203, 184, 102, 62, 49, 239, 66, 166, 80, 239, 202, 199
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    95, 187, 236, 128, 243, 132, 217, 65, 33, 70, 174, 226, 128, 174, 46, 192
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_64m4_b16 (data1_v, data2_v, vl);
