...
int main(){
    const int16_t data1[] = {
    -81, -30, -42, -68, -77, 13, 37, -117, -108, 112, 117, -107, 74, -115, 114, -55
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    106, -70, 50, -125, 62, -105, 39, -75, -120, -107, 72, 16, 62, -63, 69, -112
    };
    ...
    int16_t golden[] = {
    -128, 40, -92, 57, -128, 118, -2, -42, 12, 127, 45, -123, 12, -52, 45, 57
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
