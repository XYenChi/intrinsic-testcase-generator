...
int main(){
    ...
    92, 147, 82, 209, 10, 118, 75, 56, 250, 180, 132, 146, 158, 127, 38, 202
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    166, 245, 35, 87, 13, 125, 126, 113, 208, 9, 43, 110, 198, 74, 229, 136
    };
    ...
    uint16_t golden[] = {
    15272, 36015, 2870, 18183, 130, 14750, 9450, 6328, 52000, 1620, 5676, 16060, 31284, 9398, 8702, 27472
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
