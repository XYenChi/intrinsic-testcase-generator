...
int main(){
    ...
    189, 138, 238, 196, 120, 15, 60, 172, 8, 109, 143, 85, 254, 83, 166, 215
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    189, 245, 206, 136, 253, 17, 229, 83, 51, 79, 155, 57, 160, 221, 146, 212
    };
    ...
    uint16_t golden[] = {
    35721, 33810, 49028, 26656, 30360, 255, 13740, 14276, 408, 8611, 22165, 4845, 40640, 18343, 24236, 45580
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
