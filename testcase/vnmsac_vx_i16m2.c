...
int main(){
    const int16_t data1[] = {
    -72, 41, 28, 127, -72, -23, -88, 57, 21, 28, -87, -34, 76, -66, 46, 102
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    16, -58, 109, -74, -97, 38, 83, -112, 3, 34, 119, 1, 43, 122, 62, 67
    };
    ...
    int16_t golden[] = {
    1153, 2379, 62485, 9399, 58552, 875, 7305, 6385, 65474, 64585, 10354, 35, 62268, 8053, 62684, 58702
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
