...
int main(){
    ...
    122, 148, 53, 176, 180, 208, 53, 96, 126, 59, 205, 103, 223, 82, 193, 116
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    8, 241, 36, 206, 180, 32, 46, 139, 67, 117, 42, 195, 69, 141, 42, 88
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u16m1_m (mask, data1_v, data2_v, vl);
