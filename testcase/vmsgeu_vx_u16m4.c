...
int main(){
    ...
    187, 17, 145, 27, 35, 228, 9, 225, 61, 99, 173, 138, 248, 133, 63, 250
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    190, 215, 137, 44, 218, 3, 38, 173, 74, 241, 36, 86, 176, 13, 225, 215
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_16m4_b4 (data1_v, data2_v, vl);
