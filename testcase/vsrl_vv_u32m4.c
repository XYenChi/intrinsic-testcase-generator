...
int main(){
    ...
    31, 4, 144, 131, 8, 217, 159, 172, 232, 230, 116, 57, 91, 173, 23, 56
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    70, 36, 17, 27, 122, 44, 67, 121, 171, 250, 254, 86, 78, 252, 122, 55
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u32m4 (data1_v, shift, vl);
