...
int main(){
    const int64_t data1[] = {
    -116, -80, -106, -55, -87, 46, 57, -39, -13, 50, 108, 5, -53, -62, -47, -50
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -51, 113, 51, -51, 13, 120, 45, 91, 17, -79, 110, -30, 12, 46, 98, -33
    };
    ...
    int64_t golden[] = {
    65, 193, 157, 4, 100, 74, 18446744073709551604, 130, 30, 18446744073709551487, 2, 18446744073709551581, 65, 108, 145, 17
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
