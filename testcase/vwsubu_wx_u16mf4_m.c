...
int main(){
    ...
    139, 19, 149, 199, 211, 211, 107, 74, 180, 150, 23, 249, 184, 93, 255, 201
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    167, 237, 148, 65, 100, 122, 93, 191, 64, 117, 63, 56, 253, 84, 12, 153
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u16mf4_m (mask, data1_v, data2_v, vl);
