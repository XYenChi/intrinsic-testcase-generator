...
int main(){
    const int8_t data1[] = {
    -119, -20, -42, 83, 66, -97, -72, -114, -87, 114, -109, -102, 109, -111, -114, -118
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    84, 124, 49, -81, 73, -20, 44, 44, -113, -49, 23, -74, -10, 31, -105, 72
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vx_8mf2_b16 (data1_v, data2_v, vl);
