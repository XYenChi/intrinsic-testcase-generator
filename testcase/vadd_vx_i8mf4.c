...
int main(){
    const int8_t data1[] = {
    56, -117, -84, 81, 56, 69, -7, -87, -46, -99, 68, -30, 20, -37, -77, -53
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    89, -85, -93, 84, 51, 99, -102, 86, -109, 68, -83, -81, -123, 69, 24, 125
    };
    ...
    int8_t golden[] = {
    145, 54, 79, 165, 107, 168, 147, 255, 101, 225, 241, 145, 153, 32, 203, 72
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
