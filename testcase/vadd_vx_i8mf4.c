...
int main(){
    const int8_t data1[] = {
    99, -118, 67, -6, 97, 85, 120, 39, 37, -5, 13, -33, 68, -44, 0, 94
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -103, -51, -99, 116, 122, 104, 95, -105, 69, 45, 98, -25, 119, 101, -60, 25
    };
    ...
    int8_t golden[] = {
    252, 87, 224, 110, 219, 189, 215, 190, 106, 40, 111, 198, 187, 57, 196, 119
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
