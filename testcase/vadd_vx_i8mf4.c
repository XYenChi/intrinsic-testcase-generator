...
int main(){
    const int8_t data1[] = {
    -82, -40, 89, 84, 77, -37, -89, -20, 7, 101, 104, -114, -95, -109, 0, -123
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -81, -20, 109, 79, 124, -53, 89, -72, 15, 61, -41, 85, 63, 93, -33, -108
    };
    ...
    int8_t golden[] = {
    93, 196, 198, 163, 201, 166, 0, 164, 22, 162, 63, 227, 224, 240, 223, 25
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
