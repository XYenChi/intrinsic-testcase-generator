...
int main(){
    ...
    224, 58, 228, 158, 107, 200, 98, 93, 85, 147, 40, 14, 165, 216, 55, 38
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    184, 246, 142, 224, 27, 214, 200, 139, 206, 40, 6, 116, 3, 139, 135, 205
    };
    ...
    uint16_t golden[] = {
    41216, 14268, 32376, 35392, 2889, 42800, 19600, 12927, 17510, 5880, 240, 1624, 495, 30024, 7425, 7790
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
