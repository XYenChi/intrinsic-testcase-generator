...
int main(){
    ...
    98, 16, 190, 27, 153, 103, 169, 174, 242, 36, 182, 156, 96, 55, 134, 139
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    239, 187, 80, 254, 218, 156, 134, 198, 46, 193, 233, 44, 4, 120, 201, 226
    };
    ...
    uint16_t golden[] = {
    23422, 2992, 15200, 6858, 33354, 16068, 22646, 34452, 11132, 6948, 42406, 6864, 384, 6600, 26934, 31414
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
