...
int main(){
    const int16_t data1[] = {
    119, 69, -90, -103, -126, 89, -73, 57, 79, -39, 39, -112, -51, -98, -63, -113
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -79, -88, 65, 122, -75, -100, -50, 63, -27, 108, 25, -70, -118, -50, -9, 48
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vv_i16mf4 (data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    127, 127, -128, -128, -51, 127, -23, -6, 106, -128, 14, -42, 67, -48, -54, -128
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
