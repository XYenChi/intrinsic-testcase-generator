...
int main(){
    const int16_t data1[] = {
    -54, 77, -15, -40, -17, -11, -7, 67, 89, -6, 48, -56, 75, -5, 34, 118
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -77, -27, -77, -119, -64, 15, 76, -68, -64, -30, 2, 3, 77, 4, -113, 110
    };
    ...
    int16_t golden[] = {
    23, 104, 62, 79, 47, 65510, 65453, 135, 153, 24, 46, 65477, 65534, 65527, 147, 8
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
