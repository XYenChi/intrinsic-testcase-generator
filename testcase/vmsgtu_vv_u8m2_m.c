...
int main(){
    const uint8_t data1[] = {
    150, 247, 59, 225, 95, 219, 226, 207, 94, 221, 124, 54, 243, 195, 126, 106
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    92, 75, 85, 80, 250, 224, 66, 217, 77, 134, 60, 64, 78, 202, 231, 155
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_8m2_b4_m (mask, data1_v, data2_v, vl);
