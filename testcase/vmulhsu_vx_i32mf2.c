...
int main(){
    const int32_t data1[] = {
    -95, -113, 37, -91, 54, 58, 46, -43, -85, 87, 108, -104, -88, 87, 73, -12
    };
    const int32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    234, 137, 216, 226, 132, 96, 6, 197, 28, 117, 138, 19, 17, 133, 96, 161
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_32mf2_b64 (data1_v, data2_v, vl);
