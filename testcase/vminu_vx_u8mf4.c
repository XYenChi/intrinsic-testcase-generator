...
int main(){
    const uint8_t data1[] = {
    190, 20, 192, 40, 131, 168, 169, 124, 125, 216, 70, 161, 167, 183, 28, 151
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    131, 55, 145, 245, 6, 59, 208, 22, 162, 119, 165, 206, 97, 180, 187, 182
    };
    ...
    uint8_t golden[] = {
    190, 55, 192, 245, 131, 168, 208, 124, 162, 216, 165, 206, 167, 183, 187, 182
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
