...
int main(){
    const uint8_t data1[] = {
    31, 108, 161, 16, 247, 65, 5, 107, 21, 6, 37, 54, 204, 24, 150, 158
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    215, 60, 23, 183, 194, 99, 241, 128, 178, 119, 122, 158, 150, 21, 108, 225
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u8m8_m (mask, data1_v, shift, vl);
    ...
    uint8_t golden[] = {
    15, 108, 80, 8, 247, 32, 2, 107, 21, 3, 37, 54, 204, 12, 150, 79
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
