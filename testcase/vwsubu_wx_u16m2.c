...
int main(){
    ...
    152, 155, 106, 195, 190, 9, 233, 205, 51, 156, 73, 196, 173, 15, 177, 117
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    150, 119, 14, 161, 40, 173, 247, 211, 98, 191, 5, 31, 31, 57, 59, 85
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u16m2 (data1_v, data2_v, vl);
