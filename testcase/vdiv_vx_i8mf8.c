...
int main(){
    const int8_t data1[] = {
    -51, 111, 36, 69, -45, -45, 111, 55, 45, -126, -56, 71, 108, -8, 43, 30
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -67, -15, -35, -5, -108, -52, 13, -59, -83, -101, 55, 67, -105, 115, -100, 45
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdiv_vx_i8mf8 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    1, 255, 255, 255, 2, 1, 0, 254, 254, 0, 255, 0, 255, 241, 253, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
