...
int main(){
    const int16_t data1[] = {
    -118, 45, -92, -55, 64, 125, 97, -8, -128, 22, 46, -74, -76, 100, -122, -86
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    70, -113, 55, 59, 77, -97, -114, 28, -128, 22, -34, -83, 109, -116, 120, 78
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vx_16m8_b2 (data1_v, data2_v, vl);
