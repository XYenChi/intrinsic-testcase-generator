...
int main(){
    ...
    105, 174, 243, 124, 56, 235, 169, 9, 109, 212, 178, 246, 183, 156, 230, 154
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    121, 232, 63, 54, 236, 209, 84, 170, 107, 95, 125, 235, 228, 42, 135, 115
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u32m1_m (mask, data1_v, shift, vl);
    ...
    uint32_t golden[] = {
    52, 174, 121, 124, 56, 117, 169, 9, 54, 106, 89, 123, 183, 156, 115, 77
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
