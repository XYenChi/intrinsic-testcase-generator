...
int main(){
    const uint8_t data1[] = {
    52, 190, 73, 104, 152, 36, 50, 160, 57, 10, 225, 252, 136, 61, 73, 140
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    66, 190, 100, 106, 189, 57, 166, 230, 171, 161, 76, 238, 32, 243, 159, 173
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wv_8m2u_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    118, 190, 0, 106, 189, 0, 182, 0, 1, 171, 0, 1, 168, 255, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
