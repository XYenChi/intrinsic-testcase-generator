...
int main(){
    ...
    123, 143, 6, 51, 142, 136, 113, 96, 61, 243, 222, 20, 238, 37, 206, 97
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    112, 109, 15, 217, 49, 147, 4, 1, 184, 195, 4, 233, 168, 90, 39, 77
    };
    ...
    uint32_t golden[] = {
    11, 34, 4294967287, 4294967130, 93, 4294967285, 109, 95, 4294967173, 48, 218, 4294967083, 70, 4294967243, 167, 20
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
