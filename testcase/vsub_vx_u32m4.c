...
int main(){
    ...
    37, 2, 248, 77, 40, 72, 18, 164, 202, 59, 194, 111, 47, 89, 176, 51
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    89, 123, 135, 223, 8, 69, 149, 243, 135, 245, 247, 195, 104, 48, 239, 160
    };
    ...
    uint32_t golden[] = {
    4294967244, 4294967175, 113, 4294967150, 32, 3, 4294967165, 4294967217, 67, 4294967110, 4294967243, 4294967212, 4294967239, 41, 4294967233, 4294967187
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
