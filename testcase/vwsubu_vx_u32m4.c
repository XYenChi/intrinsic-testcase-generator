...
int main(){
    ...
    187, 153, 76, 208, 188, 74, 199, 140, 57, 163, 218, 199, 143, 151, 131, 138
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    59, 125, 247, 89, 126, 144, 91, 113, 102, 75, 4, 203, 175, 84, 66, 188
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u32m4 (data1_v, data2_v, vl);
