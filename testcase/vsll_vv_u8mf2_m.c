...
int main(){
    const uint8_t data1[] = {
    223, 210, 32, 158, 153, 137, 4, 143, 199, 186, 120, 168, 138, 9, 125, 27
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    227, 33, 111, 139, 148, 160, 205, 227, 76, 23, 255, 187, 244, 203, 216, 96
    };
    ...
    uint8_t golden[] = {
    446, 420, 64, 316, 153, 137, 8, 286, 199, 372, 240, 336, 138, 18, 125, 27
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
