...
int main(){
    ...
    140, 228, 117, 122, 176, 153, 78, 72, 35, 55, 237, 137, 53, 183, 173, 11
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    70, 149, 104, 143, 211, 149, 6, 43, 148, 56, 214, 201, 150, 7, 250, 49
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u16m8 (data1_v, data2_v, vl);
