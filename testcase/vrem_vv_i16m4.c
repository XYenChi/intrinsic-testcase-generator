...
int main(){
    const int16_t data1[] = {
    -83, 68, -52, -116, 35, -2, -40, -3, 59, -109, -17, 88, 107, -106, 74, -120
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    61, -60, -79, 93, -66, -111, 74, 117, -44, -39, 107, -126, 34, 77, 2, 44
    };
    ...
    int16_t golden[] = {
    65514, 8, 65509, 65513, 4, 65535, 65530, 0, 15, 65497, 65524, 50, 34, 65507, 2, 65460
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
