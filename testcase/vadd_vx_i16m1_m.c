...
int main(){
    const int16_t data1[] = {
    -4, -57, -103, -108, -48, -38, 58, 55, -111, 105, -1, 74, 65, 2, -2, 99
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    50, 95, -107, -70, -93, 102, 116, -102, 76, -66, -6, -63, 36, -48, 120, -128
    };
    ...
    int16_t golden[] = {
    0, 38, 0, 0, 1, 64, 174, 65489, 1, 39, 65529, 11, 0, 65490, 0, 65507
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
