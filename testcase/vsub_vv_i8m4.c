...
int main(){
    const int8_t data1[] = {
    149, 44, 227, 100, 3, 145, 142, 233, 136, 248, 170, 10, 189, 233, 228, 214
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    221, 249, 181, 13, 160, 113, 21, 10, 100, 99, 188, 33, 15, 86, 195, 242
    };
    ...
    int8_t golden[] = {
    -72, -205, 46, 87, -157, 32, 121, 223, 36, 149, -18, -23, 174, 147, 33, -28
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
