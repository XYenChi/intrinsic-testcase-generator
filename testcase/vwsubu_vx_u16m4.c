...
int main(){
    ...
    202, 112, 51, 70, 108, 198, 244, 78, 209, 57, 40, 196, 205, 241, 93, 174
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    137, 180, 241, 192, 244, 234, 52, 127, 105, 134, 208, 44, 27, 138, 173, 208
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u16m4 (data1_v, data2_v, vl);
