...
int main(){
    const int8_t data1[] = {
    -128, -125, -78, -14, -22, 70, -41, 14, 59, 40, -87, 18, 50, -120, 113, 15
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    180, 226, 175, 216, 243, 30, 153, 14, 31, 155, 8, 68, 114, 7, 241, 83
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_8mf8_b64 (data1_v, data2_v, vl);
