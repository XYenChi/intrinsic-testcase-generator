...
int main(){
    const int64_t data1[] = {
    -114, -22, -97, -36, 28, -75, 96, 112, 1, 27, 18, 109, -117, -28, -120, -113
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    58, 57, -59, -121, 48, 20, -85, -1, -24, 91, 108, -124, -30, 52, 11, -6
    };
    ...
    int64_t golden[] = {
    6612, 1254, 18446744073709545893, 0, 18446744073709550273, 1, 8160, 113, 25, 1, 18446744073709549673, 1, 1, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
