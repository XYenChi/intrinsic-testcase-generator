...
int main(){
    ...
    115, 110, 130, 244, 70, 153, 213, 48, 53, 85, 59, 195, 204, 102, 173, 209
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    54, 148, 19, 55, 192, 237, 216, 25, 81, 24, 63, 213, 73, 122, 236, 56
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u64m4_m (mask, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    1, 0, 19, 55, 52, 84, 3, 25, 28, 24, 4, 18, 1, 20, 63, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
