...
int main(){
    ...
    121, 185, 124, 247, 166, 212, 126, 14, 185, 187, 95, 136, 61, 149, 177, 186
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    13, 220, 116, 64, 124, 173, 10, 29, 176, 196, 149, 214, 10, 2, 126, 39
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i64m4 (data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    0, 1, 0, 0, 0, 0, 0, 2, 0, 1, 1, 1, 0, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
