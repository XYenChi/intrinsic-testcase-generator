...
int main(){
    const uint8_t data1[] = {
    174, 131, 210, 64, 120, 51, 236, 223, 113, 203, 28, 232, 177, 212, 107, 199
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnot_v_u8mf8 (data1_v, vl);
    ...
    uint8_t golden[] = {
    -175, -132, -211, -65, -121, -52, -237, -224, -114, -204, -29, -233, -178, -213, -108, -200
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
