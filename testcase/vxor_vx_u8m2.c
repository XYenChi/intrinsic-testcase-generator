...
int main(){
    const uint8_t data1[] = {
    214, 175, 104, 31, 192, 11, 51, 28, 252, 189, 138, 223, 133, 229, 82, 170
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    220, 189, 68, 64, 37, 195, 110, 57, 119, 124, 172, 88, 208, 150, 249, 75
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u8m2 (data1_v, data2_v, vl);
