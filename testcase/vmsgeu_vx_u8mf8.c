...
int main(){
    const uint8_t data1[] = {
    219, 142, 58, 134, 178, 33, 104, 187, 124, 91, 117, 135, 169, 23, 69, 63
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    13, 96, 11, 58, 43, 89, 237, 221, 197, 237, 139, 137, 136, 229, 222, 15
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_8mf8_b64 (data1_v, data2_v, vl);
