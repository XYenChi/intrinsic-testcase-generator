...
int main(){
    const int8_t data1[] = {
    69, -88, 42, 94, -4, 60, -96, -49, -18, -72, 13, -94, 79, -109, 99, -91
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -14, 74, 3, 50, 104, 31, -39, 53, 44, 8, 72, 67, -32, 84, 55, -2
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_vx_i8mf4 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    247, 234, 43, 126, 252, 63, 249, 255, 238, 184, 77, 227, 239, 215, 119, 255
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
