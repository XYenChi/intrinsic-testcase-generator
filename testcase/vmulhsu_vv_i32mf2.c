...
int main(){
    const int32_t data1[] = {
    1, -55, 47, 70, 46, 32, -4, -118, -127, -49, -104, 96, 46, -112, 105, 88
    };
    const int32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    17, 239, 105, 212, 186, 138, 155, 222, 163, 13, 247, 150, 181, 5, 14, 23
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_32mf2_b64 (data1_v, data2_v, vl);
