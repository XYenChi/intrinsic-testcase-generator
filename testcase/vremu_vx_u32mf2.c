...
int main(){
    ...
    241, 9, 47, 68, 201, 81, 228, 127, 27, 185, 109, 136, 199, 158, 235, 107
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    117, 10, 214, 209, 160, 182, 151, 194, 31, 116, 67, 143, 159, 187, 233, 39
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u32mf2 (data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    117, 1, 26, 5, 160, 20, 151, 67, 4, 116, 67, 7, 159, 29, 233, 39
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
