...
int main(){
    ...
    114, 141, 122, 216, 187, 35, 244, 160, 71, 55, 62, 189, 105, 178, 151, 186
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    81, 147, 203, 85, 74, 252, 55, 47, 62, 248, 65, 245, 54, 182, 70, 73
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u64m2 (data1_v, data2_v, vl);
