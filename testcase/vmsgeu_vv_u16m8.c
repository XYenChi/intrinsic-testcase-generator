...
int main(){
    ...
    87, 231, 53, 153, 184, 216, 112, 51, 166, 66, 34, 102, 63, 7, 73, 15
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    231, 250, 93, 204, 164, 231, 175, 150, 43, 30, 184, 146, 138, 207, 15, 191
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_16m8_b2 (data1_v, data2_v, vl);
