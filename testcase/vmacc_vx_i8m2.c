...
int main(){
    const int8_t data1[] = {
    -97, -4, -94, 81, -113, 64, -117, 15, -47, -101, -74, -123, -21, 81, -22, 39
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -110, -8, 70, -16, 62, 73, -112, -45, -13, -23, 93, 110, -71, 97, -73, -67
    };
    ...
    int8_t golden[] = {
    174, 32, 76, 240, 162, 65, 48, 93, 99, 19, 30, 39, 211, 177, 70, 203
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
