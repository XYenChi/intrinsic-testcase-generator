...
int main(){
    const int8_t data1[] = {
    0, -78, 50, 11, 34, 88, -36, -116, -81, -40, -36, 101, 125, -80, 72, -84
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -32, 95, 103, 37, 30, -23, -85, 102, 19, 74, -23, -55, 67, 100, -55, -18
    };
    ...
    int8_t golden[] = {
    0, 15, 30, 151, 252, 25, 244, 200, 254, 113, 61, 78, 184, 193, 137, 233
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
