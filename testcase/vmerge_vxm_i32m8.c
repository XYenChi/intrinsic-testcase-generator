...
int main(){
    const int32_t data1[] = {
    37, -79, -77, 37, 102, 17, 120, -83, -84, 34, 71, -107, 118, 15, 107, 59
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -42, -63, -2, 106, -126, -15, 78, -81, -62, 95, 102, -63, 104, -101, -92, -110
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmerge_vxm_i32m8 (data1_v, data2_v, masked size_t vl);
    ...
    int32_t golden[] = {
    -42, -63, -2, 37, -126, -15, 78, -83, -84, 34, 71, -107, 118, 15, 107, -110
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
