...
int main(){
    const int64_t data1[] = {
    56, 41, -24, 103, 99, -10, 14, 71, -108, -59, 114, 106, 35, -16, 75, 11
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -37, 126, -89, 111, -113, 1, 76, 4, -126, 51, -81, 88, 46, -4, 69, -8
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccus_vx_i64m4 (out_data, data1_v, data2_v, vl);
