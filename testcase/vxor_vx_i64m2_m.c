...
int main(){
    const int64_t data1[] = {
    -12, 31, -77, 78, -82, -115, -109, -52, 103, 60, 122, -69, 68, 91, 68, 84
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -107, 54, 24, 12, -53, -115, -58, 27, -113, -4, 57, -98, -27, 84, -78, -61
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_i64m2_m (mask, data1_v, data2_v, vl);
