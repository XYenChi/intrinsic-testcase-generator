...
int main(){
    const uint8_t data1[] = {
    133, 168, 177, 40, 102, 175, 230, 184, 243, 103, 2, 48, 12, 185, 157, 233
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    241, 71, 158, 11, 213, 85, 37, 100, 160, 89, 80, 139, 24, 163, 148, 87
    };
    ...
    uint8_t golden[] = {
    1, 1, 0, 0, 145, 1, 193, 84, 83, 14, 178, 165, 244, 22, 9, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
