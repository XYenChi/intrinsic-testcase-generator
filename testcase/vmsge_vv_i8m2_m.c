...
int main(){
    const int8_t data1[] = {
    54, 78, -51, -59, 106, -3, -69, -55, 26, 115, 117, 73, 63, -29, -56, -98
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    120, 67, -11, -103, -118, 95, -113, -105, -97, 91, -124, -4, 120, 10, 15, -73
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vv_8m2_b4_m (mask, data1_v, data2_v, vl);
