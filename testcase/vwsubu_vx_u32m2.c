...
int main(){
    ...
    52, 49, 192, 114, 41, 201, 27, 234, 203, 192, 67, 233, 69, 171, 54, 129
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    118, 136, 177, 41, 44, 1, 113, 65, 167, 5, 241, 66, 135, 127, 180, 105
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u32m2 (data1_v, data2_v, vl);
