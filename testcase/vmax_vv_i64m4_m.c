...
int main(){
    const int64_t data1[] = {
    -34, 115, 121, 101, -19, 98, 97, 112, -60, -4, -28, -14, -34, -49, 90, -24
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    64, 19, 23, -8, 40, -46, -38, -113, -114, -101, -39, 123, 123, -90, 99, -55
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmax_vv_i64m4_m (mask, data1_v, data2_v, vl);
    ...
    int64_t golden[] = {
    0, 115, 1, 0, 40, 0, 1, 112, 18446744073709551556, 18446744073709551612, 18446744073709551588, 0, 1, 0, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
