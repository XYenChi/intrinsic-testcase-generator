...
int main(){
    const int8_t data1[] = {
    139, 47, 4, 80, 175, 212, 26, 236, 219, 148, 252, 240, 227, 71, 231, 164
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    149, 102, 97, 187, 236, 16, 73, 234, 19, 155, 217, 97, 57, 63, 116, 24
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmin_vv_i8m4 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    149, 102, 97, 187, 236, 212, 73, 236, 219, 155, 252, 240, 227, 71, 231, 164
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
