...
int main(){
    const uint8_t data1[] = {
    44, 75, 215, 196, 8, 157, 72, 56, 149, 82, 154, 251, 138, 131, 12, 160
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    20, 188, 57, 131, 51, 12, 207, 255, 165, 48, 63, 123, 175, 80, 67, 185
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u8m2_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 38, 57, 131, 3, 1, 63, 0, 16, 48, 63, 1, 37, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
