...
int main(){
    const int16_t data1[] = {
    -69, 13, 108, -59, 22, -85, -39, -97, -27, 102, 104, 14, -43, 111, 84, 89
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -114, -118, 63, -127, 24, 33, 110, -76, -36, -45, 105, 33, -13, 105, 40, 95
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vv_16m4_b4 (data1_v, data2_v, vl);
