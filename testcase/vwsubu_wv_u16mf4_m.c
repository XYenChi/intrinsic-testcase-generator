...
int main(){
    ...
    153, 192, 63, 214, 187, 48, 247, 213, 111, 153, 36, 217, 250, 82, 40, 113
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    155, 22, 2, 115, 231, 253, 170, 38, 188, 23, 247, 35, 111, 17, 224, 15
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u16mf4_m (mask, data1_v, data2_v, vl);
