...
int main(){
    ...
    254, 106, 187, 213, 174, 80, 218, 207, 59, 167, 232, 210, 112, 41, 51, 38
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    53, 177, 45, 37, 197, 19, 162, 126, 138, 65, 32, 150, 6, 229, 94, 95
    };
    ...
    uint64_t golden[] = {
    13462, 18762, 8415, 7881, 34278, 1520, 35316, 26082, 8142, 10855, 7424, 31500, 672, 9389, 4794, 3610
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
