...
int main(){
    ...
    222, 176, 106, 222, 214, 208, 23, 96, 119, 251, 15, 209, 152, 105, 253, 47
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    137, 37, 55, 20, 202, 195, 254, 99, 120, 56, 253, 160, 177, 242, 2, 161
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_64m8_b8 (data1_v, data2_v, vl);
