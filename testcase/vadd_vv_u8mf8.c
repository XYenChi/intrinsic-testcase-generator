...
int main(){
    const uint8_t data1[] = {
    126, 167, 242, 136, 225, 117, 236, 16, 99, 75, 212, 172, 215, 210, 137, 152
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    98, 190, 10, 220, 158, 169, 238, 117, 100, 72, 196, 190, 100, 102, 69, 38
    };
    ...
    uint8_t golden[] = {
    224, 101, 252, 100, 127, 30, 218, 133, 199, 147, 152, 106, 59, 56, 206, 190
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
