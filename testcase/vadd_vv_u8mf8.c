...
int main(){
    const int8_t data1[] = {
    122, 21, 251, 195, 144, 95, 90, 180, 108, 190, 229, 68, 239, 80, 108, 213
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    90, 177, 21, 101, 171, 242, 1, 25, 32, 255, 177, 191, 85, 142, 48, 209
    };
    ...
    int8_t golden[] = {
    212, 198, 16, 40, 59, 81, 91, 205, 140, 189, 150, 3, 68, 222, 156, 166
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
