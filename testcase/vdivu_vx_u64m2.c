...
int main(){
    ...
    150, 109, 200, 60, 195, 135, 49, 183, 25, 95, 69, 148, 5, 230, 96, 165
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    164, 82, 70, 32, 98, 127, 230, 112, 198, 107, 196, 218, 168, 176, 237, 171
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i64m2 (data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    1, 0, 0, 0, 0, 0, 4, 0, 7, 1, 2, 1, 33, 0, 2, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
