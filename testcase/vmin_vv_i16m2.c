...
int main(){
    const int16_t data1[] = {
    36, -115, -50, 30, 94, 104, -31, 82, -50, -122, 8, -80, -76, 11, 8, 63
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -71, -49, -41, -17, 41, 4, 14, -78, -3, -70, -113, 23, -77, 4, 21, 110
    };
    ...
    int16_t golden[] = {
    36, 65487, 65495, 30, 94, 104, 14, 82, 65533, 65466, 8, 23, 65460, 11, 21, 110
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
