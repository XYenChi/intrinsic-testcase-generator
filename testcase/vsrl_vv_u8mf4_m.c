...
int main(){
    const uint8_t data1[] = {
    224, 124, 80, 40, 59, 169, 21, 92, 205, 60, 232, 139, 251, 234, 60, 245
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    186, 150, 245, 53, 58, 91, 73, 107, 212, 16, 140, 151, 254, 195, 65, 63
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u8mf4_m (mask, data1_v, shift, vl);
    ...
    uint8_t golden[] = {
    224, 124, 40, 20, 59, 84, 10, 46, 205, 60, 232, 69, 251, 117, 30, 122
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
