...
int main(){
    ...
    187, 102, 169, 109, 56, 34, 16, 226, 156, 134, 32, 120, 220, 141, 66, 183
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    221, 5, 102, 190, 202, 38, 32, 232, 174, 118, 104, 144, 74, 146, 50, 156
    };
    ...
    uint32_t golden[] = {
    408, 107, 271, 299, 258, 72, 48, 458, 330, 252, 136, 264, 294, 287, 116, 339
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
