...
int main(){
    ...
    238, 38, 238, 90, 66, 66, 107, 41, 152, 150, 43, 169, 144, 72, 152, 183
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    238, 107, 105, 35, 206, 120, 79, 200, 82, 51, 118, 23, 68, 126, 243, 109
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulu_vx_u32m2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    0, 0, 1, 0, 0, 7920, 8453, 1, 12464, 7650, 5074, 1, 9792, 9072, 1, 19947
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
