...
int main(){
    const int16_t data1[] = {
    15, -19, 9, 13, -54, -127, 115, 27, 14, 38, 92, 125, 11, 46, 19, -19
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -61, 96, 121, -94, -48, 92, -78, -20, 15, 65, 57, -117, -98, -122, -60, -9
    };
    ...
    int16_t golden[] = {
    65475, 96, 121, 65442, 65488, 92, 65458, 65516, 15, 65, 57, 65419, 65438, 65414, 65476, 65527
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
