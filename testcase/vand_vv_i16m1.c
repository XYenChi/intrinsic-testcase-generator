...
int main(){
    const int16_t data1[] = {
    19, 108, 78, -4, 11, 23, 101, -50, -51, 119, 43, -78, -81, -38, -15, 18
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    21, 43, -26, -6, -24, 82, -8, -118, -46, 82, -112, 18, -56, -53, -8, 75
    };
    ...
    int16_t golden[] = {
    21, 43, 65510, 65530, 65512, 82, 65528, 65418, 65490, 82, 65424, 18, 65480, 65483, 65528, 75
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
