...
int main(){
    ...
    109, 151, 9, 119, 243, 23, 52, 176, 100, 7, 105, 39, 129, 228, 225, 67
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    250, 123, 235, 226, 108, 234, 31, 199, 5, 15, 29, 152, 180, 73, 81, 216
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u16m2 (data1_v, data2_v, vl);
