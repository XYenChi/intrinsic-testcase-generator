...
int main(){
    ...
    23, 58, 65, 105, 106, 253, 212, 193, 45, 18, 11, 166, 9, 156, 212, 130
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    132, 254, 216, 95, 252, 96, 26, 56, 220, 4, 112, 46, 17, 134, 156, 21
    };
    ...
    uint16_t golden[] = {
    62500, 50804, 51496, 55562, 38825, 41249, 60025, 54728, 55637, 65464, 64304, 57900, 65384, 44633, 32464, 62806
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
