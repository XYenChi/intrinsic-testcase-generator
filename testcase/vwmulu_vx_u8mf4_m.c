...
int main(){
    const uint8_t data1[] = {
    127, 8, 112, 23, 53, 139, 201, 169, 153, 243, 29, 93, 65, 59, 97, 0
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    164, 168, 230, 209, 178, 77, 1, 170, 215, 103, 15, 123, 114, 252, 174, 101
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulu_vx_u8mf4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 1, 160, 0, 218, 207, 1, 0, 0, 197, 0, 175, 0, 20, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
