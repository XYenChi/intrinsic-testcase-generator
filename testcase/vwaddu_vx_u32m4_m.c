...
int main(){
    ...
    160, 185, 80, 21, 195, 77, 37, 67, 238, 59, 100, 228, 200, 44, 28, 119
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    62, 149, 195, 127, 37, 206, 88, 230, 191, 23, 126, 194, 121, 98, 13, 19
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u32m4_m (mask, data1_v, data2_v, vl);
