...
int main(){
    const int8_t data1[] = {
    182, 249, 107, 154, 104, 170, 148, 233, 252, 111, 60, 13, 210, 224, 161, 24
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    96, 188, 127, 187, 193, 213, 31, 65, 124, 244, 212, 81, 69, 138, 214, 79
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vrem_vv_i8mf2 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    96, 188, 20, 33, 89, 43, 31, 65, 124, 22, 32, 3, 69, 138, 53, 7
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
