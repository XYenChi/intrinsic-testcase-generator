...
int main(){
    const int32_t data1[] = {
    -38, -20, -57, 121, 64, -79, -10, -37, -97, 92, 30, 4, 113, -71, -9, -68
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    70, -121, 26, 60, -28, 93, 38, -70, -49, -48, 85, 116, -11, 76, -42, -109
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_i32m2_m (mask, data1_v, data2_v, vl);
