...
int main(){
    const uint8_t data1[] = {
    177, 162, 171, 4, 150, 152, 73, 16, 74, 147, 124, 30, 112, 71, 181, 21
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    60, 6, 71, 191, 153, 26, 74, 102, 213, 77, 57, 234, 242, 135, 94, 197
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsub_vx_u8m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 156, 171, 0, 1, 152, 1, 0, 1, 1, 124, 52, 112, 1, 0, 80
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
