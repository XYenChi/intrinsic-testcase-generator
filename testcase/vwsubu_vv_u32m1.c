...
int main(){
    ...
    215, 80, 121, 198, 35, 148, 235, 68, 74, 228, 237, 141, 176, 108, 33, 147
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    198, 173, 3, 5, 52, 181, 63, 37, 197, 181, 53, 86, 67, 222, 227, 68
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u32m1 (data1_v, data2_v, vl);
