...
int main(){
    const int16_t data1[] = {
    80, -64, 39, -22, 57, 0, 40, 124, 88, 106, 46, 67, -43, -79, -46, -115
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    94, 121, 50, -119, 85, -20, -106, -80, 89, 36, -31, -35, 89, 83, -32, 124
    };
    ...
    int16_t golden[] = {
    94, 121, 50, 65514, 85, 0, 40, 124, 89, 106, 46, 67, 89, 83, 65504, 124
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
