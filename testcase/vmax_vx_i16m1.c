...
int main(){
    const int16_t data1[] = {
    121, 15, -21, 66, 121, 111, 103, 98, 7, 80, 68, 62, 35, -102, 77, -17
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    22, 43, -57, 39, -92, 55, -57, -15, -32, -54, -12, 57, -107, 105, 70, -28
    };
    ...
    int16_t golden[] = {
    121, 43, 65515, 66, 121, 111, 103, 98, 7, 80, 68, 62, 35, 105, 77, 65519
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
