...
int main(){
    ...
    137, 213, 23, 165, 18, 120, 150, 83, 204, 14, 87, 100, 26, 85, 219, 100
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    130, 241, 236, 1, 254, 138, 253, 102, 221, 41, 104, 49, 41, 120, 225, 84
    };
    ...
    uint16_t golden[] = {
    267, 454, 259, 166, 272, 258, 403, 185, 425, 55, 191, 149, 67, 205, 444, 184
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
