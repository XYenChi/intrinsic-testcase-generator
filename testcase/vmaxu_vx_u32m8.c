...
int main(){
    ...
    233, 252, 67, 161, 42, 28, 29, 113, 224, 189, 187, 20, 28, 27, 26, 15
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    114, 7, 208, 77, 80, 181, 237, 140, 157, 52, 113, 245, 111, 15, 91, 115
    };
    ...
    uint32_t golden[] = {
    233, 252, 208, 161, 80, 181, 237, 140, 224, 189, 187, 245, 111, 27, 91, 115
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
