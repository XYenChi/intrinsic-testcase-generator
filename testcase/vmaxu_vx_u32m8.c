...
int main(){
    ...
    15, 122, 144, 240, 17, 235, 30, 150, 74, 54, 44, 1, 140, 116, 242, 236
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    66, 233, 214, 120, 36, 165, 66, 89, 82, 212, 151, 167, 249, 253, 45, 88
    };
    ...
    uint32_t golden[] = {
    66, 233, 214, 240, 36, 235, 66, 150, 82, 212, 151, 167, 249, 253, 242, 236
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
