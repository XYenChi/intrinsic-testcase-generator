...
int main(){
    const int8_t data1[] = {
    86, 24, -114, -102, 89, 9, -20, -57, -87, -53, -7, -14, -31, -112, 124, -121
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    25, -13, -11, -14, 19, -40, -46, -91, -96, 50, 47, 115, 83, -61, -53, 39
    };
    ...
    int8_t golden[] = {
    172, 48, -228, -102, 178, 9, -20, -114, -87, -53, -14, -28, -62, -224, 248, -242
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
