...
int main(){
    const int32_t data1[] = {
    54, 52, -35, -29, -120, -105, -55, 92, -69, 117, 63, 13, -50, 18, 107, -109
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -48, -110, -12, 6, -86, 24, 34, -115, 23, 125, 64, 35, 71, 46, -95, 67
    };
    ...
    int32_t golden[] = {
    54, 52, 4294967284, 0, 4294967210, 1, 1, 92, 23, 125, 64, 0, 0, 46, 107, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
