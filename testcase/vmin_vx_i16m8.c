...
int main(){
    const int16_t data1[] = {
    -127, 75, 30, 25, -41, -96, 74, -100, -12, -50, 88, 7, -29, 122, -45, 31
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    114, 66, 66, 12, -28, -75, 115, 87, -12, -77, 109, -44, 81, 84, 116, -66
    };
    ...
    int16_t golden[] = {
    114, 75, 66, 25, 65508, 65461, 115, 87, 65524, 65486, 109, 7, 81, 122, 116, 31
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
