...
int main(){
    const uint8_t data1[] = {
    151, 106, 20, 254, 77, 221, 132, 242, 117, 102, 86, 84, 127, 143, 97, 141
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    94, 173, 37, 110, 181, 6, 176, 83, 161, 77, 235, 147, 186, 225, 56, 197
    };
    ...
    uint8_t golden[] = {
    151, 173, 37, 254, 181, 221, 176, 242, 161, 102, 235, 147, 186, 225, 97, 197
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
