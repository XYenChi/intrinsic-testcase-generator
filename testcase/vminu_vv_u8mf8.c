...
int main(){
    const uint8_t data1[] = {
    90, 80, 22, 89, 57, 162, 30, 73, 76, 24, 87, 16, 122, 43, 221, 214
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    199, 191, 114, 3, 180, 219, 104, 192, 58, 74, 133, 147, 196, 146, 45, 49
    };
    ...
    uint8_t golden[] = {
    199, 191, 114, 89, 180, 219, 104, 192, 76, 74, 133, 147, 196, 146, 221, 214
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
