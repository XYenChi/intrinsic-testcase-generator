...
int main(){
    ...
    180, 238, 182, 165, 253, 224, 119, 247, 247, 112, 172, 246, 111, 30, 41, 4
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    27, 242, 96, 71, 130, 174, 24, 161, 56, 249, 197, 128, 48, 182, 143, 15
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u64m4 (data1_v, data2_v, vl);
