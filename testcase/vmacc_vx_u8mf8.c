...
int main(){
    const uint8_t data1[] = {
    44, 32, 31, 88, 10, 248, 122, 89, 3, 198, 113, 165, 153, 78, 59, 102
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    172, 220, 99, 120, 236, 126, 249, 93, 167, 160, 185, 172, 241, 7, 203, 19
    };
    ...
    uint8_t golden[] = {
    145, 129, 253, 65, 57, 17, 171, 86, 245, 193, 169, 221, 10, 34, 202, 147
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
