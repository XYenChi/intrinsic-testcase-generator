...
int main(){
    const int32_t data1[] = {
    43, 9, -8, -84, 25, 119, 109, -9, -41, 113, 87, -74, -73, 126, 25, -48
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    72, -93, -105, -90, 37, 63, -96, -25, 51, -39, 99, -102, -48, -55, -127, 32
    };
    ...
    int32_t golden[] = {
    115, 4294967212, 0, 4294967122, 0, 1, 13, 1, 1, 74, 186, 0, 0, 0, 4294967194, 4294967280
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
