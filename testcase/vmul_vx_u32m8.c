...
int main(){
    ...
    242, 236, 124, 242, 59, 221, 150, 134, 120, 20, 40, 13, 184, 78, 56, 213
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    54, 111, 65, 203, 1, 57, 127, 198, 1, 22, 150, 230, 156, 59, 245, 197
    };
    ...
    uint32_t golden[] = {
    13068, 26196, 8060, 49126, 59, 12597, 19050, 26532, 120, 440, 6000, 2990, 28704, 4602, 13720, 41961
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
