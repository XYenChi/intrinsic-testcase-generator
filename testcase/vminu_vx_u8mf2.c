...
int main(){
    const uint8_t data1[] = {
    212, 143, 15, 195, 110, 74, 108, 33, 36, 211, 232, 159, 219, 79, 203, 183
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    121, 107, 164, 151, 104, 173, 242, 17, 99, 34, 231, 88, 156, 249, 101, 224
    };
    ...
    uint8_t golden[] = {
    212, 143, 164, 195, 110, 173, 242, 33, 99, 211, 232, 159, 219, 249, 203, 224
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
