...
int main(){
    ...
    199, 44, 212, 130, 49, 112, 32, 83, 17, 225, 238, 229, 147, 254, 107, 240
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    207, 126, 19, 100, 200, 247, 12, 53, 248, 204, 65, 92, 85, 158, 71, 106
    };
    const uint64_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e64m4(avl);
    const uint out_data[] = {
    1, 1, 1, 1, 1, 1, 0, 1, 0, 0, 1, 0, 0, 0, 0, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulu_vx_u64m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    41193, 1, 1, 13000, 9800, 1, 384, 1, 4216, 0, 1, 0, 0, 0, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
