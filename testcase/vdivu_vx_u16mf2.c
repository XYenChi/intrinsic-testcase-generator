...
int main(){
    ...
    203, 59, 70, 215, 85, 243, 168, 214, 151, 58, 87, 129, 241, 59, 125, 192
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    22, 227, 191, 243, 162, 37, 146, 235, 187, 241, 155, 240, 64, 48, 54, 43
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i16mf2 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    0, 3, 2, 1, 1, 0, 0, 1, 1, 4, 1, 1, 0, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
