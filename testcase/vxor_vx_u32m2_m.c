...
int main(){
    ...
    129, 223, 45, 233, 143, 181, 5, 170, 199, 39, 98, 163, 200, 210, 26, 102
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    95, 113, 149, 30, 183, 68, 187, 6, 252, 69, 120, 157, 189, 37, 228, 39
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u32m2_m (mask, data1_v, data2_v, vl);
