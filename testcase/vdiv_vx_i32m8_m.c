...
int main(){
    const int32_t data1[] = {
    81, -60, 82, 38, 56, 72, -6, 116, 78, -6, -26, 46, 85, -51, -6, -83
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -61, -14, 7, 119, 85, 97, -103, 95, 110, 43, 23, 56, 5, 18, 66, 33
    };
    ...
    int32_t golden[] = {
    0, 0, 0, 3, 0, 1, 0, 1, 1, 4294967288, 0, 0, 1, 4294967295, 4294967285, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
