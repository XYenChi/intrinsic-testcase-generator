...
int main(){
    const int8_t data1[] = {
    96, 125, -128, 107, 117, 94, -78, -64, -63, 76, -65, 38, 30, -5, -27, 124
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -66, 22, 39, 52, -110, -22, -119, -97, 118, 12, -66, -40, 98, -126, -22, 123
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsra_wx_8mf2_m (mask, data1_v, shift, vl);
