...
int main(){
    ...
    82, 26, 58, 7, 98, 203, 12, 88, 175, 2, 108, 43, 14, 78, 107, 225
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    29, 48, 173, 45, 3, 126, 9, 77, 2, 47, 95, 84, 83, 215, 29, 10
    };
    ...
    uint32_t golden[] = {
    53, 4294967274, 4294967181, 4294967258, 95, 77, 3, 11, 173, 4294967251, 13, 4294967255, 4294967227, 4294967159, 78, 215
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
