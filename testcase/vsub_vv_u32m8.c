...
int main(){
    ...
    135, 4, 120, 103, 8, 17, 94, 244, 206, 22, 85, 8, 173, 251, 247, 243
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    20, 49, 72, 81, 80, 134, 233, 91, 145, 77, 115, 16, 78, 17, 0, 98
    };
    ...
    uint32_t golden[] = {
    115, 4294967251, 48, 22, 4294967224, 4294967179, 4294967157, 153, 61, 4294967241, 4294967266, 4294967288, 95, 234, 247, 145
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
