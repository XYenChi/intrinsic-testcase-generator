...
int main(){
    ...
    6, 1, 215, 117, 240, 234, 215, 49, 94, 255, 217, 102, 16, 4, 111, 255
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    177, 51, 113, 83, 41, 65, 64, 242, 202, 107, 151, 105, 249, 115, 182, 56
    };
    ...
    uint16_t golden[] = {
    177, 1, 0, 117, 1, 234, 215, 0, 202, 255, 217, 1, 1, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
