...
int main(){
    ...
    165, 243, 156, 217, 193, 96, 75, 142, 49, 84, 118, 203, 234, 143, 179, 17
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    124, 99, 251, 236, 6, 75, 128, 220, 86, 192, 174, 110, 253, 108, 119, 151
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i32mf2 (data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    0, 0, 1, 1, 0, 0, 1, 1, 1, 2, 1, 0, 1, 0, 0, 8
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
