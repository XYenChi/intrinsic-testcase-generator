...
int main(){
    ...
    194, 151, 139, 60, 89, 50, 217, 9, 2, 76, 98, 217, 195, 227, 249, 28
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    158, 57, 231, 170, 122, 72, 111, 172, 151, 140, 216, 40, 237, 27, 13, 77
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vx_16m8_b2_m (mask, data1_v, data2_v, vl);
