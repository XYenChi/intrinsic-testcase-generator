...
int main(){
    ...
    74, 169, 39, 168, 212, 56, 102, 41, 215, 214, 205, 102, 11, 52, 68, 112
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    108, 43, 112, 201, 243, 165, 59, 45, 122, 27, 175, 156, 249, 60, 3, 194
    };
    ...
    uint16_t golden[] = {
    7992, 7267, 4368, 33768, 51516, 9240, 6018, 1845, 26230, 5778, 35875, 15912, 2739, 3120, 204, 21728
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
