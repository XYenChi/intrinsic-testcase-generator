...
int main(){
    ...
    118, 80, 49, 98, 116, 153, 75, 144, 239, 84, 175, 186, 208, 239, 165, 226
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    229, 62, 110, 213, 185, 0, 42, 209, 7, 241, 127, 133, 55, 51, 100, 110
    };
    ...
    uint32_t golden[] = {
    229, 80, 110, 213, 185, 153, 75, 209, 239, 241, 175, 186, 208, 239, 165, 226
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
