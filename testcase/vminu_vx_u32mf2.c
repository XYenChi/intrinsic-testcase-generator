...
int main(){
    ...
    61, 0, 249, 62, 63, 35, 226, 124, 47, 39, 184, 249, 187, 80, 62, 220
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    43, 93, 66, 120, 46, 222, 183, 120, 136, 112, 178, 36, 1, 134, 116, 108
    };
    ...
    uint32_t golden[] = {
    61, 93, 249, 120, 63, 222, 226, 124, 136, 112, 184, 249, 187, 134, 116, 220
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
