...
int main(){
    const int16_t data1[] = {
    66, 110, 92, 64, 69, 34, 79, 84, 62, 114, 65, -11, 83, 42, -113, -39
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -24, -59, -123, 111, -80, 47, 120, -47, 72, 67, -102, 38, 25, 110, -51, 109
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_16m2_b8 (data1_v, data2_v, vl);
