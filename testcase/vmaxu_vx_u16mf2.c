...
int main(){
    ...
    173, 120, 171, 39, 179, 70, 170, 98, 166, 66, 92, 87, 140, 210, 134, 90
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    127, 227, 11, 24, 1, 82, 194, 242, 25, 3, 123, 181, 157, 224, 179, 147
    };
    ...
    uint16_t golden[] = {
    173, 227, 171, 39, 179, 82, 194, 242, 166, 66, 123, 181, 157, 224, 179, 147
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
