...
int main(){
    ...
    191, 37, 1, 11, 70, 87, 39, 215, 59, 172, 120, 166, 7, 111, 99, 89
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    217, 21, 95, 232, 220, 79, 161, 158, 187, 209, 99, 13, 64, 244, 255, 131
    };
    ...
    uint16_t golden[] = {
    217, 37, 95, 232, 220, 87, 161, 215, 187, 209, 120, 166, 64, 244, 255, 131
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
