...
int main(){
    ...
    245, 119, 232, 160, 188, 220, 49, 175, 167, 235, 53, 214, 3, 66, 157, 232
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    251, 112, 68, 205, 29, 83, 188, 23, 199, 88, 72, 215, 170, 151, 124, 90
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u32m2 (data1_v, data2_v, vl);
