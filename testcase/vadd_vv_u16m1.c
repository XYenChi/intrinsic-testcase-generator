...
int main(){
    const int16_t data1[] = {
    106, 221, 68, 111, 119, 126, 138, 78, 120, 14, 67, 123, 106, 10, 1, 45
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    24, 82, 111, 220, 135, 211, 156, 246, 1, 178, 206, 179, 171, 221, 94, 2
    };
    ...
    int16_t golden[] = {
    130, 303, 179, 331, 254, 337, 294, 324, 121, 192, 273, 302, 277, 231, 95, 47
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
