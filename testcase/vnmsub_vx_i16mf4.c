...
int main(){
    const int16_t data1[] = {
    -65, -56, 72, 82, -108, 21, 107, 28, 116, -110, -23, -41, 0, 42, 98, 5
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -102, -103, -38, 14, 56, -110, 7, 85, 26, 55, -118, -59, 91, -123, 104, -15
    };
    ...
    int16_t golden[] = {
    65471, 47, 72, 82, 65428, 131, 107, 65479, 116, 65426, 65513, 18, 0, 42, 98, 5
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
