...
int main(){
    const uint8_t data1[] = {
    44, 83, 237, 151, 73, 162, 111, 169, 161, 72, 194, 133, 72, 57, 175, 52
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    207, 192, 47, 104, 17, 18, 163, 216, 217, 240, 150, 79, 169, 212, 27, 132
    };
    ...
    uint32_t masked[] = {
    1, 0, 0, 1, 0, 1, 1, 0, 1, 1, 1, 1, 0, 0, 1, 1
    };
    ...
    uint8_t golden[] = {
    251, 0, 1, 255, 1, 180, 18, 1, 122, 56, 88, 212, 1, 1, 202, 184
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
