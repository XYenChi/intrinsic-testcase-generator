...
int main(){
    ...
    171, 184, 69, 186, 43, 169, 207, 90, 238, 242, 166, 16, 162, 172, 44, 35
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    59, 194, 239, 251, 241, 26, 144, 239, 69, 95, 2, 114, 246, 14, 95, 174
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u32m4 (data1_v, data2_v, vl);
