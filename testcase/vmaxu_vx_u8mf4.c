...
int main(){
    const uint8_t data1[] = {
    238, 218, 120, 233, 223, 95, 223, 162, 1, 65, 228, 81, 224, 2, 234, 121
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    93, 85, 227, 79, 173, 9, 238, 126, 146, 63, 185, 112, 245, 36, 193, 129
    };
    ...
    uint8_t golden[] = {
    238, 218, 227, 233, 223, 95, 238, 162, 146, 65, 228, 112, 245, 36, 234, 129
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
