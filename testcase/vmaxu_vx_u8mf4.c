...
int main(){
    const uint8_t data1[] = {
    165, 51, 148, 184, 0, 217, 21, 13, 61, 149, 207, 174, 198, 13, 35, 246
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    210, 63, 186, 79, 86, 61, 109, 190, 92, 249, 61, 151, 164, 34, 124, 15
    };
    ...
    uint8_t golden[] = {
    210, 63, 186, 184, 86, 217, 109, 190, 92, 249, 207, 174, 198, 34, 124, 246
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
