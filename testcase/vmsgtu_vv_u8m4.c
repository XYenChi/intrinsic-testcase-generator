...
int main(){
    const uint8_t data1[] = {
    117, 149, 100, 63, 210, 250, 206, 42, 40, 169, 192, 206, 248, 134, 106, 102
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    11, 10, 158, 23, 183, 177, 171, 103, 3, 245, 39, 21, 71, 164, 82, 207
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_8m4_b2 (data1_v, data2_v, vl);
