...
int main(){
    const uint8_t data1[] = {
    81, 82, 177, 137, 121, 229, 72, 197, 100, 119, 132, 155, 18, 212, 182, 222
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    190, 168, 87, 0, 228, 27, 198, 64, 150, 35, 202, 4, 151, 103, 233, 165
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i8mf8 (data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    2, 2, 0, 0, 1, 0, 2, 0, 1, 0, 1, 0, 8, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
