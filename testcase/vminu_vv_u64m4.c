...
int main(){
    ...
    22, 158, 234, 105, 239, 117, 186, 225, 137, 86, 169, 25, 193, 167, 47, 76
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    65, 114, 2, 72, 114, 58, 125, 90, 34, 128, 34, 203, 222, 215, 147, 102
    };
    ...
    uint64_t golden[] = {
    65, 158, 234, 105, 239, 117, 186, 225, 137, 128, 169, 203, 222, 215, 147, 102
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
