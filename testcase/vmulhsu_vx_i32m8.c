...
int main(){
    const int32_t data1[] = {
    91, 35, 9, -81, -95, -72, 27, -113, 125, 36, 36, -106, 90, 76, 115, -51
    };
    const int32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    113, 208, 201, 4, 247, 94, 91, 199, 101, 29, 127, 64, 208, 204, 65, 124
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_32m8_b4 (data1_v, data2_v, vl);
