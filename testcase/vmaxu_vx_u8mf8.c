...
int main(){
    const uint8_t data1[] = {
    214, 7, 182, 235, 217, 157, 64, 104, 18, 215, 248, 193, 193, 165, 170, 173
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    41, 24, 32, 35, 174, 121, 221, 248, 18, 156, 32, 183, 151, 56, 38, 107
    };
    ...
    uint8_t golden[] = {
    214, 24, 182, 235, 217, 157, 221, 248, 18, 215, 248, 193, 193, 165, 170, 173
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
