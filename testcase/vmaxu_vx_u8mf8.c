...
int main(){
    const uint8_t data1[] = {
    125, 201, 72, 100, 207, 65, 124, 131, 75, 101, 86, 174, 88, 12, 30, 144
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    157, 227, 189, 40, 233, 175, 36, 50, 202, 98, 99, 112, 255, 229, 74, 193
    };
    ...
    uint8_t golden[] = {
    157, 227, 189, 100, 233, 175, 124, 131, 202, 101, 99, 174, 255, 229, 74, 193
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
