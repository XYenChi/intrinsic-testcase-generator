...
int main(){
    const int32_t data1[] = {
    -109, 70, 48, 41, -100, -68, -49, 66, 45, -87, 15, 96, 121, -93, -53, -110
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -117, -10, 109, -73, 50, 121, -15, -77, -78, -66, 53, 5, 54, 16, -81, -2
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vv_32m2_b16_m (mask, data1_v, data2_v, vl);
