...
int main(){
    const int32_t data1[] = {
    -9, -113, 92, -85, 91, 42, 47, 116, 10, -74, 15, 77, 93, 127, -18, -80
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    36, -105, -1, 125, 114, -39, -26, -1, 91, -64, 58, 32, -31, -72, 90, -64
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccus_vx_i32m8 (out_data, data1_v, data2_v, vl);
