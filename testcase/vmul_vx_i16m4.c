...
int main(){
    const int16_t data1[] = {
    -70, -123, 22, 22, 6, 39, 56, 80, 37, 77, -12, -95, 54, 93, -86, 14
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -78, -2, 66, 66, 103, 42, -80, 87, -13, 5, 81, 103, -115, -41, -72, -26
    };
    ...
    int16_t golden[] = {
    5460, 246, 1452, 1452, 618, 1638, 61056, 6960, 65055, 385, 64564, 55751, 59326, 61723, 6192, 65172
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
