...
int main(){
    const int16_t data1[] = {
    -97, -17, 93, -70, -125, 122, -4, -5, 58, -71, 116, -62, -25, 67, -67, 106
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -90, 67, -56, -85, 94, -23, 43, 81, -39, 106, 9, -72, 113, -50, -83, 95
    };
    ...
    int16_t golden[] = {
    8730, 64397, 60328, 5950, 53786, 62730, 65364, 65131, 63274, 58010, 1044, 4464, 62711, 62186, 5561, 10070
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
