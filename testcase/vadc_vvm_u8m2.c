...
int main(){
    const uint8_t data1[] = {
    98, 81, 31, 231, 169, 88, 130, 222, 81, 30, 92, 94, 170, 176, 254, 0
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    146, 170, 137, 113, 99, 42, 238, 40, 241, 213, 56, 148, 224, 86, 211, 81
    };
    ...
    uint8_t golden[] = {
    244, 251, 169, 345, 268, 131, 368, 263, 322, 244, 148, 243, 394, 263, 465, 81
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
