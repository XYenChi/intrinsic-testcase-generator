...
int main(){
    const uint8_t data1[] = {
    207, 192, 216, 154, 25, 91, 104, 90, 42, 8, 225, 212, 188, 82, 93, 185
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    204, 178, 132, 8, 96, 14, 43, 107, 154, 148, 238, 185, 136, 229, 139, 48
    };
    ...
    uint8_t golden[] = {
    411, 371, 349, 162, 121, 106, 147, 197, 196, 156, 463, 397, 324, 311, 233, 234
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
