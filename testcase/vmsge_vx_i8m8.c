...
int main(){
    const int8_t data1[] = {
    -23, -27, -124, -19, 78, -79, 126, 69, -78, -123, 66, 57, 98, 99, -118, 75
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    122, 55, -107, 22, 87, 91, 28, -113, -89, 66, 122, 82, 110, 109, 60, 65
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_8m8_b1 (data1_v, data2_v, vl);
