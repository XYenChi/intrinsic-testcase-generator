...
int main(){
    const int64_t data1[] = {
    103, 70, 10, 7, 243, 89, 232, 28, 236, 66, 12, 118, 0, 147, 202, 207
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    180, 134, 51, 148, 102, 64, 255, 50, 148, 188, 210, 152, 155, 44, 245, 8
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vv_ui64m2 (data1_v, data2_v, vl);
    ...
    int64_t golden[] = {
    0, 0, 0, 0, 141, 25, 0, 0, 88, 0, 0, 0, 0, 103, 0, 199
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
