...
int main(){
    const int16_t data1[] = {
    102, 48, 55, -123, -73, -89, 30, -8, -31, -100, 38, -56, 80, 19, 30, 94
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    3, -26, -91, -70, 125, 20, -87, 20, -61, 16, 41, -106, -61, -16, -34, -77
    };
    ...
    int16_t golden[] = {
    102, 48, 55, 65466, 125, 20, 30, 20, 65505, 16, 41, 65480, 80, 19, 30, 94
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
