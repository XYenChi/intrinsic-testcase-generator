...
int main(){
    const uint8_t data1[] = {
    208, 201, 183, 247, 27, 155, 105, 214, 255, 77, 88, 171, 80, 112, 68, 86
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    218, 139, 75, 26, 252, 160, 114, 162, 14, 229, 113, 166, 224, 218, 252, 233
    };
    ...
    uint8_t golden[] = {
    218, 0, 75, 26, 1, 0, 114, 162, 14, 1, 113, 1, 0, 1, 0, 233
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
