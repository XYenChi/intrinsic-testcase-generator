...
int main(){
    const int32_t data1[] = {
    -72, -41, -61, -75, 74, 34, 125, 61, 32, -86, 50, -105, -123, 42, 51, 23
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    97, -82, -24, 18, -78, -112, -9, -25, -118, 62, -113, -85, -15, 122, 93, -91
    };
    ...
    int32_t golden[] = {
    25, -122, -84, -57, -3, -78, 116, 36, -86, -23, -62, -189, -138, 165, 145, -68
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
