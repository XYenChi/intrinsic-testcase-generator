...
int main(){
    const int32_t data1[] = {
    -42, 81, -95, 113, -42, -65, 98, 28, 88, -78, 35, 122, -32, 43, -48, -31
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -100, -19, 17, 96, 117, 88, -85, -86, -23, -11, 35, 39, -118, 96, -12, 82
    };
    ...
    int32_t golden[] = {
    -142, 62, -77, 209, 76, 24, 14, -58, 66, -89, 71, 162, -149, 140, -60, 52
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
