...
int main(){
    const int8_t data1[] = {
    -57, -46, -62, -21, -17, 125, 104, -14, 55, 58, -128, 76, -50, 118, 69, -50
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    10, 126, 33, -86, -46, 122, 13, 16, 51, -63, 50, -38, -27, -41, -110, 107
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccsu_vv_i8mf8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    199, 0, 3, 1, 14, 147, 0, 1, 1, 187, 1, 1, 70, 27, 91, 26
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
