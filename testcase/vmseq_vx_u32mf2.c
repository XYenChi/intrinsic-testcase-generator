...
int main(){
    ...
    145, 50, 177, 140, 43, 183, 10, 140, 224, 28, 188, 180, 194, 231, 65, 161
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    24, 228, 86, 166, 113, 11, 134, 211, 58, 35, 200, 175, 129, 6, 15, 31
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_32mf2_b64 (data1_v, data2_v, vl);
