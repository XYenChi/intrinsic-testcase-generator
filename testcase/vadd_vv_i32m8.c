...
int main(){
    const int32_t data1[] = {
    88, 51, 82, -99, -63, 114, 20, 98, 57, 55, -100, -112, 61, -6, -71, -12
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    24, 71, -30, 5, 39, -127, 50, -128, 81, -54, -65, -98, 2, -6, -62, 36
    };
    ...
    int32_t golden[] = {
    112, 122, 52, 4294967202, 4294967272, 4294967283, 70, 4294967266, 138, 1, 4294967131, 4294967086, 63, 4294967284, 4294967163, 24
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
