...
int main(){
    const int32_t data1[] = {
    72, 118, -54, -97, -50, 53, 93, -126, -13, 86, 123, 32, -30, 71, 105, -9
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -39, 84, 89, -121, -118, -64, -54, -105, 31, 100, -107, -77, -77, -105, 52, 32
    };
    ...
    int32_t golden[] = {
    33, 202, 35, 4294967078, 4294967128, 4294967285, 39, 4294967065, 18, 186, 16, 4294967251, 4294967189, 4294967262, 157, 23
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
