...
int main(){
    const uint8_t data1[] = {
    4, 64, 32, 247, 112, 119, 42, 163, 18, 14, 151, 50, 31, 252, 123, 7
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    247, 108, 1, 190, 147, 230, 192, 103, 76, 110, 90, 147, 114, 238, 233, 2
    };
    ...
    uint8_t golden[] = {
    247, 172, 33, 190, 3, 93, 234, 10, 94, 124, 90, 197, 114, 238, 100, 2
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
