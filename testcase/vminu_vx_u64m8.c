...
int main(){
    ...
    121, 167, 161, 158, 51, 97, 98, 16, 194, 114, 14, 254, 65, 195, 201, 69
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    117, 82, 127, 135, 157, 208, 47, 41, 77, 137, 146, 166, 162, 204, 203, 140
    };
    ...
    uint64_t golden[] = {
    121, 167, 161, 158, 157, 208, 98, 41, 194, 137, 146, 254, 162, 204, 203, 140
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
