...
int main(){
    ...
    59, 8, 202, 158, 106, 255, 15, 132, 72, 184, 71, 179, 196, 224, 17, 133
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    141, 154, 17, 176, 206, 151, 239, 164, 81, 77, 212, 121, 250, 120, 107, 61
    };
    ...
    uint64_t golden[] = {
    141, 154, 202, 176, 206, 255, 239, 164, 81, 184, 212, 179, 250, 224, 107, 133
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
