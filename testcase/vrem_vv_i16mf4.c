...
int main(){
    const int16_t data1[] = {
    -20, 62, -53, 44, -59, 78, 65, -56, 107, 64, 2, 12, -91, 100, 14, 0
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    6, 4, 90, 0, -58, -76, 80, -125, 93, -25, -106, -9, -68, 67, 7, -60
    };
    ...
    int16_t golden[] = {
    65522, 4, 65520, 0, 65478, 2, 15, 65523, 93, 39, 0, 3, 65468, 67, 7, 65476
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
