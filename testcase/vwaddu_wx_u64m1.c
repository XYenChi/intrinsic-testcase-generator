...
int main(){
    ...
    86, 77, 212, 244, 161, 182, 249, 175, 108, 233, 80, 184, 234, 219, 46, 109
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    238, 134, 144, 3, 97, 233, 198, 230, 183, 30, 236, 192, 39, 128, 8, 36
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u64m1 (data1_v, data2_v, vl);
