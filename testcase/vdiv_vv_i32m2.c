...
int main(){
    const int32_t data1[] = {
    7, 1, 73, -24, 32, -29, 32, 29, -36, 118, -101, -8, -13, -122, 66, 8
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -26, 32, 80, 113, -66, 55, 23, 106, 105, -56, -93, 108, 78, 99, 54, 33
    };
    ...
    int32_t golden[] = {
    4294967292, 32, 1, 4294967291, 4294967293, 4294967294, 0, 3, 4294967293, 4294967295, 0, 4294967282, 4294967290, 4294967295, 0, 4
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
