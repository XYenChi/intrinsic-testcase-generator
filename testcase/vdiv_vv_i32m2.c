...
int main(){
    const int32_t data1[] = {
    74, 25, 106, -59, 86, -1, 84, 105, -120, -110, 60, 117, 48, 25, 97, 38
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -117, -23, 60, 116, 73, -105, 101, -27, -119, -125, 75, 29, 59, 57, 67, 59
    };
    ...
    int32_t golden[] = {
    4294967294, 4294967295, 0, 4294967294, 0, 105, 1, 4294967295, 0, 1, 1, 0, 1, 2, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
