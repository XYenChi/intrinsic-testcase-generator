...
int main(){
    const int64_t data1[] = {
    18, -68, -114, 7, -86, -45, -44, -112, 73, 12, 41, -112, 0, -111, -4, -105
    };
    const int64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    246, 112, 30, 241, 15, 15, 51, 128, 236, 187, 125, 151, 184, 153, 128, 123
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_64m4_b16 (data1_v, data2_v, vl);
