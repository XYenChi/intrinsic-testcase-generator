...
int main(){
    ...
    59, 42, 212, 29, 156, 250, 246, 44, 3, 137, 104, 84, 186, 64, 58, 241
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    167, 167, 22, 190, 43, 34, 177, 94, 181, 142, 41, 168, 129, 204, 59, 200
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u16mf4 (data1_v, data2_v, vl);
