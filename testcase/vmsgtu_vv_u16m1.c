...
int main(){
    ...
    185, 96, 182, 83, 233, 132, 61, 89, 10, 241, 115, 58, 89, 200, 138, 199
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    186, 42, 102, 125, 96, 234, 130, 198, 126, 79, 59, 15, 192, 177, 171, 35
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_16m1_b16 (data1_v, data2_v, vl);
