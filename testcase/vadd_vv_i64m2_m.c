...
int main(){
    const int64_t data1[] = {
    66, 90, -36, -15, 115, -66, -69, -89, 38, 71, 119, 42, 98, 40, -113, -57
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    28, 34, -121, -86, -46, -126, -51, -35, -87, 110, 66, 19, -119, -74, 13, 25
    };
    ...
    int64_t golden[] = {
    1, 124, 1, 0, 69, 0, 0, 0, 1, 181, 1, 0, 1, 0, 18446744073709551516, 18446744073709551584
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
