...
int main(){
    const int64_t data1[] = {
    -76, -14, 4, -123, -88, -115, 99, 41, 80, -25, -115, -54, 98, -68, 16, 116
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    5, 39, -44, -118, 88, -3, 81, 114, -86, -3, 78, -70, -102, 15, 85, -70
    };
    ...
    int64_t golden[] = {
    1, 25, 1, 1, 0, 18446744073709551498, 0, 0, 18446744073709551610, 0, 18446744073709551579, 0, 1, 18446744073709551563, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
