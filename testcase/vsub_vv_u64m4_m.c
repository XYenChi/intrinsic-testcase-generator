...
int main(){
    ...
    89, 221, 134, 38, 136, 171, 97, 154, 52, 102, 224, 101, 2, 162, 145, 62
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    121, 243, 157, 38, 59, 61, 184, 196, 151, 251, 70, 158, 161, 153, 183, 107
    };
    ...
    uint64_t golden[] = {
    1, 18446744073709551594, 1, 0, 77, 110, 0, 1, 18446744073709551517, 18446744073709551467, 154, 18446744073709551559, 18446744073709551457, 9, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
