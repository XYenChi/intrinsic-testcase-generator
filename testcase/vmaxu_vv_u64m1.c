...
int main(){
    ...
    68, 8, 97, 194, 55, 181, 177, 111, 140, 23, 124, 121, 155, 166, 205, 148
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    34, 18, 197, 28, 183, 144, 201, 141, 221, 157, 65, 186, 75, 223, 12, 140
    };
    ...
    uint64_t golden[] = {
    68, 18, 197, 194, 183, 181, 201, 141, 221, 157, 124, 186, 155, 223, 205, 148
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
