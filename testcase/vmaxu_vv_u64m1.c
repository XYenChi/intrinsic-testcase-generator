...
int main(){
    ...
    212, 213, 212, 53, 242, 207, 99, 42, 75, 3, 243, 228, 117, 127, 255, 60
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    48, 242, 82, 5, 23, 35, 30, 36, 136, 166, 152, 182, 157, 2, 35, 199
    };
    ...
    uint64_t golden[] = {
    212, 242, 212, 53, 242, 207, 99, 42, 136, 166, 243, 228, 157, 127, 255, 199
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
