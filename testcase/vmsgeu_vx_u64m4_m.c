...
int main(){
    ...
    65, 117, 246, 30, 186, 138, 231, 233, 140, 231, 218, 230, 149, 176, 70, 245
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    157, 126, 133, 62, 124, 131, 14, 211, 150, 149, 80, 129, 27, 219, 187, 34
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_64m4_b16 (mask, data1_v, data2_v, vl);
