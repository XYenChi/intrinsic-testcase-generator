...
int main(){
    ...
    128, 206, 187, 64, 48, 7, 78, 254, 145, 255, 31, 183, 29, 69, 80, 94
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    217, 107, 121, 155, 164, 164, 149, 227, 141, 34, 247, 58, 1, 49, 191, 111
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u16mf2 (data1_v, data2_v, vl);
