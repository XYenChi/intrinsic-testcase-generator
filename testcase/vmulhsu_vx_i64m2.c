...
int main(){
    const int64_t data1[] = {
    -70, -45, 64, 60, 120, 5, 47, 103, -102, 122, 97, -19, 59, 19, -50, 84
    };
    const int64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    73, 111, 16, 7, 197, 101, 210, 122, 19, 85, 100, 83, 80, 209, 253, 19
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_64m2_b32 (data1_v, data2_v, vl);
