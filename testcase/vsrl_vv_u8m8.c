...
int main(){
    const uint8_t data1[] = {
    68, 143, 140, 213, 244, 175, 146, 8, 184, 233, 98, 140, 146, 99, 232, 206
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    70, 156, 54, 186, 157, 194, 106, 184, 198, 240, 58, 173, 153, 97, 206, 13
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u8m8 (data1_v, shift, vl);
