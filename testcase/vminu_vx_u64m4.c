...
int main(){
    ...
    106, 75, 107, 86, 94, 208, 251, 216, 223, 0, 4, 236, 76, 96, 29, 69
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    193, 33, 25, 79, 90, 190, 57, 255, 92, 132, 172, 82, 73, 80, 201, 237
    };
    ...
    uint64_t golden[] = {
    193, 75, 107, 86, 94, 208, 251, 255, 223, 132, 172, 236, 76, 96, 201, 237
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
