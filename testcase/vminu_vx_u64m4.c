...
int main(){
    ...
    6, 91, 77, 120, 6, 54, 99, 61, 66, 247, 180, 93, 127, 192, 34, 235
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    10, 144, 97, 227, 120, 105, 14, 247, 188, 188, 142, 73, 98, 9, 106, 109
    };
    ...
    uint64_t golden[] = {
    10, 144, 97, 227, 120, 105, 99, 247, 188, 247, 180, 93, 127, 192, 106, 235
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
