...
int main(){
    const uint8_t data1[] = {
    204, 232, 16, 84, 31, 16, 81, 8, 191, 248, 157, 166, 94, 155, 125, 160
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    74, 9, 50, 117, 104, 158, 38, 96, 2, 196, 205, 254, 58, 42, 110, 124
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_8mf4_b32 (mask, data1_v, data2_v, vl);
