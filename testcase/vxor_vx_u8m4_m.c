...
int main(){
    const uint8_t data1[] = {
    12, 220, 196, 122, 49, 181, 0, 32, 51, 62, 139, 190, 94, 200, 131, 200
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    121, 229, 173, 166, 90, 163, 255, 71, 70, 153, 234, 207, 242, 25, 81, 243
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u8m4_m (mask, data1_v, data2_v, vl);
