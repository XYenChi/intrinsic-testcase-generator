...
int main(){
    const int16_t data1[] = {
    -88, 127, 119, -113, 79, -45, -19, -66, -116, -12, 119, 48, 0, 29, -25, 14
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -64, 69, 55, 32, -6, -66, 23, 101, -118, -18, 84, -14, -86, 121, -95, 14
    };
    ...
    int16_t golden[] = {
    -64, 127, 119, -113, 79, -45, 23, 101, -116, -18, 84, -14, 0, 121, -25, 14
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
