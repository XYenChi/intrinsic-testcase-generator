...
int main(){
    const uint8_t data1[] = {
    216, 170, 37, 8, 51, 95, 71, 10, 93, 105, 79, 74, 124, 67, 147, 15
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    4, 252, 146, 17, 3, 112, 181, 26, 163, 25, 116, 104, 117, 128, 147, 118
    };
    ...
    uint8_t golden[] = {
    0, 0, 146, 17, 3, 1, 181, 1, 163, 25, 116, 104, 1, 1, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
