...
int main(){
    const uint8_t data1[] = {
    221, 11, 231, 103, 41, 63, 19, 139, 149, 224, 169, 87, 203, 125, 148, 193
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    71, 115, 103, 34, 251, 215, 76, 120, 95, 135, 36, 80, 159, 180, 31, 187
    };
    ...
    uint8_t golden[] = {
    1, 115, 103, 34, 251, 215, 76, 120, 95, 1, 1, 1, 159, 0, 1, 187
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
