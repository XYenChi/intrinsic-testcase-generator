...
int main(){
    const int8_t data1[] = {
    -59, 99, -59, 72, -81, 126, -13, -61, -122, -50, -7, -11, -51, -107, -25, 16
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -2, -103, 101, 58, -84, 90, -126, 10, -23, 72, -18, -76, 75, 56, 0, -64
    };
    ...
    int8_t golden[] = {
    199, 202, 96, 14, 3, 36, 113, 185, 157, 134, 11, 65, 130, 93, 231, 80
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
