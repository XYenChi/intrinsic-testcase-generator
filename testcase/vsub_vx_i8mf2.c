...
int main(){
    const int8_t data1[] = {
    124, -82, -122, 97, -91, -94, -110, 16, 18, 87, 4, -68, -88, 97, 122, -100
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -59, 57, -6, 66, 65, -2, -41, -91, -105, 94, -38, 78, 53, -72, -88, -26
    };
    ...
    int8_t golden[] = {
    127, -128, -116, 31, -128, -92, -69, 107, 123, -7, 42, -128, -128, 127, 127, -74
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
