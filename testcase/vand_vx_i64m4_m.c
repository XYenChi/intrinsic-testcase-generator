...
int main(){
    const int64_t data1[] = {
    -33, 41, -36, 39, 108, 123, 111, -93, -117, -114, 54, 7, 29, 62, -37, -18
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -114, 54, 98, -86, 103, -62, 117, -18, -4, 114, -128, -126, 16, 120, -18, 26
    };
    ...
    int64_t golden[] = {
    0, 54, 98, 1, 1, 1, 1, 0, 18446744073709551612, 114, 1, 18446744073709551490, 16, 120, 18446744073709551598, 26
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
