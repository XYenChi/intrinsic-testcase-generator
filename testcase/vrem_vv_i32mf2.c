...
int main(){
    const int32_t data1[] = {
    -113, 83, -128, 31, 52, 33, 6, -98, -23, 79, 68, -43, 112, 75, 41, 59
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -99, 33, -108, 34, -97, -41, -40, 46, 74, 88, -83, -98, 69, -61, 66, 62
    };
    ...
    int32_t golden[] = {
    4294967197, 33, 4294967188, 3, 7, 25, 2, 4294967244, 4294967278, 9, 53, 4294967284, 69, 14, 25, 3
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
