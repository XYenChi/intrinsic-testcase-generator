...
int main(){
    ...
    193, 222, 175, 221, 208, 105, 238, 122, 247, 233, 213, 138, 15, 132, 248, 235
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    18, 204, 24, 168, 127, 172, 209, 17, 145, 179, 3, 20, 76, 215, 118, 99
    };
    ...
    uint16_t golden[] = {
    0, 1, 4200, 37128, 1, 0, 49742, 2074, 35815, 1, 639, 0, 1140, 28380, 29264, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
