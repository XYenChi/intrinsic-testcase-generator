...
int main(){
    ...
    95, 56, 182, 216, 129, 137, 54, 3, 98, 164, 9, 237, 107, 223, 118, 46
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    76, 252, 20, 96, 122, 148, 85, 154, 198, 205, 232, 66, 79, 194, 146, 99
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_16m1_b16_m (mask, data1_v, data2_v, vl);
