...
int main(){
    ...
    221, 94, 20, 91, 24, 93, 163, 79, 227, 125, 85, 128, 92, 217, 65, 166
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    156, 114, 220, 178, 218, 204, 4, 46, 152, 88, 183, 237, 225, 163, 201, 100
    };
    ...
    uint64_t golden[] = {
    377, 208, 240, 269, 242, 297, 167, 125, 379, 213, 268, 365, 317, 380, 266, 266
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
