...
int main(){
    const int64_t data1[] = {
    126, 193, 21, 70, 64, 12, 75, 17, 198, 204, 94, 220, 146, 202, 154, 93
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    11, 83, 80, 24, 33, 129, 98, 211, 93, 5, 234, 205, 186, 31, 102, 126
    };
    ...
    int64_t golden[] = {
    137, 276, 101, 94, 97, 141, 173, 228, 291, 209, 328, 425, 332, 233, 256, 219
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
