...
int main(){
    const uint8_t data1[] = {
    153, 224, 104, 72, 71, 237, 127, 65, 223, 116, 245, 146, 26, 53, 81, 153
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    50, 137, 121, 1, 90, 28, 212, 225, 222, 30, 216, 152, 217, 46, 170, 22
    };
    ...
    uint8_t golden[] = {
    153, 224, 121, 72, 90, 237, 212, 225, 223, 116, 245, 152, 217, 53, 170, 153
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
