...
int main(){
    const uint8_t data1[] = {
    195, 181, 224, 155, 186, 65, 252, 126, 53, 65, 118, 144, 219, 120, 96, 178
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    47, 154, 204, 230, 17, 191, 74, 228, 149, 71, 63, 27, 211, 130, 202, 53
    };
    ...
    uint8_t golden[] = {
    195, 181, 224, 230, 186, 191, 252, 228, 149, 71, 118, 144, 219, 130, 202, 178
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
