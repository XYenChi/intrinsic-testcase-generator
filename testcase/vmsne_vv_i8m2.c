...
int main(){
    const int8_t data1[] = {
    89, 44, -107, -124, -85, 31, -89, 89, -41, 47, -75, 87, -121, -15, -65, 1
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    117, 105, 27, -15, -59, -116, -113, 109, -21, -120, 108, -76, 27, -84, 64, -83
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_8m2_b4 (data1_v, data2_v, vl);
