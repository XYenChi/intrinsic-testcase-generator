...
int main(){
    ...
    110, 168, 215, 78, 85, 83, 12, 61, 117, 209, 35, 33, 214, 74, 234, 28
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    237, 70, 122, 101, 249, 153, 76, 165, 193, 20, 138, 147, 62, 42, 163, 9
    };
    ...
    uint16_t golden[] = {
    237, 168, 215, 101, 249, 153, 76, 165, 193, 209, 138, 147, 214, 74, 234, 28
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
