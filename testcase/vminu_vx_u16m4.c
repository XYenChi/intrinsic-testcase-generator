...
int main(){
    ...
    168, 210, 204, 53, 93, 209, 244, 183, 42, 219, 183, 53, 234, 143, 217, 233
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    178, 44, 147, 60, 98, 164, 142, 168, 64, 42, 232, 49, 170, 55, 164, 112
    };
    ...
    uint16_t golden[] = {
    178, 210, 204, 60, 98, 209, 244, 183, 64, 219, 232, 53, 234, 143, 217, 233
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
