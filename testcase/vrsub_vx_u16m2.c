...
int main(){
    ...
    9, 169, 243, 226, 199, 89, 150, 87, 26, 182, 92, 243, 153, 25, 22, 126
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    149, 63, 64, 173, 197, 220, 169, 5, 61, 70, 124, 233, 236, 125, 211, 246
    };
    ...
    uint16_t golden[] = {
    140, 65430, 65357, 65483, 65534, 131, 19, 65454, 35, 65424, 32, 65526, 83, 100, 189, 120
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
