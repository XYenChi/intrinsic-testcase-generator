...
int main(){
    const int32_t data1[] = {
    -72, -99, 19, -87, -66, -28, 7, -5, -71, 83, -58, 114, -108, 3, -70, -38
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    94, -26, 37, -66, 108, -25, 121, 84, 122, 6, -122, 90, 96, -128, 29, 22
    };
    ...
    int32_t golden[] = {
    94, 4294967270, 37, 4294967230, 108, 4294967271, 121, 84, 122, 83, 4294967238, 114, 96, 3, 29, 22
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
