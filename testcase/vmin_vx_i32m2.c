...
int main(){
    const int32_t data1[] = {
    -3, 45, -14, -54, -50, -29, 54, -73, -94, 109, 94, 13, -76, -31, 104, 74
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    98, -55, -79, -40, 73, 111, 110, -94, 78, -23, 58, -90, -72, 32, -16, -107
    };
    ...
    int32_t golden[] = {
    98, 45, 4294967282, 4294967256, 73, 111, 110, 4294967223, 78, 109, 94, 13, 4294967224, 32, 104, 74
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
