...
int main(){
    ...
    145, 37, 13, 42, 188, 247, 52, 85, 33, 154, 163, 247, 190, 48, 64, 50
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    168, 30, 197, 163, 208, 81, 77, 248, 100, 82, 78, 102, 247, 166, 64, 13
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_32m8 (data1_v, shift, vl);
