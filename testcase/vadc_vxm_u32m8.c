...
int main(){
    ...
    217, 203, 198, 155, 124, 16, 45, 147, 208, 13, 68, 32, 40, 61, 56, 72
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    193, 77, 134, 217, 25, 58, 125, 201, 191, 2, 190, 238, 176, 153, 122, 150
    };
    ...
    uint32_t golden[] = {
    411, 281, 333, 372, 149, 75, 171, 349, 399, 16, 258, 270, 216, 215, 179, 223
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
