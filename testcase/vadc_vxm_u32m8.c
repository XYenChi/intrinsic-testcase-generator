...
int main(){
    ...
    105, 230, 180, 234, 81, 45, 64, 120, 226, 166, 112, 90, 26, 133, 99, 181
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    216, 155, 214, 35, 25, 238, 106, 19, 10, 100, 29, 197, 232, 151, 212, 171
    };
    ...
    uint32_t golden[] = {
    321, 385, 395, 270, 106, 283, 170, 139, 236, 266, 141, 288, 259, 284, 312, 352
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
