...
int main(){
    const int8_t data1[] = {
    26, 39, -103, -118, -107, 53, 57, 94, -20, 39, 127, -62, -52, 9, 21, -95
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -61, -35, -92, -54, 93, -9, 112, 17, -33, -97, -73, 23, 56, 125, -79, 53
    };
    ...
    int8_t golden[] = {
    87, 74, 245, 192, 56, 62, 201, 77, 13, 136, 200, 171, 148, 140, 100, 108
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
