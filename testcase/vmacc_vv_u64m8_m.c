...
int main(){
    ...
    218, 182, 22, 168, 124, 181, 39, 221, 124, 205, 160, 153, 0, 56, 225, 125
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    70, 60, 42, 232, 154, 43, 34, 217, 228, 178, 178, 211, 191, 182, 103, 167
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmacc_vv_u64m8_m (mask, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    15261, 1, 925, 38976, 19096, 7783, 0, 47958, 28273, 1, 1, 32283, 1, 10192, 0, 20876
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
