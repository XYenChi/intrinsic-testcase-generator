...
int main(){
    ...
    166, 210, 141, 78, 96, 139, 64, 72, 70, 227, 143, 178, 255, 54, 129, 92
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    56, 55, 1, 255, 20, 169, 201, 140, 186, 93, 235, 40, 4, 108, 253, 141
    };
    ...
    uint32_t golden[] = {
    1, 0, 1, 333, 1, 1, 0, 212, 1, 0, 378, 218, 1, 0, 382, 233
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
