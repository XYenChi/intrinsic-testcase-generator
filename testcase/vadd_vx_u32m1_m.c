...
int main(){
    ...
    119, 50, 233, 113, 22, 79, 159, 119, 46, 243, 238, 135, 24, 170, 206, 169
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    198, 92, 224, 52, 222, 127, 241, 106, 45, 190, 24, 16, 204, 163, 239, 113
    };
    ...
    uint32_t golden[] = {
    317, 1, 1, 165, 1, 1, 400, 225, 91, 433, 262, 151, 0, 333, 1, 282
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
