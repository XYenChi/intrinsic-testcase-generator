...
int main(){
    ...
    149, 32, 72, 112, 29, 24, 17, 204, 73, 175, 94, 191, 69, 110, 246, 214
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    77, 113, 167, 46, 217, 198, 12, 13, 89, 154, 252, 216, 105, 139, 209, 249
    };
    ...
    uint64_t golden[] = {
    77, 113, 167, 46, 246, 222, 29, 13, 89, 154, 252, 216, 174, 249, 209, 249
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
