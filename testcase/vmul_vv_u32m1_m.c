...
int main(){
    ...
    91, 64, 128, 43, 232, 39, 245, 106, 41, 27, 63, 149, 13, 34, 125, 39
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    91, 133, 208, 102, 56, 131, 201, 3, 236, 241, 203, 229, 252, 216, 43, 199
    };
    ...
    uint32_t golden[] = {
    8281, 1, 26624, 4386, 12992, 5109, 0, 0, 9676, 0, 12789, 34121, 0, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
