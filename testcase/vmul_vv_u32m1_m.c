...
int main(){
    ...
    63, 99, 202, 130, 197, 179, 95, 128, 49, 168, 132, 160, 70, 206, 192, 179
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    27, 75, 85, 222, 43, 13, 2, 53, 45, 141, 148, 224, 68, 227, 114, 13
    };
    const uint32_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e32m1(avl);
    const uint out_data[] = {
    1, 0, 1, 0, 0, 0, 0, 1, 1, 0, 1, 1, 1, 0, 0, 1
    };
    ...
    uint32_t golden[] = {
    1, 7425, 17170, 28860, 0, 2327, 0, 1, 1, 23688, 19536, 35840, 1, 0, 0, 2327
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
