...
int main(){
    const uint8_t data1[] = {
    249, 237, 6, 237, 148, 97, 244, 103, 87, 30, 61, 231, 208, 55, 13, 157
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    98, 107, 25, 90, 71, 188, 50, 22, 189, 192, 58, 108, 29, 50, 237, 181
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u8m4 (data1_v, shift, vl);
