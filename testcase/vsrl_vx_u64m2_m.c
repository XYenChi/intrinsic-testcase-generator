...
int main(){
    ...
    7, 27, 89, 46, 2, 201, 93, 222, 15, 233, 7, 31, 29, 181, 98, 18
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    116, 99, 249, 107, 15, 130, 29, 28, 48, 206, 132, 195, 157, 52, 85, 224
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u64m2_m (mask, data1_v, shift, vl);
    ...
    uint64_t golden[] = {
    7, 13, 44, 23, 1, 201, 46, 222, 15, 233, 7, 15, 14, 181, 49, 18
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
