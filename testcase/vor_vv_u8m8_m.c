...
int main(){
    const uint8_t data1[] = {
    220, 246, 46, 243, 122, 251, 208, 21, 211, 214, 225, 118, 50, 239, 179, 144
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    167, 207, 108, 230, 6, 85, 8, 126, 207, 247, 160, 99, 107, 178, 238, 74
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wv_8m8u_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    1, 1, 110, 1, 0, 255, 0, 127, 0, 0, 1, 0, 1, 255, 255, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
