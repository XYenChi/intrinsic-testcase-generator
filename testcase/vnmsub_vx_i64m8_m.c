...
int main(){
    const int64_t data1[] = {
    -24, -44, 16, -8, -107, 70, 34, 96, 87, 71, -79, -43, 123, 5, -88, 29
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    36, 12, -114, 125, 109, -22, -23, 87, 104, 81, 88, 9, -42, 106, -43, -65
    };
    ...
    int64_t golden[] = {
    18446744073709551556, 1, 130, 18446744073709551608, 18446744073709551509, 92, 0, 0, 0, 18446744073709551606, 0, 1, 123, 18446744073709551515, 18446744073709551571, 29
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
