...
int main(){
    const int16_t data1[] = {
    14, 15, -124, -122, 58, -55, -75, 53, 106, 102, -28, -111, -81, 79, -52, -17
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -38, 32, 68, 61, 23, -58, -128, -74, 119, 94, -125, 92, -17, 92, 124, -17
    };
    const int16_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e16mf4(avl);
    const int out_data[] = {
    0, 1, 1, 0, 0, 0, 1, 1, 0, 1, 0, 0, 0, 0, 1, 1
    };
    ...
    int16_t golden[] = {
    65484, 17, 1, 183, 65501, 65533, 1, 1, 0, 1, 0, 0, 64, 13, 176, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
