...
int main(){
    const int16_t data1[] = {
    118, -108, -6, 116, 74, -118, 26, -40, 63, 59, -22, 94, 19, -75, -89, 3
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    68, -65, 71, -125, -62, 71, -39, 99, -81, -88, -70, -90, 123, 88, -86, 52
    };
    ...
    int16_t golden[] = {
    118, 65471, 71, 116, 74, 71, 26, 99, 63, 59, 65514, 94, 123, 88, 65450, 52
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
