...
int main(){
    ...
    229, 47, 32, 140, 190, 41, 137, 112, 195, 103, 94, 3, 111, 226, 232, 253
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnot_v_u16mf4 (data1_v, vl);
    ...
    uint16_t golden[] = {
    -230, -48, -33, -141, -191, -42, -138, -113, -196, -104, -95, -4, -112, -227, -233, -254
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
