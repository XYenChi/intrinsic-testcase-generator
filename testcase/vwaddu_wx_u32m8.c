...
int main(){
    ...
    105, 240, 221, 57, 8, 61, 142, 7, 12, 213, 146, 176, 172, 88, 66, 159
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    180, 115, 86, 68, 57, 204, 47, 134, 77, 42, 153, 216, 185, 69, 44, 207
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u32m8 (data1_v, data2_v, vl);
