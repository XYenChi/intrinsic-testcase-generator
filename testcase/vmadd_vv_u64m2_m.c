...
int main(){
    ...
    48, 76, 23, 73, 246, 24, 189, 147, 10, 24, 135, 52, 159, 65, 91, 66
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    170, 124, 217, 10, 234, 215, 113, 247, 156, 64, 183, 111, 154, 48, 47, 140
    };
    ...
    uint64_t golden[] = {
    48, 124, 23, 83, 234, 215, 302, 247, 10, 88, 183, 111, 159, 113, 47, 206
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
