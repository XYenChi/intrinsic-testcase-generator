...
int main(){
    ...
    53, 32, 181, 146, 79, 93, 42, 145, 58, 197, 163, 216, 133, 241, 140, 15
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    82, 40, 74, 233, 174, 189, 159, 234, 219, 142, 166, 23, 172, 147, 2, 115
    };
    ...
    uint32_t masked[] = {
    1, 1, 1, 0, 1, 0, 0, 0, 1, 1, 1, 1, 1, 0, 1, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmadd_vv_u64m2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    82, 72, 255, 146, 253, 93, 42, 145, 277, 142, 329, 239, 172, 241, 142, 15
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
