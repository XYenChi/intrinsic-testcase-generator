...
int main(){
    ...
    45, 93, 104, 201, 101, 211, 157, 164, 38, 102, 202, 130, 218, 130, 165, 196
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    206, 69, 39, 150, 217, 2, 196, 73, 158, 104, 74, 204, 146, 108, 124, 151
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u64m4_m (mask, data1_v, data2_v, vl);
