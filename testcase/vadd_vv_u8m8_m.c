...
int main(){
    const uint8_t data1[] = {
    65, 115, 6, 141, 144, 234, 56, 225, 107, 18, 71, 180, 112, 103, 204, 22
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    114, 33, 137, 68, 87, 95, 114, 119, 96, 34, 47, 177, 154, 10, 196, 75
    };
    ...
    uint8_t golden[] = {
    0, 0, 1, 209, 0, 1, 170, 88, 0, 1, 118, 1, 10, 113, 144, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
