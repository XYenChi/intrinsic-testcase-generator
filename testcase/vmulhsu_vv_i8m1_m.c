...
int main(){
    const int8_t data1[] = {
    22, 81, 30, -88, -98, -121, -70, -88, -96, 97, -82, 73, 3, -13, 41, -23
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    212, 9, 244, 212, 16, 60, 148, 130, 72, 189, 184, 166, 244, 193, 151, 199
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_8m1_b8 (mask, data1_v, data2_v, vl);
