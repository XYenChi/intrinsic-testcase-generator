...
int main(){
    const uint8_t data1[] = {
    45, 213, 160, 125, 172, 75, 137, 108, 73, 58, 3, 244, 217, 55, 243, 253
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    221, 37, 68, 113, 129, 43, 116, 200, 254, 39, 198, 222, 200, 85, 105, 111
    };
    ...
    uint8_t golden[] = {
    1, 213, 160, 125, 0, 75, 1, 1, 1, 1, 1, 0, 1, 1, 0, 253
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
