...
int main(){
    ...
    163, 175, 222, 76, 213, 63, 29, 2, 157, 156, 57, 156, 25, 109, 203, 206
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    222, 111, 95, 148, 71, 103, 240, 126, 220, 168, 63, 215, 146, 77, 215, 113
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_64m8_b8_m (mask, data1_v, data2_v, vl);
