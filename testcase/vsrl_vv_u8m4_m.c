...
int main(){
    const uint8_t data1[] = {
    141, 36, 159, 52, 2, 104, 109, 17, 173, 98, 47, 221, 165, 113, 73, 53
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    129, 56, 22, 1, 92, 70, 219, 148, 29, 69, 6, 19, 117, 114, 80, 179
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u8m4_m (mask, data1_v, shift, vl);
    ...
    uint8_t golden[] = {
    70, 36, 159, 26, 2, 104, 54, 17, 86, 49, 47, 110, 82, 113, 73, 26
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
