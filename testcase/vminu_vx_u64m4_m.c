...
int main(){
    ...
    63, 214, 84, 61, 101, 37, 24, 91, 161, 232, 81, 171, 238, 127, 181, 129
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    185, 190, 178, 238, 168, 8, 185, 43, 175, 136, 137, 90, 135, 188, 199, 190
    };
    ...
    uint64_t golden[] = {
    185, 1, 178, 0, 0, 37, 1, 91, 1, 1, 1, 171, 0, 0, 199, 190
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
