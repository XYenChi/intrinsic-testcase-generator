...
int main(){
    ...
    227, 219, 238, 9, 94, 130, 36, 91, 231, 238, 107, 186, 15, 44, 201, 7
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    29, 157, 249, 122, 149, 104, 104, 60, 86, 9, 140, 119, 26, 42, 30, 79
    };
    ...
    uint64_t golden[] = {
    0, 219, 249, 122, 0, 130, 1, 1, 0, 238, 1, 186, 0, 1, 0, 79
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
