...
int main(){
    ...
    13, 250, 198, 172, 250, 177, 147, 67, 165, 87, 55, 27, 226, 238, 160, 45
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    51, 228, 163, 118, 31, 61, 20, 199, 171, 137, 9, 154, 121, 75, 50, 69
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u16mf2_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    0, 0, 163, 118, 0, 61, 0, 1, 6, 50, 9, 19, 121, 75, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
