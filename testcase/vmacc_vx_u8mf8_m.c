...
int main(){
    const uint8_t data1[] = {
    56, 35, 180, 100, 59, 241, 45, 213, 195, 18, 63, 85, 30, 217, 174, 210
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    55, 207, 153, 108, 43, 16, 90, 29, 137, 104, 125, 39, 157, 79, 3, 22
    };
    ...
    uint8_t golden[] = {
    8, 77, 149, 48, 1, 1, 0, 34, 0, 81, 196, 244, 103, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
