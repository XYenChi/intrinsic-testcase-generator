...
int main(){
    const uint8_t data1[] = {
    87, 250, 22, 11, 40, 110, 54, 80, 152, 188, 57, 109, 122, 5, 95, 86
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    218, 247, 173, 91, 249, 22, 71, 10, 80, 131, 73, 116, 82, 202, 194, 120
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmacc_vx_u8mf8_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 0, 222, 234, 232, 0, 0, 32, 1, 0, 66, 1, 0, 242, 255, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
