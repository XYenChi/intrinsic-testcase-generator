...
int main(){
    const uint8_t data1[] = {
    150, 95, 115, 119, 213, 139, 2, 67, 100, 206, 141, 141, 141, 56, 217, 189
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    154, 116, 136, 198, 172, 240, 194, 16, 81, 22, 141, 48, 250, 84, 139, 224
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_8mf4_m (mask, data1_v, shift, vl);
