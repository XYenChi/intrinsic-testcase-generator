...
int main(){
    const int8_t data1[] = {
    -107, 71, -35, -91, -89, 16, 113, -62, 14, 1, -1, -27, 30, -33, -127, 110
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    63, 112, -44, 14, 40, -6, -112, 62, -5, -100, 108, -47, 86, 49, -93, 6
    };
    ...
    uint64_t masked[] = {
    0, 0, 1, 1, 1, 0, 0, 1, 1, 0, 1, 1, 1, 0, 1, 0
    };
    ...
    int8_t golden[] = {
    1, 0, 9, 151, 127, 1, 1, 132, 19, 0, 147, 20, 200, 0, 222, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
