...
int main(){
    const int32_t data1[] = {
    126, -75, 68, 71, -30, 79, -63, -90, 121, 41, 27, 50, 92, 22, -5, 77
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -26, 74, 50, -14, -8, 37, -39, -53, -16, 51, -106, -12, 54, -47, -18, 88
    };
    ...
    int32_t golden[] = {
    4294964021, 4294961746, 3400, 4294966302, 240, 2924, 2458, 4770, 4294965361, 2091, 4294964434, 4294966697, 4969, 4294966262, 91, 6776
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
