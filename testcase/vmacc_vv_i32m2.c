...
int main(){
    const int32_t data1[] = {
    49, -54, -110, -34, 99, 34, 34, -124, -80, 76, 55, 49, -75, 16, -114, -127
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -14, -122, -1, -57, -87, 111, -74, 118, 39, 43, 14, -67, -40, -104, -38, -24
    };
    ...
    int32_t golden[] = {
    4294966611, 6588, 111, 1938, 4294958684, 3775, 4294964781, 4294952664, 4294964177, 3268, 770, 4294964013, 3000, 4294965633, 4333, 3049
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
