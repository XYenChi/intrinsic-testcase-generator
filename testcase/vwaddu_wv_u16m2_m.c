...
int main(){
    ...
    33, 251, 111, 85, 197, 183, 68, 46, 110, 104, 9, 94, 16, 108, 95, 39
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    39, 126, 87, 254, 163, 152, 128, 154, 219, 194, 114, 40, 181, 9, 189, 245
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u16m2_m (mask, data1_v, data2_v, vl);
