...
int main(){
    ...
    18, 122, 3, 7, 41, 91, 10, 179, 149, 206, 186, 91, 230, 21, 122, 36
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    111, 80, 119, 219, 163, 177, 152, 150, 232, 143, 132, 155, 109, 61, 17, 213
    };
    ...
    uint16_t golden[] = {
    1998, 9760, 357, 1533, 6683, 16107, 1520, 26850, 34568, 29458, 24552, 14105, 25070, 1281, 2074, 7668
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
