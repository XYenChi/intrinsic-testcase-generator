...
int main(){
    ...
    121, 202, 140, 209, 62, 16, 202, 245, 218, 81, 234, 16, 141, 73, 159, 204
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    0, 50, 255, 170, 206, 216, 209, 230, 3, 124, 92, 25, 205, 214, 219, 115
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_32m4_b8 (data1_v, data2_v, vl);
