...
int main(){
    const uint8_t data1[] = {
    185, 253, 118, 187, 88, 195, 216, 193, 23, 243, 10, 67, 88, 235, 37, 136
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    91, 238, 27, 151, 139, 105, 39, 117, 34, 55, 29, 91, 134, 129, 203, 209
    };
    ...
    uint8_t golden[] = {
    94, 15, 91, 36, 205, 90, 177, 76, 245, 188, 237, 232, 210, 106, 90, 183
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
