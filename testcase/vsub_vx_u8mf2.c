...
int main(){
    const uint8_t data1[] = {
    113, 234, 243, 84, 65, 111, 16, 135, 156, 252, 34, 44, 36, 50, 141, 43
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    98, 110, 112, 133, 111, 237, 44, 84, 252, 24, 10, 127, 241, 123, 75, 214
    };
    ...
    uint8_t golden[] = {
    15, 124, 131, 207, 210, 130, 228, 51, 160, 228, 24, 173, 51, 183, 66, 85
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
