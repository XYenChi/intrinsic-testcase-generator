...
int main(){
    const uint8_t data1[] = {
    133, 149, 216, 70, 202, 196, 136, 171, 96, 41, 61, 9, 179, 7, 130, 28
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    77, 100, 208, 218, 165, 199, 248, 32, 89, 82, 104, 111, 243, 130, 143, 87
    };
    ...
    uint8_t golden[] = {
    133, 0, 0, 70, 0, 1, 0, 1, 1, 41, 213, 154, 0, 7, 243, 197
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
