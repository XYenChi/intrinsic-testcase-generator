...
int main(){
    const int8_t data1[] = {
    -51, 16, 105, 110, 113, 54, -15, 90, 111, -61, -59, 126, 95, -20, 31, 56
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    8, -127, -16, -29, 41, 66, -80, -32, 90, -56, 2, -128, -30, 16, 126, 24
    };
    ...
    int8_t golden[] = {
    104, 16, 112, 138, 25, 236, 176, 192, 6, 88, 138, 0, 222, 192, 66, 64
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
