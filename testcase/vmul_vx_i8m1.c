...
int main(){
    const int8_t data1[] = {
    -47, 31, -87, 2, 107, -32, 38, -93, 62, -4, 84, -9, -55, -91, -117, 110
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    123, 53, -49, 59, -68, -27, -104, -52, -12, -56, 71, -39, 38, -60, 108, -82
    };
    ...
    int8_t golden[] = {
    107, 107, 167, 118, 148, 96, 144, 228, 24, 224, 76, 95, 214, 84, 164, 196
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
