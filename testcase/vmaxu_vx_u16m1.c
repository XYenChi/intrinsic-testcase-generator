...
int main(){
    ...
    70, 126, 194, 214, 189, 100, 66, 20, 27, 89, 255, 8, 168, 113, 151, 8
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    129, 64, 194, 84, 123, 89, 151, 80, 216, 74, 171, 128, 44, 18, 223, 236
    };
    ...
    uint16_t golden[] = {
    129, 126, 194, 214, 189, 100, 151, 80, 216, 89, 255, 128, 168, 113, 223, 236
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
