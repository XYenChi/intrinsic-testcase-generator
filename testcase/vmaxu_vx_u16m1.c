...
int main(){
    ...
    243, 14, 90, 251, 167, 99, 6, 158, 244, 128, 14, 155, 172, 29, 87, 221
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    147, 113, 109, 0, 8, 218, 255, 200, 6, 238, 253, 224, 83, 243, 83, 108
    };
    ...
    uint16_t golden[] = {
    243, 113, 109, 251, 167, 218, 255, 200, 244, 238, 253, 224, 172, 243, 87, 221
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
