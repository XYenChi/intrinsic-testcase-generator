...
int main(){
    ...
    79, 118, 113, 180, 145, 21, 245, 98, 210, 247, 123, 79, 58, 62, 196, 198
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    148, 84, 239, 124, 255, 56, 223, 196, 90, 102, 194, 240, 147, 101, 222, 196
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u64m1 (data1_v, data2_v, vl);
