...
int main(){
    ...
    249, 31, 107, 80, 96, 211, 207, 234, 110, 74, 126, 171, 92, 206, 146, 45
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    73, 178, 155, 216, 240, 106, 205, 78, 231, 115, 113, 224, 66, 6, 77, 24
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u16m8_m (mask, data1_v, data2_v, vl);
