...
int main(){
    ...
    128, 125, 78, 114, 16, 237, 191, 180, 25, 88, 120, 190, 113, 76, 202, 204
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    74, 11, 218, 89, 44, 47, 202, 85, 148, 243, 88, 213, 246, 105, 169, 55
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u64m8 (data1_v, data2_v, vl);
