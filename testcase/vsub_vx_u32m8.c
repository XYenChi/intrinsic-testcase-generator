...
int main(){
    ...
    166, 78, 103, 150, 96, 151, 59, 76, 250, 242, 18, 80, 113, 113, 71, 9
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    112, 222, 242, 235, 112, 106, 71, 84, 243, 42, 153, 209, 189, 64, 238, 125
    };
    ...
    uint32_t golden[] = {
    54, 4294967152, 4294967157, 4294967211, 4294967280, 45, 4294967284, 4294967288, 7, 200, 4294967161, 4294967167, 4294967220, 49, 4294967129, 4294967180
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
