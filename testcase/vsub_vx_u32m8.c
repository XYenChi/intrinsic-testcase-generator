...
int main(){
    ...
    67, 89, 49, 222, 254, 6, 177, 15, 251, 67, 222, 214, 13, 214, 110, 181
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    129, 178, 173, 237, 111, 113, 239, 69, 42, 82, 213, 51, 29, 196, 108, 236
    };
    ...
    uint32_t golden[] = {
    4294967234, 4294967207, 4294967172, 4294967281, 143, 4294967189, 4294967234, 4294967242, 209, 4294967281, 9, 163, 4294967280, 18, 2, 4294967241
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
