...
int main(){
    ...
    79, 89, 103, 252, 132, 164, 34, 27, 138, 243, 249, 230, 148, 98, 98, 152
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    251, 226, 123, 93, 181, 101, 119, 96, 135, 0, 114, 213, 163, 162, 22, 64
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_16m8_b2 (mask, data1_v, data2_v, vl);
