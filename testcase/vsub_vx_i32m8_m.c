...
int main(){
    const int32_t data1[] = {
    79, 20, -86, 68, 55, -120, 83, 68, -52, 31, 64, 42, -124, 92, 101, 14
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    113, 97, -62, -128, -78, -64, 1, 81, -33, 66, -71, -5, -6, -54, -94, -43
    };
    ...
    int32_t golden[] = {
    1, 4294967219, 4294967272, 196, 133, 0, 82, 1, 4294967277, 4294967261, 1, 0, 0, 146, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
