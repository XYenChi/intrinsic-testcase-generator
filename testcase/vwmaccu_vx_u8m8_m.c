...
int main(){
    const uint8_t data1[] = {
    167, 225, 33, 235, 127, 59, 147, 51, 34, 19, 37, 161, 227, 111, 66, 229
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    54, 224, 143, 36, 37, 58, 253, 49, 225, 21, 141, 208, 210, 208, 141, 121
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vx_u8m8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    59, 0, 111, 12, 91, 0, 0, 195, 227, 1, 0, 1, 1, 0, 0, 62
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
