...
int main(){
    const int16_t data1[] = {
    89, 78, 95, 56, 87, -3, 56, -1, 30, -14, 3, 14, 77, 3, 104, 83
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    81, -35, -50, 114, -5, -66, 40, -3, 125, -105, 100, -104, -64, 98, 23, -43
    };
    ...
    int16_t golden[] = {
    170, 43, 45, 170, 82, 65467, 96, 65532, 155, 65417, 103, 65446, 13, 101, 127, 40
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
