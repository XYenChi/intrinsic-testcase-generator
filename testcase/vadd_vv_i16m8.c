...
int main(){
    const int16_t data1[] = {
    -3, 21, 55, -127, -57, -54, -21, 33, 7, 65, 81, -34, -14, -51, 2, -18
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    5, 48, 100, 95, -29, 2, 95, -61, 103, -118, -93, -8, -107, 127, -72, 119
    };
    ...
    int16_t golden[] = {
    2, 69, 155, 65504, 65450, 65484, 74, 65508, 110, 65483, 65524, 65494, 65415, 76, 65466, 101
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
