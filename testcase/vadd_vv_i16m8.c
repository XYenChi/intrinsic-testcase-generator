...
int main(){
    const int16_t data1[] = {
    -126, 41, -68, 106, 50, 114, 127, 10, -25, -6, -11, -44, -71, 74, -126, 94
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -49, 115, 34, -122, 34, -11, 110, -38, 53, -96, -33, -15, 6, 15, -53, -64
    };
    ...
    int16_t golden[] = {
    65361, 156, 65502, 65520, 84, 103, 237, 65508, 28, 65434, 65492, 65477, 65471, 89, 65357, 30
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
