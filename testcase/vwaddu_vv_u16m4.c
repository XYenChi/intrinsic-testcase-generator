...
int main(){
    ...
    121, 185, 120, 143, 25, 25, 225, 171, 132, 208, 20, 217, 122, 96, 86, 210
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    95, 131, 72, 72, 254, 129, 218, 160, 83, 25, 170, 207, 12, 48, 138, 75
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u16m4 (data1_v, data2_v, vl);
