...
int main(){
    const int8_t data1[] = {
    -58, -120, -49, -72, 127, -108, -69, 7, 30, 9, 53, -20, 23, -97, -85, -72
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -77, -8, 27, -2, -16, 92, -109, 62, 75, -66, -82, 53, -50, 55, 84, -15
    };
    ...
    int8_t golden[] = {
    237, 112, 76, 70, 113, 200, 216, 55, 45, 181, 121, 73, 183, 152, 169, 57
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
