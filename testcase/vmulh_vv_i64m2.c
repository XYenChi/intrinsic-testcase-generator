...
int main(){
    const int64_t data1[] = {
    -17, 22, -64, -111, -26, 22, 94, 35, 59, 45, -123, 25, 84, -108, 19, -90
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    53, -73, -106, 99, 58, -33, -9, -106, 117, -126, -114, 83, 45, 27, 25, 125
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vv_64m2_b32 (data1_v, data2_v, vl);
