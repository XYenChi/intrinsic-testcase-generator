...
int main(){
    const int32_t data1[] = {
    123, 119, 113, 93, -28, 20, 92, -25, -43, 112, 99, 49, -49, -49, -21, -96
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    89, 56, 56, 5, -17, 74, 127, 88, -106, -61, 104, 74, 100, -114, 33, 30
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_32m1_b32 (data1_v, data2_v, vl);
