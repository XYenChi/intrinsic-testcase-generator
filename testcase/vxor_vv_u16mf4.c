...
int main(){
    ...
    152, 83, 167, 104, 102, 110, 217, 247, 228, 246, 126, 211, 181, 96, 172, 105
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    232, 219, 40, 67, 236, 134, 229, 11, 18, 251, 180, 195, 46, 103, 119, 136
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u16mf4 (data1_v, data2_v, vl);
