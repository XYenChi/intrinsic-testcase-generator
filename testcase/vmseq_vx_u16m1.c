...
int main(){
    ...
    92, 70, 222, 236, 4, 161, 62, 164, 156, 162, 138, 215, 151, 128, 0, 92
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    154, 8, 35, 222, 183, 70, 59, 43, 137, 62, 187, 217, 1, 81, 41, 138
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_16m1_b16 (data1_v, data2_v, vl);
