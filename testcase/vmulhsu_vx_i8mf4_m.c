...
int main(){
    const int8_t data1[] = {
    -52, 30, 113, 32, 10, -13, 34, 90, 21, -10, -124, -121, 4, -48, -31, 66
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    182, 150, 100, 101, 123, 160, 129, 71, 249, 15, 159, 75, 34, 116, 219, 102
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_8mf4_b32 (mask, data1_v, data2_v, vl);
