...
int main(){
    const uint8_t data1[] = {
    201, 236, 153, 24, 166, 34, 4, 22, 171, 96, 21, 97, 247, 31, 193, 247
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    187, 14, 229, 76, 142, 244, 19, 98, 161, 6, 12, 60, 99, 231, 140, 161
    };
    ...
    uint8_t golden[] = {
    0, 1, 229, 1, 166, 1, 1, 0, 171, 96, 0, 97, 247, 231, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
