...
int main(){
    const int32_t data1[] = {
    -52, -119, -44, 23, 18, 27, 102, -116, -11, 58, -60, -3, -59, 83, 120, 89
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    42, -105, -53, -96, 73, -96, 101, -122, 0, -18, -87, -29, -15, 83, -41, 47
    };
    ...
    int32_t golden[] = {
    -10, -224, -97, -72, 91, -69, 203, -238, -11, 41, -147, -31, -74, 166, 79, 137
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
