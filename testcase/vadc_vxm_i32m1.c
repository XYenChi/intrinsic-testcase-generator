...
int main(){
    const int32_t data1[] = {
    -20, -73, -83, 65, -22, 116, 107, 0, 88, 19, 43, 45, 15, 88, 33, 91
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -116, 97, -89, 70, 43, -38, -81, 105, -110, 62, -41, -7, -55, 107, 124, -126
    };
    ...
    int32_t golden[] = {
    -136, 25, -171, 136, 22, 79, 26, 105, -21, 81, 2, 39, -40, 196, 158, -35
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
