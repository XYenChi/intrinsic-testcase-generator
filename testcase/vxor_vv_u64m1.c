...
int main(){
    ...
    18, 9, 118, 67, 44, 109, 120, 154, 59, 52, 103, 73, 235, 10, 169, 56
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    242, 249, 125, 244, 122, 153, 54, 215, 43, 149, 186, 124, 108, 241, 58, 158
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u64m1 (data1_v, data2_v, vl);
