...
int main(){
    const int64_t data1[] = {
    25, -16, -50, -31, 124, 124, -39, -97, -62, 74, 66, -4, 118, 81, 16, 89
    };
    const int64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    99, 18, 60, 35, 56, 120, 114, 33, 2, 89, 57, 239, 178, 87, 100, 14
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_64m4_b16 (mask, data1_v, data2_v, vl);
