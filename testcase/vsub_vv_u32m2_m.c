...
int main(){
    ...
    136, 76, 16, 125, 177, 10, 61, 192, 18, 158, 242, 154, 14, 197, 254, 97
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    160, 78, 208, 186, 226, 125, 154, 28, 186, 243, 234, 77, 103, 194, 162, 178
    };
    ...
    uint32_t golden[] = {
    4294967272, 0, 1, 4294967235, 1, 4294967181, 4294967203, 164, 4294967128, 4294967211, 1, 77, 4294967207, 0, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
