...
int main(){
    const int64_t data1[] = {
    92, -66, 94, -75, 91, -115, -125, -85, -97, 4, 25, 27, -120, 1, -114, -62
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    92, -54, -86, -41, 14, -42, -88, -28, -9, 35, -71, 106, 53, 56, 78, -14
    };
    ...
    int64_t golden[] = {
    0, 18446744073709551562, 94, 18446744073709551575, 91, 18446744073709551574, 18446744073709551528, 0, 0, 1, 25, 106, 0, 56, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
