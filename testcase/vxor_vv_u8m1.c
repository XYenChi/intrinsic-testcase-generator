...
int main(){
    const uint8_t data1[] = {
    217, 37, 39, 241, 208, 224, 28, 157, 180, 116, 153, 206, 251, 223, 166, 55
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    245, 30, 4, 33, 55, 124, 107, 92, 58, 218, 167, 63, 198, 50, 178, 98
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u8m1 (data1_v, data2_v, vl);
