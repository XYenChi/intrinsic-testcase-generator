...
int main(){
    ...
    40, 140, 185, 152, 150, 191, 37, 65, 125, 240, 210, 61, 32, 34, 55, 230
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    86, 41, 41, 126, 113, 13, 19, 184, 115, 65, 10, 55, 103, 34, 127, 7
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u64m8 (data1_v, data2_v, vl);
