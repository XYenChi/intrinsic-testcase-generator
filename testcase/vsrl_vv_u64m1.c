...
int main(){
    ...
    171, 114, 21, 98, 210, 118, 241, 139, 71, 210, 93, 53, 37, 165, 29, 211
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    33, 228, 236, 115, 33, 162, 144, 118, 54, 187, 235, 214, 54, 149, 217, 119
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u64m1 (data1_v, shift, vl);
