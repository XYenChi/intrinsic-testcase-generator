...
int main(){
    const int64_t data1[] = {
    63, -56, -92, -128, -84, -75, 38, 54, 111, -36, 45, 73, 72, 102, -59, -16
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    16, 51, 33, -3, -112, -107, 16, -127, -99, 40, -84, -98, 27, 53, 50, 19
    };
    ...
    int64_t golden[] = {
    63, 51, 33, 18446744073709551613, 18446744073709551532, 18446744073709551541, 38, 54, 111, 40, 45, 73, 72, 102, 50, 19
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
