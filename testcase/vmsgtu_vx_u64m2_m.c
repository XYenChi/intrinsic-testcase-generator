...
int main(){
    ...
    193, 236, 229, 104, 78, 44, 115, 219, 147, 73, 196, 78, 172, 96, 29, 218
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    74, 7, 53, 245, 164, 39, 74, 156, 152, 103, 209, 132, 227, 191, 231, 120
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_64m2_b32_m (mask, data1_v, data2_v, vl);
