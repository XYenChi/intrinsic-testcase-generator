...
int main(){
    const int32_t data1[] = {
    40, 96, -89, 79, 58, 1, 82, -44, -8, -29, 62, -89, -89, -15, -86, 86
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -100, 102, 26, -90, -76, -29, -6, -116, 26, -83, 68, -2, 29, 89, -76, -99
    };
    const int32_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e32m1(avl);
    const int out_data[] = {
    1, 0, 0, 1, 1, 0, 0, 0, 1, 0, 1, 0, 1, 1, 1, 0
    };
    ...
    int32_t golden[] = {
    1, 1, 0, 4294967294, 4294967294, 0, 4294967295, 0, 1, 0, 1, 0, 1, 1, 0, 4294967294
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
