...
int main(){
    const int32_t data1[] = {
    -128, -124, -22, -74, 52, -81, 89, 85, -59, -58, 9, 59, 106, 120, 76, 109
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -105, -35, 115, -91, -40, -25, -44, -118, -123, 104, -117, 26, 24, -80, -94, -4
    };
    ...
    int32_t golden[] = {
    1, 1, 4294967290, 1, 1, 0, 1, 0, 1, 0, 1, 0, 0, 4294967295, 0, 4294967295
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
