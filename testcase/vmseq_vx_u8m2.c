...
int main(){
    const uint8_t data1[] = {
    219, 218, 204, 149, 36, 129, 216, 86, 2, 177, 19, 91, 132, 245, 187, 80
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    196, 2, 37, 246, 164, 36, 58, 180, 89, 135, 153, 80, 53, 33, 58, 164
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_8m2_b4 (data1_v, data2_v, vl);
