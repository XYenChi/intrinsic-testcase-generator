...
int main(){
    const uint8_t data1[] = {
    143, 51, 129, 255, 73, 11, 253, 212, 178, 252, 197, 171, 142, 165, 86, 61
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    147, 79, 134, 162, 210, 72, 129, 161, 84, 165, 157, 128, 80, 30, 15, 105
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u8m1_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 28, 0, 0, 1, 6, 129, 1, 84, 165, 1, 128, 1, 1, 15, 44
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
