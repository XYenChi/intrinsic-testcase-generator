...
int main(){
    ...
    1, 71, 27, 112, 36, 119, 178, 95, 3, 150, 117, 23, 198, 98, 237, 97
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    121, 36, 63, 5, 29, 241, 219, 176, 61, 54, 10, 197, 103, 159, 234, 128
    };
    ...
    uint16_t golden[] = {
    1, 107, 90, 117, 0, 1, 1, 1, 0, 1, 127, 220, 301, 257, 471, 225
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
