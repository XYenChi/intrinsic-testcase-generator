...
int main(){
    ...
    7, 13, 82, 41, 246, 38, 21, 222, 86, 130, 232, 163, 126, 128, 218, 211
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    235, 97, 118, 118, 17, 48, 22, 91, 54, 55, 207, 89, 143, 11, 74, 207
    };
    ...
    uint16_t golden[] = {
    1, 0, 1, 159, 1, 1, 43, 0, 1, 0, 439, 252, 269, 0, 292, 418
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
