...
int main(){
    const int16_t data1[] = {
    -81, 73, -34, -26, -71, -83, -25, -108, 2, -34, 107, 78, -46, 81, -102, -67
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -18, -31, -93, -59, -87, 55, 34, 68, 106, 34, -69, -86, 0, -128, 14, -118
    };
    ...
    int16_t golden[] = {
    64079, 2264, 62374, 64002, 59360, 4565, 851, 7344, 65325, 1156, 7384, 6709, 0, 10369, 1428, 57631
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
