...
int main(){
    ...
    82, 34, 204, 110, 54, 31, 157, 34, 21, 193, 237, 193, 127, 20, 48, 66
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    194, 253, 168, 104, 135, 22, 184, 95, 149, 12, 170, 209, 247, 220, 206, 77
    };
    ...
    uint16_t golden[] = {
    112, 219, 1, 65530, 81, 1, 0, 0, 128, 0, 1, 16, 120, 1, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
