...
int main(){
    const int16_t data1[] = {
    -61, -98, 10, 25, -127, 46, -123, -83, -17, -126, -17, -83, -52, -8, -116, -101
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -23, 36, 21, -105, -90, 95, -24, 110, -120, -31, 57, -91, 72, -37, -60, 116
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_16m1_b16 (data1_v, data2_v, vl);
