...
int main(){
    const int8_t data1[] = {
    55, -32, -70, -82, -81, -19, -20, -57, 11, -65, -32, 42, -28, 56, 56, -117
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    127, -105, 64, -30, -44, -55, 64, -104, 78, 37, 52, -47, 60, -98, 88, 57
    };
    ...
    int8_t golden[] = {
    127, 151, 64, 226, 212, 201, 64, 152, 78, 37, 52, 209, 60, 158, 88, 57
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
