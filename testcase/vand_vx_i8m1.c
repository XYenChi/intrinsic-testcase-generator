...
int main(){
    const int8_t data1[] = {
    -90, -97, -112, -17, -66, -123, 32, -50, 99, -40, -122, -6, 51, -11, 16, 67
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    19, -102, 28, -87, -15, 122, -85, -72, 83, 73, 36, 104, 96, 120, -20, -49
    };
    ...
    int8_t golden[] = {
    19, 154, 28, 169, 241, 122, 171, 184, 83, 73, 36, 104, 96, 120, 236, 207
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
