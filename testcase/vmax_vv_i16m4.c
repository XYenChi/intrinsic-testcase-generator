...
int main(){
    const int16_t data1[] = {
    -60, 5, 120, 64, 4, 20, 124, -121, -91, 19, 97, 56, -33, -119, -68, -43
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    126, -15, -8, 15, -75, -119, -121, 70, -5, 95, -52, 97, -29, -110, 60, -33
    };
    ...
    int16_t golden[] = {
    126, 5, 120, 64, 4, 20, 124, 70, 65531, 95, 97, 97, 65507, 65426, 60, 65503
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
