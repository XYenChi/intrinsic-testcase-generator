...
int main(){
    const int16_t data1[] = {
    70, 0, 39, -46, 91, 50, 123, 85, 8, 39, -128, -35, -97, -34, 91, 66
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -24, -83, -15, 46, 122, -24, 36, -122, -16, -53, 99, -116, -89, -12, 82, 3
    };
    ...
    int16_t golden[] = {
    70, 0, 39, 46, 122, 50, 123, 85, 8, 39, 99, 65501, 65447, 65524, 91, 66
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
