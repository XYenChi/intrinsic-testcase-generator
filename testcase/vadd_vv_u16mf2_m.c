...
int main(){
    ...
    17, 1, 107, 198, 143, 12, 225, 11, 171, 15, 147, 121, 227, 61, 64, 56
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    174, 20, 230, 47, 228, 147, 63, 40, 98, 173, 90, 231, 205, 87, 161, 130
    };
    ...
    uint16_t golden[] = {
    191, 21, 0, 0, 371, 1, 0, 51, 0, 1, 237, 1, 432, 0, 1, 186
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
