...
int main(){
    const uint8_t data1[] = {
    54, 84, 191, 187, 232, 141, 71, 88, 123, 29, 230, 124, 126, 241, 186, 116
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    98, 63, 84, 125, 72, 57, 201, 143, 122, 75, 111, 93, 71, 216, 148, 230
    };
    ...
    uint8_t golden[] = {
    172, 1, 0, 0, 0, 101, 191, 40, 1, 1, 186, 0, 0, 88, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
