...
int main(){
    const uint8_t data1[] = {
    138, 190, 109, 253, 98, 2, 216, 87, 58, 99, 156, 238, 33, 204, 209, 250
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    244, 25, 58, 108, 135, 83, 14, 203, 8, 19, 177, 46, 153, 125, 95, 240
    };
    ...
    uint8_t golden[] = {
    0, 0, 0, 188, 174, 166, 0, 253, 0, 0, 1, 0, 1, 156, 143, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
