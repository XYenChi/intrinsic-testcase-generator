...
int main(){
    const int64_t data1[] = {
    109, 75, -122, 29, 118, -59, 69, 115, 33, 101, 26, 117, -31, -95, 2, -82
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    4, 33, -46, 1, -103, 91, -12, 32, 127, -17, 102, 43, 101, 20, 111, -53
    };
    ...
    int64_t golden[] = {
    109, 75, 0, 29, 118, 91, 0, 115, 0, 0, 102, 1, 101, 1, 1, 18446744073709551563
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
