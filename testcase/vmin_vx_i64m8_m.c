...
int main(){
    const int64_t data1[] = {
    116, -128, 17, -55, -101, -32, 63, 64, -30, 119, 42, -80, -34, 2, 23, 43
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -46, 117, -63, 16, 108, -90, -119, -65, 19, -115, -57, -43, -107, -62, -119, 2
    };
    ...
    int64_t golden[] = {
    116, 1, 17, 1, 1, 18446744073709551584, 0, 1, 1, 119, 1, 18446744073709551573, 0, 2, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
