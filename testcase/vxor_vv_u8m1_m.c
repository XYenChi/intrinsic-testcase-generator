...
int main(){
    const uint8_t data1[] = {
    112, 19, 182, 32, 43, 153, 244, 178, 134, 188, 252, 38, 196, 78, 144, 105
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    184, 117, 253, 52, 43, 11, 182, 35, 36, 191, 237, 202, 79, 191, 90, 69
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u8m1_m (mask, data1_v, data2_v, vl);
