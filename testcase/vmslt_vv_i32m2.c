...
int main(){
    const int32_t data1[] = {
    -122, -35, 100, -20, -40, -89, 80, 53, 89, 21, -99, 69, -61, -27, -60, 73
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -86, 124, 26, 113, -96, -22, 37, 32, -89, 82, -70, 6, 66, -104, 118, 118
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vv_32m2_b16 (data1_v, data2_v, vl);
