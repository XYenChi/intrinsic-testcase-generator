...
int main(){
    ...
    215, 165, 62, 248, 0, 73, 78, 184, 53, 11, 76, 3, 114, 133, 162, 254
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    59, 210, 218, 172, 198, 196, 219, 64, 27, 26, 214, 250, 180, 85, 124, 101
    };
    ...
    uint16_t golden[] = {
    0, 210, 0, 0, 0, 1, 219, 64, 27, 26, 1, 250, 0, 0, 124, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
