...
int main(){
    const int32_t data1[] = {
    -122, 54, 22, -112, 121, 27, -59, -9, -102, 45, -48, -12, -1, -7, -4, 35
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -98, 0, 3, 110, 121, 88, 92, 35, 28, -62, -64, -69, 4, 42, -18, -88
    };
    ...
    int32_t golden[] = {
    4294967174, 54, 22, 4294967294, 121, 88, 92, 35, 4294967194, 45, 4294967232, 4294967215, 4294967295, 4294967289, 4294967292, 4294967243
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
