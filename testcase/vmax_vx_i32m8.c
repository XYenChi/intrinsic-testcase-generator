...
int main(){
    const int32_t data1[] = {
    108, -94, -87, 84, 83, -87, -66, 106, 5, -56, 62, 72, 104, 52, -19, -99
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    3, 18, -81, -46, 5, 123, 49, -96, -25, 98, 72, 61, 44, -18, 82, 112
    };
    ...
    int32_t golden[] = {
    108, 18, 4294967215, 84, 83, 123, 49, 106, 5, 98, 72, 72, 104, 52, 82, 112
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
