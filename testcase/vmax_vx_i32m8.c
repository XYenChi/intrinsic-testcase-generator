...
int main(){
    const int32_t data1[] = {
    -51, 3, 62, -70, -114, 75, -51, -15, -53, 89, -54, -38, 42, 48, -84, -55
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    73, -8, -77, -112, -2, 45, 70, -87, 113, 119, -110, 16, 14, 1, 43, -30
    };
    ...
    int32_t golden[] = {
    73, 3, 62, 4294967226, 4294967294, 75, 70, 4294967281, 113, 119, 4294967242, 16, 42, 48, 43, 4294967266
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
