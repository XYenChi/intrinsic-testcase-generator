...
int main(){
    ...
    79, 4, 238, 175, 57, 29, 154, 64, 174, 200, 90, 32, 115, 101, 17, 75
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    225, 92, 218, 209, 103, 248, 167, 114, 96, 199, 60, 53, 194, 37, 102, 168
    };
    ...
    uint16_t golden[] = {
    0, 92, 0, 209, 0, 0, 0, 114, 174, 200, 90, 53, 194, 101, 0, 168
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
