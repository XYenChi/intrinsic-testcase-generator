...
int main(){
    const int32_t data1[] = {
    26, 15, 85, 21, 51, 20, 36, 93, 7, -55, -48, -53, -37, -55, -103, -107
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -32, -69, -20, 87, 12, 114, 12, -62, -59, -89, -89, 3, -105, 37, -24, 33
    };
    ...
    int32_t golden[] = {
    4294966464, 4294966262, 4294965596, 1828, 613, 2281, 432, 4294961530, 4294966884, 4895, 4272, 4294967137, 3886, 4294965261, 2472, 4294963766
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
