...
int main(){
    const int32_t data1[] = {
    -104, -50, 69, -50, 109, 57, -86, -14, -22, -57, 118, -18, 100, 113, -64, 4
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -63, -62, -37, 84, -46, 78, -81, -123, -95, -57, -102, 28, -9, -27, 34, 120
    };
    ...
    int32_t golden[] = {
    6553, 3101, 4294964743, 4294963096, 4294962283, 4446, 6966, 1722, 2091, 3250, 4294955260, 4294966792, 4294966397, 4294964245, 4294965121, 480
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
