...
int main(){
    ...
    16, 169, 72, 85, 123, 181, 145, 26, 179, 162, 119, 149, 129, 188, 0, 219
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    57, 42, 102, 37, 75, 36, 53, 212, 3, 55, 152, 22, 53, 149, 249, 7
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u16mf2_m (mask, data1_v, data2_v, vl);
