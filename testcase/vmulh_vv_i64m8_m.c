...
int main(){
    const int64_t data1[] = {
    -122, 32, -79, -33, -97, 108, 86, 28, -87, -86, 16, -69, -11, 106, -24, 105
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -54, 82, 73, 58, -91, -115, 15, 124, -60, 57, -11, 76, 43, -23, -85, -70
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vv_64m8_b8 (mask, data1_v, data2_v, vl);
