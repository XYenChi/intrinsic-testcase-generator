...
int main(){
    ...
    175, 115, 10, 77, 134, 190, 46, 190, 150, 7, 17, 102, 164, 66, 15, 238
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    227, 45, 121, 106, 32, 172, 128, 56, 115, 161, 129, 164, 174, 24, 76, 98
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u16m1_m (mask, data1_v, data2_v, vl);
