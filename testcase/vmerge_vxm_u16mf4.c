...
int main(){
    ...
    24, 151, 100, 118, 56, 109, 121, 185, 107, 17, 186, 247, 164, 103, 94, 78
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    111, 246, 205, 96, 245, 165, 108, 199, 119, 219, 227, 1, 208, 204, 136, 224
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmerge_vxm_u16mf4 (data1_v, data2_v, masked size_t vl);
    ...
    uint16_t golden[] = {
    111, 246, 100, 96, 245, 109, 108, 199, 107, 219, 227, 1, 208, 103, 94, 224
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
