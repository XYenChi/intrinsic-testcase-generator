...
int main(){
    ...
    137, 131, 225, 226, 144, 166, 206, 253, 148, 113, 78, 209, 146, 149, 252, 119
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnot_v_u16m2 (data1_v, vl);
    ...
    uint16_t golden[] = {
    -138, -132, -226, -227, -145, -167, -207, -254, -149, -114, -79, -210, -147, -150, -253, -120
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
