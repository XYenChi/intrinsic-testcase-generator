...
int main(){
    const int8_t data1[] = {
    -12, -75, 105, 103, 111, -67, -10, 63, -4, -114, 3, 107, -99, 123, -84, -39
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -31, 32, 57, -55, -3, 29, -26, 75, -49, -46, 53, -124, -10, -127, -87, -124
    };
    ...
    int8_t golden[] = {
    225, 213, 162, 201, 253, 29, 220, 138, 203, 96, 53, 239, 147, 252, 85, 93
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
