...
int main(){
    const int16_t data1[] = {
    100, 41, -21, 5, 68, 121, 51, 100, -104, -45, 79, 96, -30, 62, 51, -35
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    89, 24, -53, 68, 6, 0, -52, -21, -62, -9, -118, -94, 15, 42, 17, 111
    };
    ...
    int16_t golden[] = {
    89, 24, 65483, 68, 6, 0, 65484, 65515, 65474, 65527, 65418, 65442, 15, 42, 17, 111
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
