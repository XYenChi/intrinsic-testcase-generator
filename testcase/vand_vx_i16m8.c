...
int main(){
    const int16_t data1[] = {
    123, 10, -96, 40, -112, 63, 5, 36, -13, -69, -120, 87, 57, 73, -44, 40
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    91, -120, 55, -82, 126, -95, -68, 70, -3, 119, 94, -27, 89, 87, 3, -45
    };
    ...
    int16_t golden[] = {
    91, 65416, 55, 65454, 126, 65441, 65468, 70, 65533, 119, 94, 65509, 89, 87, 3, 65491
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
