...
int main(){
    const uint8_t data1[] = {
    74, 11, 22, 210, 128, 241, 200, 0, 116, 195, 115, 5, 60, 182, 67, 171
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    208, 124, 186, 5, 63, 75, 121, 6, 236, 100, 6, 159, 155, 216, 211, 112
    };
    ...
    uint8_t golden[] = {
    0, 1, 1, 230, 129, 1, 0, 0, 17, 212, 1, 229, 172, 113, 199, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
