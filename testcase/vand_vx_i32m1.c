...
int main(){
    const int32_t data1[] = {
    -51, -119, -29, -114, 45, 79, -112, -97, 45, -55, 81, -55, 57, -74, 34, -97
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -9, -50, 69, 75, 76, 72, 110, 112, 8, 59, 47, 117, 108, 75, -54, 121
    };
    ...
    int32_t golden[] = {
    4294967287, 4294967246, 69, 75, 76, 72, 110, 112, 8, 59, 47, 117, 108, 75, 4294967242, 121
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
