...
int main(){
    const int64_t data1[] = {
    -73, 49, 87, -27, -78, 48, 51, -95, 96, 106, -87, -126, 103, -25, 125, -27
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    88, -42, -30, -94, 80, -54, 127, -18, 7, 16, -126, -44, -48, -17, 87, 40
    };
    ...
    int64_t golden[] = {
    -128, 91, 117, 67, -128, 102, -76, -77, 89, 90, 39, -82, 127, -8, 38, -67
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
