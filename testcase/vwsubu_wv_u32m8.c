...
int main(){
    ...
    249, 233, 72, 121, 40, 72, 189, 116, 34, 177, 83, 84, 53, 56, 191, 97
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    133, 68, 236, 120, 27, 111, 133, 47, 63, 77, 156, 218, 239, 174, 116, 221
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u32m8 (data1_v, data2_v, vl);
