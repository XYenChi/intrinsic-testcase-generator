...
int main(){
    ...
    198, 250, 32, 137, 55, 133, 76, 193, 42, 237, 185, 254, 37, 1, 87, 190
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    172, 54, 45, 97, 231, 170, 202, 58, 70, 254, 243, 79, 75, 148, 14, 89
    };
    ...
    uint32_t golden[] = {
    198, 250, 0, 1, 231, 170, 1, 193, 0, 0, 0, 1, 1, 0, 1, 190
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
