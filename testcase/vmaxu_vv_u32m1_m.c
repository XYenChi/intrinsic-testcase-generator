...
int main(){
    ...
    69, 215, 253, 90, 16, 149, 213, 244, 50, 111, 92, 64, 42, 16, 10, 90
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    209, 184, 82, 208, 107, 145, 162, 237, 81, 251, 255, 151, 129, 122, 0, 253
    };
    ...
    uint32_t golden[] = {
    209, 1, 0, 0, 0, 1, 213, 244, 1, 251, 255, 151, 1, 1, 1, 253
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
