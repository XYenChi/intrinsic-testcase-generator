...
int main(){
    const int16_t data1[] = {
    91, 109, 52, -95, 124, -2, 45, 25, 67, -62, 19, 92, 101, 96, 47, -56
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -58, 47, -12, -88, 88, 16, 68, 121, -105, -68, 1, 4, -109, 83, -28, -57
    };
    ...
    int16_t golden[] = {
    33, 47, 40, 65448, 88, 0, 23, 21, 29, 65530, 1, 4, 93, 83, 19, 65535
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
