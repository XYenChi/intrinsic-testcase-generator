...
int main(){
    ...
    1, 211, 211, 109, 28, 249, 118, 165, 19, 73, 193, 184, 36, 1, 225, 242
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    123, 210, 136, 0, 156, 82, 39, 152, 79, 202, 252, 78, 231, 118, 249, 73
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i16m2_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    123, 1, 1, 0, 1, 0, 0, 0, 4, 0, 0, 0, 0, 118, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
