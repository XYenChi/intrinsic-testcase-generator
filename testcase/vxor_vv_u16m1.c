...
int main(){
    ...
    116, 243, 170, 244, 82, 5, 211, 24, 105, 9, 24, 176, 96, 187, 208, 107
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    157, 199, 120, 243, 226, 121, 94, 228, 233, 177, 231, 219, 44, 191, 157, 248
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u16m1 (data1_v, data2_v, vl);
