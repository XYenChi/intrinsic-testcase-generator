...
int main(){
    const int32_t data1[] = {
    116, -40, -25, 49, -46, 27, 3, -22, 18, -37, 0, 43, 11, 71, -24, 9
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    54, 66, 119, -31, 29, -16, 22, 83, -65, -47, 31, 104, 56, 43, 95, -89
    };
    ...
    int32_t golden[] = {
    6265, 4294964656, 4294964322, 4294965778, 4294965963, 4294966864, 66, 4294965470, 4294966126, 1739, 1, 4473, 616, 3054, 4294965016, 4294966496
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
