...
int main(){
    const int32_t data1[] = {
    -126, 113, 1, -62, 48, -43, 81, -76, -33, -119, -20, -6, -117, 67, -42, -13
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    61, -86, -28, 6, 85, 8, -33, -73, -75, -76, -36, 56, -118, 87, 96, 96
    };
    ...
    int32_t golden[] = {
    4294959611, 4294957578, 4294967268, 4294966925, 4080, 4294966952, 4294964623, 5548, 2476, 9045, 720, 4294966961, 13807, 5830, 4294963264, 4294966049
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
