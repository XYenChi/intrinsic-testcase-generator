...
int main(){
    const int8_t data1[] = {
    48, -83, 62, 25, 118, -89, 59, 82, 67, 36, -51, -113, 35, 26, -81, -106
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    63, 118, -97, 12, 47, -16, -35, 33, 43, 44, -98, 126, 56, -21, 44, -96
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_8m2_b4_m (mask, data1_v, data2_v, vl);
