...
int main(){
    ...
    244, 232, 46, 107, 81, 220, 26, 77, 119, 66, 73, 41, 101, 245, 6, 117
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    62, 64, 183, 133, 189, 148, 253, 92, 212, 111, 90, 169, 163, 139, 8, 55
    };
    ...
    uint16_t golden[] = {
    244, 232, 183, 133, 189, 220, 253, 92, 212, 111, 90, 169, 163, 245, 8, 117
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
