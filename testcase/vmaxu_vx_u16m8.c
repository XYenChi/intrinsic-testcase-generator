...
int main(){
    ...
    200, 165, 167, 200, 234, 31, 90, 124, 180, 42, 180, 113, 2, 72, 250, 233
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    245, 13, 67, 82, 96, 39, 116, 176, 68, 17, 24, 192, 34, 42, 224, 73
    };
    ...
    uint16_t golden[] = {
    245, 165, 167, 200, 234, 39, 116, 176, 180, 42, 180, 192, 34, 72, 250, 233
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
