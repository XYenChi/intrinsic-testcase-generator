...
int main(){
    const int16_t data1[] = {
    -106, 39, 77, 36, -8, 30, 63, -84, 112, -97, 41, 67, 15, 68, -51, 65
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    127, 122, -24, 101, 37, -45, 123, -54, -97, -98, -119, 55, 85, 57, -46, 21
    };
    ...
    int16_t golden[] = {
    -106, 39, 77, 36, 37, 30, 63, -84, 112, -97, -119, 55, 15, 57, -51, 21
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
