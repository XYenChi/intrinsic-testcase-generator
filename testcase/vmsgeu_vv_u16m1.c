...
int main(){
    ...
    146, 171, 15, 255, 111, 108, 182, 214, 134, 197, 36, 243, 30, 15, 154, 219
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    40, 152, 136, 132, 72, 52, 0, 38, 32, 145, 62, 39, 75, 125, 135, 63
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_16m1_b16 (data1_v, data2_v, vl);
