...
int main(){
    const int32_t data1[] = {
    -68, 38, -116, 126, 107, 20, -99, 74, -83, -89, -26, -39, -23, -8, -114, 41
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -66, -103, 4, 121, 44, 47, 16, -87, 41, -55, -93, -17, -28, 99, 35, 118
    };
    ...
    int32_t golden[] = {
    0, 4294967293, 4294967295, 0, 0, 2, 4294967295, 4294967294, 4294967295, 0, 3, 0, 1, 4294967283, 4294967295, 2
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
