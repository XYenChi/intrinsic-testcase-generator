...
int main(){
    const int32_t data1[] = {
    42, 84, -33, 65, 49, -40, -9, -21, 17, -22, 75, 21, 115, 63, -90, 24
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -63, -53, 75, 123, 126, -104, 44, 20, -50, -51, -64, 46, 116, -109, 94, -118
    };
    ...
    int32_t golden[] = {
    4294967294, 4294967295, 4294967293, 1, 2, 2, 4294967291, 4294967295, 4294967293, 2, 4294967295, 2, 1, 4294967294, 4294967294, 4294967291
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
