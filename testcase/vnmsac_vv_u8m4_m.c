...
int main(){
    const uint8_t data1[] = {
    190, 141, 230, 21, 175, 119, 93, 170, 19, 215, 91, 231, 31, 82, 168, 125
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    227, 166, 62, 45, 234, 111, 78, 212, 38, 75, 183, 202, 107, 116, 239, 246
    };
    ...
    uint8_t golden[] = {
    134, 0, 0, 79, 1, 1, 1, 56, 47, 1, 0, 186, 0, 0, 40, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
