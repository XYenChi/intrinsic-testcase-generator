...
int main(){
    ...
    153, 62, 96, 33, 189, 169, 83, 153, 202, 175, 192, 33, 101, 123, 89, 69
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    248, 47, 65, 187, 142, 186, 216, 210, 123, 25, 219, 97, 78, 42, 146, 2
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_64m1_b64 (data1_v, data2_v, vl);
