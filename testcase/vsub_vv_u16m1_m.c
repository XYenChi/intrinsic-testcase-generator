...
int main(){
    ...
    141, 129, 38, 12, 126, 39, 57, 125, 102, 140, 58, 230, 120, 80, 34, 5
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    252, 29, 107, 149, 133, 201, 220, 13, 18, 84, 143, 211, 123, 70, 246, 33
    };
    ...
    uint16_t golden[] = {
    65425, 100, 65467, 65399, 1, 1, 0, 0, 84, 0, 65451, 0, 65533, 10, 65324, 65508
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
