...
int main(){
    ...
    61, 32, 185, 204, 55, 169, 241, 150, 39, 111, 84, 246, 250, 128, 131, 102
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    59, 173, 100, 12, 107, 239, 184, 168, 99, 110, 44, 217, 5, 150, 152, 39
    };
    ...
    uint16_t golden[] = {
    0, 0, 85, 192, 1, 1, 0, 65518, 65476, 1, 0, 29, 1, 65514, 0, 63
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
