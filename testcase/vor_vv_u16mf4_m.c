...
int main(){
    ...
    75, 123, 74, 126, 61, 77, 181, 86, 126, 227, 168, 186, 162, 52, 41, 135
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    218, 149, 71, 121, 14, 118, 127, 186, 62, 119, 187, 25, 228, 101, 124, 65
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wv_16mf4u_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    219, 255, 79, 127, 1, 127, 255, 0, 1, 247, 187, 1, 1, 117, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
