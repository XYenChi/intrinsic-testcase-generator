...
int main(){
    ...
    198, 31, 154, 253, 127, 75, 37, 0, 62, 162, 64, 218, 32, 197, 13, 95
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    206, 53, 108, 56, 202, 144, 154, 140, 220, 136, 87, 100, 94, 205, 43, 96
    };
    const uint64_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e64m2(avl);
    const uint out_data[] = {
    0, 0, 0, 0, 1, 0, 1, 0, 1, 1, 1, 0, 0, 1, 0, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u64m2_m (mask, data1_v, data2_v, vl);
