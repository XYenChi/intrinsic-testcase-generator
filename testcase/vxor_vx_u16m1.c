...
int main(){
    ...
    222, 213, 99, 21, 113, 249, 11, 70, 236, 126, 182, 17, 118, 177, 24, 162
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    134, 21, 27, 85, 159, 74, 246, 191, 210, 117, 4, 254, 211, 214, 238, 87
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u16m1 (data1_v, data2_v, vl);
