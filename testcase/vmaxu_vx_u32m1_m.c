...
int main(){
    ...
    163, 29, 33, 177, 209, 22, 223, 76, 138, 80, 114, 96, 85, 56, 175, 166
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    229, 210, 251, 215, 62, 92, 184, 3, 215, 70, 226, 28, 24, 69, 178, 228
    };
    ...
    uint32_t golden[] = {
    229, 1, 251, 215, 209, 1, 223, 76, 1, 80, 1, 1, 0, 69, 0, 228
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
