...
int main(){
    const int8_t data1[] = {
    -28, -31, -50, -26, 37, -95, -58, 107, -78, 62, 8, -120, -95, 74, -76, -92
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    15, 93, 15, 39, -88, 75, -45, 18, -85, 12, -107, -24, 112, 91, -8, 96
    };
    ...
    int8_t golden[] = {
    15, 93, 15, 39, 168, 75, 211, 18, 171, 12, 149, 232, 112, 91, 248, 96
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
