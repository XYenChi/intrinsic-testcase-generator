...
int main(){
    const int8_t data1[] = {
    -65, 101, -103, -38, -66, 43, -128, -64, 10, -31, 49, -125, 0, -57, -43, -125
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -72, 90, -94, -82, 8, 65, 43, -3, -36, 17, 120, 66, 117, -86, 15, -56
    };
    ...
    int8_t golden[] = {
    184, 90, 162, 174, 8, 65, 43, 253, 220, 17, 120, 66, 0, 170, 15, 200
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
