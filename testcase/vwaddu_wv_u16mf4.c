...
int main(){
    ...
    215, 98, 113, 158, 135, 108, 1, 199, 84, 190, 239, 81, 163, 8, 153, 145
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    33, 68, 27, 234, 229, 251, 72, 168, 46, 96, 49, 241, 177, 154, 230, 82
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u16mf4 (data1_v, data2_v, vl);
