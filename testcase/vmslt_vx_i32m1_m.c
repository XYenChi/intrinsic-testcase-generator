...
int main(){
    const int32_t data1[] = {
    49, 15, 40, 77, 125, 37, 5, 2, -79, 69, 113, -29, -55, 126, -126, -61
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    44, -57, 56, 21, 3, -103, 66, 124, 32, 52, -63, 11, -25, -12, -78, 92
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_32m1_b32_m (mask, data1_v, data2_v, vl);
