...
int main(){
    const int32_t data1[] = {
    -87, 19, 54, 7, 22, -69, 7, 65, 50, -73, -102, -79, -29, -44, 38, 96
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    96, 108, 17, 61, 89, 112, -54, 41, -6, 45, 65, 4, -21, 104, -28, -115
    };
    ...
    int32_t golden[] = {
    4294958945, 2052, 919, 427, 1958, 4294959569, 4294966918, 2666, 4294966996, 4294964012, 4294960667, 4294966980, 609, 4294962720, 4294966233, 4294956256
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
