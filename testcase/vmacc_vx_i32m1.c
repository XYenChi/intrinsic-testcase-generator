...
int main(){
    const int32_t data1[] = {
    18, 55, -61, -91, -117, -19, -104, 78, 108, -60, 11, -128, 114, 113, -119, 93
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    40, 110, -3, 89, -104, 1, -84, -48, 55, -79, 63, -113, -80, -2, -77, 103
    };
    ...
    int32_t golden[] = {
    720, 6050, 184, 4294959198, 12168, 4294967278, 8737, 4294963553, 5941, 4740, 694, 14465, 4294958177, 4294967071, 9164, 9580
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
