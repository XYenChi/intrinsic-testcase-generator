...
int main(){
    const uint8_t data1[] = {
    56, 134, 96, 64, 132, 234, 85, 122, 137, 250, 108, 13, 38, 68, 168, 119
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    9, 139, 230, 169, 12, 124, 116, 7, 19, 4, 186, 108, 99, 56, 35, 47
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_8m2 (data1_v, shift, vl);
