...
int main(){
    const uint8_t data1[] = {
    187, 161, 132, 175, 76, 202, 59, 84, 232, 76, 236, 3, 252, 177, 154, 151
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    2, 19, 216, 116, 246, 183, 167, 127, 134, 185, 172, 201, 142, 204, 82, 199
    };
    ...
    uint8_t golden[] = {
    187, 161, 216, 175, 246, 202, 167, 127, 232, 185, 236, 201, 252, 204, 154, 199
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
