...
int main(){
    const uint8_t data1[] = {
    87, 149, 204, 97, 177, 214, 124, 214, 237, 64, 203, 131, 143, 42, 229, 10
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    254, 201, 138, 7, 68, 206, 245, 113, 135, 126, 167, 230, 134, 69, 182, 13
    };
    ...
    uint8_t golden[] = {
    254, 201, 204, 97, 177, 214, 245, 214, 237, 126, 203, 230, 143, 69, 229, 13
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
