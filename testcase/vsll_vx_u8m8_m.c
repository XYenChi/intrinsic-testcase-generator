...
int main(){
    const uint8_t data1[] = {
    76, 211, 9, 28, 46, 230, 113, 165, 178, 83, 235, 25, 87, 9, 126, 216
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    252, 20, 69, 112, 154, 68, 100, 79, 8, 0, 13, 8, 218, 169, 213, 242
    };
    ...
    uint8_t golden[] = {
    76, 211, 18, 28, 46, 230, 113, 330, 178, 83, 470, 25, 87, 18, 252, 216
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
