...
int main(){
    const int32_t data1[] = {
    38, 22, 76, 37, 122, 172, 173, 169, 183, 82, 70, 58, 54, 100, 51, 8
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    95, 149, 226, 69, 32, 133, 89, 155, 183, 21, 194, 77, 247, 217, 159, 118
    };
    ...
    int32_t golden[] = {
    133, 171, 302, 106, 154, 305, 262, 324, 366, 103, 264, 135, 301, 317, 210, 126
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
