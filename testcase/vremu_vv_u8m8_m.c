...
int main(){
    const uint8_t data1[] = {
    215, 90, 52, 242, 131, 137, 249, 235, 128, 141, 248, 240, 102, 56, 110, 228
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    219, 22, 105, 12, 20, 218, 85, 19, 68, 251, 140, 17, 9, 255, 144, 116
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u8m8_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 0, 1, 12, 1, 81, 85, 1, 0, 110, 0, 17, 1, 31, 34, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
