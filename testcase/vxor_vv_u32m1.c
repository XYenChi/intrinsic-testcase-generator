...
int main(){
    ...
    208, 91, 152, 182, 123, 140, 67, 174, 205, 238, 126, 239, 20, 1, 10, 194
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    113, 213, 69, 38, 117, 182, 64, 181, 128, 229, 182, 246, 2, 45, 209, 152
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u32m1 (data1_v, data2_v, vl);
