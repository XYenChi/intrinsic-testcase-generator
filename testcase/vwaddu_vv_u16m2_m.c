...
int main(){
    ...
    63, 55, 227, 106, 14, 124, 234, 173, 40, 62, 3, 75, 211, 124, 186, 204
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    108, 81, 209, 71, 39, 47, 86, 151, 88, 3, 212, 66, 16, 124, 158, 200
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u16m2_m (mask, data1_v, data2_v, vl);
