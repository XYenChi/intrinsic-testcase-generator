...
int main(){
    ...
    74, 67, 210, 242, 149, 99, 235, 67, 151, 243, 28, 237, 186, 92, 17, 212
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    145, 151, 33, 150, 248, 252, 160, 72, 253, 8, 142, 84, 120, 70, 160, 16
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u64m2_m (mask, data1_v, data2_v, vl);
