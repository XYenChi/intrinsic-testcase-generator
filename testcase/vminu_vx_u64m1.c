...
int main(){
    ...
    174, 100, 115, 238, 2, 42, 54, 60, 127, 69, 72, 186, 210, 215, 164, 134
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    32, 95, 53, 9, 126, 130, 33, 136, 221, 215, 42, 249, 145, 95, 78, 147
    };
    ...
    uint64_t golden[] = {
    174, 100, 115, 238, 126, 130, 54, 136, 221, 215, 72, 249, 210, 215, 164, 147
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
