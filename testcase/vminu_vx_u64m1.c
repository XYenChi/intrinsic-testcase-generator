...
int main(){
    ...
    105, 162, 112, 248, 74, 219, 206, 74, 202, 236, 111, 26, 62, 129, 137, 198
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    118, 15, 241, 33, 180, 9, 43, 16, 94, 158, 20, 148, 47, 97, 47, 125
    };
    ...
    uint64_t golden[] = {
    118, 162, 241, 248, 180, 219, 206, 74, 202, 236, 111, 148, 62, 129, 137, 198
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
