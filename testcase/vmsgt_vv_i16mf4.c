...
int main(){
    const int16_t data1[] = {
    1, 17, 43, 48, -95, -98, -110, -85, -98, -86, 24, -120, -52, 113, 73, -107
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    47, -116, -14, 91, -3, 108, -77, 89, -125, -76, 80, -31, 28, 15, 82, -20
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vv_16mf4_b64 (data1_v, data2_v, vl);
