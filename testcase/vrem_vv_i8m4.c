...
int main(){
    const int8_t data1[] = {
    61, 224, 171, 144, 246, 192, 52, 193, 5, 102, 18, 218, 217, 250, 233, 166
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    178, 250, 92, 182, 77, 93, 135, 178, 75, 87, 224, 131, 90, 236, 66, 157
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vrem_vv_i8m4 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    56, 26, 92, 38, 77, 93, 31, 178, 0, 87, 8, 131, 90, 236, 66, 157
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
