...
int main(){
    const uint8_t data1[] = {
    191, 210, 99, 178, 8, 105, 106, 207, 231, 52, 18, 51, 108, 136, 20, 114
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    59, 124, 219, 87, 28, 99, 225, 70, 173, 121, 161, 58, 138, 86, 133, 60
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u8mf2_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    1, 124, 1, 87, 4, 99, 0, 0, 173, 1, 17, 1, 0, 86, 13, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
