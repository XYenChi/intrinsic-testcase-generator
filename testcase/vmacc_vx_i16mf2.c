...
int main(){
    const int16_t data1[] = {
    -30, 24, 122, -88, -20, -54, -8, -113, 105, -82, 107, 111, 88, 52, 122, -47
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -47, 10, -86, -67, 67, 8, -127, -14, -40, -33, 82, -48, -96, -61, -45, 68
    };
    ...
    int16_t golden[] = {
    1411, 241, 55045, 5897, 64197, 65104, 1017, 1582, 61336, 2707, 8775, 60208, 57089, 62364, 60046, 62340
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
