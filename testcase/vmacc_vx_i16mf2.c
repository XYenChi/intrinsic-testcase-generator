...
int main(){
    const int16_t data1[] = {
    -64, -22, -80, 55, -97, -22, -14, -81, 45, 102, 75, 44, -105, -58, 22, 124
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -75, 118, -58, -70, 67, 111, 4, -90, 61, -103, 57, -27, -38, -116, -103, -77
    };
    ...
    int16_t golden[] = {
    4801, 62941, 4641, 61687, 59038, 63095, 65480, 7290, 2746, 55031, 4276, 64349, 3990, 6729, 63270, 55988
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
