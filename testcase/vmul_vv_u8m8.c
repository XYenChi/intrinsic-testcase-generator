...
int main(){
    const uint8_t data1[] = {
    199, 1, 90, 171, 54, 190, 149, 116, 227, 187, 35, 84, 46, 250, 228, 150
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    95, 2, 96, 123, 82, 74, 177, 199, 10, 248, 152, 193, 228, 27, 198, 185
    };
    ...
    uint8_t golden[] = {
    217, 2, 192, 41, 76, 236, 5, 44, 222, 40, 200, 84, 248, 94, 88, 102
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
