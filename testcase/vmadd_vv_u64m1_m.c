...
int main(){
    ...
    30, 90, 50, 157, 87, 41, 184, 252, 141, 62, 96, 145, 83, 215, 201, 0
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    135, 131, 85, 85, 202, 77, 207, 145, 174, 53, 10, 252, 136, 130, 218, 36
    };
    ...
    uint64_t golden[] = {
    165, 131, 50, 157, 87, 41, 184, 252, 141, 115, 96, 252, 219, 215, 201, 36
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
