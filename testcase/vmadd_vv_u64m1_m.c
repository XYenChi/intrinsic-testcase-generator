...
int main(){
    ...
    37, 250, 156, 198, 209, 76, 156, 41, 57, 190, 208, 92, 126, 26, 25, 8
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    214, 177, 60, 105, 194, 243, 35, 224, 225, 200, 157, 70, 113, 233, 89, 60
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmadd_vv_u64m1_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    251, 177, 216, 198, 209, 76, 191, 41, 225, 200, 208, 162, 126, 26, 25, 68
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
