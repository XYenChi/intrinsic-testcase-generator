...
int main(){
    const int16_t data1[] = {
    -95, -20, -79, -67, 125, 32, -15, -61, 11, 103, 2, 28, 32, -80, -115, -72
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    83, 70, 62, 74, 103, 45, 98, 60, 115, -49, -69, -128, -24, -91, -86, -128
    };
    ...
    int16_t golden[] = {
    65358, 65446, 65395, 65395, 22, 65523, 65423, 65415, 65432, 152, 71, 156, 56, 11, 65507, 56
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
