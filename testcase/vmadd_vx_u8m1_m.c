...
int main(){
    const uint8_t data1[] = {
    88, 173, 185, 61, 223, 163, 175, 138, 106, 49, 56, 38, 249, 36, 169, 217
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    205, 8, 147, 205, 146, 155, 61, 236, 44, 93, 158, 241, 50, 215, 174, 159
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmadd_vx_u8m1_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    88, 8, 185, 61, 223, 163, 61, 138, 106, 93, 56, 38, 50, 251, 169, 217
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
