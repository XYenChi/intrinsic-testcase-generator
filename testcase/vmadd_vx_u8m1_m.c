...
int main(){
    const uint8_t data1[] = {
    103, 135, 136, 41, 82, 83, 187, 144, 90, 100, 177, 34, 113, 120, 140, 103
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    11, 189, 120, 121, 242, 5, 46, 14, 201, 89, 214, 183, 23, 108, 89, 4
    };
    ...
    uint8_t golden[] = {
    114, 189, 136, 41, 82, 5, 233, 144, 90, 100, 135, 34, 136, 120, 140, 103
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
