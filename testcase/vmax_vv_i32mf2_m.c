...
int main(){
    const int32_t data1[] = {
    -53, -41, 66, -33, -42, -114, 84, -88, -86, -82, -75, -36, 11, -77, -96, 48
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -124, 115, 87, 39, 93, 43, 4, 23, -45, 98, 93, 20, 16, -92, 92, 19
    };
    ...
    int32_t golden[] = {
    4294967243, 1, 0, 39, 0, 1, 84, 23, 4294967251, 1, 93, 20, 1, 0, 92, 48
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
