...
int main(){
    const int32_t data1[] = {
    -59, -65, 21, -97, -56, 1, 50, -6, -64, 123, 126, 73, -81, -73, -91, -37
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    4, -47, 97, 77, 13, -92, -75, -67, 59, -49, 59, 79, 45, -74, 24, 19
    };
    ...
    int32_t golden[] = {
    1, 4294967249, 1, 0, 1, 1, 50, 4294967290, 59, 123, 126, 0, 45, 4294967223, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
