...
int main(){
    ...
    58, 142, 106, 154, 38, 211, 174, 17, 242, 28, 113, 186, 73, 216, 17, 119
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    189, 59, 243, 42, 84, 63, 137, 188, 143, 190, 227, 232, 75, 32, 88, 150
    };
    ...
    uint32_t golden[] = {
    4294967165, 83, 4294967159, 112, 4294967250, 148, 37, 4294967125, 99, 4294967134, 4294967182, 4294967250, 4294967294, 184, 4294967225, 4294967265
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
