...
int main(){
    ...
    54, 199, 24, 96, 229, 222, 239, 113, 177, 198, 12, 213, 148, 101, 233, 67
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    82, 106, 235, 248, 205, 244, 129, 83, 41, 27, 232, 109, 202, 97, 22, 136
    };
    ...
    uint32_t golden[] = {
    4294967268, 93, 4294967085, 4294967144, 24, 4294967274, 110, 30, 136, 171, 4294967076, 104, 4294967242, 4, 211, 4294967227
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
