...
int main(){
    const int8_t data1[] = {
    17, -19, -96, -125, -106, 89, -52, -102, 76, 82, 48, -95, -95, -97, -103, 123
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -27, 90, 86, -39, -46, -67, -69, -28, 126, -49, -105, 5, -92, 22, -101, -89
    };
    ...
    int8_t golden[] = {
    17, 90, 86, 217, 210, 89, 204, 228, 126, 82, 48, 5, 164, 22, 155, 123
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
