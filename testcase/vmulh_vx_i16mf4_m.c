...
int main(){
    const int16_t data1[] = {
    119, 64, 106, -100, 45, -76, -97, -92, 106, 46, -45, -118, 29, -9, 69, 72
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -107, 30, 57, 112, -101, -35, -116, -22, 36, -114, 24, 49, -47, -51, 24, 103
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vx_16mf4_b64 (mask, data1_v, data2_v, vl);
