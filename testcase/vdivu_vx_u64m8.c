...
int main(){
    ...
    143, 156, 231, 160, 169, 97, 2, 6, 7, 227, 226, 120, 229, 165, 149, 171
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    79, 67, 232, 43, 168, 103, 127, 124, 215, 230, 19, 114, 122, 226, 12, 60
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i64m8 (data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    0, 0, 1, 0, 0, 1, 63, 20, 30, 1, 0, 0, 0, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
