...
int main(){
    const int16_t data1[] = {
    82, -85, 123, -122, 60, 47, 10, -122, -6, 69, -123, -46, 68, -62, 103, 37
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -56, 77, -18, -127, 91, 59, 10, -113, -47, 37, 84, -71, 44, 34, 28, -100
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vv_16m4_b4 (data1_v, data2_v, vl);
