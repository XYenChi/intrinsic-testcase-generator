...
int main(){
    const uint8_t data1[] = {
    148, 150, 107, 187, 23, 1, 25, 46, 73, 234, 155, 228, 213, 169, 61, 134
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    7, 24, 77, 134, 24, 152, 241, 180, 58, 78, 84, 26, 6, 160, 173, 29
    };
    ...
    uint8_t golden[] = {
    1, 0, 1, 187, 24, 152, 1, 1, 73, 0, 1, 228, 1, 169, 173, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
