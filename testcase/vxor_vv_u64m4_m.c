...
int main(){
    ...
    194, 42, 121, 24, 150, 164, 135, 22, 124, 88, 97, 242, 235, 36, 31, 151
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    142, 7, 25, 134, 165, 243, 51, 194, 186, 210, 161, 165, 69, 20, 137, 125
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u64m4_m (mask, data1_v, data2_v, vl);
