...
int main(){
    ...
    38, 20, 163, 255, 132, 41, 81, 197, 153, 172, 187, 203, 235, 173, 185, 204
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    15, 55, 100, 217, 7, 234, 181, 165, 224, 74, 213, 103, 250, 18, 177, 114
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u16mf4_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    15, 0, 1, 1, 0, 0, 0, 165, 71, 1, 26, 103, 1, 18, 0, 114
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
