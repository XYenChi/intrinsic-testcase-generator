...
int main(){
    const int16_t data1[] = {
    -71, 119, 99, 0, 87, -116, -97, -103, -114, -15, 40, -87, -70, -94, 32, 51
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    5, 36, -117, 89, 11, -94, -106, -92, 71, -61, -90, 56, -52, 122, 23, -14
    };
    ...
    int16_t golden[] = {
    65460, 83, 216, 1, 76, 0, 1, 65525, 65351, 1, 0, 65393, 1, 65320, 0, 65
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
