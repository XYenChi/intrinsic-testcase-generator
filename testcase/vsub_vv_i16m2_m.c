...
int main(){
    const int16_t data1[] = {
    114, 37, 107, 103, -116, -115, -3, 36, -64, -62, 21, 59, -80, 121, 111, -29
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    93, -4, 60, -41, 127, -86, 127, 47, 111, 15, -27, 50, 104, -25, 33, 80
    };
    ...
    int16_t golden[] = {
    1, 41, 1, 144, 0, 65507, 65406, 65525, 65361, 65459, 0, 0, 1, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
