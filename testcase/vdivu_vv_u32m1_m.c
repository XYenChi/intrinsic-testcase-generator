...
int main(){
    ...
    183, 0, 12, 222, 113, 77, 68, 237, 201, 169, 176, 7, 106, 237, 18, 229
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    251, 21, 103, 92, 2, 155, 189, 33, 5, 40, 171, 126, 113, 51, 151, 165
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i32m1_m (mask, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    1, 4294967295, 8, 1, 0, 1, 1, 0, 0, 1, 0, 0, 1, 0, 8, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
