...
int main(){
    const uint8_t data1[] = {
    120, 204, 212, 228, 240, 157, 115, 86, 156, 174, 92, 201, 119, 21, 175, 229
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    121, 71, 81, 125, 1, 17, 76, 130, 24, 169, 160, 75, 177, 155, 218, 165
    };
    ...
    uint8_t golden[] = {
    121, 204, 212, 0, 0, 157, 115, 130, 156, 174, 0, 0, 0, 155, 218, 229
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
