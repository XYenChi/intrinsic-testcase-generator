...
int main(){
    const uint8_t data1[] = {
    174, 74, 207, 217, 42, 242, 125, 82, 246, 64, 5, 196, 114, 174, 33, 188
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    158, 173, 113, 247, 156, 172, 124, 158, 156, 251, 18, 212, 202, 98, 39, 29
    };
    ...
    uint8_t golden[] = {
    1, 173, 1, 247, 1, 0, 125, 158, 1, 251, 1, 1, 1, 1, 39, 188
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
