...
int main(){
    const int8_t data1[] = {
    -87, -45, -29, -95, -71, -24, 40, 37, 114, 113, 49, -62, -12, -41, -11, 123
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    56, 126, -29, -94, -93, 81, -119, -108, -117, -7, 0, -123, -115, -122, -55, 72
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vv_8m8_b1 (data1_v, data2_v, vl);
