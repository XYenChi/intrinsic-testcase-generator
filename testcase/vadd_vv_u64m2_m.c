...
int main(){
    ...
    201, 162, 197, 98, 81, 215, 194, 210, 112, 31, 176, 161, 153, 30, 9, 89
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    92, 37, 174, 1, 132, 89, 204, 138, 205, 113, 143, 202, 184, 157, 139, 31
    };
    ...
    uint64_t golden[] = {
    0, 0, 0, 99, 0, 0, 398, 1, 0, 1, 319, 1, 1, 187, 148, 120
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
