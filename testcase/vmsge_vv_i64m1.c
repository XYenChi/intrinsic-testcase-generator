...
int main(){
    const int64_t data1[] = {
    -36, 36, -83, 125, 33, 113, 38, -44, 17, 61, -105, -39, 59, -57, 36, 24
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -116, -121, 91, -43, 109, -21, 38, -102, 45, 21, 14, -72, -11, -18, -74, -38
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vv_64m1_b64 (data1_v, data2_v, vl);
