...
int main(){
    const int64_t data1[] = {
    -68, -15, -119, 107, -87, -125, 53, -99, -98, 62, -121, -29, -61, 34, -113, -119
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -54, -115, -50, -24, -50, 90, 11, 26, 80, 10, 8, -66, 47, 52, -8, -20
    };
    ...
    int64_t golden[] = {
    -14, 100, -69, 127, -37, -128, 42, -125, -128, 52, -128, 37, -108, -18, -105, -99
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
