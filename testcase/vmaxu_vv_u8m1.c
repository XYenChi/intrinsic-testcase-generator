...
int main(){
    const uint8_t data1[] = {
    133, 131, 91, 143, 228, 83, 41, 47, 94, 70, 215, 53, 154, 61, 131, 222
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    135, 249, 180, 113, 15, 252, 252, 180, 228, 59, 32, 216, 82, 241, 250, 19
    };
    ...
    uint8_t golden[] = {
    135, 249, 180, 143, 228, 252, 252, 180, 228, 70, 215, 216, 154, 241, 250, 222
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
