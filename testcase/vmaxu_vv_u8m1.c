...
int main(){
    const uint8_t data1[] = {
    186, 255, 129, 187, 203, 74, 54, 165, 75, 6, 125, 41, 54, 46, 56, 73
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    104, 40, 87, 175, 232, 182, 3, 58, 7, 105, 69, 169, 195, 211, 154, 223
    };
    ...
    uint8_t golden[] = {
    186, 255, 129, 187, 232, 182, 54, 165, 75, 105, 125, 169, 195, 211, 154, 223
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
