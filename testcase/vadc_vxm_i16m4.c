...
int main(){
    const int16_t data1[] = {
    66, 8, 85, -106, -128, -101, -75, 24, 114, -50, -18, 99, 118, 41, -100, 113
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    104, 36, 101, -72, 37, 19, -18, 109, 6, 90, 14, -58, -33, -18, 82, 112
    };
    ...
    int16_t golden[] = {
    170, 44, 186, -178, -90, -82, -92, 133, 120, 40, -3, 42, 86, 23, -17, 225
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
