...
int main(){
    const int32_t data1[] = {
    -30, 27, 89, 120, -11, -128, 94, 103, -124, 85, -63, 44, -30, 58, 41, -95
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    0, 1, -100, -33, -62, 22, 92, 106, -66, 127, -51, 80, -23, 116, -102, -55
    };
    ...
    int32_t golden[] = {
    0, 27, 89, 120, 4294967285, 22, 94, 106, 4294967230, 127, 4294967245, 80, 4294967273, 116, 41, 4294967241
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
