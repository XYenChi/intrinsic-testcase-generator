...
int main(){
    const int32_t data1[] = {
    -60, 53, 22, -96, 103, 7, -105, -117, -83, -46, -112, -55, 94, -105, -122, 105
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    97, 86, -71, 21, -126, -63, -42, -48, -122, 91, -112, -39, -2, -71, 16, -85
    };
    ...
    int32_t golden[] = {
    97, 86, 22, 21, 103, 7, 4294967254, 4294967248, 4294967213, 91, 4294967184, 4294967257, 94, 4294967225, 16, 105
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
