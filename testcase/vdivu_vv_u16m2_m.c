...
int main(){
    ...
    189, 192, 30, 220, 248, 210, 57, 51, 128, 152, 22, 92, 15, 183, 237, 185
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    143, 150, 68, 105, 209, 106, 102, 206, 220, 16, 130, 192, 85, 23, 78, 39
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i16m2_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    1, 0, 1, 0, 0, 0, 1, 0, 1, 0, 5, 2, 0, 1, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
