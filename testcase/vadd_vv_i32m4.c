...
int main(){
    const int32_t data1[] = {
    107, 125, 25, 9, -7, 102, -12, -40, -7, -14, -91, -92, 121, 73, 39, -40
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -31, -50, 41, 47, -122, 12, 66, 65, -88, 60, 67, 50, -59, 118, -109, 20
    };
    ...
    int32_t golden[] = {
    76, 75, 66, 56, 4294967167, 114, 54, 25, 4294967201, 46, 4294967272, 4294967254, 62, 191, 4294967226, 4294967276
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
