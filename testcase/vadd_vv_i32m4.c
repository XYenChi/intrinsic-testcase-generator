...
int main(){
    const int32_t data1[] = {
    64, 94, 95, 19, -89, 109, -70, 91, -82, 91, -66, -7, -91, 39, -115, -46
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    2, -89, 74, 39, -88, -50, 88, 104, 6, -8, -100, 64, -38, 50, 57, -54
    };
    ...
    int32_t golden[] = {
    66, 5, 169, 58, 4294967119, 59, 18, 195, 4294967220, 83, 4294967130, 57, 4294967167, 89, 4294967238, 4294967196
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
