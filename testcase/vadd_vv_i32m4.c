...
int main(){
    const int32_t data1[] = {
    -49, -42, -52, -22, -26, -9, 88, 46, -56, 80, 115, 116, -32, -98, -106, 24
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    11, 7, -73, 74, -29, 66, 70, 54, -66, 52, 51, 57, -30, 112, -87, 19
    };
    ...
    int32_t golden[] = {
    4294967258, 4294967261, 4294967171, 52, 4294967241, 57, 158, 100, 4294967174, 132, 166, 173, 4294967234, 14, 4294967103, 43
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
