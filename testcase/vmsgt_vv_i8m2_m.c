...
int main(){
    const int8_t data1[] = {
    -111, 11, 48, -65, 76, 9, 90, -47, 102, -7, -101, 86, -45, 0, 54, 85
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -41, -32, 71, 118, 46, 88, -120, 121, -56, 124, -45, 76, 0, 4, -6, -28
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vv_8m2_b4_m (mask, data1_v, data2_v, vl);
