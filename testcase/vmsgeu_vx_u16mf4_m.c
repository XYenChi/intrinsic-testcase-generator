...
int main(){
    ...
    120, 150, 212, 234, 251, 157, 237, 215, 181, 30, 248, 179, 244, 22, 146, 46
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    192, 6, 188, 50, 41, 156, 218, 51, 195, 247, 168, 4, 228, 175, 237, 40
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_16mf4_b64 (mask, data1_v, data2_v, vl);
