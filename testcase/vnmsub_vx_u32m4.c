...
int main(){
    ...
    210, 167, 139, 77, 44, 134, 30, 231, 227, 131, 76, 186, 26, 8, 145, 122
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    177, 143, 183, 21, 130, 157, 75, 70, 143, 112, 150, 32, 123, 105, 111, 1
    };
    ...
    uint32_t golden[] = {
    210, 167, 139, 56, 44, 134, 4294967251, 161, 227, 19, 4294967222, 186, 4294967199, 4294967199, 34, 121
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
