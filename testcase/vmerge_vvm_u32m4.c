...
int main(){
    ...
    67, 220, 87, 56, 27, 207, 148, 85, 129, 46, 215, 128, 153, 48, 238, 12
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    95, 4, 88, 224, 133, 44, 240, 4, 219, 155, 188, 204, 215, 243, 214, 111
    };
    ...
    uint32_t golden[] = {
    95, 220, 87, 56, 27, 207, 240, 4, 219, 46, 188, 204, 215, 243, 214, 12
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
