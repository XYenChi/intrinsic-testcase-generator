...
int main(){
    const int32_t data1[] = {
    96, -35, 26, -11, -77, -47, 6, 84, 127, -58, -55, -51, 15, 126, -107, 97
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    18, 63, 47, -32, -45, 63, -45, -21, -66, -45, -88, -88, 19, -24, 49, 36
    };
    ...
    int32_t golden[] = {
    0, 1, 1, 4294967285, 4294967251, 1, 1, 84, 127, 4294967251, 4294967241, 4294967245, 19, 1, 0, 97
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
