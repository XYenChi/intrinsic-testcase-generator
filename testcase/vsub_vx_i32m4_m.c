...
int main(){
    const int32_t data1[] = {
    51, -104, 126, 104, 21, 113, 111, 45, -54, 32, 42, -121, 84, 4, -63, 74
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -99, 45, -119, 122, 26, -59, 75, -117, -25, 107, 44, -89, -126, 82, 61, -94
    };
    ...
    int32_t golden[] = {
    150, 0, 245, 1, 0, 172, 36, 1, 4294967267, 4294967221, 1, 4294967264, 210, 0, 4294967172, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
