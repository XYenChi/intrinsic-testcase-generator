...
int main(){
    const int32_t data1[] = {
    48, 117, 96, 115, -86, -92, 67, -111, 1, 13, -13, -80, -115, 77, -79, -43
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -27, 21, 121, 45, -65, -73, 93, -99, -4, 112, -56, -17, 30, 41, -20, -49
    };
    const int32_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e32m4(avl);
    const int out_data[] = {
    29, -75, 103, 118, -30, -102, -22, 48, 46, 48, 21, -18, -124, -10, -1, 66
    };
    ...
    int32_t golden[] = {
    29, 96, 103, 70, -30, -102, -26, 48, 46, 48, 21, -18, -128, -10, -1, 66
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
