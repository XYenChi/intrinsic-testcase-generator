...
int main(){
    const int32_t data1[] = {
    -46, -111, -102, 45, 42, 49, -54, -127, 122, 7, 94, -34, 33, -71, -26, 48
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -71, -62, 127, -55, 26, 26, 60, -9, 19, -63, 66, 42, 14, 37, -18, 101
    };
    ...
    int32_t golden[] = {
    4294967225, 4294967234, 127, 4294967241, 26, 26, 60, 4294967287, 19, 4294967233, 66, 42, 14, 37, 4294967278, 101
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
