...
int main(){
    const uint8_t data1[] = {
    132, 46, 225, 47, 54, 105, 216, 230, 70, 6, 253, 222, 201, 254, 145, 213
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    82, 117, 217, 4, 37, 58, 146, 163, 232, 203, 24, 184, 102, 91, 79, 93
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_8mf8 (data1_v, shift, vl);
