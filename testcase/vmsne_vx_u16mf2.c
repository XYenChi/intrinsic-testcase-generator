...
int main(){
    ...
    176, 242, 216, 44, 235, 167, 23, 44, 60, 52, 108, 40, 154, 61, 61, 228
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    203, 136, 149, 9, 57, 67, 132, 161, 236, 226, 141, 172, 5, 161, 224, 227
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vx_16mf2_b32 (data1_v, data2_v, vl);
