...
int main(){
    const int16_t data1[] = {
    -128, -115, -104, 46, -41, -58, 53, -14, -67, 27, -68, 32, 67, 81, -86, -121
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -37, 57, -94, -113, 74, -41, -26, -20, -72, 88, -101, -5, 96, -16, 67, -96
    };
    ...
    int16_t golden[] = {
    -128, -58, -128, -67, 33, -99, 27, -34, -128, 115, -128, 27, 127, 65, -19, -128
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
