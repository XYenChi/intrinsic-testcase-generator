...
int main(){
    const int64_t data1[] = {
    4, -101, 6, -121, -85, -77, -127, -69, -64, -53, -20, 114, -124, -52, -33, -32
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    23, -79, 31, -41, 71, -38, -70, -108, 52, -44, 56, -102, -63, -96, -12, -121
    };
    ...
    int64_t golden[] = {
    4, -101, 31, -121, -85, -77, -70, -108, 52, -44, -20, 114, -63, -52, -33, -32
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
