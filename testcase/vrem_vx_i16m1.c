...
int main(){
    const int16_t data1[] = {
    42, -98, 31, -7, -123, -58, 15, -128, -120, 27, -64, -47, 38, -44, -37, -29
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    94, 40, 14, -94, 106, 104, -23, 10, -39, 62, 5, -7, -56, 92, 38, 20
    };
    ...
    int16_t golden[] = {
    10, 65478, 14, 65533, 65519, 65524, 7, 65418, 65497, 8, 65477, 65529, 20, 65496, 65500, 65527
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
