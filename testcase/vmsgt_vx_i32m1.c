...
int main(){
    const int32_t data1[] = {
    -45, 33, 12, -43, 123, 54, 109, 53, -29, 46, -60, 52, 93, 123, -7, -8
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -98, 16, -82, -113, -87, -12, 125, -71, -111, -20, -44, -120, 102, -124, -121, 94
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vx_32m1_b32 (data1_v, data2_v, vl);
