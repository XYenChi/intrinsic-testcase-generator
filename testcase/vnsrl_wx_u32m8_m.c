...
int main(){
    ...
    214, 139, 114, 237, 145, 154, 36, 214, 95, 22, 52, 51, 86, 56, 19, 197
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    114, 9, 179, 249, 146, 137, 112, 89, 207, 223, 58, 35, 147, 237, 142, 197
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_32m8_m (mask, data1_v, shift, vl);
