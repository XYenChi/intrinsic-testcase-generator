...
int main(){
    ...
    252, 33, 71, 159, 14, 184, 179, 198, 242, 141, 149, 204, 51, 179, 227, 230
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    109, 70, 175, 125, 180, 163, 11, 133, 205, 107, 18, 53, 237, 143, 95, 236
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u16m4 (data1_v, data2_v, vl);
