...
int main(){
    ...
    55, 225, 144, 99, 175, 204, 84, 121, 224, 52, 20, 159, 130, 247, 87, 147
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    141, 115, 234, 142, 211, 83, 247, 39, 159, 112, 65, 229, 111, 26, 168, 29
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u32m1_m (mask, data1_v, data2_v, vl);
