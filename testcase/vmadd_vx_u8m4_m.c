...
int main(){
    const uint8_t data1[] = {
    153, 219, 21, 164, 182, 12, 138, 36, 90, 49, 125, 192, 135, 56, 183, 37
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    188, 125, 158, 83, 171, 147, 47, 127, 202, 163, 45, 226, 105, 3, 61, 194
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmadd_vx_u8m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    188, 219, 179, 164, 97, 159, 185, 36, 36, 49, 45, 192, 135, 56, 183, 231
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
