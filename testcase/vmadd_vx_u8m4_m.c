...
int main(){
    const uint8_t data1[] = {
    158, 5, 82, 207, 46, 187, 162, 0, 50, 73, 10, 156, 189, 191, 225, 81
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    251, 157, 225, 154, 141, 176, 228, 227, 169, 13, 133, 105, 215, 74, 235, 58
    };
    ...
    uint8_t golden[] = {
    158, 5, 82, 207, 141, 187, 162, 0, 50, 86, 10, 5, 189, 9, 235, 139
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
