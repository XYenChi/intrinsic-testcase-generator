...
int main(){
    ...
    57, 50, 52, 174, 89, 76, 121, 61, 234, 222, 234, 100, 53, 74, 90, 176
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    1, 109, 25, 246, 99, 126, 73, 148, 11, 82, 64, 230, 142, 237, 56, 145
    };
    ...
    uint32_t golden[] = {
    0, 1, 4294967269, 1, 0, 50, 4294967248, 87, 4294967073, 4294967156, 4294967126, 1, 1, 1, 4294967262, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
