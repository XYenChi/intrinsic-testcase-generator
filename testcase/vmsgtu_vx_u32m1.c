...
int main(){
    ...
    73, 164, 229, 47, 150, 42, 28, 84, 17, 72, 3, 129, 125, 11, 217, 34
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    28, 251, 85, 126, 22, 167, 251, 244, 173, 71, 200, 245, 60, 252, 144, 168
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_32m1_b32 (data1_v, data2_v, vl);
