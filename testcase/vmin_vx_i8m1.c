...
int main(){
    const int8_t data1[] = {
    118, 107, 165, 128, 112, 75, 185, 192, 80, 221, 152, 54, 0, 93, 37, 55
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    2, 194, 119, 37, 75, 254, 86, 246, 31, 160, 49, 138, 131, 202, 100, 140
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmin_vx_i8m1 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    118, 194, 165, 128, 112, 254, 185, 246, 80, 221, 152, 138, 131, 202, 100, 140
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
