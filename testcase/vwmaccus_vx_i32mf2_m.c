...
int main(){
    const int32_t data1[] = {
    40, -45, 3, 51, -72, 66, 121, 24, -35, -71, 60, 51, 4, 95, -98, 67
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -117, -128, 6, 19, 109, -71, -17, 82, 114, 112, -63, -104, -126, 28, -55, -58
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccus_vx_i32mf2_m (mask, out_data, data1_v, data2_v, vl);
