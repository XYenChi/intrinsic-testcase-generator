...
int main(){
    const int8_t data1[] = {
    -9, 9, -118, -104, 125, -116, -100, -127, -68, 91, 79, 110, -28, 102, 122, 71
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    20, -97, -93, -43, -65, -31, 41, -121, 125, -123, -67, 70, 112, -67, -65, 18
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vv_8m2_b4 (data1_v, data2_v, vl);
