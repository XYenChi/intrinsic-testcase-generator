...
int main(){
    const int32_t data1[] = {
    -100, -15, -95, -7, 70, 125, 65, 92, -50, 82, 71, -87, -118, 122, -19, 107
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    74, -51, 104, 24, 101, 115, -64, 110, -110, 117, -77, 48, 73, -3, 89, 57
    };
    ...
    int32_t golden[] = {
    4294967196, 4294967281, 1, 0, 0, 10, 1, 4294967278, 1, 1, 1, 4294967209, 0, 122, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
