...
int main(){
    const uint8_t data1[] = {
    120, 163, 60, 109, 2, 148, 51, 150, 155, 36, 12, 37, 28, 159, 175, 179
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    187, 97, 152, 95, 43, 11, 10, 193, 112, 155, 219, 13, 7, 151, 238, 96
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vx_u8m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    1, 0, 160, 1, 86, 0, 254, 0, 208, 205, 1, 1, 196, 201, 179, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
