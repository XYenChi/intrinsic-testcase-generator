...
int main(){
    ...
    185, 163, 142, 170, 215, 123, 35, 216, 183, 125, 222, 133, 216, 52, 205, 64
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    133, 28, 122, 30, 226, 171, 239, 187, 73, 170, 252, 168, 77, 217, 66, 237
    };
    ...
    uint64_t golden[] = {
    24605, 4564, 17324, 5100, 48590, 21033, 8365, 40392, 13359, 21250, 55944, 22344, 16632, 11284, 13530, 15168
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
