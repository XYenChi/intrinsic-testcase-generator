...
int main(){
    ...
    116, 162, 253, 217, 218, 74, 62, 55, 104, 13, 138, 39, 156, 189, 218, 208
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    236, 98, 36, 11, 62, 158, 250, 82, 203, 88, 106, 171, 154, 251, 221, 61
    };
    ...
    uint64_t golden[] = {
    27376, 15876, 9108, 2387, 13516, 11692, 15500, 4510, 21112, 1144, 14628, 6669, 24024, 47439, 48178, 12688
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
