...
int main(){
    ...
    187, 79, 239, 138, 183, 252, 155, 137, 132, 254, 207, 77, 62, 198, 30, 61
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    58, 177, 112, 202, 214, 75, 71, 182, 114, 40, 72, 67, 247, 235, 14, 82
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_64m8_b8_m (mask, data1_v, data2_v, vl);
