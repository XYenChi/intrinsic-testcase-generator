...
int main(){
    const int16_t data1[] = {
    9709, 51649, 42638, 23488, 864, 22722, 18414, 22251, 21439, 30559, 9641, 31832, 61821, 26620, 44367, 3390
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    11980, 60208, 4513, 62238, 48950, 48674, 2512, 26886, 24187, 17384, 50556, 41749, 35283, 52430, 31859, 13330
    };
    ...
    int16_t golden[] = {
    11980, 60208, 42638, 62238, 48950, 48674, 18414, 26886, 24187, 30559, 50556, 41749, 61821, 52430, 44367, 13330
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
