...
int main(){
    const int16_t data1[] = {
    51, -25, 51, -28, -20, -103, 105, -121, -62, 39, -105, 38, 88, -8, 97, -29
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    127, 85, 17, 63, -107, -106, -75, 66, 1, 59, 100, -118, -44, -83, 33, 4
    };
    ...
    int16_t golden[] = {
    127, 85, 51, 63, 65516, 65433, 105, 66, 1, 59, 100, 38, 88, 65528, 97, 4
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
