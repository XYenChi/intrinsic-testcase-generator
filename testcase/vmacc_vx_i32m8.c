...
int main(){
    const int32_t data1[] = {
    -60, 30, 20, 97, 64, 20, -103, 125, 98, -27, -51, -14, 113, 23, 103, 33
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    127, -7, 98, -47, -21, 45, -12, -73, -11, 35, 43, 90, 104, -52, -101, -74
    };
    ...
    int32_t golden[] = {
    4294959676, 4294967086, 1960, 4294962738, 4294965953, 900, 1236, 4294958172, 4294966219, 4294966352, 4294965104, 4294966037, 11752, 4294966100, 4294956894, 4294964854
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
