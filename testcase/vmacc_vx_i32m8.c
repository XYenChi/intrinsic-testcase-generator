...
int main(){
    const int32_t data1[] = {
    35, -114, 75, 120, 94, -108, 61, 19, 102, -36, -84, 126, -70, 89, -77, -115
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    83, 65, 77, 7, 91, 107, 42, -43, 20, -126, -126, 88, -55, -29, 115, 4
    };
    ...
    int32_t golden[] = {
    2905, 4294959886, 5776, 840, 8555, 4294955740, 2562, 4294966480, 2041, 4536, 10584, 11088, 3851, 4294964716, 4294958442, 4294966837
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
