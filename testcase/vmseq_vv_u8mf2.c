...
int main(){
    const uint8_t data1[] = {
    37, 254, 29, 62, 30, 172, 137, 166, 94, 212, 178, 212, 133, 140, 188, 151
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    223, 162, 80, 242, 77, 225, 59, 105, 109, 145, 135, 230, 25, 133, 224, 77
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_8mf2_b16 (data1_v, data2_v, vl);
