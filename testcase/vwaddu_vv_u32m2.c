...
int main(){
    ...
    156, 89, 125, 126, 61, 59, 55, 182, 25, 29, 165, 161, 175, 48, 145, 215
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    243, 118, 154, 243, 229, 4, 181, 202, 248, 52, 86, 176, 103, 151, 102, 185
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u32m2 (data1_v, data2_v, vl);
