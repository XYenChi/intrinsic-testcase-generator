...
int main(){
    ...
    245, 82, 60, 175, 198, 148, 183, 41, 93, 122, 164, 122, 99, 15, 52, 45
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    33, 89, 123, 126, 86, 165, 182, 136, 226, 199, 43, 73, 172, 99, 222, 242
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u16m2_m (mask, data1_v, data2_v, vl);
