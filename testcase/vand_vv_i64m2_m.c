...
int main(){
    const int64_t data1[] = {
    -48, 123, -68, 100, 127, -97, -103, 125, -78, -85, -41, -127, 54, -112, -123, -97
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -89, -55, -10, 16, -16, 19, -39, -52, -38, -25, 61, 16, 25, 22, 67, 7
    };
    ...
    int64_t golden[] = {
    1, 18446744073709551561, 0, 0, 18446744073709551600, 19, 1, 1, 0, 0, 61, 16, 1, 22, 1, 7
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
