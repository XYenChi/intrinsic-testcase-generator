...
int main(){
    ...
    176, 150, 47, 225, 82, 228, 156, 37, 124, 253, 134, 229, 87, 152, 89, 68
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    77, 68, 123, 70, 178, 171, 45, 135, 31, 187, 39, 182, 223, 30, 107, 241
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u16m4 (data1_v, data2_v, vl);
