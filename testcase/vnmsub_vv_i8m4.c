...
int main(){
    const int8_t data1[] = {
    -34, -19, -19, -16, -108, -127, 16, 32, 94, 90, 105, -72, -78, 22, 7, -86
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -99, 62, -81, 67, -94, 43, 30, 75, -7, 6, 115, -35, 53, 20, 12, -83
    };
    ...
    int8_t golden[] = {
    65, 237, 237, 240, 148, 86, 242, 213, 101, 90, 246, 184, 178, 22, 7, 170
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
