...
int main(){
    const uint8_t data1[] = {
    144, 180, 46, 130, 203, 191, 215, 198, 71, 186, 42, 89, 57, 97, 50, 26
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    49, 89, 54, 104, 144, 96, 41, 133, 252, 50, 110, 15, 144, 20, 43, 165
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulu_vv_u8m1_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    144, 148, 0, 1, 48, 0, 0, 1, 0, 84, 1, 0, 16, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
