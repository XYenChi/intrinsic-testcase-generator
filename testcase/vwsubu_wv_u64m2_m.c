...
int main(){
    ...
    36, 234, 190, 233, 191, 198, 27, 108, 204, 140, 177, 163, 91, 88, 179, 140
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    53, 5, 54, 42, 240, 60, 69, 168, 46, 9, 168, 207, 85, 0, 177, 108
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u64m2_m (mask, data1_v, data2_v, vl);
