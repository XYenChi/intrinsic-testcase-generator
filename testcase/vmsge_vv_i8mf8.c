...
int main(){
    const int8_t data1[] = {
    53, 44, 29, -66, -85, 78, -113, -4, 36, -116, -17, -92, 101, 118, -34, -98
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    21, -85, 27, -15, -114, -104, -116, -24, 102, 85, -20, -100, -99, -103, 40, 25
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vv_8mf8_b64 (data1_v, data2_v, vl);
