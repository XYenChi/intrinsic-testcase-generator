...
int main(){
    ...
    88, 173, 75, 188, 195, 135, 164, 6, 164, 234, 244, 133, 136, 159, 4, 48
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    148, 1, 177, 143, 207, 239, 103, 164, 142, 187, 120, 89, 7, 113, 252, 194
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vx_u32m8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    1, 174, 13276, 1, 1, 32266, 1, 984, 23289, 1, 1, 1, 953, 1, 0, 9313
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
