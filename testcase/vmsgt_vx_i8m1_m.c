...
int main(){
    const int8_t data1[] = {
    -56, -34, -98, 43, -93, 125, 55, 77, 58, 74, -32, -99, -43, 113, -119, 60
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -7, 31, -11, 127, 86, -14, -29, -7, 10, 37, 67, 2, -84, 114, 28, 32
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vx_8m1_b8_m (mask, data1_v, data2_v, vl);
