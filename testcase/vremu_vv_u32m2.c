...
int main(){
    ...
    194, 140, 50, 114, 22, 78, 22, 53, 100, 95, 113, 160, 241, 42, 213, 92
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    180, 55, 159, 201, 35, 20, 38, 161, 33, 112, 199, 121, 114, 77, 51, 154
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u32m2 (data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    180, 55, 9, 87, 13, 20, 16, 2, 33, 17, 86, 121, 114, 35, 51, 62
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
