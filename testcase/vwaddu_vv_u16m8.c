...
int main(){
    ...
    23, 119, 110, 203, 186, 251, 19, 191, 124, 111, 240, 0, 244, 139, 13, 212
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    73, 203, 206, 96, 10, 36, 33, 180, 239, 117, 56, 168, 73, 57, 68, 44
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u16m8 (data1_v, data2_v, vl);
