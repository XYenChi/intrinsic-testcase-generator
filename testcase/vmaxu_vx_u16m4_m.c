...
int main(){
    ...
    143, 81, 177, 102, 62, 167, 189, 79, 207, 209, 168, 121, 140, 52, 138, 53
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    50, 57, 6, 248, 182, 240, 197, 7, 28, 87, 208, 242, 207, 224, 238, 205
    };
    ...
    uint16_t golden[] = {
    1, 0, 1, 0, 1, 1, 1, 0, 207, 0, 0, 242, 207, 224, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
