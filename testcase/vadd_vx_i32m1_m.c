...
int main(){
    const int32_t data1[] = {
    57, -34, -92, 34, -110, 59, 77, 42, 40, 119, 16, -33, -94, -10, -35, -23
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    57, 9, 28, -79, -18, -41, 115, 16, -27, -32, -57, -118, 88, -93, 40, 49
    };
    ...
    int32_t golden[] = {
    1, 1, 4294967232, 1, 4294967168, 18, 192, 58, 1, 87, 4294967255, 0, 1, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
