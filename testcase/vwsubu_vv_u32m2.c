...
int main(){
    ...
    249, 153, 166, 35, 144, 24, 162, 46, 17, 130, 239, 233, 94, 81, 138, 246
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    68, 149, 5, 200, 37, 232, 250, 139, 222, 36, 134, 213, 204, 78, 222, 95
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u32m2 (data1_v, data2_v, vl);
