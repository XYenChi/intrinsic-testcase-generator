...
int main(){
    ...
    31, 88, 238, 231, 54, 50, 35, 38, 201, 166, 173, 119, 235, 27, 59, 42
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    69, 126, 92, 228, 62, 215, 223, 13, 70, 167, 248, 222, 228, 43, 141, 186
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i16m1 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    2, 1, 0, 0, 1, 4, 6, 0, 0, 1, 1, 1, 0, 1, 2, 4
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
