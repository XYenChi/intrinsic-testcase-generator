...
int main(){
    const int8_t data1[] = {
    -94, 100, -34, -77, 93, -75, -33, 53, -90, 87, 110, -57, -110, 96, -58, 56
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    66, 126, -99, 115, 125, 43, 119, 18, 34, 59, -29, 120, 43, 62, 12, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vv_8mf2_b16 (data1_v, data2_v, vl);
