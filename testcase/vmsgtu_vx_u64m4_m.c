...
int main(){
    ...
    227, 53, 168, 41, 46, 117, 167, 217, 203, 15, 1, 231, 145, 152, 33, 146
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    13, 180, 13, 115, 5, 75, 112, 216, 212, 187, 51, 37, 203, 195, 136, 8
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_64m4_b16_m (mask, data1_v, data2_v, vl);
