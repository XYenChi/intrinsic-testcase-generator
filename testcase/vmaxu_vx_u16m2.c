...
int main(){
    ...
    97, 191, 147, 40, 146, 149, 50, 184, 162, 80, 161, 42, 194, 110, 46, 79
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    20, 69, 69, 62, 192, 1, 4, 132, 249, 62, 84, 124, 252, 241, 207, 171
    };
    ...
    uint16_t golden[] = {
    97, 191, 147, 62, 192, 149, 50, 184, 249, 80, 161, 124, 252, 241, 207, 171
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
