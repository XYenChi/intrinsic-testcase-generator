...
int main(){
    ...
    6, 199, 236, 20, 114, 207, 255, 236, 197, 174, 51, 57, 113, 207, 132, 54
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    183, 198, 103, 28, 169, 231, 100, 92, 84, 75, 89, 145, 17, 6, 215, 24
    };
    ...
    uint32_t golden[] = {
    12, 199, 472, 20, 228, 414, 255, 236, 197, 348, 102, 114, 226, 207, 264, 54
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
