...
int main(){
    ...
    245, 125, 91, 79, 137, 221, 40, 159, 131, 247, 117, 195, 252, 172, 73, 248
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    140, 18, 48, 97, 123, 175, 209, 56, 69, 149, 180, 186, 221, 90, 137, 218
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u16mf4 (data1_v, data2_v, vl);
