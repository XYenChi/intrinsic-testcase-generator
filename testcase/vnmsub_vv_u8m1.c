...
int main(){
    const uint8_t data1[] = {
    31, 10, 83, 207, 45, 232, 37, 76, 7, 193, 233, 26, 247, 168, 179, 122
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    193, 255, 92, 216, 252, 196, 196, 70, 138, 243, 218, 210, 159, 163, 41, 220
    };
    ...
    uint8_t golden[] = {
    31, 11, 247, 207, 45, 232, 97, 76, 7, 206, 233, 72, 247, 5, 179, 122
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
