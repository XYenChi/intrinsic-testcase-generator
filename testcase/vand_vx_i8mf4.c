...
int main(){
    const int8_t data1[] = {
    -42, 73, 104, -125, -46, -27, 61, 73, -34, 74, -101, 16, -12, 73, 102, -80
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -70, -95, -76, -115, -17, -20, -2, 127, 25, 109, 110, -49, 38, 54, 47, 26
    };
    ...
    int8_t golden[] = {
    186, 161, 180, 141, 239, 236, 254, 127, 25, 109, 110, 207, 38, 54, 47, 26
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
