...
int main(){
    const int16_t data1[] = {
    124, 46, 49, -30, 48, 28, -45, -45, -53, -106, -7, -23, -13, -21, 40, 32
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -126, -64, 25, -25, -3, -78, -44, -47, -16, 58, 35, -43, -9, 57, 22, 99
    };
    const int16_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e16m4(avl);
    const int out_data[] = {
    0, 1, 1, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1, 1, 0, 0
    };
    ...
    int16_t golden[] = {
    0, 65426, 65512, 5, 65485, 1, 1, 65534, 37, 164, 1, 1, 4, 1, 0, 67
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
