...
int main(){
    ...
    44, 123, 21, 154, 23, 183, 100, 160, 233, 37, 109, 32, 213, 63, 32, 248
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    232, 181, 164, 166, 157, 2, 255, 156, 159, 91, 188, 30, 34, 84, 253, 225
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wv_16m1u_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    236, 255, 1, 1, 159, 183, 255, 188, 255, 127, 253, 62, 1, 1, 253, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
