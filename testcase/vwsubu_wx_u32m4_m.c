...
int main(){
    ...
    172, 192, 28, 237, 129, 178, 202, 203, 64, 172, 0, 33, 140, 31, 14, 127
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    231, 1, 50, 75, 158, 176, 174, 244, 35, 233, 30, 40, 0, 129, 39, 42
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u32m4_m (mask, data1_v, data2_v, vl);
