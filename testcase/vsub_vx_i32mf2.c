...
int main(){
    const int32_t data1[] = {
    81, 70, -3, 6, -37, -69, 86, 17, -55, 39, -60, 105, 55, 87, 101, 9
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -76, 111, -58, 117, -19, 13, -68, -44, 55, 105, 43, 5, 123, 112, -39, 84
    };
    ...
    int32_t golden[] = {
    127, -41, 55, -111, -18, -82, 127, 61, -110, -66, -103, 100, -68, -25, 127, -75
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
