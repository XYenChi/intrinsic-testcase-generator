...
int main(){
    const int32_t data1[] = {
    103, 0, 8, 18, 71, -45, -70, 76, 114, -33, 45, 51, 35, -122, 17, -27
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -84, 107, -3, -107, -14, -12, 8, -106, 103, 113, 123, -55, 114, 110, -87, -94
    };
    ...
    int32_t golden[] = {
    187, 4294967189, 11, 125, 85, 4294967263, 4294967218, 182, 11, 4294967150, 4294967218, 106, 4294967217, 4294967064, 104, 67
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
