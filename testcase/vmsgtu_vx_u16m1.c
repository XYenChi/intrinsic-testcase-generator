...
int main(){
    ...
    61, 78, 122, 109, 255, 112, 127, 193, 220, 61, 23, 255, 16, 104, 205, 22
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    201, 60, 38, 132, 69, 71, 91, 249, 192, 170, 56, 113, 223, 206, 165, 76
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_16m1_b16 (data1_v, data2_v, vl);
