...
int main(){
    const uint8_t data1[] = {
    70, 225, 107, 0, 63, 132, 138, 253, 175, 133, 120, 207, 121, 101, 49, 202
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    226, 9, 135, 20, 91, 67, 139, 64, 230, 246, 27, 153, 218, 52, 101, 42
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u8m1_m (mask, data1_v, data2_v, vl);
