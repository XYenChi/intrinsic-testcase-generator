...
int main(){
    const uint8_t data1[] = {
    235, 170, 125, 59, 48, 193, 69, 113, 127, 145, 39, 87, 103, 233, 39, 209
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    113, 228, 236, 96, 218, 210, 171, 117, 71, 145, 115, 18, 224, 59, 248, 71
    };
    ...
    uint8_t golden[] = {
    92, 142, 105, 155, 10, 147, 240, 230, 198, 34, 154, 105, 71, 36, 31, 24
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
