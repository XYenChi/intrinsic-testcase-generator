...
int main(){
    ...
    217, 175, 204, 157, 218, 78, 95, 160, 204, 8, 128, 101, 189, 0, 2, 18
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    23, 33, 50, 155, 180, 226, 221, 230, 12, 114, 156, 65, 115, 113, 235, 60
    };
    ...
    uint64_t golden[] = {
    23, 33, 50, 155, 180, 226, 221, 230, 12, 114, 156, 65, 115, 0, 235, 60
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
