...
int main(){
    ...
    122, 180, 192, 124, 159, 110, 93, 162, 19, 193, 127, 9, 254, 135, 3, 118
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    184, 159, 93, 65, 128, 113, 173, 56, 38, 25, 182, 48, 154, 164, 153, 182
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u32m1_m (mask, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    1, 159, 1, 65, 128, 3, 80, 56, 1, 25, 1, 1, 154, 29, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
