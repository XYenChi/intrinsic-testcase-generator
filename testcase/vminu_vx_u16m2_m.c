...
int main(){
    ...
    240, 76, 185, 12, 94, 139, 72, 211, 126, 93, 205, 176, 53, 15, 151, 222
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    85, 208, 37, 160, 23, 69, 175, 162, 61, 17, 190, 39, 166, 24, 247, 194
    };
    ...
    uint16_t golden[] = {
    240, 0, 1, 160, 0, 139, 175, 211, 126, 0, 0, 176, 166, 24, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
