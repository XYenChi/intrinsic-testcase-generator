...
int main(){
    const int16_t data1[] = {
    124, -7, -18, -91, 122, 110, -49, -78, 63, -71, -100, 101, -25, -104, 54, -103
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -41, 126, 26, -108, -82, 100, 62, 77, -45, 47, 76, -8, -51, -107, 29, -14
    };
    ...
    int16_t golden[] = {
    -41, -7, 26, -108, -82, 100, 62, -78, 63, -71, -100, 101, -51, -107, 54, -14
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
