...
int main(){
    ...
    14, 178, 153, 47, 23, 181, 47, 149, 220, 249, 231, 32, 55, 153, 148, 36
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    17, 44, 131, 236, 7, 97, 89, 149, 65, 228, 155, 18, 249, 131, 117, 227
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u16m4_m (mask, data1_v, data2_v, vl);
