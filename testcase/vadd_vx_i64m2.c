...
int main(){
    const int64_t data1[] = {
    -70, 74, -2, -117, -72, 113, -107, -62, 72, -69, -52, 113, 114, 35, -111, 99
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -80, -71, 53, -30, 56, -121, 113, -30, 78, 80, -93, 104, -66, -38, -67, -31
    };
    ...
    int64_t golden[] = {
    -128, 3, 51, -128, -16, -8, 6, -92, 127, 11, -128, 127, 48, -3, -128, 68
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
