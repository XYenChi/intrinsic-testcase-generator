...
int main(){
    ...
    205, 21, 220, 3, 53, 226, 228, 198, 128, 104, 200, 54, 233, 7, 31, 64
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    194, 242, 95, 11, 58, 3, 179, 228, 248, 200, 185, 195, 93, 198, 76, 129
    };
    ...
    uint64_t golden[] = {
    399, 263, 315, 11, 111, 3, 179, 426, 248, 200, 385, 195, 326, 198, 107, 193
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
