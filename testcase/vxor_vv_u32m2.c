...
int main(){
    ...
    231, 11, 235, 99, 135, 138, 150, 30, 127, 235, 253, 26, 130, 150, 21, 115
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    15, 235, 126, 21, 111, 102, 118, 93, 223, 180, 58, 49, 56, 102, 102, 207
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u32m2 (data1_v, data2_v, vl);
