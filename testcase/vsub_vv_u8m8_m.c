...
int main(){
    const uint8_t data1[] = {
    5, 236, 141, 170, 91, 232, 116, 233, 94, 71, 39, 2, 205, 39, 164, 146
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    214, 224, 15, 44, 112, 220, 73, 251, 176, 213, 32, 247, 197, 248, 206, 232
    };
    ...
    uint8_t golden[] = {
    47, 1, 126, 126, 235, 12, 43, 1, 174, 114, 1, 1, 8, 47, 214, 170
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
