...
int main(){
    const uint8_t data1[] = {
    36, 131, 136, 3, 227, 43, 123, 234, 32, 119, 104, 175, 103, 146, 82, 59
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    113, 52, 147, 186, 69, 175, 132, 9, 110, 64, 185, 111, 171, 207, 116, 104
    };
    ...
    uint8_t golden[] = {
    179, 79, 0, 1, 158, 124, 1, 0, 178, 1, 1, 0, 188, 0, 0, 211
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
