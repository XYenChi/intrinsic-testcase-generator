...
int main(){
    ...
    26, 126, 47, 54, 251, 217, 85, 76, 56, 150, 153, 134, 192, 127, 170, 159
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    103, 45, 117, 215, 105, 221, 212, 143, 172, 118, 189, 98, 77, 8, 49, 203
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsac_vx_u16m1_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    1, 1, 60038, 53926, 39182, 17579, 1, 54668, 1, 1, 36620, 1, 50753, 0, 57206, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
