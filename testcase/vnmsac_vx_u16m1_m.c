...
int main(){
    ...
    72, 190, 185, 37, 191, 176, 68, 166, 166, 4, 154, 157, 23, 24, 72, 174
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    44, 98, 118, 34, 42, 201, 21, 164, 4, 123, 98, 45, 97, 176, 209, 106
    };
    ...
    uint16_t golden[] = {
    62369, 0, 1, 64278, 1, 1, 64108, 38313, 64873, 65044, 50444, 0, 63305, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
