...
int main(){
    const int8_t data1[] = {
    -9, -79, -110, 56, 106, -59, 126, -119, -24, 44, -25, 109, -39, 106, 88, -108
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -62, -8, -1, -9, 45, 37, 76, 84, 119, 24, -66, 13, 63, 116, 86, -84
    };
    const int8_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e8m1(avl);
    const int out_data[] = {
    1, 1, 0, 0, 0, 1, 1, 0, 0, 1, 0, 1, 1, 1, 0, 1
    };
    ...
    int8_t golden[] = {
    185, 169, 255, 56, 45, 234, 202, 137, 119, 44, 231, 109, 217, 106, 86, 148
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
