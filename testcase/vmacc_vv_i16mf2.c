...
int main(){
    const int16_t data1[] = {
    -56, 62, -71, 9, -67, 40, 56, 80, -124, 47, 42, -76, -103, 39, 50, 93
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    111, -15, -4, 75, -92, 82, -70, 82, -93, -26, 87, 44, -98, 33, 74, 21
    };
    ...
    int16_t golden[] = {
    59321, 64606, 285, 675, 6165, 3280, 61617, 6561, 11532, 64314, 3655, 62192, 10094, 1287, 3700, 1954
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
