...
int main(){
    const int16_t data1[] = {
    33, 57, 119, 35, -60, -49, -97, -17, 110, 50, 32, -78, -84, -62, 94, 80
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    104, -75, 114, 39, -53, -115, -48, -54, 77, 72, -7, -13, 78, 41, 39, 0
    };
    ...
    int16_t golden[] = {
    3432, 61262, 13566, 1365, 3180, 5635, 4656, 919, 8471, 3600, 65313, 1014, 58984, 62995, 3666, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
