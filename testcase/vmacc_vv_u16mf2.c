...
int main(){
    ...
    83, 252, 40, 245, 76, 90, 13, 46, 41, 202, 245, 26, 184, 231, 82, 95
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    151, 182, 118, 98, 230, 248, 69, 38, 121, 150, 206, 13, 209, 61, 229, 120
    };
    ...
    uint16_t golden[] = {
    12534, 45865, 4720, 24011, 17480, 22320, 898, 1748, 4962, 30300, 50470, 338, 38456, 14091, 18779, 11401
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
