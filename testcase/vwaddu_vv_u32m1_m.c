...
int main(){
    ...
    199, 203, 71, 66, 138, 33, 174, 110, 131, 8, 221, 136, 66, 33, 123, 50
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    72, 130, 78, 122, 136, 44, 52, 250, 28, 16, 57, 97, 57, 91, 17, 60
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u32m1_m (mask, data1_v, data2_v, vl);
