...
int main(){
    const int32_t data1[] = {
    21, -18, 92, -4, 25, -120, 68, 2, -123, 36, 110, 86, 79, 17, 71, 23
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -128, 61, 115, -26, 70, -125, -66, -96, -96, -33, -20, -34, 1, -35, 34, 101
    };
    ...
    int32_t golden[] = {
    0, 4294967292, 0, 1, 0, 1, 0, 4294967248, 0, 0, 0, 4294967295, 1, 4294967293, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
