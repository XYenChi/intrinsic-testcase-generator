...
int main(){
    ...
    29, 68, 179, 182, 181, 136, 226, 22, 168, 212, 9, 89, 118, 167, 118, 83
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    228, 17, 13, 8, 56, 253, 178, 25, 161, 217, 74, 191, 215, 62, 240, 73
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u32m1_m (mask, data1_v, data2_v, vl);
