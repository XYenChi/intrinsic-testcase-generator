...
int main(){
    const int8_t data1[] = {
    -93, 61, -40, 86, 51, 36, 79, -77, 122, 79, -13, 73, -120, -87, 123, 88
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    25, -31, 100, -5, -39, -111, -81, 73, -86, 47, -70, -96, -33, -40, 89, -94
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_i8m1_m (mask, data1_v, data2_v, vl);
