...
int main(){
    const uint8_t data1[] = {
    176, 177, 77, 17, 200, 28, 155, 212, 244, 89, 51, 184, 39, 127, 138, 122
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    3, 249, 53, 213, 188, 143, 210, 160, 124, 189, 230, 172, 149, 178, 247, 166
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_8m8_b1 (data1_v, data2_v, vl);
