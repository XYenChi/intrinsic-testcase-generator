...
int main(){
    ...
    132, 254, 223, 229, 121, 26, 19, 216, 127, 246, 29, 125, 45, 145, 92, 152
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    142, 68, 106, 55, 218, 24, 21, 254, 166, 106, 104, 115, 80, 199, 51, 57
    };
    ...
    uint32_t golden[] = {
    142, 254, 223, 229, 218, 26, 21, 254, 166, 246, 104, 125, 80, 199, 92, 152
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
