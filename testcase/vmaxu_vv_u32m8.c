...
int main(){
    ...
    20, 255, 45, 118, 31, 53, 225, 162, 3, 113, 194, 155, 162, 14, 1, 148
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    28, 23, 138, 93, 29, 208, 37, 200, 146, 143, 90, 216, 17, 37, 242, 164
    };
    ...
    uint32_t golden[] = {
    28, 255, 138, 118, 31, 208, 225, 200, 146, 143, 194, 216, 162, 37, 242, 164
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
