...
int main(){
    ...
    169, 142, 37, 255, 24, 23, 88, 54, 120, 245, 186, 101, 137, 125, 65, 155
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    121, 174, 252, 156, 167, 19, 128, 59, 158, 230, 32, 142, 94, 96, 144, 119
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vx_u32m2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    20449, 24708, 1, 39781, 0, 0, 11264, 1, 0, 0, 0, 14342, 1, 12000, 9360, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
