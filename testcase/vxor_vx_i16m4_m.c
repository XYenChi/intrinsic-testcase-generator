...
int main(){
    const int16_t data1[] = {
    65, 67, -22, 70, 47, -30, 116, 77, 89, 117, 48, -119, 55, -37, -14, -15
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -13, -64, 77, 41, -119, -29, 32, 8, -123, -125, 111, 31, 18, 96, -105, -40
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_i16m4_m (mask, data1_v, data2_v, vl);
