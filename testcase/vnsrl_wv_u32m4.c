...
int main(){
    ...
    113, 156, 87, 45, 37, 39, 29, 81, 252, 174, 207, 116, 220, 44, 65, 163
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    23, 25, 44, 104, 114, 43, 233, 236, 21, 130, 220, 215, 136, 40, 68, 120
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_32m4 (data1_v, shift, vl);
