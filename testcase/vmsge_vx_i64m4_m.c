...
int main(){
    const int64_t data1[] = {
    -116, 12, -114, 94, 32, 127, -63, 32, -56, 92, 22, -97, 80, 83, 63, 125
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -102, -105, -29, 49, -65, -84, -93, -120, 59, -37, -31, -98, -66, -92, 107, 80
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_64m4_b16_m (mask, data1_v, data2_v, vl);
