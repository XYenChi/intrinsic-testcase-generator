...
int main(){
    ...
    137, 209, 117, 81, 71, 59, 156, 87, 72, 170, 104, 165, 208, 193, 101, 74
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    41, 105, 117, 90, 93, 81, 31, 129, 65, 124, 41, 183, 4, 41, 176, 143
    };
    ...
    uint32_t golden[] = {
    137, 209, 117, 90, 93, 81, 156, 129, 72, 170, 104, 183, 208, 193, 176, 143
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
