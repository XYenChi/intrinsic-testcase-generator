...
int main(){
    ...
    40, 40, 201, 139, 77, 67, 18, 164, 21, 238, 123, 130, 11, 87, 150, 155
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    79, 165, 241, 208, 125, 195, 11, 97, 30, 99, 111, 22, 50, 230, 84, 199
    };
    ...
    uint16_t golden[] = {
    119, 205, 443, 347, 202, 263, 29, 262, 51, 338, 234, 152, 62, 317, 235, 354
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
