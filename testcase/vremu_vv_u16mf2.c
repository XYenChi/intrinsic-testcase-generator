...
int main(){
    ...
    197, 6, 63, 101, 185, 210, 21, 21, 122, 226, 139, 99, 73, 249, 10, 191
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    248, 148, 177, 176, 137, 124, 235, 104, 38, 240, 119, 51, 34, 187, 153, 35
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u16mf2 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    51, 4, 51, 75, 137, 124, 4, 20, 38, 14, 119, 51, 34, 187, 3, 35
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
