...
int main(){
    ...
    213, 179, 100, 150, 160, 193, 204, 123, 157, 241, 30, 212, 189, 237, 146, 68
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    225, 138, 200, 109, 138, 83, 134, 69, 76, 188, 235, 168, 188, 31, 14, 236
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u16m4_m (mask, data1_v, shift, vl);
    ...
    uint16_t golden[] = {
    106, 179, 100, 75, 160, 96, 204, 61, 157, 241, 15, 212, 189, 118, 146, 68
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
