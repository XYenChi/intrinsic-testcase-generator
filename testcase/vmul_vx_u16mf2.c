...
int main(){
    ...
    98, 224, 7, 107, 173, 248, 128, 94, 221, 35, 89, 48, 188, 129, 21, 107
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    219, 49, 146, 188, 161, 9, 55, 95, 143, 116, 226, 237, 112, 171, 243, 173
    };
    ...
    uint16_t golden[] = {
    21462, 10976, 1022, 20116, 27853, 2232, 7040, 8930, 31603, 4060, 20114, 11376, 21056, 22059, 5103, 18511
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
