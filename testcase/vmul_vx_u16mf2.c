...
int main(){
    ...
    2, 149, 249, 34, 78, 247, 153, 173, 204, 3, 42, 73, 13, 156, 204, 10
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    197, 73, 100, 75, 59, 82, 153, 61, 6, 2, 11, 4, 41, 38, 72, 123
    };
    ...
    uint16_t golden[] = {
    394, 10877, 24900, 2550, 4602, 20254, 23409, 10553, 1224, 6, 462, 292, 533, 5928, 14688, 1230
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
