...
int main(){
    const int16_t data1[] = {
    -33, -16, 106, -7, 11, -45, 104, -10, 74, 106, 30, -114, 78, 87, 8, 98
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    62, 22, 4, 38, -36, -3, -75, -100, 4, -56, -106, -77, -80, -113, 104, -109
    };
    ...
    int16_t golden[] = {
    29, 6, 110, 31, 65511, 65488, 29, 65426, 78, 50, 65460, 65345, 65534, 65510, 112, 65525
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
