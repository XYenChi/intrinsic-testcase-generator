...
int main(){
    const int16_t data1[] = {
    -98, 115, -15, -78, 7, -10, -85, 12, 10, -31, -113, 105, -30, 22, -66, 55
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -4, -80, -37, -102, -19, 117, -31, 69, 44, -67, -11, -97, -118, 127, -117, 76
    };
    ...
    int16_t golden[] = {
    65434, 35, 65484, 65356, 65524, 107, 65420, 81, 54, 65438, 65412, 8, 65388, 149, 65353, 131
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
