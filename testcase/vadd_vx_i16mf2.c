...
int main(){
    const int16_t data1[] = {
    72, 2, 29, 94, 5, -126, 115, 3, -25, 67, 64, 91, 78, -116, 12, -109
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -125, 122, -35, -28, -121, 75, -106, 118, 31, 34, -36, -104, -53, -112, 121, -57
    };
    ...
    int16_t golden[] = {
    -53, 124, -6, 66, -116, -51, 9, 121, 6, 101, 28, -13, 25, -128, 127, -128
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
