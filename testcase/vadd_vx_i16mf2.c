...
int main(){
    const int16_t data1[] = {
    -60, -42, -8, 97, -55, -88, 45, 76, -90, 48, 111, 101, 39, 60, 18, 31
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    112, -45, -48, 35, -6, 28, -20, -55, -97, 60, -9, 52, -85, 116, 101, -100
    };
    ...
    int16_t golden[] = {
    52, 65449, 65480, 132, 65475, 65476, 25, 21, 65349, 108, 102, 153, 65490, 176, 119, 65467
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
