...
int main(){
    const uint8_t data1[] = {
    192, 185, 238, 161, 97, 171, 159, 82, 114, 213, 162, 205, 111, 105, 105, 39
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    29, 193, 217, 233, 33, 124, 206, 47, 27, 71, 22, 229, 137, 185, 82, 80
    };
    ...
    uint8_t golden[] = {
    221, 122, 199, 138, 130, 39, 109, 129, 141, 28, 184, 178, 248, 34, 187, 119
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
