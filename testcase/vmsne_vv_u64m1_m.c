...
int main(){
    ...
    177, 244, 30, 157, 10, 2, 228, 204, 21, 46, 162, 104, 14, 153, 89, 116
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    110, 102, 176, 75, 47, 177, 71, 97, 237, 136, 154, 222, 116, 163, 9, 175
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_64m1_b64_m (mask, data1_v, data2_v, vl);
