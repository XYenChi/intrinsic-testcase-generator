...
int main(){
    const int8_t data1[] = {
    -81, 111, -115, 10, -79, 91, -53, 123, -102, 12, 95, -15, -113, 103, 51, -14
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    98, 24, -121, -111, -39, 52, 10, -37, -99, -5, 62, 19, 0, -65, 59, 109
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsra_wv_8mf2_m (mask, data1_v, shift, vl);
