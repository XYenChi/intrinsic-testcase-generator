...
int main(){
    const int16_t data1[] = {
    167, 184, 217, 20, 190, 60, 23, 222, 0, 106, 231, 88, 77, 72, 122, 250
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    160, 90, 250, 163, 93, 34, 88, 179, 175, 73, 127, 36, 72, 198, 133, 96
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vv_ui16m4 (data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    7, 94, 0, 0, 97, 26, 0, 43, 0, 33, 104, 52, 5, 0, 0, 154
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
