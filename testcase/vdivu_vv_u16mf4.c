...
int main(){
    ...
    35, 42, 182, 184, 7, 175, 203, 171, 14, 236, 198, 143, 120, 141, 160, 104
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    227, 117, 85, 164, 126, 139, 139, 197, 182, 234, 167, 14, 180, 62, 163, 66
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i16mf4 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    6, 2, 0, 0, 18, 0, 0, 1, 13, 0, 0, 0, 1, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
