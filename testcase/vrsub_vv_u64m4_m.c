...
int main(){
    ...
    139, 32, 234, 34, 40, 55, 99, 137, 201, 174, 162, 31, 44, 119, 192, 33
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    66, 5, 94, 104, 198, 211, 195, 216, 147, 19, 59, 134, 219, 175, 175, 150
    };
    ...
    uint64_t golden[] = {
    1, 18446744073709551589, 0, 0, 0, 0, 1, 79, 1, 1, 0, 103, 0, 56, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
