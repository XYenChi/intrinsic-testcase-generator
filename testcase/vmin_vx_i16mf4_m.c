...
int main(){
    const int16_t data1[] = {
    -73, 94, -33, 10, 61, -2, -52, 24, 53, -44, -52, -100, -63, 58, 47, 105
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    30, 26, 124, 3, 30, -47, -28, -4, 7, -71, -31, -70, -29, 74, -90, -52
    };
    ...
    uint64_t masked[] = {
    0, 1, 1, 0, 0, 1, 1, 1, 1, 0, 0, 1, 1, 1, 0, 0
    };
    ...
    int16_t golden[] = {
    0, 94, 124, 1, 0, 65534, 65508, 24, 53, 1, 1, 65466, 65507, 74, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
