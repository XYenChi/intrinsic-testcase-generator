...
int main(){
    ...
    155, 132, 13, 99, 147, 52, 63, 162, 170, 254, 176, 132, 145, 133, 96, 182
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    230, 27, 170, 64, 56, 168, 50, 202, 71, 230, 143, 10, 68, 90, 37, 139
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_16m2 (data1_v, shift, vl);
