...
int main(){
    const int64_t data1[] = {
    -22, -11, 47, 106, -49, 6, -117, -5, -106, -113, 60, -5, 37, -24, 117, -45
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    89, -27, -66, -66, -37, -112, 109, -18, -51, 34, -120, 102, 56, -22, -112, -68
    };
    ...
    int64_t golden[] = {
    1, 18446744073709551605, 1, 106, 0, 6, 109, 18446744073709551611, 18446744073709551565, 0, 0, 102, 1, 1, 1, 18446744073709551571
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
