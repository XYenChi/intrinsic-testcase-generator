...
int main(){
    const int64_t data1[] = {
    -48, 117, -28, -93, 27, 10, -25, 48, -128, -97, -63, -71, 37, -123, 29, -21
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -124, -78, -95, 20, -45, 6, 30, 42, -37, 87, -73, 113, -116, -38, -23, -32
    };
    ...
    int64_t golden[] = {
    1, 117, 18446744073709551588, 20, 27, 10, 30, 0, 1, 87, 18446744073709551553, 113, 37, 0, 29, 18446744073709551595
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
