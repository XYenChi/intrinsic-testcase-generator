...
int main(){
    ...
    86, 20, 200, 49, 165, 38, 78, 161, 123, 138, 26, 155, 238, 230, 170, 6
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    83, 36, 126, 112, 194, 195, 12, 101, 49, 86, 183, 225, 29, 241, 17, 54
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u32m1 (data1_v, data2_v, vl);
