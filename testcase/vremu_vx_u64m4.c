...
int main(){
    ...
    241, 243, 222, 94, 19, 250, 177, 216, 77, 51, 65, 195, 181, 174, 147, 224
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    75, 90, 55, 190, 184, 156, 173, 101, 18, 84, 7, 162, 183, 183, 244, 39
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u64m4 (data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    75, 90, 55, 2, 13, 156, 173, 101, 18, 33, 7, 162, 2, 9, 97, 39
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
