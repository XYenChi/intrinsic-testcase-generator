...
int main(){
    ...
    106, 186, 106, 28, 62, 55, 23, 29, 164, 8, 138, 161, 138, 90, 255, 208
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    195, 172, 207, 31, 136, 210, 200, 193, 77, 150, 172, 111, 115, 91, 128, 238
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u64m2_m (mask, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    0, 172, 101, 3, 1, 0, 16, 0, 1, 1, 34, 111, 115, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
