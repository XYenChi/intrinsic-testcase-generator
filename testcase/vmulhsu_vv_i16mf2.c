...
int main(){
    const int16_t data1[] = {
    -90, -83, -110, -59, -26, -78, 66, -125, -91, 109, 103, -47, -20, 104, 82, 119
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    160, 148, 49, 64, 79, 129, 192, 189, 197, 199, 61, 113, 242, 21, 9, 147
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_16mf2_b32 (data1_v, data2_v, vl);
