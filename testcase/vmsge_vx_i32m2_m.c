...
int main(){
    const int32_t data1[] = {
    39, -22, -16, -116, -85, -12, -48, -80, 34, 29, 57, -61, 100, -69, 110, 43
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    50, -107, -72, 0, -49, -96, -124, 70, 36, 68, -113, -14, -99, 78, -114, -119
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_32m2_b16_m (mask, data1_v, data2_v, vl);
