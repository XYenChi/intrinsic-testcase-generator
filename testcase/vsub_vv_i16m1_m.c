...
int main(){
    const int16_t data1[] = {
    -108, -4, 47, -9, -67, 93, -65, 27, -56, -21, -28, -24, 77, 86, -35, -103
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    29, -115, -31, -25, 64, -106, -24, -118, -102, 11, -29, 53, 29, 49, 28, -120
    };
    ...
    uint16_t masked[] = {
    1, 1, 0, 1, 0, 1, 0, 1, 1, 1, 0, 0, 0, 1, 1, 0
    };
    ...
    int16_t golden[] = {
    65399, 111, 1, 16, 1, 199, 0, 145, 46, 65504, 1, 0, 0, 37, 65473, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
