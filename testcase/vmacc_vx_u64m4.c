...
int main(){
    ...
    252, 109, 203, 78, 224, 109, 167, 66, 76, 27, 209, 236, 111, 192, 212, 27
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    67, 58, 243, 173, 191, 254, 94, 35, 97, 62, 255, 255, 80, 63, 61, 197
    };
    ...
    uint64_t golden[] = {
    16885, 6322, 49330, 13494, 42785, 27687, 15698, 2310, 7373, 1674, 53296, 60180, 8880, 12096, 12933, 5319
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
