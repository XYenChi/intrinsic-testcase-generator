...
int main(){
    const uint8_t data1[] = {
    219, 156, 170, 9, 22, 16, 182, 30, 17, 191, 19, 99, 170, 215, 149, 226
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    199, 108, 112, 3, 219, 45, 91, 251, 132, 48, 21, 184, 191, 41, 248, 131
    };
    ...
    uint8_t golden[] = {
    20, 48, 0, 6, 59, 0, 0, 35, 1, 1, 254, 171, 235, 1, 157, 95
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
