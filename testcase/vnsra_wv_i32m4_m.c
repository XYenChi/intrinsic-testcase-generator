...
int main(){
    const int32_t data1[] = {
    -109, 66, 18, 47, 99, 104, -99, -105, 8, -52, 63, -76, -98, 29, 14, -70
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -89, -46, -17, -57, -40, 116, -106, -84, 107, -30, -44, 17, -13, 100, 1, -122
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsra_wv_32m4_m (mask, data1_v, shift, vl);
