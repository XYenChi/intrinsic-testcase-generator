...
int main(){
    ...
    10, 121, 95, 164, 187, 145, 135, 71, 169, 192, 110, 59, 37, 238, 235, 190
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    84, 108, 116, 54, 70, 27, 36, 200, 255, 124, 118, 128, 232, 175, 160, 166
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vv_u32mf2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    1, 1, 1, 8857, 13091, 3915, 0, 1, 1, 1, 0, 7552, 8584, 41650, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
