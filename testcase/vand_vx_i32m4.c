...
int main(){
    const int32_t data1[] = {
    2, -37, -62, 76, -24, -96, -101, 121, 104, -6, -38, 118, 68, -23, 119, 107
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -116, -100, 61, -1, 75, 32, -81, -39, 7, 78, 117, 93, 117, -6, -119, 53
    };
    ...
    int32_t golden[] = {
    4294967180, 4294967196, 61, 4294967295, 75, 32, 4294967215, 4294967257, 7, 78, 117, 93, 117, 4294967290, 4294967177, 53
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
