...
int main(){
    const int32_t data1[] = {
    69, -1, 124, 43, 37, -5, -97, 104, -40, 61, 41, -71, -90, 54, 3, 41
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -63, -122, 12, 16, 97, 116, -85, -40, 99, 18, -72, -12, 46, 30, 126, 53
    };
    ...
    int32_t golden[] = {
    4294967233, 4294967174, 12, 16, 97, 116, 4294967211, 4294967256, 99, 18, 4294967224, 4294967284, 46, 30, 126, 53
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
