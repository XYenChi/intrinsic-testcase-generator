...
int main(){
    const int32_t data1[] = {
    23, 8, -38, 43, -66, -99, -101, -98, -59, 11, -92, 83, 71, -120, 90, -127
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -24, 116, 89, 38, 57, -109, 29, -1, -3, -51, -37, 32, 111, -21, -25, 41
    };
    ...
    int32_t golden[] = {
    4294967249, 0, 127, 1, 0, 4294967286, 1, 1, 0, 0, 55, 4294967245, 40, 1, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
