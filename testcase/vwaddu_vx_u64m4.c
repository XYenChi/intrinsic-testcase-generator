...
int main(){
    ...
    67, 106, 248, 105, 147, 214, 89, 29, 181, 215, 176, 103, 212, 24, 158, 69
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    67, 55, 2, 49, 66, 196, 104, 98, 243, 142, 219, 161, 155, 253, 24, 215
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u64m4 (data1_v, data2_v, vl);
