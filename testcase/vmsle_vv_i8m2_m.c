...
int main(){
    const int8_t data1[] = {
    -23, 81, 51, 112, 100, 44, -19, 109, 39, 72, 59, 67, -107, -125, -98, -58
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    15, 68, -56, 100, -65, -97, 112, 109, -4, 91, 63, -101, 4, -61, 24, -113
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vv_8m2_b4_m (mask, data1_v, data2_v, vl);
