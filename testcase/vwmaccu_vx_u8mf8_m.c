...
int main(){
    const uint8_t data1[] = {
    200, 212, 141, 77, 72, 30, 125, 126, 19, 11, 236, 113, 211, 102, 69, 114
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    195, 57, 58, 38, 107, 252, 83, 147, 3, 17, 215, 71, 45, 182, 13, 146
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vx_u8mf8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    1, 0, 242, 1, 1, 0, 136, 1, 1, 188, 0, 1, 1, 1, 129, 5
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
