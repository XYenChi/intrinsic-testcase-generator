...
int main(){
    ...
    249, 205, 56, 164, 182, 220, 33, 92, 36, 12, 131, 89, 255, 150, 18, 192
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    10, 174, 24, 177, 114, 223, 225, 75, 181, 140, 170, 84, 105, 36, 119, 31
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u64m8 (data1_v, data2_v, vl);
