...
int main(){
    const uint8_t data1[] = {
    61, 39, 74, 210, 60, 121, 141, 248, 243, 100, 95, 210, 122, 215, 23, 21
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    199, 15, 101, 36, 176, 33, 225, 153, 149, 59, 172, 171, 203, 13, 101, 7
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u8m8 (data1_v, shift, vl);
