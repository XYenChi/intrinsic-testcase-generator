...
int main(){
    ...
    9, 141, 169, 94, 212, 194, 56, 134, 182, 97, 57, 126, 247, 215, 106, 203
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    225, 101, 45, 105, 21, 154, 246, 217, 27, 158, 110, 18, 76, 73, 217, 83
    };
    ...
    uint64_t golden[] = {
    2025, 14241, 1, 9870, 1, 29876, 1, 1, 0, 15326, 0, 1, 1, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
