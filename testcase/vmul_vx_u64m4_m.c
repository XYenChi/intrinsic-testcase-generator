...
int main(){
    ...
    67, 206, 221, 101, 117, 83, 98, 131, 80, 148, 25, 72, 59, 75, 172, 103
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    147, 58, 133, 67, 90, 213, 102, 143, 88, 171, 52, 223, 183, 62, 112, 218
    };
    const uint64_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e64m4(avl);
    const uint out_data[] = {
    1, 0, 1, 1, 0, 1, 0, 0, 1, 0, 0, 1, 0, 0, 1, 1
    };
    ...
    uint64_t golden[] = {
    1, 11948, 29393, 1, 10530, 17679, 0, 18733, 1, 25308, 0, 1, 0, 4650, 1, 22454
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
