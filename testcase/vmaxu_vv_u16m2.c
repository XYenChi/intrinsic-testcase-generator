...
int main(){
    ...
    3, 108, 122, 196, 104, 69, 92, 248, 184, 19, 64, 47, 33, 32, 178, 138
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    141, 106, 241, 9, 234, 222, 8, 163, 203, 131, 113, 164, 168, 213, 17, 54
    };
    ...
    uint16_t golden[] = {
    141, 108, 241, 196, 234, 222, 92, 248, 203, 131, 113, 164, 168, 213, 178, 138
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
