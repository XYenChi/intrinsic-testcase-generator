...
int main(){
    ...
    14, 175, 207, 162, 207, 165, 136, 37, 148, 177, 249, 34, 254, 103, 32, 172
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    123, 26, 204, 155, 188, 74, 122, 4, 154, 70, 70, 248, 82, 37, 20, 162
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_16m8 (data1_v, shift, vl);
