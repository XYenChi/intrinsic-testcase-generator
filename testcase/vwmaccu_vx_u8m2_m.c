...
int main(){
    const uint8_t data1[] = {
    7, 145, 41, 156, 174, 94, 226, 128, 64, 108, 18, 199, 41, 153, 30, 36
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    90, 239, 97, 213, 200, 174, 216, 99, 54, 57, 205, 126, 247, 3, 221, 143
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vx_u8m2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    1, 1, 138, 0, 0, 1, 176, 0, 0, 12, 0, 243, 143, 203, 0, 28
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
