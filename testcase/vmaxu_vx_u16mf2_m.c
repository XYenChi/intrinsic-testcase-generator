...
int main(){
    ...
    144, 144, 57, 232, 232, 130, 249, 32, 205, 202, 150, 70, 25, 77, 1, 60
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    206, 174, 154, 107, 153, 135, 9, 187, 38, 93, 141, 161, 19, 207, 3, 153
    };
    ...
    uint16_t golden[] = {
    206, 174, 154, 0, 1, 0, 249, 187, 205, 202, 1, 161, 0, 207, 3, 153
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
