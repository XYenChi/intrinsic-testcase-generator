...
int main(){
    ...
    119, 132, 189, 54, 62, 103, 123, 187, 221, 204, 236, 119, 114, 49, 13, 20
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    113, 82, 180, 163, 118, 84, 10, 244, 201, 126, 87, 202, 203, 118, 247, 116
    };
    ...
    uint16_t golden[] = {
    119, 1, 189, 163, 118, 0, 123, 1, 221, 1, 236, 202, 203, 118, 247, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
