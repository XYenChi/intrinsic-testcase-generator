...
int main(){
    const int32_t data1[] = {
    127, -66, -87, 11, 111, 104, -10, 56, -49, -114, -66, -78, -33, -56, 53, 89
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    81, 107, 18, -56, -44, -85, -106, -53, 34, 5, 125, -122, -69, -125, 123, 62
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vx_32m1_b32 (data1_v, data2_v, vl);
