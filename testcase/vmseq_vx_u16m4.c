...
int main(){
    ...
    52, 172, 94, 164, 13, 36, 222, 129, 195, 140, 213, 183, 40, 222, 0, 240
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    123, 43, 193, 218, 147, 162, 72, 16, 56, 201, 248, 50, 148, 131, 24, 224
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_16m4_b4 (data1_v, data2_v, vl);
