...
int main(){
    const int16_t data1[] = {
    -55, -126, -72, -39, 50, 76, 83, -69, 91, 16, -102, 64, -26, -9, 85, 95
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    26, 109, 30, -24, 1, -11, -50, -105, 32, 49, 87, -109, 41, -14, -8, 94
    };
    ...
    int16_t golden[] = {
    1431, 13734, 1, 64601, 1, 837, 1, 58292, 0, 64753, 0, 0, 1066, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
