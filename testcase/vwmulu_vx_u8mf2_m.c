...
int main(){
    const uint8_t data1[] = {
    41, 111, 66, 116, 251, 180, 162, 188, 193, 183, 34, 244, 195, 186, 9, 224
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    8, 155, 85, 53, 234, 240, 154, 117, 203, 91, 218, 231, 93, 196, 60, 49
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulu_vx_u8mf2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    72, 1, 1, 4, 1, 192, 116, 1, 1, 13, 0, 44, 1, 104, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
