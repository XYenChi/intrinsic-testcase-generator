...
int main(){
    const int64_t data1[] = {
    -29, -57, -127, 115, -58, 89, -50, -41, 96, 94, -102, -86, -20, 38, 116, -90
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -28, 37, 2, -50, -29, 50, 57, -4, -77, 112, -31, -3, -82, 90, 115, 55
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_i64m8_m (mask, data1_v, data2_v, vl);
