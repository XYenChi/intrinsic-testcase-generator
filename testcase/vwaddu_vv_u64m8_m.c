...
int main(){
    ...
    104, 210, 166, 184, 178, 62, 99, 132, 34, 20, 45, 193, 160, 131, 115, 158
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    216, 196, 103, 69, 78, 82, 55, 180, 150, 147, 76, 69, 255, 84, 242, 18
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u64m8_m (mask, data1_v, data2_v, vl);
