...
int main(){
    const int8_t data1[] = {
    121, -127, -18, 6, 102, 13, 90, -76, 113, -61, -41, 37, -39, -117, -75, -98
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    41, 27, -26, -15, 69, 73, 34, -68, -86, -68, -96, 117, -79, -75, -16, -105
    };
    ...
    int8_t golden[] = {
    41, 27, 230, 241, 69, 73, 34, 188, 170, 188, 160, 117, 177, 181, 240, 151
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
