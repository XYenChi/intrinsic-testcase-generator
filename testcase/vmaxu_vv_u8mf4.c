...
int main(){
    const uint8_t data1[] = {
    184, 87, 65, 24, 39, 82, 43, 35, 79, 25, 78, 48, 19, 160, 127, 163
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    100, 202, 98, 40, 43, 200, 44, 105, 129, 167, 133, 4, 68, 245, 102, 35
    };
    ...
    uint8_t golden[] = {
    184, 202, 98, 40, 43, 200, 44, 105, 129, 167, 133, 48, 68, 245, 127, 163
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
