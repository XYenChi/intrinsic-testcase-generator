...
int main(){
    const uint8_t data1[] = {
    124, 196, 174, 133, 101, 191, 128, 63, 33, 182, 254, 154, 239, 137, 11, 15
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    16, 97, 149, 235, 166, 111, 133, 7, 131, 243, 231, 42, 3, 32, 77, 239
    };
    ...
    uint8_t golden[] = {
    124, 196, 174, 235, 166, 191, 133, 63, 131, 243, 254, 154, 239, 137, 77, 239
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
