...
int main(){
    ...
    42, 21, 94, 77, 146, 85, 24, 167, 107, 185, 167, 40, 107, 180, 163, 85
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    216, 157, 84, 37, 202, 36, 140, 156, 59, 140, 160, 202, 245, 217, 206, 209
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmadd_vv_u16m2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    216, 21, 94, 37, 348, 121, 164, 323, 107, 185, 167, 202, 107, 180, 163, 294
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
