...
int main(){
    ...
    125, 210, 55, 96, 60, 161, 33, 135, 131, 1, 44, 241, 9, 192, 249, 187
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    48, 53, 106, 35, 233, 126, 76, 157, 25, 102, 82, 55, 181, 75, 5, 131
    };
    ...
    uint16_t golden[] = {
    173, 53, 106, 96, 293, 126, 33, 157, 131, 1, 126, 241, 9, 192, 5, 318
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
