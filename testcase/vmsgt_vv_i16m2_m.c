...
int main(){
    const int16_t data1[] = {
    26, 60, 42, 8, 126, 18, -106, 89, -37, 125, -112, -107, -103, -30, -46, -105
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -17, 21, 0, 70, 75, -53, -34, 29, 107, 75, -58, -89, 54, 95, -104, -36
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vv_16m2_b8_m (mask, data1_v, data2_v, vl);
