...
int main(){
    ...
    9, 108, 247, 206, 253, 145, 20, 36, 2, 164, 245, 57, 145, 45, 95, 242
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    44, 241, 231, 93, 20, 121, 86, 103, 169, 199, 103, 144, 127, 39, 19, 56
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_vv_u16mf4 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    45, 253, 247, 223, 253, 249, 86, 103, 171, 231, 247, 185, 255, 47, 95, 250
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
