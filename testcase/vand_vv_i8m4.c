...
int main(){
    const int8_t data1[] = {
    105, -74, -23, -125, -76, -75, 98, 50, -126, 118, 92, -14, 66, -116, -57, 0
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    54, 36, 51, -31, -16, -71, 127, 4, 114, 106, -78, -28, -48, 34, -30, -53
    };
    ...
    int8_t golden[] = {
    54, 36, 51, 225, 240, 185, 127, 4, 114, 106, 178, 228, 208, 34, 226, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
