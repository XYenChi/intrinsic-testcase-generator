...
int main(){
    const int8_t data1[] = {
    91, -13, 79, -74, -55, 47, -103, 36, 12, 114, 37, 15, 126, 87, 34, -109
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    107, -51, -25, 54, -80, 68, -71, 72, 74, -22, 95, 82, 0, -116, -75, -46
    };
    ...
    int8_t golden[] = {
    107, 205, 231, 54, 176, 68, 185, 72, 74, 234, 95, 82, 0, 140, 181, 210
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
