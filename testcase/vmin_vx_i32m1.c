...
int main(){
    const int32_t data1[] = {
    -109, 22, 105, 111, -64, -14, 53, -14, 36, -33, 68, 38, 98, 80, -50, -24
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    77, -123, -104, -97, -85, 6, 13, -26, 91, 74, -84, 37, -118, 60, -48, 42
    };
    ...
    int32_t golden[] = {
    77, 22, 105, 111, 4294967232, 6, 53, 4294967282, 91, 74, 68, 38, 98, 80, 4294967248, 42
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
