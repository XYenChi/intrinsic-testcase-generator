...
int main(){
    const int32_t data1[] = {
    79, -90, -77, -2, -53, -95, 44, 83, 81, -41, -114, -105, 19, -26, -34, -39
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    96, 120, 4, -2, -80, -37, -55, -25, 25, 46, 14, 92, 88, 111, -46, -26
    };
    ...
    int32_t golden[] = {
    96, 120, 4, 4294967294, 4294967243, 4294967259, 44, 83, 81, 46, 14, 92, 88, 111, 4294967262, 4294967270
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
