...
int main(){
    ...
    21, 153, 56, 35, 54, 9, 38, 34, 88, 104, 117, 1, 163, 72, 207, 42
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    252, 93, 228, 158, 39, 146, 148, 189, 55, 187, 137, 222, 154, 190, 244, 82
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u16m2 (data1_v, data2_v, vl);
