...
int main(){
    ...
    55, 99, 255, 196, 250, 187, 159, 99, 55, 164, 229, 27, 225, 107, 96, 33
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    174, 160, 14, 22, 190, 155, 70, 164, 213, 173, 205, 176, 58, 245, 172, 58
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_64m1_b64_m (mask, data1_v, data2_v, vl);
