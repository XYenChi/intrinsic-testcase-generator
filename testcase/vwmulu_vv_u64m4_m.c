...
int main(){
    ...
    112, 189, 179, 78, 63, 236, 26, 223, 104, 196, 167, 154, 1, 236, 58, 25
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    90, 86, 193, 162, 210, 180, 194, 253, 129, 38, 61, 230, 226, 114, 91, 106
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulu_vv_u64m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    10080, 16254, 1, 12636, 1, 42480, 5044, 1, 1, 7448, 10187, 35420, 226, 1, 5278, 2650
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
