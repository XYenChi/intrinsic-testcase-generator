...
int main(){
    ...
    79, 58, 169, 163, 146, 251, 99, 56, 92, 251, 232, 36, 71, 126, 232, 27
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    69, 111, 220, 130, 34, 181, 86, 209, 186, 249, 13, 57, 169, 156, 10, 128
    };
    ...
    uint16_t golden[] = {
    5451, 6438, 37180, 21190, 4964, 45431, 8514, 11704, 17112, 62499, 3016, 2052, 11999, 19656, 2320, 3456
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
