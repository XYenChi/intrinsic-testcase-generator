...
int main(){
    const int32_t data1[] = {
    120, 18, 59, -44, 100, -13, 44, -22, -64, -116, -82, 112, 41, -123, -77, -3
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    122, 50, 116, -82, -125, 13, -6, 28, 40, 26, -72, 28, 34, 90, -19, -71
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsra_wv_32m8_m (mask, data1_v, shift, vl);
