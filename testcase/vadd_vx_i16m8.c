...
int main(){
    const int16_t data1[] = {
    96, -108, 20, 50, 103, 118, -96, -110, -87, 110, 54, 67, -79, 73, 50, -57
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    116, 47, 56, -14, -84, -21, -3, -48, -121, -25, 22, -90, 32, -17, -5, -76
    };
    ...
    int16_t golden[] = {
    212, 65475, 76, 36, 19, 97, 65437, 65378, 65328, 85, 76, 65513, 65489, 56, 45, 65403
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
