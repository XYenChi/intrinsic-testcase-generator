...
int main(){
    const int16_t data1[] = {
    16, -52, 119, -88, 81, 102, 39, -126, 84, -68, 1, 8, -104, 104, -43, 81
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    59, -105, 117, -92, 93, 48, 84, 36, 76, 119, -110, 93, 4, -19, -90, -2
    };
    ...
    int16_t golden[] = {
    75, 65379, 236, 65356, 174, 150, 123, 65446, 160, 51, 65427, 101, 65436, 85, 65403, 79
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
