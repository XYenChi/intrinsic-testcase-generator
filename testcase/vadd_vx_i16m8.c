...
int main(){
    const int16_t data1[] = {
    -116, 92, -121, 98, 79, -74, 20, 118, -81, -1, 102, -43, 55, 115, -61, -124
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -20, -112, -127, 64, 54, 7, 97, 15, 95, -42, 43, -91, 15, 76, -29, -52
    };
    ...
    int16_t golden[] = {
    65400, 65516, 65288, 162, 133, 65469, 117, 133, 14, 65493, 145, 65402, 70, 191, 65446, 65360
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
