...
int main(){
    ...
    44, 241, 83, 225, 142, 248, 92, 89, 173, 236, 241, 170, 56, 43, 217, 15
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    125, 190, 159, 8, 143, 225, 31, 121, 187, 156, 192, 157, 166, 46, 62, 214
    };
    ...
    uint32_t golden[] = {
    0, 51, 0, 0, 4294967295, 23, 0, 0, 1, 0, 1, 13, 1, 1, 155, 4294967097
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
