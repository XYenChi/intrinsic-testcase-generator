...
int main(){
    const uint8_t data1[] = {
    220, 215, 191, 241, 208, 218, 1, 219, 78, 159, 67, 118, 135, 234, 73, 254
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    210, 247, 20, 210, 235, 16, 188, 246, 170, 66, 75, 157, 85, 160, 101, 40
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_8mf4_b32 (data1_v, data2_v, vl);
