...
int main(){
    const int32_t data1[] = {
    -36, -38, -103, -28, 12, -27, 46, 46, -76, 36, -20, 114, -73, -91, 122, -56
    };
    const int32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    47, 115, 83, 147, 212, 68, 108, 136, 14, 65, 196, 163, 215, 27, 238, 121
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_32mf2_b64 (mask, data1_v, data2_v, vl);
