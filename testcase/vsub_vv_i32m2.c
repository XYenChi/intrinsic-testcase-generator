...
int main(){
    const int32_t data1[] = {
    12, 42, 115, -75, -121, -19, -22, 113, 77, 38, 105, 74, -4, -43, -39, -71
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    47, -121, 118, -3, 25, -62, 84, 120, 18, -109, 39, -38, 88, 79, -33, 74
    };
    ...
    int32_t golden[] = {
    4294967261, 163, 4294967293, 4294967224, 4294967150, 43, 4294967190, 4294967289, 59, 147, 66, 112, 4294967204, 4294967174, 4294967290, 4294967151
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
