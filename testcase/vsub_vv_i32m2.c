...
int main(){
    const int32_t data1[] = {
    4, 51, -20, 18, -22, -10, 66, -20, 100, -121, -22, 75, -21, 63, -39, 12
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -76, -113, 112, -109, 101, -41, 48, 40, -62, -108, -80, 85, -61, -31, 30, -36
    };
    ...
    int32_t golden[] = {
    80, 164, 4294967164, 127, 4294967173, 31, 18, 4294967236, 162, 4294967283, 58, 4294967286, 40, 94, 4294967227, 48
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
