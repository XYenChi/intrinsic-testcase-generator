...
int main(){
    const int16_t data1[] = {
    97, -20, 104, -22, 51, 118, -111, 88, 93, -122, -100, 102, 59, 78, 39, -1
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -15, -37, 1, -127, -115, -100, 82, -128, -32, -87, 75, -38, -66, -86, -113, 116
    };
    ...
    int16_t golden[] = {
    1, 1, 1, 1, 0, 65535, 1, 1, 0, 0, 65535, 65535, 1, 65534, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
