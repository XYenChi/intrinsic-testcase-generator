...
int main(){
    const int32_t data1[] = {
    -73, -74, 42, 88, -93, 42, -36, 126, -32, 111, 37, 123, 17, 53, 6, -13
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    47, -72, 90, -95, 23, -45, -103, 0, 71, -100, -7, -20, 120, 29, -64, 40
    };
    ...
    int32_t golden[] = {
    47, 4294967224, 90, 88, 23, 42, 4294967260, 126, 71, 111, 37, 123, 120, 53, 6, 40
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
