...
int main(){
    const int32_t data1[] = {
    29, -44, 109, 89, 84, -93, -20, 119, -72, -64, -38, 67, 72, 27, 79, 29
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    83, 37, 21, -104, -101, -126, -58, 71, -78, 90, -22, -50, 34, 104, -100, 81
    };
    ...
    int32_t golden[] = {
    83, 37, 109, 89, 84, 4294967203, 4294967276, 119, 4294967224, 90, 4294967274, 67, 72, 104, 79, 81
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
