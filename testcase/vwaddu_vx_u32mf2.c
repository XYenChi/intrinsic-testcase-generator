...
int main(){
    ...
    185, 163, 235, 202, 199, 41, 151, 134, 198, 159, 14, 34, 201, 141, 235, 154
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    205, 119, 45, 158, 103, 230, 225, 10, 2, 215, 164, 155, 223, 93, 61, 75
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u32mf2 (data1_v, data2_v, vl);
