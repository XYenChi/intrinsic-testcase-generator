...
int main(){
    ...
    160, 70, 252, 103, 185, 65, 19, 196, 165, 172, 68, 108, 151, 103, 46, 133
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    90, 26, 201, 86, 220, 160, 121, 4, 221, 136, 145, 146, 45, 139, 66, 158
    };
    ...
    uint32_t golden[] = {
    250, 96, 453, 189, 405, 225, 140, 200, 386, 308, 213, 254, 196, 242, 112, 291
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
