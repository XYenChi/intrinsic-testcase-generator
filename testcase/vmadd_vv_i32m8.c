...
int main(){
    const int32_t data1[] = {
    -45, 91, -67, 63, -82, -92, -14, -12, 61, -26, 38, 61, -88, -95, 64, 86
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -120, -120, 122, -34, 6, 28, 60, 35, 32, 108, 10, 94, -125, 106, -88, 127
    };
    ...
    int32_t golden[] = {
    4294967131, 4294967176, 122, 29, 6, 28, 46, 23, 93, 82, 10, 94, 4294967171, 106, 4294967208, 213
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
