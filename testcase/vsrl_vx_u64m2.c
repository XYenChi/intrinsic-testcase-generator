...
int main(){
    ...
    177, 131, 161, 218, 32, 88, 117, 186, 6, 221, 239, 127, 131, 116, 153, 53
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    235, 119, 238, 203, 68, 98, 17, 223, 148, 11, 62, 76, 149, 70, 76, 85
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u64m2 (data1_v, shift, vl);
