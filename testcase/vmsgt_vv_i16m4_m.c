...
int main(){
    const int16_t data1[] = {
    -104, 66, -99, -41, 113, 127, -4, 9, -14, -41, 122, 84, -19, 61, -103, -81
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    116, -91, 54, -57, 127, 54, -73, 21, 27, -111, 79, -123, -110, -102, -2, 82
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vv_16m4_b4_m (mask, data1_v, data2_v, vl);
