...
int main(){
    const int8_t data1[] = {
    -49, -111, -112, -10, -67, -12, 53, -15, -66, 78, -31, -94, 99, 123, 18, -81
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    127, 57, 242, 221, 84, 191, 74, 8, 242, 131, 235, 100, 62, 191, 67, 67
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_8m8_b1 (data1_v, data2_v, vl);
