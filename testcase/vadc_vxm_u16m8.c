...
int main(){
    ...
    13, 26, 182, 8, 197, 229, 247, 76, 220, 86, 44, 237, 166, 139, 197, 35
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    243, 176, 149, 150, 114, 110, 107, 69, 86, 171, 16, 114, 247, 223, 61, 28
    };
    ...
    uint16_t golden[] = {
    257, 203, 332, 158, 312, 340, 355, 145, 306, 258, 60, 352, 413, 363, 259, 64
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
