...
int main(){
    ...
    229, 46, 21, 104, 51, 196, 234, 74, 61, 70, 104, 242, 182, 209, 37, 251
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    49, 19, 253, 8, 204, 53, 80, 210, 32, 78, 127, 192, 161, 204, 54, 235
    };
    ...
    uint16_t golden[] = {
    229, 46, 253, 104, 204, 196, 234, 210, 61, 78, 127, 242, 182, 209, 54, 251
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
