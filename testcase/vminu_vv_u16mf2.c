...
int main(){
    ...
    77, 200, 131, 17, 48, 217, 121, 40, 62, 214, 143, 23, 111, 245, 177, 15
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    134, 33, 14, 38, 212, 156, 250, 109, 248, 183, 146, 143, 199, 227, 35, 176
    };
    ...
    uint16_t golden[] = {
    134, 200, 131, 38, 212, 217, 250, 109, 248, 214, 146, 143, 199, 245, 177, 176
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
