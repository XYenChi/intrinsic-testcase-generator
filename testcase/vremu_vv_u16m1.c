...
int main(){
    ...
    84, 196, 184, 69, 32, 243, 216, 29, 44, 101, 247, 181, 93, 136, 222, 244
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    109, 35, 217, 67, 104, 128, 182, 208, 115, 159, 97, 1, 85, 235, 126, 219
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u16m1 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    25, 35, 33, 67, 8, 128, 182, 5, 27, 58, 97, 1, 85, 99, 126, 219
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
