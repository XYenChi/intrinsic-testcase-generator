...
int main(){
    ...
    26, 80, 140, 171, 179, 12, 214, 75, 59, 110, 58, 2, 214, 126, 69, 105
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    54, 16, 7, 223, 54, 88, 172, 225, 224, 200, 49, 242, 56, 238, 124, 18
    };
    ...
    uint32_t golden[] = {
    26, 96, 140, 171, 233, 12, 386, 225, 224, 200, 58, 2, 214, 238, 124, 105
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
