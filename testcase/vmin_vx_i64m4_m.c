...
int main(){
    const int64_t data1[] = {
    7, -32, 53, 127, -24, -124, 15, 52, 57, -18, 88, 39, 9, -120, -87, -125
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    69, -57, -71, -51, 99, 7, 98, -46, -36, -116, -78, -3, 15, -44, -33, 66
    };
    ...
    int64_t golden[] = {
    69, 18446744073709551584, 0, 127, 99, 0, 0, 0, 57, 1, 1, 0, 1, 0, 0, 66
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
