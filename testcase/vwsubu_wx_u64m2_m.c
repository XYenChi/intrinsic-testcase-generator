...
int main(){
    ...
    223, 154, 45, 11, 199, 205, 177, 102, 211, 66, 44, 160, 149, 240, 170, 186
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    252, 188, 218, 172, 89, 5, 99, 3, 43, 17, 133, 173, 25, 13, 47, 54
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u64m2_m (mask, data1_v, data2_v, vl);
