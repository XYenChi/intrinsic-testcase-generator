...
int main(){
    const uint8_t data1[] = {
    14, 162, 30, 32, 33, 102, 63, 182, 12, 26, 216, 69, 103, 198, 92, 241
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    103, 72, 205, 247, 60, 59, 218, 152, 166, 115, 107, 54, 187, 202, 106, 51
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_8mf4_b32_m (mask, data1_v, data2_v, vl);
