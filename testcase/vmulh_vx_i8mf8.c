...
int main(){
    const int8_t data1[] = {
    24, -119, 7, 125, 85, 43, 49, -31, -97, -94, 71, 90, -22, -119, 108, 102
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -18, -101, -26, 53, -43, 109, 89, 57, -14, 90, 76, -127, -58, 82, -77, -42
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vx_8mf8_b64 (data1_v, data2_v, vl);
