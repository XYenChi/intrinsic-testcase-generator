...
int main(){
    ...
    110, 121, 227, 160, 172, 66, 69, 246, 70, 71, 160, 134, 26, 241, 105, 93
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    142, 78, 200, 56, 203, 203, 224, 224, 53, 180, 160, 111, 163, 67, 176, 22
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_16mf2_b32 (data1_v, data2_v, vl);
