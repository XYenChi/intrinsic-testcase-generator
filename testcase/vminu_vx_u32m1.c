...
int main(){
    ...
    168, 3, 237, 198, 105, 239, 213, 60, 148, 209, 142, 45, 39, 232, 28, 50
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    37, 235, 58, 24, 144, 29, 21, 43, 229, 219, 245, 54, 221, 115, 87, 244
    };
    ...
    uint32_t golden[] = {
    168, 235, 237, 198, 144, 239, 213, 60, 229, 219, 245, 54, 221, 232, 87, 244
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
