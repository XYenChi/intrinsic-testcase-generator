...
int main(){
    ...
    170, 92, 240, 30, 142, 250, 227, 197, 11, 2, 42, 39, 165, 32, 25, 0
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    94, 228, 29, 201, 236, 5, 252, 227, 5, 232, 181, 190, 141, 103, 82, 91
    };
    ...
    uint32_t golden[] = {
    170, 228, 240, 201, 236, 250, 252, 227, 11, 232, 181, 190, 165, 103, 82, 91
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
