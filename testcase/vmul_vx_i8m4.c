...
int main(){
    const int8_t data1[] = {
    -110, -120, 99, 85, 37, -25, 80, 25, -60, -96, 70, 115, -69, 54, 74, 93
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    52, 20, 65, -65, -114, 41, -54, 96, -11, 1, -66, 93, -34, 27, -126, -32
    };
    ...
    int8_t golden[] = {
    168, 160, 35, 107, 134, 255, 32, 96, 148, 160, 244, 199, 42, 178, 148, 96
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
