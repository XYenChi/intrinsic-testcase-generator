...
int main(){
    const int8_t data1[] = {
    20, -127, 69, -46, 118, 98, 11, 26, 53, 40, -55, -119, 35, -108, -59, -25
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -26, -116, -96, 124, 24, 51, -76, -79, -53, 79, -113, 100, 54, 58, 16, 102
    };
    ...
    int8_t golden[] = {
    248, 140, 32, 184, 16, 134, 188, 250, 7, 88, 71, 132, 98, 136, 80, 10
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
