...
int main(){
    const int8_t data1[] = {
    228, 227, 243, 101, 182, 241, 83, 224, 90, 217, 71, 91, 195, 35, 122, 57
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    222, 153, 134, 222, 151, 85, 3, 35, 165, 74, 221, 68, 154, 72, 65, 122
    };
    ...
    int8_t golden[] = {
    50616, 34731, 32562, 22422, 27482, 20485, 249, 7840, 14850, 16058, 15691, 6188, 30030, 2520, 7930, 6954
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
