...
int main(){
    ...
    163, 139, 117, 9, 4, 100, 221, 149, 208, 75, 235, 140, 63, 20, 129, 110
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    151, 209, 59, 111, 103, 175, 4, 197, 41, 112, 51, 181, 0, 191, 125, 26
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_16m1_m (mask, data1_v, shift, vl);
