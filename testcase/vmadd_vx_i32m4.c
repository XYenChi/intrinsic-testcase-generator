...
int main(){
    const int32_t data1[] = {
    84, -88, -45, -99, 36, 89, 42, 51, 76, -20, 10, 114, 34, 23, 20, -110
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -8, -128, 41, 6, -112, 29, -36, 96, -22, -85, 12, 53, -105, 74, -60, -98
    };
    ...
    int32_t golden[] = {
    4294967288, 4294967080, 4294967292, 4294967203, 4294967184, 29, 6, 147, 4294967274, 4294967211, 22, 53, 4294967191, 97, 4294967236, 4294967088
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
