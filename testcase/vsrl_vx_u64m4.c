...
int main(){
    ...
    117, 165, 87, 126, 88, 210, 226, 223, 101, 154, 83, 193, 112, 175, 210, 109
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    157, 73, 61, 162, 87, 140, 59, 223, 21, 18, 50, 100, 85, 81, 169, 209
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u64m4 (data1_v, shift, vl);
