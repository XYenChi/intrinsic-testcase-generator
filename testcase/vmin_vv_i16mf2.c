...
int main(){
    const int16_t data1[] = {
    -118, 32, -69, 51, -25, -15, -124, -71, -30, -57, 0, -124, 100, -101, 56, 65
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    88, 20, 15, -91, -114, -19, 62, 118, 127, 112, 70, -80, 1, 99, 41, -96
    };
    ...
    int16_t golden[] = {
    88, 32, 15, 51, 65511, 65521, 62, 118, 127, 112, 70, 65456, 100, 99, 56, 65
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
