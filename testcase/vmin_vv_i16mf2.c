...
int main(){
    const int16_t data1[] = {
    39, 127, -117, 68, 54, 124, 100, 113, 96, 65, 31, -50, -114, -106, -28, -17
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    99, -75, -84, -21, 101, 71, 34, 2, -43, -80, -70, -44, 30, -60, 36, -14
    };
    ...
    int16_t golden[] = {
    99, 127, 65452, 68, 101, 124, 100, 113, 96, 65, 31, 65492, 30, 65476, 36, 65522
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
