...
int main(){
    const uint8_t data1[] = {
    191, 230, 85, 197, 42, 67, 238, 18, 132, 195, 197, 92, 118, 94, 8, 236
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    174, 181, 33, 128, 86, 92, 181, 141, 111, 168, 222, 179, 110, 238, 160, 182
    };
    ...
    uint8_t golden[] = {
    174, 181, 0, 0, 0, 0, 181, 0, 111, 0, 1, 0, 0, 238, 160, 182
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
