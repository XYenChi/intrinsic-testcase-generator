...
int main(){
    const int32_t data1[] = {
    -5, -57, 85, -4, -96, 91, 67, 79, -77, -61, 91, -73, -122, 85, 13, -109
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -62, -33, 57, -69, 76, -34, 107, 122, 94, 87, -19, 50, -58, -67, 65, -75
    };
    ...
    int32_t golden[] = {
    57, 0, 28, 1, 4294967124, 125, 0, 1, 4294967125, 0, 1, 4294967173, 4294967232, 0, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
