...
int main(){
    const int32_t data1[] = {
    -63, -113, 29, 27, 112, 85, -3, 31, 41, 68, -65, -40, 106, 10, -20, 37
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -57, 29, 68, 66, 106, 78, 58, 69, -14, 65, 96, -15, 71, -44, 77, 3
    };
    ...
    int32_t golden[] = {
    4294967290, 1, 0, 4294967257, 6, 1, 1, 1, 1, 3, 4294967135, 4294967271, 1, 54, 4294967199, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
