...
int main(){
    const int64_t data1[] = {
    72, -80, 20, -12, 110, 50, -43, -20, -58, 40, -101, 62, 53, 114, 82, 21
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    60, -35, 88, 51, 73, -44, 98, -47, 83, 123, 36, -82, -103, 20, 38, 26
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vv_64m1_b64 (mask, data1_v, data2_v, vl);
