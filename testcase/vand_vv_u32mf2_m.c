...
int main(){
    ...
    168, 147, 187, 97, 149, 212, 154, 135, 130, 133, 98, 19, 86, 146, 141, 130
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    100, 188, 56, 40, 20, 244, 51, 240, 4, 30, 255, 10, 180, 134, 126, 90
    };
    ...
    uint32_t golden[] = {
    100, 0, 1, 40, 0, 244, 0, 240, 0, 1, 255, 10, 0, 1, 126, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
