...
int main(){
    ...
    164, 98, 248, 184, 55, 34, 216, 91, 241, 0, 155, 186, 240, 104, 186, 43
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    181, 79, 167, 194, 130, 80, 199, 204, 253, 110, 186, 113, 181, 240, 84, 52
    };
    ...
    uint32_t golden[] = {
    0, 79, 167, 194, 1, 80, 199, 1, 253, 0, 0, 113, 0, 1, 84, 52
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
