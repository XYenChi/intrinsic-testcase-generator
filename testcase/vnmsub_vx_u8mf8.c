...
int main(){
    const uint8_t data1[] = {
    209, 226, 32, 153, 102, 232, 134, 175, 44, 218, 112, 253, 15, 133, 114, 37
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    193, 50, 13, 37, 254, 218, 30, 216, 56, 245, 104, 59, 123, 81, 169, 186
    };
    ...
    uint8_t golden[] = {
    16, 176, 32, 116, 104, 232, 104, 175, 44, 229, 112, 194, 148, 52, 201, 37
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
