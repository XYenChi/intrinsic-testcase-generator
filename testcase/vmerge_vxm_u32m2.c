...
int main(){
    ...
    159, 230, 43, 65, 165, 147, 132, 201, 193, 85, 166, 233, 45, 37, 180, 210
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    148, 220, 141, 121, 253, 247, 227, 24, 126, 51, 45, 12, 121, 20, 208, 61
    };
    ...
    uint32_t golden[] = {
    159, 230, 43, 121, 165, 147, 227, 24, 126, 51, 45, 233, 121, 20, 208, 61
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
