...
int main(){
    ...
    18, 240, 83, 63, 34, 101, 25, 196, 69, 30, 255, 188, 205, 57, 143, 241
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    255, 175, 151, 236, 213, 71, 234, 121, 167, 242, 170, 50, 212, 238, 13, 34
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i16mf2 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    14, 0, 1, 3, 6, 0, 9, 0, 2, 8, 0, 0, 1, 4, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
