...
int main(){
    const int16_t data1[] = {
    17, -37, 124, 36, -81, 35, 98, -17, 57, -99, 45, -116, 87, 64, 0, 125
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    75, 68, 18, -30, -60, 69, -57, 86, -29, -117, -20, 37, 79, 90, -125, 81
    };
    ...
    int16_t golden[] = {
    -58, -105, 106, 66, -21, -34, 127, -103, 86, 18, 65, -128, 8, -26, 125, 44
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
