...
int main(){
    const int8_t data1[] = {
    -82, 13, 104, -94, 34, 31, 72, 67, -96, -25, 110, 89, -126, 115, -37, -28
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -71, 121, -94, -119, -56, 6, 9, -21, -25, -42, 38, 44, 92, -110, 90, 31
    };
    ...
    int8_t golden[] = {
    0, 37, 208, 178, 144, 1, 136, 129, 1, 26, 1, 76, 184, 150, 254, 156
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
