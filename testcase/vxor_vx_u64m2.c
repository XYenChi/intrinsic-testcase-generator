...
int main(){
    ...
    49, 56, 55, 35, 46, 40, 57, 46, 238, 255, 128, 229, 32, 128, 205, 232
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    58, 103, 128, 173, 164, 152, 29, 48, 134, 58, 144, 24, 63, 201, 115, 20
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u64m2 (data1_v, data2_v, vl);
