...
int main(){
    const int16_t data1[] = {
    27, -74, -32, -21, -20, -103, 123, -79, -30, 62, 102, -12, 45, 36, -92, -71
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    42, 98, -26, -56, -24, -7, 42, -3, 67, 66, 14, -113, -52, -1, -68, -102
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccsu_vv_i16m2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    0, 58285, 833, 0, 0, 0, 0, 1, 63527, 4093, 0, 0, 63197, 65500, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
