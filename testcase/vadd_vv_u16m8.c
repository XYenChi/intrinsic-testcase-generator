...
int main(){
    ...
    247, 105, 226, 95, 9, 208, 177, 111, 67, 51, 249, 201, 196, 104, 118, 25
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    134, 168, 200, 73, 16, 200, 116, 202, 136, 195, 51, 104, 9, 99, 83, 101
    };
    ...
    uint16_t golden[] = {
    381, 273, 426, 168, 25, 408, 293, 313, 203, 246, 300, 305, 205, 203, 201, 126
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
