...
int main(){
    ...
    108, 107, 225, 71, 213, 28, 157, 236, 68, 220, 64, 106, 18, 153, 113, 6
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    134, 228, 25, 205, 157, 6, 139, 9, 108, 168, 94, 46, 200, 126, 87, 182
    };
    ...
    uint64_t golden[] = {
    108, 107, 25, 276, 157, 28, 296, 236, 108, 388, 94, 106, 18, 153, 113, 6
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
