...
int main(){
    ...
    68, 142, 44, 52, 241, 50, 101, 232, 207, 0, 48, 179, 195, 136, 191, 243
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    224, 216, 179, 110, 158, 172, 253, 74, 54, 246, 51, 211, 221, 52, 215, 90
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmadd_vv_u64m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    224, 142, 223, 162, 158, 50, 253, 74, 54, 0, 48, 179, 195, 188, 191, 333
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
