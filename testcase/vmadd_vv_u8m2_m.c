...
int main(){
    const uint8_t data1[] = {
    63, 67, 107, 168, 34, 8, 153, 33, 149, 5, 134, 156, 7, 99, 53, 115
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    225, 228, 64, 64, 1, 8, 205, 131, 42, 74, 42, 155, 204, 241, 207, 119
    };
    ...
    uint8_t golden[] = {
    63, 228, 107, 168, 34, 8, 153, 33, 149, 79, 176, 156, 204, 99, 4, 119
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
