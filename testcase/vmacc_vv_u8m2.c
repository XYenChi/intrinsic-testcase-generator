...
int main(){
    const uint8_t data1[] = {
    193, 140, 248, 83, 70, 12, 74, 49, 185, 82, 244, 78, 183, 22, 241, 35
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    51, 250, 122, 128, 33, 109, 65, 122, 146, 43, 177, 46, 129, 7, 172, 75
    };
    ...
    uint8_t golden[] = {
    115, 184, 48, 128, 6, 29, 203, 90, 130, 198, 180, 5, 55, 155, 236, 66
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
