...
int main(){
    const int32_t data1[] = {
    -126, -125, 76, -7, -75, -97, 7, 46, 78, -50, 30, 44, -31, -89, -80, -84
    };
    const int32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    92, -16, 127, 74, -116, -64, 85, 69, 45, -35, 121, -59, 21, 66, 38, 77
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulsu_vx_i32m8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int32_t golden[] = {
    1, 2000, 9652, 4294966778, 0, 0, 1, 1, 1, 1, 1, 4294964700, 0, 4294961422, 4294964256, 4294960828
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
