...
int main(){
    const uint8_t data1[] = {
    89, 247, 94, 229, 9, 141, 104, 162, 76, 124, 205, 64, 224, 2, 143, 192
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    201, 48, 76, 153, 99, 17, 95, 95, 194, 43, 12, 72, 246, 50, 59, 134
    };
    ...
    uint8_t golden[] = {
    201, 247, 94, 1, 99, 1, 104, 0, 1, 124, 205, 1, 0, 50, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
