...
int main(){
    const uint8_t data1[] = {
    178, 36, 134, 188, 15, 92, 188, 11, 159, 34, 166, 216, 194, 253, 60, 220
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    122, 134, 66, 199, 249, 219, 2, 58, 196, 98, 106, 26, 21, 32, 11, 127
    };
    const uint8_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e8mf2(avl);
    const uint out_data[] = {
    0, 1, 1, 1, 1, 0, 0, 0, 1, 1, 0, 0, 0, 0, 1, 0
    };
    ...
    uint8_t golden[] = {
    0, 1, 1, 199, 249, 219, 188, 58, 196, 1, 166, 0, 194, 253, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
