...
int main(){
    ...
    58, 216, 50, 231, 175, 228, 11, 23, 209, 216, 20, 169, 255, 209, 65, 72
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    4, 138, 188, 148, 41, 71, 220, 243, 247, 235, 173, 7, 171, 116, 169, 206
    };
    ...
    uint16_t golden[] = {
    54, 78, 65398, 83, 134, 157, 65327, 65316, 65498, 65517, 65383, 162, 84, 93, 65432, 65402
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
