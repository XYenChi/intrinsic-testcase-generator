...
int main(){
    ...
    67, 159, 136, 219, 242, 231, 12, 97, 75, 103, 125, 72, 219, 240, 193, 194
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    73, 202, 72, 61, 224, 158, 15, 252, 131, 184, 162, 72, 253, 1, 32, 40
    };
    ...
    uint16_t golden[] = {
    65530, 65493, 64, 158, 18, 73, 65533, 65381, 65480, 65455, 65499, 0, 65502, 239, 161, 154
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
