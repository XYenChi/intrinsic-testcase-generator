...
int main(){
    ...
    195, 135, 66, 36, 33, 243, 72, 63, 9, 19, 50, 187, 102, 154, 213, 16
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    110, 131, 58, 122, 118, 247, 18, 110, 190, 46, 76, 165, 83, 154, 80, 60
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wx_16mf4u_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    239, 135, 122, 0, 1, 247, 90, 0, 191, 63, 1, 191, 119, 0, 213, 60
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
