...
int main(){
    const int8_t data1[] = {
    69, -64, -111, -97, -79, -94, 104, 89, 46, -4, -121, -90, -99, -81, -33, 45
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -118, -1, -41, 5, -123, 17, -49, 114, -123, 113, -61, 69, -102, -111, 66, 33
    };
    ...
    int8_t golden[] = {
    50, 64, 200, 27, 246, 195, 24, 163, 230, 61, 214, 191, 115, 31, 127, 205
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
