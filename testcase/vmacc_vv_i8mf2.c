...
int main(){
    const int8_t data1[] = {
    59, 126, -103, 49, 101, 94, 80, 122, 1, 82, 96, 37, 60, 74, 60, 56
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    43, -86, -34, -125, 86, -127, -6, -81, -15, -71, 53, -113, -51, 38, -93, 75
    };
    ...
    int8_t golden[] = {
    234, 173, 174, 20, 238, 95, 33, 103, 241, 66, 225, 172, 12, 252, 53, 105
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
