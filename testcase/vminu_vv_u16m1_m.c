...
int main(){
    ...
    188, 79, 71, 205, 195, 69, 57, 171, 53, 196, 181, 121, 52, 103, 183, 174
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    253, 234, 218, 197, 115, 9, 123, 169, 208, 165, 218, 238, 167, 244, 146, 186
    };
    ...
    uint16_t golden[] = {
    253, 1, 1, 1, 195, 1, 123, 171, 208, 196, 218, 0, 1, 244, 183, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
