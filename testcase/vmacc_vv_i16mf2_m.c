...
int main(){
    const int16_t data1[] = {
    5, 86, 13, -56, -120, 16, 78, -25, 49, -41, -5, 54, -82, 36, 10, 65
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    119, 21, -96, -39, 41, 119, -16, -12, -96, -73, -52, -80, 115, -58, -41, -97
    };
    ...
    int16_t golden[] = {
    596, 1, 1, 2185, 60617, 0, 64289, 301, 60833, 2993, 261, 0, 56107, 63448, 65126, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
