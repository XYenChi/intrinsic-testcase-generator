...
int main(){
    ...
    130, 138, 226, 150, 121, 47, 93, 137, 107, 91, 222, 205, 255, 87, 58, 147
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    251, 182, 72, 199, 9, 231, 73, 105, 193, 73, 39, 155, 144, 75, 170, 157
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i32m4 (data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    1, 1, 0, 1, 0, 4, 0, 0, 1, 0, 0, 0, 0, 0, 2, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
