...
int main(){
    ...
    238, 171, 59, 58, 148, 132, 40, 179, 18, 100, 197, 229, 160, 107, 116, 58
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    148, 160, 130, 54, 9, 48, 176, 194, 249, 94, 52, 57, 198, 91, 74, 218
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_32mf2_b64_m (mask, data1_v, data2_v, vl);
