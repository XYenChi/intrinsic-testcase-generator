...
int main(){
    ...
    20, 51, 116, 150, 122, 195, 132, 66, 249, 10, 19, 0, 215, 210, 80, 216
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    98, 4, 196, 133, 199, 133, 195, 39, 146, 202, 169, 90, 88, 125, 140, 48
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_16mf2_b32 (data1_v, data2_v, vl);
