...
int main(){
    ...
    64, 176, 147, 95, 182, 36, 60, 7, 73, 147, 50, 224, 228, 134, 40, 110
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    28, 25, 89, 34, 166, 171, 239, 89, 233, 189, 8, 206, 72, 156, 59, 28
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u64m8_m (mask, data1_v, data2_v, vl);
