...
int main(){
    ...
    128, 174, 181, 20, 158, 22, 231, 16, 0, 251, 211, 237, 131, 235, 188, 253
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    149, 130, 129, 11, 98, 8, 23, 239, 247, 121, 208, 78, 216, 158, 144, 237
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wx_64m8u_m (mask, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    149, 174, 181, 1, 0, 0, 1, 1, 247, 0, 211, 0, 0, 1, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
