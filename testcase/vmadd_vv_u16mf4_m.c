...
int main(){
    ...
    199, 90, 214, 143, 14, 34, 54, 58, 69, 220, 33, 94, 244, 54, 116, 187
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    52, 41, 62, 150, 53, 153, 238, 42, 181, 107, 97, 25, 173, 148, 16, 131
    };
    ...
    uint16_t golden[] = {
    199, 41, 62, 293, 14, 187, 238, 42, 181, 220, 33, 25, 417, 54, 16, 187
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
