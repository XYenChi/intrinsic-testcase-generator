...
int main(){
    const uint8_t data1[] = {
    114, 27, 216, 177, 212, 120, 251, 125, 83, 40, 25, 161, 90, 21, 19, 82
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    198, 131, 14, 128, 48, 9, 233, 151, 228, 197, 144, 55, 34, 100, 54, 222
    };
    ...
    uint8_t golden[] = {
    198, 131, 216, 177, 212, 120, 251, 151, 228, 197, 144, 161, 90, 100, 54, 222
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
