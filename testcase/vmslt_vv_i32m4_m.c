...
int main(){
    const int32_t data1[] = {
    -66, -74, -79, -115, 52, -125, -36, 22, 107, 55, -101, 32, 36, 52, -27, -85
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -102, 42, -77, 127, -67, -85, 127, -123, 16, 16, -117, 61, 107, -122, -92, -107
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vv_32m4_b8_m (mask, data1_v, data2_v, vl);
