...
int main(){
    ...
    81, 86, 232, 6, 213, 183, 144, 168, 50, 136, 18, 168, 140, 156, 211, 161
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    6, 217, 241, 78, 26, 241, 248, 97, 170, 87, 223, 143, 48, 121, 20, 217
    };
    ...
    uint32_t golden[] = {
    81, 86, 232, 6, 187, 4294967238, 4294967192, 168, 4294967176, 136, 4294967091, 25, 140, 156, 191, 161
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
