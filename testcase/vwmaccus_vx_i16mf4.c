...
int main(){
    const int16_t data1[] = {
    -44, 99, 70, -56, -42, -94, 17, 80, -41, -38, -95, -87, 39, 34, -31, -10
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -39, -7, 82, -63, -21, -60, 2, -74, 111, 9, -18, 76, 28, -121, -58, 71
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccus_vx_i16mf4 (out_data, data1_v, data2_v, vl);
