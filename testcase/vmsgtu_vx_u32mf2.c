...
int main(){
    ...
    2, 68, 203, 142, 191, 31, 132, 152, 201, 249, 111, 105, 74, 21, 9, 239
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    0, 57, 179, 229, 199, 225, 54, 213, 79, 22, 39, 201, 246, 171, 105, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_32mf2_b64 (data1_v, data2_v, vl);
