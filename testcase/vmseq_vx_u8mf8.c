...
int main(){
    const uint8_t data1[] = {
    203, 13, 27, 183, 231, 210, 26, 88, 90, 231, 166, 226, 6, 157, 215, 54
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    195, 152, 251, 113, 22, 155, 102, 129, 190, 158, 44, 86, 56, 218, 136, 215
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_8mf8_b64 (data1_v, data2_v, vl);
