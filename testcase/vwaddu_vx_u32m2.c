...
int main(){
    ...
    131, 172, 32, 41, 85, 238, 50, 206, 124, 14, 169, 162, 92, 149, 242, 223
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    62, 210, 65, 206, 235, 69, 38, 122, 165, 35, 65, 219, 176, 232, 193, 158
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u32m2 (data1_v, data2_v, vl);
