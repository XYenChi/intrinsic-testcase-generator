...
int main(){
    const int8_t data1[] = {
    -22, 100, 91, 77, 40, 42, 118, 127, 80, 59, -73, 106, 96, 49, 10, -125
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -39, 95, 74, -29, -97, -57, -59, 66, -74, 11, 121, 108, 47, -107, 78, 61
    };
    ...
    int8_t golden[] = {
    234, 100, 91, 77, 40, 42, 118, 127, 80, 59, 121, 108, 96, 49, 78, 61
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
