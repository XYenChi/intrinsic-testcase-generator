...
int main(){
    const int8_t data1[] = {
    -48, 29, -57, 109, 61, 110, -112, -17, 80, -6, -124, -58, -70, -39, 43, -87
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    111, 84, 68, -27, -43, 98, 14, 118, 93, -106, 52, -125, 94, 31, 6, -60
    };
    ...
    int8_t golden[] = {
    111, 84, 68, 109, 61, 110, 14, 118, 93, 250, 52, 198, 94, 31, 43, 196
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
