...
int main(){
    ...
    64, 45, 159, 128, 129, 164, 188, 133, 19, 104, 148, 45, 78, 206, 166, 235
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    125, 69, 57, 69, 217, 180, 157, 148, 165, 209, 80, 198, 200, 25, 7, 115
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulu_vx_u32m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    0, 0, 0, 0, 1, 29520, 1, 0, 3135, 21736, 1, 8910, 15600, 5150, 1162, 27025
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
