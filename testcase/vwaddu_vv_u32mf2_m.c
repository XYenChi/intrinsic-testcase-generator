...
int main(){
    ...
    225, 74, 54, 195, 199, 59, 201, 17, 155, 119, 253, 101, 165, 148, 131, 199
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    62, 232, 40, 100, 101, 116, 240, 109, 74, 72, 215, 213, 65, 63, 96, 213
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u32mf2_m (mask, data1_v, data2_v, vl);
