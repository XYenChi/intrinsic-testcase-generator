...
int main(){
    ...
    185, 147, 129, 57, 133, 164, 139, 130, 175, 53, 21, 135, 69, 202, 36, 158
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    133, 218, 181, 141, 34, 103, 218, 4, 95, 232, 33, 183, 154, 147, 25, 47
    };
    ...
    uint64_t golden[] = {
    185, 147, 310, 57, 133, 164, 139, 134, 270, 53, 21, 135, 69, 147, 61, 158
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
