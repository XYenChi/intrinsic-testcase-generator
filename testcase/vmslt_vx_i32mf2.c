...
int main(){
    const int32_t data1[] = {
    83, 26, -32, 122, 28, 87, -20, -60, -116, -13, -23, -103, -95, -102, -78, 27
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    44, 4, 81, -74, 96, 47, 76, 54, 110, -50, -58, -40, -121, -93, -18, -66
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_32mf2_b64 (data1_v, data2_v, vl);
