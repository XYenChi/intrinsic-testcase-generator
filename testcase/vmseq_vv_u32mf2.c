...
int main(){
    ...
    247, 121, 19, 203, 160, 72, 231, 165, 42, 140, 1, 73, 252, 186, 44, 173
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    238, 229, 90, 250, 219, 223, 112, 179, 108, 160, 138, 188, 192, 28, 148, 133
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_32mf2_b64 (data1_v, data2_v, vl);
