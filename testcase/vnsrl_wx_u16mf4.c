...
int main(){
    ...
    8, 200, 189, 27, 4, 241, 77, 2, 108, 84, 28, 30, 38, 52, 184, 43
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    221, 125, 28, 157, 149, 143, 98, 99, 91, 43, 127, 24, 62, 176, 153, 221
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_16mf4 (data1_v, shift, vl);
