...
int main(){
    ...
    235, 55, 130, 23, 246, 235, 143, 204, 15, 228, 20, 30, 8, 253, 129, 255
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    70, 49, 107, 174, 196, 100, 114, 90, 48, 213, 55, 252, 89, 212, 226, 134
    };
    ...
    uint32_t golden[] = {
    235, 55, 130, 174, 246, 235, 143, 204, 48, 228, 55, 252, 89, 253, 226, 255
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
