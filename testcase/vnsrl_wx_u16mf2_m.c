...
int main(){
    ...
    164, 0, 23, 238, 67, 205, 19, 141, 15, 5, 99, 167, 84, 152, 240, 89
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    145, 38, 116, 167, 30, 182, 65, 98, 30, 121, 75, 117, 222, 147, 119, 130
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_16mf2_m (mask, data1_v, shift, vl);
