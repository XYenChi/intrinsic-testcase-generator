...
int main(){
    const int32_t data1[] = {
    -57, 99, 18, -36, -13, -95, 113, -119, 31, 109, 83, -32, -127, -5, -56, 59
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -60, -28, 40, 25, 52, -15, -79, 57, -95, -20, -4, 68, 96, -120, -60, 28
    };
    ...
    int32_t golden[] = {
    4294967179, 71, 40, 4294967260, 4294967283, 4294967201, 4294967217, 4294967177, 4294967201, 109, 4294967292, 36, 4294967169, 4294967291, 4294967240, 87
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
