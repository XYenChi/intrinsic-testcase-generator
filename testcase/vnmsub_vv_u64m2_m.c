...
int main(){
    ...
    33, 244, 32, 98, 128, 156, 213, 206, 250, 175, 13, 32, 60, 245, 233, 117
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    187, 34, 52, 11, 60, 134, 47, 191, 210, 137, 106, 18, 183, 131, 218, 48
    };
    ...
    uint64_t golden[] = {
    18446744073709551462, 244, 18446744073709551596, 98, 0, 156, 1, 15, 40, 1, 1, 32, 18446744073709551493, 1, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
