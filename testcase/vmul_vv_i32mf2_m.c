...
int main(){
    const int32_t data1[] = {
    32, -8, 64, 41, -90, 27, 50, 68, 32, 108, 76, 77, 93, -123, 100, 123
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    70, 12, -78, 68, 76, 48, -24, 110, 111, -4, -90, 109, 107, 16, -55, -63
    };
    ...
    int32_t golden[] = {
    2240, 4294967200, 4294962304, 0, 0, 1296, 4294966096, 7480, 3552, 4294966864, 0, 1, 9951, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
