...
int main(){
    const int32_t data1[] = {
    41, 94, -107, 121, -70, 113, 123, -56, -12, -5, -25, 94, 16, 104, -120, 109
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    120, -11, 117, 100, -95, 5, -41, -125, -49, 55, -89, 110, 102, 69, 94, -12
    };
    ...
    int32_t golden[] = {
    79, 1, 224, 0, 4294967271, 0, 4294967132, 1, 0, 60, 0, 1, 86, 0, 214, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
