...
int main(){
    ...
    80, 242, 160, 153, 109, 131, 207, 63, 192, 189, 254, 31, 52, 229, 13, 210
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    100, 83, 202, 92, 35, 126, 46, 106, 149, 44, 66, 17, 174, 113, 188, 133
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u64m8_m (mask, data1_v, data2_v, vl);
