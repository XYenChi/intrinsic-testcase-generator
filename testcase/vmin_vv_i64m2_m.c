...
int main(){
    const int64_t data1[] = {
    82, -115, -34, 71, -22, -18, -19, 113, 124, -64, 54, -68, -53, 25, 45, 55
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    115, -62, -17, 14, -71, -70, 63, 96, -43, 36, -124, -41, 89, 54, 16, -80
    };
    ...
    int64_t golden[] = {
    115, 18446744073709551554, 1, 0, 0, 1, 1, 1, 1, 36, 1, 18446744073709551575, 1, 1, 45, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
