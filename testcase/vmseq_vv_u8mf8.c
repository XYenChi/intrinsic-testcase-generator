...
int main(){
    const uint8_t data1[] = {
    179, 222, 47, 111, 77, 117, 221, 83, 94, 110, 6, 10, 140, 99, 178, 135
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    233, 45, 199, 127, 250, 234, 244, 159, 103, 170, 244, 62, 219, 73, 153, 113
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_8mf8_b64 (data1_v, data2_v, vl);
