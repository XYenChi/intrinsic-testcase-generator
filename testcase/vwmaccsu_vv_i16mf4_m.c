...
int main(){
    const int16_t data1[] = {
    -20, 124, 14, 23, -46, -78, -64, 127, -87, 39, -99, 16, -29, 125, -87, -31
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    19, 86, -53, 86, 105, -58, -120, 60, 18, -30, 106, 125, -89, -93, -78, 55
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccsu_vv_i16mf4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    1, 10665, 64794, 1, 60706, 1, 0, 0, 63970, 64367, 55043, 1, 0, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
