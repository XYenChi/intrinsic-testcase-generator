...
int main(){
    const uint8_t data1[] = {
    154, 61, 231, 96, 62, 95, 171, 25, 233, 178, 91, 107, 225, 184, 136, 121
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    63, 97, 238, 187, 42, 161, 9, 213, 117, 228, 191, 167, 28, 160, 219, 44
    };
    ...
    uint8_t golden[] = {
    154, 97, 238, 187, 62, 161, 171, 213, 233, 228, 191, 167, 225, 184, 219, 121
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
