...
int main(){
    const uint8_t data1[] = {
    22, 24, 227, 128, 160, 7, 162, 131, 62, 149, 28, 138, 128, 105, 29, 239
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    215, 81, 148, 229, 114, 145, 210, 139, 237, 194, 112, 68, 182, 211, 46, 93
    };
    ...
    uint8_t golden[] = {
    215, 81, 227, 229, 160, 145, 210, 139, 237, 194, 112, 138, 182, 211, 46, 239
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
