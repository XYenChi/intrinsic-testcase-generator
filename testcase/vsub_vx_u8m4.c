...
int main(){
    const uint8_t data1[] = {
    98, 29, 183, 224, 135, 150, 103, 0, 253, 30, 136, 136, 5, 107, 189, 142
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    114, 94, 135, 131, 240, 138, 73, 143, 62, 126, 151, 202, 212, 34, 142, 107
    };
    ...
    uint8_t golden[] = {
    240, 191, 48, 93, 151, 12, 30, 113, 191, 160, 241, 190, 49, 73, 47, 35
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
