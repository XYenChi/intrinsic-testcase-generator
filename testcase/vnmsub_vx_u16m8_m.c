...
int main(){
    ...
    189, 26, 71, 249, 33, 238, 17, 245, 62, 4, 249, 216, 26, 71, 207, 172
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    27, 99, 11, 214, 102, 4, 199, 219, 2, 6, 164, 204, 128, 248, 230, 164
    };
    ...
    uint16_t golden[] = {
    189, 65463, 1, 35, 0, 238, 17, 245, 0, 1, 249, 12, 65434, 1, 207, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
