...
int main(){
    ...
    143, 95, 219, 151, 78, 132, 243, 142, 13, 148, 110, 85, 12, 123, 180, 200
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    78, 94, 104, 101, 22, 141, 44, 220, 139, 203, 60, 34, 182, 39, 52, 76
    };
    ...
    uint32_t golden[] = {
    221, 189, 323, 252, 100, 273, 287, 362, 152, 351, 170, 119, 194, 162, 232, 276
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
