...
int main(){
    const int64_t data1[] = {
    76, 52, -108, -121, 20, -124, 67, -54, 92, -45, 29, -65, -23, 5, -71, 52
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    61, -68, 16, 38, 104, -90, 112, -50, -59, -109, -85, 122, -72, 55, -59, 45
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vrsub_vx_i64m2_m (mask, data1_v, data2_v, vl);
    ...
    int64_t golden[] = {
    18446744073709551601, 0, 124, 1, 84, 34, 1, 0, 1, 0, 1, 0, 0, 50, 0, 18446744073709551609
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
