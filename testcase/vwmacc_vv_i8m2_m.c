...
int main(){
    const int8_t data1[] = {
    124, 120, 46, 107, 109, 2, -12, -123, -7, -36, 44, -38, 79, 122, -34, 11
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -128, 35, 82, -17, 101, 101, 84, 94, -66, -72, -80, -16, -80, -20, 115, 8
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmacc_vv_i8m2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    1, 0, 189, 230, 0, 203, 1, 0, 1, 1, 1, 97, 0, 1, 186, 89
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
