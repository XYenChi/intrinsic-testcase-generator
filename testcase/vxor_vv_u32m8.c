...
int main(){
    ...
    35, 49, 43, 15, 228, 203, 29, 20, 125, 238, 8, 205, 173, 240, 153, 246
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    105, 88, 188, 242, 25, 82, 248, 35, 164, 117, 128, 218, 139, 99, 170, 232
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u32m8 (data1_v, data2_v, vl);
