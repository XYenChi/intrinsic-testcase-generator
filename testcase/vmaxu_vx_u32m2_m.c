...
int main(){
    ...
    224, 204, 98, 228, 202, 21, 41, 65, 122, 75, 244, 127, 61, 20, 198, 133
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    31, 230, 170, 181, 253, 55, 161, 35, 207, 77, 184, 15, 120, 8, 202, 61
    };
    ...
    uint32_t golden[] = {
    224, 230, 0, 228, 1, 1, 161, 0, 207, 1, 244, 127, 120, 20, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
