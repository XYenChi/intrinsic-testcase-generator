...
int main(){
    const int8_t data1[] = {
    -100, 36, 11, -115, 113, -34, 95, 60, 15, 119, -27, 7, -99, -17, -66, -109
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -69, -121, -13, -58, -79, -15, 43, 78, -92, 84, -19, 29, 67, -43, 98, 40
    };
    ...
    int8_t golden[] = {
    87, 171, 11, 141, 113, 222, 95, 138, 164, 119, 229, 29, 157, 239, 190, 187
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
