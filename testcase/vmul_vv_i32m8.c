...
int main(){
    const int32_t data1[] = {
    -107, 26, -53, 10, -104, -64, 63, -94, -48, 63, -25, -59, -104, 36, -89, -118
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    71, -46, 59, -107, -49, -80, 36, -11, 79, 29, -33, 65, -50, 29, 9, -91
    };
    ...
    int32_t golden[] = {
    4294959699, 4294966100, 4294964169, 4294966226, 5096, 5120, 2268, 1034, 4294963504, 1827, 825, 4294963461, 5200, 1044, 4294966495, 10738
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
