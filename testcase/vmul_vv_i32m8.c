...
int main(){
    const int32_t data1[] = {
    96, 78, 90, -92, 120, 56, -42, -4, 28, -122, 19, 20, -112, 54, -86, -19
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    37, 94, 62, 9, 18, -107, -1, -124, 65, -81, 46, -10, -108, -49, 102, 15
    };
    ...
    int32_t golden[] = {
    3552, 7332, 5580, 4294966468, 2160, 4294961304, 42, 496, 1820, 9882, 874, 4294967096, 12096, 4294964650, 4294958524, 4294967011
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
