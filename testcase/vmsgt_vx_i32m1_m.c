...
int main(){
    const int32_t data1[] = {
    36, 84, -42, -116, -84, -13, -56, 57, 126, 92, -19, -7, 45, -22, -37, -117
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -75, -35, 2, 37, -107, -62, 92, -6, 67, -82, -25, -128, -95, 94, -58, -9
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vx_32m1_b32_m (mask, data1_v, data2_v, vl);
