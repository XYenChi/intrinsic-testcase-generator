...
int main(){
    ...
    177, 158, 254, 90, 60, 148, 185, 40, 85, 104, 158, 198, 59, 221, 9, 117
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    175, 233, 216, 43, 228, 68, 113, 17, 255, 254, 132, 235, 227, 229, 237, 115
    };
    ...
    uint16_t golden[] = {
    2, 65461, 1, 0, 65368, 80, 72, 1, 65366, 65386, 26, 1, 65368, 1, 65308, 2
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
