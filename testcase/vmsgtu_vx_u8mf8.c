...
int main(){
    const uint8_t data1[] = {
    152, 143, 212, 133, 176, 204, 75, 252, 85, 245, 248, 223, 31, 133, 33, 127
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    39, 43, 33, 254, 19, 128, 107, 18, 40, 249, 103, 19, 188, 186, 3, 16
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_8mf8_b64 (data1_v, data2_v, vl);
