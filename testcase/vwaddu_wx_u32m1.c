...
int main(){
    ...
    199, 191, 125, 123, 191, 2, 21, 173, 140, 156, 0, 145, 244, 242, 159, 55
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    180, 112, 25, 14, 83, 172, 213, 1, 82, 166, 116, 170, 182, 136, 97, 121
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u32m1 (data1_v, data2_v, vl);
