...
int main(){
    const int64_t data1[] = {
    89, -72, -84, 88, 19, 51, -24, 30, -121, 19, 76, -44, -100, -43, 84, -102
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -55, -9, -7, 46, -106, 53, 38, -3, 65, 44, -73, 113, -62, 50, -69, -44
    };
    ...
    int64_t golden[] = {
    1, 1, 1, 0, 0, 51, 18446744073709551554, 0, 18446744073709551495, 0, 76, 0, 1, 0, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
