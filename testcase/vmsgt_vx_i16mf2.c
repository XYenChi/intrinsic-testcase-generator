...
int main(){
    const int16_t data1[] = {
    108, -49, 72, -93, 65, -15, 23, 93, 58, 95, -12, 27, -82, 73, 101, -127
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    77, 124, 98, -126, 78, 109, -104, 13, -77, 120, 104, -118, -57, -57, 114, 45
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vx_16mf2_b32 (data1_v, data2_v, vl);
