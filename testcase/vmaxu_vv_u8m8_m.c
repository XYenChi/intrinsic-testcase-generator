...
int main(){
    const uint8_t data1[] = {
    50, 236, 25, 125, 131, 120, 162, 102, 101, 180, 15, 100, 145, 224, 221, 169
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    157, 245, 56, 28, 219, 162, 7, 237, 198, 186, 115, 42, 45, 177, 40, 236
    };
    ...
    uint8_t golden[] = {
    157, 245, 56, 1, 219, 162, 0, 1, 198, 0, 0, 100, 0, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
