...
int main(){
    const int32_t data1[] = {
    108, -56, 82, -121, 86, -3, 0, -43, 85, -30, -126, -98, -55, 115, 95, 60
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    102, 30, -112, 96, 106, 54, 124, -44, -114, 0, 58, -108, -79, 29, -19, 93
    };
    ...
    int32_t golden[] = {
    102, 30, 4294967184, 96, 106, 54, 0, 4294967252, 4294967182, 0, 58, 4294967188, 4294967217, 29, 4294967277, 93
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
