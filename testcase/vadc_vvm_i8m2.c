...
int main(){
    const int8_t data1[] = {
    -119, 23, -122, -15, -115, 79, 77, 30, 87, 78, 64, 55, -83, -115, -11, 26
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    56, 101, -92, 65, -28, 85, -111, 102, -100, -111, -43, 72, -44, 27, 20, -119
    };
    ...
    int8_t golden[] = {
    -63, 124, -213, 50, -142, 164, -34, 132, -12, -33, 22, 128, -126, -88, 9, -93
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
