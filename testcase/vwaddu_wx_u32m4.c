...
int main(){
    ...
    229, 201, 97, 162, 122, 238, 240, 8, 7, 198, 3, 169, 63, 196, 29, 166
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    18, 104, 172, 232, 92, 246, 195, 226, 254, 118, 107, 94, 130, 183, 170, 175
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u32m4 (data1_v, data2_v, vl);
