...
int main(){
    const int32_t data1[] = {
    81, 78, -68, 17, -42, -43, 60, 119, -31, 111, -30, -91, 52, 27, -107, -90
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    43, 115, -55, -72, 101, 1, -78, -38, 1, 10, -42, 13, -12, 6, -18, -21
    };
    ...
    int32_t golden[] = {
    0, 1, 0, 4294967291, 4294967293, 4294967295, 4294967294, 4294967295, 4294967295, 0, 1, 4294967295, 4294967295, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
