...
int main(){
    const int32_t data1[] = {
    15, -3, -79, 32, -22, 89, 127, -28, 116, 69, -9, -116, -42, 78, -31, 36
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -122, 94, 28, 92, -10, -77, 104, -24, 97, -16, 23, -48, 46, -59, 68, -18
    };
    ...
    int32_t golden[] = {
    4294967287, 4294967264, 4294967295, 2, 0, 4294967295, 0, 0, 0, 4294967295, 4294967293, 0, 4294967294, 4294967295, 4294967293, 4294967295
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
