...
int main(){
    const int64_t data1[] = {
    121, 70, -75, -22, 69, -18, -105, 32, -14, -61, -14, 97, -13, 109, 64, -111
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -110, -9, -103, -80, -91, -123, -27, -106, -72, -45, -52, -50, 22, 99, 120, 6
    };
    ...
    int64_t golden[] = {
    1, 1, 1, 0, 0, 2214, 2835, 18446744073709548224, 0, 1, 728, 18446744073709546766, 1, 10791, 7680, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
