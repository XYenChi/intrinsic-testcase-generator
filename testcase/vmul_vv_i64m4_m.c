...
int main(){
    const int64_t data1[] = {
    63, -68, 35, 93, 98, -87, -49, 47, 39, -51, -78, -25, 61, -67, 120, -83
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -111, 69, 20, -124, 21, 74, -69, 46, 85, 82, 104, -96, -114, 71, 5, -45
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmul_vv_i64m4_m (mask, data1_v, data2_v, vl);
    ...
    int64_t golden[] = {
    1, 18446744073709546924, 700, 18446744073709540084, 0, 18446744073709545178, 1, 0, 1, 1, 18446744073709543504, 2400, 18446744073709544662, 1, 600, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
