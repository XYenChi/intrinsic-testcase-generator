...
int main(){
    ...
    72, 65, 110, 222, 189, 1, 99, 142, 135, 97, 218, 111, 205, 58, 59, 229
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    175, 3, 86, 6, 218, 197, 67, 204, 121, 117, 136, 228, 39, 2, 47, 210
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_16m8_b2 (data1_v, data2_v, vl);
