...
int main(){
    ...
    135, 153, 248, 222, 7, 212, 212, 91, 124, 110, 45, 153, 253, 133, 186, 167
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    95, 211, 57, 99, 8, 149, 245, 5, 110, 197, 52, 41, 182, 143, 9, 187
    };
    ...
    uint64_t golden[] = {
    12825, 32283, 14136, 21978, 56, 31588, 51940, 455, 13640, 21670, 2340, 6273, 46046, 19019, 1674, 31229
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
