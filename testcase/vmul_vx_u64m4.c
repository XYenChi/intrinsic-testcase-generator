...
int main(){
    ...
    153, 68, 221, 133, 87, 222, 2, 138, 73, 207, 170, 158, 27, 100, 105, 131
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    107, 65, 145, 248, 40, 73, 199, 248, 129, 235, 249, 112, 185, 15, 234, 221
    };
    ...
    uint64_t golden[] = {
    16371, 4420, 32045, 32984, 3480, 16206, 398, 34224, 9417, 48645, 42330, 17696, 4995, 1500, 24570, 28951
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
