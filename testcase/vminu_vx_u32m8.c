...
int main(){
    ...
    218, 130, 235, 24, 36, 153, 213, 153, 58, 74, 156, 141, 96, 175, 75, 113
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    101, 243, 159, 25, 62, 71, 233, 209, 131, 218, 121, 181, 132, 185, 55, 234
    };
    ...
    uint32_t golden[] = {
    218, 243, 235, 25, 62, 153, 233, 209, 131, 218, 156, 181, 132, 185, 75, 234
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
