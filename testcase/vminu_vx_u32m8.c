...
int main(){
    ...
    137, 82, 70, 241, 210, 78, 63, 137, 123, 194, 12, 156, 162, 130, 42, 7
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    45, 28, 123, 81, 44, 41, 35, 25, 94, 202, 152, 163, 123, 112, 240, 169
    };
    ...
    uint32_t golden[] = {
    137, 82, 123, 241, 210, 78, 63, 137, 123, 202, 152, 163, 162, 130, 240, 169
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
