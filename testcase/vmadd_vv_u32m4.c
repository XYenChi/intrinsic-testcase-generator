...
int main(){
    ...
    115, 85, 48, 155, 247, 156, 254, 40, 221, 176, 234, 254, 2, 54, 23, 6
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    38, 63, 119, 122, 160, 125, 221, 91, 68, 141, 111, 1, 236, 229, 28, 59
    };
    ...
    uint32_t golden[] = {
    153, 148, 167, 277, 407, 125, 475, 91, 68, 317, 111, 255, 238, 229, 51, 59
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
