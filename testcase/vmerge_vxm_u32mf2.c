...
int main(){
    ...
    94, 71, 97, 16, 37, 2, 213, 87, 140, 85, 82, 219, 133, 119, 98, 34
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    28, 111, 206, 3, 116, 42, 144, 13, 193, 210, 149, 231, 49, 69, 111, 43
    };
    ...
    uint32_t golden[] = {
    94, 71, 97, 16, 116, 2, 213, 87, 140, 210, 82, 231, 133, 69, 111, 43
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
