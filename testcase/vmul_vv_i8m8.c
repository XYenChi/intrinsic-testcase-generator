...
int main(){
    const int8_t data1[] = {
    76, 6, 66, 70, 52, -72, -123, 28, 14, -39, 116, 27, -54, 48, 110, -128
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    118, -105, 56, 113, -125, -32, -19, -94, -124, 1, -91, 40, 116, -79, 17, -28
    };
    ...
    int8_t golden[] = {
    8, 138, 112, 230, 156, 0, 33, 184, 56, 217, 196, 56, 136, 48, 78, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
