...
int main(){
    const int8_t data1[] = {
    0, -30, -62, 13, 79, -66, 75, -37, 106, 52, -20, -113, 113, -111, 113, -37
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -115, 108, -46, 75, -81, -37, -104, 73, 19, 112, 55, 35, -90, 82, -1, -95
    };
    ...
    int8_t golden[] = {
    0, 88, 36, 208, 1, 138, 137, 116, 223, 192, 181, 141, 71, 115, 144, 187
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
