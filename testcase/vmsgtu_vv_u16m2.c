...
int main(){
    ...
    106, 225, 45, 102, 194, 219, 165, 68, 105, 149, 68, 21, 38, 159, 169, 71
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    254, 143, 85, 214, 22, 76, 131, 150, 38, 109, 76, 134, 41, 216, 175, 246
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_16m2_b8 (data1_v, data2_v, vl);
