...
int main(){
    const int64_t data1[] = {
    -7, -100, 17, 25, -103, -89, -52, 55, -45, -97, 117, -29, -88, -32, -7, -94
    };
    const int64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    188, 17, 216, 136, 95, 206, 235, 21, 38, 139, 241, 200, 248, 33, 187, 164
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_64m1_b64 (mask, data1_v, data2_v, vl);
