...
int main(){
    ...
    116, 67, 114, 132, 156, 238, 250, 165, 97, 208, 79, 70, 233, 178, 181, 40
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    54, 158, 204, 21, 76, 239, 244, 199, 27, 17, 83, 71, 247, 113, 92, 16
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_16m2_b8 (data1_v, data2_v, vl);
