...
int main(){
    const uint8_t data1[] = {
    200, 254, 242, 4, 116, 190, 235, 54, 32, 156, 209, 178, 248, 196, 97, 15
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    23, 23, 72, 203, 252, 1, 141, 152, 19, 113, 84, 50, 227, 123, 31, 102
    };
    ...
    uint8_t golden[] = {
    248, 210, 16, 44, 48, 190, 111, 16, 96, 220, 148, 196, 232, 44, 191, 250
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
