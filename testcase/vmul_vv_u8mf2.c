...
int main(){
    const uint8_t data1[] = {
    36, 247, 209, 93, 88, 71, 33, 184, 199, 5, 102, 138, 46, 98, 33, 55
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    187, 231, 250, 29, 158, 104, 36, 81, 50, 178, 66, 87, 254, 1, 94, 239
    };
    ...
    uint8_t golden[] = {
    76, 225, 26, 137, 80, 216, 164, 56, 222, 122, 76, 230, 164, 98, 30, 89
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
