...
int main(){
    ...
    152, 250, 86, 80, 184, 23, 251, 200, 67, 220, 98, 161, 136, 5, 74, 6
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    30, 48, 170, 67, 169, 139, 179, 197, 51, 11, 58, 211, 246, 234, 180, 119
    };
    ...
    uint16_t golden[] = {
    122, 202, 65452, 80, 15, 65420, 72, 3, 67, 220, 40, 65486, 65426, 65307, 65430, 6
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
