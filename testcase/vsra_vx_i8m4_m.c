...
int main(){
    const int8_t data1[] = {
    -58, 49, 19, -48, -58, -83, -120, -21, -92, -18, -80, -31, -104, 18, 81, 65
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    79, -53, 103, -115, 24, -21, 1, 77, 52, -7, 103, -74, -84, -112, -114, 8
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsra_vx_i8m4_m (mask, data1_v, shift, vl);
    ...
    int8_t golden[] = {
    -29, 24, 9, -24, -58, -42, -60, -11, -92, -9, -40, -31, -104, 18, 81, 65
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
