...
int main(){
    ...
    30, 30, 35, 82, 131, 40, 53, 147, 12, 23, 225, 121, 159, 218, 198, 156
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    111, 28, 184, 132, 52, 167, 62, 168, 98, 107, 37, 205, 93, 90, 42, 172
    };
    ...
    uint32_t golden[] = {
    111, 30, 0, 0, 131, 1, 0, 168, 98, 107, 225, 1, 159, 218, 198, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
