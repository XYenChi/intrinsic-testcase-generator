...
int main(){
    ...
    185, 170, 125, 23, 14, 45, 155, 20, 177, 31, 80, 58, 120, 168, 25, 192
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    24, 37, 128, 131, 106, 110, 17, 65, 150, 131, 36, 72, 87, 99, 5, 122
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u16m8 (data1_v, data2_v, vl);
