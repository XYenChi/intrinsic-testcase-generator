...
int main(){
    const int64_t data1[] = {
    -67, -119, 5, -80, -76, -3, 126, 17, 25, 11, -70, 117, 122, 26, -14, 116
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    15, 37, 121, 56, -41, 28, 113, -6, -26, 102, 106, -16, -52, -49, -82, 109
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vrem_vv_i64m4_m (mask, data1_v, data2_v, vl);
    ...
    int64_t golden[] = {
    18446744073709551564, 0, 1, 1, 0, 0, 113, 11, 24, 3, 1, 101, 0, 3, 1, 109
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
