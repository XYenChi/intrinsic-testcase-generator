...
int main(){
    const int8_t data1[] = {
    -58, -41, -110, -87, 102, 76, 80, -85, -48, -27, -25, 81, 22, 22, 29, 59
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -24, 111, -25, 94, -125, -17, -2, -85, 89, 5, 18, -99, 84, -19, -85, 104
    };
    ...
    int8_t golden[] = {
    232, 111, 231, 94, 131, 239, 254, 171, 89, 5, 18, 157, 84, 237, 171, 104
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
