...
int main(){
    const int8_t data1[] = {
    -70, 103, 53, -42, 61, -7, 115, 115, -109, -101, -36, -33, -102, -1, 84, -120
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -47, 59, 35, -126, 111, 35, 84, -102, -107, 57, -22, 98, -43, 120, -72, 28
    };
    ...
    int8_t golden[] = {
    209, 59, 35, 130, 111, 35, 84, 154, 149, 57, 234, 98, 213, 120, 184, 28
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
