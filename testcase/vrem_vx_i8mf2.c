...
int main(){
    const int8_t data1[] = {
    -54, 113, 73, 77, -41, -48, 51, -49, -92, 65, -53, -18, -128, 54, 106, 120
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    31, 82, 120, 65, -69, -118, -83, 6, -99, 108, 96, 57, 6, -9, -9, -82
    };
    ...
    int8_t golden[] = {
    233, 82, 47, 65, 228, 234, 19, 213, 249, 43, 246, 241, 134, 45, 97, 38
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
