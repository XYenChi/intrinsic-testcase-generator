...
int main(){
    const int8_t data1[] = {
    238, 47, 228, 115, 150, 12, 68, 14, 28, 188, 92, 163, 134, 69, 91, 186
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    240, 111, 18, 175, 194, 185, 54, 33, 71, 139, 160, 240, 32, 221, 101, 70
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vrem_vx_i8mf2 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    2, 17, 18, 60, 44, 5, 54, 5, 15, 139, 68, 77, 32, 14, 10, 70
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
