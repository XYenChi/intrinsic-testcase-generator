...
int main(){
    ...
    65, 127, 95, 203, 162, 75, 111, 50, 136, 170, 255, 2, 76, 197, 131, 99
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    60, 21, 182, 53, 57, 171, 173, 207, 242, 97, 184, 20, 62, 170, 118, 31
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u32mf2_m (mask, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    1, 21, 87, 1, 57, 21, 62, 1, 106, 97, 1, 0, 62, 1, 118, 31
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
