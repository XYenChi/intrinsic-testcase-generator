...
int main(){
    const int8_t data1[] = {
    68, -35, -109, -107, 106, -69, 11, -22, -74, 103, 116, -11, 123, 19, -119, 71
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -47, 79, 33, -18, 30, -116, -95, 120, 23, -2, -83, -45, 47, 120, -24, 108
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vx_8m4_b2_m (mask, data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    1, 1, 1, 0, 0, 0, 0, 1, 1, 0, 1, 0, 1, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
