...
int main(){
    const int32_t data1[] = {
    -10, -84, 96, 15, -69, -84, 118, 48, -47, -47, -16, 8, -42, -122, -48, -27
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -105, -2, -32, -17, 17, -110, 7, -111, -7, 57, -117, -1, 64, -108, -15, -124
    };
    ...
    int32_t golden[] = {
    1051, 169, 4294964225, 4294967042, 4294966123, 9241, 827, 4294961969, 329, 4294964617, 1872, 4294967289, 4294964609, 13177, 721, 3349
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
