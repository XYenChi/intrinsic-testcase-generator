...
int main(){
    const int32_t data1[] = {
    50, 65, -29, -101, 102, 46, 94, -78, 37, -70, 35, 84, -107, -96, 88, -102
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -72, 96, 111, -4, -23, -56, -61, -12, -35, -94, -119, 76, 43, 85, -39, 8
    };
    ...
    int32_t golden[] = {
    4294963697, 6241, 4294964077, 404, 4294964950, 4294964720, 4294961562, 936, 4294966001, 6580, 4294963131, 6385, 4294962695, 4294959137, 4294963865, 4294966480
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
