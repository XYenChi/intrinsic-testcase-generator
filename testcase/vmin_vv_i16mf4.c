...
int main(){
    const int16_t data1[] = {
    -56, 42, -7, -15, -117, 52, -98, 83, -31, 75, -7, -105, -88, -53, -97, -64
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    10, -8, 29, 35, -50, 52, 22, 38, -36, -14, 116, 119, 101, -95, 118, 101
    };
    ...
    int16_t golden[] = {
    10, 42, 29, 35, 65486, 52, 22, 83, 65505, 75, 116, 119, 101, 65483, 118, 101
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
