...
int main(){
    const uint8_t data1[] = {
    191, 185, 21, 47, 135, 129, 175, 125, 174, 25, 203, 126, 199, 117, 222, 166
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    95, 59, 163, 30, 239, 148, 42, 61, 19, 153, 166, 55, 77, 104, 58, 143
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u8m4 (data1_v, data2_v, vl);
