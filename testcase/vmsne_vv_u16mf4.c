...
int main(){
    ...
    182, 247, 173, 150, 40, 104, 63, 76, 12, 45, 127, 118, 123, 89, 38, 237
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    169, 161, 52, 154, 14, 58, 21, 106, 182, 171, 254, 147, 57, 164, 218, 210
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_16mf4_b64 (data1_v, data2_v, vl);
