...
int main(){
    ...
    235, 230, 183, 242, 153, 102, 70, 121, 23, 254, 117, 41, 62, 127, 59, 115
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    26, 162, 144, 207, 152, 39, 57, 27, 82, 159, 115, 96, 119, 6, 96, 223
    };
    ...
    uint32_t golden[] = {
    26, 0, 1, 207, 1, 39, 57, 27, 82, 159, 0, 0, 119, 0, 96, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
