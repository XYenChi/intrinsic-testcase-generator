...
int main(){
    const int32_t data1[] = {
    65, -56, -51, -76, 123, 41, -87, -63, 91, 23, 41, -55, 83, -34, -34, -76
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -53, -4, -73, 12, -32, 99, 114, 50, 14, -85, 126, 103, 44, 74, 76, -36
    };
    ...
    int32_t golden[] = {
    65, 4294967292, 4294967245, 12, 123, 99, 114, 50, 91, 23, 126, 103, 83, 74, 76, 4294967260
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
