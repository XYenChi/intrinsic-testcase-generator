...
int main(){
    const int32_t data1[] = {
    -84, -27, -49, -114, -83, -16, -94, -7, -69, 18, 50, 30, 14, -35, 73, 23
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    35, -45, 89, -17, 96, 16, 6, -54, 121, -121, -3, 77, 30, 110, -46, -92
    };
    ...
    int32_t golden[] = {
    35, 4294967269, 89, 4294967279, 96, 16, 6, 4294967289, 121, 18, 50, 77, 30, 110, 73, 23
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
