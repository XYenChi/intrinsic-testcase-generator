...
int main(){
    ...
    204, 204, 219, 173, 13, 146, 162, 7, 247, 180, 33, 236, 192, 192, 17, 151
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    193, 3, 208, 81, 210, 33, 208, 250, 132, 225, 26, 94, 227, 185, 182, 95
    };
    ...
    uint16_t golden[] = {
    39372, 612, 45552, 14013, 1, 4818, 33696, 1750, 0, 40500, 0, 22184, 43584, 35520, 3094, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
