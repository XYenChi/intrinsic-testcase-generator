...
int main(){
    ...
    148, 185, 213, 148, 143, 181, 83, 52, 76, 19, 238, 18, 228, 21, 230, 99
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    56, 187, 95, 229, 155, 165, 76, 147, 96, 10, 147, 239, 101, 41, 82, 242
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u16m4_m (mask, data1_v, data2_v, vl);
