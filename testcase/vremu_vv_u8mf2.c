...
int main(){
    const uint8_t data1[] = {
    104, 70, 180, 182, 185, 185, 223, 89, 119, 10, 65, 6, 57, 138, 173, 36
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    199, 238, 56, 14, 183, 147, 17, 84, 253, 250, 69, 52, 192, 237, 179, 203
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u8mf2 (data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    95, 28, 56, 14, 183, 147, 17, 84, 15, 0, 4, 4, 21, 99, 6, 23
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
