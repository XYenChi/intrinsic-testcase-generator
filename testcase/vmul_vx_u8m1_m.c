...
int main(){
    const uint8_t data1[] = {
    215, 174, 159, 115, 136, 188, 170, 205, 195, 177, 193, 237, 185, 0, 140, 249
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    163, 199, 204, 108, 156, 87, 220, 112, 68, 163, 37, 123, 147, 239, 29, 25
    };
    ...
    uint8_t golden[] = {
    229, 1, 0, 1, 1, 228, 24, 176, 204, 179, 1, 223, 1, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
