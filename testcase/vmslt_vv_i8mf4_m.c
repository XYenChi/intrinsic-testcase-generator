...
int main(){
    const int8_t data1[] = {
    -64, 80, 57, -88, 44, 53, 59, 33, 47, 55, -23, 105, -80, 61, -27, 11
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -4, 26, 40, 76, 39, 47, -121, 17, 72, -70, -109, 19, 96, 3, 64, -108
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vv_8mf4_b32_m (mask, data1_v, data2_v, vl);
