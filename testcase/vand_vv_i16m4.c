...
int main(){
    const int16_t data1[] = {
    126, 28, 42, 69, 121, 116, -17, -62, -23, 119, -54, -81, -49, -106, 83, 31
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -34, -105, 92, -30, 99, 60, -50, 98, -52, 61, 62, 3, 117, -113, -37, -24
    };
    ...
    int16_t golden[] = {
    65502, 65431, 92, 65506, 99, 60, 65486, 98, 65484, 61, 62, 3, 117, 65423, 65499, 65512
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
