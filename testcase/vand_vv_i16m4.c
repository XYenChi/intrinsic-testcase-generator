...
int main(){
    const int16_t data1[] = {
    -35, 88, 23, -110, -115, 4, -5, -80, -44, 92, -67, -34, -124, -114, -89, 66
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -22, 1, -109, -29, -27, -26, 105, 26, 109, -62, -13, 109, -45, 93, 65, 51
    };
    ...
    int16_t golden[] = {
    65514, 1, 65427, 65507, 65509, 65510, 105, 26, 109, 65474, 65523, 109, 65491, 93, 65, 51
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
