...
int main(){
    ...
    70, 149, 127, 85, 46, 197, 252, 105, 72, 155, 58, 179, 170, 139, 207, 66
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    9, 7, 92, 78, 218, 67, 5, 37, 30, 131, 84, 56, 102, 120, 111, 180
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u64m4 (data1_v, data2_v, vl);
