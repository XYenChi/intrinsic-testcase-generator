...
int main(){
    const int8_t data1[] = {
    100, 103, 103, 235, 210, 208, 125, 65, 231, 169, 47, 105, 131, 241, 176, 91
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    213, 158, 138, 205, 237, 217, 254, 128, 249, 87, 64, 1, 33, 6, 10, 252
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsbc_vv_i8m8 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    -113, -55, -35, 30, -27, -9, -129, -63, -18, 82, -17, 104, 98, 235, 166, -161
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
