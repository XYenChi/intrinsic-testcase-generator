...
int main(){
    const int64_t data1[] = {
    77, -118, 111, 22, -78, 111, 59, 82, 35, 60, -2, 114, 4, 115, 119, -100
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    17, 78, 126, -78, -45, -95, 2, 91, 3, 11, 118, 21, -36, -11, -84, -34
    };
    ...
    int64_t golden[] = {
    77, 18446744073709551420, 111, 100, 18446744073709551583, 111, 59, 82, 35, 60, 18446744073709551614, 93, 4, 115, 203, 18446744073709551516
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
