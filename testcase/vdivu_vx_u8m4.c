...
int main(){
    const uint8_t data1[] = {
    248, 184, 129, 102, 98, 35, 116, 204, 250, 167, 131, 183, 124, 19, 137, 70
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    124, 145, 108, 170, 218, 233, 22, 89, 104, 181, 165, 19, 93, 203, 27, 127
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i8m4 (data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 0, 0, 1, 2, 6, 0, 0, 0, 1, 1, 0, 0, 10, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
