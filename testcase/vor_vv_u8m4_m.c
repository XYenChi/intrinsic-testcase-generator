...
int main(){
    const uint8_t data1[] = {
    245, 146, 253, 230, 140, 59, 18, 72, 68, 247, 146, 26, 34, 147, 241, 255
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    121, 241, 151, 132, 134, 62, 221, 84, 197, 119, 158, 148, 170, 224, 14, 77
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wv_8m4u_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 243, 255, 230, 1, 63, 0, 0, 0, 0, 158, 158, 170, 0, 0, 255
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
