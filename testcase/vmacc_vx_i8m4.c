...
int main(){
    const int8_t data1[] = {
    113, 69, 42, -35, 104, -84, -6, -5, -113, 62, -87, 91, 86, -76, -89, 47
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    20, -43, 110, -54, 73, 19, 102, 117, 15, -71, -102, 7, 75, -106, 123, 89
    };
    ...
    int8_t golden[] = {
    213, 106, 13, 99, 168, 197, 156, 184, 97, 207, 170, 126, 50, 120, 62, 87
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
