...
int main(){
    const int8_t data1[] = {
    104, 87, 120, 125, 15, 117, -64, -32, 108, -74, 10, 86, -127, -74, -103, -108
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    66, -113, -41, -61, -82, -72, -84, -18, -114, 106, 103, 69, -98, 105, -127, 4
    };
    ...
    int8_t golden[] = {
    209, 153, 200, 55, 50, 25, 0, 65, 232, 92, 6, 46, 159, 167, 25, 80
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
