...
int main(){
    const uint8_t data1[] = {
    222, 177, 87, 175, 103, 18, 181, 238, 92, 180, 17, 163, 59, 45, 236, 60
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    54, 218, 46, 117, 198, 220, 91, 229, 27, 251, 126, 224, 237, 210, 204, 255
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wx_8m8u_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    254, 251, 127, 1, 0, 222, 255, 239, 0, 255, 127, 227, 0, 255, 236, 255
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
