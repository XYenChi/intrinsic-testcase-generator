...
int main(){
    const int32_t data1[] = {
    -102, -44, 106, 37, -37, 1, -114, 20, -14, 80, 10, -94, -72, 48, 46, -30
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -117, -32, 14, 0, 103, -26, 14, -51, -128, 27, -32, 116, -88, -94, -35, -18
    };
    ...
    int32_t golden[] = {
    -218, -75, 121, 37, 67, -25, -100, -31, -141, 108, -22, 22, -160, -45, 11, -48
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
