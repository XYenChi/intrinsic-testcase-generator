...
int main(){
    const uint8_t data1[] = {
    249, 129, 113, 5, 34, 34, 175, 10, 59, 21, 29, 125, 121, 91, 119, 190
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    191, 203, 114, 114, 46, 136, 34, 197, 210, 201, 192, 10, 36, 206, 76, 2
    };
    ...
    uint8_t golden[] = {
    58, 182, 255, 1, 1, 154, 141, 69, 0, 76, 0, 115, 85, 0, 43, 188
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
