...
int main(){
    const uint8_t data1[] = {
    198, 177, 227, 55, 123, 29, 69, 162, 227, 248, 131, 182, 236, 212, 56, 69
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    202, 214, 21, 249, 252, 167, 112, 173, 71, 118, 152, 137, 58, 179, 164, 219
    };
    ...
    uint8_t golden[] = {
    252, 219, 0, 62, 0, 118, 213, 1, 156, 130, 235, 1, 0, 33, 148, 106
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
