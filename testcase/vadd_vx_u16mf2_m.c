...
int main(){
    ...
    117, 77, 12, 244, 213, 238, 123, 229, 37, 137, 99, 129, 66, 135, 71, 212
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    96, 131, 98, 32, 45, 89, 130, 73, 232, 153, 69, 217, 70, 254, 184, 130
    };
    ...
    uint16_t golden[] = {
    213, 0, 110, 0, 1, 1, 0, 302, 269, 290, 168, 1, 0, 389, 255, 342
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
