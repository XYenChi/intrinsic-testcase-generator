...
int main(){
    const int64_t data1[] = {
    104, 107, -64, 11, 42, -126, -36, 126, 30, 92, 123, 101, 50, 37, -59, 7
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    126, -82, 68, -33, 116, 75, -53, -87, 100, -9, 3, -15, 84, 23, -56, -97
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vrem_vv_i64m8_m (mask, data1_v, data2_v, vl);
    ...
    int64_t golden[] = {
    22, 25, 18446744073709551556, 0, 0, 18446744073709551565, 0, 1, 10, 1, 1, 1, 34, 0, 18446744073709551560, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
