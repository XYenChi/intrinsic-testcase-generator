...
int main(){
    const int8_t data1[] = {
    126, -88, -11, 82, -116, -63, 104, -33, -103, -56, -62, -56, 85, -69, -74, 71
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -24, 119, 121, 57, -120, 58, 13, -40, 83, 42, -113, 66, 109, -78, -46, -3
    };
    ...
    int8_t golden[] = {
    232, 119, 121, 57, 136, 58, 13, 216, 83, 42, 143, 66, 109, 178, 210, 253
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
