...
int main(){
    const int8_t data1[] = {
    -82, 3, -52, 11, -60, 11, 98, -108, 19, 91, -92, -70, -14, -57, -90, -45
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -62, -82, -40, 9, 119, 101, -44, -79, 17, 82, 87, -35, 70, 123, -16, -30
    };
    ...
    int8_t golden[] = {
    194, 174, 216, 9, 119, 101, 212, 177, 17, 82, 87, 221, 70, 123, 240, 226
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
