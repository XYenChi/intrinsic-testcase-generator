...
int main(){
    const uint8_t data1[] = {
    58, 133, 220, 77, 38, 17, 213, 103, 66, 233, 76, 186, 255, 211, 210, 248
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    72, 112, 218, 88, 20, 254, 101, 124, 4, 224, 126, 207, 53, 25, 216, 158
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vv_u8m1_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    81, 48, 0, 120, 249, 0, 10, 1, 9, 1, 105, 0, 203, 155, 48, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
