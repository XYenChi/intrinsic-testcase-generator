...
int main(){
    const int8_t data1[] = {
    35, -53, 62, 39, 4, 49, -110, 59, -113, -112, 106, -118, 41, 31, -51, -54
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -76, -25, -70, 20, -67, -111, 58, 100, -55, -91, -7, -41, -83, 97, 119, -104
    };
    ...
    int8_t golden[] = {
    215, 178, 248, 59, 193, 194, 204, 159, 88, 53, 99, 97, 214, 128, 68, 98
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
