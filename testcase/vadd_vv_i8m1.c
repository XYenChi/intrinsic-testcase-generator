...
int main(){
    const int8_t data1[] = {
    -42, 75, 41, 7, 116, -46, 86, -72, -86, 33, -70, 71, -35, 70, 38, 50
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -68, 30, -26, -12, -37, -76, 31, -75, -12, 45, -47, -93, 109, 27, -14, -37
    };
    ...
    int8_t golden[] = {
    146, 105, 15, 251, 79, 134, 117, 109, 158, 78, 139, 234, 74, 97, 24, 13
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
