...
int main(){
    ...
    163, 246, 134, 215, 134, 3, 94, 9, 13, 120, 21, 45, 111, 215, 114, 21
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    243, 249, 97, 48, 173, 19, 171, 14, 152, 99, 2, 228, 5, 175, 155, 5
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_64m1_b64 (data1_v, data2_v, vl);
