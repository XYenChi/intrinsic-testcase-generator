...
int main(){
    const int32_t data1[] = {
    35, -81, -44, -96, 105, -77, 37, -65, -97, -71, -62, 98, 12, -6, -113, 22
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -56, 101, -115, 87, 50, -36, -68, -56, -88, 69, 71, -95, -86, -69, -54, 66
    };
    ...
    int32_t golden[] = {
    35, 101, 4294967252, 87, 105, 4294967260, 37, 4294967240, 4294967208, 69, 71, 98, 12, 4294967290, 4294967242, 66
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
