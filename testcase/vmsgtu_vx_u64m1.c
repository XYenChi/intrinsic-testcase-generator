...
int main(){
    ...
    66, 116, 198, 249, 179, 64, 212, 233, 116, 79, 222, 22, 197, 203, 50, 38
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    151, 73, 226, 141, 177, 2, 90, 187, 110, 199, 109, 187, 42, 198, 45, 236
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_64m1_b64 (data1_v, data2_v, vl);
