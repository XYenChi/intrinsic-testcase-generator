...
int main(){
    const uint8_t data1[] = {
    114, 3, 18, 244, 159, 222, 100, 91, 164, 134, 184, 144, 242, 243, 234, 38
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    210, 25, 210, 218, 178, 182, 3, 175, 254, 3, 33, 55, 2, 65, 252, 196
    };
    ...
    uint8_t golden[] = {
    96, 22, 0, 230, 1, 216, 0, 1, 0, 0, 1, 167, 16, 1, 18, 158
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
