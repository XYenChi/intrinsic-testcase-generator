...
int main(){
    ...
    133, 139, 155, 162, 38, 111, 253, 18, 164, 230, 233, 237, 196, 89, 176, 133
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    59, 85, 149, 126, 168, 166, 44, 31, 79, 80, 102, 111, 253, 76, 63, 173
    };
    ...
    uint16_t golden[] = {
    133, 139, 155, 162, 168, 166, 253, 31, 164, 230, 233, 237, 253, 89, 176, 173
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
