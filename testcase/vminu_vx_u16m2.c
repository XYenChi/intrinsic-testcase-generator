...
int main(){
    ...
    70, 63, 205, 128, 53, 124, 42, 122, 130, 60, 145, 251, 123, 65, 153, 233
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    62, 157, 5, 19, 35, 121, 37, 192, 135, 108, 21, 217, 21, 227, 117, 72
    };
    ...
    uint16_t golden[] = {
    70, 157, 205, 128, 53, 124, 42, 192, 135, 108, 145, 251, 123, 227, 153, 233
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
