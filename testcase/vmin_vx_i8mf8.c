...
int main(){
    const int8_t data1[] = {
    67, 35, 179, 171, 207, 131, 56, 91, 223, 196, 132, 145, 7, 184, 240, 132
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    47, 159, 255, 192, 247, 137, 250, 237, 252, 43, 116, 64, 137, 176, 169, 18
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmin_vx_i8mf8 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    67, 159, 255, 192, 247, 137, 250, 237, 252, 196, 132, 145, 137, 184, 240, 132
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
