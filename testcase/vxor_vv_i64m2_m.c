...
int main(){
    const int64_t data1[] = {
    118, -44, 116, -93, 12, 94, 100, 93, 73, 38, -106, -107, -8, 13, -78, 114
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -117, 81, 57, 6, -104, -59, -105, 75, 54, -25, -87, -55, 124, 108, -32, -53
    };
    ...
    uint32_t masked[] = {
    1, 0, 1, 1, 1, 0, 0, 1, 0, 1, 0, 1, 1, 0, 1, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_i64m2_m (mask, data1_v, data2_v, vl);
