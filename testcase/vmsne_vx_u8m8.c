...
int main(){
    const uint8_t data1[] = {
    82, 41, 197, 157, 150, 150, 43, 115, 220, 113, 192, 190, 148, 198, 191, 78
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    110, 243, 240, 162, 189, 167, 138, 125, 17, 187, 46, 9, 81, 214, 164, 167
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vx_8m8_b1 (data1_v, data2_v, vl);
