...
int main(){
    const int32_t data1[] = {
    -60, 39, -48, 46, 100, 40, -32, 64, 100, -83, 123, -63, 91, -38, -118, -22
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -54, 78, -11, -53, 20, -2, 39, -37, 94, -39, 10, 18, 66, -59, 80, 126
    };
    ...
    int32_t golden[] = {
    3240, 3042, 528, 4294964858, 2000, 4294967216, 4294966048, 4294964928, 9400, 3237, 1230, 4294966162, 6006, 2242, 4294957856, 4294964524
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
