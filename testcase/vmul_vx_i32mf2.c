...
int main(){
    const int32_t data1[] = {
    -4, -51, -45, 112, -66, -91, 78, 58, 55, -35, -116, 80, -110, -115, -7, 110
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    112, -116, -102, 74, -100, -104, 36, -35, -20, -79, -23, 104, -63, -4, 46, 79
    };
    ...
    int32_t golden[] = {
    4294966848, 5916, 4590, 8288, 6600, 9464, 2808, 4294965266, 4294966196, 2765, 2668, 8320, 6930, 460, 4294966974, 8690
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
