...
int main(){
    ...
    178, 201, 139, 182, 53, 149, 130, 194, 222, 199, 28, 163, 35, 223, 83, 58
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    79, 101, 105, 248, 200, 124, 67, 60, 120, 91, 252, 45, 244, 235, 169, 118
    };
    ...
    uint32_t golden[] = {
    0, 0, 0, 0, 0, 1, 197, 0, 342, 290, 1, 208, 279, 458, 1, 176
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
