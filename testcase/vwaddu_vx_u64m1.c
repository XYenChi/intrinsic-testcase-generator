...
int main(){
    ...
    167, 13, 238, 44, 203, 18, 143, 120, 134, 0, 167, 78, 226, 3, 27, 82
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    72, 140, 137, 244, 4, 86, 146, 248, 237, 156, 72, 82, 94, 194, 174, 23
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u64m1 (data1_v, data2_v, vl);
