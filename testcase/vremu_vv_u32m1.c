...
int main(){
    ...
    190, 19, 158, 92, 27, 22, 6, 150, 203, 23, 212, 161, 124, 193, 51, 225
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    189, 62, 191, 181, 116, 238, 172, 209, 73, 15, 71, 109, 198, 197, 122, 18
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u32m1 (data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    189, 5, 33, 89, 8, 18, 4, 59, 73, 15, 71, 109, 74, 4, 20, 18
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
