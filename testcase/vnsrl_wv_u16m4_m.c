...
int main(){
    ...
    64, 172, 118, 244, 88, 84, 141, 211, 88, 183, 189, 145, 43, 108, 252, 14
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    38, 255, 192, 176, 144, 191, 23, 128, 160, 245, 2, 76, 234, 217, 16, 78
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_16m4_m (mask, data1_v, shift, vl);
