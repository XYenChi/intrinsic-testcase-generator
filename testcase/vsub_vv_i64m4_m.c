...
int main(){
    const int64_t data1[] = {
    -6, 38, -15, -4, -72, 118, 102, 27, 21, 84, -93, 39, 119, 19, -75, 36
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    98, 12, 65, -55, -87, 26, -76, 7, -119, 69, -119, -79, -113, -7, 68, 66
    };
    ...
    int64_t golden[] = {
    18446744073709551512, 26, 1, 0, 15, 0, 0, 0, 1, 15, 26, 0, 232, 0, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
