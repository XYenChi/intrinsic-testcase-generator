...
int main(){
    const int64_t data1[] = {
    -85, 82, -43, 63, -93, -78, 89, -53, 4, -9, 5, 49, -37, -52, -34, 110
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    49, 18, -112, -46, 53, -107, -96, 119, -71, -42, 127, 87, -124, 91, -110, 32
    };
    ...
    int64_t golden[] = {
    1, 1, 1, 109, 18446744073709551470, 29, 0, 18446744073709551444, 75, 33, 0, 18446744073709551578, 1, 1, 76, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
