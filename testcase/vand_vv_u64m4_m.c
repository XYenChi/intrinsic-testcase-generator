...
int main(){
    ...
    113, 69, 51, 226, 209, 81, 180, 96, 243, 172, 29, 175, 205, 49, 3, 82
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    224, 118, 44, 176, 204, 155, 59, 15, 80, 18, 60, 104, 49, 97, 210, 171
    };
    ...
    uint64_t golden[] = {
    1, 118, 44, 176, 204, 1, 0, 1, 80, 1, 60, 0, 0, 1, 0, 171
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
