...
int main(){
    const uint8_t data1[] = {
    116, 78, 145, 36, 205, 171, 56, 245, 70, 58, 116, 223, 125, 188, 32, 198
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    136, 229, 255, 52, 199, 215, 70, 0, 26, 133, 9, 161, 140, 94, 152, 101
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vrsub_vx_u8m4_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    20, 0, 110, 16, 0, 0, 14, 11, 0, 75, 149, 1, 0, 162, 120, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
