...
int main(){
    const uint8_t data1[] = {
    118, 226, 5, 193, 90, 93, 130, 23, 121, 84, 128, 118, 228, 180, 7, 12
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    183, 140, 192, 30, 72, 22, 194, 222, 56, 105, 70, 13, 181, 187, 238, 240
    };
    ...
    uint8_t golden[] = {
    91, 153, 192, 158, 81, 254, 133, 243, 120, 116, 1, 255, 52, 125, 130, 65
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
