...
int main(){
    const int8_t data1[] = {
    -87, 19, -56, 58, 118, 32, 118, -80, 108, -98, 127, -48, -106, -88, 71, -107
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    46, -84, -118, -44, -90, 65, 47, 92, 8, -27, 38, -13, -19, -66, -41, 115
    };
    ...
    int8_t golden[] = {
    -41, -64, -174, 14, 28, 97, 166, 13, 116, -124, 165, -60, -125, -153, 31, 8
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
