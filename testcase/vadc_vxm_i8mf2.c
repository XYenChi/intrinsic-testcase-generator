...
int main(){
    const int8_t data1[] = {
    37, -49, 17, 66, -125, 123, -74, -50, 58, -93, 78, -51, -3, -13, -18, -99
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -36, 104, 33, 53, -20, -59, -120, 112, -75, -46, -44, 45, 52, -101, 48, -97
    };
    ...
    int8_t golden[] = {
    2, 55, 50, 120, -145, 64, -194, 62, -16, -139, 35, -5, 49, -114, 30, -195
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
