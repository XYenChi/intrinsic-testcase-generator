...
int main(){
    ...
    140, 192, 7, 222, 2, 103, 192, 224, 57, 166, 93, 35, 229, 126, 194, 153
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    255, 86, 124, 167, 203, 211, 226, 92, 103, 231, 62, 109, 9, 109, 81, 80
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u32m4 (data1_v, shift, vl);
