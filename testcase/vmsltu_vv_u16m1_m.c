...
int main(){
    ...
    246, 8, 121, 111, 193, 176, 56, 38, 195, 148, 235, 119, 79, 208, 68, 174
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    11, 141, 16, 150, 171, 226, 150, 92, 125, 157, 163, 191, 207, 37, 128, 39
    };
    const uint16_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e16m1(avl);
    const uint out_data[] = {
    1, 1, 1, 0, 1, 1, 0, 1, 0, 0, 0, 0, 0, 1, 1, 1
    };
    const uint16_t *out = &out_data[0];
    uint16_t masked[] = {
    1, 0, 0, 0, 0, 1, 0, 1, 1, 1, 0, 0, 1, 0, 0, 0
    };
