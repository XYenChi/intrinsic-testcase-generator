...
int main(){
    ...
    216, 145, 156, 8, 216, 35, 156, 38, 65, 190, 81, 84, 40, 77, 138, 131
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    181, 90, 172, 187, 128, 127, 228, 91, 225, 190, 142, 31, 188, 57, 161, 188
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i16m8 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    0, 0, 1, 23, 0, 3, 1, 2, 3, 1, 1, 0, 4, 0, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
