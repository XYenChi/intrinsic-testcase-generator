...
int main(){
    const int8_t data1[] = {
    102, -21, -103, 85, -119, 112, 101, 54, -45, 127, -116, -61, -25, 121, 76, -46
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -62, -72, -119, 106, 31, -96, 126, 45, 65, -111, -117, -94, -36, -58, -111, -78
    };
    ...
    int8_t golden[] = {
    76, 232, 225, 50, 151, 0, 182, 126, 147, 239, 4, 102, 132, 150, 12, 4
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
