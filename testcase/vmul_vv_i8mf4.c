...
int main(){
    const int8_t data1[] = {
    78, 62, 113, -102, -22, -91, 125, -16, 82, -79, -83, 121, 52, 7, 19, -90
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    17, -106, -66, -89, 43, 126, 81, 53, -116, 92, 121, -124, -55, -17, 116, 22
    };
    ...
    int8_t golden[] = {
    46, 84, 222, 118, 78, 54, 141, 176, 216, 156, 197, 100, 212, 137, 156, 68
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
