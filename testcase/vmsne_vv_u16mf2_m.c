...
int main(){
    ...
    152, 225, 87, 25, 246, 50, 96, 248, 10, 167, 225, 194, 77, 165, 66, 102
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    193, 13, 184, 196, 191, 72, 249, 14, 103, 105, 79, 157, 121, 164, 246, 111
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_16mf2_b32_m (mask, data1_v, data2_v, vl);
