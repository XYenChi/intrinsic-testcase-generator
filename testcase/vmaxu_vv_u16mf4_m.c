...
int main(){
    ...
    176, 31, 208, 181, 140, 183, 44, 75, 206, 6, 36, 192, 65, 80, 176, 177
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    178, 60, 127, 202, 37, 15, 197, 193, 217, 20, 171, 254, 224, 120, 54, 25
    };
    ...
    uint16_t golden[] = {
    0, 60, 0, 202, 140, 0, 197, 1, 1, 20, 171, 254, 224, 120, 176, 177
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
