...
int main(){
    const uint8_t data1[] = {
    180, 145, 122, 85, 210, 215, 71, 145, 18, 130, 166, 98, 207, 175, 102, 232
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    24, 34, 224, 4, 25, 43, 189, 134, 81, 251, 220, 89, 130, 158, 196, 106
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u8mf8_m (mask, data1_v, shift, vl);
    ...
    uint8_t golden[] = {
    180, 145, 122, 85, 105, 107, 35, 145, 9, 65, 166, 49, 207, 175, 102, 232
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
