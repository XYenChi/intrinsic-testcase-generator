...
int main(){
    const uint8_t data1[] = {
    221, 61, 148, 233, 199, 129, 165, 205, 207, 172, 59, 35, 194, 188, 45, 134
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    248, 5, 249, 137, 66, 62, 178, 247, 169, 184, 226, 198, 89, 142, 111, 177
    };
    ...
    uint8_t golden[] = {
    248, 61, 249, 233, 199, 129, 178, 247, 207, 184, 226, 198, 194, 188, 111, 177
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
