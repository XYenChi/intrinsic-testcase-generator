...
int main(){
    const uint8_t data1[] = {
    36, 135, 85, 93, 10, 211, 163, 28, 112, 91, 31, 220, 43, 52, 222, 59
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    204, 194, 24, 43, 146, 109, 88, 132, 195, 210, 203, 197, 101, 231, 51, 210
    };
    ...
    uint8_t golden[] = {
    204, 194, 85, 93, 146, 211, 163, 132, 195, 210, 203, 220, 101, 231, 222, 210
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
