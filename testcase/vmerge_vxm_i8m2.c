...
int main(){
    const int8_t data1[] = {
    97, 19, 52, 116, -108, -42, -8, 10, -82, -83, -122, 126, 114, 10, 113, -25
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -99, -78, 116, 96, 127, 62, 71, 67, 123, 76, -50, -93, -122, 112, -49, -96
    };
    ...
    int8_t golden[] = {
    97, 19, 52, 96, -108, -42, 71, 67, -82, -83, -122, -93, -122, 10, -49, -96
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
