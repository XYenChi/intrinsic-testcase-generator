...
int main(){
    const uint8_t data1[] = {
    47, 4, 104, 120, 205, 118, 187, 51, 53, 56, 124, 126, 243, 249, 77, 42
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    93, 170, 221, 111, 164, 0, 163, 151, 10, 52, 119, 106, 219, 91, 52, 178
    };
    ...
    uint8_t golden[] = {
    1, 0, 221, 111, 164, 1, 0, 0, 10, 1, 119, 106, 0, 91, 52, 178
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
