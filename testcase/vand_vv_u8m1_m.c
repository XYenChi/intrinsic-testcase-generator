...
int main(){
    const uint8_t data1[] = {
    46, 37, 100, 31, 29, 71, 225, 88, 106, 205, 111, 95, 215, 4, 37, 69
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    45, 127, 195, 141, 68, 36, 124, 209, 48, 105, 35, 119, 19, 137, 150, 194
    };
    ...
    uint8_t golden[] = {
    45, 0, 0, 141, 68, 36, 124, 0, 1, 105, 35, 119, 1, 137, 150, 194
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
