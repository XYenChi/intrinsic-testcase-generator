...
int main(){
    const int8_t data1[] = {
    -82, 65, 70, -1, 29, -58, -17, 2, -80, 47, 97, -54, 26, 3, 4, -59
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    86, -28, -4, 8, -111, -89, 59, -18, -67, 111, 59, -119, 92, -104, 95, -15
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulsu_vx_i8m1_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    0, 0, 0, 248, 0, 0, 1, 1, 240, 97, 91, 26, 1, 0, 124, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
