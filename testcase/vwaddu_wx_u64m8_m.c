...
int main(){
    ...
    180, 19, 98, 36, 9, 225, 152, 196, 77, 25, 214, 109, 30, 251, 10, 123
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    196, 16, 127, 30, 196, 164, 4, 83, 45, 42, 143, 81, 47, 99, 210, 135
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u64m8_m (mask, data1_v, data2_v, vl);
