...
int main(){
    const int32_t data1[] = {
    42, -92, -71, -97, -20, -112, 55, -117, 108, 11, -76, 109, -112, 121, 64, -93
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -63, -75, 3, -10, -127, -106, -25, -116, 90, 0, -57, 7, 94, 52, 49, -16
    };
    ...
    int32_t golden[] = {
    0, 1, 1, 0, 4294967169, 1, 0, 0, 90, 1, 4294967239, 1, 94, 52, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
