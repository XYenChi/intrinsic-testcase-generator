...
int main(){
    ...
    169, 54, 43, 18, 205, 35, 245, 120, 61, 115, 124, 1, 255, 30, 147, 162
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    69, 43, 163, 54, 45, 69, 123, 143, 4, 61, 43, 146, 238, 67, 92, 231
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_16m2_b8 (data1_v, data2_v, vl);
