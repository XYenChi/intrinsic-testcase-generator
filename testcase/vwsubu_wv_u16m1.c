...
int main(){
    ...
    37, 14, 49, 233, 228, 228, 15, 114, 119, 96, 64, 95, 245, 239, 69, 254
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    123, 93, 53, 25, 144, 240, 5, 173, 210, 126, 243, 10, 105, 49, 245, 230
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u16m1 (data1_v, data2_v, vl);
