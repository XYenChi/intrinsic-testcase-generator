...
int main(){
    const int32_t data1[] = {
    123, 108, -123, -116, -46, -126, 68, -11, 93, 25, 111, 114, -54, 58, -25, 11
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    99, -37, -86, -36, 16, -27, -57, 6, 101, -23, 56, 30, 23, 4, -21, 12
    };
    ...
    int32_t golden[] = {
    99, 4294967259, 4294967210, 4294967260, 16, 4294967269, 4294967239, 6, 101, 4294967273, 56, 30, 23, 4, 4294967275, 12
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
