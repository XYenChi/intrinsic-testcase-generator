...
int main(){
    const uint8_t data1[] = {
    19, 228, 212, 152, 16, 210, 214, 122, 58, 106, 227, 240, 65, 82, 180, 22
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    121, 208, 209, 205, 140, 203, 56, 26, 118, 251, 108, 191, 245, 86, 129, 249
    };
    ...
    uint8_t golden[] = {
    38, 228, 424, 304, 16, 420, 214, 122, 58, 212, 227, 480, 130, 82, 360, 44
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
