...
int main(){
    ...
    162, 145, 67, 85, 250, 173, 81, 40, 126, 112, 191, 128, 118, 197, 24, 175
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    7, 178, 21, 163, 39, 165, 221, 73, 34, 163, 13, 176, 21, 185, 253, 98
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u16mf4 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    7, 33, 21, 78, 39, 165, 59, 33, 34, 51, 13, 48, 21, 185, 13, 98
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
