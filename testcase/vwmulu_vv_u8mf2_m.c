...
int main(){
    const uint8_t data1[] = {
    125, 73, 150, 192, 140, 168, 202, 189, 142, 193, 65, 94, 200, 105, 0, 128
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    83, 248, 160, 80, 8, 46, 88, 87, 239, 210, 42, 54, 45, 173, 168, 37
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulu_vv_u8mf2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    135, 184, 192, 0, 96, 1, 1, 59, 146, 0, 170, 0, 40, 245, 1, 128
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
