...
int main(){
    ...
    90, 252, 203, 5, 179, 255, 229, 84, 218, 242, 207, 115, 36, 0, 132, 136
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    138, 77, 100, 219, 251, 175, 218, 202, 254, 58, 13, 4, 88, 139, 22, 245
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u32m8 (data1_v, shift, vl);
