...
int main(){
    const int16_t data1[] = {
    -63, -127, -108, -29, -116, -102, -89, -28, 89, -32, -121, -128, -38, 68, 127, 30
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -45, 7, 100, -34, -119, 22, 66, -127, -75, -4, -126, -60, -111, -59, 92, 57
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vv_16mf4_b64 (data1_v, data2_v, vl);
