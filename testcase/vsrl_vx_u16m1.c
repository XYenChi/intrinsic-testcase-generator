...
int main(){
    ...
    216, 251, 118, 192, 19, 173, 0, 126, 107, 150, 133, 17, 173, 60, 48, 139
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    82, 100, 47, 222, 160, 197, 51, 54, 100, 55, 73, 99, 165, 42, 207, 173
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u16m1 (data1_v, shift, vl);
