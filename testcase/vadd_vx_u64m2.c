...
int main(){
    ...
    251, 120, 85, 231, 235, 172, 104, 173, 210, 230, 50, 175, 33, 212, 159, 155
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    177, 136, 35, 225, 31, 207, 89, 71, 48, 56, 70, 247, 148, 81, 219, 25
    };
    ...
    uint64_t golden[] = {
    428, 256, 120, 456, 266, 379, 193, 244, 258, 286, 120, 422, 181, 293, 378, 180
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
