...
int main(){
    const int8_t data1[] = {
    -29, -36, 14, -59, -85, 50, -15, 77, 109, -128, -19, 125, -13, -94, -52, 34
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    6, -91, -12, -54, -9, 66, -115, -96, 46, -108, -89, 66, -4, -15, 113, -16
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vadd_vx_u8mf2 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    -61, -28, 120, -64, 16, 145, 47, 112, 147, -175, 43, 128, -70, -199, -36, -26
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
