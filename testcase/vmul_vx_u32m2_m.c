...
int main(){
    ...
    222, 87, 73, 94, 215, 216, 201, 72, 138, 36, 186, 15, 10, 14, 7, 126
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    0, 177, 75, 34, 168, 173, 20, 253, 124, 95, 43, 219, 29, 88, 249, 81
    };
    ...
    uint32_t golden[] = {
    1, 0, 1, 1, 0, 1, 1, 18216, 17112, 3420, 7998, 1, 290, 1232, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
