...
int main(){
    ...
    73, 216, 80, 68, 238, 192, 104, 190, 25, 126, 9, 146, 18, 5, 35, 38
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    129, 41, 204, 202, 19, 25, 86, 174, 96, 33, 94, 229, 130, 151, 9, 40
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u64m2 (data1_v, data2_v, vl);
