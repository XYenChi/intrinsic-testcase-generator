...
int main(){
    const int8_t data1[] = {
    -78, -125, -34, 12, -109, -24, 24, -43, 14, 8, 48, -114, -112, 10, 102, 12
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    18, 111, 76, -103, 110, 126, 104, 6, -19, 124, -83, -14, 11, 7, -75, -26
    };
    ...
    int8_t golden[] = {
    132, 205, 233, 45, 43, 49, 193, 255, 246, 224, 112, 61, 49, 70, 30, 201
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
