...
int main(){
    const uint8_t data1[] = {
    29, 147, 152, 105, 55, 51, 138, 175, 44, 12, 144, 243, 223, 88, 120, 243
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    153, 102, 40, 211, 222, 17, 128, 43, 132, 173, 179, 188, 127, 45, 201, 69
    };
    ...
    uint8_t golden[] = {
    0, 0, 1, 117, 1, 158, 1, 155, 80, 0, 80, 1, 1, 136, 200, 130
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
