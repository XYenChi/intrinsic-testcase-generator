...
int main(){
    ...
    85, 154, 161, 234, 178, 198, 116, 9, 56, 218, 49, 106, 99, 50, 255, 50
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    53, 4, 10, 225, 146, 188, 42, 118, 128, 3, 18, 252, 249, 107, 224, 76
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u64m8 (data1_v, data2_v, vl);
