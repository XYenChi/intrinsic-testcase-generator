...
int main(){
    const int32_t data1[] = {
    46, -59, 50, 126, -17, 71, -38, 80, 78, -37, -73, 50, 54, 22, 108, -34
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    8, -116, 60, 57, -116, -54, 90, -122, -111, 43, 69, -1, -104, -26, -58, 6
    };
    ...
    int32_t golden[] = {
    46, 4294967237, 60, 126, 4294967279, 71, 90, 80, 78, 43, 69, 50, 54, 22, 108, 6
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
