...
int main(){
    const uint8_t data1[] = {
    198, 179, 62, 255, 210, 135, 140, 45, 99, 17, 132, 46, 101, 66, 233, 203
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    97, 56, 233, 190, 19, 117, 126, 33, 157, 113, 98, 108, 191, 174, 209, 12
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulu_vv_u8m8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 40, 110, 1, 150, 1, 232, 205, 1, 129, 136, 0, 91, 220, 57, 132
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
