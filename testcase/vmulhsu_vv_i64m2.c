...
int main(){
    const int64_t data1[] = {
    49, 79, -2, -73, -39, 34, -127, 25, -40, -107, 25, -102, -65, 98, -81, -90
    };
    const int64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    204, 253, 173, 239, 4, 62, 31, 107, 221, 22, 100, 163, 26, 123, 200, 227
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_64m2_b32 (data1_v, data2_v, vl);
