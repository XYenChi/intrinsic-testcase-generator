...
int main(){
    const int8_t data1[] = {
    -112, 84, -104, 7, -83, -32, -53, -107, 9, -15, 109, 78, 88, -23, -2, 126
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    69, 1, -94, -29, 29, -127, -99, 23, 118, 60, 38, -34, -38, -84, 122, -125
    };
    ...
    int8_t golden[] = {
    69, 84, 162, 7, 29, 224, 203, 23, 118, 60, 109, 78, 88, 233, 122, 126
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
