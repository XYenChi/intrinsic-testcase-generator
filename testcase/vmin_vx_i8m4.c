...
int main(){
    const int8_t data1[] = {
    8, 49, 22, 5, 236, 236, 76, 252, 168, 201, 234, 87, 244, 132, 225, 153
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    240, 256, 97, 19, 250, 177, 14, 230, 23, 79, 158, 146, 130, 182, 107, 215
    };
    ...
    int8_t golden[] = {
    240, 256, 97, 19, 250, 236, 76, 252, 168, 201, 234, 146, 244, 182, 225, 215
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
