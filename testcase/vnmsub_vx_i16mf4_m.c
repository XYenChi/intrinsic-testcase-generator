...
int main(){
    const int16_t data1[] = {
    -101, 71, 37, 30, 24, -109, -10, -66, -37, -27, 32, -13, 99, 65, -101, 68
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    109, -59, -70, 35, 57, -43, 13, -67, 44, -37, -37, 102, 122, -114, -93, -69
    };
    ...
    int16_t golden[] = {
    65435, 130, 1, 65531, 1, 0, 1, 65470, 0, 1, 69, 1, 1, 65, 65435, 137
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
