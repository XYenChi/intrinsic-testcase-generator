...
int main(){
    const int16_t data1[] = {
    83, -117, -90, 120, 122, -112, -14, -89, 49, -124, -29, 79, -103, -9, 77, 91
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -64, 10, 53, -111, 67, 30, 24, 90, -74, 76, -124, 78, -7, 92, 95, 32
    };
    ...
    int16_t golden[] = {
    19, -107, -37, 9, 190, -81, 10, 2, -25, -47, -153, 158, -110, 84, 172, 123
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
