...
int main(){
    ...
    75, 222, 82, 119, 241, 140, 248, 185, 162, 53, 127, 118, 24, 89, 125, 35
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    240, 20, 30, 64, 22, 158, 164, 148, 129, 69, 69, 171, 245, 162, 167, 108
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u64m2_m (mask, data1_v, data2_v, vl);
