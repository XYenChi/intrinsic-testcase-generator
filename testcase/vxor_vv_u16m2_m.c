...
int main(){
    ...
    93, 251, 74, 127, 186, 70, 91, 124, 131, 4, 91, 36, 96, 163, 91, 102
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    245, 123, 244, 176, 250, 166, 193, 145, 210, 92, 245, 135, 255, 34, 21, 227
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u16m2_m (mask, data1_v, data2_v, vl);
