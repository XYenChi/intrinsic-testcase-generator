...
int main(){
    const int32_t data1[] = {
    47, -95, -43, 22, 64, -106, -43, 56, 24, 90, -112, 91, -47, 87, 28, 106
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    9, 125, -49, 9, 39, 61, 62, -86, 121, -2, 121, -9, 52, 65, 70, -121
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_32mf2_b64_m (mask, data1_v, data2_v, vl);
