...
int main(){
    ...
    22, 111, 72, 239, 57, 74, 169, 123, 94, 251, 213, 40, 162, 180, 124, 149
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnot_v_u32m4 (data1_v, vl);
    ...
    uint32_t golden[] = {
    -23, -112, -73, -240, -58, -75, -170, -124, -95, -252, -214, -41, -163, -181, -125, -150
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
