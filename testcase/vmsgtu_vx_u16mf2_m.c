...
int main(){
    ...
    233, 217, 145, 223, 87, 242, 13, 179, 11, 220, 194, 190, 238, 93, 35, 1
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    16, 254, 170, 229, 49, 47, 138, 75, 79, 201, 73, 100, 22, 237, 97, 255
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_16mf2_b32_m (mask, data1_v, data2_v, vl);
