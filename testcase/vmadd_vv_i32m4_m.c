...
int main(){
    const int32_t data1[] = {
    -53, 29, -91, 100, -119, -126, -24, -38, -88, -106, 36, 47, 103, -67, -66, -78
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    59, -23, -86, -114, 110, 27, -120, 120, 100, 79, -94, 124, 22, -20, -2, -61
    };
    ...
    int32_t golden[] = {
    6, 29, 4294967119, 4294967182, 4294967287, 4294967170, 4294967272, 120, 12, 4294967190, 36, 124, 103, 4294967209, 4294967230, 4294967218
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
