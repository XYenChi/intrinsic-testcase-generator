...
int main(){
    ...
    191, 35, 9, 247, 34, 38, 7, 170, 181, 22, 55, 221, 70, 50, 95, 203
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    120, 31, 139, 97, 203, 93, 215, 23, 54, 254, 181, 108, 47, 108, 153, 94
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_32mf2_b64 (data1_v, data2_v, vl);
