...
int main(){
    ...
    43, 90, 188, 103, 15, 216, 187, 2, 151, 80, 63, 17, 101, 157, 18, 97
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    242, 66, 72, 70, 18, 19, 238, 110, 0, 6, 221, 137, 118, 37, 51, 81
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_32m2_m (mask, data1_v, shift, vl);
