...
int main(){
    ...
    123, 231, 183, 38, 147, 88, 34, 232, 169, 91, 67, 76, 142, 169, 193, 9
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    67, 227, 139, 26, 232, 211, 100, 234, 153, 69, 50, 129, 8, 71, 210, 146
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_32m2_b16_m (mask, data1_v, data2_v, vl);
