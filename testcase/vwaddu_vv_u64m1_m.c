...
int main(){
    ...
    121, 8, 61, 103, 119, 6, 180, 28, 141, 101, 132, 123, 244, 82, 50, 12
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    7, 6, 125, 29, 104, 140, 91, 57, 167, 4, 248, 71, 100, 80, 85, 111
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u64m1_m (mask, data1_v, data2_v, vl);
