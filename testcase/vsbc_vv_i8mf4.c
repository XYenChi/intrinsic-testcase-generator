...
int main(){
    const int8_t data1[] = {
    80, 168, 196, 115, 175, 199, 178, 116, 136, 105, 100, 232, 73, 1, 29, 219
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    83, 67, 190, 185, 172, 104, 115, 64, 219, 54, 188, 61, 47, 21, 100, 117
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsbc_vv_i8mf4 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    -3, 101, 6, -70, 3, 95, 63, 52, -83, 51, -88, 171, 26, -20, -71, 102
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
