...
int main(){
    const int32_t data1[] = {
    -112, 111, 14, -48, 93, -105, -36, 110, -35, 27, 92, -56, 81, -48, -42, -121
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -19, -55, -110, 8, -117, 123, -63, -76, 64, 73, 12, -95, 75, -80, -48, 117
    };
    ...
    int32_t golden[] = {
    4294967277, 56, 1, 0, 0, 4294967209, 4294967269, 1, 1, 19, 1, 4294967257, 0, 4294967264, 0, 4294967292
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
