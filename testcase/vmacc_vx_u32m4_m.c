...
int main(){
    ...
    100, 66, 177, 89, 178, 244, 213, 61, 150, 28, 236, 12, 164, 253, 126, 65
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    206, 203, 29, 233, 134, 213, 244, 235, 75, 251, 123, 132, 182, 183, 185, 168
    };
    ...
    uint32_t golden[] = {
    20601, 0, 1, 20738, 23853, 51973, 51973, 1, 11250, 7029, 29029, 1584, 1, 0, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
