...
int main(){
    ...
    27, 59, 79, 7, 169, 137, 223, 71, 141, 53, 104, 12, 254, 73, 186, 255
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    252, 248, 242, 41, 109, 200, 153, 77, 192, 142, 137, 75, 37, 14, 7, 222
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u32m2 (data1_v, data2_v, vl);
