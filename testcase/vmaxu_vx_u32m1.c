...
int main(){
    ...
    132, 26, 246, 204, 242, 133, 90, 74, 44, 149, 203, 223, 5, 0, 79, 124
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    244, 92, 53, 50, 120, 138, 224, 65, 75, 24, 96, 190, 237, 117, 191, 161
    };
    ...
    uint32_t golden[] = {
    244, 92, 246, 204, 242, 138, 224, 74, 75, 149, 203, 223, 237, 117, 191, 161
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
