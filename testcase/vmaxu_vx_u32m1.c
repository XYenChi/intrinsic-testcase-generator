...
int main(){
    ...
    106, 17, 36, 9, 82, 245, 51, 175, 186, 205, 77, 12, 126, 238, 70, 207
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    158, 58, 253, 88, 226, 143, 2, 246, 201, 231, 150, 239, 112, 185, 99, 91
    };
    ...
    uint32_t golden[] = {
    158, 58, 253, 88, 226, 245, 51, 246, 201, 231, 150, 239, 126, 238, 99, 207
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
