...
int main(){
    const int32_t data1[] = {
    11, -72, -32, -110, -102, -60, 118, 103, 78, -66, 85, -71, 87, 0, -20, -57
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -37, 94, 108, 33, 64, -98, 32, 92, -38, -19, -16, 112, 106, 42, 0, -47
    };
    ...
    int32_t golden[] = {
    4294967259, 0, 108, 1, 0, 4294967198, 32, 92, 0, 4294967277, 0, 1, 1, 0, 1, 4294967249
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
