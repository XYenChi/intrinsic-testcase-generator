...
int main(){
    const int32_t data1[] = {
    -64, 126, -54, 19, 92, -38, -10, -25, 78, 39, -89, -20, 85, 109, 102, 48
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -10, -118, -92, 105, -103, -76, 76, -84, 52, -36, -99, 10, -114, 28, -41, 108
    };
    ...
    int32_t golden[] = {
    0, 1, 4294967204, 0, 0, 1, 1, 4294967212, 52, 4294967260, 4294967197, 0, 4294967182, 28, 4294967255, 108
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
