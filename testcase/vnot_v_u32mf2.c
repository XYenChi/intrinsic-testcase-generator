...
int main(){
    ...
    84, 86, 140, 27, 7, 116, 218, 68, 175, 168, 158, 235, 46, 227, 110, 198
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnot_v_u32mf2 (data1_v, vl);
    ...
    uint32_t golden[] = {
    -85, -87, -141, -28, -8, -117, -219, -69, -176, -169, -159, -236, -47, -228, -111, -199
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
