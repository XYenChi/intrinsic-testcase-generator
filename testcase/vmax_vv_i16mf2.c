...
int main(){
    const int16_t data1[] = {
    -99, -6, 46, 3, 93, 83, -21, 120, 19, -7, -72, -50, 11, 6, -117, -76
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -77, 33, -12, -66, -73, 125, 31, -72, 87, 36, -118, -14, 62, -6, -46, -108
    };
    ...
    int16_t golden[] = {
    65459, 33, 46, 3, 93, 125, 31, 120, 87, 36, 65464, 65522, 62, 6, 65490, 65460
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
