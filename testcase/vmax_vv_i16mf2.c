...
int main(){
    const int16_t data1[] = {
    -75, -8, 52, 96, 89, -5, -94, -56, -112, 112, 10, -102, -90, 71, 27, 2
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    63, 8, -119, -76, 111, -94, 41, -115, 120, 72, 76, 17, 89, 38, -37, -8
    };
    ...
    int16_t golden[] = {
    63, 8, 52, 96, 111, 65531, 41, 65480, 120, 112, 76, 17, 89, 71, 27, 2
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
