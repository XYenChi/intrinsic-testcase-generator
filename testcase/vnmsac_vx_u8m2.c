...
int main(){
    const uint8_t data1[] = {
    121, 176, 246, 38, 239, 120, 48, 159, 206, 173, 223, 57, 216, 220, 114, 147
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    71, 118, 38, 169, 90, 179, 132, 119, 64, 96, 100, 226, 235, 242, 201, 54
    };
    ...
    uint8_t golden[] = {
    113, 225, 124, 234, 250, 24, 65, 24, 128, 32, 229, 174, 185, 9, 127, 255
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
