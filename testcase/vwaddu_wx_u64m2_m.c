...
int main(){
    ...
    77, 15, 17, 176, 75, 116, 182, 190, 211, 198, 173, 69, 100, 30, 177, 205
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    148, 76, 194, 214, 117, 165, 238, 241, 17, 48, 84, 147, 108, 7, 9, 103
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u64m2_m (mask, data1_v, data2_v, vl);
