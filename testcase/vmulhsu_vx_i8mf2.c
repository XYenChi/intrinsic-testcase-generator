...
int main(){
    const int8_t data1[] = {
    117, 2, -115, 13, 49, -58, 63, -87, 77, -97, -13, 64, 82, -6, 14, -21
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    86, 135, 77, 57, 195, 94, 128, 82, 227, 128, 174, 166, 15, 235, 154, 161
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_8mf2_b16 (data1_v, data2_v, vl);
