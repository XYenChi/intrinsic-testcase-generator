...
int main(){
    ...
    32, 12, 149, 103, 108, 39, 143, 222, 78, 83, 144, 127, 171, 251, 191, 65
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    5, 102, 232, 10, 70, 173, 178, 1, 136, 128, 112, 93, 240, 208, 137, 113
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_64m2_b32 (data1_v, data2_v, vl);
