...
int main(){
    ...
    186, 23, 7, 199, 71, 253, 151, 5, 215, 239, 4, 248, 37, 233, 132, 132
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    75, 150, 103, 91, 125, 235, 76, 64, 137, 6, 78, 52, 48, 208, 201, 119
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u16m2_m (mask, data1_v, data2_v, vl);
