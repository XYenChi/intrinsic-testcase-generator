...
int main(){
    const int16_t data1[] = {
    -26, 102, 7, 28, -28, 5, 19, 15, 81, -125, -78, 46, 33, -28, 27, 67
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    63, -63, -48, -73, 12, -8, -48, 66, 126, 40, 3, -74, -19, 43, -113, 70
    };
    ...
    int16_t golden[] = {
    63898, 59111, 65200, 63492, 65200, 65497, 64624, 991, 10207, 60537, 65303, 62133, 64909, 64333, 62485, 4691
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
