...
int main(){
    const int16_t data1[] = {
    -46, -127, 95, 121, 6, 9, 123, -127, -71, 79, 86, -53, 17, 21, 82, 15
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    118, 96, -102, -107, -68, 42, 69, 116, 70, 51, -50, 122, 110, 87, -114, -28
    };
    ...
    int16_t golden[] = {
    60109, 53344, 55846, 52590, 65128, 378, 8487, 50804, 60567, 4029, 61236, 59071, 1870, 1828, 56189, 65117
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
