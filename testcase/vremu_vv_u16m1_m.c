...
int main(){
    ...
    145, 87, 247, 180, 163, 229, 160, 113, 101, 214, 127, 121, 60, 194, 128, 218
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    179, 10, 63, 34, 197, 54, 200, 189, 96, 244, 155, 87, 34, 225, 112, 231
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u16m1_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    0, 10, 63, 34, 34, 0, 0, 0, 96, 1, 28, 87, 34, 31, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
