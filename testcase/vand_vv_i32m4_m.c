...
int main(){
    const int32_t data1[] = {
    -40, -41, -38, -12, 91, -60, 45, 11, -100, 64, -94, 113, -62, 58, -72, -7
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    47, -103, 21, -83, 17, -105, 66, 53, -74, 118, 78, -49, -29, 21, -57, -85
    };
    ...
    int32_t golden[] = {
    47, 4294967193, 0, 4294967213, 17, 0, 66, 53, 4294967222, 0, 78, 4294967247, 4294967267, 0, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
