...
int main(){
    ...
    176, 100, 197, 173, 64, 14, 59, 211, 214, 159, 29, 214, 181, 247, 229, 182
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    123, 214, 212, 208, 165, 64, 30, 189, 38, 114, 27, 11, 2, 13, 240, 55
    };
    ...
    uint16_t golden[] = {
    21649, 21401, 41764, 35984, 10561, 1, 1770, 0, 8132, 1, 0, 2354, 1, 3212, 0, 10011
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
