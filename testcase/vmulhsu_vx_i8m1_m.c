...
int main(){
    const int8_t data1[] = {
    84, 80, -52, -48, 124, 106, -79, -25, -81, -85, 3, -100, 119, -128, -68, -60
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    247, 91, 213, 174, 213, 82, 25, 75, 252, 249, 213, 59, 154, 26, 157, 21
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_8m1_b8 (mask, data1_v, data2_v, vl);
