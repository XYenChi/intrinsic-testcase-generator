...
int main(){
    ...
    61, 252, 85, 130, 99, 137, 157, 217, 238, 216, 19, 171, 217, 170, 73, 136
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    225, 115, 26, 77, 66, 99, 254, 208, 93, 248, 178, 144, 58, 109, 234, 140
    };
    ...
    uint64_t golden[] = {
    225, 252, 0, 130, 99, 0, 1, 1, 238, 248, 1, 171, 0, 170, 0, 140
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
