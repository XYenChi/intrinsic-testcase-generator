...
int main(){
    const int16_t data1[] = {
    11, 41, -11, 124, -60, -64, 105, -123, 62, -67, 105, 27, -96, 70, -123, -49
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    24, -59, 60, -26, 89, -37, -35, 55, 111, 3, 81, 4, -5, -4, 47, 102
    };
    ...
    int16_t golden[] = {
    264, 63117, 64876, 62313, 60196, 2368, 61861, 58772, 6882, 65336, 8506, 108, 480, 65256, 59756, 60539
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
