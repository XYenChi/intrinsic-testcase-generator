...
int main(){
    const int16_t data1[] = {
    -7, 7, 104, -103, -9, -121, -62, -42, 6, -16, 87, -60, -55, -80, 77, 1
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    60, 66, 65, 79, -77, -109, -84, -62, 16, -7, 114, 92, -72, 12, -99, -105
    };
    ...
    int16_t golden[] = {
    65116, 463, 6760, 57400, 693, 13189, 5208, 2605, 96, 112, 9919, 60016, 3960, 64577, 57914, 65431
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
