...
int main(){
    const int32_t data1[] = {
    81, 28, -114, -37, -107, -76, 97, 125, 118, -23, 13, -26, -50, 38, 6, -102
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -120, -40, -11, 1, -90, -51, -89, 93, 65, -29, -77, -37, 122, -13, 36, 104
    };
    ...
    int32_t golden[] = {
    1, 1, 1, 1, 4294967206, 4294967245, 0, 125, 1, 0, 0, 0, 0, 0, 36, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
