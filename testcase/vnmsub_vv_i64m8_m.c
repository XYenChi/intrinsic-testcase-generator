...
int main(){
    const int64_t data1[] = {
    -49, 126, 86, -66, -10, -45, -11, 62, -4, 107, -77, 88, 39, 40, -100, 115
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -29, 45, -70, -92, -29, 121, -82, -24, -6, -7, 9, 15, -97, 32, -110, 109
    };
    ...
    int64_t golden[] = {
    1, 126, 0, 0, 19, 18446744073709551571, 71, 62, 1, 0, 18446744073709551539, 1, 39, 0, 10, 115
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
