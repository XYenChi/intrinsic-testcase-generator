...
int main(){
    const int32_t data1[] = {
    -48, 2, 52, 99, -2, -110, 80, -95, -28, -4, 122, 33, 36, 47, 114, 67
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    72, 95, 26, 57, -102, -29, -1, -91, -14, -21, -59, -22, -125, 56, 16, -64
    };
    ...
    int32_t golden[] = {
    4294963841, 191, 0, 5644, 205, 1, 1, 8645, 393, 85, 0, 4294966570, 1, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
