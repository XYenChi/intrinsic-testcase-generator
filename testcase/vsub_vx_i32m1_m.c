...
int main(){
    const int32_t data1[] = {
    -50, -4, -82, 82, 42, 42, 122, 67, -32, 95, 44, 26, 101, 94, -116, 33
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -115, -90, 101, 86, -98, -28, -51, -19, 106, 84, 89, -50, -50, 124, 25, 100
    };
    ...
    int32_t golden[] = {
    65, 0, 4294967113, 1, 1, 0, 173, 86, 1, 0, 1, 0, 151, 0, 0, 4294967229
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
