...
int main(){
    const uint8_t data1[] = {
    55, 46, 115, 167, 91, 10, 203, 30, 93, 193, 95, 21, 205, 221, 102, 36
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    55, 34, 211, 251, 22, 67, 32, 194, 73, 247, 142, 136, 254, 164, 197, 212
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_8mf8_m (mask, data1_v, shift, vl);
