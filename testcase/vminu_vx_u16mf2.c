...
int main(){
    ...
    139, 16, 44, 13, 85, 86, 155, 209, 216, 72, 100, 156, 119, 182, 207, 124
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    83, 207, 68, 240, 167, 49, 76, 16, 200, 104, 141, 29, 81, 75, 32, 202
    };
    ...
    uint16_t golden[] = {
    139, 207, 68, 240, 167, 86, 155, 209, 216, 104, 141, 156, 119, 182, 207, 202
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
