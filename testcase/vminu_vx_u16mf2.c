...
int main(){
    ...
    106, 27, 1, 248, 199, 186, 69, 68, 206, 162, 146, 12, 106, 159, 178, 163
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    17, 98, 235, 239, 130, 160, 222, 1, 59, 42, 4, 61, 225, 39, 164, 35
    };
    ...
    uint16_t golden[] = {
    106, 98, 235, 248, 199, 186, 222, 68, 206, 162, 146, 61, 225, 159, 178, 163
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
