...
int main(){
    const int32_t data1[] = {
    -2, 60, 15, 75, 75, -44, -29, 61, -96, -86, -5, -34, 61, -4, 78, -109
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    81, 38, -122, -45, -114, 80, 71, -5, -86, -1, -80, 49, -44, -114, 99, -38
    };
    ...
    int32_t golden[] = {
    81, 60, 15, 75, 75, 80, 71, 61, 4294967210, 4294967295, 4294967291, 49, 61, 4294967292, 99, 4294967258
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
