...
int main(){
    const uint8_t data1[] = {
    37, 182, 167, 11, 133, 45, 114, 87, 201, 132, 94, 123, 157, 145, 85, 58
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    245, 104, 78, 200, 228, 13, 50, 226, 98, 69, 28, 102, 46, 223, 116, 236
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wx_8m1u_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    1, 0, 1, 203, 229, 45, 0, 1, 235, 197, 1, 0, 191, 1, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
