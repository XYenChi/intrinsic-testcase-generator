...
int main(){
    ...
    1, 58, 29, 118, 155, 106, 186, 35, 182, 216, 187, 143, 167, 153, 229, 40
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    220, 37, 163, 209, 44, 174, 146, 66, 75, 119, 173, 86, 213, 51, 86, 224
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vv_u64m8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    221, 2147, 1, 1, 1, 1, 1, 2310, 1, 25705, 32352, 12299, 0, 1, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
