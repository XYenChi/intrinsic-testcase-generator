...
int main(){
    ...
    28, 169, 111, 210, 242, 62, 77, 54, 94, 121, 58, 226, 222, 238, 142, 110
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    130, 188, 178, 88, 140, 184, 185, 158, 189, 76, 138, 103, 60, 35, 16, 231
    };
    ...
    uint64_t golden[] = {
    130, 188, 1, 0, 1, 1, 1, 158, 189, 76, 138, 1, 60, 35, 1, 231
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
