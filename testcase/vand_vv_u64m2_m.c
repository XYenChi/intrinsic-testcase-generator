...
int main(){
    ...
    227, 134, 70, 87, 88, 210, 124, 36, 172, 174, 169, 69, 103, 15, 149, 39
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    39, 45, 42, 165, 183, 252, 134, 90, 211, 104, 13, 183, 231, 2, 122, 197
    };
    ...
    uint64_t golden[] = {
    0, 45, 0, 165, 183, 1, 0, 90, 1, 1, 0, 183, 231, 2, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
