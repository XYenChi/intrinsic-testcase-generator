...
int main(){
    ...
    13, 86, 79, 7, 118, 115, 124, 32, 198, 137, 70, 55, 149, 91, 201, 133
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    56, 140, 160, 218, 138, 45, 134, 156, 186, 11, 26, 209, 161, 114, 189, 15
    };
    ...
    uint16_t golden[] = {
    728, 12040, 12641, 1526, 16284, 5176, 16616, 4992, 36829, 1507, 1820, 11496, 23989, 10375, 37989, 1996
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
