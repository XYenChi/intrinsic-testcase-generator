...
int main(){
    const int8_t data1[] = {
    63, -69, -43, 79, 100, 1, -60, -106, -34, -108, 96, 125, 12, 68, 94, 48
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -105, -67, 113, -16, -16, 93, 20, 105, 87, 12, -16, -17, -120, 12, -37, -64
    };
    ...
    int8_t golden[] = {
    63, 189, 113, 79, 100, 93, 20, 105, 87, 12, 96, 125, 12, 68, 94, 48
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
