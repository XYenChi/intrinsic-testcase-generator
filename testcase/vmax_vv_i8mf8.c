...
int main(){
    const int8_t data1[] = {
    81, 128, 71, 184, 117, 104, 105, 131, 48, 179, 134, 166, 157, 209, 121, 14
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    126, 164, 145, 163, 83, 60, 221, 3, 38, 231, 212, 61, 2, 208, 123, 224
    };
    ...
    int8_t golden[] = {
    126, 164, 145, 184, 117, 104, 221, 131, 48, 231, 212, 166, 157, 209, 123, 224
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
