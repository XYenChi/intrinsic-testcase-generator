...
int main(){
    const int8_t data1[] = {
    38, -41, 15, -116, 28, -29, 42, -114, -37, 14, -31, 7, -115, -44, -41, 40
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -107, 67, -31, -81, -118, 34, -122, -86, -70, 108, 109, 108, 47, -97, -53, 17
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vv_8mf4_b32 (data1_v, data2_v, vl);
