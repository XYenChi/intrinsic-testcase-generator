...
int main(){
    const int32_t data1[] = {
    -28, -122, -126, 4, -6, 24, -121, -56, -53, 48, 70, -58, -49, -41, -1, 111
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -90, 44, -52, -109, 114, 101, 66, 26, 43, 1, 20, 103, 95, -83, 61, 12
    };
    ...
    int32_t golden[] = {
    4294967178, 44, 4294967244, 4294967191, 108, 125, 4294967241, 4294967266, 4294967286, 1, 90, 45, 95, 4294967172, 60, 123
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
