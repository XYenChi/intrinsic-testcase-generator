...
int main(){
    const uint8_t data1[] = {
    111, 240, 32, 242, 194, 92, 165, 32, 182, 55, 150, 26, 162, 76, 231, 235
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    254, 19, 181, 212, 30, 173, 82, 43, 206, 1, 224, 68, 157, 227, 77, 201
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_8m2_m (mask, data1_v, shift, vl);
