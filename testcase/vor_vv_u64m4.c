...
int main(){
    ...
    67, 176, 7, 107, 65, 166, 85, 83, 65, 68, 212, 156, 72, 48, 216, 23
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    165, 166, 20, 253, 116, 21, 234, 80, 69, 22, 77, 48, 157, 156, 78, 36
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_vv_u64m4 (data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    231, 182, 23, 255, 117, 183, 255, 83, 69, 86, 221, 188, 221, 188, 222, 55
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
