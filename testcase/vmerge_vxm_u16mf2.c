...
int main(){
    ...
    143, 255, 228, 183, 49, 96, 108, 80, 158, 192, 91, 188, 159, 28, 12, 19
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    65, 18, 38, 2, 116, 169, 252, 149, 70, 77, 125, 245, 22, 99, 43, 186
    };
    ...
    uint16_t golden[] = {
    143, 18, 38, 2, 116, 169, 252, 80, 158, 192, 125, 188, 159, 28, 12, 186
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
