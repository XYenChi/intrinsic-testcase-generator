...
int main(){
    ...
    199, 113, 84, 59, 84, 49, 155, 10, 152, 69, 18, 193, 154, 171, 155, 134
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    89, 255, 178, 155, 194, 117, 246, 3, 128, 39, 49, 16, 182, 141, 147, 213
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u64m4 (data1_v, data2_v, vl);
