...
int main(){
    const uint8_t data1[] = {
    64, 97, 156, 216, 108, 219, 175, 33, 178, 234, 99, 0, 84, 29, 142, 115
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    120, 95, 218, 253, 126, 162, 161, 236, 115, 31, 165, 149, 73, 165, 139, 202
    };
    ...
    uint8_t golden[] = {
    1, 0, 216, 120, 41, 150, 15, 108, 246, 87, 208, 0, 244, 177, 27, 191
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
