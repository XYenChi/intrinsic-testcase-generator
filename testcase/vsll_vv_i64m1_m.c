...
int main(){
    const int64_t data1[] = {
    125, 48, -110, -112, -29, -127, -1, 21, -100, -79, 36, -6, 99, -6, 42, -114
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    53, -7, 42, 126, -106, 16, -70, 108, 66, 63, -122, -85, -50, 32, 105, -8
    };
    ...
    int64_t golden[] = {
    250, 96, -110, -112, -29, -127, -1, 21, -100, -158, 36, -12, 99, -6, 84, -114
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
