...
int main(){
    ...
    9, 34, 200, 222, 72, 51, 3, 168, 190, 116, 72, 74, 113, 246, 53, 115
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    83, 110, 17, 202, 40, 18, 30, 6, 31, 45, 102, 232, 177, 246, 106, 84
    };
    ...
    uint64_t golden[] = {
    83, 0, 1, 222, 72, 1, 30, 168, 0, 116, 102, 1, 0, 246, 1, 115
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
