...
int main(){
    ...
    97, 37, 74, 246, 199, 164, 198, 99, 25, 167, 169, 10, 221, 90, 176, 246
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    254, 197, 144, 173, 171, 179, 111, 23, 211, 126, 11, 95, 67, 61, 220, 154
    };
    ...
    uint64_t golden[] = {
    254, 197, 144, 246, 199, 179, 198, 99, 211, 167, 169, 95, 221, 90, 220, 246
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
