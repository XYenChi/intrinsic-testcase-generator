...
int main(){
    const int16_t data1[] = {
    -10, 63, 12, 25, -82, 92, -119, 2, 96, 117, -34, -68, -112, -90, -1, -92
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -63, -110, 63, -95, 99, 79, -13, 34, 85, -30, 2, -54, -10, 39, -52, -20
    };
    ...
    int16_t golden[] = {
    6, 65534, 5, 65532, 65534, 0, 0, 17, 0, 65535, 65535, 0, 0, 65535, 52, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
