...
int main(){
    const uint8_t data1[] = {
    117, 6, 102, 56, 166, 251, 175, 95, 32, 5, 200, 51, 182, 84, 30, 153
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    251, 74, 46, 180, 73, 150, 71, 86, 218, 166, 64, 57, 123, 71, 210, 97
    };
    ...
    uint8_t golden[] = {
    251, 74, 102, 180, 166, 251, 175, 95, 218, 166, 200, 57, 182, 84, 210, 153
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
