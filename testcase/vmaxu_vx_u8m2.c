...
int main(){
    const uint8_t data1[] = {
    175, 216, 132, 54, 83, 238, 140, 14, 21, 19, 98, 249, 100, 130, 104, 150
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    62, 150, 213, 81, 115, 154, 235, 182, 143, 54, 131, 182, 151, 109, 133, 220
    };
    ...
    uint8_t golden[] = {
    175, 216, 213, 81, 115, 238, 235, 182, 143, 54, 131, 249, 151, 130, 133, 220
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
