...
int main(){
    const int64_t data1[] = {
    -31, 98, -35, -67, 23, 56, 115, 55, 121, -26, -61, -33, -17, 23, -52, 21
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    22, 6, 72, -34, 94, -45, 120, 117, 7, 9, 47, 30, -85, -75, -29, -26
    };
    const int64_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e64m4(avl);
    const int out_data[] = {
    94, 9, -104, 103, -8, -124, 48, -14, -97, 9, -33, 112, 120, -13, -51, -29
    };
    ...
    int64_t golden[] = {
    -9, 9, 37, 103, 117, -124, 127, -14, 127, 9, -33, -3, 120, -52, -51, -29
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
