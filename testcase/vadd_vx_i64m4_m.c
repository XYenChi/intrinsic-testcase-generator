...
int main(){
    const int64_t data1[] = {
    17, -89, 116, -11, -117, -85, -124, -89, 120, -104, -126, 125, -60, -9, 55, -32
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    16, -2, 34, 66, -66, 67, -45, -54, 124, 68, -73, -125, -17, -31, -30, -5
    };
    ...
    int64_t golden[] = {
    33, 18446744073709551525, 150, 0, 0, 18446744073709551598, 1, 18446744073709551473, 244, 18446744073709551580, 18446744073709551417, 1, 1, 18446744073709551576, 25, 18446744073709551579
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
