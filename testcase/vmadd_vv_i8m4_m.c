...
int main(){
    const int8_t data1[] = {
    50, 89, 2, 91, -94, 53, -114, 15, 0, 121, 9, 36, -76, -64, 51, 99
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -90, 105, 104, 125, -73, -6, -91, -76, -46, -107, -115, -115, -72, -65, 56, 85
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmadd_vv_i8m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    50, 194, 2, 91, 183, 53, 51, 180, 0, 14, 141, 36, 184, 192, 107, 99
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
