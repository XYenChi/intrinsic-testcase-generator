...
int main(){
    const uint8_t data1[] = {
    221, 233, 45, 37, 191, 246, 94, 236, 90, 21, 221, 120, 211, 48, 94, 154
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    248, 135, 193, 243, 138, 122, 218, 1, 91, 187, 24, 37, 210, 134, 22, 76
    };
    ...
    uint4_t masked[] = {
    1, 1, 1, 1, 1, 0, 0, 1, 0, 0, 1, 0, 1, 1, 0, 1
    };
    ...
    uint8_t golden[] = {
    1, 0, 4, 6, 0, 1, 1, 0, 0, 1, 0, 1, 0, 2, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
