...
int main(){
    const int16_t data1[] = {
    -59, -40, -19, 39, -68, 125, 50, -106, 83, -66, 41, -11, 113, 91, -6, 74
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -71, 119, 76, -4, -78, -97, 68, 103, -43, 85, 46, -55, 30, -81, 92, -101
    };
    ...
    int16_t golden[] = {
    -118, -80, -19, 39, -68, 250, 50, -212, 166, -132, 41, -22, 113, 182, -6, 148
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
