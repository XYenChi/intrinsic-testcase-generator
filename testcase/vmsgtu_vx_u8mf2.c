...
int main(){
    const uint8_t data1[] = {
    131, 159, 131, 223, 219, 26, 152, 211, 45, 148, 102, 153, 33, 28, 80, 24
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    49, 171, 83, 226, 127, 122, 8, 59, 241, 145, 198, 224, 208, 22, 44, 238
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_8mf2_b16 (data1_v, data2_v, vl);
