...
int main(){
    ...
    205, 134, 198, 4, 174, 47, 213, 94, 131, 187, 103, 234, 31, 14, 214, 249
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    52, 107, 51, 128, 71, 218, 80, 1, 93, 1, 81, 165, 174, 202, 27, 251
    };
    ...
    uint16_t golden[] = {
    10660, 0, 1, 512, 0, 0, 17040, 0, 1, 1, 8344, 38610, 5395, 2828, 5778, 62500
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
