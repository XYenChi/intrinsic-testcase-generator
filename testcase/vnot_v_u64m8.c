...
int main(){
    ...
    142, 124, 185, 24, 164, 213, 12, 181, 228, 195, 61, 225, 59, 231, 157, 144
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnot_v_u64m8 (data1_v, vl);
    ...
    uint64_t golden[] = {
    -143, -125, -186, -25, -165, -214, -13, -182, -229, -196, -62, -226, -60, -232, -158, -145
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
