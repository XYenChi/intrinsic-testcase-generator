...
int main(){
    ...
    107, 74, 194, 192, 194, 12, 214, 249, 148, 197, 136, 125, 69, 146, 58, 221
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    55, 139, 150, 247, 31, 153, 105, 227, 29, 173, 111, 63, 129, 230, 63, 120
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u32mf2 (data1_v, data2_v, vl);
