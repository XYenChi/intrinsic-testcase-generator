...
int main(){
    ...
    254, 209, 223, 220, 211, 185, 82, 240, 87, 255, 179, 5, 76, 239, 158, 107
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    115, 185, 154, 21, 248, 127, 227, 38, 127, 106, 215, 35, 10, 75, 251, 231
    };
    ...
    uint32_t golden[] = {
    254, 209, 223, 220, 248, 185, 227, 240, 127, 255, 215, 35, 76, 239, 251, 231
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
