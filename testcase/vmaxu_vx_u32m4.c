...
int main(){
    ...
    222, 108, 109, 47, 117, 188, 69, 139, 226, 122, 227, 212, 111, 84, 98, 223
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    137, 84, 118, 146, 208, 223, 114, 95, 182, 103, 155, 148, 122, 72, 45, 184
    };
    ...
    uint32_t golden[] = {
    222, 108, 118, 146, 208, 223, 114, 139, 226, 122, 227, 212, 122, 84, 98, 223
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
