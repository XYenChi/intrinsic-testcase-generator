...
int main(){
    const int8_t data1[] = {
    36, -3, 30, 22, -105, 75, -114, 99, -74, -71, 21, 32, -52, 94, 120, 71
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    52, 73, 90, -116, -31, -84, 78, -105, 67, 84, 50, -101, -27, -40, -124, -35
    };
    ...
    int8_t golden[] = {
    52, 73, 30, -116, -105, 75, 78, 99, -74, 84, 21, -101, -52, 94, 120, 71
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
