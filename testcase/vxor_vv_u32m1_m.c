...
int main(){
    ...
    28, 227, 184, 33, 91, 85, 227, 144, 166, 247, 125, 62, 113, 21, 147, 172
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    117, 3, 42, 181, 5, 163, 69, 44, 59, 64, 174, 208, 220, 222, 253, 248
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u32m1_m (mask, data1_v, data2_v, vl);
