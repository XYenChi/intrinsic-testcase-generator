...
int main(){
    const int8_t data1[] = {
    77, 46, -70, -81, 101, 20, -88, 113, 127, 35, -101, 51, -67, 69, -86, -20
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    36, 109, 60, -58, -120, 86, -55, 124, -45, -20, -27, -6, -46, 121, 110, 115
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_i8m1_m (mask, data1_v, data2_v, vl);
