...
int main(){
    const int8_t data1[] = {
    92, -56, -19, 86, 47, -106, 6, -67, 15, 8, 90, 20, -32, -24, -22, 85
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -111, 38, 103, -116, 52, -101, 111, 116, 80, -17, 27, 100, 75, 10, -127, -63
    };
    ...
    int8_t golden[] = {
    28, 176, 91, 8, 140, 210, 154, 164, 176, 120, 126, 208, 160, 16, 234, 21
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
