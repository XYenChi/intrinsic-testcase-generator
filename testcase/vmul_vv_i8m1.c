...
int main(){
    const int8_t data1[] = {
    -20, 57, 110, 15, -30, -110, 113, 81, 103, -23, 47, 118, -38, -60, 51, -127
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    124, 70, -26, 73, -69, 78, -26, 102, -41, -126, 4, 68, -6, 21, 78, -23
    };
    ...
    int8_t golden[] = {
    80, 150, 212, 71, 22, 124, 134, 70, 129, 82, 188, 88, 228, 20, 138, 105
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
