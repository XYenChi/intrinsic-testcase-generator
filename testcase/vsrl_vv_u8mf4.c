...
int main(){
    const uint8_t data1[] = {
    10, 213, 122, 66, 226, 92, 37, 180, 141, 0, 84, 132, 219, 22, 53, 206
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    91, 31, 30, 27, 109, 241, 81, 40, 89, 125, 17, 248, 79, 242, 182, 156
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u8mf4 (data1_v, shift, vl);
