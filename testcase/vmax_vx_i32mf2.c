...
int main(){
    const int32_t data1[] = {
    54, -109, -20, -76, -94, -116, 64, -48, -27, 75, 7, -58, -11, -20, 52, 35
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -40, 52, -74, -60, 46, -83, -74, -5, -17, 84, 121, -65, 83, -3, 101, -95
    };
    ...
    int32_t golden[] = {
    54, 52, 4294967276, 4294967236, 46, 4294967213, 64, 4294967291, 4294967279, 84, 121, 4294967238, 83, 4294967293, 101, 35
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
