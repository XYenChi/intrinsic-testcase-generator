...
int main(){
    const uint8_t data1[] = {
    241, 200, 247, 60, 89, 149, 92, 12, 46, 225, 137, 66, 244, 97, 247, 100
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    54, 231, 215, 107, 171, 81, 231, 248, 143, 87, 179, 50, 151, 250, 174, 128
    };
    ...
    uint8_t golden[] = {
    187, 225, 32, 209, 174, 68, 117, 20, 159, 138, 214, 16, 93, 103, 73, 228
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
