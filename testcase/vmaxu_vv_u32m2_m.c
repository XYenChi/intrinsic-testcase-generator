...
int main(){
    ...
    63, 253, 141, 115, 75, 106, 224, 200, 136, 134, 235, 149, 110, 166, 149, 99
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    249, 51, 184, 189, 1, 20, 110, 60, 159, 231, 17, 197, 122, 182, 148, 248
    };
    ...
    uint32_t golden[] = {
    249, 1, 0, 189, 75, 106, 224, 200, 0, 1, 1, 197, 122, 1, 149, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
