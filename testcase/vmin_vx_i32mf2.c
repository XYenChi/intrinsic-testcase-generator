...
int main(){
    const int32_t data1[] = {
    -32, -60, -94, 52, 64, -14, 84, 58, -55, -126, -80, -82, -31, -112, -20, 58
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -29, -125, -43, 85, 34, -70, -9, -73, -33, -4, -119, -15, 6, -96, -120, -41
    };
    ...
    int32_t golden[] = {
    4294967267, 4294967236, 4294967253, 85, 64, 4294967282, 84, 58, 4294967263, 4294967292, 4294967216, 4294967281, 6, 4294967200, 4294967276, 58
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
