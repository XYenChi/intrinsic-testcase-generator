...
int main(){
    const int32_t data1[] = {
    -89, -99, -106, 42, 119, 96, 10, -42, 51, 8, 5, -88, -52, 60, 12, -67
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -94, 73, 9, -13, -108, -67, 57, -45, -105, -32, -8, 27, -87, -71, -86, 6
    };
    ...
    int32_t golden[] = {
    4294967207, 73, 9, 42, 119, 96, 57, 4294967254, 51, 8, 5, 27, 4294967244, 60, 12, 6
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
