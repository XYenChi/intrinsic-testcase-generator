...
int main(){
    ...
    125, 134, 111, 67, 140, 169, 21, 197, 110, 160, 70, 224, 20, 10, 232, 224
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    146, 44, 208, 162, 7, 158, 113, 138, 198, 64, 111, 32, 236, 46, 37, 202
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u64m1_m (mask, data1_v, data2_v, vl);
