...
int main(){
    ...
    157, 90, 132, 70, 150, 18, 214, 62, 139, 55, 154, 93, 152, 134, 9, 180
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    30, 21, 87, 207, 228, 30, 40, 207, 175, 47, 211, 61, 3, 106, 125, 131
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u64m8_m (mask, data1_v, shift, vl);
    ...
    uint64_t golden[] = {
    157, 45, 66, 35, 150, 18, 214, 31, 69, 27, 77, 46, 76, 134, 4, 90
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
