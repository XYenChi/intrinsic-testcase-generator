...
int main(){
    const int8_t data1[] = {
    22, 231, 218, 117, 125, 122, 220, 64, 38, 23, 243, 61, 82, 34, 136, 86
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    2, 54, 149, 187, 32, 219, 249, 44, 17, 51, 51, 185, 237, 84, 154, 221
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vv_ui8mf2 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    20, 177, 69, 0, 93, 0, 0, 20, 21, 0, 192, 0, 0, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
