...
int main(){
    const uint8_t data1[] = {
    59, 50, 96, 110, 103, 170, 233, 157, 82, 72, 199, 165, 131, 108, 14, 250
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    84, 109, 10, 32, 74, 148, 32, 249, 67, 5, 57, 135, 102, 2, 180, 60
    };
    const uint8_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e8m4(avl);
    const uint out_data[] = {
    0, 0, 1, 1, 0, 1, 1, 1, 1, 0, 1, 1, 1, 0, 0, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsac_vx_u8m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 0, 1, 65, 58, 1, 225, 76, 139, 152, 1, 254, 1, 0, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
