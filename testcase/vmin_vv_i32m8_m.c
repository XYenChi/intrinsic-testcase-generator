...
int main(){
    const int32_t data1[] = {
    113, -99, 4, 60, -19, -62, 65, -60, -73, -113, -18, -122, -68, 60, -2, -44
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -93, -59, -21, 101, -43, -89, 97, 42, -23, -72, 85, 37, -5, -80, 24, 59
    };
    ...
    int32_t golden[] = {
    113, 4294967237, 1, 101, 1, 1, 97, 0, 1, 4294967224, 1, 37, 4294967291, 60, 24, 59
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
