...
int main(){
    const uint8_t data1[] = {
    107, 30, 92, 175, 147, 38, 22, 131, 227, 70, 231, 52, 70, 37, 42, 113
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    140, 194, 78, 12, 158, 213, 38, 188, 123, 193, 212, 254, 51, 29, 211, 59
    };
    ...
    uint8_t golden[] = {
    107, 30, 92, 175, 245, 0, 0, 131, 1, 1, 19, 1, 1, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
