...
int main(){
    const uint8_t data1[] = {
    218, 137, 10, 40, 104, 175, 154, 214, 205, 21, 133, 117, 233, 62, 15, 193
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    105, 216, 67, 46, 102, 213, 42, 34, 123, 20, 34, 80, 32, 188, 42, 109
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsub_vv_u8m8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    218, 0, 199, 250, 0, 175, 112, 180, 205, 21, 0, 37, 1, 62, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
