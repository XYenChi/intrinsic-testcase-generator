...
int main(){
    ...
    195, 2, 21, 162, 70, 5, 125, 243, 24, 238, 5, 125, 114, 28, 38, 10
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    37, 229, 186, 135, 164, 36, 254, 19, 138, 142, 173, 75, 137, 124, 118, 10
    };
    ...
    uint64_t golden[] = {
    195, 229, 186, 162, 0, 1, 254, 1, 1, 238, 173, 125, 0, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
