...
int main(){
    ...
    252, 105, 104, 193, 143, 36, 28, 34, 241, 176, 23, 123, 21, 146, 179, 185
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    190, 123, 181, 235, 44, 38, 169, 166, 199, 112, 138, 107, 199, 84, 235, 77
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u32m1 (data1_v, shift, vl);
