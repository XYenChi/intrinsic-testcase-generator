...
int main(){
    ...
    217, 85, 214, 8, 181, 9, 142, 91, 56, 174, 169, 0, 24, 196, 142, 54
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    219, 39, 154, 31, 225, 166, 252, 59, 184, 9, 247, 88, 25, 126, 4, 212
    };
    ...
    uint16_t golden[] = {
    0, 0, 0, 1, 0, 1494, 35784, 0, 10304, 0, 41743, 1, 1, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
