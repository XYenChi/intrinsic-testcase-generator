...
int main(){
    ...
    179, 198, 104, 186, 83, 161, 217, 125, 246, 182, 1, 210, 57, 92, 159, 115
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    199, 195, 184, 143, 102, 105, 62, 2, 35, 121, 236, 160, 11, 212, 19, 36
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_32mf2_b64_m (mask, data1_v, data2_v, vl);
