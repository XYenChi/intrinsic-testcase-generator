...
int main(){
    ...
    244, 163, 42, 245, 81, 125, 24, 243, 131, 130, 192, 233, 120, 13, 62, 10
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    95, 188, 101, 220, 59, 172, 109, 67, 119, 148, 149, 181, 196, 86, 82, 242
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u64m1_m (mask, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    95, 25, 0, 1, 0, 0, 0, 1, 119, 18, 149, 1, 1, 1, 1, 2
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
