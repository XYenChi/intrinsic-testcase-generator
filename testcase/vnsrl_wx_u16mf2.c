...
int main(){
    ...
    83, 194, 217, 117, 31, 169, 132, 76, 178, 24, 206, 168, 74, 175, 51, 41
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    223, 85, 233, 207, 69, 224, 79, 86, 13, 70, 232, 97, 231, 128, 139, 143
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_16mf2 (data1_v, shift, vl);
