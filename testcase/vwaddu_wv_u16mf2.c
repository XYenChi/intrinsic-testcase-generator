...
int main(){
    ...
    67, 0, 176, 121, 201, 80, 163, 24, 211, 122, 69, 20, 39, 128, 246, 127
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    102, 83, 254, 67, 26, 50, 33, 22, 85, 150, 56, 207, 62, 164, 28, 245
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u16mf2 (data1_v, data2_v, vl);
