...
int main(){
    const int8_t data1[] = {
    62, 93, -118, -74, -64, -73, 7, -94, -8, -30, 84, 40, -83, -65, 115, 14
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -95, 109, -56, 70, -9, 97, -93, -60, -121, 55, -92, -94, 102, 3, -42, 20
    };
    ...
    uint8_t masked[] = {
    1, 1, 0, 1, 1, 0, 0, 0, 0, 1, 1, 0, 1, 0, 0, 1
    };
    ...
    int8_t golden[] = {
    161, 202, 138, 70, 247, 183, 7, 162, 248, 25, 248, 40, 102, 191, 115, 20
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
