...
int main(){
    ...
    251, 27, 82, 83, 148, 123, 117, 217, 181, 167, 126, 246, 226, 103, 226, 251
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    246, 205, 155, 237, 252, 195, 49, 153, 180, 19, 196, 11, 241, 195, 83, 255
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i64m1 (data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    0, 7, 1, 2, 1, 1, 0, 0, 0, 0, 1, 0, 1, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
