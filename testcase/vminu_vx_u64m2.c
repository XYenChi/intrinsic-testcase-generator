...
int main(){
    ...
    127, 151, 107, 19, 105, 48, 199, 185, 197, 25, 252, 88, 89, 198, 7, 26
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    28, 83, 226, 99, 78, 237, 158, 2, 95, 182, 148, 246, 145, 207, 174, 148
    };
    ...
    uint64_t golden[] = {
    127, 151, 226, 99, 105, 237, 199, 185, 197, 182, 252, 246, 145, 207, 174, 148
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
