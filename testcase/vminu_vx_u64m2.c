...
int main(){
    ...
    48, 69, 10, 97, 34, 114, 201, 202, 145, 29, 206, 86, 232, 44, 103, 116
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    87, 112, 184, 72, 38, 69, 249, 134, 197, 46, 234, 35, 216, 110, 247, 125
    };
    ...
    uint64_t golden[] = {
    87, 112, 184, 97, 38, 114, 249, 202, 197, 46, 234, 86, 232, 110, 247, 125
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
