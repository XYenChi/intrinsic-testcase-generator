...
int main(){
    const uint8_t data1[] = {
    225, 81, 144, 20, 139, 212, 170, 211, 95, 55, 109, 60, 65, 130, 201, 203
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    86, 41, 44, 221, 195, 137, 145, 243, 152, 105, 110, 25, 83, 61, 87, 161
    };
    ...
    uint8_t golden[] = {
    1, 250, 0, 1, 225, 1, 0, 73, 1, 144, 1, 1, 20, 251, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
