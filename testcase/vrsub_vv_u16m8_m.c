...
int main(){
    ...
    184, 129, 184, 110, 236, 59, 187, 228, 192, 59, 22, 175, 240, 142, 120, 41
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    85, 49, 60, 32, 184, 39, 50, 243, 91, 182, 199, 62, 165, 200, 149, 160
    };
    ...
    uint16_t golden[] = {
    1, 1, 65412, 0, 65484, 1, 1, 15, 65435, 123, 0, 65423, 65461, 58, 29, 119
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
