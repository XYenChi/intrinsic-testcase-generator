...
int main(){
    ...
    156, 118, 95, 141, 92, 222, 245, 169, 67, 111, 254, 41, 230, 177, 83, 152
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    50, 146, 238, 64, 131, 255, 14, 116, 2, 46, 104, 153, 228, 89, 34, 212
    };
    ...
    uint64_t golden[] = {
    0, 17228, 0, 9024, 12052, 1, 3430, 0, 0, 0, 1, 1, 52440, 0, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
