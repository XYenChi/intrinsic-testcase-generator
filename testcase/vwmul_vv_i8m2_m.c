...
int main(){
    const int8_t data1[] = {
    120, 99, -5, 32, -30, 121, -40, 67, -124, -16, -112, 78, 62, 111, -54, 38
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    105, 29, -59, -37, 99, 15, 66, -39, -97, 73, 10, -58, 0, 86, -19, -36
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmul_vv_i8m2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    56, 0, 39, 0, 102, 23, 176, 1, 252, 1, 1, 84, 0, 74, 2, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
