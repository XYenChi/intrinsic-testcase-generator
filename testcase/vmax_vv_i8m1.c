...
int main(){
    const int8_t data1[] = {
    126, 132, 69, 102, 193, 59, 150, 154, 163, 133, 75, 8, 174, 192, 54, 182
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    90, 222, 31, 3, 176, 30, 72, 107, 196, 79, 25, 254, 9, 28, 239, 164
    };
    ...
    int8_t golden[] = {
    126, 222, 69, 102, 193, 59, 150, 154, 196, 133, 75, 254, 174, 192, 239, 182
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
