...
int main(){
    ...
    93, 239, 202, 60, 27, 5, 17, 177, 169, 213, 213, 192, 89, 191, 194, 24
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    101, 187, 61, 174, 153, 117, 127, 171, 214, 40, 58, 194, 236, 81, 95, 101
    };
    ...
    uint64_t golden[] = {
    101, 1, 202, 1, 153, 0, 127, 0, 1, 213, 213, 194, 1, 1, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
