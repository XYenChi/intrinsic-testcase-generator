...
int main(){
    ...
    135, 25, 184, 110, 34, 171, 187, 232, 128, 66, 253, 166, 23, 96, 113, 69
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    45, 85, 58, 147, 85, 36, 156, 202, 151, 204, 190, 244, 253, 44, 248, 151
    };
    ...
    uint64_t golden[] = {
    135, 85, 1, 147, 0, 0, 187, 0, 151, 1, 253, 244, 253, 1, 248, 151
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
