...
int main(){
    const uint8_t data1[] = {
    10, 117, 10, 249, 40, 164, 58, 27, 235, 49, 199, 212, 86, 0, 218, 240
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    33, 44, 125, 71, 58, 178, 196, 48, 32, 239, 82, 110, 113, 71, 203, 240
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vx_8m2_b4 (data1_v, data2_v, vl);
