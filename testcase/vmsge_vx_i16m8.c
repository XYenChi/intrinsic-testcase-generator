...
int main(){
    const int16_t data1[] = {
    -128, -45, -32, 58, 116, 63, 69, -126, 42, 42, -116, 102, -128, -1, -107, 94
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -87, -116, -116, 118, -15, -101, -54, -127, -66, 72, -101, -53, -121, 101, -98, -56
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_16m8_b2 (data1_v, data2_v, vl);
