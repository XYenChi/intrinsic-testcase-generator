...
int main(){
    ...
    140, 173, 87, 189, 142, 212, 38, 140, 24, 105, 130, 162, 249, 214, 186, 175
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    118, 139, 168, 221, 226, 182, 111, 95, 72, 157, 111, 67, 66, 109, 27, 58
    };
    ...
    uint64_t golden[] = {
    16520, 24047, 14616, 41769, 32092, 38584, 4218, 13300, 1728, 16485, 14430, 10854, 16434, 23326, 5022, 10150
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
