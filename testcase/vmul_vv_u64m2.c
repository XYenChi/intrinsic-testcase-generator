...
int main(){
    ...
    5, 99, 73, 231, 9, 107, 227, 75, 217, 248, 93, 46, 12, 96, 178, 174
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    28, 44, 164, 142, 83, 228, 209, 16, 232, 130, 189, 194, 221, 94, 79, 164
    };
    ...
    uint64_t golden[] = {
    140, 4356, 11972, 32802, 747, 24396, 47443, 1200, 50344, 32240, 17577, 8924, 2652, 9024, 14062, 28536
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
