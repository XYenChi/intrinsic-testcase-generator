...
int main(){
    ...
    194, 60, 169, 20, 125, 167, 181, 154, 77, 137, 70, 139, 114, 167, 64, 234
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    234, 189, 88, 6, 101, 26, 189, 119, 181, 239, 135, 7, 79, 143, 202, 126
    };
    ...
    uint16_t golden[] = {
    234, 189, 169, 20, 125, 167, 189, 154, 181, 239, 135, 139, 114, 167, 202, 234
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
