...
int main(){
    ...
    197, 97, 145, 117, 123, 69, 79, 147, 218, 18, 23, 197, 209, 3, 215, 68
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    111, 204, 180, 73, 27, 161, 192, 35, 25, 233, 68, 232, 94, 36, 109, 211
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_16mf4_b64 (data1_v, data2_v, vl);
