...
int main(){
    const uint8_t data1[] = {
    129, 152, 166, 162, 129, 200, 185, 124, 245, 145, 53, 222, 227, 172, 32, 90
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnot_v_u8mf4 (data1_v, vl);
    ...
    uint8_t golden[] = {
    -130, -153, -167, -163, -130, -201, -186, -125, -246, -146, -54, -223, -228, -173, -33, -91
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
