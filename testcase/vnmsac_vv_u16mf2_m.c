...
int main(){
    ...
    92, 33, 195, 159, 63, 108, 142, 234, 78, 113, 250, 111, 40, 140, 62, 1
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    121, 29, 156, 202, 209, 83, 82, 53, 131, 15, 86, 163, 171, 12, 183, 50
    };
    ...
    uint16_t golden[] = {
    0, 1, 35117, 33418, 0, 56572, 0, 0, 55319, 63841, 0, 1, 1, 0, 54190, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
