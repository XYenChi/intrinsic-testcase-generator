...
int main(){
    const int16_t data1[] = {
    124, -67, -124, -47, -94, -45, 32, 28, -51, -126, -36, -118, 58, 3, -28, 73
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    101, 116, 12, -96, -35, 39, 121, -2, -52, 69, -105, -54, 0, -50, 77, -21
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_16mf4_b64_m (mask, data1_v, data2_v, vl);
