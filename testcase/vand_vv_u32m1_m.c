...
int main(){
    ...
    239, 189, 137, 114, 189, 105, 220, 60, 128, 122, 163, 139, 1, 240, 217, 193
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    17, 50, 26, 139, 181, 163, 85, 203, 215, 239, 77, 134, 36, 29, 248, 120
    };
    ...
    uint32_t golden[] = {
    17, 0, 1, 139, 181, 163, 85, 203, 1, 0, 0, 134, 36, 29, 248, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
