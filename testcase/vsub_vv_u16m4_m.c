...
int main(){
    ...
    63, 239, 145, 3, 185, 86, 87, 107, 214, 216, 219, 206, 219, 203, 49, 240
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    178, 60, 197, 86, 151, 23, 200, 212, 4, 58, 248, 203, 27, 12, 165, 140
    };
    ...
    uint4_t masked[] = {
    1, 1, 1, 0, 1, 1, 0, 1, 0, 0, 0, 1, 1, 1, 0, 1
    };
    ...
    uint16_t golden[] = {
    65421, 179, 65484, 0, 34, 63, 0, 65431, 0, 1, 0, 3, 192, 191, 0, 100
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
