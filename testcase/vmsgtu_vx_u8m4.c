...
int main(){
    const uint8_t data1[] = {
    95, 66, 15, 129, 120, 170, 128, 56, 169, 95, 80, 238, 89, 187, 162, 18
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    251, 211, 11, 182, 40, 149, 80, 34, 99, 103, 113, 219, 204, 93, 48, 117
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_8m4_b2 (data1_v, data2_v, vl);
