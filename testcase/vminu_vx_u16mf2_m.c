...
int main(){
    ...
    203, 21, 27, 86, 232, 14, 190, 159, 80, 24, 94, 52, 113, 195, 202, 49
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    64, 90, 107, 5, 169, 29, 250, 242, 49, 57, 225, 124, 211, 66, 99, 179
    };
    ...
    uint16_t golden[] = {
    203, 90, 107, 0, 232, 1, 250, 242, 80, 57, 0, 1, 0, 195, 202, 179
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
