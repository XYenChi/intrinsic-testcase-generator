...
int main(){
    ...
    182, 131, 222, 245, 223, 157, 180, 183, 245, 149, 7, 255, 78, 189, 41, 231
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    89, 107, 217, 249, 206, 94, 106, 174, 176, 3, 251, 200, 129, 11, 116, 139
    };
    ...
    uint16_t golden[] = {
    182, 24, 222, 245, 223, 63, 74, 9, 245, 146, 65292, 255, 65485, 178, 41, 231
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
