...
int main(){
    ...
    91, 48, 230, 222, 91, 26, 136, 137, 24, 46, 156, 23, 203, 109, 99, 106
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    219, 115, 162, 15, 5, 58, 73, 98, 55, 41, 91, 131, 49, 76, 142, 166
    };
    ...
    uint16_t golden[] = {
    219, 115, 230, 222, 91, 58, 136, 137, 55, 46, 156, 131, 203, 109, 142, 166
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
