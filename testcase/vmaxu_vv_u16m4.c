...
int main(){
    ...
    199, 134, 220, 79, 28, 96, 92, 68, 243, 159, 248, 144, 113, 90, 112, 65
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    208, 119, 102, 9, 233, 168, 1, 39, 135, 92, 179, 38, 209, 118, 14, 136
    };
    ...
    uint16_t golden[] = {
    208, 134, 220, 79, 233, 168, 92, 68, 243, 159, 248, 144, 209, 118, 112, 136
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
