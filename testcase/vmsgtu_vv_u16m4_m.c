...
int main(){
    ...
    213, 175, 191, 49, 148, 56, 151, 58, 205, 162, 50, 253, 252, 184, 155, 127
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    34, 156, 49, 156, 171, 43, 126, 7, 49, 23, 67, 187, 158, 94, 56, 227
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_16m4_b4_m (mask, data1_v, data2_v, vl);
