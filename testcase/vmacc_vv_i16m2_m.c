...
int main(){
    const int16_t data1[] = {
    -94, -21, 48, -48, -19, 124, -97, -61, 14, 43, -2, 12, -48, -25, 67, -53
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -46, -91, 106, -49, -17, 41, 77, 107, -120, 17, 99, 69, 111, -110, 120, 54
    };
    ...
    int16_t golden[] = {
    1, 1912, 5089, 0, 0, 5085, 58068, 59010, 0, 0, 65338, 829, 60208, 2750, 8040, 62674
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
