...
int main(){
    const int8_t data1[] = {
    114, -45, 123, 84, -21, 99, 84, 106, 84, -38, -50, -108, 5, -43, 35, -52
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    37, 11, -97, -115, 111, 105, -13, -90, 20, -79, -40, -47, 78, 60, -45, -122
    };
    ...
    int8_t golden[] = {
    122, 17, 101, 68, 229, 155, 188, 188, 144, 186, 208, 212, 134, 236, 217, 200
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
