...
int main(){
    const int8_t data1[] = {
    -99, 74, -16, -2, 127, -37, 84, -12, -57, 78, 119, 93, -86, 120, 22, -65
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -80, 65, 9, 94, -103, -49, -72, -89, -17, -93, -9, -96, 101, 58, 96, -107
    };
    ...
    int8_t golden[] = {
    240, 202, 112, 68, 231, 21, 96, 44, 201, 170, 209, 32, 18, 48, 64, 43
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
