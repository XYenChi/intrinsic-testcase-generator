...
int main(){
    const int32_t data1[] = {
    35, -93, -105, 107, -32, -48, 93, -37, 124, -37, -80, 26, -52, 95, -85, -62
    };
    const int32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    96, 101, 174, 155, 248, 4, 88, 240, 10, 37, 224, 67, 206, 205, 250, 138
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_32m1_b32 (mask, data1_v, data2_v, vl);
