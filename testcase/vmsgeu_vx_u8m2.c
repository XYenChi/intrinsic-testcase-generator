...
int main(){
    const uint8_t data1[] = {
    227, 2, 227, 181, 96, 98, 244, 3, 115, 254, 67, 163, 8, 107, 27, 210
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    83, 160, 138, 144, 105, 1, 121, 207, 199, 129, 83, 2, 151, 244, 113, 41
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_8m2_b4 (data1_v, data2_v, vl);
