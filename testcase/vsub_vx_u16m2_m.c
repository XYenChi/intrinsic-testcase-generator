...
int main(){
    ...
    125, 206, 55, 146, 232, 194, 249, 32, 193, 113, 27, 40, 2, 118, 236, 72
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    15, 228, 12, 130, 195, 74, 136, 134, 92, 136, 206, 163, 140, 49, 28, 25
    };
    ...
    uint16_t golden[] = {
    110, 65514, 43, 16, 37, 120, 113, 65434, 1, 65513, 65357, 0, 0, 1, 1, 47
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
