...
int main(){
    const int32_t data1[] = {
    -8, 116, -10, 70, -53, -117, 69, -49, 18, -63, 119, -120, -66, 83, 8, 27
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -115, 105, -16, 127, -2, -96, 121, -124, -13, 35, -98, -40, 20, 18, 7, -61
    };
    ...
    int32_t golden[] = {
    920, 12180, 160, 8890, 106, 11232, 8349, 6076, 4294967062, 4294965091, 4294955634, 4800, 4294965976, 1494, 56, 4294965649
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
