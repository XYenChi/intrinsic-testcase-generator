...
int main(){
    const int32_t data1[] = {
    125, 103, -116, -79, -92, 20, -35, -121, -116, -31, -8, -1, 15, 12, -105, 122
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    50, 71, 59, 106, 125, 32, -26, -78, -38, -29, 38, 14, -96, 59, 66, -54
    };
    ...
    int32_t golden[] = {
    6250, 7313, 4294960452, 4294958922, 4294955796, 640, 910, 9438, 4408, 899, 4294966992, 4294967282, 4294965856, 708, 4294960366, 4294960708
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
