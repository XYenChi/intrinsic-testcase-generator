...
int main(){
    const int16_t data1[] = {
    -27, -11, 87, 125, 12, -122, 19, -47, 53, 8, 58, -72, 76, -103, 113, 52
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -15, 124, -54, -28, -126, 106, -36, 22, 52, 124, -120, -57, 127, -95, 54, 0
    };
    ...
    int16_t golden[] = {
    65521, 124, 87, 125, 12, 106, 19, 22, 53, 124, 58, 65479, 127, 65441, 113, 52
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
