...
int main(){
    const int16_t data1[] = {
    -12, -93, 105, -92, -16, 100, 8, -100, -67, -52, 41, 5, 35, -89, 29, 86
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -14, -34, 52, 121, 126, -124, 72, 101, -9, -74, -87, -55, 117, 7, 110, -125
    };
    ...
    int16_t golden[] = {
    65524, 65502, 105, 121, 126, 100, 72, 101, 65527, 65484, 41, 5, 117, 7, 110, 86
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
