...
int main(){
    ...
    56, 85, 99, 137, 250, 11, 8, 151, 150, 7, 90, 210, 39, 21, 244, 66
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    92, 95, 212, 93, 153, 211, 205, 245, 105, 134, 44, 125, 77, 252, 134, 34
    };
    ...
    uint16_t golden[] = {
    92, 95, 212, 137, 250, 211, 205, 245, 150, 134, 90, 210, 77, 252, 244, 66
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
