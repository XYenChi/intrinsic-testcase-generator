...
int main(){
    ...
    179, 91, 65, 153, 57, 138, 173, 120, 20, 5, 96, 111, 77, 174, 26, 72
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    229, 37, 73, 217, 42, 83, 155, 160, 189, 155, 230, 30, 171, 71, 165, 164
    };
    ...
    uint16_t golden[] = {
    229, 91, 73, 217, 57, 138, 173, 160, 189, 155, 230, 111, 171, 174, 165, 164
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
