...
int main(){
    const int32_t data1[] = {
    29, -111, 24, 82, 110, -41, -113, -54, -10, 43, -97, -125, -64, -45, -59, -27
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    99, 113, -77, 35, -105, -38, 64, -65, 59, -10, -33, 103, -11, -55, 86, -22
    };
    ...
    int32_t golden[] = {
    128, 3, -52, 118, 5, -78, -48, -119, 50, 33, -129, -21, -75, -100, 27, -49
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
