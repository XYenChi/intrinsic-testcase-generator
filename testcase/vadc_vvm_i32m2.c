...
int main(){
    const int32_t data1[] = {
    38, 92, 95, -105, -6, -70, 115, -128, 18, 110, 85, -36, 83, -74, 63, -5
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -29, 125, 90, 11, 20, -19, -118, -38, -122, 73, 95, 44, 80, -10, -84, 115
    };
    ...
    int32_t golden[] = {
    9, 218, 185, -93, 15, -88, -3, -166, -103, 183, 181, 8, 163, -83, -21, 111
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
