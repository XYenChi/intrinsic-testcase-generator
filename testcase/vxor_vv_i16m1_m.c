...
int main(){
    const int16_t data1[] = {
    -104, 125, -23, 46, 89, 65, -90, -3, -71, 54, -47, -35, 58, 19, 49, 93
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    12, -111, 110, 111, -105, -45, 10, 80, 68, -94, 80, 45, -96, -20, -77, -44
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_i16m1_m (mask, data1_v, data2_v, vl);
