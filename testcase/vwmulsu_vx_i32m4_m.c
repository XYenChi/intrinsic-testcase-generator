...
int main(){
    const int32_t data1[] = {
    72, 55, -48, -99, 1, 64, -66, -49, 45, -15, -24, 81, 84, -116, 9, 114
    };
    const int32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    -37, 2, 39, -22, -105, -126, -14, 58, 17, -107, 123, -5, -66, 64, -80, 48
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulsu_vx_i32m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int32_t golden[] = {
    0, 0, 4294965424, 2178, 1, 0, 924, 4294964454, 765, 0, 1, 1, 1, 1, 4294966576, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
