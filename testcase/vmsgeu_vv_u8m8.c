...
int main(){
    const uint8_t data1[] = {
    200, 58, 191, 211, 139, 4, 170, 248, 193, 136, 209, 190, 96, 223, 33, 56
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    200, 65, 60, 131, 236, 118, 25, 102, 182, 248, 121, 91, 180, 73, 1, 59
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_8m8_b1 (data1_v, data2_v, vl);
