...
int main(){
    const int32_t data1[] = {
    -94, -30, 4, 113, 90, 15, 16, -119, 55, -106, -63, -122, 6, 111, -96, 20
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -95, 76, 48, -20, -5, -26, -59, 40, 12, -68, -93, 103, 9, -39, -1, -22
    };
    ...
    int32_t golden[] = {
    4294967202, 76, 48, 113, 90, 15, 16, 40, 55, 4294967228, 4294967233, 103, 9, 111, 4294967295, 20
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
