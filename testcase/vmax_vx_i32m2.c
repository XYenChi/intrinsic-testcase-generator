...
int main(){
    const int32_t data1[] = {
    -57, -115, -49, 10, 91, 18, -36, 49, 0, 80, 120, 72, 17, -47, 27, 97
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    111, -9, -1, 122, -59, -26, 8, -96, -79, 107, -20, 84, 13, -73, -21, 113
    };
    ...
    int32_t golden[] = {
    111, 4294967287, 4294967295, 122, 91, 18, 8, 49, 0, 107, 120, 84, 17, 4294967249, 27, 113
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
