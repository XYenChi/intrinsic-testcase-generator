...
int main(){
    const int32_t data1[] = {
    -13, 71, 69, -32, -99, -33, 100, -125, -66, 68, 33, -37, -73, 49, -42, -128
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    84, -110, -92, -54, -79, -115, -32, 66, -89, 42, 115, 0, -32, 94, 10, -57
    };
    ...
    int32_t golden[] = {
    0, 1, 4294967273, 1, 4294967118, 1, 0, 1, 1, 1, 1, 4294967259, 0, 0, 4294967264, 4294967111
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
