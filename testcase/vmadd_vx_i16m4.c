...
int main(){
    const int16_t data1[] = {
    57, 100, -30, 111, 26, 4, -113, 30, 90, 44, 19, -54, -91, -81, 4, -21
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -88, -82, -52, -3, -19, -28, 19, 83, 64, 83, -127, -48, 122, -90, 15, 15
    };
    ...
    int16_t golden[] = {
    65448, 18, 65454, 65533, 65517, 65508, 19, 113, 154, 83, 65409, 65434, 31, 65446, 19, 15
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
