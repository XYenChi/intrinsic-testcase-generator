...
int main(){
    const int32_t data1[] = {
    105, 103, -60, 94, -109, -78, -60, -39, 73, -85, -21, 127, -77, -14, -26, -75
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    18, 72, -87, -64, -87, 36, -29, -72, -21, 117, 7, -72, -37, -75, -4, 70
    };
    ...
    int32_t golden[] = {
    1890, 1, 5220, 4294961280, 0, 1, 1740, 2808, 4294965763, 0, 1, 4294958152, 1, 0, 0, 4294962046
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
