...
int main(){
    const int32_t data1[] = {
    -1, 104, 64, -111, 68, -86, -13, 109, 108, -78, 112, -39, -35, -94, 34, 97
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -71, 58, 39, 78, 55, -102, 58, -4, 1, 48, 112, 108, -101, 112, -1, 42
    };
    ...
    int32_t golden[] = {
    4294967295, 104, 25, 4294967107, 13, 16, 4294967225, 113, 108, 4294967218, 0, 4294967149, 66, 4294967090, 34, 55
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
