...
int main(){
    const int16_t data1[] = {
    -123, 29, -51, 125, -18, -33, 21, -38, 12, -21, 87, -69, -36, 25, 28, 6
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    19, -19, 10, -70, -86, 85, 6, 34, 88, 38, -91, 92, 41, 69, 77, 12
    };
    ...
    int16_t golden[] = {
    19, 65517, 10, 65466, 65450, 85, 6, 34, 88, 38, 65445, 92, 41, 69, 77, 12
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
