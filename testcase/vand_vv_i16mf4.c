...
int main(){
    const int16_t data1[] = {
    -16, -84, 67, -108, 51, -82, -42, -31, 18, 79, -120, 11, -46, -101, 27, -95
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -101, 32, 64, -120, 56, 34, -120, -88, -14, 107, -14, -58, 102, 76, -38, 40
    };
    ...
    int16_t golden[] = {
    65435, 32, 64, 65416, 56, 34, 65416, 65448, 65522, 107, 65522, 65478, 102, 76, 65498, 40
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
