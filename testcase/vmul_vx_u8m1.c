...
int main(){
    const uint8_t data1[] = {
    23, 198, 197, 250, 248, 138, 145, 61, 52, 42, 236, 4, 149, 106, 56, 101
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    53, 128, 98, 16, 11, 23, 99, 231, 18, 99, 55, 142, 247, 17, 90, 215
    };
    ...
    uint8_t golden[] = {
    195, 0, 106, 160, 168, 102, 19, 11, 168, 62, 180, 56, 195, 10, 176, 211
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
