...
int main(){
    const int16_t data1[] = {
    -12, 73, -115, -23, 96, 101, -65, 25, -67, 103, 30, -47, -24, 113, 87, -116
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    3, 98, -30, -123, 76, 72, -109, -54, -67, -101, -35, 112, -58, 53, 32, -79
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccus_vx_i16m1_m (mask, out_data, data1_v, data2_v, vl);
