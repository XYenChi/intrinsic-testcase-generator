...
int main(){
    const uint8_t data1[] = {
    7, 84, 107, 30, 166, 50, 175, 249, 98, 89, 243, 193, 135, 249, 61, 71
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    33, 107, 88, 62, 92, 226, 82, 248, 231, 143, 55, 179, 11, 180, 179, 148
    };
    ...
    uint8_t golden[] = {
    230, 233, 19, 224, 74, 80, 93, 1, 123, 202, 188, 14, 124, 69, 138, 179
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
