...
int main(){
    const uint8_t data1[] = {
    63, 62, 242, 210, 186, 140, 142, 113, 94, 228, 171, 228, 239, 179, 54, 18
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    167, 101, 111, 220, 203, 239, 196, 3, 109, 36, 213, 130, 177, 18, 81, 102
    };
    ...
    uint8_t golden[] = {
    152, 217, 131, 246, 239, 157, 202, 110, 241, 192, 214, 98, 62, 161, 229, 172
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
