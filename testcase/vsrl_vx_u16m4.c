...
int main(){
    ...
    73, 42, 37, 31, 79, 188, 242, 1, 255, 244, 239, 119, 46, 108, 220, 78
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    69, 144, 144, 70, 11, 129, 78, 87, 69, 99, 59, 20, 227, 231, 148, 104
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u16m4 (data1_v, shift, vl);
