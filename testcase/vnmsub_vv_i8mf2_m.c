...
int main(){
    const int8_t data1[] = {
    -51, -19, 3, 58, 76, -72, 122, -27, 62, 117, 24, 20, 27, -32, 117, -53
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -3, 117, -62, -76, -44, 65, -64, -115, -95, -10, 90, 3, -46, 47, 31, -64
    };
    const int8_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e8mf2(avl);
    const int out_data[] = {
    1, 1, 1, 0, 1, 1, 0, 0, 1, 1, 1, 1, 1, 0, 1, 1
    };
    ...
    int8_t golden[] = {
    208, 120, 65, 58, 1, 1, 122, 0, 1, 127, 190, 17, 73, 224, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
