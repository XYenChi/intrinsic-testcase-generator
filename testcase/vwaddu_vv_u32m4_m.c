...
int main(){
    ...
    101, 51, 211, 90, 81, 78, 167, 100, 169, 176, 5, 120, 164, 114, 35, 39
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    59, 60, 16, 213, 134, 101, 181, 110, 74, 72, 215, 232, 241, 99, 212, 224
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u32m4_m (mask, data1_v, data2_v, vl);
