...
int main(){
    ...
    143, 29, 243, 160, 52, 187, 72, 180, 33, 109, 118, 217, 241, 80, 100, 145
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    2, 77, 240, 35, 242, 171, 48, 229, 130, 224, 176, 6, 184, 118, 106, 76
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u32m2 (data1_v, data2_v, vl);
