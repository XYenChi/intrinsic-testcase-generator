...
int main(){
    const int8_t data1[] = {
    -42, -50, 76, 22, -78, -6, 120, -25, 17, -64, -5, 53, -11, 6, 54, -13
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    111, -1, 112, -85, -109, -3, -118, 87, -46, -31, -48, -91, 35, 67, 18, -11
    };
    ...
    int8_t golden[] = {
    111, 255, 112, 22, 178, 253, 120, 87, 17, 225, 251, 53, 35, 67, 54, 245
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
