...
int main(){
    const int8_t data1[] = {
    63, -127, 8, 126, -47, 121, -105, 125, -87, -53, -13, -28, 101, -62, -109, 127
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    71, 115, 61, 33, 1, 52, 1, 99, -15, -82, 16, 39, -111, -92, -70, -38
    };
    ...
    int8_t golden[] = {
    71, 115, 61, 126, 1, 121, 1, 125, 241, 203, 16, 39, 101, 194, 186, 127
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
