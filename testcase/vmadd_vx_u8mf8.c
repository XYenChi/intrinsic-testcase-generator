...
int main(){
    const uint8_t data1[] = {
    27, 182, 168, 142, 194, 66, 34, 2, 51, 63, 51, 19, 222, 112, 10, 36
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    78, 157, 40, 14, 244, 54, 76, 23, 21, 219, 28, 147, 65, 167, 205, 37
    };
    ...
    uint8_t golden[] = {
    78, 83, 40, 14, 244, 54, 76, 23, 72, 26, 79, 166, 31, 167, 215, 37
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
