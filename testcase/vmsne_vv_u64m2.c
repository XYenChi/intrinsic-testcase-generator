...
int main(){
    ...
    153, 251, 131, 218, 46, 171, 213, 206, 144, 204, 164, 216, 242, 105, 131, 187
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    102, 14, 78, 212, 221, 216, 221, 48, 142, 133, 85, 34, 105, 179, 115, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_64m2_b32 (data1_v, data2_v, vl);
