...
int main(){
    ...
    233, 13, 34, 100, 128, 7, 98, 81, 11, 194, 233, 146, 171, 182, 214, 191
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    132, 5, 198, 57, 183, 233, 179, 17, 108, 72, 44, 214, 21, 252, 188, 187
    };
    ...
    uint64_t golden[] = {
    101, 8, 0, 1, 18446744073709551561, 0, 18446744073709551535, 0, 1, 122, 189, 18446744073709551548, 150, 18446744073709551546, 0, 4
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
