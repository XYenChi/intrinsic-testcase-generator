...
int main(){
    ...
    223, 53, 67, 201, 0, 230, 108, 179, 211, 203, 183, 71, 108, 129, 20, 4
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    16, 222, 255, 134, 144, 203, 109, 74, 41, 121, 52, 240, 10, 114, 231, 192
    };
    ...
    uint16_t golden[] = {
    223, 222, 0, 1, 1, 0, 109, 0, 1, 1, 1, 0, 108, 129, 231, 192
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
