...
int main(){
    ...
    149, 233, 48, 229, 86, 137, 87, 189, 228, 35, 227, 204, 73, 20, 134, 105
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    65, 139, 83, 107, 246, 59, 118, 176, 74, 103, 152, 223, 49, 191, 20, 158
    };
    ...
    uint32_t golden[] = {
    9685, 32387, 3984, 24503, 21156, 8083, 10266, 33264, 16872, 3605, 34504, 45492, 3577, 3820, 2680, 16590
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
