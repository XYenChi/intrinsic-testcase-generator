...
int main(){
    const int8_t data1[] = {
    -89, -94, -101, 37, -50, 69, 64, -19, -90, -127, -19, 46, -83, 113, -61, 108
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -18, 37, -14, 81, 72, -49, 71, -128, 33, 1, -44, -59, -8, -27, -20, 73
    };
    ...
    int8_t golden[] = {
    238, 199, 242, 7, 228, 20, 7, 242, 199, 130, 250, 33, 248, 86, 236, 73
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
