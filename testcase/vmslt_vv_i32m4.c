...
int main(){
    const int32_t data1[] = {
    109, 68, -51, 14, -79, 54, 4, -32, 61, -61, 95, 9, 25, -104, -124, 78
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -5, 82, 54, 123, -86, -62, 120, 100, -101, 30, 90, -108, -54, -104, 48, -40
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vv_32m4_b8 (data1_v, data2_v, vl);
    ...
    int32_t golden[] = {
    0, 1, 1, 1, 0, 0, 1, 1, 0, 1, 0, 0, 0, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
