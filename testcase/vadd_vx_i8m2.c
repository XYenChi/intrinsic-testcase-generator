...
int main(){
    const int8_t data1[] = {
    125, 43, 52, -110, 115, -14, 47, -117, -87, -24, -63, -44, -62, 6, 85, -74
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    121, 27, 60, 28, 121, 125, -90, -87, 97, -4, 50, -84, 70, -105, 113, 118
    };
    ...
    int8_t golden[] = {
    246, 70, 112, 174, 236, 111, 213, 52, 10, 228, 243, 128, 8, 157, 198, 44
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
