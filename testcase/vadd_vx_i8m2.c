...
int main(){
    const int8_t data1[] = {
    52, 27, -97, -98, 90, -13, 15, -61, -64, -29, 63, -105, -13, 122, 92, 54
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -82, -52, -84, 114, 82, 86, 119, 126, 88, -29, -126, -85, 104, -57, -115, 23
    };
    ...
    int8_t golden[] = {
    226, 231, 75, 16, 172, 73, 134, 65, 24, 198, 193, 66, 91, 65, 233, 77
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
