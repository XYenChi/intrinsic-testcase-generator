...
int main(){
    ...
    32, 148, 52, 246, 116, 197, 100, 162, 59, 98, 10, 137, 138, 121, 203, 253
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    90, 31, 227, 157, 187, 65, 192, 252, 114, 159, 158, 149, 136, 119, 253, 114
    };
    ...
    uint16_t golden[] = {
    32, 117, 65361, 246, 65465, 197, 100, 162, 59, 65475, 10, 65524, 138, 2, 65486, 139
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
