...
int main(){
    const uint8_t data1[] = {
    184, 46, 118, 63, 105, 95, 73, 138, 5, 195, 217, 16, 249, 54, 168, 193
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    204, 212, 217, 87, 160, 94, 67, 188, 207, 156, 25, 59, 24, 217, 44, 160
    };
    ...
    uint8_t golden[] = {
    204, 0, 0, 0, 160, 1, 0, 188, 207, 0, 1, 59, 249, 217, 0, 193
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
