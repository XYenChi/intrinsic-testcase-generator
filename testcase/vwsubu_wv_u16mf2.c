...
int main(){
    ...
    190, 48, 83, 151, 47, 14, 5, 225, 3, 196, 200, 7, 222, 168, 137, 207
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    120, 192, 247, 226, 62, 248, 203, 148, 219, 220, 185, 31, 205, 90, 60, 78
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u16mf2 (data1_v, data2_v, vl);
