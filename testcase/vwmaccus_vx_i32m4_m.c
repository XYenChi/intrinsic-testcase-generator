...
int main(){
    const int32_t data1[] = {
    -103, -52, -113, 6, 30, -64, -28, -100, 3, -57, 10, 108, -13, -36, 61, -40
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -8, -83, 64, -24, 125, 71, 79, 13, -23, -104, 127, -30, 26, 51, 72, 40
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccus_vx_i32m4_m (mask, out_data, data1_v, data2_v, vl);
