...
int main(){
    const int8_t data1[] = {
    -88, 0, -25, 11, 110, 20, 119, 53, -122, 114, -54, -79, 120, -70, -115, 99
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    80, -20, 76, -109, -81, 37, 8, 91, 116, -72, 101, 45, 73, 121, 14, -52
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vv_8m1_b8 (data1_v, data2_v, vl);
