...
int main(){
    const int16_t data1[] = {
    69, 15, 79, 13, 21, 68, 123, -20, -38, -52, -11, 72, 58, -68, -3, 18
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    92, -32, 72, 28, -10, 51, -62, -57, 113, 53, 66, 95, 124, 64, 5, 107
    };
    ...
    int16_t golden[] = {
    6348, 65056, 5688, 364, 65326, 3468, 57910, 1140, 61242, 62780, 64810, 6840, 7192, 61184, 65521, 1926
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
