...
int main(){
    const int16_t data1[] = {
    -72, 28, 58, 35, -103, -71, 61, -78, 65, 31, 93, -37, 92, 83, 11, -23
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -4, -89, 108, -97, 112, 4, 11, -5, -125, -86, -108, -2, 99, -67, 27, 105
    };
    ...
    int16_t golden[] = {
    288, 63044, 6264, 62141, 54000, 65252, 671, 390, 57411, 62870, 55492, 74, 9108, 59975, 297, 63121
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
