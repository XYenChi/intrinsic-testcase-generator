...
int main(){
    ...
    247, 197, 226, 33, 218, 195, 56, 90, 97, 233, 198, 49, 24, 160, 88, 209
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    247, 97, 23, 61, 239, 162, 209, 121, 77, 77, 45, 0, 11, 37, 54, 78
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u64m1 (data1_v, data2_v, vl);
