...
int main(){
    const uint8_t data1[] = {
    189, 17, 30, 112, 92, 114, 71, 69, 39, 206, 232, 231, 249, 113, 101, 185
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    109, 193, 152, 83, 130, 3, 71, 97, 236, 124, 166, 102, 232, 164, 229, 236
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vx_8mf4_b32 (data1_v, data2_v, vl);
