...
int main(){
    ...
    168, 240, 100, 210, 245, 217, 189, 253, 56, 45, 2, 51, 42, 30, 234, 192
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    202, 45, 81, 162, 109, 92, 184, 156, 193, 157, 28, 169, 224, 63, 226, 139
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulu_vv_u16m2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    33936, 10800, 8100, 1, 26705, 19964, 0, 1, 10808, 7065, 56, 8619, 0, 1890, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
