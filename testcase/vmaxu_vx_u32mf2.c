...
int main(){
    ...
    227, 162, 160, 80, 21, 93, 55, 65, 200, 184, 125, 101, 185, 236, 67, 37
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    221, 0, 26, 33, 19, 15, 194, 172, 11, 159, 2, 130, 165, 135, 97, 103
    };
    ...
    uint32_t golden[] = {
    227, 162, 160, 80, 21, 93, 194, 172, 200, 184, 125, 130, 185, 236, 97, 103
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
