...
int main(){
    const int8_t data1[] = {
    91, -45, 114, -82, -80, 125, 82, 127, -8, -113, 1, -92, 125, 9, -8, -57
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -87, 66, 75, 49, 87, 72, -104, 9, -26, -83, 94, 30, 99, 115, -22, -101
    };
    ...
    int8_t golden[] = {
    4, 21, 189, 223, 7, 197, 234, 136, 222, 60, 95, 194, 224, 124, 226, 98
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
