...
int main(){
    const int8_t data1[] = {
    -78, -111, 19, 47, -60, 47, -35, -80, 72, -110, 106, 36, -29, 9, 74, -44
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    65, -96, 4, 29, 52, 1, -123, -126, -10, 84, -48, 58, -88, 70, 119, -105
    };
    ...
    int8_t golden[] = {
    -13, -128, 23, 76, -8, 48, -128, -128, 62, -26, 58, 94, -117, 79, 127, -128
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
