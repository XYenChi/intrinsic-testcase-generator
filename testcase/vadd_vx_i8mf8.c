...
int main(){
    const int8_t data1[] = {
    230, 71, 159, 228, 131, 81, 123, 154, 205, 195, 165, 109, 86, 17, 184, 140
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    176, 32, 204, 117, 5, 163, 227, 6, 152, 96, 29, 228, 151, 231, 207, 10
    };
    ...
    int8_t golden[] = {
    406, 103, 363, 345, 136, 244, 350, 160, 357, 291, 194, 337, 237, 248, 391, 150
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
