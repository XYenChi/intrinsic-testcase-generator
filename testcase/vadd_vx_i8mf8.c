...
int main(){
    const int8_t data1[] = {
    24, -127, 124, 82, -21, -16, 117, -74, 110, -123, 25, 98, -70, 1, 7, 77
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    106, 118, -126, 11, 16, 4, -113, -33, 58, 78, 28, 74, 51, -65, 75, 32
    };
    ...
    int8_t golden[] = {
    130, 247, 254, 93, 251, 244, 4, 149, 168, 211, 53, 172, 237, 192, 82, 109
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
