...
int main(){
    const uint8_t data1[] = {
    245, 191, 77, 190, 166, 250, 23, 167, 52, 253, 60, 220, 93, 254, 165, 204
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    162, 10, 22, 24, 29, 241, 47, 221, 126, 100, 207, 229, 64, 132, 214, 7
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i8m8 (data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 0, 0, 0, 0, 0, 2, 1, 2, 0, 3, 1, 0, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
