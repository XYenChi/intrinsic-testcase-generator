...
int main(){
    const uint8_t data1[] = {
    249, 185, 197, 81, 134, 42, 157, 215, 177, 58, 219, 2, 183, 176, 221, 255
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    153, 186, 147, 150, 100, 195, 249, 115, 175, 245, 229, 138, 217, 62, 191, 105
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i8m1_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 1, 0, 0, 0, 4, 1, 1, 0, 0, 1, 69, 0, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
