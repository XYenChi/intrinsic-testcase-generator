...
int main(){
    const int8_t data1[] = {
    38, 62, -23, -90, 122, 22, 3, -62, -20, -103, 1, -39, -70, -62, -62, 71
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -95, -41, 61, 125, -55, 104, -10, 24, 36, -77, -13, -42, -57, -58, -78, 50
    };
    ...
    int8_t golden[] = {
    133, 103, 172, 41, 177, 174, 13, 170, 236, 230, 14, 3, 243, 194, 16, 21
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
