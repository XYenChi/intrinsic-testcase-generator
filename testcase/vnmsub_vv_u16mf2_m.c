...
int main(){
    ...
    68, 167, 134, 72, 143, 123, 6, 244, 20, 26, 213, 223, 145, 123, 102, 214
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    244, 155, 87, 38, 213, 30, 238, 113, 21, 78, 182, 202, 248, 208, 171, 47
    };
    ...
    uint16_t golden[] = {
    65360, 12, 134, 72, 65466, 93, 1, 131, 65535, 65484, 0, 21, 1, 0, 65467, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
