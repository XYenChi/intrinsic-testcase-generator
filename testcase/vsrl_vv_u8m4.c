...
int main(){
    const uint8_t data1[] = {
    214, 221, 130, 3, 7, 228, 75, 160, 152, 177, 248, 73, 61, 201, 63, 251
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    66, 44, 107, 155, 134, 146, 65, 177, 76, 24, 215, 33, 19, 130, 33, 234
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u8m4 (data1_v, shift, vl);
