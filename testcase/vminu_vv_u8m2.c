...
int main(){
    const uint8_t data1[] = {
    205, 71, 29, 146, 187, 229, 138, 4, 56, 122, 28, 159, 178, 242, 26, 168
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    69, 181, 62, 227, 180, 113, 71, 10, 57, 118, 23, 19, 136, 5, 30, 73
    };
    ...
    uint8_t golden[] = {
    205, 181, 62, 227, 187, 229, 138, 10, 57, 122, 28, 159, 178, 242, 30, 168
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
