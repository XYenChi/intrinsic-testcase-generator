...
int main(){
    const uint8_t data1[] = {
    234, 102, 116, 89, 58, 70, 139, 15, 74, 10, 128, 234, 170, 203, 229, 116
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    180, 95, 33, 74, 142, 196, 99, 30, 244, 115, 127, 155, 92, 8, 96, 100
    };
    ...
    uint8_t golden[] = {
    234, 102, 116, 89, 142, 196, 139, 30, 244, 115, 128, 234, 170, 203, 229, 116
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
