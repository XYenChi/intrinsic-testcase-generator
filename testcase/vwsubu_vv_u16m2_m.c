...
int main(){
    ...
    26, 237, 87, 86, 163, 11, 17, 237, 239, 143, 36, 59, 180, 244, 113, 249
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    26, 100, 187, 244, 114, 67, 230, 117, 12, 224, 232, 83, 38, 62, 183, 230
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u16m2_m (mask, data1_v, data2_v, vl);
