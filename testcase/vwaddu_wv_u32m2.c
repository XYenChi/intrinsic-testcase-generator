...
int main(){
    ...
    153, 247, 153, 60, 255, 235, 252, 217, 114, 135, 208, 20, 31, 192, 236, 228
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    8, 17, 132, 140, 177, 17, 174, 229, 206, 252, 132, 197, 194, 251, 177, 245
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u32m2 (data1_v, data2_v, vl);
