...
int main(){
    const int16_t data1[] = {
    112, -78, 17, 67, 67, 123, 53, 3, -64, -71, 2, 42, -34, 92, 66, 19
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    7, 60, 50, 101, -47, -111, -95, 60, 35, 23, -65, 24, -61, -125, -91, -117
    };
    ...
    int16_t golden[] = {
    784, 60856, 0, 6767, 0, 0, 60501, 180, 63296, 0, 0, 1008, 0, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
