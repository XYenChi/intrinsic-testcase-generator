...
int main(){
    const int16_t data1[] = {
    116, -102, -106, 39, 100, -42, -68, 12, 10, -49, -27, -36, 106, 122, 80, 84
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    64, 49, -19, -40, -115, -112, 93, 97, 39, 15, 30, 108, -29, 15, 23, -97
    };
    ...
    int16_t golden[] = {
    7424, 1, 1, 0, 1, 1, 59212, 1164, 390, 1, 1, 0, 0, 0, 1840, 57388
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
