...
int main(){
    const uint8_t data1[] = {
    250, 159, 37, 1, 91, 247, 22, 87, 202, 0, 50, 98, 144, 55, 156, 207
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    144, 93, 167, 105, 141, 248, 173, 66, 86, 61, 31, 72, 186, 55, 193, 23
    };
    ...
    uint8_t golden[] = {
    250, 93, 37, 1, 141, 247, 22, 153, 32, 0, 31, 72, 186, 55, 93, 207
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
