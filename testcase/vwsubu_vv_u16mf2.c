...
int main(){
    ...
    41, 155, 122, 109, 213, 225, 221, 6, 121, 127, 73, 28, 99, 98, 91, 96
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    93, 153, 200, 192, 78, 221, 125, 246, 30, 240, 54, 240, 194, 5, 111, 7
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u16mf2 (data1_v, data2_v, vl);
