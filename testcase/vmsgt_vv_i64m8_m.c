...
int main(){
    const int64_t data1[] = {
    -43, -115, -56, -38, 101, 14, 81, -83, -34, -119, 110, 39, -6, 107, 65, 116
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    125, -45, 96, 28, 2, 100, 53, -29, -122, -77, -71, -63, -117, -110, -19, 44
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vv_64m8_b8_m (mask, data1_v, data2_v, vl);
