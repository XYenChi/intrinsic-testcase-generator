...
int main(){
    const int32_t data1[] = {
    -14, -33, 39, -52, 122, -95, -24, 6, -118, -19, -54, -57, 4, -77, 103, -52
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -31, -78, 40, 37, 10, -75, -61, -34, -105, -1, -7, -45, 79, -36, 124, -27
    };
    ...
    int32_t golden[] = {
    4294967293, 4294967284, 1, 4294967281, 10, 4294967221, 4294967283, 2, 4294967191, 4294967295, 4294967289, 4294967251, 3, 4294967260, 21, 4294967269
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
