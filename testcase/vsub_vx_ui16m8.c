...
int main(){
    const int16_t data1[] = {
    144, 114, 150, 37, 189, 192, 210, 236, 147, 48, 63, 169, 58, 8, 3, 82
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    205, 182, 30, 63, 191, 187, 145, 147, 154, 26, 57, 95, 186, 207, 82, 61
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vx_ui16m8 (data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    0, 0, 120, 0, 0, 5, 65, 89, 0, 22, 6, 74, 0, 0, 0, 21
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
