...
int main(){
    const int16_t data1[] = {
    -42, -26, -102, 60, 64, -89, 27, -76, 50, -76, 21, 123, 63, -40, 96, -81
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    159, 104, 242, 205, 220, 240, 199, 211, 16, 120, 162, 67, 171, 189, 21, 122
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_16m1_b16 (data1_v, data2_v, vl);
