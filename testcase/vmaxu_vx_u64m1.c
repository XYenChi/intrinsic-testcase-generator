...
int main(){
    ...
    151, 181, 249, 199, 219, 127, 170, 16, 67, 201, 58, 50, 229, 229, 182, 197
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    175, 211, 155, 197, 241, 232, 55, 50, 54, 25, 246, 133, 195, 159, 23, 243
    };
    ...
    uint64_t golden[] = {
    175, 211, 249, 199, 241, 232, 170, 50, 67, 201, 246, 133, 229, 229, 182, 243
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
