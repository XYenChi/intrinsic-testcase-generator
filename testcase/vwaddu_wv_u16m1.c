...
int main(){
    ...
    4, 227, 201, 226, 60, 248, 30, 20, 186, 157, 93, 85, 92, 194, 63, 20
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    3, 81, 92, 165, 87, 188, 194, 11, 86, 176, 48, 116, 52, 89, 60, 83
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u16m1 (data1_v, data2_v, vl);
