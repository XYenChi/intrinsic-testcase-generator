...
int main(){
    const int32_t data1[] = {
    -100, -55, -113, -105, -95, -62, -90, -73, 122, -59, 1, 26, -12, 4, 41, -73
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -70, 72, -110, 70, -4, 41, -28, -124, -91, 50, -58, -95, 125, 28, 21, -112
    };
    ...
    int32_t golden[] = {
    7000, 4294963336, 12430, 4294959946, 380, 4294964754, 2520, 9052, 4294956194, 4294964346, 4294967238, 4294964826, 4294965796, 112, 861, 8176
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
