...
int main(){
    ...
    29, 12, 144, 36, 248, 169, 44, 102, 17, 239, 213, 179, 47, 130, 75, 241
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    201, 139, 68, 216, 57, 237, 169, 186, 63, 155, 123, 255, 140, 240, 188, 156
    };
    ...
    uint32_t golden[] = {
    172, 127, 4294967220, 180, 4294967105, 68, 125, 0, 1, 0, 1, 1, 93, 110, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
