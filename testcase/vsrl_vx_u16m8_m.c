...
int main(){
    ...
    75, 117, 230, 34, 102, 11, 239, 252, 210, 134, 206, 162, 113, 185, 211, 246
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    110, 39, 98, 104, 117, 198, 165, 183, 172, 186, 61, 101, 105, 27, 155, 18
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u16m8_m (mask, data1_v, shift, vl);
    ...
    uint16_t golden[] = {
    75, 58, 230, 34, 51, 11, 119, 126, 210, 134, 103, 81, 56, 92, 105, 246
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
