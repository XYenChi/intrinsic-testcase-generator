...
int main(){
    const int16_t data1[] = {
    15, 54, 4, 37, 70, 97, 119, 48, 97, 60, 101, -20, -105, 117, 0, 115
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    127, -81, -77, -16, 36, 21, -4, -81, -66, -28, 122, -127, 101, -126, -103, 110
    };
    ...
    int16_t golden[] = {
    1906, 61163, 65228, 64944, 2520, 2037, 65060, 61649, 59135, 63856, 12323, 2541, 54932, 50794, 1, 12650
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
