...
int main(){
    const int16_t data1[] = {
    127, 13, -32, -80, -30, 82, -71, 23, -76, 86, 101, -33, 30, 76, -55, -30
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -109, 75, 21, -127, -59, -56, 110, 13, 25, -99, -91, 69, 109, 123, 69, -113
    };
    ...
    int16_t golden[] = {
    51694, 976, 64865, 10161, 1770, 60945, 57726, 299, 63636, 57022, 56346, 63260, 3270, 9348, 61741, 3391
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
