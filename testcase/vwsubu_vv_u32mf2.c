...
int main(){
    ...
    140, 115, 173, 22, 159, 156, 86, 245, 247, 250, 227, 123, 68, 137, 201, 161
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    174, 244, 110, 20, 37, 225, 253, 120, 46, 196, 37, 190, 61, 232, 69, 81
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u32mf2 (data1_v, data2_v, vl);
