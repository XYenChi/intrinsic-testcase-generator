...
int main(){
    const uint8_t data1[] = {
    175, 221, 64, 68, 204, 248, 227, 26, 91, 106, 11, 59, 228, 8, 121, 73
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    122, 178, 147, 222, 151, 96, 137, 13, 24, 124, 84, 142, 198, 224, 108, 137
    };
    ...
    uint8_t golden[] = {
    298, 399, 212, 291, 355, 344, 364, 40, 115, 230, 95, 201, 426, 233, 229, 210
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
