...
int main(){
    const uint8_t data1[] = {
    11, 161, 119, 164, 111, 184, 184, 66, 237, 242, 240, 65, 107, 206, 150, 72
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    30, 219, 137, 54, 24, 224, 89, 72, 177, 200, 115, 136, 63, 78, 57, 137
    };
    ...
    uint8_t golden[] = {
    237, 198, 238, 110, 87, 216, 95, 250, 60, 42, 125, 185, 44, 128, 93, 191
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
