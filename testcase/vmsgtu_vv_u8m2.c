...
int main(){
    const uint8_t data1[] = {
    59, 212, 52, 124, 103, 253, 244, 4, 193, 245, 171, 169, 191, 211, 73, 97
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    242, 171, 134, 197, 215, 209, 130, 14, 49, 124, 115, 137, 90, 221, 123, 129
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_8m2_b4 (data1_v, data2_v, vl);
