...
int main(){
    const int16_t data1[] = {
    17, 84, 1, 51, -84, -20, 60, -11, -81, -49, -7, -13, 98, -19, -29, -17
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -52, -109, 37, -66, 69, -71, 63, 96, -123, 64, -63, 59, -58, 78, -7, 73
    };
    ...
    int16_t golden[] = {
    885, 9156, 65500, 3367, 5797, 64116, 61757, 1057, 55574, 3136, 65096, 767, 5685, 1482, 65333, 1242
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
