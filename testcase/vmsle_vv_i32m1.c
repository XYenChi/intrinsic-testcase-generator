...
int main(){
    const int32_t data1[] = {
    87, -77, -124, 73, -113, -124, 11, -101, -114, 9, 5, 77, -67, -20, -125, -54
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    1, 126, 13, -15, 86, -84, -112, -60, -112, 6, 105, 87, -19, 37, -100, 32
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vv_32m1_b32 (data1_v, data2_v, vl);
