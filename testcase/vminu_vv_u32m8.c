...
int main(){
    ...
    39, 67, 169, 136, 21, 139, 238, 63, 156, 191, 197, 206, 172, 151, 226, 21
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    173, 201, 75, 180, 4, 244, 222, 106, 41, 138, 96, 156, 208, 235, 200, 84
    };
    ...
    uint32_t golden[] = {
    173, 201, 169, 180, 21, 244, 238, 106, 156, 191, 197, 206, 208, 235, 226, 84
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
