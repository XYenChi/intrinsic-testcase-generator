...
int main(){
    ...
    181, 181, 81, 114, 36, 55, 234, 112, 241, 189, 14, 91, 240, 133, 50, 92
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    206, 93, 130, 160, 2, 38, 131, 96, 61, 119, 246, 75, 122, 66, 0, 78
    };
    ...
    uint32_t golden[] = {
    206, 181, 130, 160, 36, 55, 234, 112, 241, 189, 246, 91, 240, 133, 50, 92
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
