...
int main(){
    const uint8_t data1[] = {
    14, 174, 55, 111, 42, 7, 198, 180, 103, 51, 128, 180, 252, 68, 111, 247
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    93, 140, 166, 245, 22, 82, 237, 194, 162, 85, 10, 95, 136, 240, 224, 59
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_8mf8 (data1_v, shift, vl);
