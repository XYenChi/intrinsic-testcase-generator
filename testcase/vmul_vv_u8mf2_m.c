...
int main(){
    const uint8_t data1[] = {
    50, 208, 209, 54, 27, 197, 36, 238, 47, 225, 38, 142, 243, 221, 78, 135
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    219, 101, 28, 47, 32, 107, 198, 136, 61, 60, 44, 58, 35, 86, 108, 71
    };
    ...
    uint8_t golden[] = {
    198, 16, 0, 1, 96, 0, 216, 0, 51, 0, 136, 44, 0, 62, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
