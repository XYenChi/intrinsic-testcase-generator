...
int main(){
    const uint8_t data1[] = {
    180, 156, 178, 90, 170, 9, 80, 104, 13, 201, 226, 4, 218, 182, 41, 89
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    60, 211, 114, 51, 51, 104, 55, 2, 54, 250, 130, 86, 117, 38, 229, 219
    };
    ...
    uint8_t golden[] = {
    0, 0, 68, 238, 1, 168, 1, 0, 190, 0, 0, 88, 162, 1, 0, 35
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
