...
int main(){
    const int16_t data1[] = {
    -2, -100, 115, 106, -64, -103, -51, -23, 26, 83, -21, 106, -41, -47, 67, -71
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -35, -94, 56, -48, -80, -87, 52, 98, 94, -102, -3, -15, -83, 67, -92, -15
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vx_16mf4_b64_m (mask, data1_v, data2_v, vl);
