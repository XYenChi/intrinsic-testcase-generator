...
int main(){
    ...
    230, 45, 191, 190, 102, 199, 193, 142, 38, 107, 92, 150, 16, 76, 12, 81
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    68, 116, 92, 12, 67, 74, 19, 61, 123, 64, 35, 22, 6, 216, 77, 54
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u16m8_m (mask, data1_v, data2_v, vl);
