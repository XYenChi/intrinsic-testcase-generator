...
int main(){
    ...
    33, 122, 160, 71, 67, 244, 215, 121, 97, 238, 204, 223, 199, 45, 38, 29
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    120, 104, 11, 221, 242, 48, 170, 82, 37, 174, 152, 153, 30, 76, 24, 97
    };
    ...
    uint16_t golden[] = {
    153, 122, 11, 71, 309, 244, 215, 121, 134, 238, 152, 223, 229, 45, 38, 29
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
