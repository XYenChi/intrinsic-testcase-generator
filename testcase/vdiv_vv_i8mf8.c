...
int main(){
    const int8_t data1[] = {
    -79, -100, 82, 35, -8, -73, -122, 42, -14, -5, -123, -74, -10, -69, -74, -48
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    79, -105, 66, -37, 9, 116, 112, -81, 23, -99, 31, 74, 38, -51, 102, 60
    };
    ...
    int8_t golden[] = {
    255, 1, 0, 254, 254, 254, 255, 254, 254, 19, 255, 255, 252, 0, 254, 254
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
