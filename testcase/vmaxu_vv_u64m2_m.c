...
int main(){
    ...
    237, 145, 229, 5, 50, 85, 32, 121, 158, 184, 117, 134, 105, 107, 150, 74
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    27, 157, 252, 7, 2, 55, 166, 199, 17, 56, 50, 2, 127, 193, 56, 19
    };
    ...
    uint64_t golden[] = {
    237, 157, 0, 7, 50, 1, 1, 199, 158, 184, 117, 1, 127, 1, 150, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
