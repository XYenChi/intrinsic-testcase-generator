...
int main(){
    const uint8_t data1[] = {
    92, 31, 238, 174, 253, 7, 13, 96, 187, 17, 201, 115, 179, 197, 6, 208
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    7, 97, 202, 9, 111, 156, 247, 205, 250, 10, 133, 247, 179, 177, 35, 49
    };
    const uint8_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e8mf2(avl);
    const uint out_data[] = {
    1, 0, 0, 1, 0, 0, 0, 0, 1, 1, 1, 0, 1, 0, 1, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u8mf2_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    7, 4, 0, 1, 111, 0, 0, 13, 63, 10, 133, 17, 0, 177, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
