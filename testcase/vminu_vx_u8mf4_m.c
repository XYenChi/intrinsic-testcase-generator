...
int main(){
    const uint8_t data1[] = {
    208, 116, 150, 11, 183, 246, 163, 60, 6, 70, 205, 205, 208, 63, 33, 155
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    198, 223, 49, 168, 54, 100, 188, 218, 231, 90, 215, 106, 13, 77, 108, 131
    };
    ...
    uint8_t golden[] = {
    208, 223, 1, 168, 1, 1, 188, 218, 231, 90, 1, 205, 208, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
