...
int main(){
    const uint8_t data1[] = {
    140, 196, 13, 162, 187, 31, 42, 188, 17, 145, 56, 149, 217, 33, 227, 133
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    161, 79, 217, 36, 95, 200, 88, 226, 13, 64, 73, 98, 137, 236, 249, 42
    };
    ...
    uint8_t golden[] = {
    161, 196, 217, 162, 187, 200, 88, 226, 17, 145, 73, 149, 217, 236, 249, 133
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
