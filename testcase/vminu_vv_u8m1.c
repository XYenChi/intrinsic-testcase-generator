...
int main(){
    const uint8_t data1[] = {
    202, 145, 77, 232, 101, 143, 15, 50, 115, 66, 10, 45, 187, 35, 147, 231
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    208, 60, 63, 80, 112, 76, 173, 228, 195, 215, 79, 103, 136, 243, 250, 39
    };
    ...
    uint8_t golden[] = {
    208, 145, 77, 232, 112, 143, 173, 228, 195, 215, 79, 103, 187, 243, 250, 231
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
