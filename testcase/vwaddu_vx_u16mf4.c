...
int main(){
    ...
    38, 203, 9, 67, 96, 37, 62, 168, 2, 165, 115, 172, 112, 159, 62, 40
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    211, 106, 30, 10, 86, 169, 114, 57, 9, 253, 93, 88, 74, 206, 234, 183
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u16mf4 (data1_v, data2_v, vl);
