...
int main(){
    ...
    99, 28, 180, 253, 198, 145, 249, 48, 154, 34, 51, 165, 6, 56, 200, 188
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    33, 250, 138, 251, 36, 73, 230, 208, 2, 121, 23, 27, 142, 14, 10, 155
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u16m8 (data1_v, data2_v, vl);
