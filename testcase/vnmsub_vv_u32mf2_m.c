...
int main(){
    ...
    150, 12, 145, 251, 49, 156, 244, 64, 162, 224, 241, 92, 91, 157, 150, 199
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    115, 81, 235, 79, 3, 14, 134, 154, 192, 115, 37, 49, 43, 144, 187, 139
    };
    ...
    uint32_t golden[] = {
    1, 12, 4294967206, 1, 1, 1, 244, 4294967206, 162, 224, 0, 43, 91, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
