...
int main(){
    ...
    92, 242, 146, 171, 200, 216, 88, 236, 236, 198, 193, 65, 239, 217, 163, 58
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    50, 169, 10, 229, 5, 121, 73, 57, 118, 38, 228, 157, 18, 159, 182, 148
    };
    ...
    uint16_t golden[] = {
    1, 411, 0, 400, 0, 1, 161, 293, 354, 1, 0, 222, 257, 1, 0, 206
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
