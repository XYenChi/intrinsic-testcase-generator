...
int main(){
    const int64_t data1[] = {
    -126, -57, 18, 45, -124, -115, -47, 19, -34, -45, -125, -107, 98, 108, 47, 102
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    82, -87, -112, 46, -73, 15, 41, -84, -119, 110, 87, -26, -84, -75, -108, -117
    };
    ...
    int64_t golden[] = {
    0, 1, 18, 1, 18446744073709551543, 15, 41, 19, 18446744073709551582, 0, 87, 18446744073709551590, 98, 1, 47, 102
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
