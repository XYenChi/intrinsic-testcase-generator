...
int main(){
    ...
    132, 148, 21, 112, 245, 140, 116, 202, 114, 184, 212, 187, 117, 59, 163, 50
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    58, 61, 15, 92, 178, 195, 217, 97, 240, 35, 95, 59, 85, 229, 215, 15
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_32m2_b16 (mask, data1_v, data2_v, vl);
