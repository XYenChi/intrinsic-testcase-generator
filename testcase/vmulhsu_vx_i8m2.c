...
int main(){
    const int8_t data1[] = {
    -108, -94, 95, 65, 74, 74, -47, -127, -52, 58, -51, -80, 85, -25, 100, -35
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    124, 250, 107, 61, 5, 212, 186, 151, 145, 5, 158, 67, 191, 21, 181, 28
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_8m2_b4 (data1_v, data2_v, vl);
