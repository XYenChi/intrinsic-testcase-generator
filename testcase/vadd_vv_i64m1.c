...
int main(){
    const int64_t data1[] = {
    28, -105, 98, -98, 112, -73, 87, 79, -76, 45, -20, 109, -60, 24, 102, -80
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    100, 97, -95, -58, -54, -13, 41, -31, -24, -51, -99, 117, 113, 15, 108, -46
    };
    ...
    int64_t golden[] = {
    127, -8, 3, -128, 58, -86, 127, 48, -100, -6, -119, 127, 53, 39, 127, -126
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
