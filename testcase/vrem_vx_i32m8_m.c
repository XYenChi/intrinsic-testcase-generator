...
int main(){
    const int32_t data1[] = {
    67, -4, 49, -26, -67, -71, 88, -102, -52, -27, 68, -68, 51, -23, -124, 18
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -85, 64, -43, 34, 81, 6, 35, 67, -91, 100, -24, 0, -5, -29, 22, -100
    };
    const int32_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e32m8(avl);
    const int out_data[] = {
    0, 1, 1, 0, 1, 0, 0, 0, 0, 1, 1, 1, 0, 1, 0, 0
    };
    ...
    int32_t golden[] = {
    49, 0, 6, 4294967278, 1, 4294967231, 0, 0, 4294967257, 1, 44, 1, 46, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
