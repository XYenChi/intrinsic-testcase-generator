...
int main(){
    ...
    157, 157, 8, 170, 226, 242, 183, 48, 96, 6, 35, 220, 234, 73, 227, 16
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    15, 220, 210, 121, 163, 92, 43, 226, 173, 71, 199, 154, 78, 137, 238, 53
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vx_32m1_b32 (data1_v, data2_v, vl);
