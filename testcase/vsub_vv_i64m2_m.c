...
int main(){
    const int64_t data1[] = {
    -6, -95, -98, -18, 119, 2, 94, 6, 85, -28, 97, -89, -11, 10, 35, -89
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    110, -127, -43, 87, 33, -56, 27, -70, -50, 53, 95, -18, 106, -69, 27, -91
    };
    ...
    int64_t golden[] = {
    18446744073709551500, 0, 18446744073709551561, 1, 86, 1, 67, 0, 1, 18446744073709551535, 2, 0, 0, 79, 1, 2
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
