...
int main(){
    const int16_t data1[] = {
    -116, 64, 60, -115, 113, -31, 72, 62, -107, 99, 102, -102, 125, -24, -60, 3
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    32, 79, -88, 48, 55, 33, -37, 56, -5, -98, -10, 120, -90, -92, 80, -82
    };
    ...
    int16_t golden[] = {
    32, 79, 60, 48, 113, 33, 72, 62, 65531, 99, 102, 120, 125, 65512, 80, 3
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
