...
int main(){
    const uint8_t data1[] = {
    16, 43, 166, 144, 206, 24, 4, 114, 14, 153, 113, 178, 244, 70, 118, 236
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    217, 252, 181, 174, 55, 130, 13, 115, 79, 178, 246, 190, 203, 201, 39, 219
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vv_u8mf2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    1, 0, 0, 1, 0, 48, 1, 0, 83, 1, 151, 0, 0, 1, 250, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
