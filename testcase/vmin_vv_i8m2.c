...
int main(){
    const int8_t data1[] = {
    104, 98, -20, 53, 60, -53, -83, -86, -121, -96, -35, -58, -114, 19, -11, 22
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    5, -47, -40, -68, -24, 63, -52, -33, 30, 44, -110, 126, -77, 89, -19, -74
    };
    ...
    int8_t golden[] = {
    104, 98, 236, 53, 60, 63, 204, 223, 30, 44, 221, 126, 179, 89, 245, 22
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
