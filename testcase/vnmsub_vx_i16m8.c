...
int main(){
    const int16_t data1[] = {
    -91, -76, 80, 81, 72, -19, -23, -88, -94, 73, -37, 94, 53, 43, 33, 6
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    40, -45, -111, -125, 115, -56, 81, -7, -126, 102, 119, 114, 10, -11, 15, -46
    };
    ...
    int16_t golden[] = {
    65445, 65505, 80, 206, 65493, 65517, 65513, 65448, 65442, 73, 65499, 65516, 53, 54, 33, 52
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
