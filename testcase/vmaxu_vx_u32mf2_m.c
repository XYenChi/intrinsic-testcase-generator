...
int main(){
    ...
    167, 130, 183, 231, 129, 12, 157, 9, 20, 108, 187, 136, 43, 134, 30, 21
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    176, 97, 197, 249, 118, 83, 173, 85, 181, 153, 203, 143, 179, 84, 42, 175
    };
    ...
    uint32_t golden[] = {
    176, 130, 197, 0, 129, 1, 173, 85, 181, 1, 0, 143, 1, 0, 0, 175
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
