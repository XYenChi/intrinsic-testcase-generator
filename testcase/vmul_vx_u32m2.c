...
int main(){
    ...
    100, 223, 153, 164, 31, 34, 91, 80, 66, 161, 37, 53, 189, 239, 94, 153
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    43, 164, 156, 40, 102, 231, 54, 30, 48, 133, 142, 136, 133, 244, 232, 132
    };
    ...
    uint32_t golden[] = {
    4300, 36572, 23868, 6560, 3162, 7854, 4914, 2400, 3168, 21413, 5254, 7208, 25137, 58316, 21808, 20196
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
