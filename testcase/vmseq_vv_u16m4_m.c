...
int main(){
    ...
    241, 162, 59, 21, 58, 179, 18, 134, 14, 154, 122, 183, 89, 64, 247, 190
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    25, 39, 86, 245, 115, 87, 45, 52, 160, 6, 122, 50, 124, 250, 130, 156
    };
    ...
    uint4_t masked[] = {
    1, 0, 1, 0, 0, 0, 0, 0, 1, 1, 0, 0, 1, 1, 0, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_16m4_b4_m (mask, data1_v, data2_v, vl);
