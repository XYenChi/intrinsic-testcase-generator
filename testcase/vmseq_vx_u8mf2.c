...
int main(){
    const uint8_t data1[] = {
    45, 23, 189, 9, 169, 181, 216, 175, 129, 147, 14, 31, 156, 26, 216, 1
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    154, 93, 200, 154, 151, 116, 9, 16, 121, 204, 142, 117, 137, 125, 107, 210
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_8mf2_b16 (data1_v, data2_v, vl);
