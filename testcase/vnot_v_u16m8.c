...
int main(){
    ...
    152, 114, 191, 147, 107, 121, 67, 215, 10, 105, 213, 110, 167, 32, 114, 73
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnot_v_u16m8 (data1_v, vl);
    ...
    uint16_t golden[] = {
    -153, -115, -192, -148, -108, -122, -68, -216, -11, -106, -214, -111, -168, -33, -115, -74
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
