...
int main(){
    const int16_t data1[] = {
    0, -39, 83, 50, 41, -119, 71, -107, -113, 100, -124, -36, 86, 118, -125, 30
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    26, -1, 23, -28, 69, 10, -75, 13, 81, 97, 117, 120, -28, 89, 45, 43
    };
    ...
    int16_t golden[] = {
    1, 0, 0, 65535, 1, 1, 65534, 65535, 65535, 0, 65535, 65532, 65535, 0, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
