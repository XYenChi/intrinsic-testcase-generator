...
int main(){
    ...
    12, 192, 197, 240, 227, 131, 188, 163, 64, 5, 216, 125, 159, 94, 124, 25
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    16, 84, 228, 15, 206, 61, 16, 229, 17, 50, 131, 247, 160, 58, 218, 78
    };
    ...
    uint32_t golden[] = {
    28, 276, 425, 255, 433, 192, 204, 392, 81, 55, 347, 372, 319, 152, 342, 103
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
