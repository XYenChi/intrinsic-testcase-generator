...
int main(){
    const int32_t data1[] = {
    98, 213, 142, 156, 105, 181, 49, 100, 155, 240, 193, 199, 221, 132, 239, 209
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    154, 205, 249, 83, 148, 28, 212, 53, 22, 133, 91, 173, 134, 21, 234, 30
    };
    ...
    int32_t golden[] = {
    252, 418, 391, 239, 253, 209, 261, 153, 177, 373, 284, 372, 355, 153, 473, 239
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
