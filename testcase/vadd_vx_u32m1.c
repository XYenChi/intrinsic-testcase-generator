...
int main(){
    ...
    103, 213, 221, 66, 39, 76, 227, 10, 146, 73, 242, 223, 189, 52, 14, 42
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    201, 60, 187, 175, 134, 120, 254, 71, 132, 220, 118, 243, 124, 241, 175, 162
    };
    ...
    uint32_t golden[] = {
    304, 273, 408, 241, 173, 196, 481, 81, 278, 293, 360, 466, 313, 293, 189, 204
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
