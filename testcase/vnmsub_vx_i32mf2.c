...
int main(){
    const int32_t data1[] = {
    -11, -61, 22, 118, 67, 36, -126, 34, -40, -60, -39, -11, 96, -80, -115, 92
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -93, -117, 23, 117, -85, -109, 19, -23, 119, 86, -55, 55, -21, -13, 74, -30
    };
    ...
    int32_t golden[] = {
    82, 4294967235, 22, 1, 67, 36, 4294967151, 57, 4294967137, 4294967150, 4294967257, 4294967285, 96, 4294967216, 4294967107, 92
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
