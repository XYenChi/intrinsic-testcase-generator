...
int main(){
    const uint8_t data1[] = {
    153, 209, 207, 117, 64, 135, 129, 250, 18, 245, 45, 3, 4, 174, 110, 155
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    230, 129, 203, 82, 35, 254, 39, 11, 251, 87, 72, 35, 105, 102, 128, 81
    };
    ...
    uint8_t golden[] = {
    230, 209, 207, 117, 64, 254, 129, 250, 251, 245, 72, 35, 105, 174, 128, 155
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
