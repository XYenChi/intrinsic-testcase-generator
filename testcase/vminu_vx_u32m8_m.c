...
int main(){
    ...
    94, 41, 238, 94, 144, 88, 227, 122, 48, 190, 14, 199, 176, 214, 39, 126
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    149, 171, 162, 106, 185, 14, 79, 201, 62, 15, 55, 167, 221, 112, 217, 22
    };
    ...
    uint32_t golden[] = {
    149, 171, 1, 106, 0, 88, 0, 0, 1, 1, 0, 199, 1, 214, 217, 126
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
