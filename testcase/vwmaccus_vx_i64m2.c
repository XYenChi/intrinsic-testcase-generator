...
int main(){
    const int64_t data1[] = {
    -77, 36, 3, 65, -111, -123, 53, 0, 34, 115, -80, 32, -37, 4, -30, 97
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -127, -56, 101, 1, -70, -123, 82, -120, 53, 14, 95, 23, 96, 41, 120, -62
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccus_vx_i64m2 (out_data, data1_v, data2_v, vl);
