...
int main(){
    const int32_t data1[] = {
    -12, -98, 27, 47, -61, -125, 68, 51, -80, -113, -90, -47, 121, -123, -57, -123
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -97, -1, 26, 55, -128, -31, -104, -79, -99, -72, 115, -71, -13, -97, 109, 116
    };
    ...
    int32_t golden[] = {
    8, 0, 0, 1, 2, 0, 4294967294, 4294967294, 1, 0, 4294967294, 1, 4294967295, 0, 4294967294, 4294967295
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
