...
int main(){
    const int32_t data1[] = {
    47, 105, 127, -51, 78, -100, -105, -111, -55, 2, -33, 61, 17, -5, -94, -37
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    85, -104, 31, 113, 96, 14, 19, -111, -41, 113, 95, -122, -25, 34, 29, 44
    };
    ...
    int32_t golden[] = {
    1, 4294967295, 0, 4294967293, 1, 4294967295, 4294967295, 1, 0, 56, 4294967293, 4294967294, 4294967294, 4294967289, 4294967295, 4294967294
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
