...
int main(){
    ...
    251, 50, 148, 246, 6, 95, 71, 52, 22, 229, 225, 139, 232, 245, 96, 234
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    225, 9, 10, 62, 237, 170, 224, 26, 24, 125, 6, 25, 31, 106, 156, 178
    };
    ...
    uint64_t golden[] = {
    0, 450, 0, 1, 1, 16150, 15905, 0, 529, 28626, 0, 1, 7192, 25971, 14976, 41652
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
