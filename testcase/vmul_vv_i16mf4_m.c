...
int main(){
    const int16_t data1[] = {
    87, 40, 106, 111, 24, -52, 30, -37, 121, 36, -92, -116, -61, -5, 82, 73
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    79, -17, 111, 99, 75, 17, 28, 14, -103, 28, -27, 46, 104, 108, -78, 96
    };
    ...
    int16_t golden[] = {
    1, 64856, 11766, 1, 1800, 64652, 840, 65018, 53073, 1008, 2484, 60200, 0, 64996, 59140, 7008
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
