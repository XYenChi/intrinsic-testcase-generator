...
int main(){
    const uint8_t data1[] = {
    1, 83, 232, 101, 200, 240, 29, 91, 132, 145, 154, 121, 188, 37, 213, 106
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    119, 214, 28, 177, 200, 195, 239, 124, 184, 71, 111, 100, 107, 241, 42, 184
    };
    ...
    uint8_t golden[] = {
    1, 1, 0, 1, 64, 209, 20, 1, 225, 1, 198, 1, 1, 0, 243, 49
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
