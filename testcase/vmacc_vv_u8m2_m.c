...
int main(){
    const uint8_t data1[] = {
    184, 55, 38, 85, 133, 17, 217, 224, 245, 173, 216, 13, 97, 180, 112, 244
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    243, 122, 24, 50, 69, 147, 218, 69, 146, 17, 0, 13, 151, 116, 31, 235
    };
    ...
    uint4_t masked[] = {
    0, 1, 1, 1, 0, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmacc_vv_u8m2_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 55, 145, 154, 1, 1, 203, 97, 1, 126, 1, 169, 0, 0, 1, 252
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
