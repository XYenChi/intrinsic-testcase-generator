...
int main(){
    ...
    192, 243, 126, 25, 229, 44, 39, 18, 255, 169, 104, 188, 145, 19, 32, 120
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    185, 236, 97, 157, 87, 34, 63, 91, 68, 200, 223, 250, 73, 194, 211, 190
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u64m2 (data1_v, data2_v, vl);
