...
int main(){
    const uint8_t data1[] = {
    204, 99, 3, 155, 129, 145, 17, 160, 21, 207, 75, 177, 223, 88, 221, 68
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    114, 161, 201, 136, 38, 85, 206, 35, 46, 23, 80, 43, 31, 207, 116, 96
    };
    ...
    uint8_t golden[] = {
    114, 161, 201, 155, 129, 85, 17, 35, 21, 207, 75, 43, 31, 207, 116, 68
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
