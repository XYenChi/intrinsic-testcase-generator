...
int main(){
    ...
    32, 27, 172, 216, 148, 189, 176, 174, 208, 92, 225, 75, 30, 251, 118, 30
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    248, 213, 57, 204, 205, 172, 87, 110, 36, 217, 68, 14, 35, 59, 58, 132
    };
    ...
    uint16_t golden[] = {
    248, 27, 172, 216, 148, 361, 176, 110, 244, 92, 225, 75, 30, 251, 118, 132
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
