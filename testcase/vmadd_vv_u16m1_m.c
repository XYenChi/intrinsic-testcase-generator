...
int main(){
    ...
    147, 178, 176, 36, 211, 62, 12, 205, 165, 128, 242, 193, 97, 220, 123, 129
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    57, 12, 165, 216, 174, 22, 54, 175, 58, 116, 151, 255, 167, 84, 3, 136
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmadd_vv_u16m1_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    204, 178, 165, 252, 211, 84, 66, 205, 58, 244, 242, 255, 97, 220, 123, 265
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
