...
int main(){
    const int64_t data1[] = {
    32, -19, -81, 71, 8, 38, 103, -107, 119, -68, 31, -17, 39, -30, -50, 91
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    109, 28, -90, -81, -124, 7, 34, -52, 94, -110, -114, -52, 55, -73, 120, -82
    };
    ...
    int64_t golden[] = {
    127, 9, -128, -10, -116, 45, 127, -128, 127, -128, -83, -69, 94, -103, 70, 9
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
