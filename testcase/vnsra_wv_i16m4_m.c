...
int main(){
    const int16_t data1[] = {
    44, 42, -28, -64, -8, -18, -12, -33, 79, -71, 80, -51, 102, -123, -82, -125
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    73, 39, -39, -118, 81, -74, 67, 108, 117, 114, -29, 74, 13, -27, -26, -92
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsra_wv_16m4_m (mask, data1_v, shift, vl);
