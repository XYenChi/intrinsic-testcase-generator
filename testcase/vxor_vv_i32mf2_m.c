...
int main(){
    const int32_t data1[] = {
    79, 86, 73, -12, -73, 121, 65, 16, -107, 93, -94, 60, 82, -126, 121, 55
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    100, 84, -118, -41, -6, -84, 38, -127, 52, 64, 81, 65, -105, 45, 16, -40
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_i32mf2_m (mask, data1_v, data2_v, vl);
