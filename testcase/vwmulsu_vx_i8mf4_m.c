...
int main(){
    const int8_t data1[] = {
    9, 60, 102, 9, 72, 34, -127, -44, -16, 40, -125, 50, -64, 30, -42, -77
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    47, 59, 15, -43, 99, 117, 125, 44, 42, 85, -128, -56, 109, -35, 91, -70
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulsu_vx_i8mf4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    0, 0, 1, 125, 216, 138, 1, 112, 96, 72, 128, 16, 192, 230, 18, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
