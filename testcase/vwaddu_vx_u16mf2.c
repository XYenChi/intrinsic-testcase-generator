...
int main(){
    ...
    40, 148, 26, 55, 50, 124, 253, 170, 71, 134, 26, 42, 201, 24, 214, 219
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    73, 209, 67, 149, 145, 231, 167, 25, 51, 54, 95, 230, 101, 96, 84, 211
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u16mf2 (data1_v, data2_v, vl);
