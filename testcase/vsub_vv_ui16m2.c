...
int main(){
    const int16_t data1[] = {
    207, 48, 35, 100, 227, 103, 111, 162, 106, 165, 141, 246, 115, 63, 220, 63
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    14, 159, 252, 204, 136, 4, 71, 228, 209, 186, 152, 36, 246, 134, 216, 195
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vv_ui16m2 (data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    193, 0, 0, 0, 91, 99, 40, 0, 0, 0, 0, 210, 0, 0, 4, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
