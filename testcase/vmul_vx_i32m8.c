...
int main(){
    const int32_t data1[] = {
    -48, -5, -105, -30, 119, 47, 113, 51, 22, -71, -15, 46, 92, 81, -5, 57
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -58, -127, 42, -73, 106, -54, 57, -7, -20, -124, 52, 94, -84, -71, 120, -37
    };
    ...
    int32_t golden[] = {
    2784, 635, 4294962886, 2190, 12614, 4294964758, 6441, 4294966939, 4294966856, 8804, 4294966516, 4324, 4294959568, 4294961545, 4294966696, 4294965187
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
