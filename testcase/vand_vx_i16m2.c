...
int main(){
    const int16_t data1[] = {
    88, -9, -126, 85, 107, 75, -39, 101, 109, -3, -66, 89, -87, -71, -68, -123
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -79, 5, 88, -126, 65, -106, 116, 34, 5, -40, 68, -95, -109, 108, 91, 124
    };
    ...
    int16_t golden[] = {
    65457, 5, 88, 65410, 65, 65430, 116, 34, 5, 65496, 68, 65441, 65427, 108, 91, 124
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
