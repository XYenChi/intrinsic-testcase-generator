...
int main(){
    const int16_t data1[] = {
    -14, -28, -114, 26, -95, 111, 52, -96, 8, 10, 77, 61, -30, -11, 107, 111
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -67, 51, 89, -30, 106, 94, -115, 44, 82, 89, 57, 0, -99, 67, 84, -111
    };
    ...
    int16_t golden[] = {
    65469, 51, 89, 65506, 106, 94, 65421, 44, 82, 89, 57, 0, 65437, 67, 84, 65425
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
