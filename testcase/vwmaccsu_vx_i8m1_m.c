...
int main(){
    const int8_t data1[] = {
    6, 62, 57, 49, 70, -15, -51, -8, 15, -88, -73, 70, -73, -83, 88, -9
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    59, 30, -62, -104, -37, -33, -83, 66, -114, -119, -96, -13, 65, 49, 17, 92
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccsu_vx_i8m1_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    0, 0, 50, 25, 1, 0, 138, 240, 83, 233, 97, 1, 119, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
