...
int main(){
    const int64_t data1[] = {
    -106, -107, 77, 69, -99, 110, 29, -103, -22, 37, 109, -44, -125, 4, -3, 12
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -105, 85, -20, -113, -88, -53, 32, -88, -31, -55, 44, -36, -12, 114, -15, 44
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_64m1_b64 (data1_v, data2_v, vl);
