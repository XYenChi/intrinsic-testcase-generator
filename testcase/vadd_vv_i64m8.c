...
int main(){
    const int64_t data1[] = {
    37, 60, 39, 109, 93, 19, 41, -12, -18, -71, -2, 98, -97, 28, -25, 72
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    19, 127, 95, 25, -2, -5, 32, -98, -70, 36, -121, 111, -106, 63, 123, -125
    };
    ...
    int64_t golden[] = {
    56, 127, 127, 127, 91, 14, 73, -110, -88, -35, -123, 127, -128, 91, 98, -53
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
