...
int main(){
    ...
    184, 213, 166, 212, 156, 238, 11, 194, 79, 83, 133, 56, 187, 182, 121, 145
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    211, 182, 162, 16, 65, 124, 249, 215, 178, 94, 219, 95, 176, 2, 51, 36
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u16mf2 (data1_v, data2_v, vl);
