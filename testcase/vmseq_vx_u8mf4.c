...
int main(){
    const uint8_t data1[] = {
    184, 147, 181, 132, 152, 183, 172, 201, 55, 247, 140, 118, 251, 210, 48, 111
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    44, 93, 226, 78, 76, 99, 219, 64, 8, 143, 91, 215, 17, 184, 231, 177
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_8mf4_b32 (data1_v, data2_v, vl);
