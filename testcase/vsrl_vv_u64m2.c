...
int main(){
    ...
    247, 115, 7, 124, 168, 247, 145, 215, 140, 217, 161, 41, 188, 163, 183, 143
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    107, 126, 142, 192, 57, 72, 110, 247, 212, 143, 174, 177, 170, 65, 144, 148
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u64m2 (data1_v, shift, vl);
