...
int main(){
    ...
    86, 100, 165, 242, 81, 23, 192, 89, 13, 27, 189, 208, 157, 63, 208, 55
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    59, 164, 230, 91, 61, 187, 231, 116, 215, 0, 230, 233, 84, 88, 196, 141
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u16mf4_m (mask, data1_v, data2_v, vl);
