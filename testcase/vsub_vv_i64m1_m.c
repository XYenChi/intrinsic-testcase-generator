...
int main(){
    const int64_t data1[] = {
    81, 107, -108, -31, -42, -94, 39, 55, 68, -111, -101, 82, 5, -53, -26, -71
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -52, 7, 22, 88, 38, 89, 52, 114, 47, 83, 62, -78, 6, -75, -2, -82
    };
    ...
    int64_t golden[] = {
    1, 100, 0, 18446744073709551497, 1, 1, 0, 0, 0, 18446744073709551422, 1, 0, 18446744073709551615, 22, 18446744073709551592, 11
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
