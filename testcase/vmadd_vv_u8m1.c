...
int main(){
    const uint8_t data1[] = {
    101, 235, 11, 56, 80, 99, 54, 35, 190, 177, 143, 140, 91, 250, 223, 62
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    45, 165, 223, 198, 137, 97, 25, 72, 19, 119, 75, 7, 204, 127, 89, 226
    };
    ...
    uint8_t golden[] = {
    45, 144, 234, 198, 217, 97, 25, 72, 19, 40, 75, 7, 204, 121, 89, 32
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
