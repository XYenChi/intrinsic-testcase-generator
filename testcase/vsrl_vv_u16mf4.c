...
int main(){
    ...
    99, 197, 187, 11, 69, 60, 91, 241, 27, 144, 163, 190, 252, 158, 14, 73
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    249, 198, 153, 163, 26, 145, 9, 250, 177, 127, 91, 72, 28, 196, 200, 6
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u16mf4 (data1_v, shift, vl);
