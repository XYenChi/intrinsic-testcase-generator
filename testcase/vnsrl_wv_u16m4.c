...
int main(){
    ...
    193, 153, 193, 148, 84, 231, 142, 223, 193, 185, 253, 60, 217, 193, 151, 145
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    248, 208, 140, 147, 247, 50, 223, 125, 234, 110, 155, 44, 123, 76, 185, 70
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_16m4 (data1_v, shift, vl);
