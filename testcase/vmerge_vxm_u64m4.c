...
int main(){
    ...
    220, 131, 195, 170, 74, 226, 208, 66, 203, 51, 246, 128, 46, 78, 217, 53
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    139, 210, 234, 30, 137, 88, 182, 18, 255, 178, 209, 54, 78, 181, 97, 150
    };
    const uint64_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e64m4(avl);
    uint16_t masked[] = {
    1, 1, 1, 1, 1, 1, 0, 1, 0, 0, 0, 1, 1, 0, 0, 1
    };
    ...
    uint64_t golden[] = {
    139, 210, 234, 30, 137, 88, 208, 18, 203, 51, 246, 54, 78, 78, 217, 150
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
