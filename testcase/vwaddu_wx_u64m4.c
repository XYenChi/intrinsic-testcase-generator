...
int main(){
    ...
    211, 102, 244, 54, 144, 202, 85, 32, 95, 204, 90, 253, 17, 33, 171, 46
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    143, 28, 104, 37, 124, 184, 12, 163, 71, 253, 181, 160, 189, 166, 150, 49
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u64m4 (data1_v, data2_v, vl);
