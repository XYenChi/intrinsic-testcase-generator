...
int main(){
    ...
    49, 179, 87, 13, 153, 6, 26, 4, 174, 208, 152, 138, 213, 9, 181, 151
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    174, 38, 205, 8, 64, 119, 60, 50, 136, 129, 90, 108, 136, 161, 189, 118
    };
    const uint32_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e32m8(avl);
    const uint out_data[] = {
    0, 1, 0, 1, 1, 0, 0, 0, 1, 0, 0, 0, 1, 1, 0, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u32m8_m (mask, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    27, 1, 0, 8, 64, 5, 8, 0, 1, 129, 90, 108, 136, 1, 8, 118
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
