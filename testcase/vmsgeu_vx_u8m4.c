...
int main(){
    const uint8_t data1[] = {
    198, 30, 48, 85, 160, 229, 194, 109, 195, 112, 140, 108, 178, 204, 254, 187
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    164, 1, 21, 155, 43, 181, 247, 57, 190, 82, 2, 6, 145, 218, 79, 63
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_8m4_b2 (data1_v, data2_v, vl);
