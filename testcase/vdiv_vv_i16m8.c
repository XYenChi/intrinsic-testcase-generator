...
int main(){
    const int16_t data1[] = {
    71, -33, -34, 115, -89, 33, 58, 78, -44, 31, 20, 104, 44, 34, -61, -13
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    74, 21, 37, -78, -35, -69, -53, -113, 38, 41, 88, 92, -60, 68, -98, -87
    };
    ...
    int16_t golden[] = {
    1, 65535, 65534, 65535, 0, 65533, 65535, 65534, 65535, 1, 4, 0, 65534, 2, 1, 6
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
