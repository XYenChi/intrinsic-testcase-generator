...
int main(){
    const int16_t data1[] = {
    -104, 23, 49, 87, 41, 94, -83, -93, -48, 44, -12, 12, 99, -60, -79, -11
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -21, 125, -20, -13, 30, 66, -86, -117, 80, 0, 6, -12, 101, 47, 88, 113
    };
    ...
    int16_t golden[] = {
    0, 5, 65535, 65535, 0, 0, 1, 1, 65534, 0, 65535, 65535, 1, 65535, 65534, 65525
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
