...
int main(){
    ...
    229, 124, 253, 230, 84, 127, 190, 62, 226, 199, 156, 61, 187, 44, 84, 169
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    141, 58, 202, 102, 253, 254, 73, 133, 215, 202, 157, 75, 221, 115, 5, 92
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u32m1 (data1_v, data2_v, vl);
