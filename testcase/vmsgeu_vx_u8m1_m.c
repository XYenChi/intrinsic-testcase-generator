...
int main(){
    const uint8_t data1[] = {
    241, 27, 31, 26, 167, 147, 143, 198, 93, 117, 60, 130, 70, 135, 75, 136
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    50, 95, 233, 197, 234, 18, 193, 141, 64, 155, 224, 38, 135, 189, 32, 22
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_8m1_b8 (mask, data1_v, data2_v, vl);
