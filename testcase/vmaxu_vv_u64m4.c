...
int main(){
    ...
    5, 236, 141, 198, 95, 168, 10, 97, 14, 11, 135, 118, 197, 45, 167, 242
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    144, 29, 116, 91, 90, 178, 176, 133, 212, 171, 182, 164, 128, 166, 3, 78
    };
    ...
    uint64_t golden[] = {
    144, 236, 141, 198, 95, 178, 176, 133, 212, 171, 182, 164, 197, 166, 167, 242
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
