...
int main(){
    const int8_t data1[] = {
    -93, -65, 48, -91, -30, -96, -4, -9, -127, 73, -31, 24, 42, -76, -108, -62
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -54, -102, -18, 48, 1, 1, 16, 84, 118, 117, 52, -10, -96, -4, -90, -122
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_8m8_b1_m (mask, data1_v, data2_v, vl);
