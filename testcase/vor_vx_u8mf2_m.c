...
int main(){
    const uint8_t data1[] = {
    193, 40, 75, 63, 151, 113, 75, 76, 169, 129, 162, 45, 148, 237, 247, 27
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    168, 60, 102, 45, 55, 79, 152, 15, 248, 149, 207, 2, 232, 61, 152, 3
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wx_8mf2u_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 60, 1, 63, 1, 127, 219, 79, 0, 149, 239, 47, 0, 253, 255, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
