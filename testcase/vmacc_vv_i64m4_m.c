...
int main(){
    const int64_t data1[] = {
    65, -39, 55, -87, -60, -69, 73, -50, 125, -84, 36, -119, 126, 84, 49, 38
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    54, -59, -68, 79, 29, 37, 66, -106, 99, -35, 79, -123, 109, -118, -54, -99
    };
    ...
    uint16_t masked[] = {
    1, 1, 0, 0, 0, 0, 0, 1, 1, 0, 1, 0, 0, 1, 1, 1
    };
    ...
    int64_t golden[] = {
    3511, 2301, 0, 1, 0, 0, 1, 5301, 12375, 1, 2845, 0, 0, 18446744073709541705, 18446744073709548970, 18446744073709547855
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
