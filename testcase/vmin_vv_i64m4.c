...
int main(){
    const int64_t data1[] = {
    26, 40, 27, -74, 106, -46, -25, 39, 75, 57, -88, -117, 66, 41, 21, 1
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -80, -110, -1, -31, -7, 83, 67, -126, 11, -24, -111, -49, -39, 53, -103, -119
    };
    ...
    int64_t golden[] = {
    26, 40, 27, 18446744073709551585, 106, 83, 67, 39, 75, 57, 18446744073709551528, 18446744073709551567, 66, 53, 21, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
