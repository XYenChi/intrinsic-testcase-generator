...
int main(){
    const int64_t data1[] = {
    -58, 25, -109, -112, -26, 69, 35, -7, -92, 114, 117, -13, 79, 75, -54, -49
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    54, -52, 85, 50, 79, 23, 103, -35, -118, 121, 98, -127, 100, 9, 91, 19
    };
    ...
    int64_t golden[] = {
    18446744073709548484, 1, 1, 0, 18446744073709549562, 1587, 0, 1, 0, 13794, 11466, 0, 0, 0, 18446744073709546702, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
