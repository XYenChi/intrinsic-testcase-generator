...
int main(){
    ...
    154, 64, 131, 78, 161, 166, 131, 6, 208, 219, 229, 81, 229, 180, 66, 182
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    6, 212, 248, 64, 30, 9, 156, 133, 14, 123, 245, 41, 208, 99, 137, 60
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u16m2 (data1_v, data2_v, vl);
