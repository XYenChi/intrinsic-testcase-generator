...
int main(){
    const uint8_t data1[] = {
    232, 64, 142, 139, 20, 170, 79, 36, 78, 86, 109, 62, 227, 115, 251, 90
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    217, 173, 146, 118, 49, 95, 24, 234, 251, 241, 149, 140, 192, 203, 196, 243
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_8mf4 (data1_v, shift, vl);
