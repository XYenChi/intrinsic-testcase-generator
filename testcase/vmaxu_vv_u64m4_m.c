...
int main(){
    ...
    122, 109, 243, 72, 19, 13, 161, 252, 216, 75, 215, 221, 233, 102, 173, 186
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    23, 138, 100, 12, 68, 222, 140, 248, 58, 58, 195, 93, 127, 73, 69, 43
    };
    ...
    uint64_t golden[] = {
    122, 1, 0, 0, 0, 222, 161, 1, 0, 75, 0, 221, 233, 0, 173, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
