...
int main(){
    ...
    233, 243, 215, 66, 104, 237, 32, 250, 72, 42, 137, 204, 197, 119, 239, 41
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    163, 110, 132, 22, 253, 151, 207, 18, 63, 0, 48, 19, 132, 212, 72, 60
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_32mf2_b64 (data1_v, data2_v, vl);
