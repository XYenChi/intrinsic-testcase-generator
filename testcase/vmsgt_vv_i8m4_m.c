...
int main(){
    const int8_t data1[] = {
    -43, 100, -107, -73, -92, 106, 8, -120, -26, -28, 116, -84, 34, -95, 114, 34
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -64, 80, -8, 43, 55, 16, 58, -38, 70, 21, -69, 40, 109, 46, -77, -30
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vv_8m4_b2_m (mask, data1_v, data2_v, vl);
