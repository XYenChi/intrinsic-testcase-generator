...
int main(){
    const int32_t data1[] = {
    71, 1, -101, -59, -58, 3, -28, 83, -93, 121, 83, -26, 7, 125, 57, 106
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -110, -22, -34, -76, 81, 16, -2, 11, 25, 33, -96, 99, -87, 126, 126, -55
    };
    ...
    int32_t golden[] = {
    4294967294, 4294967274, 0, 1, 4294967294, 5, 0, 0, 4294967295, 0, 4294967294, 4294967292, 4294967283, 1, 2, 4294967295
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
