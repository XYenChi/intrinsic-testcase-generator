...
int main(){
    const int32_t data1[] = {
    41, 98, 96, 8, -63, -62, 71, 92, -4, 86, -31, -69, -19, -59, -89, 10
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    76, -92, -46, -121, -51, -47, -105, -128, -55, -118, -10, 81, -110, 122, 115, 30
    };
    ...
    int32_t golden[] = {
    1, 4294967295, 4294967295, 4294967280, 0, 0, 4294967294, 4294967294, 13, 4294967294, 0, 4294967294, 5, 4294967293, 4294967294, 3
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
