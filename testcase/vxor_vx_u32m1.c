...
int main(){
    ...
    25, 29, 55, 165, 136, 22, 113, 228, 174, 49, 72, 251, 171, 123, 72, 182
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    154, 177, 208, 229, 197, 215, 245, 133, 67, 61, 181, 143, 8, 22, 5, 162
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u32m1 (data1_v, data2_v, vl);
