...
int main(){
    ...
    179, 192, 99, 135, 248, 250, 74, 236, 47, 122, 96, 209, 82, 235, 218, 4
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    113, 156, 65, 223, 211, 97, 186, 247, 122, 76, 128, 75, 183, 51, 86, 34
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u16m2 (data1_v, shift, vl);
