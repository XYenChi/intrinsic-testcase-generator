...
int main(){
    const uint8_t data1[] = {
    39, 239, 245, 46, 10, 153, 39, 255, 174, 192, 50, 172, 30, 32, 168, 55
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    71, 63, 178, 0, 26, 137, 246, 0, 184, 147, 114, 47, 23, 222, 239, 68
    };
    ...
    uint8_t golden[] = {
    110, 46, 167, 46, 36, 34, 29, 255, 102, 83, 164, 219, 53, 254, 151, 123
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
