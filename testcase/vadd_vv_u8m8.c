...
int main(){
    const int8_t data1[] = {
    99, 100, 186, 135, 102, 140, 74, 98, 133, 141, 5, 142, 82, 55, 5, 240
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    138, 243, 30, 173, 143, 202, 183, 10, 4, 153, 36, 215, 202, 207, 233, 82
    };
    ...
    int8_t golden[] = {
    237, 87, 216, 52, 245, 86, 1, 108, 137, 38, 41, 101, 28, 6, 238, 66
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
