...
int main(){
    ...
    118, 149, 81, 109, 100, 243, 60, 108, 80, 114, 224, 81, 83, 2, 55, 219
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    40, 53, 240, 232, 3, 144, 122, 138, 124, 242, 84, 129, 54, 21, 166, 91
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u32m1 (data1_v, shift, vl);
