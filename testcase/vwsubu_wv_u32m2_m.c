...
int main(){
    ...
    54, 203, 1, 107, 44, 179, 168, 78, 36, 157, 230, 121, 170, 167, 196, 43
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    185, 4, 68, 63, 180, 234, 86, 235, 44, 162, 117, 13, 214, 147, 241, 14
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u32m2_m (mask, data1_v, data2_v, vl);
