...
int main(){
    ...
    103, 34, 32, 37, 6, 8, 163, 127, 109, 86, 191, 52, 164, 9, 234, 82
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    42, 71, 51, 247, 157, 80, 61, 253, 26, 237, 121, 50, 158, 190, 132, 241
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u16m1_m (mask, data1_v, data2_v, vl);
