...
int main(){
    const uint8_t data1[] = {
    178, 242, 36, 80, 189, 185, 42, 200, 9, 0, 76, 123, 213, 245, 79, 101
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    108, 189, 221, 201, 160, 252, 212, 57, 137, 50, 52, 251, 182, 66, 91, 209
    };
    ...
    uint8_t golden[] = {
    178, 1, 1, 1, 1, 252, 212, 200, 137, 50, 1, 251, 213, 245, 91, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
