...
int main(){
    const uint8_t data1[] = {
    12, 191, 39, 237, 249, 17, 239, 122, 232, 164, 201, 50, 31, 25, 53, 62
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    147, 211, 0, 101, 81, 189, 147, 239, 148, 107, 67, 186, 244, 164, 201, 115
    };
    ...
    uint8_t golden[] = {
    0, 211, 1, 237, 0, 189, 239, 0, 0, 164, 1, 0, 244, 164, 0, 115
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
