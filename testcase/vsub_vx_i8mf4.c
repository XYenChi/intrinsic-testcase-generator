...
int main(){
    const int8_t data1[] = {
    -73, 60, -115, 112, 0, 19, 67, 29, 113, 111, -97, 110, -41, 84, -100, -59
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -98, 60, 89, 96, -57, -37, 94, 84, -118, 32, 1, 114, -89, 95, -100, 40
    };
    ...
    int8_t golden[] = {
    25, 0, 52, 16, 57, 56, 229, 201, 231, 79, 158, 252, 48, 245, 0, 157
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
