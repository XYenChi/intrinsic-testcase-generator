...
int main(){
    const int8_t data1[] = {
    57, -52, 14, -79, 55, -11, 58, -6, 39, 32, -70, -21, 34, -60, -49, -36
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -60, -31, -75, 113, -98, 102, -110, -73, 124, 55, -20, -49, -121, -5, 55, 80
    };
    ...
    int8_t golden[] = {
    117, 235, 89, 64, 153, 143, 168, 67, 171, 233, 206, 28, 155, 201, 152, 140
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
