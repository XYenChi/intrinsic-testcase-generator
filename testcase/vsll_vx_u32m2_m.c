...
int main(){
    ...
    145, 254, 241, 178, 250, 107, 20, 107, 43, 180, 206, 212, 90, 184, 37, 42
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    101, 95, 176, 195, 66, 184, 123, 27, 117, 189, 18, 246, 19, 235, 125, 182
    };
    ...
    uint32_t golden[] = {
    290, 508, 241, 356, 250, 107, 40, 214, 86, 360, 206, 212, 180, 368, 74, 42
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
