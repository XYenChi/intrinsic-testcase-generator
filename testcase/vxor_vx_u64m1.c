...
int main(){
    ...
    37, 234, 252, 134, 31, 34, 19, 51, 7, 42, 171, 33, 187, 75, 179, 39
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    62, 204, 193, 8, 123, 252, 45, 70, 19, 144, 148, 1, 243, 234, 134, 107
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u64m1 (data1_v, data2_v, vl);
