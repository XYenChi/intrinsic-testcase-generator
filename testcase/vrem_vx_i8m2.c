...
int main(){
    const int8_t data1[] = {
    72, 88, 109, -83, -20, -85, 101, -76, 122, -32, -59, -73, -74, -85, 110, 106
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -25, -87, 79, 57, 3, 120, 42, 83, -87, 114, -47, 80, 12, 9, -32, -119
    };
    ...
    int8_t golden[] = {
    47, 1, 79, 230, 239, 206, 42, 187, 35, 242, 209, 190, 194, 180, 78, 93
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
