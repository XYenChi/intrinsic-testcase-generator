...
int main(){
    ...
    170, 78, 28, 4, 48, 163, 83, 139, 113, 122, 59, 19, 80, 137, 169, 230
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    150, 102, 155, 71, 104, 250, 26, 199, 240, 146, 192, 177, 13, 108, 111, 239
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vx_16m1_b16 (data1_v, data2_v, vl);
