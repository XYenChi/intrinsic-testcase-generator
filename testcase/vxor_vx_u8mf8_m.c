...
int main(){
    const uint8_t data1[] = {
    253, 101, 168, 29, 239, 216, 82, 153, 42, 26, 205, 66, 122, 113, 81, 134
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    206, 53, 93, 111, 233, 108, 46, 65, 83, 248, 9, 104, 115, 151, 249, 151
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u8mf8_m (mask, data1_v, data2_v, vl);
