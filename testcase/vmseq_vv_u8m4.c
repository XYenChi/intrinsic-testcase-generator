...
int main(){
    const uint8_t data1[] = {
    116, 88, 230, 95, 236, 199, 172, 43, 87, 42, 71, 209, 22, 249, 9, 162
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    111, 196, 209, 83, 199, 181, 65, 139, 247, 140, 114, 246, 105, 206, 74, 162
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_8m4_b2 (data1_v, data2_v, vl);
