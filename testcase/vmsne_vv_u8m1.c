...
int main(){
    const uint8_t data1[] = {
    198, 235, 148, 22, 56, 234, 255, 150, 133, 163, 93, 60, 187, 135, 102, 229
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    250, 64, 253, 206, 115, 111, 189, 46, 4, 126, 205, 177, 206, 178, 255, 44
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_8m1_b8 (data1_v, data2_v, vl);
