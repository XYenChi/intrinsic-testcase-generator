...
int main(){
    ...
    111, 87, 22, 75, 19, 177, 27, 19, 67, 31, 233, 214, 106, 72, 63, 123
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    191, 157, 85, 223, 216, 107, 186, 100, 5, 30, 141, 12, 17, 137, 165, 230
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u32mf2 (data1_v, data2_v, vl);
