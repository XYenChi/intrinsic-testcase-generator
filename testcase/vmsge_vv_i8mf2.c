...
int main(){
    const int8_t data1[] = {
    115, 10, -116, 46, -44, -70, 110, 55, 37, 77, 98, 106, 52, 59, 70, 60
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    79, 12, -44, 10, 64, -15, 85, -52, 69, -115, 78, -50, -66, -107, -31, -66
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vv_8mf2_b16 (data1_v, data2_v, vl);
