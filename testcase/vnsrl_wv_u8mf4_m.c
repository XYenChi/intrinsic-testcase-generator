...
int main(){
    const uint8_t data1[] = {
    149, 82, 10, 72, 140, 218, 52, 33, 125, 2, 33, 80, 71, 13, 193, 6
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    216, 205, 56, 14, 156, 187, 154, 240, 111, 114, 242, 12, 82, 103, 200, 55
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_8mf4_m (mask, data1_v, shift, vl);
