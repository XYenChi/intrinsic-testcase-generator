...
int main(){
    ...
    231, 140, 231, 205, 97, 245, 188, 211, 9, 107, 24, 170, 196, 237, 65, 220
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    85, 222, 143, 211, 63, 23, 25, 231, 173, 166, 69, 72, 29, 38, 64, 250
    };
    ...
    uint32_t golden[] = {
    85, 222, 0, 211, 0, 23, 1, 1, 1, 0, 1, 0, 1, 0, 64, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
