...
int main(){
    ...
    114, 78, 245, 199, 125, 28, 227, 159, 22, 217, 244, 232, 67, 96, 249, 251
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    60, 0, 15, 109, 67, 29, 88, 168, 46, 153, 232, 59, 39, 184, 28, 235
    };
    ...
    uint64_t golden[] = {
    174, 78, 260, 308, 193, 58, 316, 327, 69, 370, 477, 292, 107, 280, 278, 486
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
