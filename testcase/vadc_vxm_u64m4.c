...
int main(){
    ...
    37, 167, 192, 105, 235, 145, 186, 234, 113, 118, 157, 56, 250, 163, 243, 91
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    227, 129, 149, 194, 78, 119, 194, 155, 180, 255, 95, 226, 99, 224, 83, 60
    };
    ...
    uint64_t golden[] = {
    264, 297, 342, 299, 313, 265, 381, 390, 294, 373, 252, 282, 349, 387, 327, 151
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
