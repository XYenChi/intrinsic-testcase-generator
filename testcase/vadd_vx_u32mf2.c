...
int main(){
    ...
    208, 19, 251, 22, 65, 173, 53, 65, 233, 211, 72, 48, 119, 170, 112, 234
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    241, 116, 147, 121, 64, 209, 231, 45, 77, 33, 190, 16, 127, 235, 12, 47
    };
    ...
    uint32_t golden[] = {
    449, 135, 398, 143, 129, 382, 284, 110, 310, 244, 262, 64, 246, 405, 124, 281
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
