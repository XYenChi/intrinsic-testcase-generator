...
int main(){
    const int32_t data1[] = {
    24, 29, 209, 150, 173, 220, 48, 63, 240, 151, 22, 32, 81, 86, 140, 71
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    203, 14, 27, 155, 218, 40, 44, 111, 113, 181, 163, 118, 27, 106, 58, 196
    };
    ...
    int32_t golden[] = {
    227, 43, 236, 305, 391, 260, 92, 174, 353, 332, 185, 150, 108, 192, 198, 267
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
