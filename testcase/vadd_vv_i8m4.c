...
int main(){
    const int8_t data1[] = {
    19, -45, 49, -47, 61, 34, -50, -37, -36, 70, -54, 34, 99, 35, -63, -32
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -38, 24, 119, 120, 76, -30, -82, -11, 125, 33, 95, 105, -103, 73, 17, 14
    };
    ...
    int8_t golden[] = {
    237, 235, 168, 73, 137, 4, 124, 208, 89, 103, 41, 139, 252, 108, 210, 238
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
