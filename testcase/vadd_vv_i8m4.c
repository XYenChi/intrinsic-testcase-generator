...
int main(){
    const int8_t data1[] = {
    74, -70, 43, -101, 26, 16, -89, -70, 88, 60, -107, -73, 82, -57, 91, 114
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -113, -19, -57, 116, 10, -113, -47, 124, -128, -126, -43, 36, -51, -93, 83, 97
    };
    ...
    int8_t golden[] = {
    143, -134, 64, -135, 124, -90, -43, -29, 83, 33, -55, -188, 79, -86, -28, 10
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
