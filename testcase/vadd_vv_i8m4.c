...
int main(){
    const int8_t data1[] = {
    -73, -106, -12, 126, -104, 99, 119, -28, -15, -50, 118, -63, -47, -75, 5, -71
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -71, 61, -56, 47, 121, -115, 9, -121, 39, 44, 125, -32, 61, -81, 8, 29
    };
    ...
    int8_t golden[] = {
    112, 211, 188, 173, 17, 240, 128, 107, 24, 250, 243, 161, 14, 100, 13, 214
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
