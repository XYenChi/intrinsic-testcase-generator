...
int main(){
    const int8_t data1[] = {
    15, 225, 42, 19, 66, 2, 250, 209, 160, 28, 150, 181, 190, 134, 63, 79
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    152, 181, 24, 38, 235, 185, 24, 70, 105, 217, 41, 193, 56, 62, 62, 127
    };
    ...
    int8_t golden[] = {
    167, 406, 66, 57, 301, 187, 274, 279, 265, 245, 191, 374, 246, 196, 125, 206
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
