...
int main(){
    const uint8_t data1[] = {
    78, 238, 249, 199, 47, 115, 220, 233, 89, 107, 57, 47, 145, 3, 169, 141
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    184, 244, 136, 137, 33, 221, 6, 246, 190, 136, 114, 252, 64, 111, 106, 15
    };
    ...
    uint8_t golden[] = {
    184, 1, 249, 199, 0, 221, 220, 246, 0, 136, 114, 0, 1, 1, 1, 141
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
