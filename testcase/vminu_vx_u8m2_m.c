...
int main(){
    const uint8_t data1[] = {
    22, 108, 1, 241, 48, 158, 101, 63, 138, 119, 123, 163, 11, 226, 42, 39
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    124, 138, 63, 119, 44, 144, 87, 38, 85, 146, 254, 118, 135, 13, 105, 103
    };
    ...
    uint8_t golden[] = {
    1, 138, 0, 241, 1, 158, 101, 1, 138, 146, 254, 163, 1, 226, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
