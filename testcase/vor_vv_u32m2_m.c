...
int main(){
    ...
    42, 33, 234, 192, 209, 242, 132, 13, 231, 31, 92, 142, 116, 143, 168, 202
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    229, 242, 89, 61, 207, 70, 62, 21, 239, 206, 26, 72, 68, 152, 45, 247
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wv_32m2u_m (mask, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    239, 243, 251, 0, 223, 0, 190, 29, 0, 0, 0, 206, 0, 1, 173, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
