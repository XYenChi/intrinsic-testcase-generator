...
int main(){
    const int8_t data1[] = {
    -10, 39, -24, -59, -72, -34, -35, -38, -92, 36, -100, 90, -115, -55, -59, 96
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    109, -71, -126, 114, -94, -110, 73, 14, -125, -14, -41, -92, -73, -46, -38, 84
    };
    ...
    int8_t golden[] = {
    109, 39, 232, 114, 184, 222, 73, 14, 164, 36, 215, 90, 183, 210, 218, 96
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
