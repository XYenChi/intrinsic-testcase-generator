...
int main(){
    ...
    118, 202, 56, 252, 124, 10, 199, 195, 135, 214, 161, 59, 101, 63, 46, 89
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    246, 53, 176, 10, 169, 152, 148, 121, 106, 118, 12, 39, 134, 72, 202, 51
    };
    ...
    uint16_t golden[] = {
    1, 202, 0, 0, 169, 152, 0, 0, 135, 214, 161, 59, 1, 72, 202, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
