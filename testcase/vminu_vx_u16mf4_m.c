...
int main(){
    ...
    32, 214, 14, 128, 61, 16, 103, 222, 232, 104, 118, 158, 252, 99, 156, 1
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    57, 153, 93, 90, 221, 13, 159, 57, 240, 60, 67, 28, 153, 176, 247, 122
    };
    ...
    uint16_t golden[] = {
    57, 0, 93, 128, 1, 16, 159, 1, 0, 104, 118, 0, 252, 176, 247, 122
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
