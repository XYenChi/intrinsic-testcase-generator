...
int main(){
    ...
    55, 39, 2, 179, 7, 233, 131, 79, 114, 39, 44, 26, 163, 105, 238, 55
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    245, 156, 31, 185, 51, 27, 172, 184, 160, 1, 136, 136, 62, 114, 108, 172
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u64m1_m (mask, data1_v, data2_v, vl);
