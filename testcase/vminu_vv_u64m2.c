...
int main(){
    ...
    134, 9, 229, 205, 53, 221, 141, 102, 73, 64, 117, 56, 63, 250, 118, 65
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    64, 179, 27, 241, 239, 253, 12, 89, 36, 184, 78, 232, 146, 150, 220, 89
    };
    ...
    uint64_t golden[] = {
    134, 179, 229, 241, 239, 253, 141, 102, 73, 184, 117, 232, 146, 250, 220, 89
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
