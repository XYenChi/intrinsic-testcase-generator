...
int main(){
    ...
    28, 55, 66, 215, 100, 58, 26, 229, 141, 37, 249, 217, 2, 237, 222, 109
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    103, 77, 68, 208, 133, 28, 254, 232, 106, 183, 157, 223, 35, 143, 181, 181
    };
    ...
    uint64_t golden[] = {
    103, 77, 68, 215, 133, 58, 254, 232, 141, 183, 249, 223, 35, 237, 222, 181
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
