...
int main(){
    const int32_t data1[] = {
    51, 91, 67, 26, 208, 22, 181, 11, 87, 101, 131, 113, 159, 221, 37, 247
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    150, 61, 203, 82, 17, 222, 212, 153, 198, 175, 146, 224, 6, 119, 147, 166
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vx_ui32m2 (data1_v, data2_v, vl);
    ...
    int32_t golden[] = {
    0, 30, 0, 0, 191, 0, 0, 0, 0, 0, 0, 0, 153, 102, 0, 81
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
