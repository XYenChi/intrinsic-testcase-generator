...
int main(){
    const int16_t data1[] = {
    -104, 92, -47, -73, -24, 113, -67, 72, 121, -26, -49, -127, 52, 41, -123, -42
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -119, 32, 99, 87, -127, 122, 60, 104, 31, 69, -92, -117, 60, -23, 116, -48
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vx_16m2_b8 (data1_v, data2_v, vl);
