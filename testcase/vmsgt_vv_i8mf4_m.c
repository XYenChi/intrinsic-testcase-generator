...
int main(){
    const int8_t data1[] = {
    4, -89, -102, 113, -12, -19, -7, 56, -94, 94, -120, 32, 83, -25, 104, -38
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    93, -97, 2, 56, -85, 83, 6, -60, 87, -57, -8, 66, 62, -99, 37, -97
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vv_8mf4_b32_m (mask, data1_v, data2_v, vl);
