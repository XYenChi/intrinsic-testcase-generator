...
int main(){
    ...
    195, 40, 108, 56, 134, 220, 200, 139, 159, 23, 208, 6, 26, 105, 105, 162
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    218, 241, 12, 173, 40, 227, 99, 77, 50, 46, 22, 82, 131, 201, 198, 234
    };
    ...
    uint16_t golden[] = {
    23, 201, 65440, 117, 65442, 7, 65435, 65474, 65427, 23, 65350, 76, 105, 96, 93, 72
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
