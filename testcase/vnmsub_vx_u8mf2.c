...
int main(){
    const uint8_t data1[] = {
    144, 242, 100, 43, 8, 78, 10, 252, 2, 49, 135, 228, 135, 141, 24, 160
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    114, 204, 131, 30, 151, 99, 254, 241, 8, 236, 254, 150, 20, 22, 17, 184
    };
    ...
    uint8_t golden[] = {
    144, 38, 225, 13, 113, 235, 10, 252, 2, 49, 137, 228, 115, 141, 7, 160
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
