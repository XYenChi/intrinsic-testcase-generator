...
int main(){
    ...
    181, 24, 199, 167, 186, 159, 143, 122, 226, 60, 247, 241, 49, 67, 109, 205
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    17, 154, 245, 39, 229, 220, 221, 142, 90, 104, 192, 20, 216, 28, 3, 240
    };
    ...
    uint16_t golden[] = {
    0, 154, 0, 167, 1, 220, 0, 0, 226, 104, 247, 1, 1, 67, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
