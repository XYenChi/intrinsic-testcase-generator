...
int main(){
    const uint8_t data1[] = {
    153, 179, 14, 46, 230, 38, 111, 124, 222, 107, 9, 3, 109, 141, 7, 254
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    205, 239, 148, 141, 40, 125, 94, 15, 113, 131, 250, 25, 84, 8, 252, 8
    };
    ...
    uint8_t golden[] = {
    1, 162, 0, 187, 14, 163, 1, 1, 1, 238, 3, 0, 193, 1, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
