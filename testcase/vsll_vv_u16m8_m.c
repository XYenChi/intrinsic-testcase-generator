...
int main(){
    ...
    149, 168, 232, 107, 28, 65, 186, 74, 13, 38, 202, 198, 23, 153, 84, 194
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    100, 62, 79, 106, 140, 128, 250, 160, 142, 194, 158, 162, 150, 38, 207, 194
    };
    ...
    uint16_t golden[] = {
    149, 168, 464, 107, 28, 65, 186, 74, 13, 38, 202, 198, 23, 153, 168, 194
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
