...
int main(){
    ...
    222, 181, 81, 196, 1, 39, 118, 211, 255, 34, 55, 169, 223, 221, 200, 38
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    71, 250, 208, 219, 135, 21, 60, 203, 148, 210, 203, 32, 40, 201, 132, 54
    };
    ...
    uint32_t golden[] = {
    293, 250, 289, 219, 135, 21, 60, 414, 403, 210, 258, 201, 263, 201, 332, 54
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
