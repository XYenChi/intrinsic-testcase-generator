...
int main(){
    ...
    139, 85, 22, 94, 122, 30, 192, 226, 55, 81, 135, 13, 188, 47, 79, 122
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    94, 40, 89, 115, 68, 30, 200, 119, 87, 43, 121, 218, 108, 40, 198, 197
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u16m4 (data1_v, data2_v, vl);
