...
int main(){
    const int16_t data1[] = {
    -83, -15, 106, 82, 12, -14, 3, -59, 100, -120, -5, 14, -106, 40, -84, -60
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -6, -1, -36, -110, -126, 124, 79, -11, 47, -86, 102, 20, 121, -90, -79, -9
    };
    ...
    int16_t golden[] = {
    0, 0, 1, 0, 0, 65398, 1, 65488, 53, 1, 65429, 65530, 1, 130, 65531, 65485
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
