...
int main(){
    const uint8_t data1[] = {
    95, 76, 110, 40, 5, 207, 196, 142, 96, 167, 112, 234, 99, 236, 7, 115
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    176, 187, 198, 230, 231, 145, 53, 181, 70, 174, 0, 10, 85, 100, 115, 244
    };
    ...
    uint8_t golden[] = {
    1, 133, 20, 241, 1, 64, 148, 102, 0, 131, 0, 36, 0, 49, 38, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
