...
int main(){
    const uint8_t data1[] = {
    126, 94, 255, 110, 245, 164, 83, 69, 67, 242, 174, 24, 146, 168, 144, 128
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    129, 149, 220, 14, 100, 202, 195, 249, 127, 189, 227, 152, 174, 118, 26, 69
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmacc_vx_u8mf4_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    127, 182, 0, 5, 180, 0, 58, 0, 1, 170, 75, 1, 60, 112, 0, 129
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
