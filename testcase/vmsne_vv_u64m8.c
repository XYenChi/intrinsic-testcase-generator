...
int main(){
    ...
    157, 138, 241, 162, 144, 96, 17, 142, 90, 234, 187, 226, 124, 241, 72, 162
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    233, 192, 246, 30, 255, 21, 17, 38, 224, 57, 211, 235, 202, 1, 139, 27
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_64m8_b8 (data1_v, data2_v, vl);
