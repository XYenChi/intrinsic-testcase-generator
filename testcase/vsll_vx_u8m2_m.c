...
int main(){
    const uint8_t data1[] = {
    19, 190, 155, 88, 117, 48, 135, 62, 159, 102, 62, 119, 164, 57, 210, 221
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    186, 153, 115, 241, 106, 98, 250, 22, 84, 132, 69, 11, 160, 130, 155, 112
    };
    ...
    uint8_t golden[] = {
    19, 380, 310, 176, 117, 48, 135, 62, 159, 102, 124, 238, 164, 57, 420, 221
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
