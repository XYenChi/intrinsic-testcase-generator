...
int main(){
    const uint8_t data1[] = {
    167, 13, 135, 248, 22, 152, 231, 37, 110, 138, 191, 82, 83, 232, 169, 125
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    4, 151, 55, 24, 143, 114, 28, 187, 132, 118, 189, 44, 18, 130, 227, 223
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u8m1 (data1_v, data2_v, vl);
