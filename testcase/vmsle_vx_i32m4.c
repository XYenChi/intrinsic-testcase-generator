...
int main(){
    const int32_t data1[] = {
    33, 74, -44, -117, -73, -2, 52, 31, -125, 114, 122, -15, -49, 72, -16, 47
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    6, 74, 58, -41, 23, -20, 79, 74, 84, -3, -37, -96, 27, 96, -40, 98
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vx_32m4_b8 (data1_v, data2_v, vl);
    ...
    int32_t golden[] = {
    0, 1, 1, 1, 1, 0, 1, 1, 1, 0, 0, 0, 1, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
