...
int main(){
    ...
    235, 0, 132, 8, 128, 57, 148, 250, 1, 91, 94, 156, 147, 1, 108, 48
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    90, 145, 15, 156, 146, 219, 89, 58, 242, 117, 149, 191, 134, 140, 209, 69
    };
    ...
    uint16_t golden[] = {
    145, 65391, 117, 65388, 65518, 65374, 59, 192, 65295, 65510, 65481, 65501, 13, 65397, 65435, 65515
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
