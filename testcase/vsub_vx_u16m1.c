...
int main(){
    ...
    98, 181, 84, 72, 143, 144, 6, 22, 90, 67, 203, 63, 143, 208, 244, 226
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    30, 103, 116, 152, 240, 58, 73, 187, 94, 89, 219, 99, 242, 198, 166, 254
    };
    ...
    uint16_t golden[] = {
    68, 78, 65504, 65456, 65439, 86, 65469, 65371, 65532, 65514, 65520, 65500, 65437, 10, 78, 65508
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
