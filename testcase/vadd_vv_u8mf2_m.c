...
int main(){
    const uint8_t data1[] = {
    184, 48, 169, 33, 120, 51, 124, 96, 215, 87, 212, 176, 158, 19, 249, 10
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    26, 186, 2, 30, 120, 49, 97, 111, 215, 198, 143, 233, 97, 16, 174, 119
    };
    ...
    uint8_t golden[] = {
    1, 234, 0, 63, 1, 100, 1, 1, 174, 29, 1, 153, 255, 35, 167, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
