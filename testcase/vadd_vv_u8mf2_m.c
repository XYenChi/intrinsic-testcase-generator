...
int main(){
    const uint8_t data1[] = {
    167, 90, 67, 190, 17, 12, 179, 37, 97, 162, 221, 107, 67, 21, 88, 90
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    80, 75, 88, 227, 206, 64, 180, 26, 186, 245, 14, 61, 123, 157, 156, 4
    };
    ...
    uint8_t golden[] = {
    247, 165, 0, 1, 0, 1, 1, 1, 27, 151, 235, 1, 1, 1, 244, 94
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
