...
int main(){
    ...
    183, 71, 24, 172, 84, 188, 98, 151, 44, 250, 199, 101, 147, 23, 236, 116
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    100, 140, 140, 238, 48, 27, 32, 231, 159, 185, 29, 143, 51, 171, 118, 4
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u16m8 (data1_v, shift, vl);
