...
int main(){
    const uint8_t data1[] = {
    137, 206, 14, 235, 86, 166, 188, 241, 131, 233, 101, 11, 49, 155, 156, 172
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    229, 109, 252, 84, 251, 161, 223, 0, 156, 15, 255, 53, 49, 125, 91, 252
    };
    ...
    uint8_t golden[] = {
    1, 97, 18, 151, 0, 5, 1, 1, 0, 0, 102, 214, 0, 1, 65, 176
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
