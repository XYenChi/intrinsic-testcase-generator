...
int main(){
    const uint8_t data1[] = {
    182, 63, 155, 199, 69, 78, 253, 176, 224, 33, 125, 33, 176, 87, 118, 160
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    16, 247, 84, 246, 169, 185, 141, 136, 11, 52, 67, 169, 82, 237, 149, 93
    };
    ...
    uint8_t golden[] = {
    182, 63, 84, 246, 69, 78, 141, 136, 11, 33, 125, 33, 82, 87, 118, 93
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
