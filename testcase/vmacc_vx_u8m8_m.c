...
int main(){
    const uint8_t data1[] = {
    1, 126, 171, 239, 11, 111, 101, 229, 110, 185, 102, 103, 30, 198, 215, 184
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    44, 149, 76, 118, 23, 22, 196, 182, 223, 207, 246, 227, 233, 96, 245, 31
    };
    ...
    uint8_t golden[] = {
    45, 86, 197, 43, 0, 138, 0, 0, 210, 152, 4, 86, 79, 64, 1, 72
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
