...
int main(){
    const uint8_t data1[] = {
    243, 159, 226, 46, 68, 186, 128, 152, 108, 240, 213, 13, 205, 178, 139, 194
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    57, 53, 110, 138, 91, 214, 213, 232, 178, 180, 188, 47, 249, 0, 10, 174
    };
    ...
    uint8_t golden[] = {
    243, 159, 226, 138, 91, 214, 213, 232, 178, 240, 213, 47, 249, 178, 139, 194
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
