...
int main(){
    ...
    87, 39, 129, 78, 57, 203, 248, 249, 132, 138, 40, 253, 93, 55, 192, 78
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    196, 155, 162, 252, 120, 151, 208, 118, 152, 183, 68, 54, 215, 8, 0, 154
    };
    ...
    uint32_t golden[] = {
    0, 0, 20898, 19656, 1, 0, 1, 0, 20064, 25254, 2720, 13662, 19995, 0, 0, 12012
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
