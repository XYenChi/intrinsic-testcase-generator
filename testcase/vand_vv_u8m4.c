...
int main(){
    const uint8_t data1[] = {
    29, 175, 142, 173, 240, 188, 124, 166, 156, 123, 0, 89, 39, 141, 135, 54
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    233, 83, 142, 182, 133, 83, 151, 101, 212, 204, 248, 216, 29, 171, 97, 70
    };
    ...
    uint8_t golden[] = {
    233, 83, 142, 182, 133, 83, 151, 101, 212, 204, 0, 216, 29, 171, 97, 70
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
