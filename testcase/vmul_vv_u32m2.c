...
int main(){
    ...
    25, 46, 151, 30, 166, 37, 28, 212, 227, 128, 31, 30, 220, 29, 59, 38
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    20, 64, 124, 0, 205, 79, 196, 109, 176, 13, 6, 44, 207, 211, 182, 107
    };
    ...
    uint32_t golden[] = {
    500, 2944, 18724, 0, 34030, 2923, 5488, 23108, 39952, 1664, 186, 1320, 45540, 6119, 10738, 4066
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
