...
int main(){
    ...
    225, 159, 126, 92, 113, 78, 13, 43, 201, 107, 31, 100, 84, 133, 228, 55
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    125, 71, 72, 113, 253, 74, 71, 38, 89, 73, 59, 166, 133, 112, 190, 52
    };
    ...
    uint32_t golden[] = {
    351, 230, 199, 206, 367, 152, 84, 82, 291, 181, 90, 266, 218, 245, 418, 108
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
