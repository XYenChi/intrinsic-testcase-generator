...
int main(){
    const int8_t data1[] = {
    26, -102, 32, -17, -56, 26, -34, -48, 101, -59, -98, -51, -89, -49, -41, 9
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    92, 106, 8, 91, 28, 71, 63, 71, 60, 112, -25, -69, 90, -71, 30, 29
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsra_vv_i8m2_m (mask, data1_v, shift, vl);
    ...
    int8_t golden[] = {
    26, -102, 32, -9, -56, 13, -17, -24, 101, -59, -49, -26, -89, -25, -41, 4
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
