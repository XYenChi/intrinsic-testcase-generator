...
int main(){
    ...
    53, 49, 110, 173, 234, 137, 233, 60, 165, 223, 220, 166, 90, 24, 1, 122
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    253, 238, 121, 204, 161, 150, 100, 72, 175, 187, 250, 60, 96, 36, 93, 165
    };
    ...
    uint16_t golden[] = {
    253, 238, 121, 204, 234, 150, 233, 72, 175, 223, 250, 166, 96, 36, 93, 165
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
