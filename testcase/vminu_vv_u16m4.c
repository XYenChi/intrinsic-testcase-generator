...
int main(){
    ...
    193, 237, 97, 129, 38, 115, 84, 53, 245, 134, 251, 249, 7, 232, 148, 7
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    120, 56, 123, 103, 112, 40, 131, 246, 235, 65, 148, 217, 80, 197, 235, 121
    };
    ...
    uint16_t golden[] = {
    193, 237, 123, 129, 112, 115, 131, 246, 245, 134, 251, 249, 80, 232, 235, 121
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
