...
int main(){
    ...
    234, 70, 174, 135, 81, 91, 199, 229, 93, 158, 155, 13, 18, 229, 107, 117
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    232, 158, 3, 40, 36, 79, 212, 45, 179, 132, 144, 217, 138, 48, 48, 125
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_64m4_b16 (data1_v, data2_v, vl);
