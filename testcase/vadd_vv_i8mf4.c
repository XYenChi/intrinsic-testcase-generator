...
int main(){
    const int8_t data1[] = {
    19, 67, 51, -123, -70, 19, 91, -124, 124, -124, 55, 28, -122, 22, 45, -64
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    97, -125, 6, -87, -107, 98, 38, 117, -9, -118, 1, 84, -105, 110, 18, 22
    };
    ...
    int8_t golden[] = {
    116, -58, 57, -128, -128, 117, 127, -7, 115, -128, 56, 112, -128, 127, 63, -42
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
