...
int main(){
    const int8_t data1[] = {
    16, -88, -125, 67, 54, 44, -74, -28, 53, 119, -99, -17, -3, -68, -24, 73
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -95, 4, 107, -40, -79, -3, -30, 17, -99, -17, -44, 124, 14, -5, -79, -35
    };
    ...
    int8_t golden[] = {
    177, 172, 238, 27, 231, 41, 152, 245, 210, 102, 113, 107, 11, 183, 153, 38
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
