...
int main(){
    const int8_t data1[] = {
    15, -16, 5, -83, -87, 109, -50, 118, 21, -103, 81, -27, -54, 43, -47, 13
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -112, 0, -55, 77, 49, 79, -114, -122, 31, -12, 3, 63, -124, -108, 94, -48
    };
    ...
    int8_t golden[] = {
    15, -16, 10, -166, -174, 218, -50, 118, 42, -103, 162, -54, -54, 43, -47, 13
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
