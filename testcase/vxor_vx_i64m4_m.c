...
int main(){
    const int64_t data1[] = {
    -20, -55, 10, -111, -67, -121, -15, -106, 79, -15, -104, 7, -13, 74, -28, -5
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    11, -76, 93, -110, 127, 118, 25, -19, 24, 88, 109, -31, -9, -20, -113, -1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_i64m4_m (mask, data1_v, data2_v, vl);
