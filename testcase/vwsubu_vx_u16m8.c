...
int main(){
    ...
    159, 197, 65, 64, 59, 152, 195, 175, 183, 241, 146, 168, 139, 97, 191, 59
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    6, 193, 20, 125, 197, 22, 185, 79, 217, 153, 132, 58, 52, 151, 3, 84
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u16m8 (data1_v, data2_v, vl);
