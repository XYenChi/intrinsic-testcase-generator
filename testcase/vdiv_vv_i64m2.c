...
int main(){
    const int64_t data1[] = {
    98, 67, -80, -73, -35, 123, 75, 45, -77, 43, -52, -123, -48, 47, -13, -107
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    62, 124, -70, -62, -45, 51, -112, 48, 65, 73, -31, -100, -110, -62, -85, -78
    };
    ...
    int64_t golden[] = {
    0, 1, 0, 0, 1, 0, 18446744073709551614, 1, 18446744073709551615, 1, 0, 0, 2, 18446744073709551614, 6, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
