...
int main(){
    const int8_t data1[] = {
    -32, -27, 56, 25, 32, 19, 0, 115, 89, 73, -5, 91, -102, 110, -15, -58
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    23, -21, -2, 107, -113, 111, -102, -67, -111, 71, 81, 96, -107, 18, -94, -27
    };
    ...
    int8_t golden[] = {
    23, 235, 56, 107, 32, 111, 0, 115, 89, 73, 81, 96, 154, 110, 241, 229
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
