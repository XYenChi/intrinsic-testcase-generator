...
int main(){
    const uint8_t data1[] = {
    22, 140, 70, 251, 158, 165, 43, 26, 218, 255, 196, 162, 8, 240, 129, 162
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    184, 169, 184, 188, 250, 248, 139, 179, 195, 31, 153, 155, 74, 235, 240, 170
    };
    ...
    uint8_t golden[] = {
    94, 227, 142, 0, 158, 173, 43, 1, 23, 0, 43, 7, 0, 0, 145, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
