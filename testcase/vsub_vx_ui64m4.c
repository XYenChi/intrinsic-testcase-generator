...
int main(){
    const int64_t data1[] = {
    162, 187, 17, 75, 145, 183, 58, 13, 188, 113, 86, 187, 48, 116, 132, 109
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    95, 207, 136, 146, 212, 89, 73, 135, 60, 232, 149, 250, 92, 232, 227, 127
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vx_ui64m4 (data1_v, data2_v, vl);
    ...
    int64_t golden[] = {
    67, 0, 0, 0, 0, 94, 0, 0, 128, 0, 0, 0, 0, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
