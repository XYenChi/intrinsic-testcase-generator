...
int main(){
    ...
    116, 54, 138, 71, 82, 231, 40, 10, 157, 247, 221, 167, 207, 14, 158, 25
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    184, 110, 43, 189, 78, 158, 164, 44, 156, 206, 230, 202, 226, 31, 71, 210
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i32m2 (data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    1, 2, 0, 2, 0, 0, 4, 4, 0, 0, 1, 1, 1, 2, 0, 8
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
