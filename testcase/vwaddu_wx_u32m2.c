...
int main(){
    ...
    57, 17, 237, 129, 104, 154, 253, 0, 251, 130, 135, 63, 34, 80, 160, 200
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    177, 118, 97, 163, 19, 239, 243, 151, 107, 32, 174, 86, 1, 176, 178, 86
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u32m2 (data1_v, data2_v, vl);
