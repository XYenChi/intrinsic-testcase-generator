...
int main(){
    const int16_t data1[] = {
    -72, -20, 59, -15, -46, -4, -127, -84, -56, 88, 6, -121, -126, 62, 42, -81
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    35, -94, -104, 37, 50, -74, 118, -42, 9, 126, -39, -75, -63, 81, 123, -80
    };
    ...
    int16_t golden[] = {
    65535, 4, 65534, 65533, 65534, 18, 65535, 0, 65535, 1, 65529, 0, 0, 1, 2, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
