...
int main(){
    const int16_t data1[] = {
    -4, -12, 10, 88, 85, -17, 35, -121, -48, -78, 1, 125, 85, -51, 51, 67
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    61, -14, -75, -73, 0, 35, -15, -53, 68, 80, -90, -94, 53, 23, -30, -2
    };
    ...
    int16_t golden[] = {
    65520, 1, 65528, 65535, 0, 65533, 65535, 0, 65534, 65534, 65446, 65535, 0, 65535, 65535, 65535
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
