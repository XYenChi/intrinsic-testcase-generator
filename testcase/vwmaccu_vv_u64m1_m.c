...
int main(){
    ...
    111, 25, 226, 248, 177, 222, 235, 89, 225, 50, 208, 218, 0, 95, 60, 37
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    237, 139, 141, 13, 100, 189, 93, 3, 31, 134, 221, 228, 164, 234, 215, 53
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vv_u64m1_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    1, 1, 31867, 3224, 17700, 41959, 21856, 268, 1, 0, 45968, 49704, 1, 1, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
