...
int main(){
    const uint8_t data1[] = {
    66, 249, 205, 65, 108, 242, 108, 250, 84, 128, 199, 103, 201, 40, 124, 147
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    119, 246, 74, 221, 71, 20, 44, 147, 100, 168, 149, 241, 51, 109, 180, 2
    };
    ...
    uint8_t golden[] = {
    119, 249, 1, 221, 108, 1, 0, 1, 100, 168, 199, 0, 201, 0, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
