...
int main(){
    ...
    3, 107, 157, 228, 190, 113, 229, 219, 104, 143, 205, 102, 228, 177, 18, 108
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    133, 112, 169, 27, 173, 81, 108, 168, 145, 28, 187, 123, 236, 182, 22, 103
    };
    ...
    uint32_t golden[] = {
    4294967166, 4294967291, 4294967284, 201, 17, 32, 121, 51, 4294967255, 115, 18, 4294967275, 4294967288, 4294967291, 4294967292, 5
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
