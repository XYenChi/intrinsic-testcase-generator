...
int main(){
    ...
    99, 18, 176, 49, 196, 26, 42, 244, 95, 238, 177, 237, 54, 13, 217, 243
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    201, 100, 224, 158, 141, 145, 77, 108, 158, 14, 65, 53, 243, 51, 81, 108
    };
    ...
    uint32_t golden[] = {
    4294967194, 4294967214, 4294967248, 4294967187, 55, 4294967177, 4294967261, 136, 4294967233, 224, 112, 184, 4294967107, 4294967258, 136, 135
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
