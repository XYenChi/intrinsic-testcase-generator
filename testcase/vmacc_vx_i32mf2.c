...
int main(){
    const int32_t data1[] = {
    -47, -118, -26, 31, -79, 30, 82, -59, 64, 41, 21, -64, 55, -120, 79, -108
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    96, -9, -54, 61, 54, -15, -41, -101, -23, 93, 18, 119, 80, 104, 54, -7
    };
    ...
    int32_t golden[] = {
    4294962784, 1062, 1404, 1892, 4294963031, 4294966847, 4294963934, 5960, 4294965825, 3813, 379, 4294959681, 4400, 4294954817, 4266, 757
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
