...
int main(){
    const int8_t data1[] = {
    119, 0, -36, 122, 118, -31, -30, -112, 94, -4, 77, 95, -73, -74, -13, -109
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -29, 97, -88, 21, 3, -57, -72, -15, 92, -77, 55, 87, 105, -60, -89, 45
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vv_8m4_b2_m (mask, data1_v, data2_v, vl);
