...
int main(){
    ...
    131, 38, 80, 170, 28, 143, 29, 177, 41, 203, 145, 250, 106, 134, 218, 123
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    41, 26, 38, 130, 85, 245, 241, 1, 194, 26, 165, 141, 211, 183, 162, 55
    };
    ...
    uint16_t golden[] = {
    5371, 988, 3040, 22100, 2380, 35035, 6989, 177, 7954, 5278, 23925, 35250, 22366, 24522, 35316, 6765
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
