...
int main(){
    ...
    115, 122, 209, 78, 71, 194, 86, 200, 131, 214, 203, 14, 90, 220, 202, 87
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    42, 68, 174, 14, 172, 205, 133, 122, 71, 201, 208, 22, 32, 48, 128, 98
    };
    ...
    uint16_t golden[] = {
    4830, 8296, 36366, 1092, 12212, 39770, 11438, 24400, 9301, 43014, 42224, 308, 2880, 10560, 25856, 8526
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
