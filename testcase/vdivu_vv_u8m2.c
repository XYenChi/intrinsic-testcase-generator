...
int main(){
    const uint8_t data1[] = {
    241, 101, 147, 56, 8, 187, 225, 235, 240, 182, 33, 25, 108, 7, 152, 30
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    62, 119, 143, 113, 76, 30, 23, 70, 168, 250, 87, 156, 72, 64, 135, 22
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i8m2 (data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 1, 0, 2, 9, 0, 0, 0, 0, 1, 2, 6, 0, 9, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
