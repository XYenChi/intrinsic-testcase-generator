...
int main(){
    const int16_t data1[] = {
    42, 22, 57, -1, -37, 22, 93, 76, -24, -36, 29, -103, 16, 85, -46, 76
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    99, 49, 52, -76, 108, -91, 114, -37, 33, -33, 11, 107, 4, -86, -44, 4
    };
    ...
    int16_t golden[] = {
    65479, 65509, 5, 75, 65391, 113, 65515, 113, 65479, 65533, 18, 65326, 12, 171, 65534, 72
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
