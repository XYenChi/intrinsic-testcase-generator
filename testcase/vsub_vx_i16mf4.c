...
int main(){
    const int16_t data1[] = {
    41, -71, 95, -57, -41, 28, 112, -34, 20, -55, 48, -1, -112, 75, -52, 89
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -122, -48, -40, -105, 117, -97, 59, 115, -85, -59, -126, 119, -48, 10, 29, 61
    };
    ...
    int16_t golden[] = {
    127, -23, 127, 48, -128, 125, 53, -128, 105, 4, 127, -120, -64, 65, -81, 28
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
