...
int main(){
    ...
    7, 216, 69, 72, 214, 251, 123, 132, 162, 239, 180, 74, 23, 110, 142, 217
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    136, 97, 68, 29, 79, 106, 207, 59, 50, 185, 5, 154, 196, 233, 57, 179
    };
    ...
    uint32_t golden[] = {
    4294967167, 119, 1, 43, 135, 145, 4294967212, 73, 112, 54, 175, 4294967216, 4294967123, 4294967173, 85, 38
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
