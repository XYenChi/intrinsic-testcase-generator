...
int main(){
    ...
    173, 103, 167, 153, 18, 119, 192, 154, 255, 86, 124, 208, 236, 61, 163, 164
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    132, 67, 8, 97, 92, 25, 133, 182, 75, 117, 12, 207, 6, 66, 81, 175
    };
    ...
    uint32_t golden[] = {
    41, 36, 159, 56, 4294967222, 94, 59, 4294967268, 180, 4294967265, 112, 1, 230, 4294967291, 82, 4294967285
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
