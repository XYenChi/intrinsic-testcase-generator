...
int main(){
    const int64_t data1[] = {
    -25, -123, -28, 118, -62, 29, -119, -5, 107, -80, -29, -117, 97, 47, 68, 52
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -10, 108, 72, -55, -125, 48, -124, 102, 74, 81, 57, 122, 42, -81, 57, 126
    };
    ...
    int64_t golden[] = {
    18446744073709551606, 18446744073709551601, 18446744073709551604, 63, 18446744073709551615, 19, 0, 18446744073709551613, 74, 18446744073709551537, 0, 18446744073709551504, 42, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
