...
int main(){
    ...
    154, 232, 188, 174, 0, 73, 211, 251, 43, 118, 96, 119, 161, 222, 147, 167
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    227, 130, 189, 17, 45, 28, 88, 94, 58, 229, 232, 194, 32, 30, 38, 76
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_32m4_b8 (data1_v, data2_v, vl);
