...
int main(){
    const int8_t data1[] = {
    -3, -54, 2, -91, -50, 79, 71, 127, 7, 29, 46, 104, -117, 9, -122, 11
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -13, -87, 35, -41, -107, 18, 96, 78, 110, -13, -44, 8, -34, 87, -111, 103
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wv_8m2i_m (mask, data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    255, 235, 1, 247, 1, 0, 103, 0, 0, 255, 254, 104, 223, 0, 151, 111
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
