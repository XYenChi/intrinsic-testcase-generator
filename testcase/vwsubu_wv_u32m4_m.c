...
int main(){
    ...
    40, 137, 178, 155, 179, 196, 163, 86, 216, 0, 158, 92, 25, 91, 50, 49
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    183, 181, 38, 53, 27, 216, 121, 30, 81, 75, 53, 112, 212, 247, 28, 107
    };
    const uint32_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e32m4(avl);
    const uint out_data[] = {
    0, 1, 0, 1, 1, 1, 1, 0, 1, 0, 0, 1, 0, 1, 1, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u32m4_m (mask, data1_v, data2_v, vl);
