...
int main(){
    const int64_t data1[] = {
    87, 39, -16, 104, 114, 75, 126, 116, -104, 110, -97, 111, 73, -95, 53, 39
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -29, -24, 52, 15, 65, 97, 56, -91, 90, 127, -13, -108, 87, 78, -15, -88
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vv_64m4_b16 (data1_v, data2_v, vl);
