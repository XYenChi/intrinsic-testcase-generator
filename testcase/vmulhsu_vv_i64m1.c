...
int main(){
    const int64_t data1[] = {
    -10, -117, 112, -93, -80, -96, -32, 66, 12, 89, -18, 56, -73, -80, -103, -123
    };
    const int64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    87, 221, 233, 107, 115, 229, 243, 2, 100, 123, 56, 249, 223, 15, 142, 92
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_64m1_b64 (data1_v, data2_v, vl);
