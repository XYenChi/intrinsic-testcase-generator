...
int main(){
    const int8_t data1[] = {
    28, -35, -110, -99, -41, 64, -39, -111, -126, -71, -12, -108, -88, 30, 101, -84
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -122, 59, -68, -100, -118, -13, -39, -120, -70, 77, 42, -60, -93, -75, -13, -56
    };
    ...
    int8_t golden[] = {
    -94, 24, -178, -199, -159, 51, -78, -230, -196, 6, 31, -168, -180, -45, 89, -139
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
