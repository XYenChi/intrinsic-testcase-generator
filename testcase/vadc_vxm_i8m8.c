...
int main(){
    const int8_t data1[] = {
    -92, -67, -22, -73, -7, 24, 70, -109, 110, -109, -75, 61, 33, 67, 79, 21
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -76, -115, 120, 58, -37, 21, 94, 86, -124, -75, 22, 89, 88, -124, 92, -71
    };
    ...
    int8_t golden[] = {
    -167, -181, 98, -15, -43, 46, 165, -22, -14, -183, -53, 150, 122, -57, 171, -50
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
