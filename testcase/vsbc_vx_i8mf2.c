...
int main(){
    const int8_t data1[] = {
    242, 66, 9, 68, 54, 216, 44, 76, 220, 237, 123, 226, 127, 34, 233, 109
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    190, 85, 211, 73, 205, 96, 110, 207, 44, 248, 26, 238, 195, 155, 203, 164
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsbc_vx_i8mf2 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    52, -19, -202, -5, -151, 120, -66, -131, 176, -11, 97, -12, -68, -121, 30, -55
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
