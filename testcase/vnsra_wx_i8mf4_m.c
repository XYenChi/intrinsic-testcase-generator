...
int main(){
    const int8_t data1[] = {
    51, -43, -33, -114, 126, -109, 103, -43, 47, -121, 51, 69, 114, -25, 124, -43
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -126, 105, 105, -94, 22, -127, -116, 19, 93, -102, -49, -74, -88, -33, 82, -99
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsra_wx_8mf4_m (mask, data1_v, shift, vl);
