...
int main(){
    const int64_t data1[] = {
    107, 19, 69, -26, 121, -75, 54, -84, -68, 111, -80, -85, 104, 115, 53, 51
    };
    const int64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    216, 119, 38, 169, 36, 4, 182, 44, 109, 137, 213, 72, 80, 106, 197, 140
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_64m8_b8 (mask, data1_v, data2_v, vl);
