...
int main(){
    ...
    106, 171, 161, 19, 13, 187, 248, 156, 213, 190, 112, 116, 0, 215, 158, 138
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    72, 125, 91, 214, 227, 5, 244, 50, 174, 129, 9, 217, 10, 65, 171, 41
    };
    ...
    uint16_t golden[] = {
    178, 171, 161, 233, 240, 187, 248, 156, 213, 319, 112, 333, 0, 65, 158, 41
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
