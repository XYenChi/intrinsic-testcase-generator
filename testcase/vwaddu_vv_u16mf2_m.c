...
int main(){
    ...
    199, 56, 161, 52, 36, 159, 128, 173, 187, 168, 156, 69, 191, 202, 199, 105
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    12, 201, 240, 139, 237, 248, 135, 187, 52, 157, 95, 233, 211, 94, 81, 116
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u16mf2_m (mask, data1_v, data2_v, vl);
