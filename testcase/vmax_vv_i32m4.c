...
int main(){
    const int32_t data1[] = {
    46, 0, -58, -43, 3, 126, -123, -99, 94, 2, -47, 115, 24, 83, 115, -25
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    11, 52, 72, -56, 78, -82, 6, -25, -123, -119, 125, -87, 38, -99, -5, -46
    };
    ...
    int32_t golden[] = {
    46, 52, 72, 4294967253, 78, 126, 6, 4294967271, 94, 2, 125, 115, 38, 83, 115, 4294967271
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
