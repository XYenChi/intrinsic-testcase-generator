...
int main(){
    const int32_t data1[] = {
    -35, 14, -61, 112, -8, 19, 24, 5, 64, 28, 65, 28, -36, 115, 118, -97
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    107, -94, 91, 23, 41, -22, 70, -121, -14, 85, 107, -116, 45, -81, -90, 91
    };
    ...
    int32_t golden[] = {
    107, 14, 91, 112, 41, 19, 70, 5, 64, 85, 107, 28, 45, 115, 118, 91
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
