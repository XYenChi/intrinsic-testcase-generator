...
int main(){
    const int16_t data1[] = {
    -90, 12, 48, 17, -66, -103, 52, 48, 5, 75, 74, -66, 113, 13, -57, 72
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    132, 223, 111, 174, 134, 92, 154, 18, 50, 69, 233, 231, 55, 194, 63, 199
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_16m1_b16 (data1_v, data2_v, vl);
