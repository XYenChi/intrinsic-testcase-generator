...
int main(){
    const int32_t data1[] = {
    106, 38, 100, 87, 29, 89, 4, 89, 84, -23, -27, 53, 66, -73, 93, -58
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -34, 3, 28, -8, 125, -36, -93, 26, -21, 111, -107, 69, 27, -5, 26, -23
    };
    ...
    int32_t golden[] = {
    72, 41, 128, 79, 154, 53, 4294967207, 115, 63, 88, 4294967162, 122, 93, 4294967218, 119, 4294967215
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
