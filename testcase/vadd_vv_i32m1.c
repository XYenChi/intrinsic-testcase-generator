...
int main(){
    const int32_t data1[] = {
    -73, 17, -48, -63, 106, 37, -48, 41, 76, 31, 11, -46, -81, 86, 118, -50
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -66, 14, 39, 41, 7, -113, 11, -37, 49, 53, 41, 125, 43, -26, 90, -102
    };
    ...
    int32_t golden[] = {
    4294967157, 31, 4294967287, 4294967274, 113, 4294967220, 4294967259, 4, 125, 84, 52, 79, 4294967258, 60, 208, 4294967144
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
