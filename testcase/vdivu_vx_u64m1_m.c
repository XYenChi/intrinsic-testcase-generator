...
int main(){
    ...
    53, 233, 145, 42, 201, 147, 175, 131, 63, 134, 204, 49, 155, 153, 69, 148
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    191, 158, 9, 137, 15, 2, 147, 234, 200, 156, 10, 113, 238, 154, 105, 209
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i64m1_m (mask, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    3, 0, 0, 0, 1, 1, 1, 1, 0, 1, 1, 2, 1, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
