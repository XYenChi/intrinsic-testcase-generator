...
int main(){
    ...
    80, 107, 162, 215, 63, 125, 128, 86, 75, 203, 102, 181, 100, 111, 138, 57
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    136, 214, 217, 17, 147, 66, 176, 111, 33, 34, 48, 43, 205, 119, 97, 10
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmacc_vx_u16mf2_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    0, 22898, 35155, 3655, 9262, 1, 22528, 9546, 0, 6902, 0, 7783, 20501, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
