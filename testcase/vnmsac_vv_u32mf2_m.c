...
int main(){
    ...
    187, 215, 29, 38, 248, 223, 100, 125, 219, 208, 11, 56, 4, 28, 8, 13
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    87, 95, 248, 219, 255, 230, 169, 198, 253, 213, 206, 21, 242, 109, 134, 178
    };
    ...
    uint32_t golden[] = {
    4294951028, 4294946872, 4294960104, 0, 4294904057, 4294916006, 1, 1, 4294911889, 4294922993, 4294965031, 1, 1, 4294964244, 4294966225, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
