...
int main(){
    ...
    170, 138, 76, 62, 63, 113, 104, 83, 243, 236, 108, 94, 175, 219, 128, 96
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    22, 101, 174, 195, 77, 135, 24, 185, 164, 95, 230, 214, 219, 2, 205, 113
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsac_vv_u32mf2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    1, 1, 4294954073, 4294955206, 4294962445, 4294952042, 4294964801, 4294951941, 4294927445, 4294944877, 4294942456, 1, 0, 1, 1, 4294956448
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
