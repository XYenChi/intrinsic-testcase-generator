...
int main(){
    const uint8_t data1[] = {
    111, 32, 77, 200, 167, 233, 211, 117, 111, 49, 57, 106, 151, 201, 226, 31
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    237, 251, 35, 207, 205, 249, 165, 29, 37, 130, 162, 38, 236, 15, 145, 143
    };
    const uint8_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e8m4(avl);
    const uint out_data[] = {
    1, 1, 0, 0, 0, 1, 0, 1, 0, 0, 1, 0, 1, 0, 1, 1
    };
    ...
    uint8_t golden[] = {
    222, 64, 154, 400, 334, 466, 422, 234, 222, 49, 57, 106, 151, 402, 452, 62
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
