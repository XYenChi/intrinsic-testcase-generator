...
int main(){
    ...
    14, 165, 113, 5, 110, 53, 152, 1, 152, 220, 204, 91, 28, 44, 186, 185
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    65, 145, 246, 153, 233, 213, 217, 85, 161, 23, 251, 170, 222, 223, 122, 40
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u32m2 (data1_v, shift, vl);
