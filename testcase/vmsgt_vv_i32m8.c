...
int main(){
    const int32_t data1[] = {
    15, 107, -9, -112, -26, -22, 121, -89, -22, 107, -118, 105, 2, -75, -109, 39
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    99, -79, 58, -34, 57, -64, 110, -63, 74, 76, 125, 60, -66, -96, -71, -96
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vv_32m8_b4 (data1_v, data2_v, vl);
