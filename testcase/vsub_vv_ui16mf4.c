...
int main(){
    const int16_t data1[] = {
    69, 52, 28, 14, 197, 247, 80, 232, 155, 39, 197, 6, 176, 26, 7, 221
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    205, 75, 137, 133, 226, 107, 54, 124, 107, 189, 48, 143, 167, 179, 230, 63
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vv_ui16mf4 (data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    0, 0, 0, 0, 0, 140, 26, 108, 48, 0, 149, 0, 9, 0, 0, 158
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
