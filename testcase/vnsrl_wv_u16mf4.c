...
int main(){
    ...
    118, 166, 216, 32, 23, 184, 232, 246, 180, 166, 255, 55, 59, 57, 67, 251
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    234, 163, 3, 2, 42, 128, 186, 137, 215, 230, 207, 148, 246, 186, 132, 170
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_16mf4 (data1_v, shift, vl);
