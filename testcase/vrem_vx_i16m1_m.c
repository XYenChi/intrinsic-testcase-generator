...
int main(){
    const int16_t data1[] = {
    36, -91, 63, -66, 116, -33, -44, -55, 32, -120, -64, 43, 50, -84, 80, 110
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -21, -1, 12, -84, -101, -73, 43, 11, -44, 57, 82, 16, 62, 54, -38, -56
    };
    ...
    uint16_t masked[] = {
    1, 0, 0, 0, 0, 1, 0, 0, 1, 0, 1, 1, 0, 1, 1, 0
    };
    ...
    int16_t golden[] = {
    15, 1, 1, 1, 0, 65529, 0, 1, 20, 1, 65490, 16, 0, 65506, 42, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
