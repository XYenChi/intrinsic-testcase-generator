...
int main(){
    const int16_t data1[] = {
    50, -43, -97, 103, -87, 64, -16, -80, -45, -93, 61, -10, 106, 2, -49, 100
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -108, 96, -119, 67, 77, -29, 78, -18, 32, -56, -47, -3, -93, -127, -83, -128
    };
    ...
    int16_t golden[] = {
    158, 65397, 65439, 103, 65449, 64, 65442, 65456, 65459, 65443, 61, 65529, 199, 129, 65487, 100
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
