...
int main(){
    const int64_t data1[] = {
    90, -12, -39, -56, 78, 104, 87, 108, -116, 65, 83, -127, 75, -20, 87, 30
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    86, -34, 109, 102, 124, 59, -63, -91, -87, 114, -44, 116, -70, -61, 102, -61
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_64m2_b32_m (mask, data1_v, data2_v, vl);
