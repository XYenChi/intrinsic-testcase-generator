...
int main(){
    ...
    41, 203, 123, 228, 192, 58, 20, 196, 181, 144, 136, 9, 142, 36, 134, 116
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    241, 85, 221, 228, 241, 134, 173, 99, 15, 242, 190, 206, 220, 0, 184, 24
    };
    ...
    uint16_t golden[] = {
    241, 203, 221, 228, 241, 134, 173, 196, 181, 242, 190, 206, 220, 36, 184, 116
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
