...
int main(){
    ...
    221, 118, 116, 190, 147, 56, 237, 130, 134, 46, 183, 80, 238, 250, 145, 146
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    76, 174, 171, 217, 7, 46, 5, 145, 99, 60, 139, 94, 63, 175, 104, 72
    };
    ...
    uint16_t golden[] = {
    221, 174, 171, 217, 147, 56, 237, 145, 134, 60, 183, 94, 238, 250, 145, 146
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
