...
int main(){
    const int16_t data1[] = {
    54, 162, 18, 28, 117, 226, 255, 230, 61, 146, 48, 53, 219, 10, 239, 163
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    237, 213, 11, 124, 108, 56, 138, 34, 46, 162, 60, 73, 51, 131, 150, 182
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vx_ui16mf4 (data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    0, 0, 7, 0, 9, 170, 117, 196, 15, 0, 0, 0, 168, 0, 89, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
