...
int main(){
    const int32_t data1[] = {
    32, 30, 116, 15, 114, -16, -113, -124, 90, -105, 79, -125, -65, -21, -111, 29
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -38, 1, -44, -123, 95, 73, 99, -26, -111, 31, 10, -117, 9, -86, 10, -56
    };
    ...
    int32_t golden[] = {
    -5, 32, 72, -108, 209, 57, -13, -150, -21, -74, 89, -242, -56, -107, -100, -27
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
