...
int main(){
    const int8_t data1[] = {
    -32, -27, -101, 115, 62, 110, -59, -108, 7, -114, -62, -42, 37, 70, 119, 29
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -35, 67, 84, -128, -121, -34, 8, 69, 24, -101, 123, 95, -113, 27, 52, 26
    };
    const int8_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e8m8(avl);
    const int out_data[] = {
    0, 0, 1, 0, 0, 1, 1, 0, 1, 0, 0, 0, 1, 0, 1, 0
    };
    ...
    int8_t golden[] = {
    0, 0, 1, 0, 0, 1, 255, 0, 1, 0, 254, 253, 1, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
