...
int main(){
    const int8_t data1[] = {
    172, 93, 240, 10, 107, 166, 45, 242, 256, 55, 112, 140, 36, 131, 68, 6
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    0, 199, 68, 202, 164, 66, 10, 153, 13, 71, 248, 98, 130, 101, 162, 132
    };
    const int8_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = vsetvl_e8m8(size_t avl);
    const int out_data[] = {
    253, 133, 249, 57, 92, 72, 213, 143, 60, 234, 136, 239, 67, 101, 246, 153
    };
    ...
    int8_t golden[] = {
    253, 133, 249, 20, 92, 72, 213, 0, 60, 234, 2, 0, 3, 0, 2, 153
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
