...
int main(){
    const int16_t data1[] = {
    77, -67, -92, -103, 119, 48, -34, 48, -23, 28, -103, -73, -112, 69, -98, 83
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    60, 99, -118, 48, -4, 123, 17, -62, 52, 121, -46, -38, 25, -49, 79, -5
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsra_wx_16mf4_m (mask, data1_v, shift, vl);
