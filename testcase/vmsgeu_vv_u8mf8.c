...
int main(){
    const uint8_t data1[] = {
    90, 5, 114, 207, 152, 188, 81, 56, 59, 188, 65, 223, 163, 60, 131, 174
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    34, 97, 112, 43, 161, 69, 100, 19, 139, 177, 95, 198, 100, 210, 3, 170
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_8mf8_b64 (data1_v, data2_v, vl);
