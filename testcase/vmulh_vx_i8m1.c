...
int main(){
    const int8_t data1[] = {
    36, -95, -25, 66, -117, 81, 74, 76, -93, 118, -109, 101, 46, -47, 59, 12
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    94, -126, 69, 29, -21, -127, -102, -96, -59, 95, -72, 50, 21, -50, 107, -52
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vx_8m1_b8 (data1_v, data2_v, vl);
