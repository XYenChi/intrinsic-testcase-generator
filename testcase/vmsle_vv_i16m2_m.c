...
int main(){
    const int16_t data1[] = {
    -105, -102, -110, 78, 35, 4, -39, 125, 3, -2, -114, -32, 71, -38, 105, -111
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -48, 111, 49, 43, -119, -4, 49, -118, 12, -18, 85, 66, -116, -101, -89, 90
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vv_16m2_b8_m (mask, data1_v, data2_v, vl);
