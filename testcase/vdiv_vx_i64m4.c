...
int main(){
    const int64_t data1[] = {
    -121, 99, 1, 95, 113, 64, -1, -67, 18, 90, 48, -53, 46, -62, -43, 112
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -26, 45, 13, -10, 73, 86, 90, -52, 9, 45, -33, 111, 48, -29, 60, -39
    };
    ...
    int64_t golden[] = {
    0, 0, 13, 18446744073709551615, 0, 1, 18446744073709551526, 0, 0, 0, 18446744073709551615, 18446744073709551613, 1, 0, 18446744073709551614, 18446744073709551615
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
