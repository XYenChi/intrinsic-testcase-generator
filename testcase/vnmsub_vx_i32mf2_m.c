...
int main(){
    const int32_t data1[] = {
    104, -21, 35, 94, 103, -88, 17, -69, -6, -114, -87, 77, 1, -21, -121, -11
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -91, 29, -45, -26, 1, -12, 42, -8, 22, -88, -59, -19, -81, -61, 30, 51
    };
    ...
    int32_t golden[] = {
    195, 1, 1, 94, 102, 0, 17, 4294967227, 4294967290, 1, 4294967268, 1, 82, 4294967275, 4294967145, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
