...
int main(){
    ...
    112, 170, 222, 154, 69, 100, 5, 204, 203, 12, 112, 203, 79, 217, 159, 108
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    9, 38, 200, 108, 48, 134, 90, 162, 179, 137, 27, 3, 140, 188, 170, 56
    };
    ...
    uint64_t golden[] = {
    112, 170, 200, 108, 117, 100, 95, 366, 203, 12, 112, 203, 79, 217, 170, 108
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
