...
int main(){
    ...
    27, 55, 188, 38, 221, 96, 166, 114, 244, 248, 157, 113, 90, 202, 64, 13
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    142, 180, 169, 70, 226, 167, 150, 69, 69, 208, 144, 167, 230, 46, 138, 213
    };
    ...
    uint16_t golden[] = {
    142, 180, 188, 70, 226, 167, 166, 114, 244, 248, 157, 167, 230, 202, 138, 213
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
