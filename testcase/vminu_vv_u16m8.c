...
int main(){
    ...
    9, 12, 9, 131, 201, 77, 36, 182, 90, 70, 117, 96, 194, 252, 89, 209
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    198, 36, 36, 190, 140, 48, 77, 148, 232, 187, 5, 71, 53, 49, 41, 150
    };
    ...
    uint16_t golden[] = {
    198, 36, 36, 190, 201, 77, 77, 182, 232, 187, 117, 96, 194, 252, 89, 209
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
