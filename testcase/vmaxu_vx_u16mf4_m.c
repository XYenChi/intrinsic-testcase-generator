...
int main(){
    ...
    156, 76, 64, 85, 81, 63, 8, 145, 174, 247, 32, 19, 229, 104, 102, 229
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    145, 210, 56, 196, 2, 219, 55, 243, 246, 186, 200, 104, 54, 237, 64, 241
    };
    ...
    uint16_t golden[] = {
    0, 0, 1, 196, 81, 0, 55, 243, 246, 1, 200, 104, 229, 237, 102, 241
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
