...
int main(){
    ...
    197, 12, 168, 75, 102, 240, 41, 228, 57, 86, 70, 239, 214, 79, 20, 17
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    80, 17, 97, 18, 51, 247, 146, 76, 57, 145, 77, 10, 211, 62, 93, 84
    };
    ...
    uint16_t golden[] = {
    197, 1, 168, 1, 102, 247, 146, 228, 0, 145, 77, 239, 214, 79, 93, 84
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
