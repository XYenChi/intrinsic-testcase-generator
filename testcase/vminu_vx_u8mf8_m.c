...
int main(){
    const uint8_t data1[] = {
    122, 219, 109, 30, 246, 216, 110, 122, 111, 132, 158, 202, 27, 245, 133, 15
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    214, 238, 127, 128, 155, 170, 127, 205, 133, 161, 89, 42, 115, 249, 227, 194
    };
    ...
    uint8_t golden[] = {
    214, 1, 127, 1, 246, 216, 127, 0, 1, 0, 158, 202, 1, 0, 227, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
