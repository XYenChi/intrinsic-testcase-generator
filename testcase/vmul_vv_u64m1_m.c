...
int main(){
    ...
    103, 198, 162, 194, 249, 144, 45, 85, 118, 91, 232, 75, 51, 38, 206, 129
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    223, 46, 111, 106, 136, 156, 227, 139, 227, 213, 103, 74, 143, 252, 206, 102
    };
    ...
    uint64_t golden[] = {
    1, 9108, 0, 20564, 0, 1, 0, 1, 1, 0, 23896, 0, 1, 9576, 42436, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
