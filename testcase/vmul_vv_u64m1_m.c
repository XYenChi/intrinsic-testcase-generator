...
int main(){
    ...
    111, 42, 203, 238, 127, 200, 44, 84, 51, 200, 202, 33, 21, 172, 126, 253
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    24, 40, 228, 44, 63, 235, 9, 188, 91, 1, 242, 44, 134, 213, 212, 71
    };
    ...
    uint64_t golden[] = {
    2664, 1680, 1, 10472, 8001, 47000, 0, 0, 1, 1, 48884, 1452, 2814, 36636, 26712, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
