...
int main(){
    const int16_t data1[] = {
    -102, 50, 92, -65, 46, 89, 2, 116, 34, -106, -72, 59, 111, 100, -35, -69
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    39, 22, 3, -121, -105, 122, 120, 34, -128, -9, -107, 74, 125, -63, 106, -19
    };
    ...
    int16_t golden[] = {
    0, 64437, 65260, 57671, 4830, 54679, 1, 1, 4353, 64582, 57833, 1, 51661, 1, 3711, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
