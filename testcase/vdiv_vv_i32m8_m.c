...
int main(){
    const int32_t data1[] = {
    109, -33, -127, -89, -54, -63, -122, -49, 66, 63, -37, 76, 11, -54, 114, 98
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    126, -99, 73, 11, 89, -26, -124, -38, 100, -104, -68, -102, 15, -98, 107, 74
    };
    ...
    int32_t golden[] = {
    1, 1, 4294967295, 4294967295, 1, 0, 0, 1, 1, 4294967294, 1, 1, 0, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
