...
int main(){
    ...
    152, 165, 120, 203, 247, 163, 26, 119, 141, 5, 171, 126, 253, 166, 96, 208
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    8, 236, 219, 129, 174, 223, 157, 166, 253, 158, 67, 8, 239, 4, 236, 222
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u16mf4 (data1_v, data2_v, vl);
