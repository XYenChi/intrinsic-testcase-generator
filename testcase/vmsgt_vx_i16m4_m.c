...
int main(){
    const int16_t data1[] = {
    -118, -119, 35, 110, 27, -50, -89, 4, 96, 34, 123, 16, 50, 28, -36, 32
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -91, -24, -55, 34, -50, 39, 113, 50, 90, 23, -2, -28, 46, -29, 21, -89
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vx_16m4_b4_m (mask, data1_v, data2_v, vl);
