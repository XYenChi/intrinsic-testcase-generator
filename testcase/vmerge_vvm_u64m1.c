...
int main(){
    ...
    100, 166, 131, 25, 242, 81, 134, 54, 98, 24, 172, 125, 10, 220, 120, 219
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    218, 64, 196, 22, 27, 223, 39, 147, 35, 52, 131, 164, 174, 206, 30, 255
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmerge_vvm_u64m1 (data1_v, data2_v, masked size_t vl);
    ...
    uint64_t golden[] = {
    218, 166, 131, 22, 27, 81, 134, 54, 35, 52, 131, 164, 174, 206, 120, 255
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
