...
int main(){
    const int16_t data1[] = {
    -5, -104, -117, -82, -30, 94, 34, -15, 33, -113, -47, -74, 14, -100, 45, 1
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -22, -46, -11, 20, -58, -14, -4, -98, 71, -72, 104, -49, -93, 126, -27, 94
    };
    ...
    int16_t golden[] = {
    -27, -149, -127, -62, -88, 80, 31, -113, 105, -185, 57, -122, -79, 27, 18, 95
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
