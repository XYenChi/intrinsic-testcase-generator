...
int main(){
    const int64_t data1[] = {
    -121, 60, 103, 109, -106, -96, 67, 96, -4, 103, -45, -38, -123, 87, -7, 123
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -119, -124, -19, -85, -79, 46, -75, 105, 122, 93, -81, -76, -116, 41, 124, 108
    };
    ...
    int64_t golden[] = {
    0, 1, 0, 194, 1, 0, 142, 18446744073709551607, 18446744073709551490, 0, 36, 38, 18446744073709551609, 1, 0, 15
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
