...
int main(){
    ...
    182, 31, 87, 146, 106, 41, 160, 5, 215, 64, 133, 19, 62, 71, 190, 243
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    235, 193, 37, 239, 28, 154, 211, 190, 179, 17, 131, 123, 78, 17, 58, 12
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vx_64m8_b8 (data1_v, data2_v, vl);
