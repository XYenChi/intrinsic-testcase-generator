...
int main(){
    ...
    100, 75, 130, 158, 220, 89, 102, 251, 96, 168, 199, 184, 129, 104, 109, 151
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    183, 185, 58, 98, 48, 15, 14, 185, 14, 52, 230, 23, 63, 20, 7, 155
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_16m1 (data1_v, shift, vl);
