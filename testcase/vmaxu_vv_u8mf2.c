...
int main(){
    const uint8_t data1[] = {
    242, 165, 209, 26, 137, 180, 0, 182, 210, 28, 186, 148, 231, 57, 240, 5
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    148, 220, 119, 109, 84, 250, 55, 236, 144, 152, 244, 35, 187, 198, 114, 142
    };
    ...
    uint8_t golden[] = {
    242, 220, 209, 109, 137, 250, 55, 236, 210, 152, 244, 148, 231, 198, 240, 142
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
