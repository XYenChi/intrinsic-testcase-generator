...
int main(){
    const uint8_t data1[] = {
    5, 145, 102, 141, 66, 173, 199, 26, 51, 203, 0, 25, 11, 104, 38, 210
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    250, 42, 225, 20, 234, 50, 72, 244, 195, 172, 241, 218, 92, 218, 22, 175
    };
    ...
    uint8_t golden[] = {
    250, 145, 225, 141, 234, 173, 199, 244, 195, 203, 241, 218, 92, 218, 38, 210
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
