...
int main(){
    const int8_t data1[] = {
    61, -78, -71, 91, -16, 98, -54, -67, -73, -99, -117, 38, -109, -45, -21, 12
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    90, 107, -101, 11, 8, -124, 71, -36, -54, 62, -127, -19, -38, 106, 72, -114
    };
    ...
    int8_t golden[] = {
    61, -156, -142, 182, -16, 98, -108, -67, -73, -99, -234, 76, -109, -45, -21, 12
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
