...
int main(){
    const uint8_t data1[] = {
    215, 15, 18, 54, 191, 148, 82, 92, 92, 243, 43, 112, 209, 234, 222, 162
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    69, 178, 3, 176, 108, 70, 97, 214, 16, 13, 98, 203, 82, 225, 157, 238
    };
    ...
    uint8_t golden[] = {
    215, 1, 18, 176, 1, 1, 0, 0, 92, 243, 1, 203, 1, 0, 1, 238
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
