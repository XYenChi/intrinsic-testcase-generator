...
int main(){
    const int16_t data1[] = {
    74, -118, -99, 45, -21, -117, -117, -124, -121, 13, -10, 58, -82, -42, -91, 14
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    53, 78, -31, 15, 27, -31, -64, 123, -102, 12, -24, -79, 123, 84, 76, -8
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_i16mf2_m (mask, data1_v, data2_v, vl);
