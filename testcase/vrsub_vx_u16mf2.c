...
int main(){
    ...
    37, 161, 2, 9, 164, 33, 181, 229, 181, 237, 151, 230, 60, 87, 169, 111
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    28, 37, 86, 15, 186, 64, 244, 107, 99, 230, 47, 240, 150, 87, 133, 5
    };
    ...
    uint16_t golden[] = {
    65527, 65412, 84, 6, 22, 31, 63, 65414, 65454, 65529, 65432, 10, 90, 0, 65500, 65430
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
