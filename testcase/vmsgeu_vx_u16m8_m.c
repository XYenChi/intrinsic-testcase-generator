...
int main(){
    ...
    121, 227, 139, 124, 243, 255, 235, 199, 102, 65, 40, 151, 129, 46, 129, 194
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    64, 55, 160, 140, 35, 143, 102, 104, 197, 32, 197, 249, 102, 151, 169, 172
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_16m8_b2 (mask, data1_v, data2_v, vl);
