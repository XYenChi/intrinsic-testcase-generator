...
int main(){
    const uint8_t data1[] = {
    51, 161, 198, 109, 58, 149, 50, 113, 187, 197, 111, 112, 199, 141, 102, 1
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    74, 47, 244, 70, 240, 162, 145, 144, 240, 116, 109, 208, 84, 107, 14, 24
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulu_vv_u8m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 1, 184, 0, 1, 74, 0, 144, 0, 1, 67, 0, 76, 239, 148, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
