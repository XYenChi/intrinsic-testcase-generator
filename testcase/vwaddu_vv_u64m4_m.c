...
int main(){
    ...
    110, 96, 230, 120, 247, 188, 71, 106, 107, 143, 32, 194, 245, 51, 11, 48
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    15, 102, 168, 169, 127, 66, 7, 34, 101, 86, 236, 9, 224, 70, 34, 146
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u64m4_m (mask, data1_v, data2_v, vl);
