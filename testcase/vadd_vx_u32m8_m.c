...
int main(){
    ...
    23, 17, 100, 109, 206, 15, 192, 197, 211, 1, 53, 54, 4, 141, 72, 28
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    215, 30, 49, 6, 97, 173, 96, 188, 252, 8, 225, 158, 128, 76, 75, 33
    };
    ...
    uint32_t golden[] = {
    238, 0, 149, 115, 303, 188, 1, 385, 463, 0, 0, 1, 132, 217, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
