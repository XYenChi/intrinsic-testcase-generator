...
int main(){
    ...
    142, 101, 35, 183, 253, 230, 123, 3, 243, 183, 235, 252, 127, 81, 48, 168
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    99, 218, 24, 134, 131, 186, 191, 140, 10, 196, 149, 48, 196, 178, 201, 222
    };
    ...
    uint16_t golden[] = {
    241, 319, 59, 317, 384, 416, 314, 143, 253, 379, 384, 300, 323, 259, 249, 390
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
