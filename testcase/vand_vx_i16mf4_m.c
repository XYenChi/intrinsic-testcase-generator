...
int main(){
    const int16_t data1[] = {
    -81, 39, -69, -122, 71, -23, 29, 37, -74, -26, -46, -118, -50, -4, -114, -89
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -76, 9, 54, -48, 116, -61, -64, 12, 126, -105, 110, 10, 67, 64, 50, -75
    };
    ...
    int16_t golden[] = {
    65460, 9, 1, 65488, 0, 0, 1, 1, 126, 65431, 110, 0, 0, 64, 1, 65461
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
