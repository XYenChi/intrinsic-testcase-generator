...
int main(){
    const uint8_t data1[] = {
    77, 234, 208, 83, 45, 25, 194, 203, 91, 159, 236, 39, 87, 172, 0, 204
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    27, 185, 132, 132, 123, 0, 27, 125, 100, 1, 216, 138, 138, 55, 39, 142
    };
    ...
    uint8_t golden[] = {
    27, 185, 132, 132, 123, 0, 27, 125, 100, 1, 216, 138, 138, 55, 0, 142
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
