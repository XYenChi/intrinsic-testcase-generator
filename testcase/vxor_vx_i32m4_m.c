...
int main(){
    const int32_t data1[] = {
    79, -51, 70, -75, 51, -71, -36, -64, 68, -124, 127, -31, 15, 113, -41, -7
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -113, 69, 21, -89, -26, 61, -10, 27, 76, -20, 59, -72, -108, 120, 33, -47
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_i32m4_m (mask, data1_v, data2_v, vl);
