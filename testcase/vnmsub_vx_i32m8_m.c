...
int main(){
    const int32_t data1[] = {
    -27, -98, -22, 59, 123, -31, 44, -124, -48, 53, -3, -124, -108, 8, -3, -30
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    16, 88, -97, 104, -80, 22, 42, -33, 122, -77, 107, 57, -30, -81, -61, -50
    };
    ...
    int32_t golden[] = {
    1, 0, 1, 4294967251, 1, 1, 2, 4294967205, 4294967248, 0, 4294967186, 4294967172, 4294967218, 8, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
