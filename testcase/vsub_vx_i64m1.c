...
int main(){
    const int64_t data1[] = {
    110, -29, 60, -74, 32, 63, -17, -89, 46, -23, -38, -78, 53, 37, 52, -83
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -22, -73, 83, 23, -76, -102, -43, -53, -46, 26, -50, -23, 77, 16, -68, 13
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vx_i64m1 (data1_v, data2_v, vl);
    ...
    int64_t golden[] = {
    127, 44, -23, -97, 108, 127, 26, -36, 92, -49, 12, -55, -24, 21, 120, -96
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
