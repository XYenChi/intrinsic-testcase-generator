...
int main(){
    const int64_t data1[] = {
    98, -8, 84, 22, -43, 53, 41, -122, 72, -39, 19, -26, 57, -52, 100, 13
    };
    const int64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    23, 77, -91, -63, 26, -67, 12, 115, 31, 65, -78, -7, -126, 45, 9, -60
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulsu_vx_i64m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int64_t golden[] = {
    2254, 0, 0, 18446744073709550230, 0, 0, 0, 18446744073709537586, 0, 0, 18446744073709550134, 182, 0, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
