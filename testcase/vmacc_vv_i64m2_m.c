...
int main(){
    const int64_t data1[] = {
    -72, -79, 12, -75, 125, 64, -92, 99, 62, 32, -16, -7, -99, -42, 91, 20
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    127, -65, 54, 113, 46, 12, -93, -4, 22, -17, -119, 119, 95, 50, -107, 36
    };
    ...
    int64_t golden[] = {
    0, 5136, 648, 18446744073709543142, 5751, 768, 8557, 18446744073709551221, 1, 18446744073709551072, 1905, 0, 1, 1, 18446744073709541879, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
