...
int main(){
    const int32_t data1[] = {
    -56, 98, 13, -16, -38, 62, 32, 127, 31, -114, -121, -27, 8, -30, 20, 74
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    108, 105, -43, 79, -106, 42, 93, 119, 76, -117, -42, 28, 41, 83, 111, 65
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_32mf2_b64 (data1_v, data2_v, vl);
