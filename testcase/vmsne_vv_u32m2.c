...
int main(){
    ...
    203, 220, 201, 78, 113, 27, 36, 234, 244, 225, 108, 250, 211, 202, 74, 217
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    18, 255, 161, 208, 187, 105, 223, 254, 231, 122, 22, 254, 227, 22, 153, 137
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_32m2_b16 (data1_v, data2_v, vl);
