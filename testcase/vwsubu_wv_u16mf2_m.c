...
int main(){
    ...
    76, 189, 159, 142, 73, 237, 1, 172, 19, 255, 119, 160, 60, 120, 59, 20
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    6, 242, 37, 45, 144, 3, 239, 217, 70, 80, 246, 152, 171, 197, 53, 230
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u16mf2_m (mask, data1_v, data2_v, vl);
