...
int main(){
    ...
    193, 152, 101, 105, 6, 160, 187, 80, 238, 128, 240, 56, 99, 234, 178, 198
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    172, 122, 218, 108, 96, 52, 185, 147, 0, 127, 146, 243, 186, 138, 245, 251
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u32mf2_m (mask, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    0, 122, 16, 3, 0, 52, 185, 67, 1, 0, 1, 1, 0, 0, 67, 53
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
