...
int main(){
    ...
    101, 233, 119, 154, 195, 185, 65, 244, 23, 248, 180, 212, 112, 42, 158, 82
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    238, 138, 250, 228, 68, 218, 31, 248, 123, 132, 27, 78, 113, 44, 239, 184
    };
    ...
    uint16_t golden[] = {
    1, 1, 250, 0, 1, 0, 31, 0, 123, 132, 27, 1, 113, 44, 239, 184
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
