...
int main(){
    const int16_t data1[] = {
    17, 109, -110, 40, -22, 37, 76, -96, -70, 101, 10, 109, 14, 0, -61, -41
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    -60, 99, -30, 79, -74, -7, 45, -54, -106, 116, 62, -24, -66, -22, -87, 64
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmul_vx_i16mf4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    64516, 0, 3300, 3160, 0, 1, 0, 5184, 7420, 11716, 620, 0, 0, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
