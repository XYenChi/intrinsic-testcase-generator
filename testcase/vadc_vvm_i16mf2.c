...
int main(){
    const int16_t data1[] = {
    106, -3, 66, 104, -83, -80, -19, -44, -18, 70, 113, 82, 13, 111, 120, 12
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    54, -18, -122, -6, 118, 126, 107, 72, -75, -58, -55, 63, 24, 30, -13, 89
    };
    ...
    int16_t golden[] = {
    160, -20, -56, 98, 36, 46, 88, 29, -93, 12, 59, 146, 37, 141, 107, 101
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
