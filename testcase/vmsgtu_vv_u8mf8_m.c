...
int main(){
    const uint8_t data1[] = {
    161, 212, 122, 107, 99, 16, 210, 96, 40, 101, 114, 117, 135, 55, 235, 248
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    170, 212, 18, 7, 50, 166, 195, 201, 41, 125, 129, 55, 7, 181, 50, 111
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_8mf8_b64_m (mask, data1_v, data2_v, vl);
