...
int main(){
    ...
    212, 92, 142, 26, 20, 174, 118, 148, 85, 155, 35, 2, 120, 135, 107, 214
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    170, 201, 77, 204, 255, 185, 117, 194, 103, 14, 83, 118, 63, 1, 145, 107
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i64m1 (data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    0, 2, 0, 7, 12, 1, 0, 1, 1, 0, 2, 59, 0, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
