...
int main(){
    const int16_t data1[] = {
    52, 93, 95, -31, -67, -68, 57, -62, 127, 74, -128, -22, 95, 120, 61, 118
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -94, -37, -114, 50, -79, -97, -53, -74, -90, -6, -20, 14, -100, 75, 48, 67
    };
    ...
    int16_t golden[] = {
    65534, 65535, 0, 0, 0, 1, 65535, 1, 65535, 65535, 0, 65535, 65534, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
