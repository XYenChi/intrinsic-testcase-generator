...
int main(){
    const uint8_t data1[] = {
    101, 74, 153, 97, 212, 254, 239, 65, 166, 46, 63, 130, 46, 244, 161, 8
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    3, 114, 19, 27, 82, 235, 109, 200, 18, 99, 141, 194, 79, 139, 205, 21
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_8mf2 (data1_v, shift, vl);
