...
int main(){
    const int16_t data1[] = {
    -115, 80, 56, -88, 124, 6, 86, -1, -20, 86, 61, 7, -30, 24, -98, -106
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    59, -52, 86, -71, -126, -99, -110, -93, -123, 50, 17, 97, 61, 114, -9, 123
    };
    ...
    int16_t golden[] = {
    58751, 61376, 4816, 6248, 49912, 64942, 56076, 93, 2460, 4300, 1037, 679, 63706, 2736, 882, 52498
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
