...
int main(){
    ...
    105, 103, 175, 77, 41, 144, 170, 62, 41, 140, 88, 133, 20, 27, 218, 163
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    123, 123, 185, 183, 198, 166, 242, 182, 173, 35, 128, 136, 54, 66, 28, 176
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u32m2_m (mask, data1_v, data2_v, vl);
