...
int main(){
    const int64_t data1[] = {
    -54, 90, -125, 115, 98, 104, 42, 1, 67, -74, 69, 102, 14, -90, 94, 52
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    104, 86, -28, 119, 63, 121, -63, 90, 4, 48, 70, 2, 67, 27, -122, -21
    };
    const int64_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e64m2(avl);
    const int out_data[] = {
    1, 1, 0, 1, 1, 0, 1, 0, 0, 0, 1, 0, 0, 1, 1, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vv_64m2_b32_m (mask, data1_v, data2_v, vl);
