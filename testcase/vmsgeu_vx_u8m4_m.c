...
int main(){
    const uint8_t data1[] = {
    6, 2, 190, 237, 21, 235, 43, 53, 69, 236, 103, 36, 152, 185, 40, 131
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    70, 16, 221, 241, 9, 36, 240, 75, 160, 227, 136, 229, 7, 35, 33, 220
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_8m4_b2 (mask, data1_v, data2_v, vl);
