...
int main(){
    const uint8_t data1[] = {
    182, 47, 148, 155, 228, 204, 97, 35, 176, 160, 233, 204, 25, 211, 179, 158
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    56, 240, 83, 217, 162, 164, 41, 8, 248, 51, 175, 209, 244, 91, 129, 246
    };
    ...
    uint8_t golden[] = {
    0, 1, 148, 1, 1, 204, 1, 35, 0, 1, 0, 209, 244, 0, 179, 246
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
