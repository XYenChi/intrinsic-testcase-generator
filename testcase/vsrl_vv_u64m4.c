...
int main(){
    ...
    19, 30, 53, 193, 56, 81, 185, 198, 161, 39, 201, 198, 248, 211, 159, 234
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    77, 112, 42, 22, 105, 148, 73, 216, 70, 88, 157, 28, 254, 3, 167, 254
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u64m4 (data1_v, shift, vl);
