...
int main(){
    ...
    242, 68, 224, 228, 181, 219, 112, 24, 205, 122, 58, 207, 14, 203, 99, 168
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    187, 74, 30, 181, 158, 169, 49, 54, 147, 180, 77, 81, 105, 166, 143, 19
    };
    ...
    uint32_t golden[] = {
    45254, 5032, 6720, 0, 28598, 0, 5488, 1, 0, 21960, 4466, 16767, 1470, 1, 14157, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
