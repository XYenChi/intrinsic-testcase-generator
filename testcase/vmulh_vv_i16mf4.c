...
int main(){
    const int16_t data1[] = {
    36, -13, 90, -33, 50, -108, 64, -97, -121, -92, 104, -101, -125, -88, 101, -88
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -44, -55, 12, -35, -39, 49, 40, 48, -94, 89, 102, -102, 51, 31, -39, 61
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vv_16mf4_b64 (data1_v, data2_v, vl);
