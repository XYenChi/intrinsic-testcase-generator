...
int main(){
    const uint8_t data1[] = {
    227, 204, 56, 89, 239, 73, 125, 217, 229, 25, 132, 201, 27, 253, 79, 229
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    149, 227, 168, 53, 126, 53, 132, 234, 45, 128, 13, 46, 140, 161, 97, 11
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulu_vx_u8m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 228, 192, 109, 1, 0, 1, 90, 0, 128, 180, 30, 0, 29, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
