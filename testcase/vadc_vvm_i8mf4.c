...
int main(){
    const int8_t data1[] = {
    24, -66, -78, 63, 121, -59, 6, -111, -9, -68, 46, -107, 113, 85, 5, -65
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -80, -17, -79, -14, 71, 69, 22, -34, 34, 82, -77, -31, 109, -89, -106, -42
    };
    ...
    int8_t golden[] = {
    -56, -82, -156, 49, 193, 10, 28, -144, 26, 15, -31, -138, 223, -4, -101, -107
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
