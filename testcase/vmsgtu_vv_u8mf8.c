...
int main(){
    const uint8_t data1[] = {
    141, 233, 144, 1, 30, 93, 50, 200, 183, 13, 236, 226, 135, 32, 97, 101
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    70, 160, 0, 192, 33, 123, 22, 47, 165, 155, 109, 119, 27, 68, 12, 216
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_8mf8_b64 (data1_v, data2_v, vl);
