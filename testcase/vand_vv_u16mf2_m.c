...
int main(){
    ...
    139, 124, 141, 143, 251, 191, 133, 142, 27, 138, 198, 227, 229, 31, 27, 232
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    86, 101, 43, 75, 215, 113, 33, 30, 74, 73, 80, 158, 242, 39, 16, 163
    };
    ...
    uint16_t golden[] = {
    86, 0, 1, 0, 1, 113, 33, 30, 0, 73, 1, 1, 242, 1, 16, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
