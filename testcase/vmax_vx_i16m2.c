...
int main(){
    const int16_t data1[] = {
    112, -13, 35, 11, -123, 32, 11, -100, -30, -116, 21, -40, -123, -73, -84, 47
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -39, -66, -2, 44, 47, -52, -105, -68, 110, -110, 54, -83, 79, -119, 2, -63
    };
    ...
    int16_t golden[] = {
    112, 65523, 35, 44, 47, 32, 11, 65468, 110, 65426, 54, 65496, 79, 65463, 2, 47
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
