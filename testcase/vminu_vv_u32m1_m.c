...
int main(){
    ...
    144, 31, 73, 160, 128, 167, 226, 122, 196, 178, 154, 90, 217, 209, 148, 246
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    236, 49, 246, 153, 235, 221, 92, 149, 198, 19, 59, 76, 57, 36, 134, 104
    };
    ...
    uint32_t golden[] = {
    1, 0, 0, 160, 0, 1, 1, 1, 0, 178, 0, 90, 217, 209, 0, 246
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
