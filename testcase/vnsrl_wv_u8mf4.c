...
int main(){
    const uint8_t data1[] = {
    104, 67, 71, 167, 40, 146, 221, 6, 26, 19, 231, 62, 90, 43, 224, 2
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    108, 76, 240, 99, 243, 154, 5, 183, 32, 72, 221, 187, 82, 212, 10, 110
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_8mf4 (data1_v, shift, vl);
