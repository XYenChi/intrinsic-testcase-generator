...
int main(){
    ...
    46, 34, 195, 142, 219, 61, 72, 240, 9, 101, 232, 44, 128, 143, 220, 34
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    224, 107, 87, 103, 119, 16, 117, 123, 198, 250, 64, 143, 145, 10, 35, 6
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmacc_vx_u16m1_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    10305, 0, 0, 14627, 1, 976, 8425, 29521, 0, 25250, 14848, 1, 1, 0, 7700, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
