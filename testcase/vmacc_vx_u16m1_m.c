...
int main(){
    ...
    167, 219, 222, 19, 27, 98, 71, 211, 51, 41, 154, 30, 87, 89, 74, 216
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    43, 120, 54, 191, 238, 16, 69, 27, 6, 52, 43, 247, 181, 237, 247, 182
    };
    ...
    uint16_t golden[] = {
    1, 26281, 1, 3630, 6427, 1569, 0, 5697, 307, 2132, 0, 1, 15748, 0, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
