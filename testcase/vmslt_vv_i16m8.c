...
int main(){
    const int16_t data1[] = {
    63, -41, -115, 65, 80, 108, 102, 112, -36, 37, -120, 15, 106, -128, 25, 12
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -101, 87, 63, 79, 108, -113, -30, -15, -75, -86, 112, -30, -22, -41, -109, -127
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vv_16m8_b2 (data1_v, data2_v, vl);
