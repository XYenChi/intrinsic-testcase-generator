...
int main(){
    ...
    144, 127, 139, 161, 30, 21, 130, 197, 80, 217, 127, 149, 236, 67, 156, 79
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    38, 102, 33, 68, 66, 68, 82, 223, 112, 210, 81, 174, 147, 38, 156, 224
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u32m4_m (mask, data1_v, data2_v, vl);
