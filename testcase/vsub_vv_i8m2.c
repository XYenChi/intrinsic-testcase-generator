...
int main(){
    const int8_t data1[] = {
    13, 0, 146, 227, 1, 251, 21, 64, 164, 23, 247, 217, 207, 226, 210, 8
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    49, 152, 138, 158, 89, 199, 35, 149, 80, 97, 134, 19, 92, 82, 50, 201
    };
    ...
    int8_t golden[] = {
    -36, -152, 8, 69, -88, 52, -14, -85, 84, -74, 113, 198, 115, 144, 160, -193
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
