...
int main(){
    const uint8_t data1[] = {
    41, 236, 152, 140, 189, 46, 170, 173, 149, 131, 2, 79, 189, 175, 143, 113
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    202, 111, 120, 178, 8, 160, 176, 134, 151, 54, 169, 179, 88, 128, 22, 231
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i8m4 (data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    4, 0, 0, 1, 0, 3, 1, 0, 1, 0, 84, 2, 0, 0, 0, 2
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
