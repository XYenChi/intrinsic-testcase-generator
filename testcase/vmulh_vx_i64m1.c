...
int main(){
    const int64_t data1[] = {
    125, 15, 49, 118, -20, -36, -125, -73, -79, 52, -61, 109, -10, -105, 33, -53
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -8, -123, -126, 65, -111, 53, 92, -109, -6, 54, -102, 47, 97, -68, 36, -125
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vx_64m1_b64 (data1_v, data2_v, vl);
