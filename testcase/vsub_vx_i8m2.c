...
int main(){
    const int8_t data1[] = {
    145, 149, 46, 78, 93, 155, 160, 232, 11, 68, 74, 67, 149, 191, 200, 70
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    175, 192, 4, 184, 88, 118, 53, 149, 117, 108, 190, 100, 54, 104, 6, 140
    };
    ...
    int8_t golden[] = {
    -30, -43, 42, -106, 5, 37, 107, 83, -106, -40, -116, -33, 95, 87, 194, -70
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
