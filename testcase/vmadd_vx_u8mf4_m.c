...
int main(){
    const uint8_t data1[] = {
    240, 151, 164, 223, 96, 94, 89, 235, 248, 21, 179, 133, 25, 49, 231, 123
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    224, 50, 186, 54, 228, 31, 156, 219, 8, 185, 33, 29, 75, 87, 222, 204
    };
    ...
    uint8_t golden[] = {
    240, 201, 164, 223, 68, 94, 89, 235, 8, 21, 212, 29, 75, 87, 222, 204
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
