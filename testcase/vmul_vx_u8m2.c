...
int main(){
    const uint8_t data1[] = {
    218, 194, 166, 105, 169, 251, 189, 172, 95, 30, 123, 111, 130, 253, 248, 44
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    196, 41, 23, 142, 70, 34, 42, 158, 240, 203, 130, 109, 50, 31, 61, 97
    };
    ...
    uint8_t golden[] = {
    232, 18, 234, 62, 54, 86, 2, 40, 16, 202, 118, 67, 100, 163, 24, 172
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
