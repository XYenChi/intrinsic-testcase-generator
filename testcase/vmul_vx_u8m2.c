...
int main(){
    const uint8_t data1[] = {
    199, 72, 100, 104, 123, 28, 79, 197, 224, 0, 5, 138, 68, 90, 67, 29
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    133, 216, 246, 159, 160, 147, 132, 68, 244, 148, 16, 100, 108, 101, 181, 7
    };
    ...
    uint8_t golden[] = {
    99, 192, 24, 152, 224, 20, 188, 84, 128, 0, 80, 232, 176, 130, 95, 203
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
