...
int main(){
    ...
    243, 66, 108, 91, 66, 25, 45, 227, 54, 44, 137, 180, 92, 205, 162, 98
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    1, 149, 146, 185, 182, 47, 121, 195, 157, 84, 103, 126, 97, 253, 233, 61
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_16mf2_b32 (data1_v, data2_v, vl);
