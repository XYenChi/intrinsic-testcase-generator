...
int main(){
    const uint8_t data1[] = {
    155, 117, 10, 81, 28, 110, 175, 19, 189, 243, 2, 213, 175, 147, 22, 188
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    199, 101, 2, 222, 197, 217, 108, 136, 203, 247, 146, 164, 84, 188, 200, 148
    };
    ...
    uint8_t golden[] = {
    212, 0, 1, 115, 1, 1, 67, 1, 242, 1, 0, 49, 1, 147, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
