...
int main(){
    ...
    113, 35, 33, 211, 11, 201, 93, 251, 77, 15, 34, 94, 66, 196, 156, 233
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    224, 177, 101, 191, 224, 44, 132, 36, 206, 232, 225, 168, 126, 100, 8, 223
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u32mf2_m (mask, data1_v, data2_v, vl);
