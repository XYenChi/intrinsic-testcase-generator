...
int main(){
    const uint8_t data1[] = {
    47, 143, 133, 15, 148, 37, 245, 53, 242, 179, 37, 101, 191, 77, 67, 35
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    37, 127, 175, 146, 118, 40, 190, 63, 69, 45, 114, 38, 220, 118, 115, 197
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_8mf8_b64 (mask, data1_v, data2_v, vl);
