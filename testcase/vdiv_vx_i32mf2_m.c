...
int main(){
    const int32_t data1[] = {
    29, -26, 0, 32, 121, 33, 21, 36, 43, 92, 57, 61, -28, -83, 22, 55
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    92, 52, 14, -74, -97, 10, -8, -109, -40, -111, 59, -122, 20, -51, -36, 112
    };
    ...
    int32_t golden[] = {
    1, 4294967294, 4294967295, 0, 4294967295, 0, 0, 0, 4294967295, 4294967294, 1, 0, 0, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
