...
int main(){
    const int32_t data1[] = {
    -100, 17, 119, -79, 27, 81, 101, 27, 115, -91, 77, 108, -26, 55, -58, -44
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -90, 122, -63, 61, -23, 34, -14, -48, -32, -48, -70, 34, 27, 123, -23, -71
    };
    ...
    int32_t golden[] = {
    0, 7, 4294967295, 0, 4294967295, 0, 4294967295, 0, 4294967295, 1, 4294967295, 0, 0, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
