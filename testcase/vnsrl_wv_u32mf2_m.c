...
int main(){
    ...
    99, 250, 177, 158, 135, 253, 140, 82, 219, 86, 4, 199, 150, 183, 37, 66
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    169, 106, 255, 179, 205, 183, 17, 134, 69, 87, 238, 106, 73, 63, 119, 196
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_32mf2_m (mask, data1_v, shift, vl);
