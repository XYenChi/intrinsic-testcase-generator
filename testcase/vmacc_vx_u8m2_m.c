...
int main(){
    const uint8_t data1[] = {
    135, 41, 31, 229, 35, 120, 67, 255, 56, 203, 107, 240, 185, 79, 21, 119
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    204, 41, 23, 53, 70, 115, 229, 97, 211, 103, 223, 70, 225, 142, 173, 27
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmacc_vx_u8m2_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 0, 1, 106, 0, 233, 239, 159, 0, 173, 0, 161, 154, 0, 49, 141
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
