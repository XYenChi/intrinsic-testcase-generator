...
int main(){
    const uint8_t data1[] = {
    13, 34, 168, 129, 61, 70, 108, 167, 254, 9, 58, 235, 172, 235, 163, 41
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    49, 153, 136, 86, 209, 134, 147, 3, 173, 35, 221, 3, 142, 75, 254, 37
    };
    ...
    uint8_t golden[] = {
    126, 83, 65, 0, 0, 164, 5, 245, 167, 1, 1, 0, 105, 218, 187, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
