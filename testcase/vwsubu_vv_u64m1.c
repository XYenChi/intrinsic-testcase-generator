...
int main(){
    ...
    196, 35, 92, 150, 199, 200, 100, 136, 173, 140, 30, 18, 53, 182, 207, 205
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    97, 18, 114, 178, 11, 138, 235, 144, 245, 188, 134, 201, 16, 85, 31, 192
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u64m1 (data1_v, data2_v, vl);
