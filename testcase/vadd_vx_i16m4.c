...
int main(){
    const int16_t data1[] = {
    -112, 8, -23, 4, 48, 118, -106, -26, -80, 87, -122, 59, 30, 103, 127, -28
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    97, -7, -75, 53, -59, 30, 123, -32, 15, -53, -109, 63, -128, -52, 16, -44
    };
    ...
    int16_t golden[] = {
    65521, 1, 65438, 57, 65525, 148, 17, 65478, 65471, 34, 65305, 122, 65438, 51, 143, 65464
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
