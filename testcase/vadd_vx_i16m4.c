...
int main(){
    const int16_t data1[] = {
    49, -55, -47, 21, 2, -40, 21, -97, 10, -112, -18, 58, -67, 79, -58, 15
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -9, 103, 126, 31, 87, 59, 26, -69, -91, -102, -10, 89, 99, -122, 86, -82
    };
    ...
    int16_t golden[] = {
    40, 48, 79, 52, 89, 19, 47, 65370, 65455, 65322, 65508, 147, 32, 65493, 28, 65469
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
