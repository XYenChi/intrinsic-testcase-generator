...
int main(){
    const uint8_t data1[] = {
    45, 81, 50, 110, 58, 64, 162, 186, 187, 95, 42, 37, 30, 188, 251, 198
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    146, 249, 163, 114, 151, 148, 188, 211, 100, 232, 8, 112, 11, 119, 198, 167
    };
    ...
    uint8_t golden[] = {
    0, 74, 1, 224, 209, 0, 94, 141, 0, 1, 50, 0, 1, 51, 1, 109
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
