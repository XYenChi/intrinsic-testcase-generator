...
int main(){
    const int64_t data1[] = {
    53, -46, 46, -3, -86, 20, 109, -64, -86, -106, 96, -78, -64, 29, -61, -9
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -91, 5, 51, -72, 105, -8, -108, 5, 74, -123, -126, -18, -41, 43, -124, 110
    };
    ...
    int64_t golden[] = {
    144, 18446744073709551565, 0, 0, 18446744073709551425, 28, 1, 18446744073709551547, 18446744073709551456, 0, 0, 18446744073709551556, 18446744073709551593, 18446744073709551602, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
