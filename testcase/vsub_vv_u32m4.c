...
int main(){
    ...
    122, 148, 216, 62, 216, 209, 96, 45, 130, 188, 133, 198, 23, 239, 69, 66
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    128, 251, 239, 7, 182, 151, 164, 55, 249, 72, 205, 178, 27, 63, 156, 20
    };
    ...
    uint32_t golden[] = {
    4294967290, 4294967193, 4294967273, 55, 34, 58, 4294967228, 4294967286, 4294967177, 116, 4294967224, 20, 4294967292, 176, 4294967209, 46
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
