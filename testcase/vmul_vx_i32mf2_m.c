...
int main(){
    const int32_t data1[] = {
    123, -120, 15, -113, 121, 47, -42, 59, -3, 6, 24, -84, -42, 58, -15, 122
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -94, -123, -122, 98, 33, 127, 55, -122, -28, 72, 37, 101, 23, 87, -43, -106
    };
    ...
    int32_t golden[] = {
    1, 14760, 0, 1, 3993, 0, 4294964986, 4294960098, 84, 432, 888, 4294958812, 1, 0, 645, 4294954364
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
