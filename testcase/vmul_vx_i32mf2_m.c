...
int main(){
    const int32_t data1[] = {
    7, 108, 9, -69, -28, 79, -72, -22, -43, 15, 79, -65, -121, -91, 97, -110
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    5, -35, -41, -59, -15, 123, 50, 61, -62, -32, -123, 8, 0, -9, -102, -81
    };
    ...
    int32_t golden[] = {
    1, 1, 1, 0, 0, 9717, 0, 4294965954, 2666, 1, 4294957579, 1, 0, 1, 1, 8910
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
