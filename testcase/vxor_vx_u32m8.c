...
int main(){
    ...
    241, 61, 217, 149, 255, 48, 189, 13, 127, 25, 109, 34, 3, 172, 175, 160
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    204, 64, 141, 97, 73, 253, 80, 67, 87, 237, 46, 227, 174, 189, 192, 83
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u32m8 (data1_v, data2_v, vl);
