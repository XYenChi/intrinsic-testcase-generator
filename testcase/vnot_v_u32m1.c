...
int main(){
    ...
    184, 138, 208, 225, 41, 204, 246, 85, 56, 10, 222, 125, 211, 111, 120, 38
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnot_v_u32m1 (data1_v, vl);
    ...
    uint32_t golden[] = {
    -185, -139, -209, -226, -42, -205, -247, -86, -57, -11, -223, -126, -212, -112, -121, -39
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
