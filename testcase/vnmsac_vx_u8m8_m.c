...
int main(){
    const uint8_t data1[] = {
    30, 80, 204, 101, 250, 95, 197, 213, 221, 45, 110, 63, 214, 54, 139, 219
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    250, 101, 74, 183, 145, 84, 51, 93, 56, 59, 55, 38, 212, 80, 25, 101
    };
    ...
    uint8_t golden[] = {
    180, 1, 9, 205, 102, 212, 193, 1, 1, 161, 95, 167, 201, 32, 109, 154
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
