...
int main(){
    const int64_t data1[] = {
    125, -123, 39, 15, -98, 110, 36, 80, 70, -123, 90, 10, 52, -44, -62, 105
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    63, -51, 122, -77, -127, -2, -127, 104, -24, -5, -90, 19, 35, 45, -86, -74
    };
    ...
    int64_t golden[] = {
    7875, 1, 1, 18446744073709550462, 12446, 0, 18446744073709547045, 8320, 1, 0, 1, 190, 1, 18446744073709549637, 0, 18446744073709543847
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
