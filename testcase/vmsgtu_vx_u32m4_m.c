...
int main(){
    ...
    0, 171, 171, 38, 107, 102, 1, 53, 13, 208, 111, 231, 170, 49, 21, 43
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    81, 76, 109, 209, 214, 96, 79, 90, 234, 227, 140, 94, 46, 114, 108, 51
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_32m4_b8_m (mask, data1_v, data2_v, vl);
