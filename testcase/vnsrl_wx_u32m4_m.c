...
int main(){
    ...
    131, 148, 237, 169, 13, 231, 92, 103, 184, 206, 223, 88, 18, 234, 151, 160
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    37, 216, 128, 212, 215, 210, 113, 118, 238, 53, 162, 242, 30, 226, 210, 173
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_32m4_m (mask, data1_v, shift, vl);
