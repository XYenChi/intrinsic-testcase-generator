...
int main(){
    ...
    52, 240, 72, 163, 67, 183, 100, 50, 153, 9, 6, 194, 132, 130, 249, 150
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    170, 92, 43, 95, 25, 200, 123, 232, 172, 142, 149, 213, 213, 196, 218, 220
    };
    ...
    uint32_t golden[] = {
    0, 1, 29, 1, 42, 4294967279, 4294967273, 1, 0, 0, 0, 1, 0, 1, 0, 150
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
