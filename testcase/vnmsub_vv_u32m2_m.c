...
int main(){
    ...
    183, 197, 200, 210, 105, 237, 159, 177, 225, 111, 221, 195, 178, 89, 247, 66
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    98, 190, 228, 110, 132, 214, 81, 48, 240, 221, 245, 201, 227, 153, 141, 11
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsub_vv_u32m2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    183, 197, 4294967268, 100, 1, 23, 0, 0, 4294967281, 1, 4294967272, 4294967290, 0, 4294967232, 247, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
