...
int main(){
    const uint8_t data1[] = {
    216, 243, 97, 214, 133, 75, 118, 10, 187, 46, 99, 10, 228, 157, 210, 87
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    64, 86, 12, 232, 42, 25, 61, 180, 144, 26, 150, 33, 28, 174, 178, 98
    };
    ...
    uint8_t golden[] = {
    1, 0, 0, 18, 165, 1, 0, 170, 213, 1, 1, 23, 56, 17, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
