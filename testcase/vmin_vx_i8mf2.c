...
int main(){
    const int8_t data1[] = {
    -31, -58, -74, -16, -31, -21, -59, -128, -115, -79, -68, 3, 109, 72, -122, -77
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -118, 54, 53, 110, -47, 11, -75, 58, 17, 39, -65, 34, 97, -120, 30, 65
    };
    ...
    int8_t golden[] = {
    225, 54, 53, 110, 225, 11, 197, 58, 17, 39, 191, 34, 109, 72, 30, 65
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
