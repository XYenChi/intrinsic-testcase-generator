...
int main(){
    const int32_t data1[] = {
    138, 181, 167, 121, 1, 236, 162, 195, 165, 173, 235, 17, 18, 152, 59, 114
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    111, 73, 219, 243, 107, 246, 180, 77, 150, 97, 255, 85, 154, 8, 151, 212
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vv_ui32mf2 (data1_v, data2_v, vl);
    ...
    int32_t golden[] = {
    27, 108, 0, 0, 0, 0, 0, 118, 15, 76, 0, 0, 0, 144, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
