...
int main(){
    ...
    149, 133, 40, 212, 148, 110, 231, 145, 23, 114, 190, 215, 202, 81, 195, 158
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    38, 100, 255, 93, 78, 81, 107, 69, 194, 92, 70, 33, 14, 227, 44, 228
    };
    ...
    uint64_t golden[] = {
    0, 18446744073709538317, 1, 18446744073709531901, 1, 18446744073709542707, 0, 18446744073709541611, 18446744073709547154, 18446744073709541128, 1, 18446744073709544522, 0, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
