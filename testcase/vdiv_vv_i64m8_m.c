...
int main(){
    const int64_t data1[] = {
    -9, 35, 60, -103, 33, -101, -111, 69, 101, 27, -13, 3, 79, -55, -12, 107
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    71, -73, 42, -12, -25, 88, -88, -87, 116, 27, 17, -8, -104, -84, 79, -64
    };
    ...
    int64_t golden[] = {
    1, 1, 0, 0, 0, 1, 0, 18446744073709551614, 1, 1, 18446744073709551614, 0, 18446744073709551614, 1, 1, 18446744073709551615
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
