...
int main(){
    ...
    171, 172, 200, 104, 177, 125, 183, 119, 119, 242, 3, 82, 121, 194, 169, 39
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    184, 156, 59, 175, 173, 42, 181, 252, 27, 63, 67, 107, 155, 62, 37, 216
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u32m8 (data1_v, shift, vl);
