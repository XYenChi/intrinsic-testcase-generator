...
int main(){
    const int64_t data1[] = {
    -58, 127, 123, 16, -85, -99, -106, -94, -62, 41, 74, -122, 32, 87, 94, -109
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    28, 85, 31, 76, 94, -123, 63, -10, -70, -16, -46, -54, 62, -50, 118, 123
    };
    ...
    int64_t golden[] = {
    1, 1, 3813, 0, 18446744073709543626, 0, 18446744073709544939, 941, 4341, 0, 18446744073709548212, 1, 1985, 1, 0, 18446744073709538209
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
