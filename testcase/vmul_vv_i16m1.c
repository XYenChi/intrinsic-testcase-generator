...
int main(){
    const int16_t data1[] = {
    -29, 92, 22, 113, -82, -123, 96, 49, -80, 85, -92, -46, 46, 125, 21, 95
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -48, 105, -10, 60, -49, 107, -31, 120, 7, 69, 127, -73, 124, -32, -44, 65
    };
    ...
    int16_t golden[] = {
    1392, 9660, 65316, 6780, 4018, 52375, 62560, 5880, 64976, 5865, 53852, 3358, 5704, 61536, 64612, 6175
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
