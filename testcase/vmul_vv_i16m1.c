...
int main(){
    const int16_t data1[] = {
    -124, 8, -109, -39, -112, 19, 101, -51, -31, 24, -67, -5, 106, 124, -99, 3
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -117, 127, -45, 88, 103, -102, 68, 77, -128, -52, 94, -105, 24, 55, 104, -77
    };
    ...
    int16_t golden[] = {
    14508, 1016, 4905, 62104, 54000, 63598, 6868, 61609, 3968, 64288, 59238, 525, 2544, 6820, 55240, 65305
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
