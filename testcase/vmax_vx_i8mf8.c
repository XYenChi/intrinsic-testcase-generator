...
int main(){
    const int8_t data1[] = {
    106, 16, 205, 128, 161, 122, 178, 49, 116, 209, 202, 204, 251, 59, 105, 196
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    118, 148, 152, 101, 100, 59, 210, 89, 133, 31, 164, 51, 125, 232, 69, 217
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmax_vx_i8mf8 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    118, 148, 205, 128, 161, 122, 210, 89, 133, 209, 202, 204, 251, 232, 105, 217
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
