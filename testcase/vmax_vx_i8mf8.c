...
int main(){
    const int8_t data1[] = {
    -77, -20, 94, 43, 109, -98, 85, -67, -18, -42, 102, 87, -63, 37, 24, -37
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    26, 53, 70, -32, 60, -35, 79, 51, 62, -95, -42, 114, 8, -101, 36, -126
    };
    ...
    int8_t golden[] = {
    26, 53, 94, 43, 109, 221, 85, 51, 62, 214, 102, 114, 8, 37, 36, 219
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
