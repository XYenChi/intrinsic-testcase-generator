...
int main(){
    ...
    179, 138, 117, 160, 224, 112, 31, 250, 57, 62, 252, 103, 19, 182, 150, 205
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    209, 136, 137, 103, 156, 222, 99, 195, 166, 123, 128, 240, 21, 118, 115, 10
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i32mf2 (data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    1, 0, 1, 0, 0, 1, 3, 0, 2, 1, 0, 2, 1, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
