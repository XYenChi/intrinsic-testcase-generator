...
int main(){
    ...
    78, 37, 220, 141, 41, 144, 124, 194, 111, 146, 246, 114, 67, 27, 62, 219
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    252, 106, 53, 120, 46, 121, 32, 178, 113, 21, 50, 92, 139, 232, 220, 156
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_16mf2_b32 (data1_v, data2_v, vl);
