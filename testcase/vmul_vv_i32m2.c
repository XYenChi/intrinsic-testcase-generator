...
int main(){
    const int32_t data1[] = {
    -81, -50, -110, 103, 73, -9, -6, -63, -106, 41, 57, 73, -102, -96, -53, 102
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -56, 26, -95, -83, 107, 39, -98, 16, 122, 124, 64, 28, 65, 122, -46, -39
    };
    ...
    int32_t golden[] = {
    4536, 4294965996, 10450, 4294958747, 7811, 4294966945, 588, 4294966288, 4294954364, 5084, 3648, 2044, 4294960666, 4294955584, 2438, 4294963318
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
