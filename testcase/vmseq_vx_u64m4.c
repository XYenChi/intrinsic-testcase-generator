...
int main(){
    ...
    126, 124, 23, 21, 36, 32, 87, 154, 136, 5, 200, 129, 92, 232, 152, 223
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    219, 67, 236, 209, 157, 1, 17, 215, 198, 230, 174, 105, 37, 171, 223, 206
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_64m4_b16 (data1_v, data2_v, vl);
