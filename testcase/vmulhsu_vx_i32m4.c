...
int main(){
    const int32_t data1[] = {
    123, -64, -31, -12, 73, -35, -72, 86, -91, -90, 92, 117, -105, 89, 70, 110
    };
    const int32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    118, 21, 44, 42, 245, 144, 41, 110, 207, 202, 171, 88, 62, 99, 160, 189
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_32m4_b8 (data1_v, data2_v, vl);
