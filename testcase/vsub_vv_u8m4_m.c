...
int main(){
    const uint8_t data1[] = {
    128, 207, 75, 48, 38, 212, 10, 163, 29, 16, 177, 212, 17, 185, 71, 123
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    123, 85, 165, 148, 216, 66, 53, 35, 33, 24, 54, 105, 41, 218, 135, 55
    };
    ...
    uint8_t golden[] = {
    0, 122, 166, 156, 1, 146, 213, 0, 0, 248, 123, 107, 1, 223, 192, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
