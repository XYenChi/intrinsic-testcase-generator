...
int main(){
    ...
    123, 186, 232, 229, 211, 14, 172, 137, 20, 251, 11, 158, 31, 75, 220, 229
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    195, 33, 118, 20, 120, 136, 179, 66, 235, 83, 23, 100, 110, 32, 249, 217
    };
    ...
    uint64_t golden[] = {
    0, 0, 232, 0, 211, 1, 0, 71, 1, 168, 11, 1, 1, 43, 220, 229
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
