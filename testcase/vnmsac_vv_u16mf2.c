...
int main(){
    ...
    174, 249, 188, 32, 118, 170, 63, 35, 24, 122, 190, 61, 220, 250, 251, 20
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    248, 6, 125, 95, 139, 48, 32, 185, 203, 152, 30, 131, 122, 182, 182, 226
    };
    ...
    uint16_t golden[] = {
    22384, 64043, 42036, 62497, 49134, 57377, 63520, 59062, 60665, 46992, 59836, 57545, 38697, 20036, 19855, 61017
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
