...
int main(){
    const int32_t data1[] = {
    43, -50, -79, -5, 12, 20, -68, 38, -56, -122, -5, 39, 12, 44, -5, -44
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -45, 120, 12, 3, 87, -66, 39, -108, -35, -66, 51, -66, 113, -84, -48, -52
    };
    ...
    int32_t golden[] = {
    1, 0, 4294967229, 4294967294, 0, 0, 1, 1, 1, 1, 4294967292, 1, 5, 1, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
