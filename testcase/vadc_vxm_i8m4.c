...
int main(){
    const int8_t data1[] = {
    37, 91, 35, 42, 5, 86, 25, -59, -27, 111, -57, -38, -112, -23, 79, -124
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -126, 103, 107, -57, -88, -123, -114, -19, -43, -15, 50, 93, -46, -32, 19, -63
    };
    ...
    int8_t golden[] = {
    -88, 194, 143, -14, -82, -36, -89, -78, -69, 97, -7, 55, -157, -54, 99, -186
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
