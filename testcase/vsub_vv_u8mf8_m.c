...
int main(){
    const uint8_t data1[] = {
    199, 146, 142, 124, 118, 217, 39, 100, 154, 119, 0, 239, 53, 104, 186, 131
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    46, 120, 232, 219, 157, 233, 195, 251, 193, 179, 56, 78, 236, 174, 142, 132
    };
    ...
    uint8_t golden[] = {
    0, 26, 166, 0, 217, 0, 0, 105, 0, 0, 1, 1, 0, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
