...
int main(){
    const uint8_t data1[] = {
    153, 77, 102, 214, 115, 248, 110, 178, 60, 244, 88, 69, 85, 19, 206, 246
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    12, 49, 32, 86, 86, 37, 237, 191, 76, 130, 196, 37, 153, 229, 203, 36
    };
    ...
    uint8_t golden[] = {
    141, 0, 70, 128, 1, 211, 129, 1, 1, 114, 0, 32, 1, 1, 1, 210
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
