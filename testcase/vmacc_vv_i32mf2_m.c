...
int main(){
    const int32_t data1[] = {
    33, 77, 127, -32, -109, 104, 54, 119, 89, -36, 122, 59, -53, 13, -56, 95
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    92, 89, 26, -102, -97, -70, -22, 110, 18, 118, -127, -27, -111, -93, -45, 95
    };
    ...
    int32_t golden[] = {
    3037, 1, 0, 0, 10573, 4294960016, 4294966109, 13090, 0, 4294963049, 1, 1, 5884, 4294966087, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
