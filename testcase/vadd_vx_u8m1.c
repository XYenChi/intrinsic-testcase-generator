...
int main(){
    const int8_t data1[] = {
    212, 251, 196, 70, 133, 155, 29, 122, 166, 89, 77, 35, 195, 119, 139, 228
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    23, 183, 27, 123, 139, 48, 30, 68, 187, 140, 144, 216, 8, 64, 144, 220
    };
    ...
    int8_t golden[] = {
    235, 178, 223, 193, 16, 203, 59, 190, 97, 229, 221, 251, 203, 183, 27, 192
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
