...
int main(){
    const uint8_t data1[] = {
    205, 74, 108, 176, 1, 214, 252, 127, 126, 204, 113, 112, 255, 210, 101, 215
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    142, 36, 69, 127, 167, 154, 187, 0, 176, 31, 153, 61, 74, 103, 111, 224
    };
    ...
    uint8_t golden[] = {
    91, 110, 177, 47, 168, 112, 183, 127, 46, 235, 10, 173, 73, 57, 212, 183
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
