...
int main(){
    const uint8_t data1[] = {
    22, 168, 124, 14, 223, 13, 75, 74, 39, 23, 79, 207, 229, 229, 30, 19
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    145, 181, 204, 219, 229, 82, 250, 11, 152, 135, 96, 117, 139, 136, 74, 254
    };
    ...
    uint8_t golden[] = {
    167, 93, 72, 233, 196, 95, 69, 85, 191, 158, 175, 68, 112, 109, 104, 17
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
