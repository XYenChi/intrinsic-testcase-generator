...
int main(){
    const int8_t data1[] = {
    80, -110, -65, 8, 72, -5, 77, -5, 50, 122, 62, 104, 9, 79, -68, 21
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -17, -62, -102, -45, -44, 57, -79, 11, -111, 58, 34, -43, 114, -72, 103, 109
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vv_8m4_b2_m (mask, data1_v, data2_v, vl);
