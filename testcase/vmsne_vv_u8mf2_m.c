...
int main(){
    const uint8_t data1[] = {
    127, 174, 172, 148, 213, 150, 216, 155, 247, 42, 252, 235, 148, 127, 218, 107
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    0, 250, 204, 201, 117, 164, 77, 88, 35, 68, 43, 31, 209, 39, 128, 232
    };
    const uint8_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e8mf2(avl);
    const uint out_data[] = {
    0, 1, 1, 0, 1, 0, 0, 0, 1, 0, 1, 1, 0, 1, 0, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_8mf2_b16_m (mask, data1_v, data2_v, vl);
