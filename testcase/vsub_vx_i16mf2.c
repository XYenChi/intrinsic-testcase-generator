...
int main(){
    const int16_t data1[] = {
    56, 103, -128, 47, 81, 73, -25, 99, -52, 109, 33, 107, 85, -28, -121, 10
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -35, -115, 117, 6, -35, -98, -25, -56, -127, 23, -74, 80, 85, -85, 97, 32
    };
    ...
    int16_t golden[] = {
    91, 218, 65291, 41, 116, 171, 0, 155, 75, 86, 107, 27, 0, 57, 65318, 65514
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
