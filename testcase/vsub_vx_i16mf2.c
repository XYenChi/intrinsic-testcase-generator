...
int main(){
    const int16_t data1[] = {
    -83, 4, 65, 115, 42, -3, 64, 67, -49, -81, 125, -122, 11, 90, -30, -54
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    20, 111, -37, 85, 22, -74, -83, -127, -71, -98, -15, 60, -34, -27, 73, -120
    };
    ...
    int16_t golden[] = {
    -103, -107, 102, 30, 20, 71, 127, 127, 22, 17, 127, -128, 45, 117, -103, 66
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
