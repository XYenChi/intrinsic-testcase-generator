...
int main(){
    ...
    132, 116, 6, 233, 95, 107, 145, 19, 238, 171, 61, 210, 60, 49, 215, 118
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    155, 192, 50, 80, 131, 122, 215, 178, 45, 126, 147, 223, 7, 191, 168, 212
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u16m4_m (mask, data1_v, data2_v, vl);
