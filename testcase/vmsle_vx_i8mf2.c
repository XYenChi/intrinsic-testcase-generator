...
int main(){
    const int8_t data1[] = {
    -66, 122, 17, -14, -3, -88, 17, -112, 75, -43, -22, 31, 46, 50, 125, -39
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    16, 10, -86, 23, -107, -57, -120, 53, -126, -94, -113, 73, -120, -99, 67, 120
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vx_8mf2_b16 (data1_v, data2_v, vl);
