...
int main(){
    const int64_t data1[] = {
    -42, 9, -6, 41, -2, 80, -29, -13, -6, -19, -111, -39, -4, -109, -113, -89
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    16, -62, -26, 117, -88, -113, -49, -52, -24, -125, 44, 86, 100, -110, 102, -66
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vx_64m4_b16 (mask, data1_v, data2_v, vl);
