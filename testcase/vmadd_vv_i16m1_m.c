...
int main(){
    const int16_t data1[] = {
    -92, -2, -105, 101, -51, 113, -10, 40, -116, 119, -87, 36, -108, 88, -109, -44
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -8, -6, 121, 68, -1, 76, 23, 79, 83, 79, -116, 78, 55, -86, 61, 6
    };
    ...
    int16_t golden[] = {
    65444, 65528, 16, 68, 65535, 189, 65526, 119, 65420, 198, 65420, 78, 65428, 65450, 65488, 65498
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
