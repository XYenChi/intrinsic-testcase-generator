...
int main(){
    const int8_t data1[] = {
    199, 46, 247, 12, 103, 77, 128, 64, 72, 113, 217, 203, 41, 245, 98, 126
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    27, 118, 85, 114, 38, 161, 9, 198, 150, 13, 59, 147, 176, 164, 184, 54
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsbc_vx_i8m8 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    172, -72, 162, -102, 65, -84, 119, -134, -78, 100, 158, 56, -135, 81, -86, 72
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
