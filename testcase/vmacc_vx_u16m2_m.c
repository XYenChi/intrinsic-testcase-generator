...
int main(){
    ...
    205, 87, 179, 26, 18, 151, 133, 67, 48, 167, 221, 234, 175, 249, 223, 41
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    238, 85, 191, 25, 47, 236, 123, 226, 54, 44, 20, 241, 7, 93, 176, 112
    };
    ...
    uint16_t golden[] = {
    1, 1, 34189, 0, 847, 35636, 0, 1, 0, 0, 1, 0, 0, 23158, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
