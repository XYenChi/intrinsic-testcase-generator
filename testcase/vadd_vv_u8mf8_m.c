...
int main(){
    const uint8_t data1[] = {
    158, 31, 125, 219, 222, 75, 172, 221, 190, 231, 220, 100, 62, 158, 169, 54
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    240, 199, 251, 111, 160, 9, 166, 215, 243, 171, 191, 173, 94, 219, 112, 65
    };
    ...
    uint8_t golden[] = {
    142, 230, 0, 74, 0, 84, 82, 1, 1, 1, 155, 17, 156, 0, 25, 119
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
