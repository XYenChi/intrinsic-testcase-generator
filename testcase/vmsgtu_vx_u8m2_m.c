...
int main(){
    const uint8_t data1[] = {
    12, 227, 165, 9, 177, 251, 64, 157, 19, 71, 194, 175, 190, 138, 185, 146
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    192, 232, 182, 199, 234, 59, 107, 129, 155, 250, 74, 130, 121, 89, 180, 29
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_8m2_b4_m (mask, data1_v, data2_v, vl);
