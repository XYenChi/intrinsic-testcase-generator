...
int main(){
    const int16_t data1[] = {
    56, 113, 44, -91, 32, -116, 126, 79, -20, -128, 25, 59, 83, -4, 44, -100
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    63, -92, -125, -46, 14, 80, 23, 72, 47, 68, -68, -41, 39, 107, 87, -27
    };
    ...
    int16_t golden[] = {
    3528, 55140, 1, 1, 448, 56256, 1, 0, 0, 56832, 1, 63117, 3237, 65108, 3828, 2700
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
