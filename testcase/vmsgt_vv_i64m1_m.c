...
int main(){
    const int64_t data1[] = {
    -52, -101, -116, -7, -16, -85, -18, -44, -9, 125, -23, -114, 97, -21, 24, 23
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -54, -51, -88, 3, -15, 116, -108, -59, -92, -100, 100, 13, -65, 45, 81, -61
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vv_64m1_b64_m (mask, data1_v, data2_v, vl);
