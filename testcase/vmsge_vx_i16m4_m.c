...
int main(){
    const int16_t data1[] = {
    76, 120, -115, -23, -58, -117, -23, -104, -56, 112, -29, -61, 76, -114, -71, -8
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -54, -125, -32, 90, 45, 11, 21, 109, 116, -107, -115, -12, -75, -21, 108, 94
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_16m4_b4_m (mask, data1_v, data2_v, vl);
