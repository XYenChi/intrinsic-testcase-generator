...
int main(){
    const uint8_t data1[] = {
    107, 29, 32, 23, 4, 11, 243, 82, 20, 151, 208, 57, 75, 133, 180, 140
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    171, 236, 219, 156, 14, 95, 203, 73, 29, 250, 49, 54, 90, 165, 212, 94
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u8mf4_m (mask, data1_v, data2_v, vl);
