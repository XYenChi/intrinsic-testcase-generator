...
int main(){
    ...
    206, 123, 96, 7, 141, 47, 56, 144, 72, 249, 7, 41, 117, 141, 124, 239
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    127, 20, 138, 165, 121, 53, 137, 155, 252, 53, 158, 177, 164, 245, 8, 143
    };
    ...
    uint64_t golden[] = {
    1, 18446744073709549157, 18446744073709538369, 1, 18446744073709534555, 18446744073709549125, 18446744073709543944, 0, 18446744073709533472, 1, 1, 1, 18446744073709532429, 1, 18446744073709550624, 18446744073709517439
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
