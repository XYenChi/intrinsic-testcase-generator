...
int main(){
    const int32_t data1[] = {
    -29, 32, -89, 39, -13, 100, 30, -4, 89, -31, 43, -100, 5, -74, 119, 87
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -3, -73, 88, -53, -37, -24, 122, -112, 90, -113, 100, 16, -118, -103, 22, 14
    };
    ...
    int32_t golden[] = {
    4294967264, 4294967255, 4294967295, 4294967282, 4294967246, 76, 152, 4294967180, 179, 4294967152, 143, 4294967212, 4294967183, 4294967119, 141, 101
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
