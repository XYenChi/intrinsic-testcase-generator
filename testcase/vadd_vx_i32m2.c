...
int main(){
    const int32_t data1[] = {
    42, -2, -118, 63, -55, -116, -1, 102, 91, 123, 114, 58, 119, -9, -41, 40
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    22, -120, 42, 26, -98, 127, 50, -126, 37, 76, -12, 92, -109, 67, 54, -71
    };
    ...
    int32_t golden[] = {
    64, -122, -76, 89, -128, 11, 49, -24, 127, 127, 102, 127, 10, 58, 13, -31
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
