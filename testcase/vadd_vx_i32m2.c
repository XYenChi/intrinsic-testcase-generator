...
int main(){
    const int32_t data1[] = {
    0, 69, 6, 115, -125, -63, 56, 73, -59, -21, 8, -115, 29, 35, 9, 117
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    50, 20, -101, -110, -14, 17, -60, 118, 118, 46, -12, 93, 91, 91, 3, 5
    };
    ...
    int32_t golden[] = {
    50, 89, 4294967201, 5, 4294967157, 4294967250, 4294967292, 191, 59, 25, 4294967292, 4294967274, 120, 126, 12, 122
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
