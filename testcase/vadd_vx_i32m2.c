...
int main(){
    const int32_t data1[] = {
    118, -77, 106, -94, 89, -109, 25, 54, -93, -117, 67, 59, 90, 98, -106, 15
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    100, 119, -27, 120, -103, 85, 105, -97, -13, 26, 35, 36, 31, 117, 50, -116
    };
    ...
    int32_t golden[] = {
    218, 42, 79, 26, 4294967282, 4294967272, 130, 4294967253, 4294967190, 4294967205, 102, 95, 121, 215, 4294967240, 4294967195
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
