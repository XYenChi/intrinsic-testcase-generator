...
int main(){
    ...
    199, 84, 163, 191, 62, 63, 35, 67, 240, 109, 118, 240, 140, 150, 136, 98
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    174, 243, 107, 251, 233, 85, 189, 34, 128, 221, 114, 212, 228, 180, 79, 86
    };
    const uint16_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e16m2(avl);
    const uint out_data[] = {
    0, 0, 1, 1, 0, 1, 0, 0, 1, 1, 1, 1, 0, 1, 1, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u16m2_m (mask, data1_v, data2_v, vl);
