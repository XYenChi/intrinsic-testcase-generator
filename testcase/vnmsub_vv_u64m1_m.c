...
int main(){
    ...
    213, 15, 183, 1, 131, 183, 218, 80, 155, 94, 204, 130, 230, 233, 159, 28
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    111, 167, 245, 56, 26, 213, 118, 7, 192, 139, 177, 165, 75, 146, 43, 181
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsub_vv_u64m1_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    1, 18446744073709551464, 1, 0, 105, 183, 0, 1, 155, 94, 0, 130, 155, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
