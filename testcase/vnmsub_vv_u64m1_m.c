...
int main(){
    ...
    237, 0, 133, 25, 111, 47, 91, 126, 126, 158, 64, 102, 133, 183, 165, 75
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    102, 206, 92, 12, 212, 139, 128, 25, 36, 39, 225, 68, 108, 52, 143, 200
    };
    ...
    uint64_t golden[] = {
    0, 1, 0, 13, 111, 47, 0, 0, 90, 119, 64, 1, 133, 131, 0, 18446744073709551491
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
