...
int main(){
    const uint8_t data1[] = {
    191, 98, 157, 145, 116, 91, 18, 181, 168, 166, 52, 228, 40, 195, 252, 42
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    218, 168, 255, 87, 210, 232, 208, 208, 69, 131, 194, 117, 231, 74, 252, 127
    };
    ...
    uint8_t golden[] = {
    0, 168, 255, 1, 0, 1, 208, 208, 168, 1, 0, 1, 1, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
