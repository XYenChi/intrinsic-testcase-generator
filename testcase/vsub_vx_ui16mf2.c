...
int main(){
    const int16_t data1[] = {
    188, 1, 71, 202, 119, 109, 49, 107, 243, 180, 29, 4, 35, 227, 103, 181
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    215, 116, 213, 112, 63, 9, 243, 206, 212, 95, 191, 195, 98, 131, 55, 200
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vx_ui16mf2 (data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    0, 0, 0, 90, 56, 100, 0, 0, 31, 85, 0, 0, 0, 96, 48, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
