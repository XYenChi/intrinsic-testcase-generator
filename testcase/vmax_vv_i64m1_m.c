...
int main(){
    const int64_t data1[] = {
    26, -65, 109, -98, -79, -95, -82, -110, -99, 4, -15, -41, -25, 27, -121, -33
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    77, -128, 93, 3, -90, 6, 109, 83, -27, 113, 109, -93, 33, -31, 13, 55
    };
    ...
    int64_t golden[] = {
    0, 18446744073709551551, 109, 3, 1, 0, 1, 83, 0, 113, 0, 18446744073709551575, 33, 0, 13, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
