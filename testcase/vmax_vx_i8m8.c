...
int main(){
    const int8_t data1[] = {
    42, 120, -48, 31, -26, -59, 24, 40, -116, -60, -22, -91, 20, 19, -120, -121
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    113, 110, -95, -66, 122, -93, -20, -90, 2, -125, -10, -110, 62, 28, -69, 92
    };
    ...
    int8_t golden[] = {
    113, 120, 208, 31, 122, 197, 24, 40, 2, 196, 246, 165, 62, 28, 187, 92
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
