...
int main(){
    const int8_t data1[] = {
    9, -21, 10, -35, 38, -56, -35, 100, -106, 67, 60, 39, -78, 41, 66, -34
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -55, -27, 87, 109, -86, 42, -16, 17, 100, 119, -65, 39, 61, -72, 53, 93
    };
    ...
    int8_t golden[] = {
    9, 235, 87, 109, 38, 42, 240, 100, 100, 119, 60, 39, 61, 41, 66, 93
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
