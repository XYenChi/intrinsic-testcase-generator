...
int main(){
    const int32_t data1[] = {
    41, 97, 45, -60, 33, -80, 32, 91, 87, 109, -77, -54, 9, -69, 52, 28
    };
    const int32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    51, 193, 5, 95, 179, 196, 144, 3, 190, 248, 65, 7, 127, 139, 35, 185
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_32m2_b16 (data1_v, data2_v, vl);
