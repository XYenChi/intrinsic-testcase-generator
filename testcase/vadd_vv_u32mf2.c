...
int main(){
    const int32_t data1[] = {
    5, 75, 71, 132, 51, 247, 174, 64, 20, 222, 130, 143, 217, 223, 194, 180
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    176, 52, 136, 94, 110, 36, 51, 144, 186, 243, 141, 188, 7, 34, 231, 229
    };
    ...
    int32_t golden[] = {
    181, 127, 207, 226, 161, 283, 225, 208, 206, 465, 271, 331, 224, 257, 425, 409
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
