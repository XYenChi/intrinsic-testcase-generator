...
int main(){
    ...
    188, 90, 116, 70, 213, 197, 157, 147, 88, 89, 217, 58, 200, 11, 163, 32
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    107, 117, 57, 255, 240, 173, 203, 40, 247, 253, 8, 235, 18, 205, 174, 247
    };
    ...
    uint32_t golden[] = {
    295, 207, 173, 325, 453, 370, 360, 187, 335, 342, 225, 293, 218, 216, 337, 279
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
