...
int main(){
    ...
    150, 218, 153, 168, 100, 111, 80, 193, 239, 29, 83, 152, 111, 102, 117, 162
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    59, 64, 252, 73, 133, 169, 226, 209, 199, 43, 131, 43, 55, 120, 163, 239
    };
    ...
    uint32_t golden[] = {
    209, 282, 405, 241, 233, 280, 306, 402, 438, 72, 214, 195, 166, 222, 280, 401
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
