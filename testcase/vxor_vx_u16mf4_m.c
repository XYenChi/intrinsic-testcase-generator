...
int main(){
    ...
    34, 15, 122, 176, 121, 245, 76, 155, 173, 22, 148, 29, 137, 223, 127, 108
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    95, 246, 50, 42, 60, 69, 246, 60, 78, 161, 86, 117, 39, 79, 31, 69
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u16mf4_m (mask, data1_v, data2_v, vl);
