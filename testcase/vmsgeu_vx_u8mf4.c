...
int main(){
    const uint8_t data1[] = {
    82, 182, 78, 232, 182, 153, 135, 174, 75, 123, 148, 136, 35, 10, 99, 77
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    31, 32, 32, 2, 186, 25, 72, 81, 248, 130, 134, 21, 19, 113, 29, 248
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_8mf4_b32 (data1_v, data2_v, vl);
