...
int main(){
    const uint8_t data1[] = {
    29, 70, 184, 140, 236, 206, 141, 74, 84, 143, 8, 228, 87, 115, 169, 81
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    146, 214, 52, 45, 8, 32, 161, 170, 30, 147, 1, 142, 149, 121, 202, 105
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_8m4 (data1_v, shift, vl);
