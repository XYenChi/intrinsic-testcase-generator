...
int main(){
    ...
    107, 24, 74, 27, 31, 191, 180, 71, 153, 217, 74, 141, 102, 71, 250, 229
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    15, 188, 218, 243, 207, 184, 103, 202, 69, 209, 69, 69, 169, 221, 94, 37
    };
    ...
    uint64_t golden[] = {
    1, 0, 218, 243, 1, 191, 180, 1, 153, 217, 74, 0, 169, 221, 250, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
