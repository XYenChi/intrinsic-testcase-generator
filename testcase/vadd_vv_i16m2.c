...
int main(){
    const int16_t data1[] = {
    109, 106, 44, 73, 103, -71, 33, -7, -90, 122, -123, -50, -48, 103, 104, 26
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -115, 124, 15, 122, 113, 90, 120, -106, 40, 113, 88, -113, -84, -94, 111, 94
    };
    ...
    int16_t golden[] = {
    65530, 230, 59, 195, 216, 19, 153, 65423, 65486, 235, 65501, 65373, 65404, 9, 215, 120
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
