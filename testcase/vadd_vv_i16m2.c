...
int main(){
    const int16_t data1[] = {
    61, 84, -20, -13, -75, 35, -52, 43, 73, -10, -75, 26, -4, 32, -71, -43
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -10, 55, 30, 47, 85, -22, 35, -89, 42, -69, 115, 66, 94, -45, 127, -53
    };
    ...
    int16_t golden[] = {
    51, 139, 10, 34, 10, 13, 65519, 65490, 115, 65457, 40, 92, 90, 65523, 56, 65440
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
