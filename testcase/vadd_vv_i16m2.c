...
int main(){
    const int16_t data1[] = {
    -17, 42, -48, -61, -109, 108, 6, 124, -37, 48, -42, 3, -24, -39, -36, 114
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    34, 88, -92, 126, 78, -108, -117, 3, 40, -13, 4, -122, -75, 67, 119, 118
    };
    ...
    int16_t golden[] = {
    17, 130, 65396, 65, 65505, 0, 65425, 127, 3, 35, 65498, 65417, 65437, 28, 83, 232
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
