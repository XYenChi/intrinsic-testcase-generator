...
int main(){
    ...
    200, 120, 30, 80, 214, 101, 208, 5, 132, 19, 13, 75, 34, 41, 136, 121
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    190, 251, 198, 123, 132, 171, 20, 138, 195, 215, 155, 241, 185, 221, 77, 194
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_16m4_m (mask, data1_v, shift, vl);
