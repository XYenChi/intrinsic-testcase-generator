...
int main(){
    const int16_t data1[] = {
    -99, 59, 46, -113, -104, 103, -77, 12, -25, -56, -105, -78, -37, -77, 64, 85
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    17, -123, -52, -34, -110, 9, -103, 23, -55, -54, 87, 23, -109, 101, -67, 58
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_16m4_b4 (data1_v, data2_v, vl);
