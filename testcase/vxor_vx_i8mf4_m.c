...
int main(){
    const int8_t data1[] = {
    -17, 86, 105, -123, 50, 60, -35, 22, 20, 89, 13, 120, -52, -17, -10, 38
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    43, 119, 86, -89, 87, -119, -1, 102, 32, -96, -52, 28, -70, -17, -73, 106
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_i8mf4_m (mask, data1_v, data2_v, vl);
