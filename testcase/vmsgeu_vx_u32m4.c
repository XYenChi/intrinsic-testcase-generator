...
int main(){
    ...
    2, 80, 81, 218, 34, 224, 113, 81, 74, 87, 253, 232, 37, 94, 96, 122
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    247, 247, 95, 7, 114, 29, 113, 18, 8, 78, 149, 47, 177, 70, 157, 124
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_32m4_b8 (data1_v, data2_v, vl);
