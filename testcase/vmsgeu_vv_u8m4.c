...
int main(){
    const uint8_t data1[] = {
    239, 98, 20, 173, 126, 85, 250, 29, 229, 45, 230, 222, 224, 165, 217, 236
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    246, 8, 175, 116, 23, 73, 25, 238, 29, 237, 98, 40, 186, 132, 97, 248
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_8m4_b2 (data1_v, data2_v, vl);
