...
int main(){
    const int32_t data1[] = {
    4, 127, 64, 100, -25, -106, 87, -109, -81, 126, -99, 117, 95, 38, -9, -32
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -103, 12, 124, 25, 112, -70, 119, 68, -82, 33, -2, -55, 77, -38, 40, -92
    };
    ...
    int32_t golden[] = {
    413, 4294965773, 4294959361, 4294964797, 2801, 4294959877, 4294956944, 7412, 4294960654, 4294963139, 4294967099, 6435, 4294959982, 1444, 361, 4294964352
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
