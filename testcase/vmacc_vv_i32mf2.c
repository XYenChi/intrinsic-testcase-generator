...
int main(){
    const int32_t data1[] = {
    -6, -40, 114, -65, -91, 39, -55, -117, 78, 42, 84, 110, 66, 1, 66, 123
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    81, -18, 20, 5, 36, -64, 120, -120, 28, 1, 4, 127, -99, 48, 120, 92
    };
    ...
    int32_t golden[] = {
    4294966810, 721, 2281, 4294966972, 4294964020, 4294964801, 4294960697, 14041, 2185, 42, 337, 13971, 4294960762, 48, 7920, 11316
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
