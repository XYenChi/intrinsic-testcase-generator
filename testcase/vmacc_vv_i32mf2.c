...
int main(){
    const int32_t data1[] = {
    123, 118, 54, 106, 95, 43, 78, -30, -116, 52, -2, -15, -84, 94, -48, -43
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    32, -79, -77, 8, 95, -93, -106, -111, 104, -38, 25, 51, -110, -4, -95, -5
    };
    ...
    int32_t golden[] = {
    3937, 4294957974, 4294963138, 848, 9026, 4294963297, 4294959028, 3330, 4294955232, 4294965320, 4294967246, 4294966532, 9241, 4294966921, 4560, 216
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
