...
int main(){
    const uint8_t data1[] = {
    82, 100, 204, 120, 160, 14, 153, 148, 235, 219, 16, 78, 213, 121, 159, 70
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    114, 5, 47, 113, 224, 84, 122, 209, 225, 135, 242, 57, 76, 243, 121, 74
    };
    ...
    uint8_t golden[] = {
    132, 244, 116, 248, 0, 152, 234, 212, 139, 125, 32, 94, 60, 219, 39, 60
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
