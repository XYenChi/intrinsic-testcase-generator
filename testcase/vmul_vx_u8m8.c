...
int main(){
    const uint8_t data1[] = {
    138, 180, 153, 213, 232, 238, 82, 191, 42, 220, 92, 38, 116, 175, 7, 129
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    209, 158, 229, 152, 59, 94, 48, 68, 250, 231, 143, 221, 208, 128, 119, 172
    };
    ...
    uint8_t golden[] = {
    170, 24, 221, 120, 120, 100, 96, 188, 4, 132, 100, 206, 64, 128, 65, 172
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
