...
int main(){
    const int16_t data1[] = {
    125, -17, 3, 73, 120, -90, 23, 20, 127, 102, 74, -2, -77, 74, -15, 57
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -28, -72, 66, -29, -101, -45, 101, -50, -74, 2, -109, -103, 113, -105, -72, -53
    };
    ...
    int16_t golden[] = {
    97, -88, 70, 45, 20, -135, 124, -30, 53, 104, -35, -105, 36, -31, -86, 5
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
