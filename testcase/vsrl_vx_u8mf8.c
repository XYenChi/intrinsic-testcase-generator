...
int main(){
    const uint8_t data1[] = {
    97, 254, 3, 226, 108, 208, 67, 228, 154, 0, 225, 142, 126, 237, 86, 130
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    12, 191, 199, 3, 40, 100, 51, 139, 172, 254, 63, 125, 101, 35, 12, 128
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u8mf8 (data1_v, shift, vl);
