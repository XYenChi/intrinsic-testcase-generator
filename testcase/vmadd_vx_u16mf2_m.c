...
int main(){
    ...
    13, 16, 246, 177, 18, 240, 113, 43, 193, 102, 50, 101, 200, 23, 52, 7
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    150, 247, 217, 226, 129, 170, 227, 108, 120, 166, 171, 139, 248, 171, 175, 82
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmadd_vx_u16mf2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    13, 247, 246, 177, 129, 240, 340, 43, 313, 102, 171, 101, 200, 23, 52, 7
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
