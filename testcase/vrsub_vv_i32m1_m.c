...
int main(){
    const int32_t data1[] = {
    112, -49, 75, -66, 53, -88, -111, 84, 78, 36, 67, -116, -111, -18, 54, 96
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -47, -8, -59, -6, -77, 74, 55, -49, -82, -14, 123, 73, 105, -88, 64, 24
    };
    ...
    int32_t golden[] = {
    4294967137, 41, 1, 1, 4294967166, 0, 0, 1, 1, 4294967246, 1, 0, 216, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
