...
int main(){
    const uint8_t data1[] = {
    170, 45, 159, 97, 73, 92, 68, 232, 94, 250, 168, 54, 84, 139, 152, 237
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    86, 110, 215, 16, 192, 250, 50, 136, 37, 220, 79, 145, 64, 130, 128, 41
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u8mf2 (data1_v, data2_v, vl);
