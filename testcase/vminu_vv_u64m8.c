...
int main(){
    ...
    98, 185, 70, 121, 229, 253, 145, 70, 2, 117, 204, 196, 35, 102, 61, 209
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    254, 26, 99, 154, 149, 143, 9, 76, 220, 98, 136, 241, 247, 53, 188, 117
    };
    ...
    uint64_t golden[] = {
    254, 185, 99, 154, 229, 253, 145, 76, 220, 117, 204, 241, 247, 102, 188, 209
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
