...
int main(){
    const int32_t data1[] = {
    105, 106, -16, 10, 113, 62, -52, 116, -45, 117, 117, -98, 31, -41, -10, -63
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -37, -5, -40, -28, -105, 67, 82, 71, -79, -24, 118, 21, 64, 82, -15, 27
    };
    ...
    int32_t golden[] = {
    3885, 531, 4294966657, 280, 11866, 4294963143, 4264, 4294959061, 4294963741, 2809, 4294953491, 2059, 4294965313, 3363, 4294967146, 1701
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
