...
int main(){
    const int8_t data1[] = {
    -122, -25, -18, 94, 51, -86, -54, 100, -23, 96, 68, -20, 119, -67, -62, -21
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    98, 7, 32, -28, 62, -22, 29, -98, -39, 50, -45, -30, -116, 86, -17, -11
    };
    ...
    int8_t golden[] = {
    -106, -125, -75, 161, 54, 29, -166, 194, -22, 17, 94, 51, 71, -184, -78, -80
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
