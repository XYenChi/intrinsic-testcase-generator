...
int main(){
    ...
    146, 109, 206, 250, 197, 152, 135, 212, 54, 128, 65, 230, 211, 14, 25, 239
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    1, 16, 253, 20, 167, 101, 230, 20, 250, 17, 147, 87, 86, 186, 146, 158
    };
    ...
    uint64_t masked[] = {
    0, 0, 0, 1, 0, 1, 0, 1, 1, 0, 1, 0, 0, 1, 0, 0
    };
    ...
    uint16_t golden[] = {
    0, 0, 1, 0, 0, 0, 0, 0, 4, 1, 2, 0, 1, 13, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
