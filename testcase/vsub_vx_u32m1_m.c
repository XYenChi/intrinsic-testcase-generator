...
int main(){
    ...
    28, 217, 228, 58, 146, 112, 208, 67, 10, 184, 146, 39, 170, 61, 225, 9
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    122, 73, 101, 189, 40, 138, 144, 46, 123, 133, 51, 205, 216, 77, 222, 48
    };
    ...
    uint32_t golden[] = {
    1, 144, 127, 4294967165, 106, 0, 64, 21, 4294967183, 51, 95, 1, 4294967250, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
