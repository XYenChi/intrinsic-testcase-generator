...
int main(){
    ...
    87, 7, 241, 58, 110, 245, 200, 166, 23, 95, 248, 77, 197, 24, 232, 188
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    118, 2, 133, 104, 10, 116, 122, 232, 178, 2, 249, 152, 57, 15, 212, 16
    };
    ...
    uint32_t golden[] = {
    4294967265, 5, 0, 4294967250, 0, 129, 1, 0, 0, 93, 4294967295, 4294967221, 140, 0, 20, 172
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
