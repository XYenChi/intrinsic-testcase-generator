...
int main(){
    ...
    200, 92, 28, 89, 55, 200, 45, 73, 24, 218, 177, 162, 125, 235, 224, 50
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    211, 212, 94, 194, 118, 143, 121, 26, 2, 30, 40, 80, 245, 7, 136, 50
    };
    ...
    uint32_t masked[] = {
    0, 1, 0, 1, 1, 0, 1, 0, 0, 0, 1, 1, 0, 1, 0, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u32m1_m (mask, data1_v, data2_v, vl);
