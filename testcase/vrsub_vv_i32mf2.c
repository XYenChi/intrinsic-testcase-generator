...
int main(){
    const int32_t data1[] = {
    -24, 17, 116, -66, 27, -116, -93, 114, -78, -28, 73, 18, 117, 23, -62, 101
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    94, -123, 104, 71, 4, -69, 97, 75, 115, -30, -59, -39, 18, -15, -1, 96
    };
    ...
    int32_t golden[] = {
    118, 4294967156, 4294967284, 137, 4294967273, 47, 190, 4294967257, 193, 4294967294, 4294967164, 4294967239, 4294967197, 4294967258, 61, 4294967291
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
