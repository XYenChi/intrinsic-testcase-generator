...
int main(){
    const int32_t data1[] = {
    53, -90, 121, -103, 95, 57, 102, 35, 110, -1, -14, -49, -87, -113, 126, -121
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    91, -90, 20, 89, 98, -50, -117, -17, -67, 117, -81, 25, -123, -24, -61, 34
    };
    ...
    int32_t golden[] = {
    38, 0, 4294967195, 192, 3, 4294967189, 4294967077, 4294967244, 4294967119, 118, 4294967229, 74, 4294967260, 89, 4294967109, 155
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
