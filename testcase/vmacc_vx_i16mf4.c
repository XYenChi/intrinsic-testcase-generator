...
int main(){
    const int16_t data1[] = {
    -87, 46, 48, -119, -85, -70, 61, -1, 109, -42, 113, 68, 88, 53, -64, 37
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -71, 37, -82, 44, -11, 116, -23, 67, -95, -51, -112, -101, -73, -47, 55, 13
    };
    ...
    int16_t golden[] = {
    6178, 1703, 61601, 60301, 935, 57417, 64134, 65470, 55182, 2142, 52880, 58668, 59113, 63045, 62017, 482
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
