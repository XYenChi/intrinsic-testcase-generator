...
int main(){
    const int16_t data1[] = {
    -86, -68, -96, 25, -68, 79, 60, 127, 20, 0, -117, -76, -73, -71, 4, -48
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    61, 73, -72, -108, 104, 64, 77, -75, -100, 3, 115, -40, -110, -39, 104, 53
    };
    ...
    int16_t golden[] = {
    60290, 60573, 6912, 62837, 58464, 5056, 4621, 56011, 63536, 0, 52082, 3041, 8031, 2770, 417, 62993
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
