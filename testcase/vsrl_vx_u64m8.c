...
int main(){
    ...
    26, 138, 232, 223, 183, 73, 156, 15, 251, 139, 179, 11, 138, 213, 111, 214
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    57, 76, 242, 56, 206, 178, 193, 225, 39, 242, 19, 187, 44, 94, 6, 24
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u64m8 (data1_v, shift, vl);
