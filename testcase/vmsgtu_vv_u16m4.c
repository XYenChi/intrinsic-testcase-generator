...
int main(){
    ...
    117, 43, 240, 222, 214, 209, 155, 166, 214, 144, 74, 190, 176, 209, 139, 91
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    86, 234, 22, 117, 145, 103, 113, 109, 29, 23, 114, 28, 106, 35, 135, 29
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_16m4_b4 (data1_v, data2_v, vl);
