...
int main(){
    const uint8_t data1[] = {
    244, 41, 203, 208, 136, 177, 197, 23, 46, 245, 50, 224, 233, 9, 67, 134
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    208, 181, 44, 70, 196, 99, 129, 30, 48, 125, 254, 41, 158, 188, 151, 30
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsac_vv_u8m8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    192, 4, 28, 33, 0, 0, 1, 79, 97, 95, 1, 32, 50, 1, 123, 76
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
