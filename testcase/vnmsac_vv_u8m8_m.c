...
int main(){
    const uint8_t data1[] = {
    168, 194, 187, 149, 11, 4, 8, 202, 200, 199, 3, 113, 12, 40, 25, 164
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    33, 46, 5, 222, 28, 23, 216, 147, 212, 51, 119, 121, 234, 251, 77, 133
    };
    ...
    uint8_t golden[] = {
    88, 36, 89, 202, 1, 0, 64, 3, 97, 1, 156, 151, 1, 200, 1, 205
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
