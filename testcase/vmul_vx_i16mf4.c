...
int main(){
    const int16_t data1[] = {
    -95, -58, -49, -40, -96, 74, -17, 47, 69, -116, 44, 18, -18, 61, -110, -26
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -4, 44, 67, 70, -56, -118, 10, 56, -102, 102, -59, -127, -9, 52, 84, -33
    };
    ...
    int16_t golden[] = {
    380, 62984, 62253, 62736, 5376, 56804, 65366, 2632, 58498, 53704, 62940, 63250, 162, 3172, 56296, 858
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
