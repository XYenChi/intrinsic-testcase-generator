...
int main(){
    const int16_t data1[] = {
    -58, -43, -108, 15, -47, 116, -9, 57, 31, 68, -85, -49, -85, 39, 15, -70
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -114, 91, -67, 77, 7, 49, 87, -68, -67, -22, 124, 104, -60, -33, -113, 119
    };
    ...
    int16_t golden[] = {
    6612, 61623, 7236, 1155, 65207, 5684, 64753, 61660, 63459, 64040, 54996, 60440, 5100, 64249, 63841, 57206
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
