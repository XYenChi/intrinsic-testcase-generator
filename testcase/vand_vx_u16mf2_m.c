...
int main(){
    ...
    131, 54, 199, 242, 68, 54, 47, 113, 88, 32, 249, 29, 215, 177, 106, 149
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    164, 220, 136, 76, 252, 18, 244, 117, 104, 155, 142, 125, 119, 29, 27, 67
    };
    ...
    uint16_t golden[] = {
    1, 1, 136, 1, 252, 18, 244, 1, 104, 155, 1, 125, 0, 29, 1, 67
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
