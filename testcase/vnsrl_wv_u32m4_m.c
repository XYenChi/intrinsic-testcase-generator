...
int main(){
    ...
    180, 168, 129, 10, 21, 121, 149, 189, 240, 91, 168, 31, 20, 18, 79, 22
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    112, 111, 29, 252, 155, 226, 253, 116, 170, 241, 56, 64, 86, 233, 179, 182
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_32m4_m (mask, data1_v, shift, vl);
