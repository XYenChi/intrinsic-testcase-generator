...
int main(){
    ...
    168, 90, 26, 181, 224, 26, 195, 209, 3, 237, 95, 170, 28, 214, 155, 190
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    237, 206, 138, 210, 20, 133, 97, 190, 12, 164, 90, 56, 17, 255, 122, 238
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_16m8_b2 (data1_v, data2_v, vl);
