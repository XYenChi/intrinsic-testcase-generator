...
int main(){
    const int8_t data1[] = {
    -61, 113, 89, -81, -37, 61, 110, 35, 2, 87, 54, 106, 124, -100, 53, -57
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    65, 13, -111, -22, 35, 88, 126, 127, -50, -117, 56, 93, -125, 84, -47, -39
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vx_8mf4_b32_m (mask, data1_v, data2_v, vl);
