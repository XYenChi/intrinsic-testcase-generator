...
int main(){
    const int64_t data1[] = {
    -101, -51, -30, -1, 41, 106, -88, 52, -51, 126, 78, -118, -68, -99, 29, -65
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    112, 44, -99, 45, 18, 21, 123, -98, -35, -50, -77, -50, -115, 11, 118, -19
    };
    ...
    int64_t golden[] = {
    18446744073709551614, 18446744073709551615, 3, 1, 1, 1, 1, 0, 0, 1, 1, 0, 1, 18446744073709551615, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
