...
int main(){
    const int64_t data1[] = {
    -109, -22, 109, 32, -102, -34, 103, -63, 45, 113, -74, -72, 27, 49, -48, 94
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    81, 41, -58, -103, 7, 59, 92, -57, -17, 97, -119, 0, -110, -103, 109, 44
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdiv_vx_i64m4_m (mask, data1_v, data2_v, vl);
    ...
    int64_t golden[] = {
    18446744073709551615, 0, 18446744073709551615, 18446744073709551612, 18446744073709551615, 1, 0, 0, 0, 0, 1, 0, 18446744073709551611, 0, 18446744073709551613, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
