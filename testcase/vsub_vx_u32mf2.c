...
int main(){
    ...
    250, 174, 18, 118, 114, 221, 144, 201, 169, 33, 89, 180, 248, 147, 240, 3
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    19, 147, 195, 140, 157, 165, 177, 192, 223, 74, 187, 52, 249, 140, 167, 118
    };
    ...
    uint32_t golden[] = {
    231, 27, 4294967119, 4294967274, 4294967253, 56, 4294967263, 9, 4294967242, 4294967255, 4294967198, 128, 4294967295, 7, 73, 4294967181
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
