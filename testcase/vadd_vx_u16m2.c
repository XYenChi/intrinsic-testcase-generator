...
int main(){
    const int16_t data1[] = {
    151, 17, 41, 15, 239, 7, 209, 61, 190, 70, 184, 25, 215, 131, 255, 222
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    188, 91, 116, 143, 148, 87, 255, 143, 121, 214, 168, 5, 63, 157, 102, 102
    };
    ...
    int16_t golden[] = {
    339, 108, 157, 158, 387, 94, 464, 204, 311, 284, 352, 30, 278, 288, 357, 324
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
