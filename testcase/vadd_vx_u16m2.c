...
int main(){
    ...
    40, 130, 16, 95, 100, 241, 184, 66, 159, 229, 185, 8, 156, 40, 165, 134
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    163, 238, 52, 55, 107, 225, 97, 198, 235, 93, 226, 208, 249, 242, 200, 127
    };
    ...
    uint16_t golden[] = {
    203, 368, 68, 150, 207, 466, 281, 264, 394, 322, 411, 216, 405, 282, 365, 261
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
