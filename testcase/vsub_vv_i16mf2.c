...
int main(){
    const int16_t data1[] = {
    -59, -58, -90, 10, 66, -108, -96, 40, -101, -116, -40, -116, 55, -40, -125, -14
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -45, -86, -104, 127, -81, -80, 22, 62, -13, 31, 62, 24, 88, -16, -52, -42
    };
    ...
    int16_t golden[] = {
    -14, 28, 14, -117, 127, -28, -118, -22, -88, -128, -102, -128, -33, -24, -73, 28
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
