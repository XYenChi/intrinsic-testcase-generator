...
int main(){
    ...
    27, 190, 21, 72, 245, 68, 182, 210, 82, 47, 188, 240, 163, 42, 209, 127
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    214, 199, 254, 51, 115, 140, 67, 243, 154, 217, 219, 148, 6, 132, 40, 12
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_32m4_b8 (data1_v, data2_v, vl);
