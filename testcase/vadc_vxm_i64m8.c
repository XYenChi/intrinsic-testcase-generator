...
int main(){
    const int64_t data1[] = {
    -67, 16, -116, 108, 70, 78, 83, -15, 91, -65, -101, 28, 49, 116, 1, 6
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -20, 7, 110, 89, -102, -33, 114, 121, -51, 116, 81, -38, 104, 63, 58, -120
    };
    ...
    int64_t golden[] = {
    -86, 24, -6, 197, -31, 46, 197, 107, 41, 52, -19, -9, 154, 179, 60, -114
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
