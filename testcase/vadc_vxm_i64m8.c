...
int main(){
    const int64_t data1[] = {
    -16, 77, -125, 48, -22, 63, -87, -121, 21, -8, 115, 78, 83, -113, -75, 85
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    121, -5, 57, 79, -58, -31, -29, -33, -22, -49, 70, 6, 95, -56, -33, -50
    };
    ...
    int64_t golden[] = {
    106, 73, -68, 128, -80, 33, -116, -153, 0, -57, 186, 84, 179, -168, -108, 36
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
