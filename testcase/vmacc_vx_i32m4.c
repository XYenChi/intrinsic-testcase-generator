...
int main(){
    const int32_t data1[] = {
    85, -73, 18, 0, -42, 110, -47, -67, -125, 62, 8, -75, 82, 74, -45, -91
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    105, 91, -102, 72, 33, 122, 126, 1, 111, -100, -70, 50, -4, 125, -41, 38
    };
    ...
    int32_t golden[] = {
    8926, 4294960653, 4294965460, 1, 4294965910, 13421, 4294961374, 4294967230, 4294953421, 4294961097, 4294966737, 4294963546, 4294966968, 9251, 1845, 4294963838
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
