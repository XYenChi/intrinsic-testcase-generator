...
int main(){
    const int32_t data1[] = {
    -1, -15, -75, 40, -20, 58, 1, -20, -12, -80, 26, -72, -65, -27, 127, 1
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -33, 4, -60, -88, -97, -120, -62, -96, -120, -120, 1, -72, 91, 81, 2, 114
    };
    ...
    int32_t golden[] = {
    33, 4294967237, 4500, 4294963777, 1941, 4294960336, 4294967234, 1921, 1440, 9600, 26, 5185, 4294961382, 4294965109, 255, 114
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
