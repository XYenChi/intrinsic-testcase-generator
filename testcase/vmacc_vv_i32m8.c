...
int main(){
    const int32_t data1[] = {
    -88, -45, -69, -27, 71, 69, -49, -101, -111, -77, 28, 103, -57, 40, -42, -54
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    124, 15, 101, -107, -103, 81, 95, -121, -94, -38, -76, -58, 8, -29, -83, 20
    };
    ...
    int32_t golden[] = {
    4294956385, 4294966622, 4294960328, 2889, 4294959984, 5589, 4294962642, 12221, 10435, 2926, 4294965169, 4294961323, 4294966840, 4294966136, 3486, 4294966216
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
