...
int main(){
    const int32_t data1[] = {
    -111, 101, 86, 71, -28, -23, 127, 37, -102, -6, -8, 38, 10, 115, -24, -9
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    11, 13, 9, -31, 115, 32, -37, 11, 12, 101, -117, -57, -6, 58, 46, -86
    };
    ...
    int32_t golden[] = {
    4294966075, 1313, 775, 4294965095, 4294964077, 4294966560, 4294962597, 408, 4294966073, 4294966691, 936, 4294965131, 4294967237, 6671, 4294966192, 774
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
