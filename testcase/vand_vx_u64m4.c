...
int main(){
    ...
    188, 93, 63, 100, 183, 18, 221, 68, 191, 108, 177, 22, 162, 0, 140, 234
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    255, 89, 69, 116, 86, 57, 7, 2, 116, 63, 7, 83, 208, 20, 251, 169
    };
    ...
    uint64_t golden[] = {
    255, 89, 69, 116, 86, 57, 7, 2, 116, 63, 7, 83, 208, 0, 251, 169
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
