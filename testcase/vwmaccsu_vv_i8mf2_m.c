...
int main(){
    const int8_t data1[] = {
    89, 63, 12, -108, -66, 102, -80, -75, 19, 27, 108, 60, -105, -67, 104, -90
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    -17, -17, -17, -19, -57, 39, -93, -22, -67, -49, 66, 8, 97, -45, 27, 114
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccsu_vv_i8mf2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    23, 210, 1, 0, 178, 1, 17, 115, 0, 0, 217, 0, 1, 199, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
