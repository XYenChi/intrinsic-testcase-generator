...
int main(){
    ...
    140, 150, 242, 224, 121, 145, 244, 23, 53, 52, 27, 179, 29, 50, 151, 158
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    248, 164, 126, 237, 57, 141, 234, 171, 132, 110, 216, 88, 185, 22, 6, 90
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u64m4_m (mask, data1_v, data2_v, vl);
