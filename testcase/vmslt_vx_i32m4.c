...
int main(){
    const int32_t data1[] = {
    90, -104, 49, -79, -123, -30, 39, 127, -42, 79, 118, 96, 62, -111, -115, 98
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -44, -77, 74, -37, 5, 101, -106, -112, -99, 30, 9, 76, -12, 125, 61, -80
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_32m4_b8 (data1_v, data2_v, vl);
