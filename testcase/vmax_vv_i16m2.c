...
int main(){
    const int16_t data1[] = {
    -110, -21, 39, -101, 12, -72, -4, -69, 75, 22, -103, -19, 23, -41, -107, 101
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    79, 86, 69, -78, -27, -111, -1, 89, -35, 125, -91, 61, 9, -71, 89, 43
    };
    ...
    int16_t golden[] = {
    79, 86, 69, 65458, 12, 65464, 65535, 89, 75, 125, 65445, 61, 23, 65495, 89, 101
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
