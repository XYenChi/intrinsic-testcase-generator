...
int main(){
    const int16_t data1[] = {
    91, 115, 109, 56, 16, -107, 29, 76, 22, 74, 115, -100, -101, -45, -69, -81
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    41, 95, -94, 12, 89, -123, 97, 107, 99, 116, -31, -49, 69, 25, 36, 110
    };
    ...
    int16_t golden[] = {
    91, 115, 109, 56, 89, 65429, 97, 107, 99, 116, 115, 65487, 69, 25, 36, 110
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
