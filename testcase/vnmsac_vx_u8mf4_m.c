...
int main(){
    const uint8_t data1[] = {
    102, 179, 24, 153, 171, 106, 171, 32, 228, 233, 194, 36, 32, 194, 211, 134
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    70, 82, 223, 53, 31, 31, 98, 85, 147, 61, 215, 65, 148, 48, 9, 165
    };
    ...
    uint8_t golden[] = {
    29, 171, 1, 83, 0, 43, 0, 0, 20, 123, 0, 1, 1, 161, 0, 163
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
