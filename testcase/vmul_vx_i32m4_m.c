...
int main(){
    const int32_t data1[] = {
    -20, 7, -2, -38, -37, 14, -66, 27, 28, -29, 3, 88, -76, -27, 64, -110
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -68, 65, 66, 37, 58, 27, -118, 84, 115, 79, 45, 58, 111, 7, -65, -40
    };
    ...
    int32_t golden[] = {
    0, 1, 1, 1, 4294965150, 1, 7788, 0, 3220, 0, 1, 5104, 4294958860, 1, 0, 4400
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
