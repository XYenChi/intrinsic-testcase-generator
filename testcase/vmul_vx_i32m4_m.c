...
int main(){
    const int32_t data1[] = {
    86, -100, -67, -98, -4, -97, -35, 5, -14, 39, 105, -39, -56, -124, 91, -30
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    20, -42, 77, -85, 124, -81, -22, -64, -52, 19, 8, -115, -49, 35, -114, -92
    };
    ...
    int32_t golden[] = {
    0, 1, 0, 8330, 0, 7857, 770, 0, 1, 1, 840, 0, 2744, 4294962956, 0, 2760
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
