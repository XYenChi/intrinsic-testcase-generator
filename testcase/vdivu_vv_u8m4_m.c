...
int main(){
    const uint8_t data1[] = {
    248, 24, 145, 47, 155, 37, 133, 20, 45, 98, 94, 119, 93, 192, 156, 205
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    127, 34, 166, 128, 65, 166, 123, 23, 246, 41, 68, 160, 220, 230, 18, 206
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i8m4_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 1, 0, 0, 0, 0, 1, 0, 5, 0, 0, 1, 2, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
