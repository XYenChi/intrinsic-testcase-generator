...
int main(){
    ...
    232, 38, 80, 190, 119, 196, 197, 26, 106, 105, 245, 54, 226, 231, 98, 2
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    203, 41, 32, 63, 125, 248, 147, 59, 135, 184, 219, 157, 113, 49, 71, 196
    };
    ...
    uint16_t golden[] = {
    232, 41, 80, 190, 125, 248, 197, 59, 135, 184, 245, 157, 226, 231, 98, 196
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
