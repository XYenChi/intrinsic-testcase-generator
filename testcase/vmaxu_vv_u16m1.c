...
int main(){
    ...
    98, 11, 202, 79, 34, 202, 44, 158, 226, 205, 80, 107, 106, 95, 30, 140
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    56, 103, 222, 164, 173, 243, 26, 77, 0, 236, 185, 160, 251, 90, 42, 28
    };
    ...
    uint16_t golden[] = {
    98, 103, 222, 164, 173, 243, 44, 158, 226, 236, 185, 160, 251, 95, 42, 140
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
