...
int main(){
    const int16_t data1[] = {
    -66, -83, 113, 1, -123, 7, 122, -47, -99, 57, -49, -4, 3, -81, 29, -105
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -95, -17, 78, 85, 108, 123, -84, -65, 12, -126, 7, 112, 124, -28, -87, -73
    };
    ...
    int16_t golden[] = {
    6270, 1411, 8815, 85, 52253, 862, 55289, 3055, 64348, 58355, 65194, 65089, 373, 2268, 63013, 7666
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
