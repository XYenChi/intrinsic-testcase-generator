...
int main(){
    ...
    74, 56, 31, 49, 252, 136, 182, 26, 190, 233, 98, 10, 51, 153, 31, 162
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    131, 166, 125, 159, 132, 102, 18, 210, 15, 223, 209, 187, 101, 250, 124, 67
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_16mf4_b64_m (mask, data1_v, data2_v, vl);
