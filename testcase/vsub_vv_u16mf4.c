...
int main(){
    ...
    252, 92, 34, 222, 122, 2, 157, 117, 39, 225, 7, 47, 91, 101, 38, 144
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    223, 212, 237, 84, 155, 214, 234, 232, 218, 14, 48, 213, 160, 131, 81, 89
    };
    ...
    uint16_t golden[] = {
    29, 65416, 65333, 138, 65503, 65324, 65459, 65421, 65357, 211, 65495, 65370, 65467, 65506, 65493, 55
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
