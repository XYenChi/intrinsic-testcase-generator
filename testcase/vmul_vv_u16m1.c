...
int main(){
    ...
    79, 18, 9, 198, 66, 101, 111, 30, 84, 183, 51, 251, 101, 166, 64, 150
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    208, 74, 121, 232, 52, 18, 72, 204, 191, 132, 92, 232, 107, 178, 185, 21
    };
    ...
    uint16_t golden[] = {
    16432, 1332, 1089, 45936, 3432, 1818, 7992, 6120, 16044, 24156, 4692, 58232, 10807, 29548, 11840, 3150
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
