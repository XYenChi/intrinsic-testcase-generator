...
int main(){
    const int8_t data1[] = {
    -121, -63, -103, 35, 3, -44, -105, 39, -26, -127, -119, -92, -40, -39, -105, -86
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    61, 130, 213, 245, 224, 108, 9, 157, 78, 214, 240, 168, 224, 185, 203, 85
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_8mf2_b16 (mask, data1_v, data2_v, vl);
