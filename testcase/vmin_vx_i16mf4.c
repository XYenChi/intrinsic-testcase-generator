...
int main(){
    const int16_t data1[] = {
    -97, 122, 101, -71, -74, -74, -2, -17, -45, -88, 95, -98, -95, 30, 15, -33
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -18, 89, -42, 50, -104, -115, 51, 5, -1, 19, 11, -128, -61, -65, 101, 119
    };
    ...
    int16_t golden[] = {
    65518, 122, 101, 50, 65462, 65462, 51, 5, 65535, 19, 95, 65438, 65475, 30, 101, 119
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
