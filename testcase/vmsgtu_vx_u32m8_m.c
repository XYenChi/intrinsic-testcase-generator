...
int main(){
    ...
    122, 84, 242, 12, 228, 152, 109, 108, 238, 24, 69, 244, 157, 193, 191, 179
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    183, 168, 57, 198, 33, 111, 176, 89, 205, 174, 4, 161, 104, 124, 238, 222
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_32m8_b4_m (mask, data1_v, data2_v, vl);
