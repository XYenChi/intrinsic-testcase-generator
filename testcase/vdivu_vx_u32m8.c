...
int main(){
    ...
    227, 233, 122, 12, 248, 10, 162, 113, 105, 135, 166, 72, 177, 71, 173, 7
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    216, 196, 44, 154, 104, 238, 18, 88, 175, 165, 201, 233, 180, 129, 225, 207
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i32m8 (data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    0, 0, 0, 12, 0, 23, 0, 0, 1, 1, 1, 3, 1, 1, 1, 29
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
