...
int main(){
    ...
    78, 43, 66, 173, 152, 56, 222, 164, 108, 65, 111, 51, 79, 77, 112, 164
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    217, 45, 92, 180, 236, 227, 49, 91, 231, 114, 105, 155, 182, 142, 151, 248
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u64m4 (data1_v, data2_v, vl);
