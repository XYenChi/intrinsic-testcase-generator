...
int main(){
    ...
    160, 23, 120, 99, 246, 229, 3, 106, 235, 88, 98, 143, 77, 231, 175, 1
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    219, 52, 160, 178, 103, 136, 68, 40, 229, 136, 187, 12, 6, 41, 162, 255
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u16m4_m (mask, data1_v, data2_v, vl);
