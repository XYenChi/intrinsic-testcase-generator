...
int main(){
    ...
    196, 109, 88, 139, 0, 32, 145, 143, 211, 119, 127, 169, 82, 90, 53, 76
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    82, 50, 168, 87, 104, 137, 59, 246, 17, 236, 81, 126, 165, 60, 34, 76
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u16m4_m (mask, data1_v, data2_v, vl);
