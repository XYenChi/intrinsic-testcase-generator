...
int main(){
    const uint8_t data1[] = {
    96, 167, 186, 111, 166, 55, 5, 32, 213, 176, 227, 115, 58, 95, 175, 132
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    141, 26, 172, 155, 28, 157, 201, 216, 89, 199, 37, 44, 31, 159, 68, 16
    };
    ...
    uint8_t golden[] = {
    0, 193, 1, 10, 0, 1, 1, 248, 0, 1, 1, 1, 89, 254, 243, 148
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
