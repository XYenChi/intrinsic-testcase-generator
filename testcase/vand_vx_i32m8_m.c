...
int main(){
    const int32_t data1[] = {
    102, 61, 43, -76, -108, 98, -35, -113, -112, 125, -62, -9, 96, 50, 63, 1
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -118, -17, -25, 78, 124, 89, 32, 18, 119, 111, -43, 73, -24, -79, -116, 84
    };
    ...
    int32_t golden[] = {
    4294967178, 4294967279, 4294967271, 1, 124, 0, 0, 18, 119, 0, 4294967253, 0, 1, 4294967217, 4294967180, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
