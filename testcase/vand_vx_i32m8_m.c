...
int main(){
    const int32_t data1[] = {
    39, -46, -70, -109, -20, 21, -67, -85, -4, -17, 28, -20, 58, 9, 52, -68
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    11, -81, -79, 2, 28, -26, -89, -29, 91, -117, 48, 5, 87, -57, 13, 95
    };
    ...
    int32_t golden[] = {
    1, 1, 4294967217, 1, 1, 1, 4294967207, 4294967267, 91, 1, 0, 5, 87, 4294967239, 1, 95
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
