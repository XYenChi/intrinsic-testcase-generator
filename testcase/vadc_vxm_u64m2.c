...
int main(){
    ...
    207, 37, 196, 223, 37, 169, 104, 72, 68, 206, 67, 137, 144, 139, 191, 14
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    234, 178, 82, 85, 247, 44, 102, 3, 233, 68, 171, 157, 147, 82, 93, 23
    };
    ...
    uint64_t golden[] = {
    442, 215, 279, 308, 284, 213, 206, 76, 301, 275, 238, 294, 291, 222, 285, 37
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
