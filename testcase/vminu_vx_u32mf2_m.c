...
int main(){
    ...
    254, 52, 166, 185, 124, 215, 123, 96, 204, 141, 29, 64, 217, 195, 172, 92
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    225, 49, 23, 58, 126, 42, 9, 101, 155, 75, 43, 78, 74, 112, 169, 178
    };
    ...
    uint32_t golden[] = {
    254, 52, 166, 0, 126, 0, 123, 1, 204, 141, 43, 78, 0, 1, 172, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
