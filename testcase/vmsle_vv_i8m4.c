...
int main(){
    const int8_t data1[] = {
    -113, -126, 88, 83, -48, -60, 1, -103, 125, -114, 28, -69, 33, 19, -19, -123
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    125, 123, 32, -98, 89, -94, 33, 117, -19, -19, -89, -117, -54, -23, 109, 121
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vv_8m4_b2 (data1_v, data2_v, vl);
