...
int main(){
    ...
    228, 207, 5, 10, 128, 70, 195, 19, 153, 241, 67, 69, 158, 102, 129, 3
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    176, 90, 163, 251, 69, 204, 213, 127, 111, 178, 171, 112, 49, 104, 116, 101
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_16m2_b8_m (mask, data1_v, data2_v, vl);
