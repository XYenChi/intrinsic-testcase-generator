...
int main(){
    const int32_t data1[] = {
    -20, -32, -75, -44, 41, -69, -57, 2, -128, -32, -7, 73, 104, 17, 86, -50
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    119, -72, -9, 107, 81, -69, -25, -120, 8, 96, -14, 74, 10, -88, -35, -80
    };
    ...
    int32_t golden[] = {
    4294967295, 4294967288, 4294967287, 4294967271, 40, 0, 4294967271, 0, 4294967176, 0, 0, 1, 10, 14, 51, 4294967266
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
