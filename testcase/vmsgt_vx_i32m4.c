...
int main(){
    const int32_t data1[] = {
    -31, 82, -96, 119, -115, -60, 110, -45, 35, -52, -55, 89, -51, -45, 85, -73
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -99, -123, -30, 72, 31, 55, 127, -59, 123, -78, 39, 45, -65, 115, 81, 119
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vx_32m4_b8 (data1_v, data2_v, vl);
