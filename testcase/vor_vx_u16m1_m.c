...
int main(){
    ...
    242, 105, 170, 160, 231, 192, 93, 138, 91, 247, 180, 66, 106, 157, 157, 134
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    181, 12, 237, 238, 135, 247, 253, 249, 81, 123, 170, 61, 66, 72, 72, 234
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wx_16m1u_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    247, 0, 1, 238, 231, 1, 1, 0, 91, 255, 1, 0, 1, 221, 221, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
