...
int main(){
    const int32_t data1[] = {
    -34, 117, -86, 115, -85, 81, 29, -101, -127, 19, 117, 49, -34, 34, -117, 51
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -47, -72, -96, -20, 9, 2, -127, -91, 126, -12, 119, -38, 5, -6, 37, -74
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsra_wx_32m4_m (mask, data1_v, shift, vl);
