...
int main(){
    ...
    107, 35, 81, 202, 195, 196, 35, 34, 84, 141, 118, 87, 80, 118, 82, 119
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    61, 246, 254, 220, 233, 32, 231, 127, 26, 45, 219, 7, 225, 115, 248, 112
    };
    ...
    uint16_t golden[] = {
    0, 0, 1, 220, 233, 32, 0, 127, 1, 45, 219, 7, 0, 1, 248, 112
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
