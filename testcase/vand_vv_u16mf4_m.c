...
int main(){
    ...
    218, 192, 95, 69, 106, 245, 53, 127, 42, 227, 56, 107, 31, 199, 132, 64
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    233, 96, 154, 130, 231, 57, 211, 50, 73, 15, 253, 114, 208, 147, 142, 132
    };
    ...
    uint16_t golden[] = {
    233, 96, 1, 130, 231, 57, 1, 0, 1, 15, 253, 114, 208, 0, 142, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
