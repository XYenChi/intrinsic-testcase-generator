...
int main(){
    const uint8_t data1[] = {
    101, 189, 31, 49, 106, 116, 94, 247, 167, 199, 86, 203, 216, 75, 248, 16
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    178, 212, 57, 57, 124, 132, 235, 221, 204, 130, 191, 96, 141, 30, 14, 57
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wv_8m4_m (mask, data1_v, shift, vl);
