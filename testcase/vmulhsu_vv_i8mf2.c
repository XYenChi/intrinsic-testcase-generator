...
int main(){
    const int8_t data1[] = {
    -9, -120, 23, -12, 65, -34, -21, 33, 19, 107, -79, 12, 113, 2, 85, 86
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    214, 97, 152, 22, 155, 163, 41, 0, 151, 7, 150, 72, 41, 61, 29, 17
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_8mf2_b16 (data1_v, data2_v, vl);
