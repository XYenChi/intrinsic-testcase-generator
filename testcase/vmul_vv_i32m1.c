...
int main(){
    const int32_t data1[] = {
    43, -97, 111, -67, 76, -99, -115, -65, -88, -49, 103, -108, 110, 8, -122, -125
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -60, -112, 12, 99, 15, -75, -75, 117, -14, 89, -45, 62, 9, 125, 37, 107
    };
    ...
    int32_t golden[] = {
    4294964716, 10864, 1332, 4294960663, 1140, 7425, 8625, 4294959691, 1232, 4294962935, 4294962661, 4294960600, 990, 1000, 4294962782, 4294953921
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
