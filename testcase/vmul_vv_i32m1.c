...
int main(){
    const int32_t data1[] = {
    32, -29, -20, 97, -90, 69, 82, 57, -2, -25, 98, 91, -48, 99, 28, -83
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    61, -23, 54, -45, 71, 12, 51, 124, -2, 43, -73, -50, 25, 85, -74, -119
    };
    ...
    int32_t golden[] = {
    1952, 667, 4294966216, 4294962931, 4294960906, 828, 4182, 7068, 4, 4294966221, 4294960142, 4294962746, 4294966096, 8415, 4294965224, 9877
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
