...
int main(){
    ...
    223, 175, 45, 5, 53, 20, 65, 177, 251, 162, 214, 66, 179, 57, 132, 181
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    32, 252, 235, 6, 196, 188, 150, 46, 149, 205, 200, 175, 61, 52, 185, 204
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u32m1_m (mask, data1_v, data2_v, vl);
