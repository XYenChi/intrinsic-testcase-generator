...
int main(){
    const int64_t data1[] = {
    106, 100, -111, -115, 90, -64, -47, 30, -99, -36, 8, 51, -67, -88, -30, -120
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    60, 126, -36, 118, 86, -25, 30, 86, 28, -111, 102, 79, 63, -50, 79, 127
    };
    ...
    int64_t golden[] = {
    18446744073709551570, 26, 75, 233, 18446744073709551612, 39, 77, 56, 127, 18446744073709551541, 94, 28, 130, 38, 109, 247
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
