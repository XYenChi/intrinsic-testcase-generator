...
int main(){
    ...
    237, 155, 247, 116, 144, 182, 110, 26, 66, 150, 218, 102, 190, 112, 209, 119
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    253, 40, 155, 6, 32, 198, 48, 92, 52, 177, 164, 3, 82, 53, 48, 117
    };
    ...
    uint32_t golden[] = {
    59961, 0, 0, 696, 1, 36036, 0, 2392, 1, 26550, 35752, 0, 0, 1, 10032, 13923
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
