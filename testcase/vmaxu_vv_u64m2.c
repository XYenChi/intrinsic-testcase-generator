...
int main(){
    ...
    107, 16, 73, 107, 78, 252, 179, 191, 18, 18, 77, 243, 31, 98, 224, 210
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    219, 243, 117, 159, 218, 241, 199, 211, 10, 33, 76, 21, 17, 72, 35, 179
    };
    ...
    uint64_t golden[] = {
    219, 243, 117, 159, 218, 252, 199, 211, 18, 33, 77, 243, 31, 98, 224, 210
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
