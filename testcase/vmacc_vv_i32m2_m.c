...
int main(){
    const int32_t data1[] = {
    -63, 53, -59, 67, -97, 3, 17, 8, 48, -127, -108, -86, 108, 88, 11, 87
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -116, -14, -108, 18, -58, 107, -21, -16, -76, -38, -60, -128, -72, -1, 21, 124
    };
    ...
    int32_t golden[] = {
    1, 1, 0, 1206, 1, 321, 1, 4294967168, 4294963649, 1, 6481, 11009, 1, 4294967209, 232, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
