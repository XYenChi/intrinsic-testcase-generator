...
int main(){
    ...
    203, 14, 3, 17, 47, 182, 161, 93, 232, 32, 119, 35, 108, 230, 61, 247
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    207, 249, 252, 60, 123, 145, 24, 17, 65, 1, 175, 247, 31, 67, 145, 206
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u32mf2_m (mask, data1_v, data2_v, vl);
