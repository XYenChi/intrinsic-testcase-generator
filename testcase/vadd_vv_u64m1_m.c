...
int main(){
    ...
    192, 120, 73, 107, 169, 209, 241, 153, 78, 255, 70, 177, 17, 83, 77, 168
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    8, 150, 89, 109, 180, 221, 161, 99, 194, 159, 0, 9, 243, 79, 240, 24
    };
    ...
    uint64_t golden[] = {
    1, 0, 162, 1, 349, 430, 1, 1, 272, 0, 0, 0, 260, 1, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
