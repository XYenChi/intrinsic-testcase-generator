...
int main(){
    ...
    51, 111, 79, 176, 178, 1, 179, 228, 137, 29, 40, 31, 215, 22, 29, 42
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    198, 22, 130, 59, 216, 240, 209, 136, 117, 159, 150, 145, 152, 197, 163, 25
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i32m1 (data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    3, 0, 1, 0, 1, 240, 1, 0, 0, 5, 3, 4, 0, 8, 5, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
