...
int main(){
    const uint8_t data1[] = {
    179, 102, 111, 220, 218, 76, 245, 123, 52, 153, 23, 229, 24, 53, 109, 74
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    9, 5, 173, 122, 216, 7, 3, 235, 53, 94, 212, 108, 118, 30, 229, 15
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsac_vv_u8m2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    182, 1, 0, 41, 17, 237, 1, 23, 0, 0, 244, 101, 241, 202, 127, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
