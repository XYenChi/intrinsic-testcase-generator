...
int main(){
    const uint8_t data1[] = {
    157, 51, 16, 220, 155, 200, 11, 164, 209, 133, 40, 85, 17, 170, 24, 133
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    34, 114, 115, 38, 162, 169, 159, 178, 99, 5, 43, 208, 44, 173, 205, 27
    };
    ...
    uint8_t golden[] = {
    38, 74, 0, 1, 0, 1, 43, 249, 1, 0, 0, 240, 20, 0, 200, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
