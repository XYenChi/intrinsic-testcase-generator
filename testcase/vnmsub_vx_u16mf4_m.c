...
int main(){
    ...
    160, 71, 173, 47, 9, 102, 3, 186, 251, 157, 200, 141, 179, 127, 129, 7
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    191, 250, 111, 59, 13, 14, 65, 31, 132, 204, 209, 53, 101, 162, 135, 85
    };
    ...
    uint16_t golden[] = {
    1, 1, 1, 0, 1, 1, 65474, 155, 0, 1, 65527, 0, 78, 127, 0, 7
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
