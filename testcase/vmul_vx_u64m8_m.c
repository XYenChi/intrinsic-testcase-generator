...
int main(){
    ...
    74, 154, 176, 42, 213, 243, 136, 170, 227, 60, 180, 72, 128, 139, 14, 138
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    215, 183, 214, 20, 183, 250, 36, 123, 89, 107, 11, 55, 85, 222, 140, 214
    };
    ...
    uint64_t golden[] = {
    0, 1, 37664, 1, 0, 0, 1, 0, 20203, 0, 0, 0, 1, 30858, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
