...
int main(){
    ...
    135, 140, 239, 17, 114, 138, 136, 69, 177, 228, 9, 95, 185, 237, 117, 32
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    155, 64, 225, 90, 21, 122, 58, 125, 182, 93, 124, 112, 57, 227, 57, 6
    };
    ...
    uint64_t golden[] = {
    0, 204, 464, 107, 1, 260, 194, 194, 359, 321, 133, 0, 1, 1, 174, 38
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
