...
int main(){
    ...
    200, 152, 235, 43, 108, 87, 31, 218, 144, 169, 253, 23, 120, 152, 24, 60
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    17, 129, 152, 181, 121, 239, 112, 240, 182, 101, 228, 50, 31, 30, 16, 124
    };
    ...
    uint64_t golden[] = {
    217, 281, 1, 1, 1, 326, 0, 1, 0, 1, 1, 73, 0, 182, 1, 184
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
