...
int main(){
    ...
    75, 227, 55, 17, 27, 11, 96, 185, 230, 152, 82, 141, 167, 55, 160, 179
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    197, 166, 54, 237, 153, 233, 243, 124, 78, 156, 4, 157, 192, 161, 84, 47
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u64m8 (data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    47, 166, 54, 16, 18, 2, 51, 124, 78, 4, 4, 16, 25, 51, 84, 47
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
