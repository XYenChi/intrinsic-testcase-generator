...
int main(){
    const int64_t data1[] = {
    -3, 77, 67, -57, 17, -17, -50, 4, 14, 45, -54, -115, -72, 95, -97, 45
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    60, -43, 118, 56, 85, -55, 72, -118, -7, 95, -106, -65, 90, 75, -33, 79
    };
    ...
    int64_t golden[] = {
    0, 77, 0, 1, 85, 1, 0, 4, 14, 95, 1, 18446744073709551551, 90, 95, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
