...
int main(){
    const int8_t data1[] = {
    54, 186, 55, 128, 71, 151, 200, 4, 179, 156, 197, 77, 17, 218, 65, 44
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    45, 104, 78, 122, 85, 170, 238, 256, 42, 53, 135, 223, 141, 37, 150, 200
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsbc_vx_i8m1 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    9, 82, -23, 6, -14, -19, -38, -252, 137, 103, 62, -146, -124, 181, -85, -156
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
