...
int main(){
    const int32_t data1[] = {
    -3, -74, -25, 54, -61, 122, -119, 106, -110, 13, -76, 6, 126, -44, 71, 127
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    15, -125, -63, -13, -45, 110, -49, 64, -31, -69, -69, 74, 76, -96, -110, -74
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vv_32m1_b32 (data1_v, data2_v, vl);
