...
int main(){
    ...
    43, 249, 208, 62, 11, 72, 159, 195, 131, 85, 242, 27, 61, 239, 114, 123
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    69, 132, 143, 89, 168, 0, 174, 134, 143, 254, 122, 253, 93, 186, 128, 197
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_16m2_b8_m (mask, data1_v, data2_v, vl);
