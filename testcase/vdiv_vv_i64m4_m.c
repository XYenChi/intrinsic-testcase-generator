...
int main(){
    const int64_t data1[] = {
    109, 74, 44, -3, -70, 73, 27, 97, 57, 43, 27, -74, -112, 91, 91, -122
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    14, 59, -95, 71, -99, -100, 100, -91, -118, -83, -72, -86, 19, -14, 6, -46
    };
    ...
    int64_t golden[] = {
    0, 0, 0, 1, 1, 1, 1, 18446744073709551615, 1, 0, 1, 1, 18446744073709551615, 18446744073709551615, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
