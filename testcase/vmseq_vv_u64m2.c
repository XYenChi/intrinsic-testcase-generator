...
int main(){
    ...
    13, 0, 217, 236, 6, 240, 141, 66, 239, 153, 13, 134, 224, 210, 47, 240
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    186, 187, 125, 92, 241, 238, 149, 82, 84, 131, 38, 15, 23, 85, 172, 179
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_64m2_b32 (data1_v, data2_v, vl);
