...
int main(){
    const int32_t data1[] = {
    91, -24, 44, 69, 84, -7, -9, 32, 29, -122, 101, -120, 121, -126, -46, 109
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    67, -118, -62, -97, 125, 54, 21, 12, 79, 125, 78, -39, -127, 43, 31, 54
    };
    ...
    int32_t golden[] = {
    24, 94, 1, 166, 4294967255, 4294967235, 4294967266, 20, 1, 1, 23, 4294967215, 1, 4294967127, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
