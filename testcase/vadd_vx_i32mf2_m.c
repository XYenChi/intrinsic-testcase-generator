...
int main(){
    const int32_t data1[] = {
    -61, -93, -100, 14, 69, -40, 1, 9, 8, 49, -62, 15, 25, 13, 33, -80
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -17, -59, 121, -62, 79, -113, -2, 20, -39, -39, -2, -58, -105, 40, -10, 96
    };
    ...
    int32_t golden[] = {
    4294967218, 1, 21, 4294967248, 0, 1, 1, 0, 0, 10, 4294967232, 4294967253, 1, 53, 0, 16
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
