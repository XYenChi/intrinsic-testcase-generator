...
int main(){
    ...
    124, 136, 238, 79, 188, 12, 37, 244, 26, 137, 132, 167, 206, 194, 231, 31
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    139, 204, 16, 209, 232, 187, 254, 0, 51, 78, 230, 122, 255, 112, 35, 163
    };
    ...
    uint64_t golden[] = {
    248, 136, 238, 158, 188, 24, 37, 244, 52, 137, 132, 167, 412, 194, 462, 62
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
