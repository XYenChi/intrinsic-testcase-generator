...
int main(){
    const int16_t data1[] = {
    1, -99, 125, 81, 30, 126, 65, 6, 63, 36, -100, 29, -81, -63, -71, -21
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -123, -68, -59, 62, -5, 81, 86, 56, 92, -126, 113, -36, -30, 125, 98, 94
    };
    ...
    int16_t golden[] = {
    1, 65468, 125, 81, 30, 126, 86, 56, 92, 36, 113, 29, 65506, 125, 98, 94
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
