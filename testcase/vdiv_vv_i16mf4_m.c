...
int main(){
    const int16_t data1[] = {
    14, 2, 32, -87, -33, -115, -98, -88, 115, 49, 118, 67, 89, -30, -85, -97
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    118, 93, -99, -35, 39, 45, -20, 81, -58, -53, 76, 33, -116, -78, 54, 125
    };
    ...
    int16_t golden[] = {
    8, 1, 65532, 1, 65534, 0, 0, 65535, 65535, 1, 0, 1, 0, 2, 65535, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
