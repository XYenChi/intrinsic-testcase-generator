...
int main(){
    ...
    74, 51, 89, 157, 251, 1, 179, 46, 126, 255, 144, 98, 17, 149, 134, 147
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    26, 179, 184, 38, 74, 8, 63, 107, 212, 116, 253, 175, 246, 193, 52, 227
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u16m2 (data1_v, data2_v, vl);
