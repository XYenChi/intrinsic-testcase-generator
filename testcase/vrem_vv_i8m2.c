...
int main(){
    const int8_t data1[] = {
    129, 154, 91, 235, 35, 76, 70, 197, 215, 143, 102, 116, 54, 70, 89, 32
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    255, 99, 147, 223, 231, 41, 138, 47, 105, 88, 190, 93, 33, 222, 16, 248
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vrem_vv_i8m2 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    126, 99, 56, 223, 21, 41, 68, 47, 105, 88, 88, 93, 33, 12, 16, 24
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
