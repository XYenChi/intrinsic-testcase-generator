...
int main(){
    ...
    202, 48, 182, 209, 109, 244, 25, 161, 249, 33, 204, 43, 227, 149, 128, 179
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    5, 171, 106, 95, 63, 209, 81, 62, 14, 25, 27, 59, 61, 237, 146, 123
    };
    ...
    uint16_t golden[] = {
    197, 65413, 182, 114, 46, 244, 25, 161, 235, 8, 177, 43, 166, 149, 128, 56
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
