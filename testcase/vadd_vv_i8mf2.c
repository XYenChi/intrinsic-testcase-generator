...
int main(){
    const int8_t data1[] = {
    -76, 70, 112, 26, 105, -63, -47, -64, 60, 18, 32, 60, -49, 104, -22, 112
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    54, -26, 9, -104, 95, 29, 115, -96, 81, -55, 11, -123, 28, 43, -98, 101
    };
    ...
    int8_t golden[] = {
    234, 44, 121, 178, 200, 222, 68, 96, 141, 219, 43, 193, 235, 147, 136, 213
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
