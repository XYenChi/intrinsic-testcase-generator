...
int main(){
    const int8_t data1[] = {
    37, 85, 13, -82, -22, -81, -21, 100, 104, 90, -117, 103, 115, 81, -95, 119
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -110, -54, 95, -21, 51, 108, 97, 96, 122, -94, 17, 19, -32, -116, -116, 3
    };
    ...
    int8_t golden[] = {
    183, 31, 108, 153, 29, 27, 76, 196, 226, 252, 156, 122, 83, 221, 45, 122
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
