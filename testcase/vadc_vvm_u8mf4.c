...
int main(){
    const uint8_t data1[] = {
    58, 59, 22, 88, 34, 26, 163, 7, 210, 222, 144, 45, 159, 65, 110, 89
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    36, 125, 73, 216, 188, 98, 139, 60, 212, 5, 44, 78, 33, 151, 234, 218
    };
    ...
    uint8_t golden[] = {
    94, 185, 96, 305, 223, 125, 303, 68, 422, 227, 189, 124, 192, 216, 345, 307
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
