...
int main(){
    const int8_t data1[] = {
    39, -102, 6, -61, 64, -94, -79, -60, -16, 74, 124, -16, -8, 124, -42, 35
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -12, -8, -49, -100, 118, -113, -115, 46, -62, 112, 63, 17, 27, 112, 63, 44
    };
    ...
    int8_t golden[] = {
    39, 248, 6, 195, 118, 162, 177, 46, 240, 112, 124, 17, 27, 124, 63, 44
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
