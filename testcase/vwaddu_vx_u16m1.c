...
int main(){
    ...
    75, 167, 255, 61, 24, 231, 16, 71, 119, 201, 81, 250, 15, 228, 5, 149
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    173, 244, 23, 127, 92, 47, 121, 109, 16, 1, 16, 46, 110, 127, 224, 219
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u16m1 (data1_v, data2_v, vl);
