...
int main(){
    const uint8_t data1[] = {
    126, 37, 49, 132, 56, 107, 135, 86, 58, 142, 215, 52, 40, 186, 57, 119
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    221, 216, 247, 0, 10, 38, 30, 3, 202, 69, 172, 42, 216, 94, 50, 113
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wx_8m4u_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    0, 253, 0, 132, 58, 0, 0, 0, 250, 207, 1, 62, 1, 254, 59, 119
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
