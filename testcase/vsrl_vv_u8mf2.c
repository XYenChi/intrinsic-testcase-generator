...
int main(){
    const uint8_t data1[] = {
    224, 203, 171, 113, 107, 60, 1, 94, 26, 181, 199, 203, 91, 98, 148, 98
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    230, 198, 224, 129, 243, 222, 81, 193, 91, 118, 240, 157, 193, 110, 59, 61
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u8mf2 (data1_v, shift, vl);
