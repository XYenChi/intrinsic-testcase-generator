...
int main(){
    ...
    56, 20, 126, 242, 224, 15, 59, 120, 109, 192, 83, 169, 82, 216, 111, 42
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    108, 225, 121, 77, 250, 36, 55, 186, 130, 106, 139, 161, 26, 193, 164, 37
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vv_i16m2 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    1, 11, 0, 0, 1, 2, 0, 1, 1, 0, 1, 0, 0, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
