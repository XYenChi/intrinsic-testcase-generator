...
int main(){
    const int32_t data1[] = {
    122, 64, -113, 81, 91, 90, -117, -116, 40, 100, 16, -70, 118, -24, 107, -27
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    48, -123, -8, 45, 97, 22, -104, 10, 43, -22, 66, 96, 73, -67, -37, -2
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccus_vx_i32m8_m (mask, out_data, data1_v, data2_v, vl);
