...
int main(){
    ...
    211, 10, 228, 230, 193, 171, 31, 34, 110, 168, 161, 205, 189, 245, 196, 94
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    174, 40, 21, 63, 123, 15, 17, 52, 130, 195, 108, 164, 133, 136, 142, 74
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulu_vx_u16m1_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    0, 400, 1, 14490, 23739, 2565, 527, 0, 0, 1, 17388, 0, 25137, 1, 27832, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
