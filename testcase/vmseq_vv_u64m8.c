...
int main(){
    ...
    3, 122, 180, 210, 199, 239, 32, 66, 184, 161, 229, 196, 25, 47, 179, 114
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    130, 120, 127, 105, 42, 232, 179, 204, 157, 154, 58, 152, 162, 30, 70, 222
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_64m8_b8 (data1_v, data2_v, vl);
