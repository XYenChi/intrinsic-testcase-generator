...
int main(){
    const int32_t data1[] = {
    -106, 63, -120, -92, 71, -84, 46, -12, -9, 61, 103, -24, -46, 103, -67, 48
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    113, -92, -64, -20, -31, -117, 70, 30, -99, 4, 12, 15, -122, -28, 52, 88
    };
    ...
    int32_t golden[] = {
    7, 4294967267, 4294967112, 4294967184, 40, 4294967095, 116, 18, 4294967188, 65, 115, 4294967287, 4294967128, 75, 4294967281, 136
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
