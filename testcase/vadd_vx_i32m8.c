...
int main(){
    const int32_t data1[] = {
    -126, 68, 117, 68, 30, 45, 80, -101, 26, -6, 16, -77, 126, 56, 115, -76
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    111, -100, 56, 105, -2, -33, -113, 16, -7, -80, 97, -66, -86, -124, -42, 113
    };
    ...
    int32_t golden[] = {
    4294967281, 4294967264, 173, 173, 28, 12, 4294967263, 4294967211, 19, 4294967210, 113, 4294967153, 40, 4294967228, 73, 37
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
