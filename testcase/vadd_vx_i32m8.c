...
int main(){
    const int32_t data1[] = {
    -92, 93, 46, -120, 21, -17, 35, 47, -59, -43, -32, 12, -116, -51, -19, -113
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -42, -37, 119, 48, 121, -72, -68, -60, 40, 56, 16, 86, -44, 107, -71, -78
    };
    ...
    int32_t golden[] = {
    -128, 56, 127, -72, 127, -89, -33, -13, -19, 13, -16, 98, -128, 56, -90, -128
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
