...
int main(){
    const int32_t data1[] = {
    -98, -110, -86, 107, 35, -66, -64, -35, -73, -36, -63, 31, -94, -60, 38, -64
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    88, -15, -50, -74, -5, 109, -51, -119, 106, 60, -39, 8, -79, 104, -61, 2
    };
    ...
    int32_t golden[] = {
    4294967286, 4294967171, 4294967160, 33, 30, 43, 4294967181, 4294967142, 33, 24, 4294967194, 39, 4294967123, 44, 4294967273, 4294967234
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
