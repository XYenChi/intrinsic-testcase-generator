...
int main(){
    const uint8_t data1[] = {
    255, 153, 206, 188, 52, 87, 62, 126, 213, 12, 157, 152, 58, 230, 209, 190
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    45, 14, 183, 245, 132, 166, 91, 253, 212, 182, 6, 13, 38, 120, 195, 196
    };
    ...
    uint8_t golden[] = {
    1, 139, 23, 1, 0, 177, 1, 1, 1, 1, 151, 139, 0, 110, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
