...
int main(){
    const int8_t data1[] = {
    -70, -37, 61, -64, -59, -68, -1, 18, 69, -40, 38, 79, -98, 58, 23, -51
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -109, 65, -106, -23, -77, 47, -109, 56, 45, 104, 42, -9, 12, -13, 117, 90
    };
    ...
    int8_t golden[] = {
    217, 102, 89, 41, 238, 115, 148, 38, 232, 144, 4, 168, 110, 185, 94, 141
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
