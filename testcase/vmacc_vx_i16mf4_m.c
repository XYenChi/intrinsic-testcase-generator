...
int main(){
    const int16_t data1[] = {
    -29, 107, 123, 33, -21, -107, 4, 83, 87, -121, -104, 87, -22, 112, 127, -44
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -82, 70, -96, -103, 4, -8, 121, -4, 125, 101, 57, -83, -72, -75, -100, 105
    };
    ...
    int16_t golden[] = {
    2379, 7491, 1, 62138, 0, 0, 484, 1, 1, 0, 59609, 1, 1, 0, 52836, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
