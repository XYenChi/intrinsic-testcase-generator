...
int main(){
    const int32_t data1[] = {
    -70, 29, -82, 82, -12, -47, -46, -68, -53, 73, 68, -45, -51, 41, 23, -49
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -13, 49, -45, -21, -47, -24, -40, 118, 112, -59, 123, -33, 97, -97, -33, 100
    };
    ...
    int32_t golden[] = {
    0, 49, 4294967251, 1, 4294967284, 1, 1, 118, 0, 73, 1, 4294967263, 0, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
