...
int main(){
    const int32_t data1[] = {
    -64, 44, -51, -111, -28, -79, 65, 42, -20, 104, 48, -65, -35, 36, 5, 121
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -70, -32, 19, -35, -33, 7, 98, -84, 78, -84, -56, -31, -101, 4, 61, -97
    };
    ...
    int32_t golden[] = {
    4294967232, 0, 19, 4294967261, 4294967268, 7, 98, 0, 78, 104, 0, 1, 0, 36, 1, 121
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
