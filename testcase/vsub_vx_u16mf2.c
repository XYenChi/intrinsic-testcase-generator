...
int main(){
    ...
    64, 216, 245, 208, 72, 46, 155, 237, 210, 37, 165, 209, 147, 47, 115, 9
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    144, 115, 134, 64, 224, 66, 156, 92, 96, 123, 82, 123, 6, 71, 162, 170
    };
    ...
    uint16_t golden[] = {
    65456, 101, 111, 144, 65384, 65516, 65535, 145, 114, 65450, 83, 86, 141, 65512, 65489, 65375
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
