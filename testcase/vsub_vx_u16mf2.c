...
int main(){
    ...
    79, 248, 174, 188, 219, 74, 201, 213, 214, 75, 25, 174, 127, 224, 12, 154
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    194, 165, 49, 232, 100, 123, 59, 160, 62, 170, 169, 181, 243, 61, 142, 143
    };
    ...
    uint16_t golden[] = {
    65421, 83, 125, 65492, 119, 65487, 142, 53, 152, 65441, 65392, 65529, 65420, 163, 65406, 11
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
