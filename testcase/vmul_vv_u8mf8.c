...
int main(){
    const uint8_t data1[] = {
    83, 118, 119, 36, 98, 153, 238, 51, 111, 215, 199, 166, 65, 176, 63, 105
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    145, 157, 109, 212, 179, 18, 123, 208, 113, 168, 230, 204, 83, 191, 170, 237
    };
    ...
    uint8_t golden[] = {
    3, 94, 171, 208, 134, 194, 90, 112, 255, 24, 202, 72, 19, 80, 214, 53
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
