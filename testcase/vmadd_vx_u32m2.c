...
int main(){
    ...
    3, 238, 69, 202, 91, 130, 179, 236, 136, 186, 116, 17, 238, 145, 245, 183
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    178, 244, 248, 168, 23, 177, 182, 227, 66, 193, 196, 201, 120, 101, 138, 185
    };
    ...
    uint32_t golden[] = {
    181, 244, 248, 370, 114, 177, 361, 227, 66, 193, 312, 201, 358, 246, 383, 185
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
