...
int main(){
    const int64_t data1[] = {
    10, 50, 13, 30, 111, 87, -101, -115, 27, -62, 29, -59, -11, 117, -57, -53
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    39, 56, 10, 42, -51, -100, -101, -32, 127, 102, 104, 96, 102, -127, -30, 6
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vv_64m1_b64 (data1_v, data2_v, vl);
