...
int main(){
    ...
    107, 119, 166, 148, 54, 249, 180, 64, 124, 37, 149, 182, 213, 160, 77, 31
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    197, 133, 171, 186, 202, 180, 134, 105, 103, 35, 104, 237, 246, 87, 116, 58
    };
    ...
    uint16_t golden[] = {
    197, 1, 1, 0, 1, 180, 1, 105, 103, 35, 104, 237, 1, 87, 0, 58
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
