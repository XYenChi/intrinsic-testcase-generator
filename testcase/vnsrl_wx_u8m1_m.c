...
int main(){
    const uint8_t data1[] = {
    165, 170, 184, 218, 226, 99, 85, 241, 106, 13, 152, 193, 95, 160, 6, 255
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    73, 57, 163, 179, 239, 225, 68, 3, 98, 88, 215, 182, 108, 8, 181, 2
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_8m1_m (mask, data1_v, shift, vl);
