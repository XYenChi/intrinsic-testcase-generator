...
int main(){
    const int16_t data1[] = {
    -32, -98, -97, -85, 11, 74, -115, 70, 59, -53, -17, -102, -78, 51, -109, 60
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -1, -73, 70, -125, 120, 122, -103, -94, -21, -84, -82, 38, -55, 58, -19, 111
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_16mf2_b32 (data1_v, data2_v, vl);
