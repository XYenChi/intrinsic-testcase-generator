...
int main(){
    ...
    233, 33, 93, 46, 101, 23, 95, 18, 74, 247, 218, 109, 26, 20, 158, 169
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    157, 43, 41, 123, 45, 120, 118, 45, 39, 90, 123, 254, 52, 143, 58, 52
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u16m2 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    157, 10, 41, 31, 45, 5, 23, 9, 39, 90, 123, 36, 0, 3, 58, 52
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
