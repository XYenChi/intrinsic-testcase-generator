...
int main(){
    ...
    69, 63, 205, 147, 204, 247, 171, 234, 116, 57, 220, 124, 61, 192, 215, 9
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    6, 211, 164, 163, 181, 135, 76, 250, 108, 192, 62, 139, 25, 143, 216, 182
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u64m4_m (mask, data1_v, shift, vl);
    ...
    uint64_t golden[] = {
    69, 31, 205, 73, 102, 123, 171, 234, 116, 57, 220, 62, 30, 96, 215, 9
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
