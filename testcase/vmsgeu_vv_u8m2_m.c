...
int main(){
    const uint8_t data1[] = {
    69, 252, 56, 18, 76, 28, 92, 163, 66, 193, 147, 197, 185, 235, 180, 201
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    5, 80, 53, 169, 160, 195, 221, 200, 107, 176, 191, 210, 244, 102, 238, 48
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_8m2_b4 (mask, data1_v, data2_v, vl);
