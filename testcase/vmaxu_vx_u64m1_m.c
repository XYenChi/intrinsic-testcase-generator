...
int main(){
    ...
    69, 168, 198, 41, 186, 252, 176, 197, 74, 243, 140, 202, 201, 97, 239, 13
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    219, 170, 161, 194, 216, 254, 53, 234, 141, 173, 47, 224, 45, 16, 201, 46
    };
    ...
    uint64_t golden[] = {
    1, 170, 198, 1, 216, 254, 1, 0, 141, 1, 1, 1, 0, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
