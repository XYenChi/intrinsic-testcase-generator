...
int main(){
    const int32_t data1[] = {
    -46, -104, 73, 53, 21, 33, -89, 16, -3, 102, 87, -54, 60, 78, -56, -59
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    76, 42, 96, -69, 97, -7, 120, 73, 46, -44, 15, -63, 3, 122, -24, -78
    };
    ...
    int32_t golden[] = {
    76, 42, 96, 53, 97, 33, 120, 73, 46, 102, 87, 4294967242, 60, 122, 4294967272, 4294967237
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
