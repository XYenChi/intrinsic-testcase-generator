...
int main(){
    const int32_t data1[] = {
    -54, 24, -38, 95, -56, 107, 46, 17, 30, -41, -84, 20, 120, 5, -55, -42
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    42, -113, -28, 100, 41, 117, -44, 66, -128, 100, 14, -80, -52, 45, -13, -47
    };
    ...
    int32_t golden[] = {
    42, 24, 4294967268, 100, 41, 117, 46, 66, 30, 100, 14, 20, 120, 45, 4294967283, 4294967254
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
