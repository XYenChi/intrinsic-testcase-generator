...
int main(){
    const uint8_t data1[] = {
    94, 141, 153, 181, 157, 253, 27, 207, 45, 110, 19, 112, 140, 230, 16, 204
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    160, 114, 47, 80, 245, 84, 98, 185, 119, 105, 133, 0, 247, 3, 54, 180
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_8m1_b8 (data1_v, data2_v, vl);
