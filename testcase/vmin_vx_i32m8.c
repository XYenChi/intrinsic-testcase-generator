...
int main(){
    const int32_t data1[] = {
    11, -39, -108, -20, 60, 48, -74, 53, 33, -22, -26, -123, 87, 111, -62, 37
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -68, -20, 95, -69, 124, 77, -12, -115, -14, 27, -115, 85, -41, -21, -72, 66
    };
    ...
    int32_t golden[] = {
    11, 4294967276, 95, 4294967276, 124, 77, 4294967284, 53, 33, 27, 4294967270, 85, 87, 111, 4294967234, 66
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
