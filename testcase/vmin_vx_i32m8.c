...
int main(){
    const int32_t data1[] = {
    31, 6, -122, -27, -2, -96, -33, 29, -53, 23, 111, -3, -51, 2, 104, 116
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -64, 1, 9, 0, -39, -11, 103, 33, -115, 71, 111, -100, 57, -64, 24, 127
    };
    ...
    int32_t golden[] = {
    31, 6, 9, 0, 4294967294, 4294967285, 103, 33, 4294967243, 71, 111, 4294967293, 57, 2, 104, 127
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
