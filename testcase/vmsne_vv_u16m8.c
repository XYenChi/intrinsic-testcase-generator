...
int main(){
    ...
    251, 11, 237, 77, 5, 167, 137, 157, 19, 100, 26, 4, 226, 242, 162, 234
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    119, 178, 142, 58, 244, 209, 57, 39, 100, 23, 31, 188, 166, 247, 31, 210
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_16m8_b2 (data1_v, data2_v, vl);
