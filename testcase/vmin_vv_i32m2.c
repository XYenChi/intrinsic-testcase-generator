...
int main(){
    const int32_t data1[] = {
    48, 85, 74, 7, -112, 68, -64, 8, -67, 95, 33, 58, -37, -50, -41, -2
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    84, -52, -19, 72, 68, 127, -86, -123, 40, -76, -68, 58, 13, -8, 1, -97
    };
    ...
    int32_t golden[] = {
    84, 85, 74, 72, 68, 127, 4294967232, 8, 40, 95, 33, 58, 13, 4294967288, 1, 4294967294
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
