...
int main(){
    const uint8_t data1[] = {
    170, 146, 178, 39, 250, 137, 122, 128, 215, 190, 170, 67, 83, 85, 141, 241
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    24, 52, 166, 221, 59, 128, 216, 23, 89, 227, 69, 108, 233, 45, 247, 253
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_8m1_b8 (data1_v, data2_v, vl);
