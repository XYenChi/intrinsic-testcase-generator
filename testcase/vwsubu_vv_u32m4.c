...
int main(){
    ...
    172, 171, 62, 64, 163, 97, 175, 80, 107, 132, 120, 166, 10, 57, 163, 218
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    124, 11, 210, 174, 120, 131, 120, 12, 135, 132, 93, 30, 158, 56, 63, 69
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u32m4 (data1_v, data2_v, vl);
