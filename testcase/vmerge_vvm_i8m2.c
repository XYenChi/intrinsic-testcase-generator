...
int main(){
    const int8_t data1[] = {
    -118, 122, 11, -34, -84, -122, -6, -63, 100, 73, -78, -1, -82, -109, -20, -115
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    29, -42, -19, 104, 95, 22, 101, 94, 71, 112, 76, 7, -85, -14, 64, -45
    };
    ...
    int8_t golden[] = {
    29, 122, 11, 104, -84, 22, 101, 94, 100, 73, 76, 7, -85, -14, -20, -45
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
