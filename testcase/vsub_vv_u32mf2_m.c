...
int main(){
    ...
    183, 49, 169, 113, 28, 251, 30, 140, 70, 24, 219, 167, 16, 217, 23, 20
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    54, 44, 33, 21, 207, 176, 206, 68, 103, 231, 63, 234, 80, 56, 231, 2
    };
    ...
    uint32_t golden[] = {
    0, 0, 136, 92, 4294967117, 75, 4294967120, 0, 4294967263, 4294967089, 1, 4294967229, 1, 0, 4294967088, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
