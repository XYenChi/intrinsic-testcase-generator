...
int main(){
    const int32_t data1[] = {
    110, 122, 63, 94, -26, -16, -57, 77, 12, -53, 81, 88, -37, -83, 37, 72
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    62, 34, 44, 28, 1, -94, -50, 119, 69, 37, -87, -77, -89, 118, 100, -63
    };
    ...
    int32_t golden[] = {
    0, 0, 0, 0, 4294967295, 5, 0, 1, 5, 4294967295, 4294967294, 4294967295, 2, 4294967294, 2, 4294967295
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
