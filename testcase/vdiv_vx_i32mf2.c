...
int main(){
    const int32_t data1[] = {
    -6, -118, 11, 29, -21, 26, 96, 50, -76, -83, -67, 70, -17, -40, 122, -40
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    92, -111, 24, 37, -29, 91, 99, -100, -115, -76, -10, 125, 33, 0, 100, -109
    };
    ...
    int32_t golden[] = {
    4294967280, 0, 2, 1, 1, 3, 1, 4294967294, 1, 0, 0, 1, 4294967294, 0, 0, 2
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
