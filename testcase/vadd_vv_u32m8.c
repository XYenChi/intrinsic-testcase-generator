...
int main(){
    ...
    126, 182, 16, 222, 240, 17, 214, 67, 255, 255, 3, 132, 140, 65, 61, 106
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    16, 76, 69, 114, 83, 104, 37, 248, 56, 146, 168, 140, 203, 113, 36, 58
    };
    ...
    uint32_t golden[] = {
    142, 258, 85, 336, 323, 121, 251, 315, 311, 401, 171, 272, 343, 178, 97, 164
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
