...
int main(){
    ...
    97, 169, 229, 109, 193, 120, 35, 45, 73, 108, 192, 27, 203, 230, 230, 57
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    245, 5, 45, 218, 46, 40, 254, 241, 184, 210, 254, 244, 131, 193, 165, 36
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_64m8_b8 (data1_v, data2_v, vl);
