...
int main(){
    const int32_t data1[] = {
    119, -18, 42, 38, -59, 24, 42, -5, -98, 57, -66, -99, -65, -79, 77, -65
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -94, -33, 77, 115, -109, -32, -65, 97, 55, 55, -3, 41, 71, -125, 52, 79
    };
    ...
    int32_t golden[] = {
    25, 4294967245, 119, 153, 4294967128, 4294967288, 4294967273, 92, 4294967253, 112, 4294967227, 4294967238, 6, 4294967092, 129, 14
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
