...
int main(){
    const int32_t data1[] = {
    -74, -54, 41, -63, -111, 25, -48, -13, 31, 41, 86, -92, 45, 21, -106, -30
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    91, 118, -9, -30, -83, -9, -125, 74, 71, 120, 45, -109, 90, 93, 2, 120
    };
    ...
    int32_t golden[] = {
    17, 64, 32, -93, -128, 16, -128, 61, 102, 127, 127, -128, 127, 114, -104, 90
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
