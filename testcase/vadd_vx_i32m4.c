...
int main(){
    const int32_t data1[] = {
    24, -51, 82, -43, 120, -76, -96, -90, -71, 69, 89, -119, 91, 75, -29, -101
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    59, 98, -4, 43, 10, 57, 111, -36, 78, 63, -66, -14, 13, 72, 109, 22
    };
    ...
    int32_t golden[] = {
    83, 47, 78, 0, 130, 4294967277, 15, 4294967170, 7, 132, 23, 4294967163, 104, 147, 80, 4294967217
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
