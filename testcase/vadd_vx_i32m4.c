...
int main(){
    const int32_t data1[] = {
    -41, -91, 63, 40, -84, 9, 58, -34, -98, -17, 54, -84, -100, 118, 60, 64
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -57, 94, 43, -31, -49, -125, 68, -22, -116, 89, 116, 96, -89, 55, -27, -24
    };
    ...
    int32_t golden[] = {
    4294967198, 3, 106, 9, 4294967163, 4294967180, 126, 4294967240, 4294967082, 72, 170, 12, 4294967107, 173, 33, 40
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
