...
int main(){
    const uint8_t data1[] = {
    41, 124, 163, 232, 219, 114, 90, 37, 236, 17, 90, 194, 217, 30, 128, 18
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    44, 28, 91, 34, 133, 97, 180, 32, 123, 28, 61, 14, 82, 121, 216, 239
    };
    ...
    uint8_t golden[] = {
    12, 144, 241, 208, 199, 50, 1, 1, 100, 1, 114, 156, 130, 46, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
