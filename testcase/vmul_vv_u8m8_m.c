...
int main(){
    const uint8_t data1[] = {
    23, 76, 34, 209, 68, 44, 168, 218, 49, 42, 84, 226, 23, 206, 175, 186
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    46, 2, 226, 156, 239, 212, 45, 30, 207, 221, 140, 41, 125, 179, 100, 11
    };
    ...
    uint8_t golden[] = {
    34, 152, 0, 92, 124, 112, 1, 0, 159, 66, 0, 1, 0, 1, 92, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
