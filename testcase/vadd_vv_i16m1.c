...
int main(){
    const int16_t data1[] = {
    -125, 31, 40, -95, 21, -95, -123, 116, -66, -73, 10, -4, 4, 69, -100, 104
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    59, 122, -37, 50, -34, -105, 70, 39, 28, -83, 108, -86, -10, -46, 105, 82
    };
    ...
    int16_t golden[] = {
    65470, 153, 3, 65491, 65523, 65336, 65483, 155, 65498, 65380, 118, 65446, 65530, 23, 5, 186
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
