...
int main(){
    const int16_t data1[] = {
    98, -61, -45, -57, 50, -96, -117, -42, -124, 114, 126, -89, -113, -118, 36, 33
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -21, 47, -76, 96, -50, -87, -38, -91, -120, -55, 26, 76, -26, 3, -91, 47
    };
    ...
    int16_t golden[] = {
    77, 65522, 65415, 39, 0, 65353, 65381, 65403, 65292, 59, 152, 65523, 65397, 65421, 65481, 80
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
