...
int main(){
    ...
    81, 17, 27, 66, 184, 199, 104, 147, 234, 58, 6, 70, 254, 25, 194, 66
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    149, 83, 237, 249, 103, 43, 253, 142, 48, 217, 182, 73, 253, 164, 108, 242
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsub_vx_u16m1_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    0, 0, 1, 66, 184, 156, 1, 147, 1, 0, 0, 0, 254, 0, 86, 65360
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
