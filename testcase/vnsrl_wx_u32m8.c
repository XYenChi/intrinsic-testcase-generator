...
int main(){
    ...
    220, 248, 179, 216, 82, 58, 142, 242, 247, 10, 50, 170, 52, 56, 70, 19
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    27, 127, 168, 115, 252, 189, 84, 216, 14, 164, 123, 23, 112, 250, 91, 223
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_32m8 (data1_v, shift, vl);
