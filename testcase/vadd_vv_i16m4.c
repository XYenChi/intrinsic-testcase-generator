...
int main(){
    const int16_t data1[] = {
    -54, -74, -99, 107, -28, -44, -64, -93, 0, -93, -113, 45, 58, -92, 4, -128
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    124, -61, 72, -29, -128, 118, -59, -49, 7, 44, 93, 112, 15, -69, 109, 17
    };
    ...
    int16_t golden[] = {
    70, -128, -27, 78, -128, 74, -123, -128, 7, -49, -20, 127, 73, -128, 113, -111
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
