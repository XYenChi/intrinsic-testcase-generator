...
int main(){
    const int16_t data1[] = {
    -96, -39, 117, -57, -88, 1, -58, -1, 20, -103, -120, 54, -36, 118, -5, -31
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    71, -118, 88, -17, -77, 81, -86, -101, -86, -65, 72, -84, 25, 43, 23, 9
    };
    ...
    int16_t golden[] = {
    65511, 65379, 205, 65462, 65371, 82, 65392, 65434, 65470, 65368, 65488, 65506, 65525, 161, 18, 65514
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
