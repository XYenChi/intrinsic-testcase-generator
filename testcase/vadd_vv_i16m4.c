...
int main(){
    const int16_t data1[] = {
    -121, 92, 118, 57, 69, 71, -51, 73, -53, 23, -25, 62, 93, -47, 100, 55
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    117, -81, -56, -31, 126, -78, -21, 14, 54, -15, -95, -85, -45, 95, 18, 83
    };
    ...
    int16_t golden[] = {
    65532, 11, 62, 26, 195, 65529, 65464, 87, 1, 8, 65416, 65513, 48, 48, 118, 138
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
