...
int main(){
    const int8_t data1[] = {
    -9, 32, 44, 113, -98, 97, -77, -104, -12, -116, 66, -16, 70, 113, -106, -69
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    32, -126, -73, -121, -125, -112, 68, -20, -20, 120, -8, -47, -63, -128, 23, -34
    };
    ...
    int8_t golden[] = {
    225, 64, 116, 151, 218, 145, 140, 33, 240, 161, 240, 240, 198, 129, 123, 43
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
