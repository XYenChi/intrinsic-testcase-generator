...
int main(){
    const int8_t data1[] = {
    85, -37, -108, 126, 107, 29, 79, 44, -17, -73, 37, -36, -26, -77, -14, -11
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    101, -126, -61, 99, 7, -123, 125, 15, -20, -121, -26, 97, 0, 38, -70, -16
    };
    ...
    int8_t golden[] = {
    137, 54, 188, 187, 237, 18, 148, 148, 84, 129, 63, 92, 1, 146, 212, 176
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
