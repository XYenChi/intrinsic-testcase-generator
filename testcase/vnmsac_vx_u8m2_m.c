...
int main(){
    const uint8_t data1[] = {
    0, 134, 103, 35, 23, 245, 108, 241, 216, 96, 226, 50, 5, 30, 162, 92
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    17, 225, 38, 251, 42, 98, 15, 166, 166, 108, 207, 57, 249, 84, 96, 185
    };
    ...
    uint8_t golden[] = {
    0, 58, 183, 0, 0, 54, 0, 186, 241, 128, 1, 223, 35, 41, 1, 132
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
