...
int main(){
    ...
    143, 168, 163, 38, 166, 89, 64, 21, 36, 91, 218, 140, 88, 194, 81, 199
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    248, 250, 122, 14, 171, 255, 196, 5, 195, 132, 174, 79, 250, 171, 199, 137
    };
    ...
    uint64_t golden[] = {
    248, 250, 163, 38, 171, 255, 196, 21, 195, 132, 218, 140, 250, 194, 199, 199
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
