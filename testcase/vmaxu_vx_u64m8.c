...
int main(){
    ...
    236, 135, 221, 70, 239, 133, 159, 102, 106, 117, 193, 105, 70, 88, 198, 99
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    164, 103, 34, 72, 92, 219, 215, 169, 156, 51, 202, 83, 185, 30, 226, 70
    };
    ...
    uint64_t golden[] = {
    236, 135, 221, 72, 239, 219, 215, 169, 156, 117, 202, 105, 185, 88, 226, 99
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
