...
int main(){
    ...
    128, 184, 103, 80, 197, 235, 32, 196, 172, 51, 127, 71, 173, 69, 234, 76
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    32, 121, 32, 145, 86, 205, 46, 238, 251, 228, 61, 211, 76, 62, 99, 92
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u32mf2_m (mask, data1_v, data2_v, vl);
