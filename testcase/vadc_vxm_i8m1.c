...
int main(){
    const int8_t data1[] = {
    98, -59, 59, -114, 122, 92, 34, -115, -109, -18, 71, -53, 61, -102, -118, 58
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -39, -36, 42, 8, -15, 39, 50, -13, 56, -118, -1, 12, 51, 73, 1, -125
    };
    ...
    int8_t golden[] = {
    59, -95, 101, -105, 107, 132, 85, -127, -53, -136, 71, -40, 112, -29, -117, -66
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
