...
int main(){
    const int32_t data1[] = {
    24, 89, -72, -31, 54, 69, -70, -81, 24, 59, -53, -62, 109, 97, 85, 55
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    75, 127, -102, 105, -26, -61, 46, 67, -77, 20, -7, -112, -67, -125, 43, 88
    };
    ...
    int32_t golden[] = {
    4294967245, 4294967258, 30, 4294967160, 80, 130, 4294967180, 4294967148, 101, 39, 4294967250, 50, 176, 222, 42, 4294967263
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
