...
int main(){
    const int32_t data1[] = {
    42, -45, -79, -18, 108, 29, 12, -10, 86, -100, 101, 32, -29, 120, -103, -19
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -63, -65, -116, 95, 116, -89, -94, -26, 0, 115, -44, -110, 2, 80, 119, -47
    };
    ...
    int32_t golden[] = {
    105, 20, 37, -113, -8, 118, 106, 16, 86, -128, 127, 127, -31, 40, -128, 28
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
