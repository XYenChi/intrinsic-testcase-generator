...
int main(){
    ...
    220, 72, 253, 253, 126, 4, 228, 214, 15, 176, 19, 204, 110, 4, 97, 212
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    42, 143, 140, 2, 113, 227, 21, 234, 243, 43, 77, 169, 53, 63, 236, 58
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i16m4 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    0, 1, 0, 0, 0, 56, 0, 1, 16, 0, 4, 0, 0, 15, 2, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
