...
int main(){
    const int32_t data1[] = {
    52, 80, 7, -67, 45, 24, -19, -38, 35, -98, -17, 40, -68, 92, -115, -57
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -103, 63, 32, -44, -119, 17, -39, -88, -125, 89, 3, -1, 100, -76, -33, 25
    };
    ...
    int32_t golden[] = {
    52, 80, 32, 4294967252, 45, 24, 4294967277, 4294967258, 35, 89, 3, 40, 100, 92, 4294967263, 25
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
