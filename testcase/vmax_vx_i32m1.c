...
int main(){
    const int32_t data1[] = {
    31, 48, -114, -41, 0, -106, 52, 51, -69, -33, 35, 0, 114, 39, 47, 2
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -34, 120, 53, -116, -53, 6, -19, 23, -113, -88, -57, 2, -88, 101, -8, -97
    };
    ...
    int32_t golden[] = {
    31, 120, 53, 4294967255, 0, 6, 52, 51, 4294967227, 4294967263, 35, 2, 114, 101, 47, 2
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
