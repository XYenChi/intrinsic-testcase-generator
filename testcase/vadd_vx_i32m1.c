...
int main(){
    const int32_t data1[] = {
    -9, -75, -9, 98, 120, -83, -55, -126, 31, -10, -28, 68, -87, 58, 122, -65
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -76, -123, -97, 109, -5, 98, -107, -120, 5, 123, 73, -28, 116, -64, 37, -31
    };
    ...
    int32_t golden[] = {
    4294967211, 4294967098, 4294967190, 207, 115, 15, 4294967134, 4294967050, 36, 113, 45, 40, 29, 4294967290, 159, 4294967200
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
