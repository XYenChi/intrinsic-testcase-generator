...
int main(){
    const int32_t data1[] = {
    15, 118, -45, 27, -12, 31, 89, 2, -21, 107, -66, 39, -91, 59, 123, 40
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -117, 4, 106, 8, -110, 15, 65, 116, -58, -65, 113, 82, 5, 54, -6, -26
    };
    ...
    int32_t golden[] = {
    4294967194, 122, 61, 35, 4294967174, 46, 154, 118, 4294967217, 42, 47, 121, 4294967210, 113, 117, 14
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
