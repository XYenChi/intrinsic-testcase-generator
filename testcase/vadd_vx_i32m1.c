...
int main(){
    const int32_t data1[] = {
    -68, 107, 73, 35, 7, -42, -127, -109, -125, 4, 107, -78, 12, 10, 52, 32
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    91, 92, 83, 42, -44, -27, 78, -25, -85, 27, 84, -39, 45, 84, 107, -96
    };
    ...
    int32_t golden[] = {
    23, 127, 127, 77, -37, -69, -49, -128, -128, 31, 127, -117, 57, 94, 127, -64
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
