...
int main(){
    const int32_t data1[] = {
    -119, 29, -97, -116, -112, 120, -12, 3, 25, -37, 63, 52, -121, 4, 44, -78
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -61, -28, -61, -116, 77, 8, 111, 102, 91, -108, 122, 76, -23, -10, -71, -98
    };
    ...
    int32_t golden[] = {
    4294967116, 1, 4294967138, 4294967064, 4294967261, 128, 99, 105, 116, 4294967151, 185, 128, 4294967152, 4294967290, 4294967269, 4294967120
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
