...
int main(){
    ...
    134, 35, 133, 15, 206, 187, 156, 94, 152, 238, 152, 229, 135, 86, 43, 2
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    60, 84, 234, 203, 74, 41, 33, 51, 17, 39, 181, 20, 164, 117, 26, 34
    };
    ...
    uint32_t golden[] = {
    134, 84, 234, 203, 1, 187, 156, 94, 1, 238, 1, 229, 164, 1, 1, 34
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
