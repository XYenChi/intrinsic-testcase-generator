...
int main(){
    ...
    242, 57, 141, 185, 122, 234, 243, 219, 44, 67, 234, 207, 168, 64, 196, 135
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    167, 59, 252, 40, 5, 134, 190, 167, 130, 47, 129, 227, 117, 80, 215, 56
    };
    ...
    uint32_t golden[] = {
    0, 0, 1, 0, 122, 0, 0, 1, 0, 67, 234, 0, 1, 80, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
