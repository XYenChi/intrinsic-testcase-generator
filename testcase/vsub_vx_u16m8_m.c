...
int main(){
    ...
    82, 5, 234, 182, 68, 209, 132, 9, 184, 154, 150, 165, 38, 9, 183, 102
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    227, 149, 60, 215, 128, 148, 19, 143, 174, 213, 78, 74, 118, 26, 184, 141
    };
    ...
    uint16_t golden[] = {
    1, 1, 1, 1, 0, 0, 113, 1, 0, 0, 72, 0, 0, 0, 1, 65497
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
