...
int main(){
    const int8_t data1[] = {
    -16, 24, -27, 91, 106, 75, 56, 0, -84, -106, -69, -16, 122, 55, 30, 55
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -101, 59, -103, 70, 24, 99, 126, 71, -51, -78, -116, -88, -76, 55, -30, 90
    };
    ...
    int8_t golden[] = {
    240, 59, 229, 91, 106, 99, 126, 71, 205, 178, 187, 240, 122, 55, 30, 90
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
