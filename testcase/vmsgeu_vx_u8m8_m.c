...
int main(){
    const uint8_t data1[] = {
    208, 1, 6, 235, 154, 5, 9, 216, 111, 99, 248, 217, 34, 0, 144, 153
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    150, 253, 138, 64, 203, 167, 173, 34, 88, 86, 250, 58, 186, 224, 195, 64
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_8m8_b1 (mask, data1_v, data2_v, vl);
