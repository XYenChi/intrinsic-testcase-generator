...
int main(){
    ...
    91, 92, 66, 245, 116, 69, 58, 146, 183, 25, 57, 147, 169, 166, 156, 29
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    81, 5, 94, 212, 234, 152, 72, 60, 211, 144, 21, 102, 110, 244, 224, 203
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_32m4_b8 (data1_v, data2_v, vl);
