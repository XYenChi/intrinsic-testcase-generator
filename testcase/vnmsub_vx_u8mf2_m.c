...
int main(){
    const uint8_t data1[] = {
    243, 19, 78, 189, 222, 100, 18, 23, 76, 217, 68, 203, 56, 239, 201, 63
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    86, 53, 94, 105, 217, 87, 166, 158, 185, 85, 64, 32, 18, 207, 33, 29
    };
    ...
    uint8_t golden[] = {
    157, 19, 78, 0, 1, 100, 1, 23, 147, 0, 4, 0, 0, 0, 168, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
