...
int main(){
    const uint8_t data1[] = {
    208, 1, 247, 249, 129, 146, 195, 127, 84, 13, 110, 11, 81, 105, 26, 92
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    212, 149, 11, 207, 16, 79, 202, 97, 164, 169, 18, 249, 136, 71, 21, 98
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsub_vx_u8mf2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    208, 0, 247, 0, 0, 1, 195, 1, 176, 1, 1, 18, 81, 1, 5, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
