...
int main(){
    const int16_t data1[] = {
    18, -35, -31, 82, 84, 63, 108, 33, -46, 50, -17, 110, -73, 27, 77, 45
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -69, -82, -63, 9, -12, -111, -20, 51, -20, 119, 24, 28, 22, 119, 100, -90
    };
    ...
    int16_t golden[] = {
    -51, -117, -93, 91, 73, -47, 89, 85, -66, 170, 7, 138, -50, 147, 177, -45
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
