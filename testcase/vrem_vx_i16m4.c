...
int main(){
    const int16_t data1[] = {
    10964, 541, 10188, 63170, 17667, 59566, 22107, 38605, 34092, 1083, 40930, 32262, 16450, 44063, 2213, 17867
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    39311, 53915, 13935, 56864, 8179, 22124, 7410, 5584, 28507, 5401, 50653, 26254, 19004, 31849, 34597, 33604
    };
    ...
    int16_t golden[] = {
    6419, 356, 3747, 56864, 8179, 22124, 7410, 5584, 28507, 1069, 9723, 26254, 2554, 31849, 1402, 15737
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
