...
int main(){
    ...
    244, 113, 140, 199, 114, 45, 84, 51, 247, 61, 60, 16, 45, 250, 189, 121
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    84, 234, 235, 238, 46, 72, 38, 113, 130, 159, 19, 33, 208, 76, 149, 237
    };
    ...
    uint32_t golden[] = {
    244, 234, 235, 238, 114, 72, 84, 113, 247, 159, 60, 33, 208, 250, 189, 237
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
