...
int main(){
    ...
    133, 158, 116, 48, 102, 53, 70, 51, 126, 205, 102, 34, 177, 142, 107, 178
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    159, 184, 158, 187, 177, 167, 42, 143, 136, 81, 24, 140, 247, 147, 163, 13
    };
    ...
    uint32_t golden[] = {
    159, 184, 158, 187, 177, 167, 70, 143, 136, 205, 102, 140, 247, 147, 163, 178
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
