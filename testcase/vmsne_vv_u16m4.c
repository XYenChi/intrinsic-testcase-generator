...
int main(){
    ...
    97, 124, 91, 225, 185, 192, 244, 101, 185, 94, 60, 62, 205, 46, 144, 165
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    154, 130, 59, 206, 180, 104, 29, 33, 160, 20, 63, 59, 31, 153, 190, 223
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_16m4_b4 (data1_v, data2_v, vl);
