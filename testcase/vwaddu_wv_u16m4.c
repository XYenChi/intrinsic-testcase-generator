...
int main(){
    ...
    69, 75, 118, 153, 170, 1, 155, 239, 157, 24, 150, 73, 253, 148, 131, 126
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    193, 54, 211, 64, 194, 231, 89, 157, 172, 154, 160, 112, 66, 47, 58, 32
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u16m4 (data1_v, data2_v, vl);
