...
int main(){
    const int8_t data1[] = {
    110, 104, -83, 96, -45, 105, -77, -68, -94, -123, -124, -11, -127, 85, -101, 16
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -6, -114, -64, -62, 40, -30, -75, -59, -34, 8, 35, 68, 102, 20, -123, 82
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vv_8m4_b2 (data1_v, data2_v, vl);
