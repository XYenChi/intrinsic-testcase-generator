...
int main(){
    const int8_t data1[] = {
    3, 63, -125, -20, 112, -104, -41, 11, -54, -109, -51, 12, -39, 109, -66, -97
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    33, 73, 39, 52, 77, -49, 76, -33, -111, 19, 102, -66, 115, -9, -62, 78
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vv_8m1_b8_m (mask, data1_v, data2_v, vl);
