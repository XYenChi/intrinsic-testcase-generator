...
int main(){
    const int32_t data1[] = {
    -10, -19, 52, -71, -9, 18, 100, -64, 116, -38, -4, -85, -67, 27, 52, 33
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    13, -83, -82, 87, -83, -53, -23, -106, 46, 62, -69, 7, 38, -19, -111, -56
    };
    ...
    int32_t golden[] = {
    3, 4294967194, 4294967266, 16, 4294967204, 4294967261, 77, 4294967126, 162, 24, 4294967223, 4294967218, 4294967267, 8, 4294967237, 4294967273
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
