...
int main(){
    const int32_t data1[] = {
    -115, -13, -66, -74, 88, 3, -121, 10, 51, -98, -67, 62, -16, 65, 120, 33
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -56, 20, 36, 4, -44, 70, -21, -120, -4, -66, -104, -62, -88, -106, 52, -88
    };
    ...
    int32_t golden[] = {
    4294967125, 7, 4294967266, 4294967226, 44, 73, 4294967154, 4294967186, 47, 4294967132, 4294967125, 0, 4294967192, 4294967255, 172, 4294967241
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
