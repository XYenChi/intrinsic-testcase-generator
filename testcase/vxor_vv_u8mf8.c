...
int main(){
    const uint8_t data1[] = {
    255, 46, 36, 67, 91, 185, 217, 89, 176, 199, 175, 5, 209, 68, 174, 247
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    107, 156, 160, 239, 199, 120, 184, 18, 212, 91, 16, 138, 46, 22, 220, 206
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u8mf8 (data1_v, data2_v, vl);
