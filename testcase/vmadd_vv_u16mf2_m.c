...
int main(){
    ...
    253, 248, 5, 210, 95, 180, 244, 164, 123, 170, 204, 173, 11, 17, 100, 158
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    94, 34, 74, 240, 99, 107, 159, 190, 36, 34, 160, 160, 226, 49, 139, 224
    };
    ...
    uint16_t golden[] = {
    94, 248, 79, 210, 95, 107, 244, 164, 159, 170, 204, 160, 226, 49, 139, 224
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
