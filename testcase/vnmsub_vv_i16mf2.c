...
int main(){
    const int16_t data1[] = {
    108, -35, 91, 79, 40, -8, -37, 32, -105, 18, 92, 115, 3, 47, -11, 114
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -68, -126, -80, -36, 58, 68, -23, -12, -124, -91, -79, 122, 35, -29, -117, -111
    };
    ...
    int16_t golden[] = {
    108, 91, 171, 115, 40, 65528, 65499, 44, 65431, 109, 171, 115, 3, 47, 106, 225
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
