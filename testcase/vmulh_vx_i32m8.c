...
int main(){
    const int32_t data1[] = {
    52, 83, 59, 48, 80, 32, -60, 103, 112, 39, 32, 12, -98, 102, 119, 103
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    36, 23, -42, -27, 107, -59, -113, 95, 120, 83, 64, -87, 75, -98, -1, -46
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vx_32m8_b4 (data1_v, data2_v, vl);
