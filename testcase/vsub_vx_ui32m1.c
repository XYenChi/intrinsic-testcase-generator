...
int main(){
    const int32_t data1[] = {
    230, 204, 93, 218, 88, 102, 102, 129, 162, 31, 156, 127, 47, 1, 254, 233
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    2, 41, 111, 139, 105, 203, 94, 240, 23, 10, 240, 109, 220, 8, 126, 222
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vx_ui32m1 (data1_v, data2_v, vl);
    ...
    int32_t golden[] = {
    228, 163, 0, 79, 0, 0, 8, 0, 139, 21, 0, 18, 0, 0, 128, 11
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
