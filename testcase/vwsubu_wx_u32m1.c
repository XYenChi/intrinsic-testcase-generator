...
int main(){
    ...
    211, 216, 140, 76, 85, 225, 160, 172, 182, 0, 134, 166, 119, 103, 160, 4
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    230, 176, 230, 205, 122, 136, 14, 179, 109, 182, 77, 104, 157, 145, 14, 163
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u32m1 (data1_v, data2_v, vl);
