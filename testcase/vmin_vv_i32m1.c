...
int main(){
    const int32_t data1[] = {
    83, -58, -15, -33, -112, -111, 100, -37, -105, 56, 109, -73, 33, -125, -70, 69
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    73, 17, 28, -3, -10, -114, 46, -85, -49, -118, 44, -9, 30, -44, -86, -28
    };
    ...
    int32_t golden[] = {
    83, 17, 28, 4294967293, 4294967286, 4294967185, 100, 4294967259, 4294967247, 56, 109, 4294967287, 33, 4294967252, 4294967226, 69
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
