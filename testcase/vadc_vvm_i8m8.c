...
int main(){
    const int8_t data1[] = {
    -77, -33, 96, 109, -65, -111, -50, -102, 81, -72, -27, 60, -92, 69, -76, -35
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -81, 85, 0, 19, -97, 59, -77, -46, 73, 121, 113, -42, 87, 71, 12, 2
    };
    ...
    int8_t golden[] = {
    -157, 53, 97, 128, -161, -52, -126, -148, 155, 50, 87, 19, -5, 140, -63, -32
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
