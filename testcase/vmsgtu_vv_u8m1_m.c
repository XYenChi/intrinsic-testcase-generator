...
int main(){
    const uint8_t data1[] = {
    7, 227, 134, 180, 79, 247, 65, 62, 237, 43, 250, 207, 205, 11, 117, 16
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    190, 20, 140, 197, 17, 59, 37, 151, 180, 198, 206, 43, 203, 135, 199, 176
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_8m1_b8_m (mask, data1_v, data2_v, vl);
