...
int main(){
    ...
    90, 51, 255, 18, 63, 102, 244, 4, 243, 16, 17, 191, 4, 41, 67, 117
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    238, 109, 71, 165, 31, 101, 173, 56, 80, 151, 49, 187, 179, 230, 242, 123
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_32m2_b16_m (mask, data1_v, data2_v, vl);
