...
int main(){
    ...
    146, 97, 160, 155, 200, 169, 11, 47, 142, 144, 205, 163, 27, 57, 114, 94
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    180, 9, 126, 31, 99, 240, 186, 166, 147, 153, 119, 120, 248, 45, 248, 243
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u32mf2 (data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    34, 9, 126, 31, 99, 71, 10, 25, 5, 9, 119, 120, 5, 45, 20, 55
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
