...
int main(){
    ...
    4, 121, 174, 212, 144, 21, 81, 92, 211, 251, 8, 95, 191, 149, 122, 245
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    175, 30, 176, 200, 35, 12, 194, 118, 71, 25, 92, 63, 27, 15, 16, 24
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u64m4_m (mask, data1_v, data2_v, vl);
