...
int main(){
    ...
    184, 187, 84, 161, 235, 184, 77, 7, 148, 0, 194, 122, 133, 43, 52, 83
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    103, 176, 157, 144, 185, 122, 21, 132, 51, 30, 138, 192, 62, 171, 196, 121
    };
    ...
    uint64_t golden[] = {
    81, 187, 84, 161, 50, 62, 56, 7, 148, 0, 56, 18446744073709551546, 133, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
