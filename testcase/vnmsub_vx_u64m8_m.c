...
int main(){
    ...
    208, 250, 25, 11, 201, 105, 114, 223, 247, 172, 111, 120, 170, 240, 187, 191
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    41, 238, 87, 211, 55, 90, 140, 218, 53, 215, 18, 0, 162, 152, 190, 16
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnmsub_vx_u64m8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    1, 250, 18446744073709551554, 1, 201, 15, 0, 0, 0, 0, 111, 120, 0, 88, 0, 175
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
