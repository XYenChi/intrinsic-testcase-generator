...
int main(){
    ...
    49, 71, 21, 63, 169, 235, 90, 119, 249, 85, 228, 152, 248, 121, 18, 186
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    197, 37, 77, 68, 147, 2, 109, 30, 77, 228, 143, 122, 247, 51, 11, 145
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i16m2 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    4, 0, 3, 1, 0, 0, 1, 0, 0, 2, 0, 0, 0, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
