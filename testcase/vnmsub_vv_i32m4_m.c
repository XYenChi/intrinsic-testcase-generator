...
int main(){
    const int32_t data1[] = {
    19, -94, 39, 84, -73, 65, 31, 2, -24, -84, -69, -48, -19, -65, -117, -107
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -96, 80, -98, 61, 72, 89, 57, -24, -114, -17, 95, -29, -78, 1, -54, 51
    };
    ...
    int32_t golden[] = {
    1, 4294967122, 39, 0, 1, 4294967272, 4294967270, 26, 4294967272, 4294967229, 4294967227, 1, 59, 1, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
