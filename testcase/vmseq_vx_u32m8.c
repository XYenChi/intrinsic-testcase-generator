...
int main(){
    ...
    136, 55, 4, 118, 142, 85, 80, 145, 33, 216, 227, 224, 233, 100, 61, 70
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    182, 16, 117, 244, 71, 224, 52, 126, 210, 72, 125, 0, 144, 22, 173, 149
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_32m8_b4 (data1_v, data2_v, vl);
