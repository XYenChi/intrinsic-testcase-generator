...
int main(){
    const int16_t data1[] = {
    -65, -113, 14, -48, 25, 70, 17, -112, 111, 6, 56, 20, 57, 65, -41, -54
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    97, 123, 54, -20, -110, 0, 97, 83, -90, -84, -69, 45, 53, -60, 34, -101
    };
    ...
    int16_t golden[] = {
    59231, 51637, 756, 960, 62786, 0, 1649, 56240, 55546, 65032, 61672, 900, 3021, 61636, 64142, 5454
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
