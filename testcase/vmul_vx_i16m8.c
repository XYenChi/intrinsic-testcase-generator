...
int main(){
    const int16_t data1[] = {
    39, 21, 120, 85, -58, -63, -118, 117, 81, -51, 35, 72, 49, -63, 3, 62
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -60, 43, 97, -5, 123, -88, 58, 33, -110, -93, 21, -16, 0, -61, 31, -3
    };
    ...
    int16_t golden[] = {
    63196, 903, 11640, 65111, 58402, 5544, 58692, 3861, 56626, 4743, 735, 64384, 0, 3843, 93, 65350
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
