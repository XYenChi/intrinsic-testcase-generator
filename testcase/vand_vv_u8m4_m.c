...
int main(){
    const uint8_t data1[] = {
    157, 40, 227, 136, 202, 141, 180, 243, 217, 168, 169, 8, 156, 229, 164, 151
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    159, 72, 41, 145, 171, 63, 92, 234, 131, 125, 21, 12, 211, 223, 111, 32
    };
    ...
    uint8_t golden[] = {
    159, 72, 1, 1, 1, 0, 1, 234, 131, 1, 1, 1, 211, 223, 111, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
