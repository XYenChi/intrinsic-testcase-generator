...
int main(){
    ...
    159, 142, 74, 253, 204, 22, 228, 59, 216, 8, 12, 250, 57, 91, 167, 193
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    36, 190, 211, 192, 220, 221, 57, 21, 153, 98, 45, 210, 220, 214, 122, 234
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u16m2_m (mask, data1_v, data2_v, vl);
