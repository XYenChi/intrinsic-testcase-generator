...
int main(){
    const int64_t data1[] = {
    -40, 38, -88, -98, 101, 1, 32, 37, 104, -98, 3, -61, 116, 113, -127, -45
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -45, 41, 75, -41, -15, 126, 2, -112, 54, 106, 30, -10, 68, 59, -103, -101
    };
    ...
    int64_t golden[] = {
    18446744073709551531, 41, 18446744073709551528, 18446744073709551575, 101, 127, 2, 37, 104, 18446744073709551518, 3, 18446744073709551606, 184, 59, 18446744073709551386, 18446744073709551571
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
