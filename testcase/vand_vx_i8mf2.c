...
int main(){
    const int8_t data1[] = {
    91, -98, -76, -128, -46, -36, 87, -25, -73, -108, 95, -6, 37, -100, 50, -117
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -83, -16, 90, -25, 48, 12, 54, -84, -102, 84, 75, -15, 27, 57, 36, -64
    };
    ...
    int8_t golden[] = {
    173, 240, 90, 231, 48, 12, 54, 172, 154, 84, 75, 241, 27, 57, 36, 192
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
