...
int main(){
    ...
    201, 118, 94, 182, 114, 44, 167, 66, 87, 196, 47, 80, 232, 167, 133, 74
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    223, 134, 162, 134, 56, 28, 184, 11, 53, 46, 140, 64, 120, 19, 107, 16
    };
    ...
    uint16_t golden[] = {
    44823, 0, 15228, 1, 0, 0, 0, 726, 4611, 9016, 0, 5120, 1, 0, 0, 1184
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
