...
int main(){
    const int64_t data1[] = {
    -44, -94, 66, 92, 60, 13, -93, -54, 74, -21, -122, 22, -39, -61, 58, 106
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -90, -1, 74, -83, -63, -30, -79, -71, -12, -24, 38, -45, 115, 81, -99, -115
    };
    ...
    int64_t golden[] = {
    0, 18446744073709551615, 0, 1, 0, 18446744073709551586, 18446744073709551537, 0, 0, 18446744073709551592, 0, 18446744073709551571, 0, 1, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
