...
int main(){
    const uint8_t data1[] = {
    27, 86, 7, 46, 197, 231, 249, 23, 119, 41, 163, 19, 243, 200, 191, 203
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    81, 88, 63, 186, 186, 215, 61, 195, 189, 131, 143, 230, 51, 22, 187, 136
    };
    ...
    uint8_t golden[] = {
    81, 88, 63, 186, 197, 231, 249, 195, 189, 131, 163, 230, 243, 200, 191, 203
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
