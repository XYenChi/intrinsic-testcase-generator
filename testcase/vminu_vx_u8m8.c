...
int main(){
    const uint8_t data1[] = {
    65, 228, 174, 62, 195, 79, 124, 234, 80, 51, 50, 174, 27, 36, 102, 52
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    35, 203, 64, 209, 109, 102, 254, 137, 150, 9, 16, 129, 118, 234, 183, 95
    };
    ...
    uint8_t golden[] = {
    65, 228, 174, 209, 195, 102, 254, 234, 150, 51, 50, 174, 118, 234, 183, 95
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
