...
int main(){
    ...
    155, 201, 39, 220, 149, 123, 116, 160, 96, 163, 8, 98, 237, 141, 255, 157
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    126, 13, 148, 223, 113, 66, 252, 27, 181, 202, 166, 157, 144, 192, 56, 219
    };
    ...
    uint16_t golden[] = {
    155, 201, 148, 223, 149, 123, 252, 160, 181, 202, 166, 157, 237, 192, 255, 219
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
