...
int main(){
    const int8_t data1[] = {
    111, 51, 111, -14, -53, -43, 14, 52, -25, -119, 41, 115, 62, 81, 54, 53
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -116, 69, 37, 76, 11, -125, -16, -1, 60, 14, 67, -111, 79, 92, 123, -60
    };
    ...
    int8_t golden[] = {
    180, 191, 11, 216, 185, 255, 32, 204, 36, 126, 187, 35, 34, 28, 242, 148
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
