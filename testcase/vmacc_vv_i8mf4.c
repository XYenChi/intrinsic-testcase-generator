...
int main(){
    const int8_t data1[] = {
    241, 75, 162, 206, 213, 156, 204, 149, 44, 154, 65, 82, 240, 226, 218, 103
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    192, 151, 227, 113, 146, 39, 18, 25, 143, 89, 128, 209, 81, 195, 25, 134
    };
    ...
    const int out_data[] = {
    165, 186, 37, 63, 246, 179, 196, 131, 45, 13, 202, 5, 54, 19, 224, 44
    };
    const int8_t *out = &out_data[0];
    ...
    int8_t golden[] = {
    46437, 11511, 36811, 23341, 31344, 6263, 3868, 3856, 6337, 13719, 8522, 17143, 19494, 44089, 5674, 13846
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
