...
int main(){
    const int8_t data1[] = {
    55, -65, 22, -12, 104, -70, 73, 82, 43, -86, -87, -96, 54, 54, 43, -71
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -74, 106, -72, 124, -34, 31, 80, -3, -51, -25, 2, -87, 118, 9, -109, 64
    };
    ...
    int8_t golden[] = {
    26, 22, 208, 49, 48, 134, 209, 11, 112, 102, 83, 160, 228, 231, 177, 64
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
