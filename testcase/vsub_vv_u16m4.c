...
int main(){
    ...
    174, 34, 172, 95, 218, 212, 162, 222, 48, 216, 24, 247, 76, 111, 43, 113
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    190, 186, 226, 9, 150, 44, 17, 188, 132, 249, 146, 80, 47, 243, 182, 169
    };
    ...
    uint16_t golden[] = {
    65520, 65384, 65482, 86, 68, 168, 145, 34, 65452, 65503, 65414, 167, 29, 65404, 65397, 65480
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
