...
int main(){
    ...
    193, 42, 111, 114, 99, 29, 241, 209, 231, 116, 98, 96, 237, 250, 12, 237
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    147, 99, 22, 137, 97, 90, 54, 159, 228, 57, 63, 119, 190, 63, 77, 4
    };
    ...
    uint16_t golden[] = {
    46, 65479, 89, 65513, 2, 65475, 187, 50, 3, 59, 35, 65513, 47, 187, 65471, 233
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
