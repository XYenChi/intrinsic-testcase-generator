...
int main(){
    const int8_t data1[] = {
    -2, -51, -119, -36, 103, -71, 18, -126, -61, -62, 25, 102, 112, -35, -113, -94
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    106, 71, 75, 238, 60, 131, 43, 47, 244, 152, 249, 238, 178, 250, 102, 237
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_8m1_b8 (data1_v, data2_v, vl);
