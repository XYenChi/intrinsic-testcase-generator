...
int main(){
    ...
    140, 117, 246, 53, 95, 20, 42, 110, 70, 31, 241, 154, 53, 72, 69, 17
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    168, 40, 161, 135, 104, 63, 218, 50, 62, 114, 239, 143, 144, 84, 130, 222
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wx_64m1u_m (mask, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    0, 125, 1, 1, 127, 63, 250, 0, 0, 127, 0, 1, 181, 1, 199, 223
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
