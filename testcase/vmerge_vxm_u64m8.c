...
int main(){
    ...
    144, 250, 101, 94, 156, 1, 167, 250, 131, 146, 85, 200, 7, 254, 2, 252
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    207, 96, 162, 173, 30, 215, 126, 244, 131, 190, 39, 141, 72, 191, 3, 236
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmerge_vxm_u64m8 (data1_v, data2_v, masked size_t vl);
    ...
    uint64_t golden[] = {
    144, 96, 162, 173, 156, 215, 167, 244, 131, 146, 85, 200, 7, 254, 2, 252
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
