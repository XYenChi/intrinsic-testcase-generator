...
int main(){
    const int16_t data1[] = {
    106, -17, -40, 38, 41, 22, 119, 40, -128, 39, 3, -18, -59, 12, 65, -53
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    138, 139, 251, 59, 111, 27, 69, 45, 41, 135, 89, 38, 79, 26, 89, 180
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_16m2_b8 (mask, data1_v, data2_v, vl);
