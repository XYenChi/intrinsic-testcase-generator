...
int main(){
    const int16_t data1[] = {
    34, -104, 25, 112, 0, 62, 87, 47, -77, 49, 60, 21, -48, -20, 60, -120
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -24, 97, -108, 27, -96, -10, -118, -33, -95, -112, -122, -55, 65, -121, 12, -64
    };
    ...
    int16_t golden[] = {
    64721, 55449, 62837, 3025, 1, 64916, 55271, 63985, 7316, 60048, 58217, 64381, 62417, 2420, 720, 7681
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
