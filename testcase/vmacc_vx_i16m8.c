...
int main(){
    const int16_t data1[] = {
    -128, 87, -95, -119, 48, 11, 17, -100, -52, -99, 125, 123, -92, -32, -118, 78
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    84, -103, -88, 58, -121, 108, -105, 3, 82, -62, 99, -3, -122, 17, -127, 42
    };
    ...
    int16_t golden[] = {
    54784, 56576, 8361, 58635, 59728, 1188, 63752, 65237, 61273, 6139, 12375, 65168, 11224, 64993, 14987, 3276
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
