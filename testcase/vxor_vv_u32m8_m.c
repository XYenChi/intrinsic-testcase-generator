...
int main(){
    ...
    228, 136, 57, 12, 169, 1, 84, 115, 173, 234, 155, 42, 224, 4, 186, 41
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    55, 75, 139, 18, 249, 140, 84, 181, 45, 19, 130, 155, 219, 208, 225, 195
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u32m8_m (mask, data1_v, data2_v, vl);
