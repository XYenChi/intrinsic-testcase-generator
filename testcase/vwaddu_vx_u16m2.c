...
int main(){
    ...
    110, 41, 170, 13, 97, 141, 254, 14, 39, 244, 117, 146, 155, 115, 190, 190
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    29, 104, 161, 237, 228, 33, 21, 51, 63, 61, 82, 38, 11, 23, 81, 77
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u16m2 (data1_v, data2_v, vl);
