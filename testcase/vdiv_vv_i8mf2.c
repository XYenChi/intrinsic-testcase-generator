...
int main(){
    const int8_t data1[] = {
    51, -103, -97, 102, -74, 31, -47, -122, -107, 21, -57, -111, 5, -118, 92, -25
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -39, 122, -122, -118, -16, -125, 47, -105, -71, 123, -76, 96, 67, 93, -94, -23
    };
    ...
    int8_t golden[] = {
    255, 254, 1, 254, 0, 251, 255, 0, 0, 5, 1, 255, 13, 255, 254, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
