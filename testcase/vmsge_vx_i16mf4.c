...
int main(){
    const int16_t data1[] = {
    62, -91, -22, 122, 104, -17, -14, 98, -108, -127, 97, 32, 102, 10, 11, -13
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -126, -119, 41, -33, -59, 2, -113, -27, -89, 113, -83, 16, -95, -52, -36, 102
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_16mf4_b64 (data1_v, data2_v, vl);
