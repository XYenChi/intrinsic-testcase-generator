...
int main(){
    const int8_t data1[] = {
    66, 24, 62, 120, -32, 57, -73, 51, -67, 23, -66, -45, -67, 88, 79, -84
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -54, -63, -71, 15, 75, 98, -5, 1, -2, -61, -31, 20, 67, -64, -32, 111
    };
    ...
    int8_t golden[] = {
    120, 87, 133, 105, 149, 215, 188, 50, 191, 84, 221, 191, 122, 152, 111, 61
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
