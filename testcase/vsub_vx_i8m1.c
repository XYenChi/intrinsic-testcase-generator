...
int main(){
    const int8_t data1[] = {
    27, 57, -118, 93, 2, 56, 12, 99, -62, -72, -42, -28, -37, -26, 39, 122
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    70, 104, -73, 47, 45, 125, 23, 102, 5, -100, -43, 89, -55, 29, 92, -68
    };
    ...
    int8_t golden[] = {
    213, 209, 211, 46, 213, 187, 245, 253, 189, 28, 1, 139, 18, 201, 203, 190
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
