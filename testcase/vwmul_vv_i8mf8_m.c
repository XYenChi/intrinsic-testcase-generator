...
int main(){
    const int8_t data1[] = {
    -94, 11, 91, 77, 11, -4, -39, -73, 99, 39, -100, 95, 5, 116, 49, -90
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    -117, 73, 33, -60, 39, -120, 33, -29, 9, 122, 44, 22, -39, 110, -48, -126
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmul_vv_i8mf8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    246, 35, 1, 244, 173, 0, 249, 69, 123, 150, 208, 0, 61, 0, 1, 76
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
