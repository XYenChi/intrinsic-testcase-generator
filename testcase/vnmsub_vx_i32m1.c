...
int main(){
    const int32_t data1[] = {
    92, 16, 38, -18, 16, -23, 20, -89, -71, -33, -6, -67, 0, 24, 114, -18
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -113, 75, 100, 65, -31, -116, -102, 34, -83, -26, -75, -60, 1, 97, 56, 0
    };
    ...
    int32_t golden[] = {
    92, 4294967237, 4294967234, 4294967278, 47, 93, 20, 4294967173, 12, 4294967289, 4294967290, 4294967289, 4294967295, 4294967223, 58, 4294967278
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
