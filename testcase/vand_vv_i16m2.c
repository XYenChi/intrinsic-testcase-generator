...
int main(){
    const int16_t data1[] = {
    107, -27, -101, 115, -116, -41, -120, -127, -94, -8, 29, 114, -30, 41, 118, 92
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -97, -23, 68, 106, -94, -97, 13, 12, 56, -56, -112, -39, 52, -9, 51, 34
    };
    ...
    int16_t golden[] = {
    65439, 65513, 68, 106, 65442, 65439, 13, 12, 56, 65480, 65424, 65497, 52, 65527, 51, 34
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
