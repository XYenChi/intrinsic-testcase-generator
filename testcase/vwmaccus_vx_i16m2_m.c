...
int main(){
    const int16_t data1[] = {
    99, -121, 105, -10, 32, -47, -27, -95, 71, -6, -56, -119, -111, -99, 120, -125
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -14, 63, -55, 97, -62, 30, 76, -73, -48, -107, 107, 58, -14, 76, 40, 43
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccus_vx_i16m2_m (mask, out_data, data1_v, data2_v, vl);
