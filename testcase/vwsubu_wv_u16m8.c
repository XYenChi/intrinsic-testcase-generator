...
int main(){
    ...
    136, 10, 243, 64, 56, 221, 189, 251, 17, 216, 102, 109, 20, 14, 4, 40
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    164, 167, 89, 243, 189, 47, 34, 213, 236, 226, 121, 168, 254, 22, 86, 48
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u16m8 (data1_v, data2_v, vl);
