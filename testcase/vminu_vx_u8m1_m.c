...
int main(){
    const uint8_t data1[] = {
    55, 6, 55, 70, 65, 183, 109, 234, 37, 232, 36, 124, 238, 100, 226, 73
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    186, 166, 253, 214, 156, 111, 136, 247, 237, 62, 228, 227, 201, 62, 52, 208
    };
    ...
    uint8_t golden[] = {
    0, 0, 1, 214, 156, 0, 136, 247, 1, 1, 228, 1, 0, 100, 226, 208
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
