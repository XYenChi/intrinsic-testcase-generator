...
int main(){
    const uint8_t data1[] = {
    178, 231, 152, 232, 225, 61, 18, 227, 87, 63, 45, 178, 113, 6, 197, 107
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    241, 173, 151, 38, 108, 8, 120, 95, 16, 92, 69, 56, 218, 251, 242, 163
    };
    ...
    uint8_t golden[] = {
    241, 1, 152, 1, 225, 61, 120, 1, 87, 0, 0, 1, 0, 0, 242, 163
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
