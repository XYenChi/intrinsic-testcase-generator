...
int main(){
    const int32_t data1[] = {
    54, 3, -5, -115, 3, -49, 72, 63, 105, 51, -42, 8, -50, -14, 29, -52
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -91, 125, -64, -50, 5, 89, -20, 41, 127, 95, -66, -121, 17, 122, -109, -29
    };
    ...
    int32_t golden[] = {
    1, 4294967174, 59, 0, 0, 4294967158, 92, 22, 1, 0, 24, 129, 0, 0, 138, 4294967273
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
