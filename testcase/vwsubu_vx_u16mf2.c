...
int main(){
    ...
    63, 149, 144, 180, 16, 138, 7, 32, 53, 88, 30, 213, 243, 178, 87, 172
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    90, 7, 174, 226, 213, 13, 229, 102, 19, 190, 103, 186, 237, 64, 89, 30
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u16mf2 (data1_v, data2_v, vl);
