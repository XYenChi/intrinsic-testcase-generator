...
int main(){
    ...
    120, 91, 0, 27, 94, 230, 170, 29, 157, 14, 63, 57, 27, 183, 107, 224
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    230, 216, 243, 164, 57, 167, 177, 170, 120, 34, 51, 145, 27, 21, 221, 107
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u16m1 (data1_v, shift, vl);
