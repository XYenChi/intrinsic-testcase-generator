...
int main(){
    ...
    100, 64, 9, 29, 118, 181, 177, 134, 171, 109, 8, 93, 52, 243, 24, 166
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    195, 233, 156, 165, 70, 131, 30, 191, 105, 95, 0, 196, 59, 229, 233, 125
    };
    ...
    uint32_t golden[] = {
    19500, 14912, 1404, 4785, 8260, 23711, 5310, 25594, 17955, 10355, 0, 18228, 3068, 55647, 5592, 20750
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
