...
int main(){
    ...
    184, 105, 169, 109, 198, 11, 65, 254, 123, 121, 146, 42, 220, 149, 206, 13
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    0, 253, 180, 105, 83, 94, 71, 121, 79, 184, 96, 17, 191, 17, 218, 40
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u16m1_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    0, 0, 1, 105, 83, 6, 1, 0, 1, 1, 0, 17, 0, 0, 12, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
