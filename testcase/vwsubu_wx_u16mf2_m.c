...
int main(){
    ...
    219, 33, 196, 246, 162, 107, 41, 173, 19, 245, 232, 113, 18, 97, 106, 17
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    93, 128, 118, 243, 132, 182, 174, 71, 55, 242, 177, 129, 110, 161, 230, 18
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u16mf2_m (mask, data1_v, data2_v, vl);
