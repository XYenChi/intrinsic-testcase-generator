...
int main(){
    ...
    207, 61, 178, 22, 140, 231, 157, 194, 251, 89, 12, 99, 28, 120, 69, 72
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    98, 134, 199, 177, 26, 203, 139, 22, 104, 53, 176, 165, 99, 208, 158, 137
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u64m2_m (mask, data1_v, data2_v, vl);
