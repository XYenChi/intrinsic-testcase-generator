...
int main(){
    const int32_t data1[] = {
    -84, 31, 100, -113, -119, 20, -42, 11, 37, 23, -124, 61, -121, 45, 60, 19
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    53, -92, 90, 38, 9, 100, 91, -13, 20, 29, 23, -55, -100, 43, -19, 70
    };
    const int32_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e32mf2(avl);
    const int out_data[] = {
    0, 1, 1, 1, 0, 1, 1, 1, 0, 0, 1, 0, 1, 0, 0, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vv_32mf2_b64_m (mask, data1_v, data2_v, vl);
