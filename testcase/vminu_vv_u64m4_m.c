...
int main(){
    ...
    53, 11, 91, 100, 230, 197, 6, 43, 94, 242, 143, 42, 202, 71, 47, 145
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    204, 155, 129, 224, 53, 99, 101, 107, 56, 232, 85, 96, 247, 139, 129, 146
    };
    ...
    uint64_t golden[] = {
    204, 155, 1, 0, 1, 197, 1, 107, 94, 1, 1, 96, 247, 139, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
