...
int main(){
    ...
    149, 48, 73, 69, 13, 215, 235, 247, 234, 105, 57, 41, 153, 115, 6, 42
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    4, 26, 226, 188, 38, 64, 246, 100, 61, 162, 244, 185, 255, 78, 11, 112
    };
    ...
    uint64_t golden[] = {
    149, 48, 0, 0, 0, 215, 1, 1, 234, 162, 244, 185, 0, 115, 11, 112
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
