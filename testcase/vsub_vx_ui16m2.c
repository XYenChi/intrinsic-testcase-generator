...
int main(){
    const int16_t data1[] = {
    177, 67, 240, 140, 101, 83, 186, 179, 203, 13, 38, 52, 222, 210, 173, 36
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    200, 99, 149, 101, 142, 40, 91, 75, 38, 162, 22, 211, 123, 78, 57, 235
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vx_ui16m2 (data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    0, 0, 91, 39, 0, 43, 95, 104, 165, 0, 16, 0, 99, 132, 116, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
