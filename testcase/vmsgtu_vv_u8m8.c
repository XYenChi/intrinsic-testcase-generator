...
int main(){
    const uint8_t data1[] = {
    70, 57, 72, 222, 47, 60, 174, 231, 195, 31, 173, 138, 83, 221, 133, 164
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    184, 170, 183, 20, 185, 104, 160, 98, 27, 141, 67, 103, 255, 45, 140, 111
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_8m8_b1 (data1_v, data2_v, vl);
