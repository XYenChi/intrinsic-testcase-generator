...
int main(){
    ...
    159, 237, 57, 69, 100, 28, 234, 67, 198, 49, 0, 81, 43, 187, 143, 53
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    44, 68, 237, 246, 39, 128, 77, 171, 243, 94, 245, 248, 178, 58, 235, 101
    };
    ...
    uint32_t golden[] = {
    1, 0, 1, 177, 1, 100, 1, 0, 45, 0, 245, 0, 135, 0, 92, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
