...
int main(){
    ...
    24, 178, 59, 160, 70, 215, 36, 116, 93, 236, 225, 226, 103, 60, 182, 176
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    3, 92, 52, 122, 80, 39, 112, 181, 24, 254, 7, 198, 22, 5, 162, 100
    };
    ...
    uint64_t golden[] = {
    24, 178, 59, 160, 80, 215, 112, 181, 93, 254, 225, 226, 103, 60, 182, 176
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
