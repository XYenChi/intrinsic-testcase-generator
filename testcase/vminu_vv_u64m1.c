...
int main(){
    ...
    199, 69, 201, 190, 9, 27, 39, 122, 244, 64, 225, 98, 50, 123, 178, 197
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    114, 142, 76, 128, 159, 64, 34, 175, 223, 176, 120, 134, 198, 85, 72, 212
    };
    ...
    uint64_t golden[] = {
    199, 142, 201, 190, 159, 64, 39, 175, 244, 176, 225, 134, 198, 123, 178, 212
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
