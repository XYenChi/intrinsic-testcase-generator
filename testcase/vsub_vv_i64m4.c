...
int main(){
    const int64_t data1[] = {
    -80, 120, -113, 72, 90, -102, 56, 119, 21, -16, 40, 121, -32, 118, -53, -77
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    81, 108, 82, -36, -43, 72, 43, 49, -64, 65, -13, -108, 79, -100, -24, -16
    };
    ...
    int64_t golden[] = {
    -128, 12, -128, 108, 127, -128, 13, 70, 85, -81, 53, 127, -111, 127, -29, -61
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
