...
int main(){
    ...
    105, 65, 128, 43, 195, 126, 20, 84, 234, 185, 42, 52, 159, 25, 20, 78
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    104, 195, 179, 63, 208, 252, 239, 27, 252, 187, 33, 245, 57, 44, 92, 43
    };
    ...
    uint16_t golden[] = {
    10920, 0, 22912, 0, 0, 0, 0, 0, 58968, 34595, 1386, 0, 9063, 1100, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
