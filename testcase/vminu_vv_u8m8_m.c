...
int main(){
    const uint8_t data1[] = {
    216, 107, 110, 11, 52, 164, 139, 196, 151, 99, 7, 63, 178, 215, 92, 93
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    144, 155, 145, 48, 76, 51, 26, 103, 126, 128, 133, 195, 193, 154, 197, 153
    };
    ...
    uint8_t golden[] = {
    0, 0, 145, 48, 0, 1, 139, 0, 1, 0, 0, 195, 1, 0, 197, 153
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
