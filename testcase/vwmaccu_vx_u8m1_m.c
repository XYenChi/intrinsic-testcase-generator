...
int main(){
    const uint8_t data1[] = {
    144, 41, 27, 229, 250, 8, 252, 197, 121, 97, 109, 151, 136, 75, 134, 211
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    150, 10, 71, 251, 252, 12, 86, 62, 28, 75, 82, 167, 58, 64, 244, 81
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vx_u8m1_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    1, 154, 0, 1, 0, 96, 1, 183, 1, 1, 234, 0, 1, 192, 184, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
