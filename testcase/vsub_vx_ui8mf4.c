...
int main(){
    const int8_t data1[] = {
    230, 4, 187, 91, 66, 53, 249, 76, 77, 245, 55, 73, 136, 123, 45, 179
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    173, 80, 14, 167, 113, 181, 46, 232, 19, 35, 19, 172, 132, 170, 232, 232
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vx_ui8mf4 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    57, 0, 173, 0, 0, 0, 203, 0, 58, 210, 36, 0, 4, 0, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
