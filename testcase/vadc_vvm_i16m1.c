...
int main(){
    const int16_t data1[] = {
    65, 18, -108, 68, -79, -128, 38, 25, 96, -120, -42, 15, 122, 47, -19, 2
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    45, 56, -90, 56, -115, 90, -127, 127, 12, 78, -119, -96, 92, -119, 115, -15
    };
    ...
    int16_t golden[] = {
    110, 75, -198, 125, -194, -38, -88, 152, 108, -42, -161, -80, 214, -72, 97, -12
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
