...
int main(){
    const int16_t data1[] = {
    -52, -120, -59, -128, -19, -64, 93, 122, -105, 83, 23, 27, -30, -85, -41, -24
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -73, -123, -35, 116, -128, -1, 65, -101, -45, -29, -128, 78, -60, -51, -33, -90
    };
    ...
    int16_t golden[] = {
    -125, -242, -93, -12, -147, -65, 158, 22, -150, 55, -105, 106, -89, -136, -73, -113
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
