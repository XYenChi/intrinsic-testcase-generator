...
int main(){
    const uint8_t data1[] = {
    153, 77, 10, 101, 141, 182, 184, 56, 244, 211, 190, 38, 192, 49, 49, 142
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    158, 88, 55, 128, 5, 65, 252, 187, 148, 217, 19, 25, 66, 102, 78, 66
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u8mf2 (data1_v, data2_v, vl);
