...
int main(){
    ...
    136, 168, 88, 174, 143, 13, 10, 42, 255, 206, 251, 115, 11, 232, 190, 191
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    1, 67, 179, 207, 108, 156, 157, 92, 209, 89, 31, 228, 160, 212, 176, 133
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u32m8 (data1_v, data2_v, vl);
