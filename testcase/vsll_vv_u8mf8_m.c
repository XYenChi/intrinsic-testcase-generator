...
int main(){
    const uint8_t data1[] = {
    218, 217, 235, 0, 63, 131, 27, 50, 18, 193, 207, 89, 202, 130, 179, 250
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    188, 250, 41, 35, 193, 197, 127, 74, 11, 26, 80, 252, 22, 245, 161, 55
    };
    ...
    uint8_t golden[] = {
    218, 217, 470, 0, 126, 262, 54, 50, 36, 193, 207, 89, 202, 260, 358, 500
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
