...
int main(){
    const int64_t data1[] = {
    -14, -120, -100, -48, 6, 13, 5, 50, 9, -95, -2, -44, -101, -85, -102, 24
    };
    const int64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    225, 248, 80, 152, 29, 213, 143, 15, 217, 25, 16, 235, 173, 117, 130, 198
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_64m8_b8 (data1_v, data2_v, vl);
