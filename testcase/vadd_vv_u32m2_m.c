...
int main(){
    ...
    41, 24, 175, 230, 216, 139, 181, 54, 214, 128, 92, 102, 213, 1, 166, 0
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    106, 159, 146, 110, 110, 1, 167, 42, 52, 230, 155, 235, 248, 193, 112, 163
    };
    ...
    uint16_t masked[] = {
    1, 0, 1, 1, 0, 1, 1, 1, 0, 0, 1, 0, 0, 1, 1, 1
    };
    ...
    uint32_t golden[] = {
    147, 1, 321, 340, 0, 140, 348, 96, 0, 1, 247, 0, 0, 194, 278, 163
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
