...
int main(){
    const int64_t data1[] = {
    25, 76, 113, -28, -57, 41, 50, -53, 111, -79, -105, -46, 50, -124, -30, 84
    };
    const int64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    3, 104, 84, 215, 36, 0, 134, 226, 222, 18, 191, 133, 18, 231, 66, 109
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_64m8_b8 (data1_v, data2_v, vl);
