...
int main(){
    const uint8_t data1[] = {
    78, 13, 86, 223, 203, 195, 124, 21, 124, 195, 234, 173, 167, 22, 114, 81
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    128, 221, 19, 1, 43, 48, 251, 166, 67, 67, 243, 240, 150, 87, 9, 139
    };
    ...
    uint8_t golden[] = {
    206, 234, 105, 224, 246, 243, 119, 187, 191, 6, 221, 157, 61, 109, 123, 220
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
