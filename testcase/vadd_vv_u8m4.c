...
int main(){
    const uint8_t data1[] = {
    197, 12, 200, 155, 110, 95, 147, 84, 78, 15, 235, 87, 204, 107, 251, 56
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    3, 28, 46, 229, 172, 15, 9, 223, 51, 226, 59, 92, 64, 160, 2, 142
    };
    ...
    uint8_t golden[] = {
    200, 40, 246, 128, 26, 110, 156, 51, 129, 241, 38, 179, 12, 11, 253, 198
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
