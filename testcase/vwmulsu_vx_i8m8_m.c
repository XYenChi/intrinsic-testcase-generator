...
int main(){
    const int8_t data1[] = {
    -94, -45, -112, -36, 63, -51, -40, 25, -21, 100, -97, -120, 29, 92, -38, -5
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    -46, 32, 40, 50, 52, 99, 107, 3, 97, 62, -70, 13, 62, -36, -64, 37
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulsu_vx_i8m8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    228, 96, 1, 248, 204, 71, 72, 1, 0, 0, 134, 232, 6, 1, 128, 71
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
