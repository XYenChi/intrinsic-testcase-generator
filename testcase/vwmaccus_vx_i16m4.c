...
int main(){
    const int16_t data1[] = {
    50, -16, 47, -29, -1, 65, -50, -118, 53, 79, 43, 41, -65, -90, -22, 10
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    55, -49, 86, 110, -100, -69, 78, -40, -103, 90, 31, -62, 83, -98, 122, -97
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccus_vx_i16m4 (out_data, data1_v, data2_v, vl);
