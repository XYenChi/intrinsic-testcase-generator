...
int main(){
    const int8_t data1[] = {
    22, -78, 66, 80, 34, 50, 39, -8, 81, 18, 62, 21, -110, -8, -122, -28
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    35, -3, 105, -56, -53, -124, -38, -105, -103, 11, -10, 85, 94, -73, -23, 82
    };
    ...
    int8_t golden[] = {
    2, 234, 18, 128, 247, 201, 55, 73, 105, 199, 148, 249, 157, 73, 247, 9
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
