...
int main(){
    ...
    126, 59, 28, 69, 6, 226, 181, 143, 218, 5, 146, 198, 35, 10, 155, 249
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    84, 233, 200, 114, 3, 116, 15, 47, 251, 120, 105, 47, 116, 182, 199, 200
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_32m2_b16 (data1_v, data2_v, vl);
