...
int main(){
    ...
    193, 69, 12, 38, 116, 95, 180, 110, 52, 53, 106, 72, 226, 50, 110, 152
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    173, 24, 41, 151, 67, 72, 25, 68, 255, 238, 163, 235, 234, 226, 52, 166
    };
    ...
    uint16_t golden[] = {
    193, 69, 41, 151, 116, 95, 180, 110, 255, 238, 163, 235, 234, 226, 110, 166
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
