...
int main(){
    ...
    233, 115, 119, 195, 44, 69, 174, 191, 253, 93, 45, 92, 168, 43, 108, 140
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    238, 68, 149, 68, 20, 106, 63, 73, 136, 22, 189, 19, 134, 227, 66, 238
    };
    ...
    uint16_t golden[] = {
    238, 115, 149, 195, 44, 106, 174, 191, 253, 93, 189, 92, 168, 227, 108, 238
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
