...
int main(){
    const int64_t data1[] = {
    79, -121, -61, 52, 64, -99, 53, -84, 35, -107, -44, -79, 106, 112, -20, 121
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    50, 57, -83, 80, -68, -75, -110, -62, 117, 91, -1, 47, -48, 37, 124, -71
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_64m1_b64 (data1_v, data2_v, vl);
