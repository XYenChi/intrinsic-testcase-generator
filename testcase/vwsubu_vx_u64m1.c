...
int main(){
    ...
    44, 35, 17, 58, 22, 181, 82, 203, 19, 28, 63, 140, 128, 168, 9, 230
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    97, 140, 22, 247, 168, 218, 42, 200, 83, 90, 93, 83, 138, 8, 198, 38
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u64m1 (data1_v, data2_v, vl);
