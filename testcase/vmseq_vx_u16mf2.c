...
int main(){
    ...
    199, 100, 115, 188, 54, 203, 19, 229, 2, 3, 11, 105, 229, 55, 163, 188
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    238, 104, 205, 97, 186, 214, 110, 38, 6, 194, 135, 8, 199, 92, 41, 71
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_16mf2_b32 (data1_v, data2_v, vl);
