...
int main(){
    const int8_t data1[] = {
    86, -44, 116, -10, -64, 26, -34, 109, -44, -61, 113, -52, -93, 102, -115, 17
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -9, 70, -43, -7, 115, -27, 54, 66, -92, 94, 16, -21, -20, -50, -73, -70
    };
    ...
    int8_t golden[] = {
    95, 142, 159, 253, 77, 53, 168, 43, 48, 101, 97, 225, 183, 152, 214, 87
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
