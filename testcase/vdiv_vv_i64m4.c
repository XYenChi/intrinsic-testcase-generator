...
int main(){
    const int64_t data1[] = {
    96, -41, 32, 118, 110, -11, 87, 58, -84, 52, 30, 108, 12, -36, 42, 126
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    57, -36, 125, -9, 68, 82, 103, -51, -71, 32, -117, 53, 77, 41, 115, -117
    };
    ...
    int64_t golden[] = {
    0, 0, 3, 18446744073709551615, 0, 18446744073709551608, 1, 18446744073709551615, 0, 0, 18446744073709551612, 0, 6, 18446744073709551614, 2, 18446744073709551615
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
