...
int main(){
    const uint8_t data1[] = {
    94, 210, 88, 239, 232, 239, 248, 189, 104, 173, 15, 95, 60, 194, 49, 82
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    126, 157, 242, 101, 189, 21, 147, 12, 208, 240, 29, 64, 177, 245, 250, 198
    };
    ...
    uint8_t golden[] = {
    126, 157, 242, 101, 189, 21, 0, 12, 208, 0, 1, 64, 177, 1, 1, 198
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
