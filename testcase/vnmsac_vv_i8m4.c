...
int main(){
    const int8_t data1[] = {
    -9, 29, -54, 38, 58, -65, 33, -2, -107, -40, -125, 103, -54, 67, -27, -55
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    121, -44, 23, 117, 58, -41, -65, 112, 20, -4, 82, -124, -83, 91, -80, 126
    };
    ...
    int8_t golden[] = {
    66, 253, 219, 163, 220, 152, 97, 224, 93, 96, 11, 228, 127, 48, 144, 18
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
