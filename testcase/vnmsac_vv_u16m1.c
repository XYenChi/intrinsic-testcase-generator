...
int main(){
    ...
    132, 237, 216, 32, 235, 246, 52, 169, 135, 245, 219, 183, 210, 144, 71, 0
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    250, 74, 110, 52, 144, 185, 15, 222, 149, 70, 103, 62, 156, 233, 34, 113
    };
    ...
    uint16_t golden[] = {
    32536, 47999, 41776, 63872, 31696, 20027, 64756, 28019, 45421, 48387, 42979, 54190, 32776, 31985, 63123, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
