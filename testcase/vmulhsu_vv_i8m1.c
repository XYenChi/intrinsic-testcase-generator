...
int main(){
    const int8_t data1[] = {
    -42, 58, -1, 33, -99, 92, 111, 49, 47, -42, 7, -86, 127, -126, -103, -29
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    70, 62, 154, 205, 214, 16, 51, 42, 220, 155, 108, 243, 183, 137, 71, 131
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_8m1_b8 (data1_v, data2_v, vl);
