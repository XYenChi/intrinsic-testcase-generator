...
int main(){
    const int16_t data1[] = {
    -98, -35, 101, 111, -60, -48, 98, 102, 96, 1, 32, 23, -118, -91, -95, -21
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -86, -119, 6, -87, 120, -93, -70, 8, -90, -41, -85, 8, 54, 100, -11, 65
    };
    ...
    int16_t golden[] = {
    65450, 65417, 6, 65449, 120, 65443, 65466, 8, 65446, 65495, 65451, 8, 54, 100, 65525, 65
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
