...
int main(){
    ...
    68, 249, 43, 61, 84, 104, 13, 117, 148, 151, 95, 56, 44, 35, 243, 136
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    222, 44, 118, 236, 177, 114, 74, 206, 182, 61, 241, 177, 178, 134, 227, 101
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_64m4_b16 (data1_v, data2_v, vl);
