...
int main(){
    const int16_t data1[] = {
    0, -51, 11, -25, 74, 3, 105, -18, 89, 124, -49, -89, -116, -34, 127, -40
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -119, 45, 15, 127, 125, 54, -13, -110, 81, 124, -50, -55, 114, -100, -70, -12
    };
    ...
    int16_t golden[] = {
    0, 63242, 166, 62361, 9251, 163, 64172, 1981, 7209, 15376, 2450, 4895, 52313, 3400, 56646, 480
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
