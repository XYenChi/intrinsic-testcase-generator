...
int main(){
    const int16_t data1[] = {
    7, -62, 63, -90, -65, 81, -128, -28, -61, 120, -48, 124, 98, -32, -106, 83
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    88, -50, -63, 23, 16, -59, -110, 24, 121, -1, -94, -125, 105, -15, -105, -26
    };
    ...
    int16_t golden[] = {
    617, 3100, 61567, 63467, 64496, 60757, 14081, 64865, 58155, 65417, 4513, 50036, 10291, 480, 11131, 63378
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
