...
int main(){
    ...
    189, 22, 184, 200, 72, 23, 42, 12, 24, 34, 72, 194, 242, 133, 75, 89
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    6, 51, 227, 181, 145, 131, 13, 230, 158, 180, 218, 246, 64, 203, 80, 59
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u16m2 (data1_v, data2_v, vl);
