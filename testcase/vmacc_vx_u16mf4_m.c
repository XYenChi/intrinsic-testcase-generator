...
int main(){
    ...
    245, 91, 215, 237, 89, 6, 210, 90, 36, 56, 227, 86, 81, 144, 141, 85
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    11, 75, 151, 113, 92, 27, 255, 125, 4, 187, 200, 123, 185, 178, 139, 74
    };
    ...
    uint16_t golden[] = {
    2696, 0, 32465, 26781, 8189, 163, 53550, 11251, 144, 0, 0, 1, 14985, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
