...
int main(){
    const int8_t data1[] = {
    -71, 110, -36, 108, -99, 17, -39, -126, -81, 61, -126, -33, -7, 74, 121, -31
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -97, 9, 119, 30, -69, 106, 75, -61, -121, 103, 37, -103, -70, -68, -96, 26
    };
    ...
    int8_t golden[] = {
    -71, 110, 119, 108, -69, 106, -39, -126, -81, 103, 37, -103, -70, 74, 121, -31
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
