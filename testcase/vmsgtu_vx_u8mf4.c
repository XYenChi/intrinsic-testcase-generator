...
int main(){
    const uint8_t data1[] = {
    58, 213, 36, 255, 27, 227, 198, 171, 195, 102, 112, 88, 245, 226, 96, 151
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    197, 31, 98, 236, 117, 3, 177, 73, 6, 126, 170, 51, 100, 206, 130, 114
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_8mf4_b32 (data1_v, data2_v, vl);
