...
int main(){
    const int32_t data1[] = {
    -93, 106, 93, 81, 70, -74, 79, -124, -16, 77, -22, -120, 20, 115, 124, 45
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    116, -91, 113, -65, 1, 13, 19, -42, 48, 24, 38, 6, 85, 22, -102, -122
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_32mf2_b64_m (mask, data1_v, data2_v, vl);
