...
int main(){
    const uint8_t data1[] = {
    75, 5, 208, 206, 114, 52, 250, 15, 154, 113, 164, 100, 78, 238, 94, 247
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    98, 57, 220, 167, 20, 19, 227, 243, 9, 158, 179, 33, 223, 110, 129, 79
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u8m8_m (mask, data1_v, data2_v, vl);
