...
int main(){
    ...
    222, 247, 180, 1, 148, 210, 254, 133, 108, 115, 95, 67, 90, 203, 164, 132
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    42, 136, 150, 121, 253, 202, 247, 36, 153, 246, 12, 136, 249, 134, 37, 90
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u16m8 (data1_v, data2_v, vl);
