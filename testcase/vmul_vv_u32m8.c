...
int main(){
    ...
    216, 253, 245, 0, 60, 104, 43, 191, 31, 11, 201, 98, 47, 77, 10, 72
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    29, 171, 100, 111, 26, 151, 46, 21, 170, 80, 138, 112, 209, 156, 217, 87
    };
    ...
    uint32_t golden[] = {
    6264, 43263, 24500, 0, 1560, 15704, 1978, 4011, 5270, 880, 27738, 10976, 9823, 12012, 2170, 6264
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
