...
int main(){
    const int8_t data1[] = {
    -109, -73, -88, 58, 58, -122, -44, -23, 45, 107, 89, 93, -102, -55, -80, -29
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -48, 25, 124, -114, -88, 99, 93, 51, 39, 23, 95, 56, 53, -34, 84, 78
    };
    ...
    int8_t golden[] = {
    208, 25, 124, 58, 58, 99, 93, 51, 45, 107, 95, 93, 53, 222, 84, 78
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
