...
int main(){
    const int8_t data1[] = {
    26, -11, 35, 62, 0, 88, 4, -95, 124, -118, -96, -119, 46, -82, -42, -2
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    82, 103, -57, 110, -111, 14, -104, -43, -23, -6, -62, -82, -42, -8, 43, -56
    };
    ...
    int8_t golden[] = {
    82, 103, 35, 110, 0, 88, 4, 213, 124, 250, 194, 174, 46, 248, 43, 254
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
