...
int main(){
    const int8_t data1[] = {
    245, 90, 183, 87, 151, 234, 84, 52, 93, 132, 90, 124, 128, 81, 201, 186
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    41, 11, 246, 112, 185, 222, 167, 140, 241, 147, 37, 81, 49, 172, 230, 35
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmax_vx_i8mf2 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    245, 90, 246, 112, 185, 234, 167, 140, 241, 147, 90, 124, 128, 172, 230, 186
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
