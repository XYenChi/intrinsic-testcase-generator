...
int main(){
    const int8_t data1[] = {
    198, 173, 210, 44, 78, 29, 146, 244, 21, 198, 41, 0, 15, 17, 71, 108
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    164, 41, 231, 117, 255, 62, 171, 1, 19, 84, 111, 56, 62, 132, 50, 2
    };
    ...
    int8_t golden[] = {
    34, 132, -21, -73, -177, -33, -25, 243, 2, 114, -70, -56, -47, -115, 21, 106
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
