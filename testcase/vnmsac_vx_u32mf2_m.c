...
int main(){
    ...
    163, 99, 150, 132, 100, 27, 19, 215, 84, 236, 143, 170, 168, 126, 199, 141
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    161, 81, 80, 57, 96, 207, 242, 228, 204, 105, 41, 166, 65, 14, 150, 191
    };
    ...
    uint32_t golden[] = {
    4294941053, 4294959277, 4294955297, 4294959772, 1, 0, 1, 4294918277, 4294950160, 0, 1, 0, 4294956376, 0, 1, 4294940365
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
