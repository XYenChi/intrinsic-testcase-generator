...
int main(){
    ...
    171, 38, 154, 191, 189, 71, 153, 14, 16, 21, 241, 147, 49, 73, 83, 51
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    145, 116, 107, 193, 254, 177, 198, 206, 98, 253, 61, 68, 247, 133, 245, 115
    };
    ...
    uint32_t golden[] = {
    316, 154, 261, 384, 443, 248, 351, 220, 114, 274, 302, 215, 296, 206, 328, 166
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
