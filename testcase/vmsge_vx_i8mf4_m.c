...
int main(){
    const int8_t data1[] = {
    -17, -21, 81, 125, 98, 28, -104, 104, 108, -106, -119, 59, 77, 97, 67, -128
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    72, 101, -24, 109, -120, 106, -99, 94, -110, -34, -56, 11, -17, -1, 32, 81
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_8mf4_b32_m (mask, data1_v, data2_v, vl);
