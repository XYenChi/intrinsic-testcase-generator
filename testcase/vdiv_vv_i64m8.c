...
int main(){
    const int64_t data1[] = {
    31, -72, -54, 126, 13, -107, -47, 79, 27, 4, -26, -64, 90, -123, 52, -126
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    64, -40, -37, -84, -124, 69, -72, -28, -100, -9, -30, -52, 29, -81, 120, -69
    };
    ...
    int64_t golden[] = {
    2, 0, 0, 18446744073709551615, 18446744073709551606, 18446744073709551615, 1, 18446744073709551615, 18446744073709551612, 18446744073709551613, 1, 0, 0, 0, 2, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
