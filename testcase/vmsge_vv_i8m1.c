...
int main(){
    const int8_t data1[] = {
    -123, -55, 36, 111, 62, 54, -10, 111, -103, 38, 119, 28, -51, -79, -72, -5
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    78, -36, -71, 21, -23, -62, -111, 104, 41, -86, 112, -78, 84, 60, -71, -110
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vv_8m1_b8 (data1_v, data2_v, vl);
