...
int main(){
    ...
    23, 235, 100, 131, 146, 83, 247, 109, 205, 4, 82, 200, 142, 57, 222, 171
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    126, 220, 20, 249, 196, 60, 250, 30, 19, 142, 62, 74, 75, 32, 105, 35
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_16mf2_b32 (data1_v, data2_v, vl);
