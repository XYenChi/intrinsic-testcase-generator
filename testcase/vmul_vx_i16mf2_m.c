...
int main(){
    const int16_t data1[] = {
    -87, 58, 38, 7, 11, -16, 30, -47, 45, -14, 30, 66, 56, -107, -50, 52
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    102, -5, -112, -120, -106, 26, -115, -61, -69, -55, 2, 40, -71, 105, -21, -7
    };
    ...
    int16_t golden[] = {
    56662, 65246, 1, 1, 1, 65120, 62086, 0, 0, 0, 1, 2640, 1, 54301, 0, 65172
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
