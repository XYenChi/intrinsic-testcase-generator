...
int main(){
    const uint8_t data1[] = {
    168, 147, 180, 252, 9, 83, 183, 81, 65, 74, 97, 253, 136, 229, 48, 194
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    144, 199, 53, 248, 61, 52, 250, 10, 234, 220, 61, 53, 194, 26, 124, 205
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vv_u8m2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    129, 69, 68, 0, 37, 220, 0, 0, 1, 152, 30, 97, 17, 67, 0, 91
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
