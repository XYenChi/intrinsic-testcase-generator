...
int main(){
    ...
    87, 201, 23, 190, 26, 117, 217, 136, 127, 49, 158, 253, 97, 120, 127, 130
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    46, 81, 111, 1, 128, 145, 91, 137, 163, 217, 88, 67, 143, 165, 158, 187
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u32mf2_m (mask, data1_v, data2_v, vl);
