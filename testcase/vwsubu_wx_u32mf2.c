...
int main(){
    ...
    10, 64, 59, 254, 208, 213, 201, 165, 73, 102, 151, 87, 246, 26, 169, 63
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    241, 181, 212, 229, 232, 165, 121, 140, 113, 90, 138, 221, 4, 133, 39, 83
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u32mf2 (data1_v, data2_v, vl);
