...
int main(){
    ...
    203, 214, 41, 120, 12, 28, 81, 217, 248, 7, 198, 65, 232, 188, 85, 86
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    255, 228, 1, 163, 109, 29, 38, 251, 135, 138, 10, 219, 122, 148, 23, 238
    };
    ...
    uint16_t golden[] = {
    459, 443, 42, 283, 122, 57, 120, 468, 384, 146, 208, 285, 355, 336, 108, 325
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
