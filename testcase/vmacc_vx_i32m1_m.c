...
int main(){
    const int32_t data1[] = {
    -28, -16, 113, 4, 126, 62, 46, 23, 72, 60, 104, -125, 69, 0, 74, 0
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -30, 35, 50, 5, 47, -110, 92, -10, -68, -16, -33, 4, -68, -24, -94, 38
    };
    ...
    uint32_t masked[] = {
    1, 0, 0, 0, 0, 1, 1, 1, 0, 1, 0, 1, 1, 0, 0, 0
    };
    ...
    int32_t golden[] = {
    841, 0, 0, 1, 0, 4294960477, 4232, 4294967066, 1, 4294966336, 1, 4294966796, 4294962605, 1, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
