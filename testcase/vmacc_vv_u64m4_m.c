...
int main(){
    ...
    50, 156, 216, 26, 214, 229, 131, 79, 15, 125, 0, 127, 84, 129, 176, 156
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    83, 155, 170, 119, 239, 103, 179, 169, 72, 11, 174, 81, 232, 193, 145, 175
    };
    const uint64_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e64m4(avl);
    const uint out_data[] = {
    0, 0, 1, 1, 1, 1, 0, 0, 0, 1, 1, 0, 1, 0, 1, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmacc_vv_u64m4_m (mask, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    4150, 0, 1, 1, 1, 23588, 0, 0, 1080, 1376, 1, 10287, 19489, 0, 25521, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
