...
int main(){
    ...
    188, 56, 108, 91, 76, 67, 86, 149, 143, 212, 101, 54, 44, 174, 195, 169
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    34, 153, 208, 224, 183, 30, 144, 88, 157, 144, 37, 193, 98, 199, 23, 147
    };
    ...
    uint64_t golden[] = {
    6392, 1, 1, 20384, 1, 2011, 1, 13113, 22451, 30529, 3738, 1, 1, 0, 4486, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
