...
int main(){
    ...
    11, 247, 45, 128, 6, 5, 50, 183, 107, 182, 230, 192, 86, 158, 150, 231
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    48, 193, 124, 88, 32, 44, 183, 3, 25, 159, 176, 67, 106, 167, 29, 76
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_32m4_b8 (data1_v, data2_v, vl);
