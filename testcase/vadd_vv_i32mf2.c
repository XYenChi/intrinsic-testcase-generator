...
int main(){
    const int32_t data1[] = {
    41, -93, -101, 117, -118, 32, 113, 53, 23, -122, 121, 105, 58, -104, -119, 127
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -41, -19, 28, 41, -78, 10, 98, -86, 46, -124, -114, 4, 6, 69, -92, 123
    };
    ...
    int32_t golden[] = {
    0, 4294967184, 4294967223, 158, 4294967100, 42, 211, 4294967263, 69, 4294967050, 7, 109, 64, 4294967261, 4294967085, 250
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
