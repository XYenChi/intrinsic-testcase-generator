...
int main(){
    const int32_t data1[] = {
    -29, 101, -82, 90, 68, 19, 73, 58, -73, -112, -49, -5, 60, -103, 78, 74
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    99, -50, 64, -12, -1, -24, 27, -101, 42, -87, -54, -95, -74, 122, 99, -60
    };
    ...
    int32_t golden[] = {
    70, 51, 4294967278, 78, 67, 4294967291, 100, 4294967253, 4294967265, 4294967097, 4294967193, 4294967196, 4294967282, 19, 177, 14
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
