...
int main(){
    const int32_t data1[] = {
    47, 56, 98, -11, 21, 46, -38, -22, -46, -71, 91, 74, 87, -41, -86, -107
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    55, -90, 13, -70, 105, 83, -102, -40, 16, 24, 49, -97, 58, 10, -61, 42
    };
    ...
    int32_t golden[] = {
    102, -34, 111, -81, 126, 127, -128, -62, -30, -47, 127, -23, 127, -31, -128, -65
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
