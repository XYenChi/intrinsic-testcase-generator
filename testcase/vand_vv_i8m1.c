...
int main(){
    const int8_t data1[] = {
    -46, -3, 65, 53, 80, 72, 85, 29, -81, 107, 31, 6, -127, 26, 73, -56
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -25, -39, 123, -108, -56, 27, 57, 109, 39, -29, 32, -53, 65, -109, -50, -10
    };
    ...
    int8_t golden[] = {
    231, 217, 123, 148, 200, 27, 57, 109, 39, 227, 32, 203, 65, 147, 206, 246
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
