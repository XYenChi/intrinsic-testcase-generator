...
int main(){
    const int16_t data1[] = {
    41, 96, -61, -125, 9, 57, -87, 63, -17, -63, -68, -68, -123, -105, 69, -11
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    113, 116, 85, 19, 15, -87, -64, -118, -54, 117, 121, 83, -75, -113, -39, -105
    };
    ...
    int16_t golden[] = {
    41, 96, 85, -125, 15, 57, -87, -118, -54, -63, 121, -68, -123, -105, -39, -11
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
