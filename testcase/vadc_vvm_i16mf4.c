...
int main(){
    const int16_t data1[] = {
    -77, 79, -63, 26, 48, -57, -46, 123, -56, 121, -24, -47, -119, 78, 39, 76
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -109, 48, -58, -63, -24, -14, 126, -45, -25, 70, 79, -33, -46, 57, 54, 113
    };
    ...
    int16_t golden[] = {
    -186, 128, -121, -37, 24, -71, 81, 78, -80, 191, 55, -79, -165, 135, 94, 190
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
