...
int main(){
    const int8_t data1[] = {
    215, 8, 137, 127, 170, 162, 112, 94, 108, 103, 245, 256, 212, 28, 143, 221
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    234, 230, 118, 131, 254, 46, 49, 186, 240, 64, 196, 179, 176, 102, 60, 124
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdiv_vv_i8m8 (data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    1, 28, 0, 1, 1, 0, 0, 1, 2, 0, 0, 0, 0, 3, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
