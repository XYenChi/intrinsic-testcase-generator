...
int main(){
    const int8_t data1[] = {
    -111, -119, 69, -86, -128, -2, 100, -9, 91, -116, 44, -126, -88, 117, -23, -62
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -13, -123, 12, -3, 83, -17, 60, -61, -82, -95, 80, 74, -84, -53, 70, 34
    };
    ...
    int8_t golden[] = {
    132, 14, 81, 167, 211, 237, 160, 186, 9, 45, 124, 204, 84, 64, 47, 228
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
