...
int main(){
    const int8_t data1[] = {
    -8, -103, 75, 98, 120, 3, 2, 74, -4, -31, 39, 96, 66, -46, 9, -5
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -37, -125, -49, -111, 91, 41, -112, 67, -47, -68, 18, 16, -111, -6, -100, 56
    };
    ...
    int8_t golden[] = {
    211, 28, 26, 243, 211, 44, 146, 141, 205, 157, 57, 112, 211, 204, 165, 51
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
