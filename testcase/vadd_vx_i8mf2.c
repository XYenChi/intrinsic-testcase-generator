...
int main(){
    const int8_t data1[] = {
    -122, -94, 34, 43, -117, -74, 52, 43, -52, 23, -39, -101, 36, 57, -77, -74
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    121, -78, 95, -105, -37, -13, 33, 126, 19, 58, 77, -87, -125, -36, 119, -25
    };
    ...
    int8_t golden[] = {
    255, 84, 129, 194, 102, 169, 85, 169, 223, 81, 38, 68, 167, 21, 42, 157
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
