...
int main(){
    ...
    200, 99, 89, 78, 177, 178, 137, 144, 69, 191, 178, 69, 7, 190, 201, 251
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    107, 215, 123, 151, 7, 109, 59, 77, 242, 48, 185, 175, 223, 165, 75, 255
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_32m2_b16 (data1_v, data2_v, vl);
