...
int main(){
    const int16_t data1[] = {
    77, 57, 52, 125, -20, 113, 54, 42, -18, -5, -77, 108, -82, 65, -13, -127
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    25, 217, 70, 59, 20, 99, 30, 83, 73, 210, 127, 216, 13, 187, 94, 46
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_16m1_b16 (mask, data1_v, data2_v, vl);
