...
int main(){
    const uint8_t data1[] = {
    26, 190, 12, 6, 18, 151, 165, 133, 244, 159, 62, 214, 223, 249, 181, 132
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    142, 83, 154, 235, 114, 68, 37, 151, 191, 160, 24, 59, 13, 187, 128, 246
    };
    ...
    uint8_t golden[] = {
    142, 190, 154, 235, 1, 0, 1, 1, 244, 0, 62, 0, 223, 0, 181, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
