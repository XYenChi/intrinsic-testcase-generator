...
int main(){
    const int8_t data1[] = {
    105, -58, -64, -111, -78, 113, -101, 127, -108, -64, 18, -117, 55, -41, 15, 60
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    0, -6, -84, 16, -1, 115, -56, 112, -107, -86, -20, -128, 50, 88, 93, 5
    };
    ...
    int8_t golden[] = {
    105, -64, -147, -94, -79, 229, -156, 240, -214, -150, -2, -245, 105, 48, 108, 66
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
