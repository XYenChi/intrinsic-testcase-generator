...
int main(){
    const int8_t data1[] = {
    -35, 44, -3, 91, 19, 11, -53, 127, -43, -110, -104, -28, 31, 105, 13, 0
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -61, -85, -92, 127, -51, 27, 122, -99, 35, -88, -48, -95, -16, 60, -77, 75
    };
    ...
    int8_t golden[] = {
    160, 215, 161, 218, 224, 38, 69, 28, 248, 58, 104, 133, 15, 165, 192, 75
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
