...
int main(){
    const int8_t data1[] = {
    19, -39, 127, 22, -71, 90, 17, 92, 6, 67, 101, -124, -61, 43, -87, -19
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -84, 114, -103, 55, -86, 56, 111, -50, 46, -4, 8, -21, -43, 0, -56, -69
    };
    ...
    int8_t golden[] = {
    191, 75, 24, 77, 99, 146, 128, 42, 52, 63, 109, 111, 152, 43, 113, 168
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
