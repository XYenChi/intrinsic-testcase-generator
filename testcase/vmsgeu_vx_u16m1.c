...
int main(){
    ...
    96, 51, 109, 143, 42, 49, 195, 39, 41, 51, 94, 186, 254, 60, 181, 21
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    121, 138, 38, 193, 156, 191, 85, 24, 37, 219, 91, 36, 8, 97, 72, 242
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_16m1_b16 (data1_v, data2_v, vl);
