...
int main(){
    ...
    167, 54, 213, 207, 193, 41, 236, 31, 39, 181, 29, 138, 155, 228, 230, 207
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    56, 7, 23, 46, 55, 24, 129, 150, 103, 10, 222, 72, 116, 112, 151, 39
    };
    ...
    uint64_t golden[] = {
    0, 0, 1, 18446744073709542095, 18446744073709541001, 1, 18446744073709521173, 1, 1, 18446744073709549807, 18446744073709545178, 1, 0, 18446744073709526081, 18446744073709516887, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
