...
int main(){
    const int16_t data1[] = {
    69, 56, -80, -55, -20, -18, 79, -45, -42, 21, 77, 106, 58, -65, 84, 122
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    35, 56, -44, -16, 64, 101, 99, 67, 98, -11, 70, -109, 5, 37, 87, -40
    };
    ...
    int16_t golden[] = {
    69, 56, 65492, 65520, 64, 101, 99, 67, 98, 21, 77, 106, 58, 37, 87, 122
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
