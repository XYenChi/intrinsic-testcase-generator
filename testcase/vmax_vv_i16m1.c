...
int main(){
    const int16_t data1[] = {
    95, -78, 59, -112, 29, 107, -33, -93, 103, -126, -119, -76, 123, 4, -62, 48
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    12, -24, -77, 15, -63, 43, 99, 29, 49, -30, -52, 93, 5, 28, 46, 29
    };
    ...
    int16_t golden[] = {
    95, 65512, 59, 15, 29, 107, 99, 29, 103, 65506, 65484, 93, 123, 28, 46, 48
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
