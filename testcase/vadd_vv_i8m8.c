...
int main(){
    const int8_t data1[] = {
    -68, 77, 29, 64, 117, 41, 45, -82, 34, 62, 11, -70, 20, -2, -88, -104
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    23, -104, 124, 35, 25, -64, 4, 29, 56, 125, 77, -92, -27, 116, -18, -50
    };
    ...
    int8_t golden[] = {
    211, 229, 153, 99, 142, 233, 49, 203, 90, 187, 88, 94, 249, 114, 150, 102
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
