...
int main(){
    const int8_t data1[] = {
    -51, 25, 127, 39, -127, -9, 34, -54, 73, 19, 43, 15, 116, 8, 81, -81
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -84, 88, 15, -34, 124, -5, 13, 11, -119, -118, 23, -47, -36, -24, 88, 64
    };
    ...
    int8_t golden[] = {
    121, 113, 142, 5, 253, 242, 47, 213, 210, 157, 66, 224, 80, 240, 169, 239
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
