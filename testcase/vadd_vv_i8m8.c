...
int main(){
    const int8_t data1[] = {
    -123, 47, 8, 91, -91, -41, -55, 114, 122, 81, -38, -69, -82, 39, 16, -109
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -86, 56, 100, 124, -69, 39, -49, -45, -97, -116, -31, 58, -113, 55, 40, -97
    };
    ...
    int8_t golden[] = {
    -128, 103, 108, 127, -128, -2, -104, 69, 25, -35, -69, -11, -128, 94, 56, -128
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
