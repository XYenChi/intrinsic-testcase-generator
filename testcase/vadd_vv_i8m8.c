...
int main(){
    const int8_t data1[] = {
    -1, -95, -106, 124, 126, 95, -98, 58, 23, 86, -33, -97, 63, 61, 117, -65
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    61, 0, -90, 3, 122, 16, 67, 45, 70, 107, 35, -36, -102, 76, -15, 38
    };
    ...
    int8_t golden[] = {
    60, 161, 60, 127, 248, 111, 225, 103, 93, 193, 2, 123, 217, 137, 102, 229
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
