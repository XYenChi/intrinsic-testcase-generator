...
int main(){
    ...
    5, 225, 8, 245, 65, 9, 4, 240, 49, 81, 183, 144, 53, 239, 88, 1
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    198, 75, 180, 218, 30, 224, 189, 48, 3, 129, 149, 127, 204, 240, 247, 114
    };
    ...
    uint16_t golden[] = {
    990, 16875, 1440, 53410, 1950, 2016, 756, 11520, 147, 10449, 27267, 18288, 10812, 57360, 21736, 114
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
