...
int main(){
    ...
    17, 32, 6, 167, 216, 201, 68, 142, 159, 213, 81, 121, 67, 27, 107, 253
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    24, 42, 63, 67, 29, 153, 3, 223, 85, 54, 128, 136, 67, 61, 128, 169
    };
    ...
    uint16_t golden[] = {
    408, 1344, 378, 11189, 6264, 30753, 204, 31666, 13515, 11502, 10368, 16456, 4489, 1647, 13696, 42757
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
