...
int main(){
    const int16_t data1[] = {
    120, 42, -109, -49, 124, 102, -15, 47, -38, -52, -49, -44, 19, -10, -121, -1
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    126, -121, -34, 104, -100, 95, -10, 68, 114, -34, 127, -21, 113, -95, -62, -91
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vv_16mf2_b32 (mask, data1_v, data2_v, vl);
