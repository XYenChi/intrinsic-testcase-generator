...
int main(){
    const int8_t data1[] = {
    -104, 52, 31, 13, 64, -48, -64, 17, 51, -27, 41, 50, 58, 12, -68, 122
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    26, -103, -17, -5, -22, -110, -44, 44, 90, -83, 51, -23, 67, -42, -117, 11
    };
    const int8_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e8mf8(avl);
    const int out_data[] = {
    0, 0, 1, 0, 1, 1, 1, 1, 0, 0, 1, 0, 0, 0, 0, 1
    };
    ...
    int8_t golden[] = {
    26, 0, 31, 13, 1, 1, 1, 1, 0, 0, 51, 50, 67, 12, 188, 122
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
