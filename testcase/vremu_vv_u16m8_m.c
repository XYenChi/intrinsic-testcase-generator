...
int main(){
    ...
    26, 229, 230, 139, 95, 231, 238, 172, 20, 102, 22, 193, 70, 60, 200, 235
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    121, 52, 89, 150, 4, 21, 98, 12, 33, 34, 146, 223, 54, 208, 117, 212
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vv_u16m8_m (mask, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    0, 0, 89, 11, 1, 21, 1, 1, 0, 0, 14, 30, 54, 0, 117, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
