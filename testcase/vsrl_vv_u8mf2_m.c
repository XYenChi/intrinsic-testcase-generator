...
int main(){
    const uint8_t data1[] = {
    226, 6, 131, 134, 34, 68, 68, 185, 147, 57, 191, 206, 50, 134, 136, 34
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    62, 205, 216, 129, 93, 126, 153, 205, 179, 90, 131, 141, 190, 253, 83, 172
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u8mf2_m (mask, data1_v, shift, vl);
    ...
    uint8_t golden[] = {
    226, 3, 131, 67, 17, 68, 34, 92, 73, 57, 95, 103, 50, 67, 68, 34
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
