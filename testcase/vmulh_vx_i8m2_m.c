...
int main(){
    const int8_t data1[] = {
    76, 106, -113, -84, -123, 85, 97, -122, -123, -42, 18, -26, -45, 50, 28, -43
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -19, -81, -47, 103, -71, 58, 120, 30, -68, -124, -1, -13, -96, -115, -30, 50
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vx_8m2_b4 (mask, data1_v, data2_v, vl);
