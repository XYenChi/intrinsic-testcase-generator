...
int main(){
    const int16_t data1[] = {
    -13, -63, 68, -6, -74, -23, 73, -108, -14, -7, 105, -34, 80, -2, 59, -75
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -43, 74, -28, -47, 100, -80, -104, 65, -123, 93, 98, -87, -66, 112, -95, -102
    };
    ...
    int16_t golden[] = {
    65523, 74, 1, 65530, 100, 1, 73, 65, 65522, 93, 105, 65502, 1, 112, 59, 65461
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
