...
int main(){
    const uint8_t data1[] = {
    244, 36, 154, 37, 138, 55, 195, 55, 147, 13, 211, 83, 46, 133, 100, 124
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    109, 50, 10, 92, 47, 235, 5, 130, 117, 153, 89, 21, 198, 231, 217, 254
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_8mf8_b64 (mask, data1_v, data2_v, vl);
