...
int main(){
    const int64_t data1[] = {
    109, -8, -60, 75, -50, 35, 38, -5, 53, -32, 26, 64, 83, -51, -4, 11
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -121, 43, 122, -41, 100, -14, 51, -81, -92, -91, -57, 0, 24, 121, 91, -118
    };
    ...
    int64_t golden[] = {
    18446744073709551604, 18446744073709551608, 62, 34, 50, 21, 38, 18446744073709551611, 18446744073709551524, 18446744073709551584, 26, 64, 83, 121, 18446744073709551612, 18446744073709551498
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
