...
int main(){
    const int32_t data1[] = {
    -81, 74, -77, 116, 80, -25, 74, -17, 71, -126, 34, -29, -6, -66, 22, -25
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    37, 23, -42, 30, 98, 124, 74, 102, 82, -8, 7, -85, 124, -44, 61, -45
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccus_vx_i32m2 (out_data, data1_v, data2_v, vl);
