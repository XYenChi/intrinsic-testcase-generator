...
int main(){
    const int16_t data1[] = {
    -1, -118, 121, -128, -46, 84, 97, 104, 126, -37, 43, -95, 114, -97, -101, -85
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    71, -57, 126, 107, -97, 93, -51, -58, -86, 36, 56, -110, 76, -118, -18, -70
    };
    ...
    int16_t golden[] = {
    65465, 0, 1, 65535, 2, 1, 65535, 65535, 65535, 65535, 1, 1, 0, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
