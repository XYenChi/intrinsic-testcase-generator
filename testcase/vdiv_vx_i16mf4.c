...
int main(){
    const int16_t data1[] = {
    88, 94, 53, -81, -4, -33, 103, -74, -51, -17, -22, -52, 73, -56, 56, -23
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -48, 34, -19, 46, 18, 9, -51, -53, -88, -33, 40, -59, 54, -90, -120, 69
    };
    ...
    int16_t golden[] = {
    65535, 0, 65535, 65535, 65531, 65535, 65535, 0, 1, 1, 65534, 1, 0, 1, 65533, 65533
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
