...
int main(){
    const uint8_t data1[] = {
    134, 223, 20, 84, 185, 180, 143, 3, 81, 161, 133, 199, 18, 243, 116, 121
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    162, 206, 177, 45, 43, 241, 91, 109, 190, 92, 243, 151, 114, 153, 183, 91
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_8m4 (data1_v, shift, vl);
