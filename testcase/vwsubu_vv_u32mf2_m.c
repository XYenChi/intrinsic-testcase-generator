...
int main(){
    ...
    39, 79, 185, 204, 250, 254, 106, 9, 136, 191, 88, 165, 204, 245, 120, 62
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    136, 108, 51, 80, 31, 170, 97, 116, 215, 191, 21, 209, 180, 81, 191, 87
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u32mf2_m (mask, data1_v, data2_v, vl);
