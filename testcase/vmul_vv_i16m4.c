...
int main(){
    const int16_t data1[] = {
    11, 100, 86, -64, -53, 25, 31, -86, -30, 86, -82, 1, -9, 24, 32, -98
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    28, 15, -13, -96, 68, -21, -26, 117, 60, -8, 3, 79, -32, -24, 15, -68
    };
    ...
    int16_t golden[] = {
    308, 1500, 64418, 6144, 61932, 65011, 64730, 55474, 63736, 64848, 65290, 79, 288, 64960, 480, 6664
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
