...
int main(){
    const int16_t data1[] = {
    2, 1, 106, -37, 11, 63, 62, -123, 110, -67, 44, 19, 36, 4, 79, -2
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -62, -90, -71, -19, -125, -82, -68, 118, 63, 58, 4, -50, 109, -105, -74, -54
    };
    ...
    int16_t golden[] = {
    65412, 65446, 58010, 703, 64161, 60370, 61320, 51022, 6930, 61650, 176, 64586, 3924, 65116, 59690, 108
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
