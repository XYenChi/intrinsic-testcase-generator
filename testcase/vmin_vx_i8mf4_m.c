...
int main(){
    const int8_t data1[] = {
    -76, -59, -35, -128, -5, 61, -8, -123, 116, 38, -105, 81, 51, -61, 65, 65
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -115, -15, -33, 25, 2, -111, -69, 121, 1, -41, 29, -36, -8, -94, -26, -79
    };
    ...
    uint32_t masked[] = {
    1, 0, 1, 1, 0, 0, 0, 1, 1, 0, 1, 0, 0, 0, 1, 1
    };
    ...
    int8_t golden[] = {
    180, 0, 223, 25, 0, 0, 1, 121, 116, 0, 29, 0, 0, 1, 65, 65
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
