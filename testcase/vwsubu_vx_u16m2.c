...
int main(){
    ...
    255, 182, 184, 215, 120, 125, 177, 71, 199, 145, 53, 98, 144, 71, 224, 203
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    207, 21, 40, 115, 216, 242, 57, 250, 233, 26, 37, 94, 53, 29, 119, 119
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u16m2 (data1_v, data2_v, vl);
