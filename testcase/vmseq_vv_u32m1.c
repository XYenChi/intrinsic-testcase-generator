...
int main(){
    ...
    69, 13, 242, 41, 112, 4, 173, 79, 242, 31, 12, 214, 120, 208, 252, 156
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    59, 151, 28, 139, 195, 144, 169, 63, 121, 62, 2, 242, 103, 168, 254, 242
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_32m1_b32 (data1_v, data2_v, vl);
