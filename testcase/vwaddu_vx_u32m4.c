...
int main(){
    ...
    91, 131, 175, 51, 54, 93, 3, 168, 87, 2, 52, 30, 85, 123, 172, 42
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    248, 213, 71, 40, 209, 253, 129, 1, 170, 234, 136, 211, 86, 173, 81, 222
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u32m4 (data1_v, data2_v, vl);
