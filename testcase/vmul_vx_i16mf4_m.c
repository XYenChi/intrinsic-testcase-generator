...
int main(){
    const int16_t data1[] = {
    -80, 26, 65, -62, 14, -73, -123, -63, -128, -78, 66, -42, 54, -96, 110, -56
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -37, -65, -22, -123, 72, 70, 50, 79, 64, 93, -26, 63, 50, 122, -92, -36
    };
    ...
    int16_t golden[] = {
    0, 1, 1, 1, 1, 1, 59386, 1, 57344, 0, 1, 62890, 2700, 53824, 0, 2016
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
