...
int main(){
    ...
    148, 182, 242, 131, 215, 94, 78, 244, 181, 193, 120, 144, 140, 188, 51, 219
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    171, 89, 95, 234, 110, 138, 221, 111, 157, 19, 81, 102, 16, 120, 192, 161
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_64m2_b32 (data1_v, data2_v, vl);
