...
int main(){
    ...
    105, 128, 131, 22, 19, 174, 6, 111, 211, 216, 139, 221, 103, 173, 156, 78
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    47, 243, 126, 150, 104, 74, 26, 46, 254, 19, 126, 82, 237, 102, 12, 87
    };
    ...
    uint32_t golden[] = {
    1, 0, 1, 150, 0, 1, 1, 46, 0, 19, 0, 82, 237, 1, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
