...
int main(){
    const int32_t data1[] = {
    86, -98, 9, -57, -113, 73, -97, -98, -16, -10, 85, 55, -11, 21, -49, 75
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    61, -89, 105, 107, 116, -102, 83, -8, -100, 45, -117, -50, -67, 72, -93, -21
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccus_vx_i32mf2 (out_data, data1_v, data2_v, vl);
