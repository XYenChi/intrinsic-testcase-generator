...
int main(){
    const uint8_t data1[] = {
    194, 226, 12, 141, 139, 99, 180, 218, 206, 248, 228, 28, 36, 255, 13, 160
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    107, 47, 221, 195, 182, 227, 24, 184, 212, 130, 167, 125, 144, 33, 126, 115
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vx_8mf8_b64_m (mask, data1_v, data2_v, vl);
