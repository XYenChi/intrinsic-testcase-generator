...
int main(){
    const int16_t data1[] = {
    37, 106, 118, 60, 101, 115, 24, 40, 76, 33, 99, -20, -77, -29, 96, -42
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    81, 63, -36, 16, 93, 100, -29, 51, -76, 50, 64, 2, -112, 70, -103, 79
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccsu_vv_i16m4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    1, 6679, 61289, 1, 9394, 11500, 0, 0, 59761, 1651, 1, 0, 8625, 1, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
