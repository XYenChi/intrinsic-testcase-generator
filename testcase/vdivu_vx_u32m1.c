...
int main(){
    ...
    184, 141, 103, 14, 239, 97, 53, 131, 201, 103, 155, 3, 187, 52, 115, 53
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    244, 149, 63, 150, 156, 127, 36, 15, 183, 138, 117, 155, 134, 19, 243, 97
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i32m1 (data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    1, 1, 0, 10, 0, 1, 0, 0, 0, 1, 0, 51, 0, 0, 2, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
