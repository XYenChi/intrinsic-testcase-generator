...
int main(){
    ...
    18, 244, 174, 179, 58, 5, 176, 9, 182, 253, 24, 221, 113, 146, 152, 111
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    168, 95, 64, 211, 30, 249, 244, 174, 46, 56, 76, 20, 190, 141, 36, 173
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_64m8_b8 (data1_v, data2_v, vl);
