...
int main(){
    const uint8_t data1[] = {
    85, 73, 45, 77, 30, 186, 122, 7, 156, 115, 16, 250, 174, 203, 41, 166
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    128, 253, 88, 20, 78, 25, 253, 205, 205, 127, 38, 77, 73, 175, 221, 26
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i8mf2 (data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    1, 3, 1, 0, 2, 0, 2, 29, 1, 1, 2, 0, 0, 0, 5, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
