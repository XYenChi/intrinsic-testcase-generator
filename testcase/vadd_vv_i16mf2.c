...
int main(){
    const int16_t data1[] = {
    -120, 19, -56, 57, 61, 101, 64, 83, -72, 71, -34, 4, -125, 105, 32, -42
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    58, 101, 65, 0, -82, 59, 101, 15, -68, 30, 126, 42, -9, 112, 11, 65
    };
    ...
    int16_t golden[] = {
    65474, 120, 9, 57, 65515, 160, 165, 98, 65396, 101, 92, 46, 65402, 217, 43, 23
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
