...
int main(){
    const int16_t data1[] = {
    55, -68, -89, -56, -111, -53, -118, -31, -18, 49, -5, -45, 124, 57, -127, -42
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -97, -57, -114, 53, -56, -65, 88, -36, 83, -64, 84, 76, -32, 113, 68, 59
    };
    ...
    int16_t golden[] = {
    65494, 65411, 65333, 65533, 65369, 65418, 65506, 65469, 65, 65521, 79, 31, 92, 170, 65477, 17
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
