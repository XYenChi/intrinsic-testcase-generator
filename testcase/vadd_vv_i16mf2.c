...
int main(){
    const int16_t data1[] = {
    41, -55, -110, 110, -102, -20, -84, -90, -61, -32, -52, 28, 56, -120, 17, -42
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -86, 35, -77, -101, -124, -55, -125, 104, -122, -32, -69, 8, 75, 77, -1, 92
    };
    ...
    int16_t golden[] = {
    65491, 65516, 65349, 9, 65310, 65461, 65327, 14, 65353, 65472, 65415, 36, 131, 65493, 16, 50
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
