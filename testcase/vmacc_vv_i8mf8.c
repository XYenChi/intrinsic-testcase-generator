...
int main(){
    const int8_t data1[] = {
    -58, 4, 72, -53, -115, 105, 5, 38, 1, -81, 74, 10, 7, -77, -112, 5
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -20, -34, 110, 53, 59, -38, -55, 126, -110, 51, -104, -39, -80, 34, 114, 69
    };
    ...
    int8_t golden[] = {
    137, 120, 241, 7, 127, 107, 237, 180, 146, 222, 240, 122, 209, 198, 32, 89
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
