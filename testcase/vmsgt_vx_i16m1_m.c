...
int main(){
    const int16_t data1[] = {
    0, -19, 4, 7, 71, 72, -107, -2, 27, -50, -42, 44, 55, 102, -41, 93
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -98, 14, 61, -17, 99, 41, -67, -37, -109, -12, 26, 18, 67, -110, -28, 15
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vx_16m1_b16_m (mask, data1_v, data2_v, vl);
