...
int main(){
    const int8_t data1[] = {
    -37, 96, -8, 64, -41, 43, -104, 114, -123, 70, -82, 49, 98, 7, 75, 10
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -112, 73, 5, -49, 49, 110, -90, -44, -112, -116, -23, -116, -23, -65, -110, 79
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsra_wx_8m4_m (mask, data1_v, shift, vl);
