...
int main(){
    ...
    244, 151, 112, 140, 205, 96, 40, 78, 3, 115, 36, 48, 57, 131, 17, 113
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    70, 132, 131, 33, 36, 168, 163, 85, 212, 216, 247, 10, 61, 248, 177, 142
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vx_16m4_b4 (data1_v, data2_v, vl);
