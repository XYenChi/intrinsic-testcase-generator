...
int main(){
    ...
    39, 55, 24, 135, 131, 138, 140, 226, 117, 14, 74, 11, 126, 25, 115, 58
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    26, 111, 61, 174, 101, 89, 176, 207, 233, 33, 108, 212, 254, 251, 181, 15
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u16m4_m (mask, data1_v, data2_v, vl);
