...
int main(){
    ...
    135, 194, 81, 150, 194, 234, 93, 33, 244, 253, 51, 53, 52, 147, 92, 98
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    143, 160, 40, 23, 186, 73, 196, 67, 108, 63, 23, 60, 219, 195, 152, 213
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u64m4_m (mask, data1_v, data2_v, vl);
