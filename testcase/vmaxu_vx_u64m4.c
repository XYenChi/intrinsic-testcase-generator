...
int main(){
    ...
    161, 164, 15, 28, 84, 7, 8, 139, 101, 45, 203, 97, 42, 151, 181, 159
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    34, 238, 81, 213, 170, 59, 53, 89, 6, 87, 72, 60, 77, 86, 39, 210
    };
    ...
    uint64_t golden[] = {
    161, 238, 81, 213, 170, 59, 53, 139, 101, 87, 203, 97, 77, 151, 181, 210
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
