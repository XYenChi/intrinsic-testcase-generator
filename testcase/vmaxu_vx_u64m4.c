...
int main(){
    ...
    3, 215, 181, 103, 124, 143, 0, 14, 85, 76, 206, 235, 25, 255, 138, 1
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    184, 115, 228, 220, 127, 110, 201, 50, 148, 1, 162, 171, 133, 228, 183, 127
    };
    ...
    uint64_t golden[] = {
    184, 215, 228, 220, 127, 143, 201, 50, 148, 76, 206, 235, 133, 255, 183, 127
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
