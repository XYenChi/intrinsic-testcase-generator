...
int main(){
    ...
    59, 156, 9, 74, 154, 243, 107, 176, 114, 105, 8, 127, 39, 62, 201, 155
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    209, 94, 105, 228, 14, 139, 34, 116, 114, 87, 191, 61, 157, 246, 220, 38
    };
    ...
    uint32_t golden[] = {
    209, 156, 9, 228, 168, 139, 107, 292, 114, 105, 8, 188, 39, 62, 220, 193
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
