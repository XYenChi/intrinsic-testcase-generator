...
int main(){
    ...
    41, 221, 144, 79, 129, 6, 237, 114, 228, 16, 251, 147, 113, 136, 216, 231
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    197, 81, 47, 140, 137, 238, 64, 177, 121, 137, 226, 16, 102, 98, 113, 158
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmadd_vv_u32mf2_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    238, 221, 144, 219, 129, 244, 237, 114, 349, 16, 251, 147, 102, 98, 216, 231
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
