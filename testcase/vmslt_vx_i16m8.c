...
int main(){
    const int16_t data1[] = {
    102, 117, -27, -28, -25, 107, 76, 64, -100, 97, 84, 108, 23, 83, 64, -43
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    16, 67, 71, 104, 122, 88, -94, 126, -16, 35, -45, 18, -50, -111, -46, -97
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_16m8_b2 (data1_v, data2_v, vl);
