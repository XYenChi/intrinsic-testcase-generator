...
int main(){
    ...
    67, 171, 143, 8, 85, 37, 41, 175, 43, 57, 101, 160, 51, 127, 195, 109
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    101, 200, 243, 0, 36, 242, 4, 137, 223, 219, 181, 80, 11, 66, 223, 138
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u16mf2_m (mask, data1_v, shift, vl);
    ...
    uint16_t golden[] = {
    33, 171, 71, 8, 85, 37, 41, 87, 21, 28, 50, 160, 25, 127, 97, 109
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
