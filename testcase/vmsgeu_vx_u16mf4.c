...
int main(){
    ...
    168, 107, 151, 11, 131, 138, 226, 191, 228, 18, 124, 89, 43, 251, 38, 233
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    165, 214, 172, 85, 173, 110, 135, 17, 218, 229, 241, 10, 61, 135, 113, 24
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_16mf4_b64 (data1_v, data2_v, vl);
