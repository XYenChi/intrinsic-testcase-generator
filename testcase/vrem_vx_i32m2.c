...
int main(){
    const int32_t data1[] = {
    92, 53, 29, 77, 51, 31, -94, 106, 17, -108, 4, -94, 58, 61, 75, -101
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    20, 124, 73, 83, 112, 29, -25, 38, 68, 23, 78, 125, 32, 78, -73, -13
    };
    ...
    int32_t golden[] = {
    20, 18, 15, 6, 10, 29, 4294967271, 38, 0, 4294967211, 2, 4294967233, 32, 17, 2, 4294967283
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
