...
int main(){
    const int16_t data1[] = {
    -65, 50, 68, -103, 57, 54, -104, -46, 20, 8, -93, -88, 43, 49, -82, -68
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    55, 56, 28, 70, -83, 36, 116, -106, 34, 79, 67, 80, 76, 31, 41, 69
    };
    ...
    int16_t golden[] = {
    65416, 65530, 40, 65363, 140, 54, 65316, 60, 20, 65465, 65376, 65448, 65503, 18, 65454, 65399
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
