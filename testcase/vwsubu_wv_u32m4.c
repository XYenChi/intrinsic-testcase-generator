...
int main(){
    ...
    12, 57, 3, 201, 182, 222, 165, 188, 146, 145, 167, 203, 191, 165, 68, 230
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    249, 19, 118, 131, 87, 81, 240, 87, 226, 27, 196, 77, 142, 207, 59, 230
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u32m4 (data1_v, data2_v, vl);
