...
int main(){
    const uint8_t data1[] = {
    94, 255, 166, 180, 201, 167, 215, 121, 38, 12, 176, 188, 163, 178, 16, 149
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    124, 50, 170, 67, 247, 151, 96, 46, 155, 83, 76, 85, 150, 96, 39, 164
    };
    ...
    uint8_t golden[] = {
    124, 0, 1, 180, 0, 167, 215, 121, 1, 0, 1, 1, 163, 178, 39, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
