...
int main(){
    const uint8_t data1[] = {
    204, 126, 167, 60, 186, 0, 122, 166, 87, 172, 117, 230, 97, 227, 223, 106
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    103, 182, 145, 245, 186, 216, 239, 119, 228, 142, 251, 82, 19, 51, 173, 145
    };
    ...
    uint8_t golden[] = {
    1, 1, 167, 1, 0, 0, 239, 166, 0, 172, 251, 230, 97, 1, 1, 145
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
