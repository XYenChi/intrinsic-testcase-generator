...
int main(){
    const int64_t data1[] = {
    -114, -3, 10, -114, 45, 103, -69, -21, -111, 53, -19, 125, 60, -78, -31, -8
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    3, -38, -14, 20, -65, -89, 38, 121, -54, 4, 66, -72, 112, -79, 33, -121
    };
    const int64_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e64m4(avl);
    const int out_data[] = {
    0, 1, 1, 1, 1, 1, 0, 1, 0, 0, 0, 0, 1, 0, 0, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_64m4_b16_m (mask, data1_v, data2_v, vl);
