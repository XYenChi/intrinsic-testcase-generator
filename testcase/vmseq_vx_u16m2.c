...
int main(){
    ...
    123, 136, 209, 54, 233, 22, 126, 25, 161, 205, 222, 15, 133, 248, 81, 29
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    240, 112, 103, 174, 101, 211, 106, 11, 145, 166, 213, 116, 76, 23, 176, 21
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vx_16m2_b8 (data1_v, data2_v, vl);
