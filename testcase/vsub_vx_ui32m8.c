...
int main(){
    const int32_t data1[] = {
    209, 85, 156, 126, 28, 38, 94, 108, 217, 11, 156, 152, 122, 205, 199, 251
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    118, 140, 233, 132, 226, 88, 227, 38, 158, 36, 160, 87, 202, 160, 254, 124
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vx_ui32m8 (data1_v, data2_v, vl);
    ...
    int32_t golden[] = {
    91, 0, 0, 0, 0, 0, 0, 70, 59, 0, 0, 65, 0, 45, 0, 127
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
