...
int main(){
    ...
    118, 162, 47, 64, 236, 144, 249, 173, 144, 234, 203, 91, 63, 25, 186, 75
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    247, 130, 33, 183, 90, 126, 79, 185, 20, 82, 178, 97, 52, 97, 34, 26
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u16mf4_m (mask, data1_v, data2_v, vl);
