...
int main(){
    const int8_t data1[] = {
    43, -127, 10, 1, 101, 110, 92, 115, -102, -68, 114, -12, 14, 91, 79, 22
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -57, 5, -123, -94, -109, -5, 58, -63, 12, 38, -113, -8, 24, 51, -7, -64
    };
    ...
    int8_t golden[] = {
    254, 255, 243, 162, 254, 255, 0, 255, 255, 255, 255, 0, 1, 0, 255, 253
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
