...
int main(){
    ...
    15, 168, 137, 38, 198, 24, 189, 150, 159, 99, 43, 14, 89, 136, 74, 73
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    255, 133, 65, 38, 238, 64, 234, 155, 147, 118, 180, 212, 113, 96, 73, 23
    };
    ...
    uint64_t golden[] = {
    3825, 22344, 8905, 1444, 47124, 1536, 44226, 23250, 23373, 11682, 7740, 2968, 10057, 13056, 5402, 1679
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
