...
int main(){
    const int16_t data1[] = {
    87, 55, 68, 112, 4, -105, 67, -119, -111, 6, -83, 18, -74, 14, 54, -3
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    197, 57, 45, 99, 37, 28, 192, 216, 181, 139, 183, 170, 49, 48, 191, 51
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_16mf4_b64 (data1_v, data2_v, vl);
