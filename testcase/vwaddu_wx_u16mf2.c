...
int main(){
    ...
    167, 105, 222, 226, 95, 29, 47, 65, 100, 69, 214, 11, 210, 19, 144, 73
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    217, 231, 153, 197, 36, 49, 76, 193, 196, 60, 192, 160, 169, 102, 179, 114
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wx_u16mf2 (data1_v, data2_v, vl);
