...
int main(){
    ...
    131, 42, 158, 33, 25, 150, 226, 175, 145, 105, 254, 131, 79, 8, 111, 193
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    209, 57, 147, 130, 76, 212, 19, 183, 198, 225, 126, 70, 32, 5, 222, 61
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u64m8_m (mask, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    78, 15, 147, 0, 0, 1, 1, 8, 1, 0, 126, 1, 32, 5, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
