...
int main(){
    const int32_t data1[] = {
    91, -99, -85, 113, 59, 57, 84, -102, -73, 106, -71, 22, 78, -1, -56, 0
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -123, 62, 44, 60, 65, -79, 103, 88, 15, 116, 94, -48, -67, 90, 56, -89
    };
    ...
    int32_t golden[] = {
    0, 0, 4294967255, 60, 6, 35, 1, 1, 4294967238, 10, 4294967248, 1, 1, 0, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
