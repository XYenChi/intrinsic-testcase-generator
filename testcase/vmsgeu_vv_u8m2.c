...
int main(){
    const uint8_t data1[] = {
    63, 0, 31, 77, 212, 63, 57, 146, 93, 252, 204, 145, 106, 34, 152, 121
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    6, 98, 7, 214, 118, 145, 228, 61, 46, 11, 212, 38, 45, 46, 190, 105
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_8m2_b4 (data1_v, data2_v, vl);
