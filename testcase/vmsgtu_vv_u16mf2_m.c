...
int main(){
    ...
    200, 170, 62, 22, 109, 158, 218, 238, 226, 55, 8, 84, 255, 59, 230, 193
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    48, 201, 152, 59, 168, 209, 215, 65, 204, 19, 57, 5, 33, 86, 119, 18
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_16mf2_b32_m (mask, data1_v, data2_v, vl);
