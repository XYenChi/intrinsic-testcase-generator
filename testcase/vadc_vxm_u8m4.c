...
int main(){
    const uint8_t data1[] = {
    163, 10, 8, 132, 75, 212, 48, 217, 99, 100, 209, 216, 140, 62, 107, 240
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    7, 40, 123, 27, 59, 247, 134, 15, 78, 74, 16, 175, 46, 50, 201, 160
    };
    ...
    uint8_t golden[] = {
    170, 50, 132, 160, 134, 460, 183, 233, 177, 175, 225, 392, 187, 113, 308, 401
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
