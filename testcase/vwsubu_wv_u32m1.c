...
int main(){
    ...
    194, 90, 48, 104, 25, 51, 160, 250, 219, 19, 203, 201, 250, 18, 171, 121
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    24, 187, 201, 56, 3, 116, 0, 115, 10, 87, 177, 94, 36, 105, 245, 146
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wv_u32m1 (data1_v, data2_v, vl);
