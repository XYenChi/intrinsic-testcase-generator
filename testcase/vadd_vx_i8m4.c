...
int main(){
    const int8_t data1[] = {
    97, -83, -28, -81, -41, -54, -64, -128, -97, 83, 67, 61, 17, -66, -86, 110
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    11, 120, -116, 118, -58, -16, -20, 66, -112, -42, 103, -119, -36, -36, 67, -33
    };
    ...
    int8_t golden[] = {
    108, 37, 112, 37, 157, 186, 172, 194, 47, 41, 170, 198, 237, 154, 237, 77
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
