...
int main(){
    const int8_t data1[] = {
    -107, -70, 23, 25, 26, 28, 9, -7, -70, -122, -124, -85, 116, 86, -10, -97
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -93, 84, -75, -29, 113, 82, -54, 80, 85, 47, -44, -22, -83, -59, -57, -115
    };
    ...
    int8_t golden[] = {
    56, 14, 204, 252, 139, 110, 211, 73, 15, 181, 88, 149, 33, 27, 189, 44
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
