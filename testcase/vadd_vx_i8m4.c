...
int main(){
    const int8_t data1[] = {
    -114, -119, -43, -73, 92, 20, 99, -119, 97, -29, 4, -30, -28, -32, 124, 42
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    57, -10, 113, -51, 9, -117, 120, -99, 64, 94, 21, -35, 86, 55, 120, 92
    };
    ...
    int8_t golden[] = {
    -202, -41, -110, 37, 12, 52, 22, -32, 21, 17, -113, 90, -52, -114, 57, -43
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
