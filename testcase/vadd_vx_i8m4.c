...
int main(){
    const int8_t data1[] = {
    24, 77, -10, -97, -55, 3, 84, -43, -70, 43, -47, -103, -117, 0, -7, -81
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -3, -3, -41, -42, -68, -97, -65, -104, 87, 113, 38, 18, -41, -12, 105, -40
    };
    ...
    int8_t golden[] = {
    21, 74, 205, 117, 133, 162, 19, 109, 17, 156, 247, 171, 98, 244, 98, 135
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
