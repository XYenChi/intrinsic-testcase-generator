...
int main(){
    ...
    126, 20, 211, 44, 66, 211, 253, 77, 96, 158, 99, 227, 216, 192, 60, 99
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    212, 17, 217, 236, 226, 213, 207, 0, 171, 84, 129, 31, 216, 242, 214, 87
    };
    ...
    uint64_t golden[] = {
    212, 17, 0, 236, 0, 213, 207, 1, 171, 84, 1, 31, 216, 242, 214, 87
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
