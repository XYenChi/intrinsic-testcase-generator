...
int main(){
    const uint8_t data1[] = {
    213, 168, 13, 4, 75, 44, 133, 59, 120, 52, 112, 233, 226, 207, 123, 29
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    45, 188, 5, 149, 178, 131, 146, 123, 137, 95, 219, 128, 238, 192, 89, 170
    };
    ...
    uint8_t golden[] = {
    0, 20, 248, 0, 0, 1, 1, 0, 1, 1, 107, 1, 1, 0, 222, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
