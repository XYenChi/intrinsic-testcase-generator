...
int main(){
    const int32_t data1[] = {
    90, 15, 16, 107, 117, 102, -111, 21, -43, -65, 104, 83, 127, -26, 43, 76
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -115, -23, 21, -17, 24, 73, -1, 96, 111, 57, 104, 59, -80, -11, 62, -14
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_32m8_b4 (data1_v, data2_v, vl);
