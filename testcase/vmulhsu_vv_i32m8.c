...
int main(){
    const int32_t data1[] = {
    40, -106, -70, -83, -89, -116, 68, 120, -39, 122, 14, -43, 37, -89, -128, -62
    };
    const int32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    4, 125, 221, 154, 248, 212, 122, 81, 41, 96, 37, 221, 84, 254, 175, 173
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_32m8_b4 (data1_v, data2_v, vl);
    ...
    int32_t golden[] = {
    0, -1, -1, -1, -1, -1, 0, 0, -1, 0, 0, -1, 0, -1, -1, -1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
