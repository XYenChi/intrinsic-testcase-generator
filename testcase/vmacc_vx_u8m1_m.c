...
int main(){
    const uint8_t data1[] = {
    136, 86, 15, 45, 249, 126, 11, 41, 161, 144, 133, 20, 85, 223, 178, 134
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    182, 82, 119, 104, 93, 90, 0, 227, 67, 106, 119, 125, 228, 77, 71, 137
    };
    ...
    uint8_t golden[] = {
    0, 141, 250, 72, 118, 77, 0, 0, 35, 160, 1, 196, 180, 19, 95, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
