...
int main(){
    ...
    165, 27, 184, 175, 234, 196, 116, 7, 136, 3, 242, 184, 250, 252, 51, 128
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    81, 203, 38, 248, 19, 165, 137, 44, 172, 166, 78, 112, 217, 37, 178, 156
    };
    ...
    uint32_t golden[] = {
    13365, 5481, 1, 1, 0, 0, 0, 308, 23392, 498, 18876, 20608, 1, 9324, 9078, 19968
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
