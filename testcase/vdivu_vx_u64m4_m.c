...
int main(){
    ...
    189, 11, 154, 10, 245, 135, 130, 150, 183, 61, 121, 60, 134, 5, 10, 12
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    124, 123, 202, 236, 96, 101, 142, 37, 58, 15, 163, 179, 176, 247, 44, 114
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vdivu_vx_i64m4_m (mask, data1_v, data2_v, vl);
    ...
    uint64_t golden[] = {
    0, 11, 1, 0, 0, 0, 1, 0, 0, 1, 1, 2, 0, 0, 1, 9
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
