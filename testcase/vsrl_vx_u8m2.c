...
int main(){
    const uint8_t data1[] = {
    41, 208, 111, 138, 10, 155, 241, 216, 143, 192, 237, 240, 197, 105, 7, 71
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    7, 250, 17, 245, 51, 106, 198, 41, 178, 205, 118, 22, 175, 22, 126, 122
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u8m2 (data1_v, shift, vl);
