...
int main(){
    const int32_t data1[] = {
    126, 50, 9, -69, 102, 95, -66, 69, 88, 63, -62, -83, -119, -12, -4, 116
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -57, 49, -74, -110, 125, 69, -84, -54, 41, -100, -106, -101, 34, 45, 20, 22
    };
    ...
    int32_t golden[] = {
    69, 99, -65, -128, 127, 127, -128, 15, 127, -37, -128, -128, -85, 33, 16, 127
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
