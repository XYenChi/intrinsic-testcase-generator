...
int main(){
    const int32_t data1[] = {
    82, -69, -1, 93, 58, 106, 11, -92, -82, 4, -123, 87, -83, 11, -50, 86
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    91, -88, 111, 88, -116, -88, 98, -9, 80, -105, 26, -59, 14, 97, 97, 87
    };
    ...
    int32_t golden[] = {
    173, 4294967139, 110, 181, 4294967238, 18, 109, 4294967195, 4294967294, 4294967195, 4294967199, 28, 4294967227, 108, 47, 173
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
