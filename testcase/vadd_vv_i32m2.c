...
int main(){
    const int32_t data1[] = {
    -73, -121, -3, -7, 80, 78, -2, 79, -77, -83, -78, 66, -95, -115, 30, -48
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    112, 11, -77, -14, 5, -10, 37, -79, 93, -43, 61, -94, 51, -38, -77, -53
    };
    ...
    int32_t golden[] = {
    39, 4294967186, 4294967216, 4294967275, 85, 68, 35, 0, 16, 4294967170, 4294967279, 4294967268, 4294967252, 4294967143, 4294967249, 4294967195
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
