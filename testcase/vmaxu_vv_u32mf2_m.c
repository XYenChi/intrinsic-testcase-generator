...
int main(){
    ...
    255, 22, 127, 89, 229, 117, 39, 176, 221, 195, 227, 86, 90, 204, 95, 255
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    226, 186, 238, 21, 171, 150, 7, 166, 195, 120, 63, 42, 119, 246, 123, 107
    };
    ...
    uint32_t golden[] = {
    0, 186, 1, 89, 0, 150, 39, 1, 0, 195, 0, 86, 119, 246, 1, 255
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
