...
int main(){
    const int32_t data1[] = {
    21, -60, -73, -91, 70, -29, -114, -15, -30, 104, -121, -43, 91, 90, -107, -114
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -117, -115, -57, 85, -74, -85, 113, -106, 36, 53, -23, -110, -65, 84, 96, 103
    };
    ...
    int32_t golden[] = {
    21, 4294967236, 4294967239, 85, 70, 4294967267, 113, 4294967281, 36, 104, 4294967273, 4294967253, 91, 90, 96, 103
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
