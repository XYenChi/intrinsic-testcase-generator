...
int main(){
    ...
    41, 146, 140, 223, 249, 56, 246, 217, 126, 51, 119, 235, 93, 3, 249, 159
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    181, 61, 231, 217, 49, 212, 189, 248, 56, 58, 61, 75, 160, 194, 15, 116
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u64m8 (data1_v, data2_v, vl);
