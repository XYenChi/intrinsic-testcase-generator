...
int main(){
    ...
    238, 144, 92, 100, 125, 47, 79, 156, 4, 92, 246, 230, 169, 52, 239, 63
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    63, 78, 126, 115, 156, 204, 100, 94, 217, 194, 138, 206, 35, 52, 11, 153
    };
    ...
    uint16_t golden[] = {
    0, 1, 0, 115, 0, 1, 0, 94, 217, 0, 1, 206, 35, 52, 1, 153
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
