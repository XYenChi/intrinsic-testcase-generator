...
int main(){
    ...
    161, 31, 182, 93, 151, 27, 40, 203, 152, 218, 216, 59, 200, 190, 217, 141
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    45, 49, 22, 124, 53, 72, 13, 9, 130, 204, 227, 200, 85, 139, 229, 185
    };
    ...
    uint16_t golden[] = {
    45, 49, 22, 0, 1, 0, 1, 0, 0, 204, 227, 200, 85, 139, 229, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
