...
int main(){
    const int8_t data1[] = {
    41, -82, -69, 38, -125, 104, -97, 59, 45, -104, 58, 44, 35, -127, 107, -61
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -32, 118, 11, 37, -3, 102, -49, -101, -46, 20, -110, 70, -126, -76, 0, 79
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vx_8mf2_b16 (data1_v, data2_v, vl);
