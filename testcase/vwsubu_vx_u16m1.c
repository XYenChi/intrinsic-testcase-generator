...
int main(){
    ...
    4, 222, 235, 145, 193, 69, 35, 192, 59, 104, 41, 26, 186, 134, 251, 75
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    236, 82, 225, 140, 86, 129, 59, 149, 170, 96, 106, 100, 170, 230, 190, 154
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u16m1 (data1_v, data2_v, vl);
