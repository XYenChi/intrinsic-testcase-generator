...
int main(){
    const int8_t data1[] = {
    -72, -121, -106, -21, 11, 54, -29, 91, -60, 114, -44, 88, 52, 37, 103, 86
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    111, 54, -21, 127, -16, -69, 67, -105, -45, 111, -42, 1, 94, 101, -16, 65
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_i8m4_m (mask, data1_v, data2_v, vl);
