...
int main(){
    ...
    61, 96, 233, 224, 253, 214, 237, 43, 71, 6, 209, 196, 95, 75, 203, 89
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    202, 185, 26, 244, 44, 196, 214, 33, 220, 164, 175, 237, 166, 38, 255, 209
    };
    ...
    uint16_t golden[] = {
    202, 0, 1, 1, 1, 196, 214, 1, 220, 164, 1, 237, 1, 38, 255, 209
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
