...
int main(){
    const int8_t data1[] = {
    -58, -57, 11, 25, 111, -80, -3, 17, 1, 49, -19, 69, 101, 114, -118, -38
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -43, -16, 115, -83, -107, 124, 42, -94, -31, -126, 39, 37, -21, 67, 37, 48
    };
    ...
    int8_t golden[] = {
    -101, -73, 126, -58, 4, 44, 39, -77, -30, -77, 20, 106, 80, 127, -81, 10
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
