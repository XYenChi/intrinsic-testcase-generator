...
int main(){
    const int8_t data1[] = {
    58, 43, -56, -69, 28, -98, 31, -11, 36, 58, -51, -111, 113, -65, 98, -72
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -125, -84, -17, -42, 84, 65, -111, 18, -7, 44, -48, 34, -86, -68, 6, -45
    };
    ...
    int8_t golden[] = {
    189, 215, 183, 145, 112, 223, 176, 7, 29, 102, 157, 179, 27, 123, 104, 139
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
