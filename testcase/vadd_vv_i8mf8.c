...
int main(){
    const int8_t data1[] = {
    -65, 68, -2, -3, -24, 119, -90, 47, -82, -88, -77, -39, 77, 107, 56, -120
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -48, 118, -58, 102, 7, -70, 16, -31, 86, -29, 55, 17, 118, -121, 28, -86
    };
    ...
    int8_t golden[] = {
    143, 186, 196, 99, 239, 49, 182, 16, 4, 139, 234, 234, 195, 242, 84, 50
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
