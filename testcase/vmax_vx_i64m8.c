...
int main(){
    const int64_t data1[] = {
    36, -122, -45, 20, 74, -92, 126, -2, -63, 8, 2, -115, -21, 123, -91, -63
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -77, 46, -109, 53, -95, -92, -9, 39, -124, 103, 85, 72, -103, -60, -75, 91
    };
    ...
    int64_t golden[] = {
    36, 46, 18446744073709551571, 53, 74, 18446744073709551524, 126, 39, 18446744073709551553, 103, 85, 72, 18446744073709551595, 123, 18446744073709551541, 91
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
