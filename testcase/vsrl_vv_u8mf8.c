...
int main(){
    const uint8_t data1[] = {
    96, 189, 130, 111, 48, 111, 184, 100, 214, 208, 28, 218, 208, 152, 92, 28
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    205, 211, 32, 150, 62, 57, 170, 214, 27, 215, 146, 93, 113, 51, 167, 114
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u8mf8 (data1_v, shift, vl);
