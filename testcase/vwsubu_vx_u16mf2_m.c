...
int main(){
    ...
    128, 234, 70, 67, 112, 100, 135, 22, 93, 118, 240, 204, 38, 171, 89, 80
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    196, 26, 97, 10, 200, 110, 118, 146, 230, 90, 204, 1, 229, 195, 43, 56
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u16mf2_m (mask, data1_v, data2_v, vl);
