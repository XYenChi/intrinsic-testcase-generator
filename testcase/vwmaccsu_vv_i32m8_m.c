...
int main(){
    const int32_t data1[] = {
    25, 74, 99, 39, -98, -8, -29, 74, -68, -86, 9, -19, -68, -13, 117, 56
    };
    const int32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    26, -127, -3, 91, -53, -126, -119, 82, 98, -126, -87, -90, 62, 56, -106, -103
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccsu_vv_i32m8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    int32_t golden[] = {
    1, 1, 1, 3550, 5194, 1008, 1, 6068, 4294960632, 1, 0, 1711, 4294963080, 4294966568, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
