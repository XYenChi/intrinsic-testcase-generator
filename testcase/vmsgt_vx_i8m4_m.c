...
int main(){
    const int8_t data1[] = {
    79, 68, -127, -29, -42, 52, -53, 60, 27, 44, -127, 68, 10, -124, -86, 123
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -59, 88, -24, 70, 18, 32, -31, -110, 117, -55, -12, -120, 24, 91, -79, 8
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vx_8m4_b2_m (mask, data1_v, data2_v, vl);
