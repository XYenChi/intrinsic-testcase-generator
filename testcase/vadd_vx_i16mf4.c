...
int main(){
    const int16_t data1[] = {
    127, 69, -70, -55, -118, -59, 85, -35, 13, 52, -39, 86, -26, -41, 112, 34
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -55, 35, 38, -81, 117, 121, -85, -65, 13, -84, 21, 78, -14, 21, 88, -66
    };
    ...
    int16_t golden[] = {
    72, 104, 65504, 65400, 65535, 62, 0, 65436, 26, 65504, 65518, 164, 65496, 65516, 200, 65504
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
