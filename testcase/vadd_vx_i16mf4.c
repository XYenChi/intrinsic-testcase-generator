...
int main(){
    const int16_t data1[] = {
    24, 14, 90, 103, 38, 123, 55, -116, -70, 47, 124, -97, 42, -46, -81, 59
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    69, -125, 49, 124, -96, 106, -88, 12, 24, 107, -35, 6, -87, 52, -41, 26
    };
    ...
    int16_t golden[] = {
    93, -111, 127, 127, -58, 127, -33, -104, -46, 127, 89, -91, -45, 6, -122, 85
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
