...
int main(){
    const int16_t data1[] = {
    -7, 19, -109, 74, -58, -85, 59, 16, 62, 80, -44, -3, 125, -3, -120, 4
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    44, -32, 37, 72, 19, -103, -9, 121, 118, -24, -79, 54, 2, -91, -40, -80
    };
    ...
    int16_t golden[] = {
    37, 65523, 65464, 146, 65497, 65348, 50, 137, 180, 56, 65413, 51, 127, 65442, 65376, 65460
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
