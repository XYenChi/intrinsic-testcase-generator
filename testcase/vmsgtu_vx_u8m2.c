...
int main(){
    const uint8_t data1[] = {
    158, 54, 92, 239, 37, 244, 100, 96, 243, 2, 101, 46, 49, 246, 75, 240
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    112, 151, 5, 146, 41, 85, 233, 240, 26, 64, 17, 207, 91, 181, 236, 20
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_8m2_b4 (data1_v, data2_v, vl);
