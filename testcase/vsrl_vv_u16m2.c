...
int main(){
    ...
    254, 205, 78, 184, 138, 94, 248, 231, 179, 28, 59, 120, 6, 64, 118, 38
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    246, 1, 247, 71, 56, 15, 169, 46, 236, 230, 1, 138, 130, 21, 164, 222
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u16m2 (data1_v, shift, vl);
