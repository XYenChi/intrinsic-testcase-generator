...
int main(){
    ...
    58, 127, 120, 161, 240, 147, 194, 176, 70, 39, 59, 137, 99, 212, 145, 13
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    254, 40, 149, 155, 245, 235, 149, 99, 61, 227, 10, 133, 224, 82, 228, 151
    };
    ...
    uint32_t golden[] = {
    4294967100, 87, 4294967267, 6, 4294967291, 4294967208, 45, 77, 9, 4294967108, 49, 4, 4294967171, 130, 4294967213, 4294967158
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
