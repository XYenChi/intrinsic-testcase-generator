...
int main(){
    ...
    228, 67, 32, 216, 124, 162, 163, 221, 191, 16, 182, 64, 30, 214, 191, 64
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    120, 159, 8, 87, 172, 107, 61, 67, 101, 128, 246, 232, 20, 255, 20, 111
    };
    ...
    uint32_t golden[] = {
    108, 4294967204, 24, 129, 4294967248, 55, 102, 154, 90, 4294967184, 4294967232, 4294967128, 10, 4294967255, 171, 4294967249
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
