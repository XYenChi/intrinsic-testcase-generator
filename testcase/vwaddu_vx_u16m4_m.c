...
int main(){
    ...
    69, 203, 12, 61, 147, 41, 23, 0, 11, 63, 208, 85, 71, 172, 88, 37
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    48, 29, 97, 171, 212, 250, 15, 92, 126, 253, 252, 27, 117, 51, 185, 8
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vx_u16m4_m (mask, data1_v, data2_v, vl);
