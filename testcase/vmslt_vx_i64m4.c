...
int main(){
    const int64_t data1[] = {
    120, -124, 67, 89, -106, 27, 66, 57, 111, 72, 91, 100, 113, 27, -3, -27
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -17, 64, 109, -42, 88, 87, -95, -29, -29, 11, 30, -41, -92, -70, -93, 84
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_64m4_b16 (data1_v, data2_v, vl);
