...
int main(){
    const int32_t data1[] = {
    112, 12, -4, 51, -95, -96, -84, 79, 13, 97, 57, -97, 67, 36, 77, 69
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    115, -23, 108, 107, -33, -82, 123, 103, -99, -64, -105, -108, -99, 124, 69, 111
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vx_32m4_b8_m (mask, data1_v, data2_v, vl);
