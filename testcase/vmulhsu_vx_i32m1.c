...
int main(){
    const int32_t data1[] = {
    -115, 103, 23, 57, 51, 25, 64, 89, -47, -62, -68, -52, 74, 44, 33, -74
    };
    const int32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    136, 221, 129, 7, 153, 177, 245, 166, 21, 6, 146, 67, 87, 208, 210, 67
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_32m1_b32 (data1_v, data2_v, vl);
