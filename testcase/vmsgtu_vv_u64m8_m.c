...
int main(){
    ...
    156, 41, 132, 60, 236, 186, 225, 166, 10, 234, 149, 109, 148, 81, 34, 209
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    111, 130, 48, 252, 1, 154, 212, 156, 19, 165, 211, 5, 98, 91, 105, 160
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_64m8_b8_m (mask, data1_v, data2_v, vl);
