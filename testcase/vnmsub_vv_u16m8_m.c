...
int main(){
    ...
    167, 212, 20, 197, 57, 43, 82, 0, 253, 226, 250, 241, 185, 252, 75, 61
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    23, 90, 114, 43, 120, 117, 97, 226, 24, 198, 145, 23, 170, 248, 152, 216
    };
    ...
    uint16_t golden[] = {
    167, 1, 20, 1, 65473, 43, 1, 0, 253, 0, 105, 241, 185, 4, 1, 65381
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
