...
int main(){
    const int16_t data1[] = {
    72, 44, -49, -119, 32, 18, 13, -119, -12, 102, 43, 63, 62, 117, 63, -124
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    108, 1, -128, -121, 78, 64, 43, 47, -44, 96, 29, 27, -10, 89, -90, -19
    };
    ...
    int16_t golden[] = {
    7776, 44, 6272, 14399, 2496, 1152, 559, 59943, 528, 9792, 1247, 1701, 64916, 10413, 59866, 2356
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
