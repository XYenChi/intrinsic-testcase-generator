...
int main(){
    const int16_t data1[] = {
    57, -105, 1, -99, -121, -68, -63, 103, 5, -64, -69, 82, 126, -14, 5, -111
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    44, 32, -123, 6, -7, -103, 110, -63, 87, -111, -85, 15, -102, -107, 67, 77
    };
    ...
    int16_t golden[] = {
    2508, 62176, 65413, 64942, 847, 7004, 58606, 59047, 435, 7104, 5865, 1230, 52684, 1498, 335, 56989
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
