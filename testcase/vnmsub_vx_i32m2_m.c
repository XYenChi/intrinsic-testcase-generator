...
int main(){
    const int32_t data1[] = {
    -33, -61, 81, -42, 95, -120, 71, 86, 101, -35, -67, 49, -98, 97, -37, 23
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    25, -40, 116, -122, 86, 95, 13, 39, 93, 111, -49, -26, 56, -82, 55, -87
    };
    ...
    int32_t golden[] = {
    4294967238, 4294967275, 0, 1, 1, 0, 1, 0, 0, 4294967150, 1, 49, 4294967198, 1, 4294967204, 23
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
