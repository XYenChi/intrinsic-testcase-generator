...
int main(){
    const uint8_t data1[] = {
    89, 192, 71, 182, 148, 220, 102, 238, 201, 213, 49, 183, 10, 51, 9, 46
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    196, 33, 52, 160, 48, 197, 187, 8, 82, 168, 22, 92, 164, 138, 239, 22
    };
    ...
    uint32_t masked[] = {
    0, 1, 1, 0, 0, 1, 0, 0, 1, 0, 1, 0, 1, 0, 1, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccu_vv_u8mf4_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    1, 192, 108, 1, 1, 77, 1, 1, 98, 0, 54, 1, 104, 0, 104, 244
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
