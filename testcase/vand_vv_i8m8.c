...
int main(){
    const int8_t data1[] = {
    -98, -73, 17, 125, 116, -40, -122, -56, -116, 114, 102, -32, -51, -36, -127, -77
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    31, -37, -9, -103, -48, -78, -95, 18, 32, -56, 119, 24, -75, -33, 45, 16
    };
    ...
    int8_t golden[] = {
    31, 219, 247, 153, 208, 178, 161, 18, 32, 200, 119, 24, 181, 223, 45, 16
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
