...
int main(){
    const int8_t data1[] = {
    124, -62, 76, -62, -5, 127, -37, 50, -80, -26, -51, 66, -103, 3, -19, -128
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    71, 113, -102, -68, 28, 59, 103, 24, 76, -44, -76, -17, 88, -90, 77, -102
    };
    ...
    int8_t golden[] = {
    71, 113, 154, 188, 28, 59, 103, 24, 76, 212, 180, 239, 88, 166, 77, 154
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
