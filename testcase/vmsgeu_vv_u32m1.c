...
int main(){
    ...
    185, 109, 2, 239, 146, 55, 136, 110, 141, 53, 233, 244, 221, 199, 184, 142
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    232, 195, 217, 209, 46, 52, 3, 174, 158, 91, 79, 222, 241, 59, 175, 37
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vv_32m1_b32 (data1_v, data2_v, vl);
