...
int main(){
    const int64_t data1[] = {
    -70, -26, 87, 33, -19, -2, 49, -113, -3, 125, -56, -27, -41, -37, -111, 107
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -93, 83, 102, -78, 115, -74, -5, -22, 40, 101, 81, -8, -126, 8, 110, -82
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmaccus_vx_i64m1 (out_data, data1_v, data2_v, vl);
