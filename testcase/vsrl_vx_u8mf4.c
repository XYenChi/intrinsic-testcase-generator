...
int main(){
    const uint8_t data1[] = {
    16, 51, 12, 194, 132, 43, 136, 144, 14, 81, 64, 178, 153, 218, 41, 14
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    146, 38, 191, 1, 92, 230, 70, 241, 218, 207, 254, 67, 80, 31, 241, 65
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u8mf4 (data1_v, shift, vl);
