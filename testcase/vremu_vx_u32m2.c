...
int main(){
    ...
    243, 170, 236, 27, 132, 188, 207, 1, 125, 39, 44, 130, 142, 98, 69, 212
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    168, 16, 11, 198, 168, 24, 13, 87, 29, 85, 159, 172, 203, 245, 242, 230
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u32m2 (data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    168, 16, 11, 9, 36, 24, 13, 0, 29, 7, 27, 42, 61, 49, 35, 18
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
