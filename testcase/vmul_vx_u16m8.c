...
int main(){
    ...
    216, 187, 136, 136, 145, 97, 37, 99, 186, 204, 107, 145, 161, 199, 248, 167
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    96, 96, 63, 233, 94, 191, 182, 202, 58, 3, 202, 150, 14, 169, 243, 102
    };
    ...
    uint16_t golden[] = {
    20736, 17952, 8568, 31688, 13630, 18527, 6734, 19998, 10788, 612, 21614, 21750, 2254, 33631, 60264, 17034
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
