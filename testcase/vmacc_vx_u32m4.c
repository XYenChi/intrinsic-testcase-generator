...
int main(){
    ...
    71, 2, 47, 224, 19, 123, 135, 235, 81, 13, 194, 2, 252, 185, 57, 101
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    47, 236, 49, 37, 54, 202, 178, 91, 163, 217, 110, 53, 184, 138, 134, 49
    };
    ...
    uint32_t golden[] = {
    3338, 472, 2303, 8289, 1026, 24847, 24031, 21386, 13204, 2821, 21340, 107, 46369, 25531, 7638, 4949
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
