...
int main(){
    const int8_t data1[] = {
    -25, 75, 6, -54, -69, -79, -101, -56, 44, 57, -1, -54, 43, 16, 10, 103
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -82, 71, -22, 125, -66, 90, 37, -53, 21, 39, -82, -78, 15, -94, -70, -72
    };
    ...
    int8_t golden[] = {
    254, 51, 132, 95, 54, 199, 153, 104, 100, 82, 174, 141, 124, 224, 189, 248
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
