...
int main(){
    ...
    145, 82, 253, 71, 192, 211, 106, 89, 1, 184, 213, 214, 144, 232, 204, 137
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    133, 127, 214, 220, 58, 186, 207, 206, 121, 100, 107, 191, 38, 225, 223, 233
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u16m4 (data1_v, data2_v, vl);
