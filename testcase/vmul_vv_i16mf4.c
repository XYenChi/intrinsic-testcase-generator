...
int main(){
    const int16_t data1[] = {
    0, 79, 72, -65, -57, 84, 94, -104, -53, -15, 27, -4, 14, 35, 4, 15
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    71, -30, 78, 35, 97, 95, 74, 40, 11, -84, -112, -44, 87, -100, -23, 79
    };
    ...
    int16_t golden[] = {
    0, 63166, 5616, 63261, 60007, 7980, 6956, 61376, 64953, 1260, 62512, 176, 1218, 62036, 65444, 1185
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
