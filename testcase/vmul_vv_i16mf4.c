...
int main(){
    const int16_t data1[] = {
    -10, 75, -69, -122, 47, -22, 44, -32, 79, -98, 13, -95, 118, 4, 46, 127
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    18, -54, -21, -86, 80, -100, 104, 45, 60, -68, 30, 123, -4, 95, 121, 97
    };
    ...
    int16_t golden[] = {
    65356, 61486, 1449, 10492, 3760, 2200, 4576, 64096, 4740, 6664, 390, 53851, 65064, 380, 5566, 12319
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
