...
int main(){
    const int64_t data1[] = {
    12, 89, 112, -30, -62, -111, -44, -89, 103, 13, -65, 11, 117, -34, 88, 101
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    50, 1, -117, -76, 36, 40, -74, -32, 46, -114, 94, -19, -8, 118, 28, 31
    };
    ...
    int64_t golden[] = {
    18446744073709551016, 18446744073709551528, 13105, 18446744073709549337, 2233, 0, 18446744073709548360, 18446744073709548769, 1, 0, 1, 210, 1, 0, 0, 18446744073709548485
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
