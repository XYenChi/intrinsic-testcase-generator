...
int main(){
    const int64_t data1[] = {
    62, -91, -99, -3, 20, 57, -118, 120, 99, -7, 99, -45, 10, 1, 89, -87
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -43, -8, 59, -53, 99, 78, -96, -107, -74, -107, 42, -21, 94, 110, -77, -57
    };
    ...
    int64_t golden[] = {
    1, 0, 1, 0, 0, 21, 22, 18446744073709551389, 1, 1, 1, 0, 0, 109, 18446744073709551450, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
