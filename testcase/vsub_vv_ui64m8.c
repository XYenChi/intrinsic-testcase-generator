...
int main(){
    const int64_t data1[] = {
    91, 113, 23, 180, 0, 206, 161, 251, 123, 89, 16, 137, 195, 13, 226, 212
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    126, 217, 80, 176, 129, 230, 109, 98, 120, 66, 149, 32, 240, 213, 0, 178
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vv_ui64m8 (data1_v, data2_v, vl);
    ...
    int64_t golden[] = {
    0, 0, 0, 4, 0, 0, 52, 153, 3, 23, 0, 105, 0, 0, 226, 34
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
