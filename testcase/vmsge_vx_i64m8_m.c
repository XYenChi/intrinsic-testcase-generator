...
int main(){
    const int64_t data1[] = {
    -69, -114, -63, 24, -27, 66, -104, 107, 99, 64, -21, -23, 101, -70, 95, 78
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    -99, -98, -50, 26, 23, -41, 56, -114, -35, -9, -30, -23, -126, 97, -12, 85
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_64m8_b8_m (mask, data1_v, data2_v, vl);
