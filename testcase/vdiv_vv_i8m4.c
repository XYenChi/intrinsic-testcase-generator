...
int main(){
    const int8_t data1[] = {
    69, 18, -77, 61, 77, 33, 25, -22, -45, -100, -103, 115, 13, -16, -127, -88
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -127, -31, 62, -58, 105, 80, -105, -12, -60, -53, 64, -41, 72, 112, 50, 76
    };
    ...
    int8_t golden[] = {
    254, 254, 255, 255, 1, 2, 251, 0, 1, 0, 255, 255, 5, 249, 255, 255
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
