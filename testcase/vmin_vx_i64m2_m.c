...
int main(){
    const int64_t data1[] = {
    28, 124, -7, 70, -114, 126, -4, 125, -84, -73, 60, 44, 5, -1, 126, -87
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    34, 70, 5, -15, -42, 72, -112, -8, -112, -25, 35, -92, 46, -18, -117, 117
    };
    ...
    int64_t golden[] = {
    34, 124, 5, 1, 0, 0, 1, 1, 1, 18446744073709551591, 60, 1, 46, 18446744073709551615, 126, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
