...
int main(){
    const int64_t data1[] = {
    23, 0, 83, 8, -70, 31, 55, 36, -25, -84, -38, 39, 67, 13, 64, 37
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    49, 100, -89, -71, 2, -3, -38, -66, -78, 43, 79, -27, -49, 61, 116, -30
    };
    ...
    int64_t golden[] = {
    0, 0, 1, 569, 141, 94, 0, 1, 1, 1, 1, 0, 1, 18446744073709550823, 18446744073709544193, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
