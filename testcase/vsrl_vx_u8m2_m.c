...
int main(){
    const uint8_t data1[] = {
    63, 3, 144, 51, 155, 143, 251, 222, 33, 14, 176, 33, 54, 159, 223, 58
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    139, 63, 98, 81, 239, 112, 107, 67, 7, 112, 83, 72, 9, 166, 20, 140
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u8m2_m (mask, data1_v, shift, vl);
    ...
    uint8_t golden[] = {
    31, 1, 144, 25, 77, 143, 125, 111, 16, 14, 88, 33, 27, 159, 223, 58
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
