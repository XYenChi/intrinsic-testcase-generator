...
int main(){
    const int16_t data1[] = {
    -6, -61, -3, -65, 50, 0, 10, -91, -39, 101, 94, 94, 47, 35, -120, 27
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    113, -126, 115, 73, -62, 60, -71, 60, -59, -25, -87, -87, -101, 7, -34, 62
    };
    ...
    int16_t golden[] = {
    65417, 65, 65418, 65398, 1, 65476, 81, 65385, 1, 126, 181, 1, 1, 28, 65450, 65501
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
