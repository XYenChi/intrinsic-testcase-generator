...
int main(){
    ...
    211, 171, 224, 130, 134, 62, 229, 24, 201, 191, 232, 205, 178, 62, 167, 103
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    84, 90, 155, 141, 217, 3, 94, 13, 13, 120, 20, 183, 174, 55, 208, 77
    };
    ...
    uint16_t golden[] = {
    1, 1, 224, 141, 1, 1, 0, 1, 0, 1, 0, 205, 178, 62, 208, 103
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
