...
int main(){
    ...
    133, 3, 35, 174, 131, 200, 175, 22, 252, 17, 115, 29, 95, 86, 158, 15
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    81, 14, 101, 168, 228, 214, 124, 188, 92, 114, 53, 154, 89, 247, 118, 62
    };
    const uint16_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e16m8(avl);
    const uint out_data[] = {
    0, 1, 1, 1, 1, 0, 0, 1, 0, 0, 1, 0, 1, 1, 0, 1
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_wx_u16m8_m (mask, data1_v, data2_v, vl);
