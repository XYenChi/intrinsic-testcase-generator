...
int main(){
    ...
    163, 20, 215, 105, 26, 13, 183, 227, 255, 143, 211, 221, 242, 146, 216, 221
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    194, 29, 253, 179, 152, 103, 176, 146, 247, 85, 56, 125, 191, 189, 155, 127
    };
    ...
    uint64_t golden[] = {
    1, 18446744073709551607, 0, 1, 1, 0, 1, 0, 1, 58, 155, 0, 51, 1, 61, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
