...
int main(){
    const int64_t data1[] = {
    -3, -47, 112, 61, -44, 41, -105, 85, -21, 108, -107, -74, 7, -106, 31, 120
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    89, -53, 72, 51, 67, 57, 34, 80, 116, 20, -32, -32, -45, 36, 28, -115
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsge_vx_64m4_b16 (data1_v, data2_v, vl);
