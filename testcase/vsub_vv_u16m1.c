...
int main(){
    ...
    186, 27, 148, 46, 106, 121, 85, 84, 212, 65, 206, 187, 87, 164, 26, 137
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    164, 148, 218, 20, 235, 45, 221, 208, 166, 7, 19, 53, 63, 201, 144, 25
    };
    ...
    uint16_t golden[] = {
    22, 65415, 65466, 26, 65407, 76, 65400, 65412, 46, 58, 187, 134, 24, 65499, 65418, 112
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
