...
int main(){
    const int8_t data1[] = {
    -26, 21, -5, -114, -60, -58, 43, -75, 114, -90, -122, -73, -9, -34, 100, -70
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    23, -57, 34, 47, 122, 97, -99, -12, -49, -79, 113, -56, -58, 22, -55, -93
    };
    ...
    int8_t golden[] = {
    170, 83, 86, 19, 105, 6, 96, 133, 47, 199, 38, 248, 10, 20, 132, 110
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
