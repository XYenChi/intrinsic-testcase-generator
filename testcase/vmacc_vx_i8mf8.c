...
int main(){
    const int8_t data1[] = {
    37, 44, 70, 91, -69, 55, -85, 84, 60, 99, 127, -119, 122, -110, 76, 16
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -78, -70, -57, -64, -18, -105, 44, -79, 14, 94, 24, 13, -4, -74, 73, -47
    };
    ...
    int8_t golden[] = {
    186, 248, 107, 64, 218, 113, 100, 20, 73, 90, 232, 245, 25, 204, 172, 16
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
