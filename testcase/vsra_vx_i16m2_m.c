...
int main(){
    const int16_t data1[] = {
    66, 8, 74, -1, 87, -70, -41, -2, 84, 33, -51, -6, 96, -19, 34, 119
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    28, 104, -119, -8, 79, 19, -35, -69, 87, 54, -24, 54, 98, 61, -73, 93
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsra_vx_i16m2_m (mask, data1_v, shift, vl);
    ...
    int16_t golden[] = {
    66, 8, 37, -1, 43, -35, -21, -1, 42, 33, -51, -6, 96, -10, 17, 59
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
