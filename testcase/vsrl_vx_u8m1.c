...
int main(){
    const uint8_t data1[] = {
    144, 188, 246, 73, 223, 72, 34, 66, 181, 231, 114, 239, 117, 142, 121, 80
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    136, 245, 168, 247, 173, 245, 193, 252, 137, 33, 3, 244, 176, 53, 41, 162
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u8m1 (data1_v, shift, vl);
