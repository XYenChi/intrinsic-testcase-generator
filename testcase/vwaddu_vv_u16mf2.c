...
int main(){
    ...
    187, 246, 0, 216, 243, 153, 92, 11, 137, 67, 164, 52, 169, 67, 115, 178
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    4, 73, 192, 43, 209, 239, 225, 77, 27, 130, 128, 41, 198, 3, 54, 184
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_vv_u16mf2 (data1_v, data2_v, vl);
