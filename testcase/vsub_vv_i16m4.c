...
int main(){
    const int16_t data1[] = {
    -97, 97, -27, 44, 120, -102, -99, -100, 116, 66, -10, -77, -68, -44, 68, -41
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -61, 19, -76, 75, -44, -77, -121, 21, 39, -53, -43, 106, -48, -21, 45, 79
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vv_i16m4 (data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    -36, 78, 49, -31, 127, -25, 22, -121, 77, 119, 33, -128, -20, -23, 23, -120
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
