...
int main(){
    ...
    171, 208, 24, 84, 206, 187, 121, 191, 94, 12, 145, 202, 177, 214, 26, 203
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    1, 82, 16, 142, 14, 91, 63, 15, 78, 2, 54, 26, 189, 52, 64, 154
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vv_u32m2 (data1_v, shift, vl);
