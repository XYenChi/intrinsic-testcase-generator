...
int main(){
    ...
    95, 36, 20, 115, 235, 155, 253, 185, 92, 71, 79, 118, 187, 88, 139, 0
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    187, 131, 134, 173, 235, 230, 27, 232, 248, 116, 135, 213, 150, 43, 17, 146
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_32m8_b4 (data1_v, data2_v, vl);
