...
int main(){
    const int16_t data1[] = {
    3, 52, 73, 111, -77, -109, -40, -84, 62, -102, -128, 0, 57, -19, -124, 76
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    54, 107, 94, -51, 116, -92, 105, -47, 127, -21, 83, -128, -118, 11, -56, 7
    };
    ...
    int16_t golden[] = {
    54, 107, 94, 111, 116, 65444, 105, 65489, 127, 65515, 83, 0, 57, 11, 65480, 76
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
