...
int main(){
    const int16_t data1[] = {
    -104, 10, -26, -47, -1, -28, 39, 48, -85, -10, -61, 123, -103, 69, -7, -87
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -110, -56, -53, -26, 83, -26, -61, -13, 119, 73, 123, 112, 73, -104, -93, 52
    };
    ...
    int16_t golden[] = {
    65432, 10, 65510, 65510, 83, 65510, 39, 48, 119, 73, 123, 123, 73, 69, 65529, 52
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
