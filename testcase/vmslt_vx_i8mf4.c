...
int main(){
    const int8_t data1[] = {
    74, -22, 127, 111, -105, 52, -14, -4, -107, 104, -45, -9, -69, -128, -86, 19
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    103, 98, 96, -104, 95, 96, 84, -33, -70, -20, 76, 117, 21, 26, 25, 64
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmslt_vx_8mf4_b32 (data1_v, data2_v, vl);
