...
int main(){
    ...
    184, 235, 234, 28, 117, 113, 141, 5, 67, 18, 28, 233, 115, 108, 7, 48
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    123, 83, 149, 223, 143, 241, 67, 126, 166, 173, 76, 232, 54, 70, 31, 114
    };
    ...
    uint64_t golden[] = {
    307, 318, 383, 251, 260, 354, 208, 131, 233, 191, 104, 465, 169, 178, 38, 162
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
