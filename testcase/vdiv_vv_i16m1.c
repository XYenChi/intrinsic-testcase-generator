...
int main(){
    const int16_t data1[] = {
    127, -118, 75, -13, 85, -103, -3, -54, -54, 46, -67, -90, -8, -115, -114, -17
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    56, 75, 76, 38, -85, -96, 82, 6, 113, -53, 106, -42, -109, -65, -41, 34
    };
    ...
    int16_t golden[] = {
    0, 65535, 1, 65533, 65535, 0, 65508, 65535, 65533, 65534, 65534, 0, 13, 0, 0, 65534
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
