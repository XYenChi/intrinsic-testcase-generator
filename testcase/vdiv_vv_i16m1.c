...
int main(){
    const int16_t data1[] = {
    -40, -114, 54, 9, -49, 35, -72, 18, -122, 120, -3, -65, -114, -26, -126, 37
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    30, 49, -122, 95, 23, 44, -24, -116, 4, -84, -95, -96, -100, 8, 7, 75
    };
    ...
    int16_t golden[] = {
    65535, 65535, 65533, 10, 65535, 1, 0, 65529, 65535, 65535, 31, 1, 0, 65535, 65535, 2
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
