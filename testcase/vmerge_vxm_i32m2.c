...
int main(){
    const int32_t data1[] = {
    109, -89, 82, -71, 43, -73, -7, 22, 90, 24, -21, -36, 101, -90, -86, -25
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -41, 114, -121, -101, -4, 120, -24, -18, 57, 12, 120, -14, 110, 103, 76, 111
    };
    ...
    int32_t golden[] = {
    109, 114, -121, -101, -4, -73, -24, 22, 90, 24, -21, -14, 101, -90, 76, 111
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
