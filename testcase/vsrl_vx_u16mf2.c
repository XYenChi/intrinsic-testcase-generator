...
int main(){
    ...
    7, 105, 79, 23, 60, 136, 213, 43, 172, 99, 224, 59, 120, 84, 109, 199
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    194, 109, 179, 224, 112, 159, 119, 175, 137, 126, 218, 232, 125, 44, 66, 79
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsrl_vx_u16mf2 (data1_v, shift, vl);
