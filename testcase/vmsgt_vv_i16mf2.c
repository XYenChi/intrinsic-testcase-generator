...
int main(){
    const int16_t data1[] = {
    123, 64, -74, 32, -112, -125, 16, -23, -16, 49, -122, 1, 14, 68, -108, 62
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -120, -31, -24, 80, 30, 4, -78, -10, -25, -69, -102, 112, -16, 68, -117, -105
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgt_vv_16mf2_b32 (data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    1, 1, 0, 0, 0, 0, 1, 0, 1, 1, 0, 0, 1, 0, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
