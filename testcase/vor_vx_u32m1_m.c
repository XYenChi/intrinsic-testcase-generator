...
int main(){
    ...
    229, 248, 9, 206, 35, 215, 46, 198, 166, 67, 173, 240, 155, 157, 14, 214
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    100, 115, 122, 187, 146, 215, 51, 209, 136, 80, 35, 24, 52, 245, 68, 175
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wx_32m1u_m (mask, data1_v, data2_v, vl);
    ...
    uint32_t golden[] = {
    229, 251, 123, 255, 179, 215, 63, 0, 174, 0, 1, 248, 191, 253, 78, 255
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
