...
int main(){
    ...
    44, 179, 69, 243, 95, 82, 79, 172, 176, 208, 151, 233, 91, 85, 154, 176
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    28, 5, 51, 134, 40, 155, 198, 226, 163, 106, 51, 12, 136, 10, 54, 84
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u32m8 (data1_v, data2_v, vl);
