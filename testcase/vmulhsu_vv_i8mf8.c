...
int main(){
    const int8_t data1[] = {
    -85, 66, 22, -9, -90, 49, 98, 117, 100, 53, 43, -6, 54, -87, 48, -103
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    222, 134, 6, 30, 211, 169, 35, 84, 4, 16, 30, 245, 210, 71, 18, 18
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_8mf8_b64 (data1_v, data2_v, vl);
