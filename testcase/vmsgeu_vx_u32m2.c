...
int main(){
    ...
    94, 51, 42, 184, 109, 98, 209, 41, 68, 46, 181, 12, 61, 17, 41, 55
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    179, 74, 42, 37, 4, 193, 42, 94, 148, 184, 244, 149, 163, 158, 99, 188
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgeu_vx_32m2_b16 (data1_v, data2_v, vl);
