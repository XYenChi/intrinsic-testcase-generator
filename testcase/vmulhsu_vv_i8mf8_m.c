...
int main(){
    const int8_t data1[] = {
    89, -40, 67, -126, 122, -61, -17, -9, 126, 55, 1, -100, -19, 103, 21, 6
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    60, 112, 9, 178, 57, 165, 176, 184, 149, 7, 86, 45, 7, 58, 228, 32
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vv_8mf8_b64 (mask, data1_v, data2_v, vl);
