...
int main(){
    ...
    27, 43, 25, 10, 81, 95, 135, 15, 203, 100, 103, 174, 85, 161, 27, 179
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    192, 22, 136, 74, 196, 109, 186, 79, 224, 201, 104, 174, 207, 125, 99, 134
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u16m2 (data1_v, data2_v, vl);
