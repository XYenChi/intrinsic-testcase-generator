...
int main(){
    const uint8_t data1[] = {
    45, 146, 17, 168, 132, 254, 42, 38, 148, 218, 81, 129, 110, 117, 203, 136
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    208, 247, 104, 228, 165, 210, 42, 171, 61, 215, 171, 101, 123, 231, 169, 94
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmadd_vx_u8m8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    208, 146, 121, 140, 41, 210, 84, 171, 148, 215, 252, 230, 110, 117, 116, 136
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
