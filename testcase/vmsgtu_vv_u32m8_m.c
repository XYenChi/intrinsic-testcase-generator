...
int main(){
    ...
    116, 28, 31, 248, 230, 92, 43, 123, 53, 100, 186, 246, 188, 69, 70, 60
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    5, 65, 65, 24, 42, 85, 212, 254, 130, 76, 24, 203, 19, 164, 190, 55
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vv_32m8_b4_m (mask, data1_v, data2_v, vl);
