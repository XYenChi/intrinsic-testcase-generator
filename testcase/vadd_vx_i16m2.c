...
int main(){
    const int16_t data1[] = {
    81, -109, -17, 121, 88, 17, -1, -71, 15, -50, -101, 60, 83, -45, -66, -27
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    30, -34, -82, 46, -32, 102, -4, 58, 109, -118, 67, 20, 74, 106, -108, 17
    };
    ...
    int16_t golden[] = {
    111, -128, -99, 127, 56, 119, -5, -13, 124, -128, -34, 80, 127, 61, -128, -10
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
