...
int main(){
    const int16_t data1[] = {
    -61, 98, 81, 97, 94, -24, 6, 60, -95, -94, 34, -63, 51, -24, 2, 117
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -70, -104, 6, -80, -90, 96, 74, -38, -119, -29, -7, -37, 91, -120, 46, 60
    };
    ...
    int16_t golden[] = {
    65405, 65530, 87, 17, 4, 72, 80, 22, 65322, 65413, 27, 65436, 142, 65392, 48, 177
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
