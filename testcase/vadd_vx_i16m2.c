...
int main(){
    const int16_t data1[] = {
    -127, -9, 68, 72, 22, 110, -37, -50, 37, 113, 17, -39, 56, -1, -47, 113
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -3, 109, -34, 100, -16, -86, -53, -114, -113, -79, 6, 122, -74, -93, -19, 67
    };
    ...
    int16_t golden[] = {
    65406, 100, 34, 172, 6, 24, 65446, 65372, 65460, 34, 23, 83, 65518, 65442, 65470, 180
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
