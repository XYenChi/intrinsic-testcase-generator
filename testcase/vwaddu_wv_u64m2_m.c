...
int main(){
    ...
    29, 34, 183, 43, 117, 244, 90, 106, 63, 35, 226, 128, 195, 112, 56, 93
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    157, 105, 248, 235, 145, 178, 73, 138, 101, 226, 24, 80, 81, 58, 177, 178
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u64m2_m (mask, data1_v, data2_v, vl);
