...
int main(){
    const int8_t data1[] = {
    -128, 89, 71, 32, 35, -4, 93, 127, 54, 57, -36, 31, 26, 41, 30, -128
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    20, -86, -58, 3, -52, -77, -52, -19, 3, 72, 117, -58, 62, -9, -43, -77
    };
    ...
    int8_t golden[] = {
    20, 170, 198, 3, 204, 179, 204, 237, 3, 72, 117, 198, 62, 247, 213, 179
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
