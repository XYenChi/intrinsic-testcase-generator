...
int main(){
    const uint8_t data1[] = {
    132, 144, 107, 188, 135, 100, 18, 217, 22, 215, 245, 255, 166, 91, 206, 173
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    243, 203, 156, 250, 165, 26, 121, 25, 72, 92, 101, 2, 224, 245, 169, 145
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmseq_vv_8m2_b4 (data1_v, data2_v, vl);
