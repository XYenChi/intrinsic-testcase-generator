...
int main(){
    ...
    23, 175, 5, 217, 56, 174, 172, 124, 214, 8, 237, 49, 209, 216, 130, 110
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    221, 162, 24, 238, 202, 51, 77, 96, 80, 198, 47, 89, 166, 44, 85, 71
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vx_u16mf2 (data1_v, data2_v, vl);
