...
int main(){
    const int16_t data1[] = {
    76, -45, 50, -25, -44, 126, -10, 87, 64, 21, -90, 4, -97, -33, -124, -26
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -39, -109, 114, 71, 90, 117, 73, -50, 5, -110, -125, -114, 113, -55, -103, -99
    };
    ...
    int16_t golden[] = {
    62572, 4905, 5700, 63761, 61576, 14742, 64806, 61186, 320, 63226, 11250, 65080, 54575, 1815, 12772, 2574
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
