...
int main(){
    ...
    221, 4, 44, 53, 10, 38, 227, 156, 111, 15, 60, 129, 81, 121, 22, 109
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    235, 54, 53, 72, 38, 81, 127, 186, 101, 207, 107, 96, 144, 203, 180, 49
    };
    ...
    uint32_t golden[] = {
    235, 54, 53, 72, 38, 81, 227, 186, 111, 207, 107, 129, 144, 203, 180, 109
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
