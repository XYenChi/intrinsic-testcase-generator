...
int main(){
    ...
    22, 56, 244, 51, 58, 158, 162, 31, 30, 144, 52, 19, 87, 135, 178, 105
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    227, 91, 240, 218, 154, 164, 109, 238, 247, 79, 120, 103, 123, 193, 209, 227
    };
    ...
    uint32_t golden[] = {
    227, 91, 244, 218, 154, 164, 162, 238, 247, 144, 120, 103, 123, 193, 209, 227
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
