...
int main(){
    ...
    221, 77, 177, 253, 13, 49, 126, 146, 236, 208, 94, 128, 251, 13, 127, 110
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    77, 4, 126, 100, 45, 218, 6, 141, 15, 81, 253, 199, 29, 253, 149, 174
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vremu_vx_u16m2 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    77, 4, 126, 100, 6, 22, 6, 141, 15, 81, 65, 71, 29, 6, 22, 64
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
