...
int main(){
    const uint8_t data1[] = {
    92, 238, 109, 205, 111, 77, 251, 30, 128, 8, 35, 233, 128, 169, 74, 93
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    89, 202, 119, 179, 127, 65, 166, 64, 66, 254, 127, 24, 100, 101, 246, 154
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_8m8_b1 (data1_v, data2_v, vl);
