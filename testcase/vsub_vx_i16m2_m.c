...
int main(){
    const int16_t data1[] = {
    -93, 20, -98, -3, -98, -44, 32, -19, -8, 86, 101, -106, -50, -38, 7, 1
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    124, -23, 25, 9, 68, -51, 112, -65, -89, 36, 27, 32, 104, 22, -39, -11
    };
    const int16_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e16m2(avl);
    const int out_data[] = {
    97, -30, -80, 91, 105, -2, 102, -42, -25, -127, 80, -84, -126, 104, 66, -94
    };
    ...
    int16_t golden[] = {
    -128, 43, -123, -12, -128, 7, 102, -42, 81, 50, 74, -84, -126, 104, 66, 12
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
