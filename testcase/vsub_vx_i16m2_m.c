...
int main(){
    const int16_t data1[] = {
    -26, 33, -113, 83, 122, -57, -113, 109, -100, -81, -22, 125, -11, 88, 81, 12
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    60, -61, 72, -77, 106, -52, 11, 23, 99, -31, -123, 59, -43, 86, -87, 23
    };
    ...
    int16_t golden[] = {
    65450, 1, 1, 160, 16, 65531, 0, 1, 0, 65486, 101, 0, 32, 0, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
