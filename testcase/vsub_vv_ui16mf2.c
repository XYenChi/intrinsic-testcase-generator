...
int main(){
    const int16_t data1[] = {
    211, 180, 147, 47, 116, 10, 238, 24, 138, 216, 161, 42, 57, 171, 59, 241
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    199, 116, 150, 91, 215, 181, 229, 166, 212, 1, 180, 92, 128, 181, 177, 210
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vv_ui16mf2 (data1_v, data2_v, vl);
    ...
    int16_t golden[] = {
    12, 64, 0, 0, 0, 0, 9, 0, 0, 215, 0, 0, 0, 0, 0, 31
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
