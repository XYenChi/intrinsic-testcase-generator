...
int main(){
    const int32_t data1[] = {
    -105, 127, -88, 125, 43, 76, 74, -47, 31, -60, -18, 92, -95, -125, -104, -54
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    80, 100, 99, 32, -101, -73, -74, -26, 62, -80, 92, -58, 91, -6, 72, -17
    };
    const int32_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e32m8(avl);
    const int out_data[] = {
    1, 1, 1, 1, 0, 0, 1, 1, 1, 0, 1, 0, 1, 1, 0, 1
    };
    ...
    int32_t golden[] = {
    1, 12700, 4294958584, 1, 0, 0, 4294961820, 1222, 1922, 0, 1, 0, 4294958651, 750, 0, 918
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
