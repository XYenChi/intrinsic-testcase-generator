...
int main(){
    ...
    101, 126, 80, 76, 9, 251, 186, 137, 150, 96, 63, 18, 40, 135, 226, 81
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    73, 15, 60, 214, 17, 96, 231, 7, 109, 164, 251, 147, 47, 56, 235, 15
    };
    ...
    uint32_t golden[] = {
    202, 252, 80, 76, 18, 251, 372, 274, 300, 96, 126, 36, 80, 135, 452, 162
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
