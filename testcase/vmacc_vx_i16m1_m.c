...
int main(){
    const int16_t data1[] = {
    119, -2, 71, 64, 47, 16, 99, -86, 20, 106, 110, -55, -11, -30, 57, 11
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    23, -19, 84, 35, -114, 16, -90, 22, 57, -4, 25, 102, 100, 22, -84, -1
    };
    ...
    int16_t golden[] = {
    1, 0, 5964, 2240, 60178, 0, 1, 1, 1141, 0, 2751, 59926, 0, 64876, 60749, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
