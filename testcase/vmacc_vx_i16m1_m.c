...
int main(){
    const int16_t data1[] = {
    89, -9, 18, 105, 121, -2, 15, 39, 121, -24, -11, 17, -49, 41, 112, -113
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    121, -76, -118, 40, 77, 45, -53, 71, -81, 4, -65, 66, 113, -117, 44, 74
    };
    ...
    int16_t golden[] = {
    10769, 685, 63413, 0, 0, 65446, 0, 0, 1, 65440, 0, 1123, 59999, 60740, 0, 57174
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
