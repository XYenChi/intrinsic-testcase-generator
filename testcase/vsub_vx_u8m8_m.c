...
int main(){
    const uint8_t data1[] = {
    217, 124, 97, 18, 98, 243, 221, 174, 127, 119, 169, 170, 101, 42, 186, 135
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    5, 200, 169, 59, 234, 117, 211, 58, 66, 80, 179, 192, 115, 158, 40, 172
    };
    ...
    uint8_t golden[] = {
    0, 180, 1, 215, 120, 126, 10, 116, 61, 39, 0, 234, 1, 0, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
