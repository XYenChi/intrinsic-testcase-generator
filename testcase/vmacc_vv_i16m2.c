...
int main(){
    const int16_t data1[] = {
    -60, 36, 2, -76, 52, -40, 99, -70, 61, 23, -63, -116, 2, -72, 43, 62
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -119, 37, -1, -98, -97, -17, 35, -23, 52, 18, 71, -112, -117, 93, -38, 111
    };
    ...
    int16_t golden[] = {
    7140, 1333, 65535, 7449, 60493, 681, 3465, 1611, 3173, 415, 61064, 12993, 65302, 58840, 63902, 6883
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
