...
int main(){
    const int16_t data1[] = {
    -46, -78, -109, 91, -74, -117, 56, 45, 40, 104, -29, -96, -117, -61, 57, 28
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    97, -59, 38, 74, -69, -89, -20, -36, -69, 96, -101, 92, 24, 18, -83, 28
    };
    ...
    int16_t golden[] = {
    61074, 4603, 61394, 6735, 5106, 10413, 64417, 63917, 62777, 9984, 2930, 56704, 62729, 64439, 60806, 785
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
