...
int main(){
    ...
    6, 18, 117, 186, 52, 206, 151, 223, 77, 252, 216, 60, 125, 168, 145, 140
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    133, 53, 160, 17, 102, 95, 218, 173, 128, 32, 64, 248, 75, 98, 165, 170
    };
    ...
    uint32_t golden[] = {
    798, 954, 18720, 3162, 5304, 19570, 32918, 38579, 9856, 8064, 13824, 14880, 9375, 16464, 23925, 23800
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
