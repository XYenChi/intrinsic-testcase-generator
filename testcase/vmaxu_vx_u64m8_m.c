...
int main(){
    ...
    243, 190, 31, 140, 2, 24, 215, 149, 170, 169, 164, 120, 1, 108, 76, 239
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    105, 225, 87, 155, 183, 49, 51, 104, 128, 74, 218, 204, 172, 102, 19, 180
    };
    ...
    uint64_t golden[] = {
    243, 0, 0, 0, 183, 0, 1, 0, 0, 1, 0, 204, 172, 0, 1, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
