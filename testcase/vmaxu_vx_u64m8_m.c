...
int main(){
    ...
    190, 150, 170, 53, 209, 213, 10, 33, 137, 104, 94, 220, 208, 162, 228, 199
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    186, 95, 161, 24, 129, 117, 183, 56, 219, 11, 26, 174, 109, 208, 173, 87
    };
    ...
    uint64_t golden[] = {
    190, 150, 0, 1, 209, 0, 183, 56, 219, 104, 94, 220, 208, 208, 228, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
