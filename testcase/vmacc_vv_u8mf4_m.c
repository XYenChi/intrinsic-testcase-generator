...
int main(){
    const uint8_t data1[] = {
    66, 85, 199, 39, 104, 210, 108, 198, 97, 199, 195, 198, 108, 50, 6, 246
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    138, 167, 157, 38, 211, 83, 96, 111, 36, 35, 182, 253, 13, 218, 232, 231
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmacc_vv_u8mf4_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    148, 1, 0, 203, 185, 1, 0, 1, 1, 1, 1, 1, 0, 149, 113, 251
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
