...
int main(){
    const uint8_t data1[] = {
    17, 80, 62, 116, 59, 26, 77, 212, 240, 5, 251, 166, 105, 42, 145, 154
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    17, 148, 53, 98, 247, 47, 41, 59, 246, 131, 161, 218, 71, 135, 34, 178
    };
    ...
    uint8_t golden[] = {
    0, 0, 214, 105, 1, 198, 0, 220, 0, 0, 219, 92, 32, 1, 67, 21
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
