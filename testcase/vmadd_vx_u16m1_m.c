...
int main(){
    ...
    71, 179, 254, 25, 222, 105, 232, 59, 220, 161, 24, 221, 155, 90, 172, 231
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    164, 246, 107, 16, 172, 138, 69, 3, 131, 40, 117, 122, 237, 214, 206, 147
    };
    ...
    uint16_t golden[] = {
    164, 425, 361, 41, 222, 138, 232, 3, 220, 201, 24, 343, 155, 90, 172, 147
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
