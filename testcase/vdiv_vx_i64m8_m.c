...
int main(){
    const int64_t data1[] = {
    47, -18, -110, 17, -42, 30, -38, 110, 39, 62, -49, 79, -9, -76, -48, 120
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    118, 45, 14, 72, -112, 60, -102, -115, -101, -98, -89, 59, -80, 27, 55, 123
    };
    ...
    int64_t golden[] = {
    1, 18446744073709551613, 18446744073709551615, 0, 2, 2, 0, 0, 0, 0, 1, 0, 8, 18446744073709551615, 18446744073709551614, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
