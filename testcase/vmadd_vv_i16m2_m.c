...
int main(){
    const int16_t data1[] = {
    15, -18, 87, 20, 82, -6, -106, -1, 93, 34, -47, 94, 125, 53, -69, -98
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    19, 65, 80, 89, -107, 12, -65, 90, 57, -72, 15, -14, 92, -72, -62, 91
    };
    ...
    int16_t golden[] = {
    15, 47, 87, 20, 65429, 6, 65430, 90, 57, 34, 65489, 65522, 125, 53, 65474, 91
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
