...
int main(){
    const uint8_t data1[] = {
    159, 15, 160, 97, 170, 159, 185, 89, 245, 103, 196, 51, 138, 220, 96, 245
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    41, 140, 232, 142, 242, 139, 130, 128, 136, 126, 70, 77, 37, 64, 179, 128
    };
    ...
    uint8_t golden[] = {
    119, 52, 0, 206, 1, 0, 242, 1, 0, 178, 152, 0, 242, 1, 32, 128
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
