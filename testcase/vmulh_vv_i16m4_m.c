...
int main(){
    const int16_t data1[] = {
    63, -17, -97, -31, 91, 57, 52, 24, 58, 47, 72, 42, -110, 46, 97, -112
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    64, 75, -105, 21, -73, 27, 116, 60, -104, 64, -124, 123, 2, -39, 33, -23
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulh_vv_16m4_b4 (mask, data1_v, data2_v, vl);
