...
int main(){
    ...
    252, 27, 46, 208, 82, 127, 110, 118, 240, 46, 253, 191, 183, 59, 109, 64
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    86, 23, 61, 120, 73, 55, 70, 165, 122, 140, 28, 227, 253, 238, 193, 208
    };
    ...
    uint64_t golden[] = {
    252, 54, 92, 208, 164, 254, 110, 236, 240, 46, 253, 382, 366, 59, 218, 64
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
