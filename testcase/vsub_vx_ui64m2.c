...
int main(){
    const int64_t data1[] = {
    148, 87, 159, 113, 163, 0, 14, 20, 185, 215, 50, 8, 173, 134, 50, 245
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    48, 82, 176, 180, 112, 121, 105, 224, 4, 229, 144, 176, 19, 219, 136, 190
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vsub_vx_ui64m2 (data1_v, data2_v, vl);
    ...
    int64_t golden[] = {
    100, 5, 0, 0, 51, 0, 0, 0, 181, 0, 0, 0, 154, 0, 0, 55
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
