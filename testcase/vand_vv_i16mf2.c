...
int main(){
    const int16_t data1[] = {
    36, -28, 95, 39, 88, 127, 94, -41, 29, -29, -101, 50, -21, 96, 50, -15
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -7, -116, -12, -60, -23, -72, -52, 18, -53, -34, -108, -31, -26, 96, -115, 109
    };
    ...
    int16_t golden[] = {
    65529, 65420, 65524, 65476, 65513, 65464, 65484, 18, 65483, 65502, 65428, 65505, 65510, 96, 65421, 109
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
