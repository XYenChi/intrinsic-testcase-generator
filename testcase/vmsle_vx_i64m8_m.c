...
int main(){
    const int64_t data1[] = {
    -103, -7, -18, 75, 100, 24, 38, 20, -98, 82, 75, -84, 95, 122, -81, -27
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    47, 27, -108, 18, 110, 110, 115, 21, -81, 105, -95, 13, 18, -15, -75, 62
    };
    const int64_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e64m8(avl);
    const int out_data[] = {
    0, 0, 0, 1, 1, 1, 0, 0, 1, 0, 1, 0, 0, 1, 0, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsle_vx_64m8_b8_m (mask, data1_v, data2_v, vl);
