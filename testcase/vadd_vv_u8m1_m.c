...
int main(){
    const uint8_t data1[] = {
    172, 11, 127, 3, 209, 173, 129, 82, 193, 244, 219, 4, 155, 191, 170, 244
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    159, 108, 240, 190, 253, 119, 219, 100, 65, 225, 196, 217, 87, 122, 249, 139
    };
    ...
    uint8_t golden[] = {
    75, 119, 0, 193, 1, 36, 1, 182, 1, 213, 159, 0, 242, 57, 1, 127
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
