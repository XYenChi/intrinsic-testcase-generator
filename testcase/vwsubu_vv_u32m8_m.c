...
int main(){
    ...
    96, 148, 14, 190, 243, 251, 186, 141, 49, 80, 252, 153, 16, 44, 75, 8
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    138, 155, 154, 212, 145, 128, 177, 175, 166, 60, 242, 16, 15, 193, 49, 147
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vv_u32m8_m (mask, data1_v, data2_v, vl);
