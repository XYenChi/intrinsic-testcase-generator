...
int main(){
    ...
    106, 189, 61, 196, 255, 182, 43, 165, 154, 248, 71, 9, 243, 112, 225, 228
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    171, 9, 243, 173, 102, 43, 248, 166, 124, 155, 253, 133, 215, 46, 154, 229
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwaddu_wv_u32m8_m (mask, data1_v, data2_v, vl);
