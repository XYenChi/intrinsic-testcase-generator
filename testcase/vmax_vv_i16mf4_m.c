...
int main(){
    const int16_t data1[] = {
    87, 82, 43, 32, 66, 12, -20, 43, -99, -87, 125, -100, -50, -4, 63, 52
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -52, 28, 64, -81, -21, 39, -106, 32, -44, 30, 94, -29, 73, -40, -99, -21
    };
    const int16_t *in2 = &data2[0];
    size_t avl = 64;
    size_t vl = __riscv_vsetvl_e16mf4(avl);
    const int out_data[] = {
    0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 1, 1, 1, 0, 0, 1
    };
    ...
    int16_t golden[] = {
    0, 82, 1, 0, 1, 39, 1, 43, 0, 0, 125, 1, 1, 65532, 0, 52
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
