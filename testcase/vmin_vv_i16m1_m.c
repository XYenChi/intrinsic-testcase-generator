...
int main(){
    const int16_t data1[] = {
    -105, 70, -35, -124, -67, -14, 119, -40, 0, -75, -110, -69, -120, 64, -114, 94
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    99, 118, -116, -21, 116, 91, 9, -92, -93, -120, -20, 107, -110, -122, -96, -60
    };
    ...
    int16_t golden[] = {
    1, 118, 0, 65515, 116, 1, 1, 1, 0, 65461, 1, 107, 1, 64, 65440, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
