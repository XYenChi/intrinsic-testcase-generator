...
int main(){
    const uint8_t data1[] = {
    24, 109, 31, 92, 107, 71, 99, 242, 199, 186, 172, 58, 238, 215, 52, 13
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    82, 205, 133, 57, 110, 244, 197, 102, 46, 54, 171, 142, 202, 243, 103, 25
    };
    ...
    uint8_t golden[] = {
    198, 160, 154, 35, 253, 83, 158, 140, 153, 132, 1, 172, 36, 228, 205, 244
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
