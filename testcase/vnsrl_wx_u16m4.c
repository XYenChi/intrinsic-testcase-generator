...
int main(){
    ...
    96, 101, 173, 128, 51, 197, 242, 7, 125, 154, 139, 177, 89, 56, 168, 56
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    0, 39, 36, 116, 138, 170, 93, 252, 150, 218, 186, 250, 17, 119, 144, 243
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vnsrl_wx_16m4 (data1_v, shift, vl);
