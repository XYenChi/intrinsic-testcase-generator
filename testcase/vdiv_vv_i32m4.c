...
int main(){
    const int32_t data1[] = {
    -120, -85, 8, -127, -43, 69, 46, 104, 99, -49, 7, 115, 56, 32, 100, -93
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    58, 87, -13, -35, -101, -21, 25, -7, -66, 62, -59, -52, -15, -47, 70, -53
    };
    ...
    int32_t golden[] = {
    4294967295, 4294967294, 4294967294, 0, 2, 4294967295, 0, 4294967295, 4294967295, 4294967294, 4294967287, 4294967295, 4294967295, 4294967294, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
