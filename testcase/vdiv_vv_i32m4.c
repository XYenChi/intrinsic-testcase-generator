...
int main(){
    const int32_t data1[] = {
    55, -59, 49, 34, 50, -41, -48, 11, -49, -43, 65, -82, 0, 111, 110, -96
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -107, -40, -5, 100, -125, -91, 61, -89, 78, 67, -44, 42, -7, -89, 6, -26
    };
    ...
    int32_t golden[] = {
    4294967294, 0, 4294967295, 2, 4294967293, 2, 4294967294, 4294967287, 4294967294, 4294967294, 4294967295, 4294967295, 4294967295, 4294967295, 0, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
