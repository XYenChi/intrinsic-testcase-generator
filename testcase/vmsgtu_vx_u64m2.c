...
int main(){
    ...
    93, 53, 123, 255, 215, 188, 169, 64, 217, 9, 129, 93, 166, 159, 229, 9
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    222, 28, 89, 27, 21, 93, 238, 224, 0, 38, 142, 255, 194, 68, 254, 127
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsgtu_vx_64m2_b32 (data1_v, data2_v, vl);
