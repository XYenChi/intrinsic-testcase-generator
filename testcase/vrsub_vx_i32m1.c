...
int main(){
    const int32_t data1[] = {
    -59, 107, 49, -41, 27, -15, -96, 95, -56, 25, 56, 68, 115, 126, 70, 6
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    -114, -9, 48, 120, -49, 81, 43, 11, 85, -106, -57, -51, -58, -39, 104, -76
    };
    ...
    int32_t golden[] = {
    4294967241, 4294967180, 4294967295, 161, 4294967220, 96, 139, 4294967212, 141, 4294967165, 4294967183, 4294967177, 4294967123, 4294967131, 34, 4294967214
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
