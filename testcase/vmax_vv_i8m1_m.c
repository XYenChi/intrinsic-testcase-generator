...
int main(){
    const int8_t data1[] = {
    13, 120, 85, -102, 14, 3, -88, -57, 11, 38, 6, 104, -120, -21, 70, 92
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    27, -120, -33, 89, 71, 84, 59, 21, -101, -63, 45, -57, -93, -66, -22, 55
    };
    ...
    uint8_t masked[] = {
    0, 0, 0, 1, 1, 0, 0, 0, 0, 1, 0, 1, 1, 1, 1, 0
    };
    ...
    int8_t golden[] = {
    1, 0, 0, 89, 71, 0, 1, 1, 1, 38, 0, 104, 163, 235, 70, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
