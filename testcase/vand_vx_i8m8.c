...
int main(){
    const int8_t data1[] = {
    -91, 86, -108, 120, 126, 94, -11, -13, 125, -18, -108, -14, 75, 123, 71, 32
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    71, 117, 69, 45, -103, -110, 30, -10, -45, 16, 24, 85, 77, -115, 104, -82
    };
    ...
    int8_t golden[] = {
    71, 117, 69, 45, 153, 146, 30, 246, 211, 16, 24, 85, 77, 141, 104, 174
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
