...
int main(){
    const int8_t data1[] = {
    -89, 101, 99, -124, -88, 45, -80, -4, -47, 25, -10, 1, -92, -64, 18, 113
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -22, 20, 20, 100, -47, -33, 46, 107, 120, -118, 78, 107, 61, -79, 22, -35
    };
    ...
    int8_t golden[] = {
    234, 20, 20, 100, 209, 223, 46, 107, 120, 138, 78, 107, 61, 177, 22, 221
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
