...
int main(){
    const uint8_t data1[] = {
    208, 253, 94, 217, 133, 91, 212, 50, 190, 77, 85, 133, 137, 62, 146, 176
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    131, 100, 141, 53, 160, 136, 189, 151, 244, 81, 180, 183, 246, 142, 186, 189
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_8m4_b2 (data1_v, data2_v, vl);
