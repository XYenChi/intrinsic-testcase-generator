...
int main(){
    ...
    115, 83, 211, 41, 49, 69, 146, 119, 48, 171, 167, 156, 202, 140, 100, 145
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    47, 184, 24, 149, 140, 245, 103, 108, 171, 68, 147, 227, 255, 189, 44, 145
    };
    ...
    uint16_t golden[] = {
    115, 184, 211, 149, 140, 245, 146, 119, 171, 171, 167, 227, 255, 189, 100, 145
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
