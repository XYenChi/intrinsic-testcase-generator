...
int main(){
    ...
    85, 169, 173, 113, 190, 71, 137, 201, 17, 76, 190, 121, 65, 102, 217, 222
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    214, 16, 150, 194, 213, 194, 192, 109, 82, 123, 164, 111, 201, 45, 122, 102
    };
    ...
    uint16_t golden[] = {
    214, 169, 173, 194, 213, 194, 192, 201, 82, 123, 190, 121, 201, 102, 217, 222
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
