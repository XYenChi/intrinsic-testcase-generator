...
int main(){
    const uint8_t data1[] = {
    120, 39, 149, 230, 239, 183, 207, 227, 151, 232, 66, 113, 27, 239, 207, 249
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    61, 105, 5, 43, 235, 179, 20, 158, 217, 21, 59, 66, 144, 33, 227, 228
    };
    ...
    uint8_t golden[] = {
    1, 144, 154, 17, 0, 1, 1, 1, 112, 0, 125, 179, 171, 16, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
