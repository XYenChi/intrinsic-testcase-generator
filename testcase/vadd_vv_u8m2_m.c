...
int main(){
    const uint8_t data1[] = {
    55, 225, 222, 159, 67, 108, 34, 146, 76, 205, 3, 205, 195, 109, 240, 149
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    231, 32, 197, 84, 128, 231, 1, 170, 243, 100, 1, 45, 148, 107, 110, 221
    };
    ...
    uint8_t golden[] = {
    1, 1, 0, 243, 195, 83, 35, 60, 1, 49, 1, 250, 0, 0, 94, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
