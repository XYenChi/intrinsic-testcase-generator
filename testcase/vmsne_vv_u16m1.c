...
int main(){
    ...
    148, 163, 245, 10, 27, 94, 112, 63, 77, 62, 88, 100, 113, 205, 92, 192
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    221, 224, 46, 42, 194, 195, 35, 33, 132, 191, 33, 4, 78, 197, 101, 31
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmsne_vv_16m1_b16 (data1_v, data2_v, vl);
