...
int main(){
    const int8_t data1[] = {
    77, 41, -110, 27, -69, 64, -55, 104, -8, -33, 86, -77, 78, 102, -60, -41
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -120, 28, -44, -68, -94, 18, 63, -11, -33, -115, 58, 117, -56, -37, -111, -64
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wv_8m4i_m (mask, data1_v, data2_v, vl);
    ...
    int8_t golden[] = {
    205, 61, 214, 191, 1, 1, 1, 253, 255, 0, 126, 1, 1, 255, 0, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
