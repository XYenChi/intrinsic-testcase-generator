...
int main(){
    ...
    229, 49, 200, 183, 211, 205, 248, 24, 134, 11, 227, 155, 119, 223, 175, 68
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    215, 209, 95, 207, 168, 3, 193, 77, 191, 61, 162, 107, 25, 134, 21, 172
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwmulu_vx_u16m8_m (mask, out_data, data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    49235, 0, 1, 1, 35448, 1, 47864, 1848, 25594, 0, 1, 16585, 1, 1, 3675, 11696
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
