...
int main(){
    ...
    126, 254, 116, 218, 56, 170, 59, 61, 71, 8, 88, 68, 109, 141, 96, 80
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    70, 3, 50, 104, 132, 213, 184, 170, 48, 89, 247, 116, 230, 25, 244, 226
    };
    ...
    uint64_t golden[] = {
    8821, 0, 1, 0, 7393, 36210, 10856, 10370, 0, 712, 0, 7889, 0, 3526, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
