...
int main(){
    const int8_t data1[] = {
    112, 2, 119, 103, -91, -72, -112, -65, 78, 21, -76, 104, 83, -30, 80, -107
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    62, -19, 121, 101, 29, 95, -53, 56, 76, -69, 49, -60, 123, -111, -108, -95
    };
    ...
    int8_t golden[] = {
    0, 218, 63, 164, 178, 1, 49, 1, 41, 88, 117, 160, 0, 1, 64, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
