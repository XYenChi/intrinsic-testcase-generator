...
int main(){
    const int32_t data1[] = {
    31, -27, -47, 114, 39, 7, 113, -68, -93, -98, 127, -86, 37, -6, -98, 85
    };
    const int32_t *in1 = &data1[0];
    const int32_t data2[] = {
    106, -50, -6, -64, -49, 84, -77, 14, -77, -11, -127, -36, -124, -128, -102, 0
    };
    ...
    int32_t golden[] = {
    4294964010, 1, 4294967014, 7297, 1, 4294966708, 8701, 953, 0, 4294966219, 16129, 4294964201, 0, 0, 4294957300, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
