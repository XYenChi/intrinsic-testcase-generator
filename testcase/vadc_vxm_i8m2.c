...
int main(){
    const int8_t data1[] = {
    59, -114, 83, -74, -104, -85, 123, -125, -44, -33, 89, -14, -57, -41, 12, 10
    };
    const int8_t *in1 = &data1[0];
    const int8_t data2[] = {
    -117, -120, 42, 79, 99, -94, 77, -26, 37, 51, -26, 29, -85, 22, -84, 86
    };
    ...
    int8_t golden[] = {
    -58, -234, 125, 5, -4, -178, 201, -151, -6, 19, 63, 15, -141, -18, -72, 96
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
