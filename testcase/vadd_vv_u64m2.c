...
int main(){
    const int64_t data1[] = {
    80, 135, 147, 155, 191, 121, 126, 135, 177, 75, 67, 225, 11, 70, 204, 43
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    199, 154, 88, 246, 153, 45, 208, 77, 18, 54, 190, 96, 157, 107, 18, 59
    };
    ...
    int64_t golden[] = {
    279, 289, 235, 401, 344, 166, 334, 212, 195, 129, 257, 321, 168, 177, 222, 102
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
