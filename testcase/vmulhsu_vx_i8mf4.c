...
int main(){
    const int8_t data1[] = {
    -116, -110, 54, -33, 104, 45, 102, 28, -30, -99, 73, -14, 106, -73, -57, 41
    };
    const int8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    25, 176, 234, 46, 166, 181, 57, 5, 99, 159, 75, 1, 157, 7, 120, 254
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_8mf4_b32 (data1_v, data2_v, vl);
