...
int main(){
    ...
    99, 61, 228, 248, 93, 156, 51, 9, 108, 85, 82, 240, 214, 251, 84, 20
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    41, 220, 131, 103, 53, 176, 98, 147, 108, 249, 19, 109, 134, 97, 240, 69
    };
    ...
    uint16_t golden[] = {
    0, 1, 359, 1, 0, 332, 1, 0, 216, 1, 1, 349, 348, 348, 324, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
