...
int main(){
    const int16_t data1[] = {
    -100, -65, 93, 20, -75, -35, 80, 84, 87, -82, -65, 115, -56, 77, 6, -46
    };
    const int16_t *in1 = &data1[0];
    const int16_t data2[] = {
    -117, 93, -30, -86, -16, 15, 4, -23, 80, 90, 51, -87, -116, -117, -27, -24
    };
    ...
    int16_t golden[] = {
    11700, 59491, 62746, 63816, 1200, 65011, 320, 63604, 6960, 58156, 62221, 55531, 6496, 56527, 65374, 1104
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
