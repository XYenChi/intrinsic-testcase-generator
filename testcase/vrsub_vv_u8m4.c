...
int main(){
    const uint8_t data1[] = {
    123, 59, 116, 167, 207, 9, 228, 241, 234, 122, 73, 133, 184, 52, 189, 94
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    114, 193, 180, 127, 140, 139, 205, 233, 23, 252, 105, 161, 22, 145, 83, 61
    };
    ...
    uint8_t golden[] = {
    247, 134, 64, 216, 189, 130, 233, 248, 45, 130, 32, 28, 94, 93, 150, 223
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
