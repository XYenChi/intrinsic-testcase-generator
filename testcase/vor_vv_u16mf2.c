...
int main(){
    ...
    10, 46, 237, 172, 206, 10, 80, 37, 194, 39, 121, 24, 235, 81, 132, 197
    };
    const uint16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    32, 25, 57, 205, 150, 102, 243, 237, 30, 238, 33, 98, 155, 94, 51, 42
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_vv_u16mf2 (data1_v, data2_v, vl);
    ...
    uint16_t golden[] = {
    42, 63, 253, 237, 222, 110, 243, 237, 222, 239, 121, 122, 251, 95, 183, 239
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
