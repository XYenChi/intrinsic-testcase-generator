...
int main(){
    ...
    149, 53, 205, 19, 70, 208, 63, 10, 126, 1, 206, 210, 2, 25, 74, 32
    };
    const uint64_t *in1 = &data1[0];
    const uint64_t data2[] = {
    175, 39, 22, 22, 82, 147, 188, 156, 216, 171, 93, 15, 137, 35, 71, 135
    };
    ...
    uint64_t masked[] = {
    1, 1, 0, 0, 0, 1, 0, 1, 0, 1, 1, 1, 1, 1, 1, 0
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vxor_vv_u64m1_m (mask, data1_v, data2_v, vl);
