...
int main(){
    const int16_t data1[] = {
    -53, 46, 100, -118, -116, 65, -115, 73, -75, 43, 26, 5, 51, -58, -55, -21
    };
    const int16_t *in1 = &data1[0];
    const uint16_t data2[] = {
    185, 175, 171, 128, 128, 23, 36, 32, 5, 37, 248, 43, 1, 14, 240, 150
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vmulhsu_vx_16m8_b2 (data1_v, data2_v, vl);
