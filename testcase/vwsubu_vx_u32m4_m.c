...
int main(){
    ...
    19, 5, 191, 54, 186, 238, 212, 95, 90, 41, 95, 91, 55, 54, 155, 19
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    236, 122, 82, 42, 236, 119, 29, 226, 110, 13, 111, 36, 165, 155, 90, 43
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vwsubu_vx_u32m4_m (mask, data1_v, data2_v, vl);
