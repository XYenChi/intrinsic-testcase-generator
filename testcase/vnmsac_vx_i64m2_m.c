...
int main(){
    const int64_t data1[] = {
    90, -82, -23, 103, 36, -24, -91, 19, -66, -108, -31, -83, 55, 106, 101, -61
    };
    const int64_t *in1 = &data1[0];
    const int64_t data2[] = {
    87, 2, 31, 76, -77, -77, 32, 19, -7, -125, -101, 5, -90, 72, -87, -100
    };
    ...
    int64_t golden[] = {
    1, 164, 1, 18446744073709543789, 2772, 18446744073709549768, 0, 18446744073709551256, 18446744073709551154, 1, 18446744073709548486, 0, 0, 1, 8788, 1
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
