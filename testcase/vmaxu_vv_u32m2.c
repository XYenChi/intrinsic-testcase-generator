...
int main(){
    ...
    181, 188, 189, 105, 212, 233, 73, 103, 168, 130, 109, 211, 110, 21, 38, 197
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    238, 20, 83, 217, 215, 234, 201, 107, 208, 225, 235, 250, 110, 190, 233, 170
    };
    ...
    uint32_t golden[] = {
    238, 188, 189, 217, 215, 234, 201, 107, 208, 225, 235, 250, 110, 190, 233, 197
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
