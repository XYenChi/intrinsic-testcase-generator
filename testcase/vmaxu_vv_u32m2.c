...
int main(){
    ...
    147, 137, 210, 86, 242, 13, 32, 182, 32, 235, 212, 241, 118, 175, 129, 77
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    1, 116, 133, 80, 1, 129, 148, 234, 162, 129, 30, 222, 71, 32, 27, 137
    };
    ...
    uint32_t golden[] = {
    147, 137, 210, 86, 242, 129, 148, 234, 162, 235, 212, 241, 118, 175, 129, 137
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
