...
int main(){
    const uint8_t data1[] = {
    124, 211, 183, 237, 227, 91, 180, 193, 204, 126, 165, 121, 170, 180, 43, 101
    };
    const uint8_t *in1 = &data1[0];
    const uint8_t data2[] = {
    136, 26, 232, 248, 188, 76, 184, 215, 34, 207, 143, 75, 230, 86, 161, 241
    };
    ...
    for (size_t n = 0; n < vl; n++) {
        out_v = __riscv_vor_wv_8m1u_m (mask, data1_v, data2_v, vl);
    ...
    uint8_t golden[] = {
    252, 1, 0, 253, 0, 95, 188, 215, 238, 255, 175, 123, 238, 246, 171, 245
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
