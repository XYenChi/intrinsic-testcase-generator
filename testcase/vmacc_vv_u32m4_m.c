...
int main(){
    ...
    58, 50, 222, 118, 195, 225, 32, 234, 202, 214, 214, 228, 180, 247, 45, 62
    };
    const uint32_t *in1 = &data1[0];
    const uint32_t data2[] = {
    63, 64, 152, 45, 80, 254, 212, 226, 195, 24, 121, 107, 255, 125, 66, 63
    };
    ...
    uint32_t golden[] = {
    1, 0, 33745, 0, 15600, 0, 6784, 0, 0, 5137, 1, 24397, 45900, 30875, 1, 0
    };
    int fail = 0;
    for (int i = 0; i < 16; i++){
