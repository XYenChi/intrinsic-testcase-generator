...
vint8mf8_t __riscv_vmv_s (int8_t src, size_t vl);
int8_t __riscv_vmv_x (vint8mf4_t src);
vint8mf4_t __riscv_vmv_s (int8_t src, size_t vl);
int8_t __riscv_vmv_x (vint8mf2_t src);
vint8mf2_t __riscv_vmv_s (int8_t src, size_t vl);
int8_t __riscv_vmv_x (vint8m1_t src);
vint8m1_t __riscv_vmv_s (int8_t src, size_t vl);
int8_t __riscv_vmv_x (vint8m2_t src);
vint8m2_t __riscv_vmv_s (int8_t src, size_t vl);
int8_t __riscv_vmv_x (vint8m4_t src);
vint8m4_t __riscv_vmv_s (int8_t src, size_t vl);
int8_t __riscv_vmv_x (vint8m8_t src);
vint8m8_t __riscv_vmv_s (int8_t src, size_t vl);
int16_t __riscv_vmv_x (vint16mf4_t src);
vint16mf4_t __riscv_vmv_s (int16_t src, size_t vl);
int16_t __riscv_vmv_x (vint16mf2_t src);
vint16mf2_t __riscv_vmv_s (int16_t src, size_t vl);
int16_t __riscv_vmv_x (vint16m1_t src);
vint16m1_t __riscv_vmv_s (int16_t src, size_t vl);
int16_t __riscv_vmv_x (vint16m2_t src);
vint16m2_t __riscv_vmv_s (int16_t src, size_t vl);
int16_t __riscv_vmv_x (vint16m4_t src);
vint16m4_t __riscv_vmv_s (int16_t src, size_t vl);
int16_t __riscv_vmv_x (vint16m8_t src);
vint16m8_t __riscv_vmv_s (int16_t src, size_t vl);
int32_t __riscv_vmv_x (vint32mf2_t src);
vint32mf2_t __riscv_vmv_s (int32_t src, size_t vl);
int32_t __riscv_vmv_x (vint32m1_t src);
vint32m1_t __riscv_vmv_s (int32_t src, size_t vl);
int32_t __riscv_vmv_x (vint32m2_t src);
vint32m2_t __riscv_vmv_s (int32_t src, size_t vl);
int32_t __riscv_vmv_x (vint32m4_t src);
vint32m4_t __riscv_vmv_s (int32_t src, size_t vl);
int32_t __riscv_vmv_x (vint32m8_t src);
vint32m8_t __riscv_vmv_s (int32_t src, size_t vl);
int64_t __riscv_vmv_x (vint64m1_t src);
vint64m1_t __riscv_vmv_s (int64_t src, size_t vl);
int64_t __riscv_vmv_x (vint64m2_t src);
vint64m2_t __riscv_vmv_s (int64_t src, size_t vl);
int64_t __riscv_vmv_x (vint64m4_t src);
vint64m4_t __riscv_vmv_s (int64_t src, size_t vl);
int64_t __riscv_vmv_x (vint64m8_t src);
vint64m8_t __riscv_vmv_s (int64_t src, size_t vl);
uint8_t __riscv_vmv_x (vuint8mf8_t src);
vuint8mf8_t __riscv_vmv_s (uint8_t src, size_t vl);
uint8_t __riscv_vmv_x (vuint8mf4_t src);
vuint8mf4_t __riscv_vmv_s (uint8_t src, size_t vl);
uint8_t __riscv_vmv_x (vuint8mf2_t src);
vuint8mf2_t __riscv_vmv_s (uint8_t src, size_t vl);
uint8_t __riscv_vmv_x (vuint8m1_t src);
vuint8m1_t __riscv_vmv_s (uint8_t src, size_t vl);
uint8_t __riscv_vmv_x (vuint8m2_t src);
vuint8m2_t __riscv_vmv_s (uint8_t src, size_t vl);
uint8_t __riscv_vmv_x (vuint8m4_t src);
vuint8m4_t __riscv_vmv_s (uint8_t src, size_t vl);
uint8_t __riscv_vmv_x (vuint8m8_t src);
vuint8m8_t __riscv_vmv_s (uint8_t src, size_t vl);
uint16_t __riscv_vmv_x (vuint16mf4_t src);
vuint16mf4_t __riscv_vmv_s (uint16_t src, size_t vl);
uint16_t __riscv_vmv_x (vuint16mf2_t src);
vuint16mf2_t __riscv_vmv_s (uint16_t src, size_t vl);
uint16_t __riscv_vmv_x (vuint16m1_t src);
vuint16m1_t __riscv_vmv_s (uint16_t src, size_t vl);
uint16_t __riscv_vmv_x (vuint16m2_t src);
vuint16m2_t __riscv_vmv_s (uint16_t src, size_t vl);
uint16_t __riscv_vmv_x (vuint16m4_t src);
vuint16m4_t __riscv_vmv_s (uint16_t src, size_t vl);
uint16_t __riscv_vmv_x (vuint16m8_t src);
vuint16m8_t __riscv_vmv_s (uint16_t src, size_t vl);
uint32_t __riscv_vmv_x (vuint32mf2_t src);
vuint32mf2_t __riscv_vmv_s (uint32_t src, size_t vl);
uint32_t __riscv_vmv_x (vuint32m1_t src);
vuint32m1_t __riscv_vmv_s (uint32_t src, size_t vl);
uint32_t __riscv_vmv_x (vuint32m2_t src);
vuint32m2_t __riscv_vmv_s (uint32_t src, size_t vl);
uint32_t __riscv_vmv_x (vuint32m4_t src);
vuint32m4_t __riscv_vmv_s (uint32_t src, size_t vl);
uint32_t __riscv_vmv_x (vuint32m8_t src);
vuint32m8_t __riscv_vmv_s (uint32_t src, size_t vl);
uint64_t __riscv_vmv_x (vuint64m1_t src);
vuint64m1_t __riscv_vmv_s (uint64_t src, size_t vl);
uint64_t __riscv_vmv_x (vuint64m2_t src);
vuint64m2_t __riscv_vmv_s (uint64_t src, size_t vl);
uint64_t __riscv_vmv_x (vuint64m4_t src);
vuint64m4_t __riscv_vmv_s (uint64_t src, size_t vl);
uint64_t __riscv_vmv_x (vuint64m8_t src);
vuint64m8_t __riscv_vmv_s (uint64_t src, size_t vl);
float16_t __riscv_vfmv_f (vfloat16mf4_t src);
vfloat16mf4_t __riscv_vfmv_s (float16_t src, size_t vl);
float16_t __riscv_vfmv_f (vfloat16mf2_t src);
vfloat16mf2_t __riscv_vfmv_s (float16_t src, size_t vl);
float16_t __riscv_vfmv_f (vfloat16m1_t src);
vfloat16m1_t __riscv_vfmv_s (float16_t src, size_t vl);
float16_t __riscv_vfmv_f (vfloat16m2_t src);
vfloat16m2_t __riscv_vfmv_s (float16_t src, size_t vl);
float16_t __riscv_vfmv_f (vfloat16m4_t src);
vfloat16m4_t __riscv_vfmv_s (float16_t src, size_t vl);
float16_t __riscv_vfmv_f (vfloat16m8_t src);
vfloat16m8_t __riscv_vfmv_s (float16_t src, size_t vl);
float32_t __riscv_vfmv_f (vfloat32mf2_t src);
vfloat32mf2_t __riscv_vfmv_s (float32_t src, size_t vl);
float32_t __riscv_vfmv_f (vfloat32m1_t src);
vfloat32m1_t __riscv_vfmv_s (float32_t src, size_t vl);
float32_t __riscv_vfmv_f (vfloat32m2_t src);
vfloat32m2_t __riscv_vfmv_s (float32_t src, size_t vl);
float32_t __riscv_vfmv_f (vfloat32m4_t src);
vfloat32m4_t __riscv_vfmv_s (float32_t src, size_t vl);
float32_t __riscv_vfmv_f (vfloat32m8_t src);
vfloat32m8_t __riscv_vfmv_s (float32_t src, size_t vl);
float64_t __riscv_vfmv_f (vfloat64m1_t src);
vfloat64m1_t __riscv_vfmv_s (float64_t src, size_t vl);
float64_t __riscv_vfmv_f (vfloat64m2_t src);
vfloat64m2_t __riscv_vfmv_s (float64_t src, size_t vl);
float64_t __riscv_vfmv_f (vfloat64m4_t src);
vfloat64m4_t __riscv_vfmv_s (float64_t src, size_t vl);
float64_t __riscv_vfmv_f (vfloat64m8_t src);
vfloat64m8_t __riscv_vfmv_s (float64_t src, size_t vl);
```
### [Vector Slideup and Slidedown Functions](../rvv-intrinsic-api.md#173-vector-slide-operations):

**Prototypes:**
``` C
vint8mf8_t __riscv_vslideup (vint8mf8_t src, size_t offset, size_t vl);
vint8mf4_t __riscv_vslideup (vint8mf4_t src, size_t offset, size_t vl);
vint8mf2_t __riscv_vslideup (vint8mf2_t src, size_t offset, size_t vl);
vint8m1_t __riscv_vslideup (vint8m1_t src, size_t offset, size_t vl);
vint8m2_t __riscv_vslideup (vint8m2_t src, size_t offset, size_t vl);
vint8m4_t __riscv_vslideup (vint8m4_t src, size_t offset, size_t vl);
vint8m8_t __riscv_vslideup (vint8m8_t src, size_t offset, size_t vl);
vint16mf4_t __riscv_vslideup (vint16mf4_t src, size_t offset, size_t vl);
vint16mf2_t __riscv_vslideup (vint16mf2_t src, size_t offset, size_t vl);
vint16m1_t __riscv_vslideup (vint16m1_t src, size_t offset, size_t vl);
vint16m2_t __riscv_vslideup (vint16m2_t src, size_t offset, size_t vl);
vint16m4_t __riscv_vslideup (vint16m4_t src, size_t offset, size_t vl);
vint16m8_t __riscv_vslideup (vint16m8_t src, size_t offset, size_t vl);
vint32mf2_t __riscv_vslideup (vint32mf2_t src, size_t offset, size_t vl);
vint32m1_t __riscv_vslideup (vint32m1_t src, size_t offset, size_t vl);
vint32m2_t __riscv_vslideup (vint32m2_t src, size_t offset, size_t vl);
vint32m4_t __riscv_vslideup (vint32m4_t src, size_t offset, size_t vl);
vint32m8_t __riscv_vslideup (vint32m8_t src, size_t offset, size_t vl);
vint64m1_t __riscv_vslideup (vint64m1_t src, size_t offset, size_t vl);
vint64m2_t __riscv_vslideup (vint64m2_t src, size_t offset, size_t vl);
vint64m4_t __riscv_vslideup (vint64m4_t src, size_t offset, size_t vl);
vint64m8_t __riscv_vslideup (vint64m8_t src, size_t offset, size_t vl);
vuint8mf8_t __riscv_vslideup (vuint8mf8_t src, size_t offset, size_t vl);
vuint8mf4_t __riscv_vslideup (vuint8mf4_t src, size_t offset, size_t vl);
vuint8mf2_t __riscv_vslideup (vuint8mf2_t src, size_t offset, size_t vl);
vuint8m1_t __riscv_vslideup (vuint8m1_t src, size_t offset, size_t vl);
vuint8m2_t __riscv_vslideup (vuint8m2_t src, size_t offset, size_t vl);
vuint8m4_t __riscv_vslideup (vuint8m4_t src, size_t offset, size_t vl);
vuint8m8_t __riscv_vslideup (vuint8m8_t src, size_t offset, size_t vl);
vuint16mf4_t __riscv_vslideup (vuint16mf4_t src, size_t offset, size_t vl);
vuint16mf2_t __riscv_vslideup (vuint16mf2_t src, size_t offset, size_t vl);
vuint16m1_t __riscv_vslideup (vuint16m1_t src, size_t offset, size_t vl);
vuint16m2_t __riscv_vslideup (vuint16m2_t src, size_t offset, size_t vl);
vuint16m4_t __riscv_vslideup (vuint16m4_t src, size_t offset, size_t vl);
vuint16m8_t __riscv_vslideup (vuint16m8_t src, size_t offset, size_t vl);
vuint32mf2_t __riscv_vslideup (vuint32mf2_t src, size_t offset, size_t vl);
vuint32m1_t __riscv_vslideup (vuint32m1_t src, size_t offset, size_t vl);
vuint32m2_t __riscv_vslideup (vuint32m2_t src, size_t offset, size_t vl);
vuint32m4_t __riscv_vslideup (vuint32m4_t src, size_t offset, size_t vl);
vuint32m8_t __riscv_vslideup (vuint32m8_t src, size_t offset, size_t vl);
vuint64m1_t __riscv_vslideup (vuint64m1_t src, size_t offset, size_t vl);
vuint64m2_t __riscv_vslideup (vuint64m2_t src, size_t offset, size_t vl);
vuint64m4_t __riscv_vslideup (vuint64m4_t src, size_t offset, size_t vl);
vuint64m8_t __riscv_vslideup (vuint64m8_t src, size_t offset, size_t vl);
vfloat16mf4_t __riscv_vslideup (vfloat16mf4_t src, size_t offset, size_t vl);
vfloat16mf2_t __riscv_vslideup (vfloat16mf2_t src, size_t offset, size_t vl);
vfloat16m1_t __riscv_vslideup (vfloat16m1_t src, size_t offset, size_t vl);
vfloat16m2_t __riscv_vslideup (vfloat16m2_t src, size_t offset, size_t vl);
vfloat16m4_t __riscv_vslideup (vfloat16m4_t src, size_t offset, size_t vl);
vfloat16m8_t __riscv_vslideup (vfloat16m8_t src, size_t offset, size_t vl);
vfloat32mf2_t __riscv_vslideup (vfloat32mf2_t src, size_t offset, size_t vl);
vfloat32m1_t __riscv_vslideup (vfloat32m1_t src, size_t offset, size_t vl);
vfloat32m2_t __riscv_vslideup (vfloat32m2_t src, size_t offset, size_t vl);
vfloat32m4_t __riscv_vslideup (vfloat32m4_t src, size_t offset, size_t vl);
vfloat32m8_t __riscv_vslideup (vfloat32m8_t src, size_t offset, size_t vl);
vfloat64m1_t __riscv_vslideup (vfloat64m1_t src, size_t offset, size_t vl);
vfloat64m2_t __riscv_vslideup (vfloat64m2_t src, size_t offset, size_t vl);
vfloat64m4_t __riscv_vslideup (vfloat64m4_t src, size_t offset, size_t vl);
vfloat64m8_t __riscv_vslideup (vfloat64m8_t src, size_t offset, size_t vl);
...
// masked functions
vint8mf8_t __riscv_vslideup (vbool64_t mask, vint8mf8_t src, size_t offset, size_t vl);
vint8mf4_t __riscv_vslideup (vbool32_t mask, vint8mf4_t src, size_t offset, size_t vl);
vint8mf2_t __riscv_vslideup (vbool16_t mask, vint8mf2_t src, size_t offset, size_t vl);
vint8m1_t __riscv_vslideup (vbool8_t mask, vint8m1_t src, size_t offset, size_t vl);
vint8m2_t __riscv_vslideup (vbool4_t mask, vint8m2_t src, size_t offset, size_t vl);
vint8m4_t __riscv_vslideup (vbool2_t mask, vint8m4_t src, size_t offset, size_t vl);
vint8m8_t __riscv_vslideup (vbool1_t mask, vint8m8_t src, size_t offset, size_t vl);
vint16mf4_t __riscv_vslideup (vbool64_t mask, vint16mf4_t src, size_t offset, size_t vl);
vint16mf2_t __riscv_vslideup (vbool32_t mask, vint16mf2_t src, size_t offset, size_t vl);
vint16m1_t __riscv_vslideup (vbool16_t mask, vint16m1_t src, size_t offset, size_t vl);
vint16m2_t __riscv_vslideup (vbool8_t mask, vint16m2_t src, size_t offset, size_t vl);
vint16m4_t __riscv_vslideup (vbool4_t mask, vint16m4_t src, size_t offset, size_t vl);
vint16m8_t __riscv_vslideup (vbool2_t mask, vint16m8_t src, size_t offset, size_t vl);
vint32mf2_t __riscv_vslideup (vbool64_t mask, vint32mf2_t src, size_t offset, size_t vl);
vint32m1_t __riscv_vslideup (vbool32_t mask, vint32m1_t src, size_t offset, size_t vl);
vint32m2_t __riscv_vslideup (vbool16_t mask, vint32m2_t src, size_t offset, size_t vl);
vint32m4_t __riscv_vslideup (vbool8_t mask, vint32m4_t src, size_t offset, size_t vl);
vint32m8_t __riscv_vslideup (vbool4_t mask, vint32m8_t src, size_t offset, size_t vl);
vint64m1_t __riscv_vslideup (vbool64_t mask, vint64m1_t src, size_t offset, size_t vl);
vint64m2_t __riscv_vslideup (vbool32_t mask, vint64m2_t src, size_t offset, size_t vl);
vint64m4_t __riscv_vslideup (vbool16_t mask, vint64m4_t src, size_t offset, size_t vl);
vint64m8_t __riscv_vslideup (vbool8_t mask, vint64m8_t src, size_t offset, size_t vl);
vuint8mf8_t __riscv_vslideup (vbool64_t mask, vuint8mf8_t src, size_t offset, size_t vl);
vuint8mf4_t __riscv_vslideup (vbool32_t mask, vuint8mf4_t src, size_t offset, size_t vl);
vuint8mf2_t __riscv_vslideup (vbool16_t mask, vuint8mf2_t src, size_t offset, size_t vl);
vuint8m1_t __riscv_vslideup (vbool8_t mask, vuint8m1_t src, size_t offset, size_t vl);
vuint8m2_t __riscv_vslideup (vbool4_t mask, vuint8m2_t src, size_t offset, size_t vl);
vuint8m4_t __riscv_vslideup (vbool2_t mask, vuint8m4_t src, size_t offset, size_t vl);
vuint8m8_t __riscv_vslideup (vbool1_t mask, vuint8m8_t src, size_t offset, size_t vl);
vuint16mf4_t __riscv_vslideup (vbool64_t mask, vuint16mf4_t src, size_t offset, size_t vl);
vuint16mf2_t __riscv_vslideup (vbool32_t mask, vuint16mf2_t src, size_t offset, size_t vl);
vuint16m1_t __riscv_vslideup (vbool16_t mask, vuint16m1_t src, size_t offset, size_t vl);
vuint16m2_t __riscv_vslideup (vbool8_t mask, vuint16m2_t src, size_t offset, size_t vl);
vuint16m4_t __riscv_vslideup (vbool4_t mask, vuint16m4_t src, size_t offset, size_t vl);
vuint16m8_t __riscv_vslideup (vbool2_t mask, vuint16m8_t src, size_t offset, size_t vl);
vuint32mf2_t __riscv_vslideup (vbool64_t mask, vuint32mf2_t src, size_t offset, size_t vl);
vuint32m1_t __riscv_vslideup (vbool32_t mask, vuint32m1_t src, size_t offset, size_t vl);
vuint32m2_t __riscv_vslideup (vbool16_t mask, vuint32m2_t src, size_t offset, size_t vl);
vuint32m4_t __riscv_vslideup (vbool8_t mask, vuint32m4_t src, size_t offset, size_t vl);
vuint32m8_t __riscv_vslideup (vbool4_t mask, vuint32m8_t src, size_t offset, size_t vl);
vuint64m1_t __riscv_vslideup (vbool64_t mask, vuint64m1_t src, size_t offset, size_t vl);
vuint64m2_t __riscv_vslideup (vbool32_t mask, vuint64m2_t src, size_t offset, size_t vl);
vuint64m4_t __riscv_vslideup (vbool16_t mask, vuint64m4_t src, size_t offset, size_t vl);
vuint64m8_t __riscv_vslideup (vbool8_t mask, vuint64m8_t src, size_t offset, size_t vl);
vfloat16mf4_t __riscv_vslideup (vbool64_t mask, vfloat16mf4_t src, size_t offset, size_t vl);
vfloat16mf2_t __riscv_vslideup (vbool32_t mask, vfloat16mf2_t src, size_t offset, size_t vl);
vfloat16m1_t __riscv_vslideup (vbool16_t mask, vfloat16m1_t src, size_t offset, size_t vl);
vfloat16m2_t __riscv_vslideup (vbool8_t mask, vfloat16m2_t src, size_t offset, size_t vl);
vfloat16m4_t __riscv_vslideup (vbool4_t mask, vfloat16m4_t src, size_t offset, size_t vl);
vfloat16m8_t __riscv_vslideup (vbool2_t mask, vfloat16m8_t src, size_t offset, size_t vl);
vfloat32mf2_t __riscv_vslideup (vbool64_t mask, vfloat32mf2_t src, size_t offset, size_t vl);
vfloat32m1_t __riscv_vslideup (vbool32_t mask, vfloat32m1_t src, size_t offset, size_t vl);
vfloat32m2_t __riscv_vslideup (vbool16_t mask, vfloat32m2_t src, size_t offset, size_t vl);
vfloat32m4_t __riscv_vslideup (vbool8_t mask, vfloat32m4_t src, size_t offset, size_t vl);
vfloat32m8_t __riscv_vslideup (vbool4_t mask, vfloat32m8_t src, size_t offset, size_t vl);
vfloat64m1_t __riscv_vslideup (vbool64_t mask, vfloat64m1_t src, size_t offset, size_t vl);
vfloat64m2_t __riscv_vslideup (vbool32_t mask, vfloat64m2_t src, size_t offset, size_t vl);
vfloat64m4_t __riscv_vslideup (vbool16_t mask, vfloat64m4_t src, size_t offset, size_t vl);
vfloat64m8_t __riscv_vslideup (vbool8_t mask, vfloat64m8_t src, size_t offset, size_t vl);
...
**Prototypes:**
``` C
vint8mf8_t __riscv_vcompress (vint8mf8_t src, vbool64_t selector, size_t vl);
vint8mf4_t __riscv_vcompress (vint8mf4_t src, vbool32_t selector, size_t vl);
vint8mf2_t __riscv_vcompress (vint8mf2_t src, vbool16_t selector, size_t vl);
vint8m1_t __riscv_vcompress (vint8m1_t src, vbool8_t selector, size_t vl);
vint8m2_t __riscv_vcompress (vint8m2_t src, vbool4_t selector, size_t vl);
vint8m4_t __riscv_vcompress (vint8m4_t src, vbool2_t selector, size_t vl);
vint8m8_t __riscv_vcompress (vint8m8_t src, vbool1_t selector, size_t vl);
vint16mf4_t __riscv_vcompress (vint16mf4_t src, vbool64_t selector, size_t vl);
vint16mf2_t __riscv_vcompress (vint16mf2_t src, vbool32_t selector, size_t vl);
vint16m1_t __riscv_vcompress (vint16m1_t src, vbool16_t selector, size_t vl);
vint16m2_t __riscv_vcompress (vint16m2_t src, vbool8_t selector, size_t vl);
vint16m4_t __riscv_vcompress (vint16m4_t src, vbool4_t selector, size_t vl);
vint16m8_t __riscv_vcompress (vint16m8_t src, vbool2_t selector, size_t vl);
vint32mf2_t __riscv_vcompress (vint32mf2_t src, vbool64_t selector, size_t vl);
vint32m1_t __riscv_vcompress (vint32m1_t src, vbool32_t selector, size_t vl);
vint32m2_t __riscv_vcompress (vint32m2_t src, vbool16_t selector, size_t vl);
vint32m4_t __riscv_vcompress (vint32m4_t src, vbool8_t selector, size_t vl);
vint32m8_t __riscv_vcompress (vint32m8_t src, vbool4_t selector, size_t vl);
vint64m1_t __riscv_vcompress (vint64m1_t src, vbool64_t selector, size_t vl);
vint64m2_t __riscv_vcompress (vint64m2_t src, vbool32_t selector, size_t vl);
vint64m4_t __riscv_vcompress (vint64m4_t src, vbool16_t selector, size_t vl);
vint64m8_t __riscv_vcompress (vint64m8_t src, vbool8_t selector, size_t vl);
vuint8mf8_t __riscv_vcompress (vuint8mf8_t src, vbool64_t selector, size_t vl);
vuint8mf4_t __riscv_vcompress (vuint8mf4_t src, vbool32_t selector, size_t vl);
vuint8mf2_t __riscv_vcompress (vuint8mf2_t src, vbool16_t selector, size_t vl);
vuint8m1_t __riscv_vcompress (vuint8m1_t src, vbool8_t selector, size_t vl);
vuint8m2_t __riscv_vcompress (vuint8m2_t src, vbool4_t selector, size_t vl);
vuint8m4_t __riscv_vcompress (vuint8m4_t src, vbool2_t selector, size_t vl);
vuint8m8_t __riscv_vcompress (vuint8m8_t src, vbool1_t selector, size_t vl);
vuint16mf4_t __riscv_vcompress (vuint16mf4_t src, vbool64_t selector, size_t vl);
vuint16mf2_t __riscv_vcompress (vuint16mf2_t src, vbool32_t selector, size_t vl);
vuint16m1_t __riscv_vcompress (vuint16m1_t src, vbool16_t selector, size_t vl);
vuint16m2_t __riscv_vcompress (vuint16m2_t src, vbool8_t selector, size_t vl);
vuint16m4_t __riscv_vcompress (vuint16m4_t src, vbool4_t selector, size_t vl);
vuint16m8_t __riscv_vcompress (vuint16m8_t src, vbool2_t selector, size_t vl);
vuint32mf2_t __riscv_vcompress (vuint32mf2_t src, vbool64_t selector, size_t vl);
vuint32m1_t __riscv_vcompress (vuint32m1_t src, vbool32_t selector, size_t vl);
vuint32m2_t __riscv_vcompress (vuint32m2_t src, vbool16_t selector, size_t vl);
vuint32m4_t __riscv_vcompress (vuint32m4_t src, vbool8_t selector, size_t vl);
vuint32m8_t __riscv_vcompress (vuint32m8_t src, vbool4_t selector, size_t vl);
vuint64m1_t __riscv_vcompress (vuint64m1_t src, vbool64_t selector, size_t vl);
vuint64m2_t __riscv_vcompress (vuint64m2_t src, vbool32_t selector, size_t vl);
vuint64m4_t __riscv_vcompress (vuint64m4_t src, vbool16_t selector, size_t vl);
vuint64m8_t __riscv_vcompress (vuint64m8_t src, vbool8_t selector, size_t vl);
vfloat16mf4_t __riscv_vcompress (vfloat16mf4_t src, vbool64_t selector, size_t vl);
vfloat16mf2_t __riscv_vcompress (vfloat16mf2_t src, vbool32_t selector, size_t vl);
vfloat16m1_t __riscv_vcompress (vfloat16m1_t src, vbool16_t selector, size_t vl);
vfloat16m2_t __riscv_vcompress (vfloat16m2_t src, vbool8_t selector, size_t vl);
vfloat16m4_t __riscv_vcompress (vfloat16m4_t src, vbool4_t selector, size_t vl);
vfloat16m8_t __riscv_vcompress (vfloat16m8_t src, vbool2_t selector, size_t vl);
vfloat32mf2_t __riscv_vcompress (vfloat32mf2_t src, vbool64_t selector, size_t vl);
vfloat32m1_t __riscv_vcompress (vfloat32m1_t src, vbool32_t selector, size_t vl);
vfloat32m2_t __riscv_vcompress (vfloat32m2_t src, vbool16_t selector, size_t vl);
vfloat32m4_t __riscv_vcompress (vfloat32m4_t src, vbool8_t selector, size_t vl);
vfloat32m8_t __riscv_vcompress (vfloat32m8_t src, vbool4_t selector, size_t vl);
vfloat64m1_t __riscv_vcompress (vfloat64m1_t src, vbool64_t selector, size_t vl);
vfloat64m2_t __riscv_vcompress (vfloat64m2_t src, vbool32_t selector, size_t vl);
vfloat64m4_t __riscv_vcompress (vfloat64m4_t src, vbool16_t selector, size_t vl);
vfloat64m8_t __riscv_vcompress (vfloat64m8_t src, vbool8_t selector, size_t vl);
```