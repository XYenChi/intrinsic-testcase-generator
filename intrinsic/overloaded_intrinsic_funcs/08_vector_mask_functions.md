...
// masked functions
vuint8mf8_t __riscv_viota (vbool64_t mask, vbool64_t op1, size_t vl);
vuint8mf4_t __riscv_viota (vbool32_t mask, vbool32_t op1, size_t vl);
vuint8mf2_t __riscv_viota (vbool16_t mask, vbool16_t op1, size_t vl);
vuint8m1_t __riscv_viota (vbool8_t mask, vbool8_t op1, size_t vl);
vuint8m2_t __riscv_viota (vbool4_t mask, vbool4_t op1, size_t vl);
vuint8m4_t __riscv_viota (vbool2_t mask, vbool2_t op1, size_t vl);
vuint8m8_t __riscv_viota (vbool1_t mask, vbool1_t op1, size_t vl);
vuint16mf4_t __riscv_viota (vbool64_t mask, vbool64_t op1, size_t vl);
vuint16mf2_t __riscv_viota (vbool32_t mask, vbool32_t op1, size_t vl);
vuint16m1_t __riscv_viota (vbool16_t mask, vbool16_t op1, size_t vl);
vuint16m2_t __riscv_viota (vbool8_t mask, vbool8_t op1, size_t vl);
vuint16m4_t __riscv_viota (vbool4_t mask, vbool4_t op1, size_t vl);
vuint16m8_t __riscv_viota (vbool2_t mask, vbool2_t op1, size_t vl);
vuint32mf2_t __riscv_viota (vbool64_t mask, vbool64_t op1, size_t vl);
vuint32m1_t __riscv_viota (vbool32_t mask, vbool32_t op1, size_t vl);
vuint32m2_t __riscv_viota (vbool16_t mask, vbool16_t op1, size_t vl);
vuint32m4_t __riscv_viota (vbool8_t mask, vbool8_t op1, size_t vl);
vuint32m8_t __riscv_viota (vbool4_t mask, vbool4_t op1, size_t vl);
vuint64m1_t __riscv_viota (vbool64_t mask, vbool64_t op1, size_t vl);
vuint64m2_t __riscv_viota (vbool32_t mask, vbool32_t op1, size_t vl);
vuint64m4_t __riscv_viota (vbool16_t mask, vbool16_t op1, size_t vl);
vuint64m8_t __riscv_viota (vbool8_t mask, vbool8_t op1, size_t vl);
```
...
// masked functions
vuint8mf8_t __riscv_vid (vbool64_t mask, size_t vl);
vuint8mf4_t __riscv_vid (vbool32_t mask, size_t vl);
vuint8mf2_t __riscv_vid (vbool16_t mask, size_t vl);
vuint8m1_t __riscv_vid (vbool8_t mask, size_t vl);
vuint8m2_t __riscv_vid (vbool4_t mask, size_t vl);
vuint8m4_t __riscv_vid (vbool2_t mask, size_t vl);
vuint8m8_t __riscv_vid (vbool1_t mask, size_t vl);
vuint16mf4_t __riscv_vid (vbool64_t mask, size_t vl);
vuint16mf2_t __riscv_vid (vbool32_t mask, size_t vl);
vuint16m1_t __riscv_vid (vbool16_t mask, size_t vl);
vuint16m2_t __riscv_vid (vbool8_t mask, size_t vl);
vuint16m4_t __riscv_vid (vbool4_t mask, size_t vl);
vuint16m8_t __riscv_vid (vbool2_t mask, size_t vl);
vuint32mf2_t __riscv_vid (vbool64_t mask, size_t vl);
vuint32m1_t __riscv_vid (vbool32_t mask, size_t vl);
vuint32m2_t __riscv_vid (vbool16_t mask, size_t vl);
vuint32m4_t __riscv_vid (vbool8_t mask, size_t vl);
vuint32m8_t __riscv_vid (vbool4_t mask, size_t vl);
vuint64m1_t __riscv_vid (vbool64_t mask, size_t vl);
vuint64m2_t __riscv_vid (vbool32_t mask, size_t vl);
vuint64m4_t __riscv_vid (vbool16_t mask, size_t vl);
vuint64m8_t __riscv_vid (vbool8_t mask, size_t vl);
```